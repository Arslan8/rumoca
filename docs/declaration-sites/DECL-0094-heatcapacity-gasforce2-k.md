...
| | |
|---|---|
| **Declaration** | `Modelica 4.1.0/Mechanics/MultiBody/Examples/Loops/Utilities/GasForce2.mo:12` |
| **Parameter** | `k` |
| **Quantity** | `SI.Heatcapacity` |
| **Declared modifiers** | none |
| **Status** | **latent — a permitted value, not an observed failure** |

## What is wrong

`SI.Heatcapacity` declares no `min` in `Units.mo`, and this
declaration adds none of its own. It therefore accepts a negative value, and
a negative heat capacity makes heating cool the body.
