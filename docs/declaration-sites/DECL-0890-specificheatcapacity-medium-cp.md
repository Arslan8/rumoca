...
| | |
|---|---|
| **Declaration** | `Modelica 4.1.0/Thermal/FluidHeatFlow/Media/Medium.mo:5` |
| **Parameter** | `cp` |
| **Quantity** | `SI.Specificheatcapacity` |
| **Declared modifiers** | none |
| **Status** | **latent — a permitted value, not an observed failure** |

## What is wrong

`SI.Specificheatcapacity` declares no `min` in `Units.mo`, and this
