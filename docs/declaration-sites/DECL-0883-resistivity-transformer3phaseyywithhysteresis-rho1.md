...
| | |
|---|---|
| **Declaration** | `Modelica 4.1.0/Magnetic/FluxTubes/Examples/Hysteresis/Components/Transformer3PhaseYyWithHysteresis.mo:17` |
| **Parameter** | `rho1` |
| **Quantity** | `SI.Resistivity` |
| **Declared modifiers** | none |
| **Status** | **latent — a permitted value, not an observed failure** |

## What is wrong

`SI.Resistivity` declares no `min` in `Units.mo`, and this
