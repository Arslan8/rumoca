# FINDING-04290: `armature.d` in `AdvancedSolenoid`
...
| **Signature** | `physical:physical-intent-question:var:234:7e18296c` |
...
```console
$ python3 tools/sweep/check_one.py Modelica.Magnetic.FluxTubes.Examples.SolenoidActuator.Components.AdvancedSolenoid \
...
```console
$ python3 tools/sweep/check_one.py Modelica.Magnetic.FluxTubes.Examples.SolenoidActuator.Components.AdvancedSolenoid --keep-artifact /tmp/m.rbc \
