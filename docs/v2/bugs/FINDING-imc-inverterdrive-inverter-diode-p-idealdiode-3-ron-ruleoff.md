# FINDING-01883: `inverter.diode_p.idealDiode[3].Ron` in `IMC_InverterDrive`
...
| **Reached as** | `inverter.diode_p.idealDiode[3].Ron` |
...
| **Signature** | `physical:physical-rule-does-not-apply:var:661:4ffa79c1` |
...
```
predicate     inverter.diode_p.idealDiode[3].Ron > 0
premise       refuted
...
| `required` | inverter.diode_p.idealDiode[3].Ron &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.InductionMachines.IMC_InverterDrive \
      --target inverter.diode_p.idealDiode[3].Ron --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "inverter.diode_p.idealDiode[3].Ron"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param inverter.diode_p.idealDiode[3].Ron=0
```
