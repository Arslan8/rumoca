...
| **Reached as** | `dcdcInverter2.iMotFilter.T` |
...
| **Signature** | `divisor:divisor-reachable-zero:exp:2931:31bf5b59` |
...
```
denominator            dcdcInverter2.iMotFilter.T
witness                dcdcInverter2.iMotFilter.T = 0
  found by             set to zero
denominator at witness 0.0
at declared values     0.002
path condition         always evaluated
constraints consulted  dcdcInverter2.iMotFilter.T: unbounded
```
...
| `constraints` | dcdcInverter2.iMotFilter.T: unbounded |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.DCMachines.DCPM_Drive \
      --target dcdcInverter2.iMotFilter.T --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "dcdcInverter2.iMotFilter.T"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check \
      --param dcdcInverter2.iMotFilter.T=0
```
