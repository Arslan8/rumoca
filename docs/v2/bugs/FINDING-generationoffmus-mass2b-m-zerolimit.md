# FINDING-04713: `mass2b.m` in `GenerationOfFMUs`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:193:8f9c8af6` |
...
$ python3 tools/sweep/check_one.py Modelica.Mechanics.Translational.Examples.GenerationOfFMUs \
      --target mass2b.m --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "mass2b.m"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param mass2b.m=0
```
