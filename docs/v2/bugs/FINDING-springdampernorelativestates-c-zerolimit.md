# FINDING-04681: `c` in `SpringDamperNoRelativeStates`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:8:59812de8` |
...
```console
$ python3 tools/sweep/check_one.py Modelica.Mechanics.Rotational.Examples.Utilities.SpringDamperNoRelativeStates \
...
```console
$ python3 tools/sweep/check_one.py Modelica.Mechanics.Rotational.Examples.Utilities.SpringDamperNoRelativeStates --keep-artifact /tmp/m.rbc \
