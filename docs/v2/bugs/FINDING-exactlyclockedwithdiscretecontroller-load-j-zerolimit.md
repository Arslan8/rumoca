# FINDING-00007: `load.J` in `ExactlyClockedWithDiscreteController`

|  |  |
|---|---|
| **Tier** | **Candidate** — static only, not execution-confirmed |
| **Model** | `Modelica.Clocked.Examples.SimpleControlledDrive.ExactlyClockedWithDiscreteController` |
| **Reached as** | `load.J` |
...
```console
$ python3 tools/sweep/check_one.py Modelica.Clocked.Examples.SimpleControlledDrive.ExactlyClockedWithDiscreteController \
...
```console
$ python3 tools/sweep/check_one.py Modelica.Clocked.Examples.SimpleControlledDrive.ExactlyClockedWithDiscreteController --keep-artifact /tmp/m.rbc \
