# DECL-0683: `Rr` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Electrical/Machines/BasicMachines/InductionMachines/IM_SquirrelCage.mo:33` |
| **Parameter** | `Rr` |
| **Type** | `SI.Resistance` |
...
```modelica
// Electrical/Machines/BasicMachines/InductionMachines/IM_SquirrelCage.mo:33
