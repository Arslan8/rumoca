# FINDING-04171: `signalPWM.f` in `HBridge_TrianglePWM_RL`
...
| **Severity** | high |
| **Declaration** | `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/PowerConverters/DCDC/Control/SignalPWM.mo:51` |
| **Signature** | `divisor:divisor-reachable-zero:exp:477:cde71d76` |
...
```console
$ sed -n '51p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/PowerConverters/DCDC/Control/SignalPWM.mo"
```
...
```console
$ grep -rl '| `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/PowerConverters/DCDC/Control/SignalPWM.mo:51` |' docs/v2/bugs/
```
