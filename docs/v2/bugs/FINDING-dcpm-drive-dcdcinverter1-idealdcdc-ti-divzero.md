...
| **Signature** | `divisor:divisor-reachable-zero:exp:1662:0dc59d98` |
...
```
denominator            dcdcInverter1.idealDcDc.Ti
witness                dcdcInverter1.idealDcDc.Ti = 0
  found by             set to zero
denominator at witness 0.0
at declared values     1e-06
path condition         always evaluated
constraints consulted  dcdcInverter1.idealDcDc.Ti: unbounded
```
...
| `constraints` | dcdcInverter1.idealDcDc.Ti: unbounded |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.DCMachines.DCPM_Drive \
      --target dcdcInverter1.idealDcDc.Ti --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "dcdcInverter1.idealDcDc.Ti"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check \
      --param dcdcInverter1.idealDcDc.Ti=0
```
