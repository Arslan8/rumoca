# FINDING-04745: `mass.m` in `InverseMass`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:7:67fc9868` |
...
```console
$ python3 tools/sweep/check_one.py Modelica.Mechanics.Translational.Examples.Utilities.InverseMass \
...
```console
$ python3 tools/sweep/check_one.py Modelica.Mechanics.Translational.Examples.Utilities.InverseMass --keep-artifact /tmp/m.rbc \
