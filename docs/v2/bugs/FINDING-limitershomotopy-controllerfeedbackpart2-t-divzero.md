...
| **Reached as** | `controllerFeedbackPart2.T` |
...
| **Signature** | `divisor:divisor-reachable-zero:exp:455:b63cfa2b` |
...
```
denominator            controllerFeedbackPart2.T
witness                controllerFeedbackPart2.T = 0
  found by             set to zero
denominator at witness 0.0
at declared values     1.0
path condition         always evaluated
constraints consulted  controllerFeedbackPart2.T: unbounded
```
...
| `constraints` | controllerFeedbackPart2.T: unbounded |
...
$ python3 tools/sweep/check_one.py ModelicaTest.Blocks.LimitersHomotopy \
      --target controllerFeedbackPart2.T --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "controllerFeedbackPart2.T"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check \
      --param controllerFeedbackPart2.T=0
```
