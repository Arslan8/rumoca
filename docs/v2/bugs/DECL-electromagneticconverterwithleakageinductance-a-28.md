# DECL-0024: `A` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Magnetic/FluxTubes/Basic/ElectroMagneticConverterWithLeakageInductance.mo:28` |
| **Parameter** | `A` |
| **Type** | `SI.Area` |
| **Declared modifiers** | `—` |
...
```modelica
// Magnetic/FluxTubes/Basic/ElectroMagneticConverterWithLeakageInductance.mo:28
