# FINDING-00273: `C1.C` in `DifferenceAmplifier`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:111:c8d15c89` |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.DifferenceAmplifier \
      --target C1.C --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "C1.C"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param C1.C=0
```
