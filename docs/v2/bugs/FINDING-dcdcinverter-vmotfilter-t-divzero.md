...
| **Signature** | `divisor:divisor-reachable-zero:exp:430:73058245` |
...
| `constraints` | vMotFilter.T: unbounded |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.ControlledDCDrives.Utilities.DcdcInverter \
      --target vMotFilter.T --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "vMotFilter.T"
```
