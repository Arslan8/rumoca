# FINDING-05454: `L` in `SwitchedRLC_MSL`
...
| **Severity** | low |
| **Declaration** | `examples/models/SwitchedRLC_MSL.mo:6` |
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:1:2875fa76` |
...
```
{'quantity': 'Inductance', 'unit': 'H', 'confidence': 'QUANTITY_AND_UNIT', 'premise_state': 'unknown', 'authority': 'quantity_or_unit', 'canonical_declaration': 'SwitchedRLC_MSL.L'}
```
...
```console
$ sed -n '6p' "examples/models/SwitchedRLC_MSL.mo"
```
...
```console
$ grep -rl '| `examples/models/SwitchedRLC_MSL.mo:6` |' docs/v2/bugs/
```
