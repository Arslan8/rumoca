# FINDING-01250: `Tr.Ccs` in `Transistor`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:45:e0c16444` |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.Utilities.Transistor \
      --target Tr.Ccs --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "Tr.Ccs"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param Tr.Ccs=0
```
