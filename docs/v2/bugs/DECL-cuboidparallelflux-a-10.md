# DECL-0475: `a` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Magnetic/FluxTubes/Shapes/Force/CuboidParallelFlux.mo:10` |
| **Parameter** | `a` |
| **Type** | `SI.Length` |
| **Declared modifiers** | `—` |
...
```console
$ sed -n '10p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/FluxTubes/Shapes/Force/CuboidParallelFlux.mo"
```
...
```modelica
// Magnetic/FluxTubes/Shapes/Force/CuboidParallelFlux.mo:10
