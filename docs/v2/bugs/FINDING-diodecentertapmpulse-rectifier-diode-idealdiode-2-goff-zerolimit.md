# FINDING-03901: `rectifier.diode.idealDiode[2].Goff` in `DiodeCenterTapmPulse`
...
| **Reached as** | `rectifier.diode.idealDiode[2].Goff` |
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:157:e4f33468` |
...
```
predicate     rectifier.diode.idealDiode[2].Goff > 0
premise       refuted
...
| `required` | rectifier.diode.idealDiode[2].Goff &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.PowerConverters.Examples.ACDC.RectifierCenterTapmPulse.DiodeCenterTapmPulse \
      --target rectifier.diode.idealDiode[2].Goff --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "rectifier.diode.idealDiode[2].Goff"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param rectifier.diode.idealDiode[2].Goff=0
```
