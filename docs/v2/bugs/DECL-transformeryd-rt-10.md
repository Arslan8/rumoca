# DECL-0739: `RT` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Electrical/Polyphase/Examples/TransformerYD.mo:10` |
| **Parameter** | `RT` |
| **Type** | `SI.Resistance` |
| **Declared modifiers** | `—` |
...
It should declare `RT` with type `SI.Resistance` and no `min`.
...
```modelica
// Electrical/Polyphase/Examples/TransformerYD.mo:10
parameter SI.Resistance RT(min=0) = ...;
```
