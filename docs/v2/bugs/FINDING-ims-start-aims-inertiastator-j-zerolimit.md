# FINDING-02279: `aims.inertiaStator.J` in `IMS_Start`
...
| **Reached as** | `aims.inertiaStator.J` |
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:369:abaa66fe` |
...
```
predicate     aims.inertiaStator.J > 0
premise       refuted
...
| `required` | aims.inertiaStator.J &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.InductionMachines.IMS_Start \
      --target aims.inertiaStator.J --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "aims.inertiaStator.J"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param aims.inertiaStator.J=0
```
