...
| **Signature** | `divisor:divisor-reachable-zero:exp:1597:20688573` |
...
```
denominator            g_mFePole.l
witness                g_mFePole.l = 0
  found by             set to zero
denominator at witness 0.0
at declared values     0.0065
path condition         always evaluated
constraints consulted  g_mFePole.l: unbounded
```
...
$ python3 tools/sweep/check_one.py Modelica.Magnetic.FluxTubes.Examples.SolenoidActuator.Components.AdvancedSolenoid \
      --target g_mFePole.l --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "g_mFePole.l"
```
