# FINDING-04475: `referenceSystem.pointMass5.m` in `PointGravityWithPointMasses2`
...
| **Reached as** | `referenceSystem.pointMass5.m` |
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:927:e51bea0b` |
...
```
predicate     referenceSystem.pointMass5.m > 0
premise       refuted
...
| `required` | referenceSystem.pointMass5.m &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Mechanics.MultiBody.Examples.Elementary.PointGravityWithPointMasses2 \
      --target referenceSystem.pointMass5.m --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "referenceSystem.pointMass5.m"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param referenceSystem.pointMass5.m=0
```
