# FINDING-04672: `inertia.J` in `RollingWheel`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:25:5ad2b900` |
...
```console
$ python3 tools/sweep/check_one.py Modelica.Mechanics.Rotational.Examples.RollingWheel \
...
```console
$ python3 tools/sweep/check_one.py Modelica.Mechanics.Rotational.Examples.RollingWheel --keep-artifact /tmp/m.rbc \
