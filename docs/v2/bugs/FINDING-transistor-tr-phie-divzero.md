...
| **Signature** | `divisor:divisor-reachable-zero:exp:444:74d12bdf` |
...
constraints consulted  Tr.Phie: unbounded
```
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.Utilities.Transistor \
      --target Tr.Phie --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "Tr.Phie"
```
