# FINDING-04360: `mass.m` in `TranslatoryArmatureAndStopper`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:16:c92ef09e` |
...
$ python3 tools/sweep/check_one.py Modelica.Magnetic.FluxTubes.Examples.Utilities.TranslatoryArmatureAndStopper \
      --target mass.m --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "mass.m"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param mass.m=0
```
