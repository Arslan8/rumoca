...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:180:ce63cb1e` |
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Polyphase.Examples.TestSensors \
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Polyphase.Examples.TestSensors --keep-artifact /tmp/m.rbc \
