...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:156:d0348efb` |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.Rectifier \
      --target IdealDiode5.Goff --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "IdealDiode5.Goff"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param IdealDiode5.Goff=0
```
