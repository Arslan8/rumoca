# FINDING-01517: `ramp2.duration` in `DCPM_Drive`
...
| **Signature** | `divisor:divisor-unreachable-under-witness:exp:3116:084c1333` |
...
| `verdict` | UNSAT |
| `proof` | the path conditions cannot hold together: time must be both &gt; 1.25 and &lt; 1.25 |
