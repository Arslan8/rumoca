...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:114:aef78759` |
...
$ python3 tools/sweep/check_one.py ModelicaTest.Translational.TestBraking \
      --target mass6.m --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "mass6.m"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param mass6.m=0
```
