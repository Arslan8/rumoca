...
| **Declaration** | `Electrical/Machines/Interfaces/PartialBasicDCMachine.mo:26` |
| **Parameter** | `La` |
| **Type** | `SI.Inductance` |
| **Declared modifiers** | `(start=0.0015)` |
...
```console
$ grep -n -- "-1e40\|-1E40" "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Machines/Interfaces/PartialBasicDCMachine.mo" | head
```
...
```modelica
// Electrical/Machines/Interfaces/PartialBasicDCMachine.mo:26
