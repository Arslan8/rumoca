# FINDING-04712: `mass2a.m` in `GenerationOfFMUs`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:157:9833b6bd` |
...
$ python3 tools/sweep/check_one.py Modelica.Mechanics.Translational.Examples.GenerationOfFMUs \
      --target mass2a.m --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "mass2a.m"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param mass2a.m=0
```
