# DECL-0840: `Rrq` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Magnetic/FundamentalWave/BasicMachines/SynchronousMachines/SM_ElectricalExcited.mo:60` |
| **Parameter** | `Rrq` |
| **Type** | `SI.Resistance` |
| **Declared modifiers** | `—` |
...
```console
$ sed -n '60p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/FundamentalWave/BasicMachines/SynchronousMachines/SM_ElectricalExcited.mo"
```
...
```modelica
// Magnetic/FundamentalWave/BasicMachines/SynchronousMachines/SM_ElectricalExcited.mo:60
