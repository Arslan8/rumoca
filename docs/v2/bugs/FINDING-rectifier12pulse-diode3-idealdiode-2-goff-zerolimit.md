# FINDING-03161: `diode3.idealDiode[2].Goff` in `Rectifier12pulse`
...
| **Reached as** | `diode3.idealDiode[2].Goff` |
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:820:afa4a3a0` |
...
```
predicate     diode3.idealDiode[2].Goff > 0
premise       refuted
...
| `required` | diode3.idealDiode[2].Goff &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.Transformers.Rectifier12pulse \
      --target diode3.idealDiode[2].Goff --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "diode3.idealDiode[2].Goff"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param diode3.idealDiode[2].Goff=0
```
