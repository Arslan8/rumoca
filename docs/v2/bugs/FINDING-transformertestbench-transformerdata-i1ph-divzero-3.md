# FINDING-03309: `transformerData.I1ph` in `TransformerTestbench`
...
| **Reached as** | `transformerData.I1ph` |
...
| **Signature** | `divisor:divisor-reachable-zero:exp:1219:2221de9c` |
...
```
denominator            (3 * (transformerData.I1ph ^ 2))
witness                transformerData.I1ph = 0
  found by             set to zero
denominator at witness 0.0
at declared values     None
path condition         always evaluated
constraints consulted  transformerData.I1ph: unbounded
```
...
| `constraints` | transformerData.I1ph: unbounded |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.Transformers.TransformerTestbench \
      --target transformerData.I1ph --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "transformerData.I1ph"
```
