# FINDING-00208: `R11.R` in `CauerLowPassSC`
...
| **Signature** | `physical:physical-rule-does-not-apply:var:844:441f6345` |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.CauerLowPassSC \
      --target R11.R --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "R11.R"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param R11.R=0
```
