# FINDING-04195: `r_mFe.material.B_myMax` in `SaturatedInductor`
...
| **Reached as** | `r_mFe.material.B_myMax` |
...
| **Signature** | `divisor:divisor-reachable-zero:exp:397:0500122e` |
...
```
denominator            r_mFe.material.B_myMax
witness                r_mFe.material.B_myMax = 0
  found by             set to zero
denominator at witness 0.0
at declared values     1.16
path condition         always evaluated
constraints consulted  r_mFe.material.B_myMax: unbounded
```
...
$ python3 tools/sweep/check_one.py Modelica.Magnetic.FluxTubes.Examples.BasicExamples.SaturatedInductor \
      --target r_mFe.material.B_myMax --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "r_mFe.material.B_myMax"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check \
      --param r_mFe.material.B_myMax=0
```
