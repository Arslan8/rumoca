# DECL-0448: `l_air` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Magnetic/FluxTubes/Examples/MovingCoilActuator/Components/PermeanceActuator.mo:18` |
| **Parameter** | `l_air` |
| **Type** | `SI.Length` |
| **Declared modifiers** | `—` |
...
```console
$ sed -n '18p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/FluxTubes/Examples/MovingCoilActuator/Components/PermeanceActuator.mo"
```

It should declare `l_air` with type `SI.Length` and no `min`.
...
```modelica
// Magnetic/FluxTubes/Examples/MovingCoilActuator/Components/PermeanceActuator.mo:18
parameter SI.Length l_air(min=0) = ...;
```
