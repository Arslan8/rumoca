# FINDING-00866: `derivative.R1` in `HighPass`
...
| **Signature** | `divisor:divisor-reachable-zero:exp:75:0d76a4c1` |
...
| `constraints` | derivative.R1: unbounded |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.OpAmps.HighPass \
      --target derivative.R1 --sanitizer divisor
```
