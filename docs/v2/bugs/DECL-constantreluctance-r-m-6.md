# DECL-0591: `R_m` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Magnetic/FluxTubes/Basic/ConstantReluctance.mo:6` |
| **Parameter** | `R_m` |
| **Type** | `SI.Reluctance` |
| **Declared modifiers** | `—` |
...
```console
$ sed -n '6p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/FluxTubes/Basic/ConstantReluctance.mo"
```
...
```console
$ grep -n -- "-1e40\|-1E40" "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/FluxTubes/Basic/ConstantReluctance.mo" | head
```
...
```modelica
// Magnetic/FluxTubes/Basic/ConstantReluctance.mo:6
