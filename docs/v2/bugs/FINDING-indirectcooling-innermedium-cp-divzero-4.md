...
| **Signature** | `divisor:divisor-reachable-zero:exp:1056:84629e05` |
...
| `constraints` | innerMedium.cp: unbounded |
...
$ python3 tools/sweep/check_one.py Modelica.Thermal.FluidHeatFlow.Examples.IndirectCooling \
      --target innerMedium.cp --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "innerMedium.cp"
```
