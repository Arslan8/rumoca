# FINDING-02946: `smr.inertiaStator.J` in `SMR_Inverter`
...
| **Reached as** | `smr.inertiaStator.J` |
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:341:1ad078e5` |
...
```
predicate     smr.inertiaStator.J > 0
premise       refuted
...
| `required` | smr.inertiaStator.J &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.SynchronousMachines.SMR_Inverter \
      --target smr.inertiaStator.J --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "smr.inertiaStator.J"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param smr.inertiaStator.J=0
```
