...
| **Signature** | `divisor:divisor-reachable-zero:exp:441:acddf867` |
...
| `constraints` | firstOrder1.T: unbounded |
...
$ python3 tools/sweep/check_one.py ModelicaTest.Blocks.LimitersHomotopy \
      --target firstOrder1.T --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "firstOrder1.T"
```
