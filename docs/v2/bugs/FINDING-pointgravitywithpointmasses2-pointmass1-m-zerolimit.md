# FINDING-04465: `pointMass1.m` in `PointGravityWithPointMasses2`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:6:407c4200` |
...
$ python3 tools/sweep/check_one.py Modelica.Mechanics.MultiBody.Examples.Elementary.PointGravityWithPointMasses2 \
      --target pointMass1.m --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "pointMass1.m"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param pointMass1.m=0
```
