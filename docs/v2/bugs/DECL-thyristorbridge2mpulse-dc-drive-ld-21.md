# DECL-0207: `Ld` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Electrical/PowerConverters/Examples/ACDC/RectifierBridge2mPulse/ThyristorBridge2mPulse_DC_Drive.mo:21` |
| **Parameter** | `Ld` |
| **Type** | `SI.Inductance` |
| **Declared modifiers** | `—` |
...
It should declare `Ld` with type `SI.Inductance` and no `min`.
...
```modelica
// Electrical/PowerConverters/Examples/ACDC/RectifierBridge2mPulse/ThyristorBridge2mPulse_DC_Drive.mo:21
parameter SI.Inductance Ld(min=0) = ...;
```
