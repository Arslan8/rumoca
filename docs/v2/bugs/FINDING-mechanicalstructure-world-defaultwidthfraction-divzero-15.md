# FINDING-04636: `world.defaultWidthFraction` in `MechanicalStructure`
...
| **Severity** | high |
| **Declaration** | `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Mechanics/MultiBody/Parts/BodyShape.mo:110` |
| **Signature** | `divisor:divisor-reachable-zero:exp:2916:d65e42cf` |
...
```console
$ sed -n '110p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Mechanics/MultiBody/Parts/BodyShape.mo"
```
...
```console
$ grep -rl '| `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Mechanics/MultiBody/Parts/BodyShape.mo:110` |' docs/v2/bugs/
```
