# FINDING-04652: `heatCapacitor.C` in `EddyCurrentBrake`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:30:19a6d3d6` |
...
```console
$ python3 tools/sweep/check_one.py Modelica.Mechanics.Rotational.Examples.EddyCurrentBrake \
...
```console
$ python3 tools/sweep/check_one.py Modelica.Mechanics.Rotational.Examples.EddyCurrentBrake --keep-artifact /tmp/m.rbc \
