...
| **Reached as** | `R10.IdealCommutingSwitch1.Ron` |
...
| **Signature** | `physical:physical-rule-does-not-apply:var:794:0ec3f2b2` |
...
```
predicate     R10.IdealCommutingSwitch1.Ron > 0
premise       refuted
...
| `required` | R10.IdealCommutingSwitch1.Ron &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.CauerLowPassSC \
      --target R10.IdealCommutingSwitch1.Ron --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "R10.IdealCommutingSwitch1.Ron"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param R10.IdealCommutingSwitch1.Ron=0
```
