# FINDING-01206: `thyristor_v4_1.Roff` in `ThyristorBehaviourTest`
...
| **Signature** | `divisor:divisor-zero-unresolved:exp:437:da3acaaf` |
...
path condition         not ((thyristor_v4_1.vAK < -thyristor_v4_1.VRRM)) and ((thyristor_v4_1.vControl < thyristor_v4_1.Voff))
...
| `path_condition` | not ((thyristor_v4_1.vAK &lt; -thyristor_v4_1.VRRM)) and ((thyristor_v4_1.vControl &lt; thyristor_v4_1.Voff)) |
| `verdict` | UNKNOWN |
