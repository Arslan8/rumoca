# DECL-0909: `V` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Media/package.mo:2152` |
| **Parameter** | `V` |
| **Type** | `SI.Volume` |
| **Declared modifiers** | `—` |
...
```console
$ sed -n '2152p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Media/package.mo"
```
