# FINDING-04059: `chopperStepUp.transistor.Ron` in `ChopperStepUp_R`
...
| **Reached as** | `chopperStepUp.transistor.Ron` |
...
```
predicate     chopperStepUp.transistor.Ron > 0
premise       refuted
...
| `required` | chopperStepUp.transistor.Ron &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.PowerConverters.Examples.DCDC.ChopperStepUp.ChopperStepUp_R \
      --target chopperStepUp.transistor.Ron --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "chopperStepUp.transistor.Ron"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param chopperStepUp.transistor.Ron=0
```
