# FINDING-04238: `cActuator.l.L` in `ArmatureStroke`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:343:10bbc2c4` |
...
$ python3 tools/sweep/check_one.py Modelica.Magnetic.FluxTubes.Examples.MovingCoilActuator.ArmatureStroke \
      --target cActuator.l.L --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "cActuator.l.L"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param cActuator.l.L=0
```
