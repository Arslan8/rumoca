# FINDING-04626: `world.defaultWidthFraction` in `MechanicalStructure`
...
| **Severity** | high |
| **Declaration** | `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Mechanics/MultiBody/Parts/FixedTranslation.mo:44` |
| **Signature** | `divisor:divisor-reachable-zero:exp:1197:33f196f8` |
...
```console
$ sed -n '44p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Mechanics/MultiBody/Parts/FixedTranslation.mo"
```
...
```console
$ grep -rl '| `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Mechanics/MultiBody/Parts/FixedTranslation.mo:44` |' docs/v2/bugs/
```
