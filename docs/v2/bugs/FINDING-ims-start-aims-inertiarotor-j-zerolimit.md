# FINDING-02278: `aims.inertiaRotor.J` in `IMS_Start`
...
| **Reached as** | `aims.inertiaRotor.J` |
...
```
predicate     aims.inertiaRotor.J > 0
premise       refuted
...
| `required` | aims.inertiaRotor.J &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.InductionMachines.IMS_Start \
      --target aims.inertiaRotor.J --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "aims.inertiaRotor.J"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param aims.inertiaRotor.J=0
```
