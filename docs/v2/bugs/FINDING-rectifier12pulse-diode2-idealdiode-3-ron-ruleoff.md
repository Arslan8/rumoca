# FINDING-03134: `diode2.idealDiode[3].Ron` in `Rectifier12pulse`
...
| **Signature** | `physical:physical-rule-does-not-apply:var:266:82b3164c` |
...
```
predicate     diode2.idealDiode[3].Ron > 0
premise       refuted
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.Transformers.Rectifier12pulse \
      --target diode2.idealDiode[3].Ron --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "diode2.idealDiode[3].Ron"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param diode2.idealDiode[3].Ron=0
```
