# FINDING-03500: `pulse2.twomPulse.filter[1].transferFunction[2].a_end` in `ThyristorBridge2mPulse_DC_Drive`
...
| **Signature** | `divisor:divisor-reachable-zero:exp:4152:ba0fe988` |
