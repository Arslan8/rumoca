# DECL-0137: `Lme` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Electrical/Machines/BasicMachines/DCMachines/DC_SeriesExcited.mo:84` |
| **Parameter** | `Lme` |
| **Type** | `SI.Inductance` |
| **Declared modifiers** | `—` |
...
```modelica
// Electrical/Machines/BasicMachines/DCMachines/DC_SeriesExcited.mo:84
