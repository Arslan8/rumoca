...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:45:2e1fe3d1` |
...
```console
$ python3 tools/sweep/check_one.py Modelica.Thermal.HeatTransfer.Examples.ControlledTemperature \
...
```console
$ python3 tools/sweep/check_one.py Modelica.Thermal.HeatTransfer.Examples.ControlledTemperature --keep-artifact /tmp/m.rbc \
