...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:435:5b299cd2` |
...
$ python3 tools/sweep/check_one.py Modelica.Mechanics.MultiBody.Examples.Elementary.ThreeSprings \
      --target spring1.spring.c --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "spring1.spring.c"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param spring1.spring.c=0
```
