# FINDING-01966: `aimcData.Lrsigma` in `IMC_Inverter`
...
| **Signature** | `physical:physical-intent-question:var:619:08044222` |
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.InductionMachines.IMC_Inverter \
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.InductionMachines.IMC_Inverter --keep-artifact /tmp/m.rbc \
