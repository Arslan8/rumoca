...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:441:acda6573` |
...
```
predicate     vehicleRoll.mass.m > 0
premise       refuted
...
$ python3 tools/sweep/check_one.py ModelicaTest.Translational.Vehicles \
      --target vehicleRoll.mass.m --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "vehicleRoll.mass.m"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param vehicleRoll.mass.m=0
```
