# DECL-0146: `Lrsigmaq` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Electrical/Machines/BasicMachines/SynchronousMachines/SM_PermanentMagnet.mo:65` |
| **Parameter** | `Lrsigmaq` |
| **Type** | `SI.Inductance` |
| **Declared modifiers** | `—` |
...
```console
$ grep -n -- "-1e40\|-1E40" "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Machines/BasicMachines/SynchronousMachines/SM_PermanentMagnet.mo" | head
```
...
```modelica
// Electrical/Machines/BasicMachines/SynchronousMachines/SM_PermanentMagnet.mo:65
