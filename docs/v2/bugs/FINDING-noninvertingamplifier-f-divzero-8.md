# FINDING-00978: `f` in `NonInvertingAmplifier`
...
| **Severity** | high |
| **Declaration** | `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Analog/Examples/OpAmps/NonInvertingAmplifier.mo:13` |
| **Signature** | `divisor:divisor-reachable-zero:exp:75:3794b9b8` |
...
```console
$ sed -n '13p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Analog/Examples/OpAmps/NonInvertingAmplifier.mo"
```
...
```console
$ grep -rl '| `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Analog/Examples/OpAmps/NonInvertingAmplifier.mo:13` |' docs/v2/bugs/
```
