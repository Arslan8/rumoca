# FINDING-04590: `inertia1.rotorWith3DEffects.nJ` in `BevelGear1D`
...
| **Reached as** | `inertia1.rotorWith3DEffects.nJ` |
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:286:93ed00e6` |
...
```
predicate     inertia1.rotorWith3DEffects.nJ > 0
premise       refuted
...
| `required` | inertia1.rotorWith3DEffects.nJ &gt; 0 |
| `declared_min` | None |
...
$ python3 tools/sweep/check_one.py Modelica.Mechanics.MultiBody.Examples.Rotational3DEffects.BevelGear1D \
      --target inertia1.rotorWith3DEffects.nJ --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "inertia1.rotorWith3DEffects.nJ"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param inertia1.rotorWith3DEffects.nJ=0
```
