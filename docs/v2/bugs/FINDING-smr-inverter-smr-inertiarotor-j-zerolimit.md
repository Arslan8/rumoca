# FINDING-02945: `smr.inertiaRotor.J` in `SMR_Inverter`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:333:c160ec0d` |
...
```
predicate     smr.inertiaRotor.J > 0
premise       refuted
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.SynchronousMachines.SMR_Inverter \
      --target smr.inertiaRotor.J --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "smr.inertiaRotor.J"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param smr.inertiaRotor.J=0
```
