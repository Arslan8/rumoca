...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:69:75666de2` |
...
$ python3 tools/sweep/check_one.py Modelica.Mechanics.Translational.Examples.PreLoad \
      --target springPlateB.m --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "springPlateB.m"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param springPlateB.m=0
```
