# FINDING-02899: `smr.damperCage.Rrq` in `SMR_DOL`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:412:dfd0e310` |
...
```
predicate     smr.damperCage.Rrq >= 0
premise       refuted
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.SynchronousMachines.SMR_DOL \
      --target smr.damperCage.Rrq --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "smr.damperCage.Rrq"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param smr.damperCage.Rrq=0
```
