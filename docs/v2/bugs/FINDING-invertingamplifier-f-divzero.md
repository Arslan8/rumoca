# FINDING-00899: `f` in `InvertingAmplifier`
...
| **Severity** | high |
| **Declaration** | `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Analog/Examples/OpAmps/InvertingAmplifier.mo:10` |
| **Signature** | `divisor:divisor-reachable-zero:exp:12:ab09b0cd` |
...
```console
$ sed -n '10p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Analog/Examples/OpAmps/InvertingAmplifier.mo"
```
...
```console
$ grep -rl '| `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Analog/Examples/OpAmps/InvertingAmplifier.mo:10` |' docs/v2/bugs/
```
