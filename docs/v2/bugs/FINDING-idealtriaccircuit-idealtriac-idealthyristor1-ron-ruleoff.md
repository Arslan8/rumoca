...
| **Signature** | `physical:physical-rule-does-not-apply:var:63:87e03e5e` |
...
```
predicate     idealTriac.idealThyristor1.Ron > 0
premise       refuted
...
| `required` | idealTriac.idealThyristor1.Ron &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.IdealTriacCircuit \
      --target idealTriac.idealThyristor1.Ron --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "idealTriac.idealThyristor1.Ron"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param idealTriac.idealThyristor1.Ron=0
```
