# FINDING-03176: `transformer2.l1sigma.L` in `Rectifier12pulse`
...
| **Reached as** | `transformer2.l1sigma.L` |
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:1082:7552f003` |
...
```
predicate     transformer2.l1sigma.L > 0
premise       refuted
...
| `required` | transformer2.l1sigma.L &gt; 0 |
| `declared_min` | None |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.Transformers.Rectifier12pulse \
      --target transformer2.l1sigma.L --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "transformer2.l1sigma.L"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param transformer2.l1sigma.L=0
```
