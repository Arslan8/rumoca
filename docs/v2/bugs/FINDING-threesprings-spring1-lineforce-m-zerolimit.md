...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:401:8eafac62` |
...
```
predicate     spring1.lineForce.m > 0
premise       refuted
...
| `required` | spring1.lineForce.m &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Mechanics.MultiBody.Examples.Elementary.ThreeSprings \
      --target spring1.lineForce.m --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "spring1.lineForce.m"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param spring1.lineForce.m=0
```
