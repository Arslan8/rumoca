...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:294:0fff8347` |
...
```
predicate     vehicleDragInVar.inertia.J > 0
premise       refuted
...
| `required` | vehicleDragInVar.inertia.J &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py ModelicaTest.Translational.Vehicles \
      --target vehicleDragInVar.inertia.J --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "vehicleDragInVar.inertia.J"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param vehicleDragInVar.inertia.J=0
```
