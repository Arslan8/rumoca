...
| **Declaration** | `Electrical/Machines/Interfaces/PartialBasicInductionMachine.mo:23` |
| **Parameter** | `Lssigma` |
| **Type** | `SI.Inductance` |
...
```console
$ grep -n -- "-1e40\|-1E40" "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Machines/Interfaces/PartialBasicInductionMachine.mo" | head
```
...
```modelica
// Electrical/Machines/Interfaces/PartialBasicInductionMachine.mo:23
