...
| **Signature** | `divisor:divisor-zero-unresolved:exp:377:dc9e2dc0` |
...
path condition         not ((zDiode.v > (zDiode.Maxexp * zDiode.Vt))) and not (((zDiode.v + zDiode.Bv) < -(zDiode.Maxexp * (zDiode.Nbv * zDiode.Vt))))
...
| `path_condition` | not ((zDiode.v &gt; (zDiode.Maxexp * zDiode.Vt))) and not (((zDiode.v + zDiode.Bv) &lt; -(zDiode.Maxexp * (zDiode.Nbv * zDiode.Vt)))) |
| `verdict` | UNKNOWN |
