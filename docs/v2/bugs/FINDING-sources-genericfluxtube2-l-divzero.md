...
| **Signature** | `divisor:divisor-reachable-zero:exp:491:60d7173a` |
...
```
denominator            genericFluxTube2.l
witness                genericFluxTube2.l = 0
  found by             set to zero
denominator at witness 0.0
at declared values     0.01
path condition         always evaluated
constraints consulted  genericFluxTube2.l: unbounded
```
...
| `constraints` | genericFluxTube2.l: unbounded |
...
$ python3 tools/sweep/check_one.py ModelicaTest.Magnetic.FluxTubes.Sources \
      --target genericFluxTube2.l --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "genericFluxTube2.l"
```
