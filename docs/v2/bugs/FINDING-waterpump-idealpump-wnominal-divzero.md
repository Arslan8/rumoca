# FINDING-05117: `idealPump.wNominal` in `WaterPump`
...
| **Severity** | high |
| **Declaration** | `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Thermal/FluidHeatFlow/Sources/IdealPump.mo:23` |
| **Signature** | `divisor:divisor-reachable-zero:exp:737:7537ea30` |
...
```console
$ sed -n '23p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Thermal/FluidHeatFlow/Sources/IdealPump.mo"
```
...
```console
$ grep -rl '| `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Thermal/FluidHeatFlow/Sources/IdealPump.mo:23` |' docs/v2/bugs/
```
