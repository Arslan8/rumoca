# FINDING-00828: `firstOrder1A.R2` in `ControlCircuit`
...
| **Signature** | `divisor:divisor-reachable-zero:exp:339:1c94a062` |
...
| `constraints` | firstOrder1A.R2: unbounded |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.OpAmps.ControlCircuit \
      --target firstOrder1A.R2 --sanitizer divisor
```
