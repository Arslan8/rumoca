...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:1193:bb7b09ed` |
...
$ python3 tools/sweep/check_one.py Modelica.Mechanics.MultiBody.Examples.Systems.RobotR3.Utilities.MechanicalStructure \
      --target b6.body.m --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "b6.body.m"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param b6.body.m=0
```
