...
| **Signature** | `divisor:divisor-reachable-zero:exp:704:8b30c6e6` |
...
| `constraints` | firstOrder4.T: unbounded |
...
$ python3 tools/sweep/check_one.py ModelicaTest.Blocks.LimitersHomotopy \
      --target firstOrder4.T --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "firstOrder4.T"
```
