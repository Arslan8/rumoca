# FINDING-03627: `rectifier.diode_p2.Goff` in `DiodeBridge2Pulse`
...
| **Reached as** | `rectifier.diode_p2.Goff` |
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:62:d8afe6c1` |
...
```
predicate     rectifier.diode_p2.Goff > 0
premise       refuted
...
| `required` | rectifier.diode_p2.Goff &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.PowerConverters.Examples.ACDC.RectifierBridge2Pulse.DiodeBridge2Pulse \
      --target rectifier.diode_p2.Goff --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "rectifier.diode_p2.Goff"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param rectifier.diode_p2.Goff=0
```
