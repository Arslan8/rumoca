# FINDING-01002: `R1` in `FirstOrder`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:37:f8568ef7` |
...
```
contract    Modelica.Electrical.Analog.Basic.Resistor.R: feature_disabled (proven, from equation) — inherited from r1.R, which it binds: the parameter appears only as a multiplier, so at zero the term it scales drops out and the rest of the model is unaffected
