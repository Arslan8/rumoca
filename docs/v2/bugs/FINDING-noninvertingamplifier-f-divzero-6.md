# FINDING-00976: `f` in `NonInvertingAmplifier`
...
| **Severity** | high |
| **Declaration** | `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Analog/Examples/OpAmps/NonInvertingAmplifier.mo:11` |
| **Signature** | `divisor:divisor-reachable-zero:exp:65:70a86949` |
...
```console
$ sed -n '11p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Analog/Examples/OpAmps/NonInvertingAmplifier.mo"
```
...
```console
$ grep -rl '| `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Analog/Examples/OpAmps/NonInvertingAmplifier.mo:11` |' docs/v2/bugs/
```
