# DECL-0129: `Lrsigmaq` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Electrical/Machines/BasicMachines/Components/DamperCage.mo:5` |
| **Parameter** | `Lrsigmaq` |
| **Type** | `SI.Inductance` |
| **Declared modifiers** | `—` |
...
```modelica
// Electrical/Machines/BasicMachines/Components/DamperCage.mo:5
