# DECL-0247: `Lszero` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Magnetic/FundamentalWave/BaseClasses/Machine.mo:39` |
| **Parameter** | `Lszero` |
| **Type** | `SI.Inductance` |
| **Declared modifiers** | `—` |
...
```console
$ sed -n '39p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/FundamentalWave/BaseClasses/Machine.mo"
```
...
```modelica
// Magnetic/FundamentalWave/BaseClasses/Machine.mo:39
