# FINDING-02445: `smee.inertiaStator.J` in `SMEE_Generator`
...
| **Reached as** | `smee.inertiaStator.J` |
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:361:3c87095f` |
...
```
predicate     smee.inertiaStator.J > 0
premise       refuted
...
| `required` | smee.inertiaStator.J &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.SynchronousMachines.SMEE_Generator \
      --target smee.inertiaStator.J --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "smee.inertiaStator.J"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param smee.inertiaStator.J=0
```
