# FINDING-04688: `mass3.m` in `CompareBrakingForce`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:49:4d0a8d18` |
...
$ python3 tools/sweep/check_one.py Modelica.Mechanics.Translational.Examples.CompareBrakingForce \
      --target mass3.m --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "mass3.m"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param mass3.m=0
```
