...
| **Signature** | `divisor:divisor-reachable-zero:exp:1098:60f63163` |
...
constraints consulted  T1.Phic: unbounded
```
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.HeatingPNP_NORGate \
      --target T1.Phic --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "T1.Phic"
```
