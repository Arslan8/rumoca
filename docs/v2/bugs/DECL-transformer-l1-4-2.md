# DECL-0186: `L1` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Electrical/Polyphase/Basic/Transformer.mo:4` |
| **Parameter** | `L1` |
| **Type** | `SI.Inductance` |
...
```console
$ sed -n '4p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Polyphase/Basic/Transformer.mo"
```
...
```console
$ grep -n -- "-1e40\|-1E40" "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Polyphase/Basic/Transformer.mo" | head
```
...
```modelica
// Electrical/Polyphase/Basic/Transformer.mo:4
