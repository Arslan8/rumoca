# FINDING-04979: `ambient2.medium.rho` in `PumpDropOut`
...
```console
$ python3 tools/sweep/check_one.py Modelica.Thermal.FluidHeatFlow.Examples.PumpDropOut \
...
```console
$ python3 tools/sweep/check_one.py Modelica.Thermal.FluidHeatFlow.Examples.PumpDropOut --keep-artifact /tmp/m.rbc \
