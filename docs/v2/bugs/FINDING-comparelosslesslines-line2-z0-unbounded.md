# FINDING-00553: `line2.Z0` in `CompareLosslessLines`
...
| **Signature** | `physical:physical-domain-unenforced:var:87:69a2d966` |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.Lines.CompareLosslessLines \
      --target line2.Z0 --sanitizer physical
```
