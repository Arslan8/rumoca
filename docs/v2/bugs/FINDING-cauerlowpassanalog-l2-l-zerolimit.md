# FINDING-00097: `L2.L` in `CauerLowPassAnalog`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:57:f22f66de` |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.CauerLowPassAnalog \
      --target L2.L --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "L2.L"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param L2.L=0
```
