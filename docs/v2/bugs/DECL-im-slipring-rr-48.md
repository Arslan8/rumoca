...
| **Declaration** | `Magnetic/FundamentalWave/BasicMachines/InductionMachines/IM_SlipRing.mo:48` |
| **Parameter** | `Rr` |
| **Type** | `SI.Resistance` |
...
```console
$ sed -n '48p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/FundamentalWave/BasicMachines/InductionMachines/IM_SlipRing.mo"
```
...
```modelica
// Magnetic/FundamentalWave/BasicMachines/InductionMachines/IM_SlipRing.mo:48
