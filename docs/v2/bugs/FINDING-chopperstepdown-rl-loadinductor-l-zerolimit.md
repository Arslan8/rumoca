# FINDING-04026: `loadInductor.L` in `ChopperStepDown_RL`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:191:d4df1d85` |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.PowerConverters.Examples.DCDC.ChopperStepDown.ChopperStepDown_RL \
      --target loadInductor.L --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "loadInductor.L"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param loadInductor.L=0
```
