# FINDING-00387: `V2.signalSource.rising` in `HeatingPNP_NORGate`
...
| **Signature** | `divisor:divisor-zero-unresolved:exp:728:7dce4a5d` |
...
```
denominator            V2.signalSource.rising
witness                V2.signalSource.rising = 0
  found by             set to zero
denominator at witness 0.0
at declared values     5.0
path condition         not ((((time < V2.signalSource.startTime) or (V2.signalSource.nperiod == 0)) or ((V2.signalSource.nperiod > 0) and (V2.signalSource.count >= V2.signalSource.nperiod)))) and ((time < (V2.signalSource.T_start + V2.signalSource.T_rising)))
constraints consulted  V2.signalSource.rising: min=0
```
...
| `path_condition` | not ((((time &lt; V2.signalSource.startTime) or (V2.signalSource.nperiod == 0)) or ((V2.signalSource.nperiod &gt; 0) and (V2.signalSource.count &gt;= V2.signalSource.nperiod)))) and ((time &lt; (V2.signalSource.T_start + V2.signalSource.T_rising))) |
| `verdict` | UNKNOWN |
| `proof` | the path depends on quantities the artifact does not determine: (time &lt; (V2.signalSource.T_start + V2.signalSource.T_rising)); (time &lt; V2.signalSource.startTime) |
| `constraints` | V2.signalSource.rising: min=0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.HeatingPNP_NORGate \
      --target V2.signalSource.rising --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "V2.signalSource.rising"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check \
      --param V2.signalSource.rising=0
```
