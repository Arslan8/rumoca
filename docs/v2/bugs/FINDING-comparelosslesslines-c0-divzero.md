# FINDING-00561: `c0` in `CompareLosslessLines`
...
| **Severity** | high |
| **Declaration** | `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Analog/Examples/Lines/CompareLosslessLines.mo:11` |
| **Signature** | `divisor:divisor-reachable-zero:exp:22:aa339e35` |
...
at declared values     200000000.0
...
| `denominator_at_declared_values` | 200000000.0 |
...
```console
$ sed -n '11p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Analog/Examples/Lines/CompareLosslessLines.mo"
```
...
```console
$ grep -rl '| `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Analog/Examples/Lines/CompareLosslessLines.mo:11` |' docs/v2/bugs/
```
