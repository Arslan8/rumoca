# DECL-0164: `Lm` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Electrical/Machines/Utilities/ParameterRecords/IM_SquirrelCageData.mo:6` |
| **Parameter** | `Lm` |
| **Type** | `SI.Inductance` |
| **Declared modifiers** | `—` |
...
```modelica
// Electrical/Machines/Utilities/ParameterRecords/IM_SquirrelCageData.mo:6
