# FINDING-00803: `PIA.c.C` in `ControlCircuit`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:193:6e0cdbf9` |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.OpAmps.ControlCircuit \
      --target PIA.c.C --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "PIA.c.C"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param PIA.c.C=0
```
