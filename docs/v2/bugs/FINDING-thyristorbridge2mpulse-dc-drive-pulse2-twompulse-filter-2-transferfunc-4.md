# FINDING-03502: `pulse2.twomPulse.filter[2].transferFunction[2].a_end` in `ThyristorBridge2mPulse_DC_Drive`
...
| **Signature** | `divisor:divisor-reachable-zero:exp:4257:83d15a4b` |
