...
| **Declaration** | `Magnetic/FluxTubes/Examples/Utilities/CoilDesign.mo:12` |
| **Parameter** | `rho` |
| **Type** | `SI.Resistivity` |
| **Declared modifiers** | `—` |
...
```console
$ sed -n '12p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/FluxTubes/Examples/Utilities/CoilDesign.mo"
```

It should declare `rho` with type `SI.Resistivity` and no `min`.
...
```modelica
// Magnetic/FluxTubes/Examples/Utilities/CoilDesign.mo:12
parameter SI.Resistivity rho(min=0) = ...;
```
