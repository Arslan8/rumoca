# FINDING-01226: `L` in `InverseInductor`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:0:e79399fe` |
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.Utilities.InverseInductor \
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.Utilities.InverseInductor --keep-artifact /tmp/m.rbc \
