# FINDING-04297: `material.B_myMax` in `AdvancedSolenoid`
...
| **Signature** | `divisor:divisor-reachable-zero:exp:1002:301e7863` |
...
```
denominator            material.B_myMax
witness                material.B_myMax = 0
  found by             set to zero
denominator at witness 0.0
at declared values     1.488
path condition         always evaluated
constraints consulted  material.B_myMax: unbounded
```
...
$ python3 tools/sweep/check_one.py Modelica.Magnetic.FluxTubes.Examples.SolenoidActuator.Components.AdvancedSolenoid \
      --target material.B_myMax --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "material.B_myMax"
```
