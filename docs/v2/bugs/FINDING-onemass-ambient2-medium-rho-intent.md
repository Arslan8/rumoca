# FINDING-04821: `ambient2.medium.rho` in `OneMass`
...
| **Signature** | `physical:physical-intent-question:var:128:36320502` |
...
```console
$ python3 tools/sweep/check_one.py Modelica.Thermal.FluidHeatFlow.Examples.OneMass \
...
```console
$ python3 tools/sweep/check_one.py Modelica.Thermal.FluidHeatFlow.Examples.OneMass --keep-artifact /tmp/m.rbc \
