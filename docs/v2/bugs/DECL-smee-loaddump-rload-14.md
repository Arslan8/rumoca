# DECL-0701: `RLoad` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Electrical/Machines/Examples/SynchronousMachines/SMEE_LoadDump.mo:14` |
| **Parameter** | `RLoad` |
| **Type** | `SI.Resistance` |
| **Declared modifiers** | `—` |
...
```console
$ sed -n '14p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Machines/Examples/SynchronousMachines/SMEE_LoadDump.mo"
```
...
```modelica
// Electrical/Machines/Examples/SynchronousMachines/SMEE_LoadDump.mo:14
