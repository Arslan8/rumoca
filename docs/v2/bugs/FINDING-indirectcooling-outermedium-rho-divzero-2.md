# FINDING-04801: `outerMedium.rho` in `IndirectCooling`
...
| **Signature** | `divisor:divisor-reachable-zero:exp:1165:68e619e8` |
...
| `constraints` | outerMedium.rho: min=0 |
...
$ python3 tools/sweep/check_one.py Modelica.Thermal.FluidHeatFlow.Examples.IndirectCooling \
      --target outerMedium.rho --sanitizer divisor
```
