...
| **Signature** | `divisor:divisor-reachable-zero:exp:531:773716e5` |
...
| `constraints` | firstOrder2.T: unbounded |
...
$ python3 tools/sweep/check_one.py ModelicaTest.Blocks.LimitersHomotopy \
      --target firstOrder2.T --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "firstOrder2.T"
```
