# FINDING-05128: `pipe.medium.rho` in `WaterPump`
...
| **Signature** | `divisor:divisor-reachable-zero:exp:1002:7f055be4` |
...
| `constraints` | pipe.medium.rho: min=0 |
...
$ python3 tools/sweep/check_one.py Modelica.Thermal.FluidHeatFlow.Examples.WaterPump \
      --target pipe.medium.rho --sanitizer divisor
```
