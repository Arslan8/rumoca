...
| **Declaration** | `Mechanics/MultiBody/package.mo:93` |
| **Parameter** | `groundLength_u` |
| **Type** | `SI.Length` |
| **Declared modifiers** | `—` |
...
```console
$ sed -n '93p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Mechanics/MultiBody/package.mo"
```

It should declare `groundLength_u` with type `SI.Length` and no `min`.
...
```modelica
// Mechanics/MultiBody/package.mo:93
parameter SI.Length groundLength_u(min=0) = ...;
```
