# FINDING-01193: `switch1.Ron` in `SwitchWithArc`
...
| **Signature** | `physical:physical-rule-does-not-apply:var:36:e1db4f53` |
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.SwitchWithArc \
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.SwitchWithArc --keep-artifact /tmp/m.rbc \
