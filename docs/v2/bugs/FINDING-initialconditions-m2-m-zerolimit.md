# FINDING-04725: `m2.m` in `InitialConditions`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:85:fee4ca4d` |
...
$ python3 tools/sweep/check_one.py Modelica.Mechanics.Translational.Examples.InitialConditions \
      --target m2.m --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "m2.m"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param m2.m=0
```
