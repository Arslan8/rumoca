# FINDING-00381: `T2.Cjc` in `HeatingPNP_NORGate`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:241:5f7dda76` |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.HeatingPNP_NORGate \
      --target T2.Cjc --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "T2.Cjc"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param T2.Cjc=0
```
