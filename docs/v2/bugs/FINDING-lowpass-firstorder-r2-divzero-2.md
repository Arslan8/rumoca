# FINDING-00945: `firstOrder.R2` in `LowPass`
...
| **Signature** | `divisor:divisor-reachable-zero:exp:78:aac0177b` |
...
| `constraints` | firstOrder.R2: unbounded |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.OpAmps.LowPass \
      --target firstOrder.R2 --sanitizer divisor
```
