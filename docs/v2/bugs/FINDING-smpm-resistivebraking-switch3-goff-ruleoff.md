# FINDING-02791: `switch3.Goff` in `SMPM_ResistiveBraking`
...
| **Signature** | `physical:physical-rule-does-not-apply:var:941:28b8660c` |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.SynchronousMachines.SMPM_ResistiveBraking \
      --target switch3.Goff --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "switch3.Goff"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param switch3.Goff=0
```
