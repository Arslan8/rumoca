# DECL-0408: `length` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Fluid/Pipes.mo:228` |
| **Parameter** | `length` |
| **Type** | `SI.Length` |
| **Declared modifiers** | `—` |
...
```console
$ sed -n '228p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Fluid/Pipes.mo"
```
