# FINDING-04183: `rightLeg.l` in `QuadraticCoreAirgap`
...
| **Signature** | `divisor:divisor-reachable-zero:exp:563:16512de9` |
...
```
denominator            rightLeg.l
witness                rightLeg.l = 0
  found by             set to zero
denominator at witness 0.0
at declared values     0.08900000000000001
path condition         always evaluated
constraints consulted  rightLeg.l: unbounded
```
...
$ python3 tools/sweep/check_one.py Modelica.Magnetic.FluxTubes.Examples.BasicExamples.QuadraticCoreAirgap \
      --target rightLeg.l --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "rightLeg.l"
```
