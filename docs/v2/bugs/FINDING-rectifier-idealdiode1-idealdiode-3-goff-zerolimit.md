...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:195:7a63dced` |
...
```
predicate     idealDiode1.idealDiode[3].Goff > 0
premise       refuted
...
| `required` | idealDiode1.idealDiode[3].Goff &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Polyphase.Examples.Rectifier \
      --target idealDiode1.idealDiode[3].Goff --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "idealDiode1.idealDiode[3].Goff"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param idealDiode1.idealDiode[3].Goff=0
```
