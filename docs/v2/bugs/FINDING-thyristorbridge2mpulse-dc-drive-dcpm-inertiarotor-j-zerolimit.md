# FINDING-03476: `dcpm.inertiaRotor.J` in `ThyristorBridge2mPulse_DC_Drive`
...
| **Reached as** | `dcpm.inertiaRotor.J` |
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:894:e70ac1e6` |
...
```
predicate     dcpm.inertiaRotor.J > 0
premise       refuted
...
| `required` | dcpm.inertiaRotor.J &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.PowerConverters.Examples.ACDC.RectifierBridge2mPulse.ThyristorBridge2mPulse_DC_Drive \
      --target dcpm.inertiaRotor.J --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "dcpm.inertiaRotor.J"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param dcpm.inertiaRotor.J=0
```
