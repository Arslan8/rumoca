# FINDING-05213: `JLoad` in `SMPM_VoltageSourceWithLosses`
...
| **Severity** | low |
| **Declaration** | `target/corpus/ModelicaStandardLibrary-4.1.0/ModelicaTest/Electrical/Machines.mo:14` |
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:4:1954d2a6` |
...
```
{'quantity': 'MomentOfInertia', 'unit': 'kg.m2', 'confidence': 'QUANTITY_AND_UNIT', 'premise_state': 'unknown', 'authority': 'quantity_or_unit', 'canonical_declaration': 'ModelicaTest.Electrical.Machines.SMPM_VoltageSourceWithLosses.JLoad'}
```
...
```console
$ sed -n '14p' "target/corpus/ModelicaStandardLibrary-4.1.0/ModelicaTest/Electrical/Machines.mo"
```
...
```console
$ grep -rl '| `target/corpus/ModelicaStandardLibrary-4.1.0/ModelicaTest/Electrical/Machines.mo:14` |' docs/v2/bugs/
```
