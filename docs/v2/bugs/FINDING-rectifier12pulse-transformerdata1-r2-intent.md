# FINDING-03142: `transformerData1.R2` in `Rectifier12pulse`
...
| **Reached as** | `transformerData1.R2` |
...
| **Signature** | `physical:physical-intent-question:var:340:c6798a81` |
...
```
predicate     transformerData1.R2 > 0
premise       unknown
...
| `required` | transformerData1.R2 &gt; 0 |
| `declared_min` | None |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.Transformers.Rectifier12pulse \
      --target transformerData1.R2 --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "transformerData1.R2"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param transformerData1.R2=0
```
