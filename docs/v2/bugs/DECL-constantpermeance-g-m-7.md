# DECL-0590: `G_m` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Magnetic/QuasiStatic/FluxTubes/Basic/ConstantPermeance.mo:7` |
| **Parameter** | `G_m` |
| **Type** | `SI.Permeance` |
| **Declared modifiers** | `—` |
...
```console
$ sed -n '7p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/QuasiStatic/FluxTubes/Basic/ConstantPermeance.mo"
```
...
```console
$ grep -n -- "-1e40\|-1E40" "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/QuasiStatic/FluxTubes/Basic/ConstantPermeance.mo" | head
```
...
```modelica
// Magnetic/QuasiStatic/FluxTubes/Basic/ConstantPermeance.mo:7
