...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:31:ae496b3c` |
...
$ python3 tools/sweep/check_one.py Modelica.Mechanics.Translational.Examples.PreLoad \
      --target innerContactB.c --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "innerContactB.c"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param innerContactB.c=0
```
