...
| **Signature** | `physical:physical-rule-does-not-apply:var:404:b110b1a5` |
...
```
predicate     R9.IdealCommutingSwitch2.Goff > 0
premise       refuted
...
| `required` | R9.IdealCommutingSwitch2.Goff &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.CauerLowPassSC \
      --target R9.IdealCommutingSwitch2.Goff --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "R9.IdealCommutingSwitch2.Goff"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param R9.IdealCommutingSwitch2.Goff=0
```
