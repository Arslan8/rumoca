# FINDING-05450: `vehicleInclinationInVar.mass.m` in `Vehicles`

|  |  |
|---|---|
| **Tier** | **Candidate** — static only, not execution-confirmed |
| **Model** | `ModelicaTest.Translational.Vehicles` |
| **Reached as** | `vehicleInclinationInVar.mass.m` |
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:1031:f7787f26` |
...
```
predicate     vehicleInclinationInVar.mass.m > 0
premise       refuted
...
| `required` | vehicleInclinationInVar.mass.m &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py ModelicaTest.Translational.Vehicles \
      --target vehicleInclinationInVar.mass.m --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "vehicleInclinationInVar.mass.m"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param vehicleInclinationInVar.mass.m=0
```
