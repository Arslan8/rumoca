# FINDING-02169: `switchYDwithArc.idealOpener.openerWithArc[3].Ron` in `IMC_YDarc`
...
| **Reached as** | `switchYDwithArc.idealOpener.openerWithArc[3].Ron` |
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:845:ee8f2bb7` |
...
```
predicate     switchYDwithArc.idealOpener.openerWithArc[3].Ron > 0
premise       refuted
...
| `required` | switchYDwithArc.idealOpener.openerWithArc[3].Ron &gt; 0 |
| `declared_min` | None |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.InductionMachines.IMC_YDarc \
      --target switchYDwithArc.idealOpener.openerWithArc[3].Ron --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "switchYDwithArc.idealOpener.openerWithArc[3].Ron"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param switchYDwithArc.idealOpener.openerWithArc[3].Ron=0
```
