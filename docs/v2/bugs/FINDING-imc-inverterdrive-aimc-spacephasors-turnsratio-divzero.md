# FINDING-01929: `aimc.spacePhasorS.turnsRatio` in `IMC_InverterDrive`
...
| **Reached as** | `aimc.spacePhasorS.turnsRatio` |
...
| **Signature** | `divisor:divisor-reachable-zero:exp:7643:fff1d623` |
...
```
denominator            aimc.spacePhasorS.turnsRatio
witness                aimc.spacePhasorS.turnsRatio = 0
  found by             set to zero
denominator at witness 0.0
at declared values     1.0
path condition         always evaluated
constraints consulted  aimc.spacePhasorS.turnsRatio: unbounded
```
...
| `constraints` | aimc.spacePhasorS.turnsRatio: unbounded |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.InductionMachines.IMC_InverterDrive \
      --target aimc.spacePhasorS.turnsRatio --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "aimc.spacePhasorS.turnsRatio"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check \
      --param aimc.spacePhasorS.turnsRatio=0
```
