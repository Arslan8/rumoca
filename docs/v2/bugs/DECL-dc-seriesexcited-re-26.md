# DECL-0681: `Re` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Electrical/Machines/BasicMachines/DCMachines/DC_SeriesExcited.mo:26` |
| **Parameter** | `Re` |
| **Type** | `SI.Resistance` |
...
```modelica
// Electrical/Machines/BasicMachines/DCMachines/DC_SeriesExcited.mo:26
