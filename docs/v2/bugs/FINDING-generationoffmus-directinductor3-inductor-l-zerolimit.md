...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:245:c532e590` |
...
```
predicate     directInductor3.inductor.L > 0
premise       refuted
...
| `required` | directInductor3.inductor.L &gt; 0 |
| `declared_min` | None |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.GenerationOfFMUs \
      --target directInductor3.inductor.L --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "directInductor3.inductor.L"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param directInductor3.inductor.L=0
```
