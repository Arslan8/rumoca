...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:122:60c6cf4c` |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.Rectifier \
      --target IdealDiode3.Goff --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "IdealDiode3.Goff"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param IdealDiode3.Goff=0
```
