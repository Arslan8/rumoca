# FINDING-01704: `ramp.duration` in `DCSE_Start`
...
| **Signature** | `divisor:divisor-unreachable-under-witness:exp:1457:1b56009c` |
...
| `denominator_at_declared_values` | 0.9 |
