# DECL-0261: `Lsigma` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Magnetic/FundamentalWave/Components/PolyphaseElectroMagneticConverter.mo:45` |
| **Parameter** | `Lsigma` |
| **Type** | `SI.Inductance` |
| **Declared modifiers** | `—` |
...
```console
$ sed -n '45p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/FundamentalWave/Components/PolyphaseElectroMagneticConverter.mo"
```
...
```console
$ grep -n -- "-1e40\|-1E40" "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/FundamentalWave/Components/PolyphaseElectroMagneticConverter.mo" | head
```
...
```modelica
// Magnetic/FundamentalWave/Components/PolyphaseElectroMagneticConverter.mo:45
