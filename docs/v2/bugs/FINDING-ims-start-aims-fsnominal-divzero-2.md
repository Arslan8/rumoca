# FINDING-02320: `aims.fsNominal` in `IMS_Start`
...
| **Signature** | `divisor:divisor-reachable-zero:exp:2935:2953ad82` |
...
| `constraints` | aims.fsNominal: unbounded |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.InductionMachines.IMS_Start \
      --target aims.fsNominal --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "aims.fsNominal"
```
