# FINDING-03797: `rectifier.thyristor_p.idealThyristor[3].Ron` in `ThyristorCenterTap2mPulse_RLV_Characteristic`
...
| **Reached as** | `rectifier.thyristor_p.idealThyristor[3].Ron` |
...
| **Signature** | `physical:physical-rule-does-not-apply:var:216:ff3be2d5` |
...
```
predicate     rectifier.thyristor_p.idealThyristor[3].Ron > 0
premise       refuted
...
| `required` | rectifier.thyristor_p.idealThyristor[3].Ron &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.PowerConverters.Examples.ACDC.RectifierCenterTap2mPulse.ThyristorCenterTap2mPulse_RLV_Characteristic \
      --target rectifier.thyristor_p.idealThyristor[3].Ron --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "rectifier.thyristor_p.idealThyristor[3].Ron"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param rectifier.thyristor_p.idealThyristor[3].Ron=0
```
