# FINDING-04547: `body.m` in `UserDefinedGravityField`

|  |  |
|---|---|
| **Tier** | **Candidate** — static only, not execution-confirmed |
| **Model** | `Modelica.Mechanics.MultiBody.Examples.Elementary.UserDefinedGravityField` |
| **Reached as** | `body.m` |
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:284:82fb6555` |
...
```console
$ python3 tools/sweep/check_one.py Modelica.Mechanics.MultiBody.Examples.Elementary.UserDefinedGravityField \
...
```console
$ python3 tools/sweep/check_one.py Modelica.Mechanics.MultiBody.Examples.Elementary.UserDefinedGravityField --keep-artifact /tmp/m.rbc \
