# FINDING-00750: `tLine.Z0` in `SmoothStep`
...
| **Signature** | `divisor:divisor-guarded-by-assertion:exp:13874:7052177a` |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.Lines.SmoothStep \
      --target tLine.Z0 --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "tLine.Z0"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param tLine.Z0=0
```
