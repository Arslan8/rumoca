# FINDING-03625: `rectifier.diode_p1.Goff` in `DiodeBridge2Pulse`
...
| **Reached as** | `rectifier.diode_p1.Goff` |
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:45:6bcbeeae` |
...
```
predicate     rectifier.diode_p1.Goff > 0
premise       refuted
...
| `required` | rectifier.diode_p1.Goff &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.PowerConverters.Examples.ACDC.RectifierBridge2Pulse.DiodeBridge2Pulse \
      --target rectifier.diode_p1.Goff --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "rectifier.diode_p1.Goff"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param rectifier.diode_p1.Goff=0
```
