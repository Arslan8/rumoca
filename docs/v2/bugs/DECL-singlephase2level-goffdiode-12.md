...
| **Declaration** | `Electrical/PowerConverters/DCAC/SinglePhase2Level.mo:12` |
| **Parameter** | `GoffDiode` |
| **Type** | `SI.Conductance` |
| **Declared modifiers** | `—` |
...
It should declare `GoffDiode` with type `SI.Conductance` and no `min`.
...
```modelica
// Electrical/PowerConverters/DCAC/SinglePhase2Level.mo:12
parameter SI.Conductance GoffDiode(min=0) = ...;
```
