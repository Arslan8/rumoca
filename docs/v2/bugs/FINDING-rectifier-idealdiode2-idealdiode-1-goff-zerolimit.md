...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:245:551d804f` |
...
```
predicate     idealDiode2.idealDiode[1].Goff > 0
premise       refuted
...
| `required` | idealDiode2.idealDiode[1].Goff &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Polyphase.Examples.Rectifier \
      --target idealDiode2.idealDiode[1].Goff --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "idealDiode2.idealDiode[1].Goff"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param idealDiode2.idealDiode[1].Goff=0
```
