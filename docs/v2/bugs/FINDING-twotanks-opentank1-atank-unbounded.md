# FINDING-05068: `openTank1.ATank` in `TwoTanks`
...
| **Signature** | `physical:physical-domain-unenforced:var:25:8ad7719b` |
...
$ python3 tools/sweep/check_one.py Modelica.Thermal.FluidHeatFlow.Examples.TwoTanks \
      --target openTank1.ATank --sanitizer physical
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param openTank1.ATank=0
```
