# FINDING-03157: `diode3.Goff` in `Rectifier12pulse`
...
| **Signature** | `physical:physical-rule-does-not-apply:var:800:f60c0cb5` |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.Transformers.Rectifier12pulse \
      --target diode3.Goff --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "diode3.Goff"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param diode3.Goff=0
```
