# FINDING-02049: `idealCloser.Ron` in `IMC_Transformer`
...
| **Signature** | `physical:physical-rule-does-not-apply:var:588:39d5dbff` |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.InductionMachines.IMC_Transformer \
      --target idealCloser.Ron --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "idealCloser.Ron"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param idealCloser.Ron=0
```
