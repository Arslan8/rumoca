...
| **Signature** | `divisor:divisor-reachable-zero:exp:845:ce69ca27` |
...
```
denominator            g_mFeYokeSide.l
witness                g_mFeYokeSide.l = 0
  found by             set to zero
denominator at witness 0.0
at declared values     0.0315
path condition         always evaluated
constraints consulted  g_mFeYokeSide.l: unbounded
```
...
$ python3 tools/sweep/check_one.py Modelica.Magnetic.FluxTubes.Examples.SolenoidActuator.Components.SimpleSolenoid \
      --target g_mFeYokeSide.l --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "g_mFeYokeSide.l"
```
