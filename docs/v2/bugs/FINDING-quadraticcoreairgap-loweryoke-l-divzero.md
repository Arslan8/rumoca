# FINDING-04189: `lowerYoke.l` in `QuadraticCoreAirgap`
...
| **Signature** | `divisor:divisor-reachable-zero:exp:779:f0a5781e` |
...
| `constraints` | lowerYoke.l: unbounded |
...
$ python3 tools/sweep/check_one.py Modelica.Magnetic.FluxTubes.Examples.BasicExamples.QuadraticCoreAirgap \
      --target lowerYoke.l --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "lowerYoke.l"
```
