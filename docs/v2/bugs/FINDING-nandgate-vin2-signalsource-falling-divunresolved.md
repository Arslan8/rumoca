...
| **Reached as** | `VIN2.signalSource.falling` |
...
| **Signature** | `divisor:divisor-zero-unresolved:exp:555:5afd4b93` |
...
```
denominator            VIN2.signalSource.falling
witness                VIN2.signalSource.falling = 0
  found by             set to zero
denominator at witness 0.0
at declared values     1e-09
path condition         not ((((time < VIN2.signalSource.startTime) or (VIN2.signalSource.nperiod == 0)) or ((VIN2.signalSource.nperiod > 0) and (VIN2.signalSource.count >= VIN2.signalSource.nperiod)))) and not ((time < (VIN2.signalSource.T_start + VIN2.signalSource.T_rising))) and not ((time < (VIN2.signalSource.T_start + VIN2.signalSource.T_width))) and ((time < (VIN2.signalSource.T_start + VIN2.signalSource.T_falling)))
constraints consulted  VIN2.signalSource.falling: min=0
```
...
| `path_condition` | not ((((time &lt; VIN2.signalSource.startTime) or (VIN2.signalSource.nperiod == 0)) or ((VIN2.signalSource.nperiod &gt; 0) and (VIN2.signalSource.count &gt;= VIN2.signalSource.nperiod)))) and not ((time &lt; (VIN2.signalSource.T_start + VIN2.signalSource.T_rising))) and not ((time &lt; (VIN2.signalSource.T_start + VIN2.signalSource.T_width))) and ((time &lt; (VIN2.signalSource.T_start + VIN2.signalSource.T_falling))) |
| `verdict` | UNKNOWN |
| `proof` | the path depends on quantities the artifact does not determine: (time &lt; (VIN2.signalSource.T_start + VIN2.signalSource.T_falling)); (time &lt; (VIN2.signalSource.T_start + VIN2.signalSource.T_rising)); (time &lt; (VIN2.signalSource.T_start + VIN2.signalSource.T_width)) |
| `constraints` | VIN2.signalSource.falling: min=0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.NandGate \
      --target VIN2.signalSource.falling --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "VIN2.signalSource.falling"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check \
      --param VIN2.signalSource.falling=0
```
