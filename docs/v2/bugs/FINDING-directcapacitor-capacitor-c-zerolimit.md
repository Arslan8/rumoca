# FINDING-01221: `capacitor.C` in `DirectCapacitor`
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.Utilities.DirectCapacitor \
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.Utilities.DirectCapacitor --keep-artifact /tmp/m.rbc \
