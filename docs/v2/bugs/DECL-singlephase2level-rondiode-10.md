...
| **Declaration** | `Electrical/PowerConverters/DCAC/SinglePhase2Level.mo:10` |
| **Parameter** | `RonDiode` |
| **Type** | `SI.Resistance` |
| **Declared modifiers** | `—` |
...
It should declare `RonDiode` with type `SI.Resistance` and no `min`.
...
```modelica
// Electrical/PowerConverters/DCAC/SinglePhase2Level.mo:10
parameter SI.Resistance RonDiode(min=0) = ...;
```
