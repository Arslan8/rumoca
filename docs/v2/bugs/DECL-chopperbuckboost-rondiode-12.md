# DECL-0751: `RonDiode` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Electrical/PowerConverters/DCDC/ChopperBuckBoost.mo:12` |
| **Parameter** | `RonDiode` |
| **Type** | `SI.Resistance` |
| **Declared modifiers** | `—` |
...
```modelica
// Electrical/PowerConverters/DCDC/ChopperBuckBoost.mo:12
