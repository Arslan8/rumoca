# DECL-0518: `r2b` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Mechanics/MultiBody/Examples/Loops/PlanarLoops_analytic.mo:15` |
| **Parameter** | `r2b` |
| **Type** | `SI.Length` |
| **Declared modifiers** | `—` |
...
```console
$ sed -n '15p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Mechanics/MultiBody/Examples/Loops/PlanarLoops_analytic.mo"
```

It should declare `r2b` with type `SI.Length` and no `min`.
...
```console
$ grep -n -- "-1e40\|-1E40" "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Mechanics/MultiBody/Examples/Loops/PlanarLoops_analytic.mo" | head
```
...
```modelica
// Mechanics/MultiBody/Examples/Loops/PlanarLoops_analytic.mo:15
parameter SI.Length r2b(min=0) = ...;
```
