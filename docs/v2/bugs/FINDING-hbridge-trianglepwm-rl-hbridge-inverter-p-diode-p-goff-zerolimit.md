# FINDING-04147: `hbridge.inverter_p.diode_p.Goff` in `HBridge_TrianglePWM_RL`
...
| **Reached as** | `hbridge.inverter_p.diode_p.Goff` |
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:106:d5726651` |
...
```
predicate     hbridge.inverter_p.diode_p.Goff > 0
premise       refuted
...
| `required` | hbridge.inverter_p.diode_p.Goff &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.PowerConverters.Examples.DCDC.HBridge.HBridge_TrianglePWM_RL \
      --target hbridge.inverter_p.diode_p.Goff --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "hbridge.inverter_p.diode_p.Goff"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param hbridge.inverter_p.diode_p.Goff=0
```
