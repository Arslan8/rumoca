# FINDING-05332: `eddyCurrent.A` in `BasicComponents`
...
| **Signature** | `divisor:divisor-reachable-zero:exp:128:69f8d221` |
...
| `constraints` | eddyCurrent.A: unbounded |
...
$ python3 tools/sweep/check_one.py ModelicaTest.Magnetic.FluxTubes.BasicComponents \
      --target eddyCurrent.A --sanitizer divisor
```
