...
| **Declaration** | `Magnetic/FluxTubes/Examples/BasicExamples/QuadraticCoreAirgap.mo:5` |
| **Parameter** | `a` |
| **Type** | `SI.Length` |
| **Declared modifiers** | `—` |
...
```console
$ sed -n '5p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/FluxTubes/Examples/BasicExamples/QuadraticCoreAirgap.mo"
```
...
```modelica
// Magnetic/FluxTubes/Examples/BasicExamples/QuadraticCoreAirgap.mo:5
