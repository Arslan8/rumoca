# FINDING-01823: `aimcData.Lrsigma` in `IMC_Initialize`
...
| **Signature** | `physical:physical-intent-question:var:646:6f87133a` |
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.InductionMachines.IMC_Initialize \
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.InductionMachines.IMC_Initialize --keep-artifact /tmp/m.rbc \
