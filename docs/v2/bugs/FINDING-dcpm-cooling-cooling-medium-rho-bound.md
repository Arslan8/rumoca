...
| **Signature** | `physical:physical-bound-permits-zero:var:373:891b36f8` |
...
```
predicate     cooling.medium.rho > 0
premise       established
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.DCMachines.DCPM_Cooling \
      --target cooling.medium.rho --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "cooling.medium.rho"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param cooling.medium.rho=0
```
