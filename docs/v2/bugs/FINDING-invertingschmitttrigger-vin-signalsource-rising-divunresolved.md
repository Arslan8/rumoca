...
| **Signature** | `divisor:divisor-zero-unresolved:exp:328:68abc6fe` |
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.OpAmps.InvertingSchmittTrigger \
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.OpAmps.InvertingSchmittTrigger --keep-artifact /tmp/m.rbc \
