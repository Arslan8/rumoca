# FINDING-02060: `transformer.L2sigma` in `IMC_Transformer`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:652:5793d6c1` |
...
```
{'quantity': 'Inductance', 'unit': 'H', 'confidence': 'QUANTITY_AND_UNIT', 'premise_state': 'unknown', 'authority': 'quantity_or_unit', 'canonical_declaration': 'Modelica.Electrical.Machines.BasicMachines.Transformers.Yy.Yy00.L2sigma'}
```
