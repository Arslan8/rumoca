...
| **Declaration** | `Mechanics/MultiBody/package.mo:125` |
| **Parameter** | `defaultBodyDiameter` |
| **Type** | `SI.Length` |
| **Declared modifiers** | `—` |
...
```console
$ sed -n '125p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Mechanics/MultiBody/package.mo"
```

It should declare `defaultBodyDiameter` with type `SI.Length` and no `min`.
...
```modelica
// Mechanics/MultiBody/package.mo:125
parameter SI.Length defaultBodyDiameter(min=0) = ...;
```
