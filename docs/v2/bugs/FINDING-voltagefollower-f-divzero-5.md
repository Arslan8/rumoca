# FINDING-01070: `f` in `VoltageFollower`
...
| **Severity** | high |
| **Declaration** | `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Analog/Examples/OpAmps/VoltageFollower.mo:20` |
| **Signature** | `divisor:divisor-reachable-zero:exp:93:dec45c8d` |
...
```console
$ sed -n '20p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Analog/Examples/OpAmps/VoltageFollower.mo"
```
...
```console
$ grep -rl '| `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Analog/Examples/OpAmps/VoltageFollower.mo:20` |' docs/v2/bugs/
```
