# FINDING-04471: `referenceSystem.pointMass1.m` in `PointGravityWithPointMasses2`
...
| **Reached as** | `referenceSystem.pointMass1.m` |
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:647:a44aaf1d` |
...
```
predicate     referenceSystem.pointMass1.m > 0
premise       refuted
...
| `required` | referenceSystem.pointMass1.m &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Mechanics.MultiBody.Examples.Elementary.PointGravityWithPointMasses2 \
      --target referenceSystem.pointMass1.m --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "referenceSystem.pointMass1.m"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param referenceSystem.pointMass1.m=0
```
