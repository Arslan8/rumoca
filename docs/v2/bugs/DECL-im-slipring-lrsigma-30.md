# DECL-0140: `Lrsigma` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Electrical/Machines/BasicMachines/InductionMachines/IM_SlipRing.mo:30` |
| **Parameter** | `Lrsigma` |
| **Type** | `SI.Inductance` |
...
```console
$ grep -n -- "-1e40\|-1E40" "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Machines/BasicMachines/InductionMachines/IM_SlipRing.mo" | head
```
...
```modelica
// Electrical/Machines/BasicMachines/InductionMachines/IM_SlipRing.mo:30
