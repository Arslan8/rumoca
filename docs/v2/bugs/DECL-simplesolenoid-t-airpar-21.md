# DECL-0460: `t_airPar` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Magnetic/FluxTubes/Examples/SolenoidActuator/Components/SimpleSolenoid.mo:21` |
| **Parameter** | `t_airPar` |
| **Type** | `SI.Length` |
| **Declared modifiers** | `—` |
...
```console
$ sed -n '21p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/FluxTubes/Examples/SolenoidActuator/Components/SimpleSolenoid.mo"
```
...
```modelica
// Magnetic/FluxTubes/Examples/SolenoidActuator/Components/SimpleSolenoid.mo:21
