# DECL-0686: `Re` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Electrical/Machines/BasicMachines/SynchronousMachines/SM_ElectricalExcited.mo:96` |
| **Parameter** | `Re` |
| **Type** | `SI.Resistance` |
...
```modelica
// Electrical/Machines/BasicMachines/SynchronousMachines/SM_ElectricalExcited.mo:96
