...
| **Signature** | `divisor:divisor-reachable-zero:exp:1084:d22e2855` |
...
| `constraints` | g_mFeYokeSide1.l: unbounded |
...
$ python3 tools/sweep/check_one.py Modelica.Magnetic.FluxTubes.Examples.SolenoidActuator.Components.AdvancedSolenoid \
      --target g_mFeYokeSide1.l --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "g_mFeYokeSide1.l"
```
