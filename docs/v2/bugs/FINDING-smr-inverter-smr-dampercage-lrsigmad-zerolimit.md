# FINDING-02956: `smr.damperCage.Lrsigmad` in `SMR_Inverter`
...
| **Reached as** | `smr.damperCage.Lrsigmad` |
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:409:4d5915e4` |
...
```
predicate     smr.damperCage.Lrsigmad > 0
premise       refuted
...
| `required` | smr.damperCage.Lrsigmad &gt; 0 |
| `declared_min` | None |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.SynchronousMachines.SMR_Inverter \
      --target smr.damperCage.Lrsigmad --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "smr.damperCage.Lrsigmad"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param smr.damperCage.Lrsigmad=0
```
