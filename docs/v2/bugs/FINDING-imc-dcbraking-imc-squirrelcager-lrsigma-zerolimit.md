# FINDING-01734: `imc.squirrelCageR.Lrsigma` in `IMC_DCBraking`
...
| **Reached as** | `imc.squirrelCageR.Lrsigma` |
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:440:9037bbe8` |
...
```
predicate     imc.squirrelCageR.Lrsigma > 0
premise       refuted
...
| `required` | imc.squirrelCageR.Lrsigma &gt; 0 |
| `declared_min` | None |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.InductionMachines.IMC_DCBraking \
      --target imc.squirrelCageR.Lrsigma --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "imc.squirrelCageR.Lrsigma"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param imc.squirrelCageR.Lrsigma=0
```
