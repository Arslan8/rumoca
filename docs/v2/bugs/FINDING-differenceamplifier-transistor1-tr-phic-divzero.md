...
| **Reached as** | `Transistor1.Tr.Phic` |
...
| **Signature** | `divisor:divisor-reachable-zero:exp:1224:d669c96c` |
...
```
denominator            Transistor1.Tr.Phic
witness                Transistor1.Tr.Phic = 0
  found by             set to zero
denominator at witness 0.0
at declared values     0.8
path condition         always evaluated
constraints consulted  Transistor1.Tr.Phic: unbounded
```
...
| `constraints` | Transistor1.Tr.Phic: unbounded |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.DifferenceAmplifier \
      --target Transistor1.Tr.Phic --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "Transistor1.Tr.Phic"
```
