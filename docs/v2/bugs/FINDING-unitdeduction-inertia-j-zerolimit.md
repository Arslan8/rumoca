# FINDING-05205: `inertia.J` in `UnitDeduction`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:14:47a46bfc` |
...
```console
$ python3 tools/sweep/check_one.py ModelicaTest.Blocks.UnitDeduction \
...
```console
$ python3 tools/sweep/check_one.py ModelicaTest.Blocks.UnitDeduction --keep-artifact /tmp/m.rbc \
