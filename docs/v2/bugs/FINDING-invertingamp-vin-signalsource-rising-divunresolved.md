# FINDING-00420: `vIn.signalSource.rising` in `InvertingAmp`
...
| **Signature** | `divisor:divisor-zero-unresolved:exp:297:30266e3c` |
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.InvertingAmp \
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.InvertingAmp --keep-artifact /tmp/m.rbc \
