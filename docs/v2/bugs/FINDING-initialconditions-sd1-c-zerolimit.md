# FINDING-04724: `sd1.c` in `InitialConditions`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:74:ba168c2a` |
...
$ python3 tools/sweep/check_one.py Modelica.Mechanics.Translational.Examples.InitialConditions \
      --target sd1.c --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "sd1.c"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param sd1.c=0
```
