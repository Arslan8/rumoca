...
```console
$ python3 tools/sweep/check_one.py ModelicaTest.Blocks.Continuous \
...
```console
$ python3 tools/sweep/check_one.py ModelicaTest.Blocks.Continuous --keep-artifact /tmp/m.rbc \
