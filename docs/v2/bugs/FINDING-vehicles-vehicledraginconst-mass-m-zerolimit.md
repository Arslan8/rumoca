...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:209:67ae6d43` |
...
```
predicate     vehicleDragInConst.mass.m > 0
premise       refuted
...
| `required` | vehicleDragInConst.mass.m &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py ModelicaTest.Translational.Vehicles \
      --target vehicleDragInConst.mass.m --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "vehicleDragInConst.mass.m"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param vehicleDragInConst.mass.m=0
```
