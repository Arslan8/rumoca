...
| **Declaration** | `Electrical/Machines/Utilities/ParameterRecords/DcPermanentMagnetData.mo:5` |
| **Parameter** | `Jr` |
| **Type** | `SI.Inertia` |
| **Declared modifiers** | `—` |
...
It should declare `Jr` with type `SI.Inertia` and no `min`.
...
```modelica
// Electrical/Machines/Utilities/ParameterRecords/DcPermanentMagnetData.mo:5
parameter SI.Inertia Jr(min=0) = ...;
```
