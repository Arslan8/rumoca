# FINDING-04020: `chopperStepDown.transistor.Goff` in `ChopperStepDown_RL`
...
| **Reached as** | `chopperStepDown.transistor.Goff` |
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:56:56ef535b` |
...
```
predicate     chopperStepDown.transistor.Goff > 0
premise       refuted
...
| `required` | chopperStepDown.transistor.Goff &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.PowerConverters.Examples.DCDC.ChopperStepDown.ChopperStepDown_RL \
      --target chopperStepDown.transistor.Goff --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "chopperStepDown.transistor.Goff"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param chopperStepDown.transistor.Goff=0
```
