...
| **Declaration** | `Magnetic/FluxTubes/Basic/ConstantPermeance.mo:6` |
| **Parameter** | `G_m` |
| **Type** | `SI.Permeance` |
| **Declared modifiers** | `—` |
...
```console
$ sed -n '6p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/FluxTubes/Basic/ConstantPermeance.mo"
```
...
```console
$ grep -n -- "-1e40\|-1E40" "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/FluxTubes/Basic/ConstantPermeance.mo" | head
```
