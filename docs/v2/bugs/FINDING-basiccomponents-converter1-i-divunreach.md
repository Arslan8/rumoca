...
| **Reached as** | `converter1.i` |
| **Found by** | **DivisorSan** — `packages/modelsan/modelsan/sanitizers/divisor.py` |
| **Reported as** | `divisor-unreachable-under-witness` |
| **Severity** | low |
| **Declaration** | `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/FluxTubes/Basic/ElectroMagneticConverterWithLeakageInductance.mo:62` |
| **Signature** | `divisor:divisor-unreachable-under-witness:exp:375:7d0c6671` |
...
| `denominator_range` |  |
| `path_condition` | ((abs(converter1.i) &gt; converter1.eps)) |
| `verdict` | UNSAT |
| `proof` | the denominator is zero as declared, and ((abs(converter1.i) &gt; converter1.eps)) |
| `constraints` |  |
| `guard_that_excludes_it` | ((abs(converter1.i) &gt; converter1.eps)) |
...
$ python3 tools/sweep/check_one.py ModelicaTest.Magnetic.FluxTubes.BasicComponents \
      --target converter1.i --sanitizer divisor
```
...
```console
$ sed -n '62p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/FluxTubes/Basic/ElectroMagneticConverterWithLeakageInductance.mo"
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "converter1.i"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param converter1.i=0
```
...
```console
$ grep -rl '| `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/FluxTubes/Basic/ElectroMagneticConverterWithLeakageInductance.mo:62` |' docs/v2/bugs/
```
