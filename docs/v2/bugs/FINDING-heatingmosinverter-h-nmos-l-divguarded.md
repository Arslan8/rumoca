# FINDING-00330: `H_NMOS.L` in `HeatingMOSInverter`
...
| **Signature** | `divisor:divisor-guarded-by-assertion:exp:574:9d369a47` |
...
| `denominator_at_declared_values` | 4.5e-06 |
| `denominator_range` |  |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.HeatingMOSInverter \
      --target H_NMOS.L --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "H_NMOS.L"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param H_NMOS.L=0
```
