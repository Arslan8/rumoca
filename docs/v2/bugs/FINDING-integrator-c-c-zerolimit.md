# FINDING-01014: `c.C` in `Integrator`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:47:b27750fb` |
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.OpAmps.OpAmpCircuits.Integrator \
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.OpAmps.OpAmpCircuits.Integrator --keep-artifact /tmp/m.rbc \
