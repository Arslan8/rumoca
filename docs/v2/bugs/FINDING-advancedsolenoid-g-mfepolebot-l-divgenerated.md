# FINDING-04311: `g_mFePoleBot.l` in `AdvancedSolenoid`
...
| **Signature** | `divisor:divisor-introduced-by-translation:exp:1465:6136b930` |
...
```
denominator            g_mFePoleBot.A
witness                g_mFePoleBot.l = 0
  found by             set to zero
denominator at witness 0.0
at declared values     0.00020341812431993908
path condition         always evaluated
constraints consulted  g_mFePoleBot.l: unbounded
```
...
$ python3 tools/sweep/check_one.py Modelica.Magnetic.FluxTubes.Examples.SolenoidActuator.Components.AdvancedSolenoid \
      --target g_mFePoleBot.l --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "g_mFePoleBot.l"
```
