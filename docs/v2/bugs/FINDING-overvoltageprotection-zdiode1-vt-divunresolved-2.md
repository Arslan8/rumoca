...
| **Signature** | `divisor:divisor-zero-unresolved:exp:472:4c1b3b9f` |
...
```
denominator            zDiode1.Vt
witness                zDiode1.Vt = 0
...
constraints consulted  zDiode1.Vt: unbounded
```
...
| `constraints` | zDiode1.Vt: unbounded |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.OvervoltageProtection \
      --target zDiode1.Vt --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "zDiode1.Vt"
```
