# DECL-0687: `Rrd` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Electrical/Machines/BasicMachines/SynchronousMachines/SM_PermanentMagnet.mo:70` |
| **Parameter** | `Rrd` |
| **Type** | `SI.Resistance` |
...
```modelica
// Electrical/Machines/BasicMachines/SynchronousMachines/SM_PermanentMagnet.mo:70
