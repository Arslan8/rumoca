# FINDING-01463: `Ts` in `DCPM_CurrentControlled`
...
| **Signature** | `divisor:divisor-reachable-zero:exp:15:585c9244` |
...
constraints consulted  Ts: unbounded
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "Ts"
```
