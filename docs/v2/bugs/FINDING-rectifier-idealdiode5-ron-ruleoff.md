...
| **Signature** | `physical:physical-rule-does-not-apply:var:155:d577bb0a` |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.Rectifier \
      --target IdealDiode5.Ron --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "IdealDiode5.Ron"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param IdealDiode5.Ron=0
```
