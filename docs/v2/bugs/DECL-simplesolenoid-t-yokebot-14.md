# DECL-0457: `t_yokeBot` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Magnetic/FluxTubes/Examples/SolenoidActuator/Components/SimpleSolenoid.mo:14` |
| **Parameter** | `t_yokeBot` |
| **Type** | `SI.Length` |
| **Declared modifiers** | `—` |
...
```console
$ sed -n '14p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/FluxTubes/Examples/SolenoidActuator/Components/SimpleSolenoid.mo"
```
...
```modelica
// Magnetic/FluxTubes/Examples/SolenoidActuator/Components/SimpleSolenoid.mo:14
