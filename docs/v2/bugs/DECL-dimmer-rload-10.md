# DECL-0756: `RLoad` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Electrical/PowerConverters/Examples/ACAC/ExampleTemplates/Dimmer.mo:10` |
| **Parameter** | `RLoad` |
| **Type** | `SI.Resistance` |
| **Declared modifiers** | `—` |
...
```console
$ sed -n '10p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/PowerConverters/Examples/ACAC/ExampleTemplates/Dimmer.mo"
```
...
```modelica
// Electrical/PowerConverters/Examples/ACAC/ExampleTemplates/Dimmer.mo:10
