# FINDING-02790: `switch3.Ron` in `SMPM_ResistiveBraking`
...
| **Signature** | `physical:physical-rule-does-not-apply:var:940:f6801e34` |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.SynchronousMachines.SMPM_ResistiveBraking \
      --target switch3.Ron --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "switch3.Ron"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param switch3.Ron=0
```
