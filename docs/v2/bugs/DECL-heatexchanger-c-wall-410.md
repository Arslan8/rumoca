# DECL-0889: `c_wall` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Fluid/Examples/HeatExchanger.mo:410` |
| **Parameter** | `c_wall` |
...
```console
$ sed -n '410p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Fluid/Examples/HeatExchanger.mo"
```
...
```modelica
// Fluid/Examples/HeatExchanger.mo:410
