# FINDING-04237: `cActuator.armature.stopper_xMin.c` in `ArmatureStroke`
...
| **Reached as** | `cActuator.armature.stopper_xMin.c` |
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:326:ca47b67e` |
...
```
predicate     cActuator.armature.stopper_xMin.c > 0
premise       refuted
...
| `required` | cActuator.armature.stopper_xMin.c &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Magnetic.FluxTubes.Examples.MovingCoilActuator.ArmatureStroke \
      --target cActuator.armature.stopper_xMin.c --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "cActuator.armature.stopper_xMin.c"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param cActuator.armature.stopper_xMin.c=0
```
