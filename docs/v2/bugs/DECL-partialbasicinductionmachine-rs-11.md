...
| **Declaration** | `Electrical/Machines/Interfaces/PartialBasicInductionMachine.mo:11` |
| **Parameter** | `Rs` |
| **Type** | `SI.Resistance` |
| **Declared modifiers** | `(start=0.03*ZsRef)` |
...
```modelica
// Electrical/Machines/Interfaces/PartialBasicInductionMachine.mo:11
