# FINDING-00431: `z0` in `CompareLineTrunks`
...
| **Severity** | low |
| **Declaration** | `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Analog/Examples/Lines/CompareLineTrunks.mo:15` |
| **Signature** | `physical:physical-intent-question:var:9:70732f07` |
...
role          —
declaration   Modelica.Electrical.Analog.Examples.Lines.CompareLineTrunks.z0
```
...
```
{'quantity': 'Resistance', 'unit': 'Ohm', 'confidence': 'QUANTITY_AND_UNIT', 'premise_state': 'unknown', 'authority': 'quantity_or_unit', 'canonical_declaration': 'Modelica.Electrical.Analog.Examples.Lines.CompareLineTrunks.z0'}
```
...
| `authority` | quantity_or_unit |
| `canonical_declaration` | Modelica.Electrical.Analog.Examples.Lines.CompareLineTrunks.z0 |
...
```console
$ sed -n '15p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Analog/Examples/Lines/CompareLineTrunks.mo"
```
...
```console
$ grep -rl '| `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Analog/Examples/Lines/CompareLineTrunks.mo:15` |' docs/v2/bugs/
```
