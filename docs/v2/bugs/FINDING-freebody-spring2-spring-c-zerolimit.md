...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:582:4735793c` |
...
$ python3 tools/sweep/check_one.py Modelica.Mechanics.MultiBody.Examples.Elementary.FreeBody \
      --target spring2.spring.c --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "spring2.spring.c"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param spring2.spring.c=0
```
