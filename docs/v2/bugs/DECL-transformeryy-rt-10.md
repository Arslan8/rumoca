# DECL-0741: `RT` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Electrical/Polyphase/Examples/TransformerYY.mo:10` |
| **Parameter** | `RT` |
| **Type** | `SI.Resistance` |
| **Declared modifiers** | `—` |
...
```modelica
// Electrical/Polyphase/Examples/TransformerYY.mo:10
