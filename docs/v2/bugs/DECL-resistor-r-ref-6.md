# DECL-0809: `R_ref` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Electrical/QuasiStatic/SinglePhase/Basic/Resistor.mo:6` |
| **Parameter** | `R_ref` |
| **Type** | `SI.Resistance` |
...
```console
$ sed -n '6p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/QuasiStatic/SinglePhase/Basic/Resistor.mo"
```
...
```console
$ grep -n -- "-1e40\|-1E40" "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/QuasiStatic/SinglePhase/Basic/Resistor.mo" | head
```
...
```modelica
// Electrical/QuasiStatic/SinglePhase/Basic/Resistor.mo:6
