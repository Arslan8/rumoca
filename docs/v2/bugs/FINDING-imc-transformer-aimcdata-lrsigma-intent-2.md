# FINDING-03086: `aimcData.Lrsigma` in `IMC_Transformer`
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.Transformers.IMC_Transformer \
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.Transformers.IMC_Transformer --keep-artifact /tmp/m.rbc \
