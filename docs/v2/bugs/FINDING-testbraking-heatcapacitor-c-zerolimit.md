# FINDING-05377: `heatCapacitor.C` in `TestBraking`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:99:c12bb2a9` |
...
```console
$ python3 tools/sweep/check_one.py ModelicaTest.Rotational.TestBraking \
...
```console
$ python3 tools/sweep/check_one.py ModelicaTest.Rotational.TestBraking --keep-artifact /tmp/m.rbc \
