...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:585:b4bc4843` |
...
```
predicate     vehicleRollInVar.m > 0
premise       refuted
...
$ python3 tools/sweep/check_one.py ModelicaTest.Translational.Vehicles \
      --target vehicleRollInVar.m --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "vehicleRollInVar.m"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param vehicleRollInVar.m=0
```
