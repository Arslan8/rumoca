# FINDING-00096: `L1.L` in `CauerLowPassAnalog`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:50:817f9cec` |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.CauerLowPassAnalog \
      --target L1.L --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "L1.L"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param L1.L=0
```
