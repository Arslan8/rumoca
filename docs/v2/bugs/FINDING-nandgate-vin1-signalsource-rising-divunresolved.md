...
| **Signature** | `divisor:divisor-zero-unresolved:exp:447:ec5eea10` |
...
```
denominator            VIN1.signalSource.rising
witness                VIN1.signalSource.rising = 0
  found by             set to zero
denominator at witness 0.0
at declared values     1e-09
path condition         not ((((time < VIN1.signalSource.startTime) or (VIN1.signalSource.nperiod == 0)) or ((VIN1.signalSource.nperiod > 0) and (VIN1.signalSource.count >= VIN1.signalSource.nperiod)))) and ((time < (VIN1.signalSource.T_start + VIN1.signalSource.T_rising)))
constraints consulted  VIN1.signalSource.rising: min=0
```
...
| `path_condition` | not ((((time &lt; VIN1.signalSource.startTime) or (VIN1.signalSource.nperiod == 0)) or ((VIN1.signalSource.nperiod &gt; 0) and (VIN1.signalSource.count &gt;= VIN1.signalSource.nperiod)))) and ((time &lt; (VIN1.signalSource.T_start + VIN1.signalSource.T_rising))) |
| `verdict` | UNKNOWN |
| `proof` | the path depends on quantities the artifact does not determine: (time &lt; (VIN1.signalSource.T_start + VIN1.signalSource.T_rising)); (time &lt; VIN1.signalSource.startTime) |
| `constraints` | VIN1.signalSource.rising: min=0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.NandGate \
      --target VIN1.signalSource.rising --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "VIN1.signalSource.rising"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check \
      --param VIN1.signalSource.rising=0
```
