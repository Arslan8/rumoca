...
| **Declaration** | `Magnetic/QuasiStatic/FundamentalWave/Utilities/SwitchYD.mo:5` |
| **Parameter** | `Goff` |
| **Type** | `SI.Conductance` |
| **Declared modifiers** | `—` |
...
```console
$ sed -n '5p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/QuasiStatic/FundamentalWave/Utilities/SwitchYD.mo"
```

It should declare `Goff` with type `SI.Conductance` and no `min`.
...
```console
$ grep -n -- "-1e40\|-1E40" "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/QuasiStatic/FundamentalWave/Utilities/SwitchYD.mo" | head
```
...
```modelica
// Magnetic/QuasiStatic/FundamentalWave/Utilities/SwitchYD.mo:5
