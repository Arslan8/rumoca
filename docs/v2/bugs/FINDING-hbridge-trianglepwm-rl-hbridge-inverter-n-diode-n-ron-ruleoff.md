# FINDING-04162: `hbridge.inverter_n.diode_n.Ron` in `HBridge_TrianglePWM_RL`
...
| **Reached as** | `hbridge.inverter_n.diode_n.Ron` |
...
| **Signature** | `physical:physical-rule-does-not-apply:var:252:344c7b06` |
...
```
predicate     hbridge.inverter_n.diode_n.Ron > 0
premise       refuted
...
| `required` | hbridge.inverter_n.diode_n.Ron &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.PowerConverters.Examples.DCDC.HBridge.HBridge_TrianglePWM_RL \
      --target hbridge.inverter_n.diode_n.Ron --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "hbridge.inverter_n.diode_n.Ron"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param hbridge.inverter_n.diode_n.Ron=0
```
