# DECL-0257: `Lrsigmaq` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Magnetic/FundamentalWave/BasicMachines/SynchronousMachines/SM_ElectricalExcited.mo:49` |
| **Parameter** | `Lrsigmaq` |
| **Type** | `SI.Inductance` |
| **Declared modifiers** | `—` |
...
```console
$ sed -n '49p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/FundamentalWave/BasicMachines/SynchronousMachines/SM_ElectricalExcited.mo"
```
...
```modelica
// Magnetic/FundamentalWave/BasicMachines/SynchronousMachines/SM_ElectricalExcited.mo:49
