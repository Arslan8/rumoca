...
| **Signature** | `physical:physical-rule-does-not-apply:var:676:0f4dd06b` |
...
```
predicate     Rp1.IdealCommutingSwitch2.Goff > 0
premise       refuted
...
| `required` | Rp1.IdealCommutingSwitch2.Goff &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.CauerLowPassSC \
      --target Rp1.IdealCommutingSwitch2.Goff --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "Rp1.IdealCommutingSwitch2.Goff"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param Rp1.IdealCommutingSwitch2.Goff=0
```
