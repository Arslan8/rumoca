...
| **Declaration** | `Mechanics/Translational/Components/Vehicle.mo:6` |
| **Parameter** | `R` |
| **Type** | `SI.Length` |
| **Declared modifiers** | `—` |
...
```console
$ sed -n '6p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Mechanics/Translational/Components/Vehicle.mo"
```
...
```console
$ grep -n -- "-1e40\|-1E40" "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Mechanics/Translational/Components/Vehicle.mo" | head
```
...
```modelica
// Mechanics/Translational/Components/Vehicle.mo:6
