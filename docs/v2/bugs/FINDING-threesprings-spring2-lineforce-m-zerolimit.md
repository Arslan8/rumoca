...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:528:c8bf605c` |
...
```
predicate     spring2.lineForce.m > 0
premise       refuted
...
| `required` | spring2.lineForce.m &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Mechanics.MultiBody.Examples.Elementary.ThreeSprings \
      --target spring2.lineForce.m --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "spring2.lineForce.m"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param spring2.lineForce.m=0
```
