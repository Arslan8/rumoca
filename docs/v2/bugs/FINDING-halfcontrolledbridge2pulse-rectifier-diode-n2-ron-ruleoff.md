# FINDING-03643: `rectifier.diode_n2.Ron` in `HalfControlledBridge2Pulse`
...
| **Reached as** | `rectifier.diode_n2.Ron` |
...
| **Signature** | `physical:physical-rule-does-not-apply:var:123:3083a49e` |
...
```
predicate     rectifier.diode_n2.Ron > 0
premise       refuted
...
| `required` | rectifier.diode_n2.Ron &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.PowerConverters.Examples.ACDC.RectifierBridge2Pulse.HalfControlledBridge2Pulse \
      --target rectifier.diode_n2.Ron --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "rectifier.diode_n2.Ron"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param rectifier.diode_n2.Ron=0
```
