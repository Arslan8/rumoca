# FINDING-02783: `switch2.Goff` in `SMPM_ResistiveBraking`
...
| **Signature** | `physical:physical-rule-does-not-apply:var:867:2b26eebc` |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.SynchronousMachines.SMPM_ResistiveBraking \
      --target switch2.Goff --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "switch2.Goff"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param switch2.Goff=0
```
