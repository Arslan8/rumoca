# FINDING-05341: `genericFluxTube1.area` in `Sources`
...
| **Signature** | `divisor:divisor-reachable-zero:exp:333:44490089` |
...
```
denominator            genericFluxTube1.A
witness                genericFluxTube1.area = 0
  found by             set to zero
denominator at witness 0.0
at declared values     0.0001
path condition         always evaluated
constraints consulted  genericFluxTube1.area: unbounded
```
...
| `constraints` | genericFluxTube1.area: unbounded |
...
$ python3 tools/sweep/check_one.py ModelicaTest.Magnetic.FluxTubes.Sources \
      --target genericFluxTube1.area --sanitizer divisor
```
