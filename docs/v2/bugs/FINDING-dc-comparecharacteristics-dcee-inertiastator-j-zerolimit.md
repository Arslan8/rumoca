# FINDING-01328: `dcee.inertiaStator.J` in `DC_CompareCharacteristics`
...
| **Reached as** | `dcee.inertiaStator.J` |
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:671:af973e50` |
...
```
predicate     dcee.inertiaStator.J > 0
premise       refuted
...
| `required` | dcee.inertiaStator.J &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.DCMachines.DC_CompareCharacteristics \
      --target dcee.inertiaStator.J --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "dcee.inertiaStator.J"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param dcee.inertiaStator.J=0
```
