# FINDING-04956: `valve.y1` in `PumpAndValve`
...
| **Signature** | `divisor:divisor-guarded-by-assertion:exp:764:5dd5299e` |
...
$ python3 tools/sweep/check_one.py Modelica.Thermal.FluidHeatFlow.Examples.PumpAndValve \
      --target valve.y1 --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "valve.y1"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param valve.y1=0
```
