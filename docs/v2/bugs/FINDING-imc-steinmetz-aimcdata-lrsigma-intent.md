# FINDING-02016: `aimcData.Lrsigma` in `IMC_Steinmetz`
...
| **Signature** | `physical:physical-intent-question:var:608:c5c6c3d1` |
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.InductionMachines.IMC_Steinmetz \
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.InductionMachines.IMC_Steinmetz --keep-artifact /tmp/m.rbc \
