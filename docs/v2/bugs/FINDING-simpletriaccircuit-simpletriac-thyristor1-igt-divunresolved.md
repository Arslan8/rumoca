...
| **Severity** | medium |
| **Declaration** | `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Analog/Semiconductors/Thyristor.mo:51` |
| **Signature** | `divisor:divisor-zero-unresolved:exp:695:921e760e` |
...
path condition         ((simpleTriac.thyristor1.vGK < simpleTriac.thyristor1.vRef))
...
| `path_condition` | ((simpleTriac.thyristor1.vGK &lt; simpleTriac.thyristor1.vRef)) |
| `verdict` | UNKNOWN |
...
```console
$ sed -n '51p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Analog/Semiconductors/Thyristor.mo"
```
...
```console
$ grep -rl '| `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Analog/Semiconductors/Thyristor.mo:51` |' docs/v2/bugs/
```
