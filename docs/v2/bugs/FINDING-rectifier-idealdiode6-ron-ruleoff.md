...
| **Signature** | `physical:physical-rule-does-not-apply:var:172:249e81bd` |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.Rectifier \
      --target IdealDiode6.Ron --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "IdealDiode6.Ron"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param IdealDiode6.Ron=0
```
