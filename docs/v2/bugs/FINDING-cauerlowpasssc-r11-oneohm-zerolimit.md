# FINDING-00214: `R11.oneOhm` in `CauerLowPassSC`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:910:dfc8151d` |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.CauerLowPassSC \
      --target R11.oneOhm --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "R11.oneOhm"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param R11.oneOhm=0
```
