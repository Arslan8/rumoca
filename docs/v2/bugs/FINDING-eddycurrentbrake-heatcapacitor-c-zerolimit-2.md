# FINDING-04696: `heatCapacitor.C` in `EddyCurrentBrake`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:31:3a0aee81` |
...
```console
$ python3 tools/sweep/check_one.py Modelica.Mechanics.Translational.Examples.EddyCurrentBrake \
...
```console
$ python3 tools/sweep/check_one.py Modelica.Mechanics.Translational.Examples.EddyCurrentBrake --keep-artifact /tmp/m.rbc \
