# FINDING-01623: `dcpm2.coreParameters.GcRef` in `DCPM_withLosses`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:323:f7b1fdb7` |
...
```
predicate     dcpm2.coreParameters.GcRef > 0
premise       refuted
