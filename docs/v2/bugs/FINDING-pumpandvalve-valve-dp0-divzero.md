...
| **Signature** | `divisor:divisor-reachable-zero:exp:771:9cc025ef` |
...
| `constraints` | valve.dp0: unbounded |
...
$ python3 tools/sweep/check_one.py Modelica.Thermal.FluidHeatFlow.Examples.PumpAndValve \
      --target valve.dp0 --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "valve.dp0"
```
