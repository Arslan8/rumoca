...
| **Signature** | `physical:physical-domain-unenforced:var:12:4b44f6be` |
...
declaration   Modelica.Electrical.Machines.BasicMachines.DCMachines.DC_ElectricalExcited.Ra
```
...
```
{'quantity': 'Resistance', 'unit': 'Ohm', 'semantic_role': 'component.machine.winding_resistance', 'binding_source': 'component_type', 'confidence': 'QUANTITY_AND_UNIT', 'declaring_class': 'Modelica.Electrical.Machines.BasicMachines.DCMachines.DC_ElectricalExcited', 'member': 'Ra', 'premise_state': 'established', 'authority': 'component_contract', 'canonical_declaration': 'Modelica.Electrical.Machines.BasicMachines.DCMachines.DC_ElectricalExcited.Ra'}
```
...
| `canonical_declaration` | Modelica.Electrical.Machines.BasicMachines.DCMachines.DC_ElectricalExcited.Ra |
