# FINDING-00560: `line3.Z0` in `CompareLosslessLines`
...
| **Signature** | `divisor:divisor-guarded-by-assertion:exp:657:0a5e5069` |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.Lines.CompareLosslessLines \
      --target line3.Z0 --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "line3.Z0"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param line3.Z0=0
```
