# FINDING-05444: `vehicleInclinationInConst.inertia.J` in `Vehicles`

|  |  |
|---|---|
| **Tier** | **Candidate** — static only, not execution-confirmed |
| **Model** | `ModelicaTest.Translational.Vehicles` |
| **Reached as** | `vehicleInclinationInConst.inertia.J` |
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:883:0cc1b686` |
...
```
predicate     vehicleInclinationInConst.inertia.J > 0
premise       refuted
...
| `required` | vehicleInclinationInConst.inertia.J &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py ModelicaTest.Translational.Vehicles \
      --target vehicleInclinationInConst.inertia.J --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "vehicleInclinationInConst.inertia.J"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param vehicleInclinationInConst.inertia.J=0
```
