...
| **Declaration** | `Magnetic/FluxTubes/Examples/BasicExamples/ToroidalCoreAirgap.mo:8` |
| **Parameter** | `delta` |
| **Type** | `SI.Length` |
| **Declared modifiers** | `—` |
...
```console
$ sed -n '8p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/FluxTubes/Examples/BasicExamples/ToroidalCoreAirgap.mo"
```
