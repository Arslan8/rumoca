# FINDING-02665: `smpm.damperCage.Lrsigmad` in `SMPM_Inverter`
...
| **Reached as** | `smpm.damperCage.Lrsigmad` |
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:454:767d5cf1` |
...
```
predicate     smpm.damperCage.Lrsigmad > 0
premise       refuted
...
| `required` | smpm.damperCage.Lrsigmad &gt; 0 |
| `declared_min` | None |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.SynchronousMachines.SMPM_Inverter \
      --target smpm.damperCage.Lrsigmad --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "smpm.damperCage.Lrsigmad"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param smpm.damperCage.Lrsigmad=0
```
