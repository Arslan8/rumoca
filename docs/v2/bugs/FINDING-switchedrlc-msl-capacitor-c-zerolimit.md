# FINDING-05458: `capacitor.C` in `SwitchedRLC_MSL`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:44:c5666978` |
...
```console
$ python3 tools/sweep/check_one.py SwitchedRLC_MSL \
...
```console
$ python3 tools/sweep/check_one.py SwitchedRLC_MSL --keep-artifact /tmp/m.rbc \
