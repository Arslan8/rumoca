# FINDING-02957: `smr.damperCage.Lrsigmaq` in `SMR_Inverter`
...
| **Reached as** | `smr.damperCage.Lrsigmaq` |
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:410:a2173fc2` |
...
```
predicate     smr.damperCage.Lrsigmaq > 0
premise       refuted
...
| `required` | smr.damperCage.Lrsigmaq &gt; 0 |
| `declared_min` | None |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.SynchronousMachines.SMR_Inverter \
      --target smr.damperCage.Lrsigmaq --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "smr.damperCage.Lrsigmaq"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param smr.damperCage.Lrsigmaq=0
```
