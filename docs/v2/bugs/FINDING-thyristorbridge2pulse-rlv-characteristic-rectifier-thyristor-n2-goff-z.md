# FINDING-03720: `rectifier.thyristor_n2.Goff` in `ThyristorBridge2Pulse_RLV_Characteristic`
...
| **Reached as** | `rectifier.thyristor_n2.Goff` |
...
```
predicate     rectifier.thyristor_n2.Goff > 0
premise       refuted
...
| `required` | rectifier.thyristor_n2.Goff &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.PowerConverters.Examples.ACDC.RectifierBridge2Pulse.ThyristorBridge2Pulse_RLV_Characteristic \
      --target rectifier.thyristor_n2.Goff --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "rectifier.thyristor_n2.Goff"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param rectifier.thyristor_n2.Goff=0
```
