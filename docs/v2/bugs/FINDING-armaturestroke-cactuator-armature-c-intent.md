# FINDING-04233: `cActuator.armature.c` in `ArmatureStroke`
...
| **Reached as** | `cActuator.armature.c` |
...
| **Signature** | `physical:physical-intent-question:var:268:4d8cfba1` |
...
```
predicate     cActuator.armature.c > 0
premise       unknown
...
| `required` | cActuator.armature.c &gt; 0 |
| `declared_min` | None |
...
$ python3 tools/sweep/check_one.py Modelica.Magnetic.FluxTubes.Examples.MovingCoilActuator.ArmatureStroke \
      --target cActuator.armature.c --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "cActuator.armature.c"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param cActuator.armature.c=0
```
