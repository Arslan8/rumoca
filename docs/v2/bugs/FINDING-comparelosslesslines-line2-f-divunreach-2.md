# FINDING-00566: `line2.F` in `CompareLosslessLines`
...
| **Signature** | `divisor:divisor-unreachable-under-witness:exp:177:5668e16c` |
...
| `denominator_range` |  |
| `path_condition` | ((line2.F &gt; 0)) |
| `verdict` | UNSAT |
| `proof` | the denominator is zero as declared, and ((line2.F &gt; 0)) |
| `constraints` |  |
| `guard_that_excludes_it` | ((line2.F &gt; 0)) |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.Lines.CompareLosslessLines \
      --target line2.F --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "line2.F"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param line2.F=0
```
