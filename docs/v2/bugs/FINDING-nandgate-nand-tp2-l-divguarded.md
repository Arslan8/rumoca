...
| **Signature** | `divisor:divisor-guarded-by-assertion:exp:850:a7aa1fcd` |
...
```
denominator            (Nand.TP2.L + Nand.TP2.dL)
witness                none needed
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.NandGate \
      --target Nand.TP2.L --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "Nand.TP2.L"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param Nand.TP2.L=0
```
