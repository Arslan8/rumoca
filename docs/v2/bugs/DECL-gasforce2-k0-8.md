# DECL-0907: `k0` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Mechanics/MultiBody/Examples/Loops/Utilities/GasForce2.mo:8` |
| **Parameter** | `k0` |
| **Type** | `SI.Volume` |
| **Declared modifiers** | `—` |
...
```console
$ sed -n '8p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Mechanics/MultiBody/Examples/Loops/Utilities/GasForce2.mo"
```

It should declare `k0` with type `SI.Volume` and no `min`.
...
```modelica
// Mechanics/MultiBody/Examples/Loops/Utilities/GasForce2.mo:8
parameter SI.Volume k0(min=0) = ...;
```
