# FINDING-02008: `idealOpener.Ron` in `IMC_Steinmetz`
...
| **Signature** | `physical:physical-rule-does-not-apply:var:553:06e055dd` |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.InductionMachines.IMC_Steinmetz \
      --target idealOpener.Ron --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "idealOpener.Ron"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param idealOpener.Ron=0
```
