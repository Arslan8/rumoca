# FINDING-00065: `mixingUnit.c0` in `MixingUnitWithContinuousControl`
...
| **Signature** | `divisor:divisor-reachable-zero:exp:294:543526c9` |
...
| `constraints` | mixingUnit.c0: unbounded |
...
$ python3 tools/sweep/check_one.py Modelica.Clocked.Examples.Systems.Utilities.ComponentsMixingUnit.MixingUnitWithContinuousControl \
      --target mixingUnit.c0 --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "mixingUnit.c0"
```
