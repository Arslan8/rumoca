# FINDING-04019: `chopperStepDown.transistor.Ron` in `ChopperStepDown_RL`
...
| **Reached as** | `chopperStepDown.transistor.Ron` |
...
| **Signature** | `physical:physical-rule-does-not-apply:var:55:f6103cc0` |
...
```
predicate     chopperStepDown.transistor.Ron > 0
premise       refuted
...
| `required` | chopperStepDown.transistor.Ron &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.PowerConverters.Examples.DCDC.ChopperStepDown.ChopperStepDown_RL \
      --target chopperStepDown.transistor.Ron --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "chopperStepDown.transistor.Ron"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param chopperStepDown.transistor.Ron=0
```
