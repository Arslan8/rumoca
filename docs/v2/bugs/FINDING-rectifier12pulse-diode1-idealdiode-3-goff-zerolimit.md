# FINDING-03127: `diode1.idealDiode[3].Goff` in `Rectifier12pulse`
...
| **Reached as** | `diode1.idealDiode[3].Goff` |
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:183:25bf9d2c` |
...
```
predicate     diode1.idealDiode[3].Goff > 0
premise       refuted
...
| `required` | diode1.idealDiode[3].Goff &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.Transformers.Rectifier12pulse \
      --target diode1.idealDiode[3].Goff --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "diode1.idealDiode[3].Goff"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param diode1.idealDiode[3].Goff=0
```
