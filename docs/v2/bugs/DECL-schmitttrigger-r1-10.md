# DECL-0647: `R1` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Electrical/Analog/Examples/OpAmps/SchmittTrigger.mo:10` |
| **Parameter** | `R1` |
| **Type** | `SI.Resistance` |
| **Declared modifiers** | `—` |
...
```modelica
// Electrical/Analog/Examples/OpAmps/SchmittTrigger.mo:10
