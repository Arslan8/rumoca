...
| **Declaration** | `Electrical/Analog/Interfaces/IdealSwitchWithArc.mo:5` |
| **Parameter** | `Goff` |
| **Type** | `SI.Conductance` |
| **Declared modifiers** | `—` |
...
```console
$ grep -n -- "-1e40\|-1E40" "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Analog/Interfaces/IdealSwitchWithArc.mo" | head
```
...
```modelica
// Electrical/Analog/Interfaces/IdealSwitchWithArc.mo:5
