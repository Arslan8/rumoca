...
| **Signature** | `divisor:divisor-zero-unresolved:exp:529:10b9fb71` |
...
```
denominator            VIN2.signalSource.rising
witness                VIN2.signalSource.rising = 0
  found by             set to zero
denominator at witness 0.0
at declared values     1e-09
path condition         not ((((time < VIN2.signalSource.startTime) or (VIN2.signalSource.nperiod == 0)) or ((VIN2.signalSource.nperiod > 0) and (VIN2.signalSource.count >= VIN2.signalSource.nperiod)))) and ((time < (VIN2.signalSource.T_start + VIN2.signalSource.T_rising)))
constraints consulted  VIN2.signalSource.rising: min=0
```
...
| `path_condition` | not ((((time &lt; VIN2.signalSource.startTime) or (VIN2.signalSource.nperiod == 0)) or ((VIN2.signalSource.nperiod &gt; 0) and (VIN2.signalSource.count &gt;= VIN2.signalSource.nperiod)))) and ((time &lt; (VIN2.signalSource.T_start + VIN2.signalSource.T_rising))) |
| `verdict` | UNKNOWN |
| `proof` | the path depends on quantities the artifact does not determine: (time &lt; (VIN2.signalSource.T_start + VIN2.signalSource.T_rising)); (time &lt; VIN2.signalSource.startTime) |
| `constraints` | VIN2.signalSource.rising: min=0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.NandGate \
      --target VIN2.signalSource.rising --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "VIN2.signalSource.rising"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check \
      --param VIN2.signalSource.rising=0
```
