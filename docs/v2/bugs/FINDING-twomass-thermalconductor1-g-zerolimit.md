...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:272:93f7df3e` |
...
```
predicate     thermalConductor1.G > 0
premise       refuted
...
| `required` | thermalConductor1.G &gt; 0 |
| `declared_min` | None |
...
$ python3 tools/sweep/check_one.py Modelica.Thermal.FluidHeatFlow.Examples.TwoMass \
      --target thermalConductor1.G --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "thermalConductor1.G"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param thermalConductor1.G=0
```
