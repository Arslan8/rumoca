# DECL-0343: `Jr` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Magnetic/QuasiStatic/FundamentalWave/BaseClasses/Machine.mo:7` |
| **Parameter** | `Jr` |
| **Type** | `SI.Inertia` |
| **Declared modifiers** | `(start=0.29)` |
...
```console
$ sed -n '7p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/QuasiStatic/FundamentalWave/BaseClasses/Machine.mo"
```
...
```modelica
// Magnetic/QuasiStatic/FundamentalWave/BaseClasses/Machine.mo:7
