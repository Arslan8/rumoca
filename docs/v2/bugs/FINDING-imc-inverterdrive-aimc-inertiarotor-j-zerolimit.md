# FINDING-01909: `aimc.inertiaRotor.J` in `IMC_InverterDrive`
...
| **Reached as** | `aimc.inertiaRotor.J` |
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:1273:25bd2e92` |
...
```
predicate     aimc.inertiaRotor.J > 0
premise       refuted
...
| `required` | aimc.inertiaRotor.J &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.InductionMachines.IMC_InverterDrive \
      --target aimc.inertiaRotor.J --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "aimc.inertiaRotor.J"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param aimc.inertiaRotor.J=0
```
