# FINDING-02908: `smrData.Lrsigmad` in `SMR_DOL`
...
| **Signature** | `physical:physical-intent-question:var:664:1400398f` |
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.SynchronousMachines.SMR_DOL \
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.SynchronousMachines.SMR_DOL --keep-artifact /tmp/m.rbc \
