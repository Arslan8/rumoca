# FINDING-02768: `smpm.Jr` in `SMPM_ResistiveBraking`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:368:2ca0607d` |
...
```
contract    Modelica.Mechanics.Rotational.Components.Inertia.J: algebraic_limit (proven, from equation) — inherited from smpm.inertiaRotor.J, which it binds: the parameter multiplies a derivative, so at zero the differential relation becomes an algebraic constraint rather than an undefined quotient
