# DECL-0117: `Lzer` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Electrical/Analog/Examples/ShowSaturatingInductor.mo:5` |
| **Parameter** | `Lzer` |
| **Type** | `SI.Inductance` |
| **Declared modifiers** | `—` |
...
```modelica
// Electrical/Analog/Examples/ShowSaturatingInductor.mo:5
