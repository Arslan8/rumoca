# FINDING-02375: `smeeData.Re` in `SMEE_DOL`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:876:ede3316e` |
...
```
contract    Modelica.Electrical.Machines.Utilities.SynchronousMachineData.Re: feature_disabled (proven, from equation) — the parameter appears only as a multiplier, so at zero the term it scales drops out and the rest of the model is unaffected
