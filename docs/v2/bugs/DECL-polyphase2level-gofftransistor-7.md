# DECL-0066: `GoffTransistor` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Electrical/PowerConverters/DCAC/Polyphase2Level.mo:7` |
...
```console
$ grep -n -- "-1e40\|-1E40" "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/PowerConverters/DCAC/Polyphase2Level.mo" | head
```
...
```modelica
// Electrical/PowerConverters/DCAC/Polyphase2Level.mo:7
