# FINDING-05081: `openTank2.ATank` in `TwoTanks`
...
| **Signature** | `divisor:divisor-reachable-zero:exp:324:1787e5f9` |
...
```
denominator            openTank2.ATank
witness                openTank2.ATank = 0
  found by             set to zero
denominator at witness 0.0
at declared values     1.0
path condition         always evaluated
constraints consulted  openTank2.ATank: unbounded
```
...
| `constraints` | openTank2.ATank: unbounded |
...
$ python3 tools/sweep/check_one.py Modelica.Thermal.FluidHeatFlow.Examples.TwoTanks \
      --target openTank2.ATank --sanitizer divisor
```
