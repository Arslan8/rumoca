...
| **Declaration** | `Electrical/Machines/Utilities/ParameterRecords/InductionMachineData.mo:23` |
| **Parameter** | `Lssigma` |
| **Type** | `SI.Inductance` |
| **Declared modifiers** | `—` |
...
```console
$ grep -n -- "-1e40\|-1E40" "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Machines/Utilities/ParameterRecords/InductionMachineData.mo" | head
```
...
```modelica
// Electrical/Machines/Utilities/ParameterRecords/InductionMachineData.mo:23
