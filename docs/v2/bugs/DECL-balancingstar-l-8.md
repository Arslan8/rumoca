...
| **Declaration** | `Electrical/QuasiStatic/Polyphase/Examples/BalancingStar.mo:8` |
| **Parameter** | `L` |
| **Type** | `SI.Inductance` |
| **Declared modifiers** | `—` |
...
```console
$ sed -n '8p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/QuasiStatic/Polyphase/Examples/BalancingStar.mo"
```
...
```console
$ grep -n -- "-1e40\|-1E40" "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/QuasiStatic/Polyphase/Examples/BalancingStar.mo" | head
```
...
```modelica
// Electrical/QuasiStatic/Polyphase/Examples/BalancingStar.mo:8
