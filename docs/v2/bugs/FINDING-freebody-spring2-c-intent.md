# FINDING-04405: `spring2.c` in `FreeBody`
...
| **Signature** | `physical:physical-intent-question:var:504:4e8b27c2` |
...
```console
$ python3 tools/sweep/check_one.py Modelica.Mechanics.MultiBody.Examples.Elementary.FreeBody \
...
```console
$ python3 tools/sweep/check_one.py Modelica.Mechanics.MultiBody.Examples.Elementary.FreeBody --keep-artifact /tmp/m.rbc \
