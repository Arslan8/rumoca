# FINDING-04573: `body3.m` in `PlanarFourbar`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:476:aa22bf43` |
...
```
contract    Modelica.Mechanics.MultiBody.Parts.Body.m: feature_disabled (proven, from equation) — inherited from body3.body.m, which it binds: the parameter appears only as a multiplier, so at zero the term it scales drops out and the rest of the model is unaffected
