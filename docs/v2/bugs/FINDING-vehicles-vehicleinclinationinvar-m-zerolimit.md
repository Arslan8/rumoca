...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:938:6c69e8a0` |
...
```
predicate     vehicleInclinationInVar.m > 0
premise       refuted
...
| `required` | vehicleInclinationInVar.m &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py ModelicaTest.Translational.Vehicles \
      --target vehicleInclinationInVar.m --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "vehicleInclinationInVar.m"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param vehicleInclinationInVar.m=0
```
