# FINDING-03438: `rectifier.diode_n.idealDiode[1].Ron` in `HalfControlledBridge2mPulse`
...
| **Reached as** | `rectifier.diode_n.idealDiode[1].Ron` |
...
| **Signature** | `physical:physical-rule-does-not-apply:var:254:afb21d16` |
...
```
predicate     rectifier.diode_n.idealDiode[1].Ron > 0
premise       refuted
...
| `required` | rectifier.diode_n.idealDiode[1].Ron &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.PowerConverters.Examples.ACDC.RectifierBridge2mPulse.HalfControlledBridge2mPulse \
      --target rectifier.diode_n.idealDiode[1].Ron --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "rectifier.diode_n.idealDiode[1].Ron"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param rectifier.diode_n.idealDiode[1].Ron=0
```
