# FINDING-05278: `R` in `HalfControlledBridge2mPulse`
...
| **Severity** | low |
| **Declaration** | `target/corpus/ModelicaStandardLibrary-4.1.0/ModelicaTest/Electrical/PowerConverters.mo:15` |
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:4:2bce2ea8` |
...
```
{'quantity': 'Resistance', 'unit': 'Ohm', 'confidence': 'QUANTITY_AND_UNIT', 'premise_state': 'unknown', 'authority': 'quantity_or_unit', 'canonical_declaration': 'ModelicaTest.Electrical.PowerConverters.HalfControlledBridge2mPulse.R'}
```
...
```console
$ sed -n '15p' "target/corpus/ModelicaStandardLibrary-4.1.0/ModelicaTest/Electrical/PowerConverters.mo"
```
...
```console
$ grep -rl '| `target/corpus/ModelicaStandardLibrary-4.1.0/ModelicaTest/Electrical/PowerConverters.mo:15` |' docs/v2/bugs/
```
