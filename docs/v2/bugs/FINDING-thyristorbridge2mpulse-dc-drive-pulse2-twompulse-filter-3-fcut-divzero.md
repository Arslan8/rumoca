# FINDING-03525: `pulse2.twomPulse.filter[3].fCut` in `ThyristorBridge2mPulse_DC_Drive`
...
| **Signature** | `divisor:divisor-reachable-zero:exp:1616:dc2b093a` |
...
```
denominator            pulse2.twomPulse.filter[3].fCut
