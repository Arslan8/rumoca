...
| **Declaration** | `Mechanics/MultiBody/Parts/Body.mo:114` |
| **Parameter** | `I` |
| **Type** | `SI.Inertia` |
| **Declared modifiers** | `—` |
...
```console
$ grep -n -- "-1e40\|-1E40" "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Mechanics/MultiBody/Parts/Body.mo" | head
```
...
```modelica
// Mechanics/MultiBody/Parts/Body.mo:114
