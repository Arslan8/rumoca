# DECL-0231: `L` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Electrical/QuasiStatic/Polyphase/Basic/Inductor.mo:4` |
| **Parameter** | `L` |
| **Type** | `SI.Inductance` |
...
```console
$ sed -n '4p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/QuasiStatic/Polyphase/Basic/Inductor.mo"
```
...
```console
$ grep -n -- "-1e40\|-1E40" "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/QuasiStatic/Polyphase/Basic/Inductor.mo" | head
```
...
```modelica
// Electrical/QuasiStatic/Polyphase/Basic/Inductor.mo:4
