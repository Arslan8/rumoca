# DECL-0507: `t` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Magnetic/QuasiStatic/FluxTubes/Shapes/Leakage/EighthOfHollowSphere.mo:7` |
| **Parameter** | `t` |
| **Type** | `SI.Length` |
| **Declared modifiers** | `(start=0.01)` |
...
```console
$ sed -n '7p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/QuasiStatic/FluxTubes/Shapes/Leakage/EighthOfHollowSphere.mo"
```
...
```console
$ grep -n -- "-1e40\|-1E40" "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/QuasiStatic/FluxTubes/Shapes/Leakage/EighthOfHollowSphere.mo" | head
```
...
```modelica
// Magnetic/QuasiStatic/FluxTubes/Shapes/Leakage/EighthOfHollowSphere.mo:7
