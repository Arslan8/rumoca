# FINDING-03757: `rectifier.diode_p.idealDiode[2].Goff` in `DiodeCenterTap2mPulse`
...
| **Reached as** | `rectifier.diode_p.idealDiode[2].Goff` |
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:164:c4a76cae` |
...
```
predicate     rectifier.diode_p.idealDiode[2].Goff > 0
premise       refuted
...
| `required` | rectifier.diode_p.idealDiode[2].Goff &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.PowerConverters.Examples.ACDC.RectifierCenterTap2mPulse.DiodeCenterTap2mPulse \
      --target rectifier.diode_p.idealDiode[2].Goff --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "rectifier.diode_p.idealDiode[2].Goff"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param rectifier.diode_p.idealDiode[2].Goff=0
```
