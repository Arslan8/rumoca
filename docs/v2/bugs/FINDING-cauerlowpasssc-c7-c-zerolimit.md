# FINDING-00139: `C7.C` in `CauerLowPassSC`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:89:d73b20fa` |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.CauerLowPassSC \
      --target C7.C --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "C7.C"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param C7.C=0
```
