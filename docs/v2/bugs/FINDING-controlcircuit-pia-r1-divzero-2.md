# FINDING-00826: `PIA.R1` in `ControlCircuit`
...
| **Signature** | `divisor:divisor-reachable-zero:exp:233:19cc783e` |
...
constraints consulted  PIA.R1: unbounded
```
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.OpAmps.ControlCircuit \
      --target PIA.R1 --sanitizer divisor
```
