# FINDING-03804: `rectifier.thyristor_n.idealThyristor[2].Goff` in `ThyristorCenterTap2mPulse_RLV_Characteristic`
...
| **Reached as** | `rectifier.thyristor_n.idealThyristor[2].Goff` |
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:278:593a62df` |
...
```
predicate     rectifier.thyristor_n.idealThyristor[2].Goff > 0
premise       refuted
...
| `required` | rectifier.thyristor_n.idealThyristor[2].Goff &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.PowerConverters.Examples.ACDC.RectifierCenterTap2mPulse.ThyristorCenterTap2mPulse_RLV_Characteristic \
      --target rectifier.thyristor_n.idealThyristor[2].Goff --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "rectifier.thyristor_n.idealThyristor[2].Goff"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param rectifier.thyristor_n.idealThyristor[2].Goff=0
```
