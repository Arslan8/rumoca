# DECL-0038: `A` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Mechanics/Translational/Examples/Vehicle.mo:7` |
| **Parameter** | `A` |
| **Type** | `SI.Area` |
| **Declared modifiers** | `—` |
...
```console
$ sed -n '7p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Mechanics/Translational/Examples/Vehicle.mo"
```
...
```modelica
// Mechanics/Translational/Examples/Vehicle.mo:7
