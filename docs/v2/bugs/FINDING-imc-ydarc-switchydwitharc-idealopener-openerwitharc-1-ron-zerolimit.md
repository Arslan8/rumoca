# FINDING-02165: `switchYDwithArc.idealOpener.openerWithArc[1].Ron` in `IMC_YDarc`
...
| **Reached as** | `switchYDwithArc.idealOpener.openerWithArc[1].Ron` |
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:807:c7d3875d` |
...
```
predicate     switchYDwithArc.idealOpener.openerWithArc[1].Ron > 0
premise       refuted
...
| `required` | switchYDwithArc.idealOpener.openerWithArc[1].Ron &gt; 0 |
| `declared_min` | None |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.InductionMachines.IMC_YDarc \
      --target switchYDwithArc.idealOpener.openerWithArc[1].Ron --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "switchYDwithArc.idealOpener.openerWithArc[1].Ron"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param switchYDwithArc.idealOpener.openerWithArc[1].Ron=0
```
