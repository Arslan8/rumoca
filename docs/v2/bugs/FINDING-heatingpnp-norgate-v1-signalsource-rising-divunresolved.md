...
| **Signature** | `divisor:divisor-zero-unresolved:exp:646:dd11bb84` |
...
```
denominator            V1.signalSource.rising
witness                V1.signalSource.rising = 0
  found by             set to zero
denominator at witness 0.0
at declared values     5.0
path condition         not ((((time < V1.signalSource.startTime) or (V1.signalSource.nperiod == 0)) or ((V1.signalSource.nperiod > 0) and (V1.signalSource.count >= V1.signalSource.nperiod)))) and ((time < (V1.signalSource.T_start + V1.signalSource.T_rising)))
constraints consulted  V1.signalSource.rising: min=0
```
...
| `path_condition` | not ((((time &lt; V1.signalSource.startTime) or (V1.signalSource.nperiod == 0)) or ((V1.signalSource.nperiod &gt; 0) and (V1.signalSource.count &gt;= V1.signalSource.nperiod)))) and ((time &lt; (V1.signalSource.T_start + V1.signalSource.T_rising))) |
| `verdict` | UNKNOWN |
| `proof` | the path depends on quantities the artifact does not determine: (time &lt; (V1.signalSource.T_start + V1.signalSource.T_rising)); (time &lt; V1.signalSource.startTime) |
| `constraints` | V1.signalSource.rising: min=0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.HeatingPNP_NORGate \
      --target V1.signalSource.rising --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "V1.signalSource.rising"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check \
      --param V1.signalSource.rising=0
```
