# DECL-0447: `t` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Magnetic/FluxTubes/Examples/MovingCoilActuator/Components/PermeanceActuator.mo:15` |
| **Parameter** | `t` |
| **Type** | `SI.Length` |
| **Declared modifiers** | `—` |
...
```console
$ sed -n '15p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/FluxTubes/Examples/MovingCoilActuator/Components/PermeanceActuator.mo"
```
...
```modelica
// Magnetic/FluxTubes/Examples/MovingCoilActuator/Components/PermeanceActuator.mo:15
