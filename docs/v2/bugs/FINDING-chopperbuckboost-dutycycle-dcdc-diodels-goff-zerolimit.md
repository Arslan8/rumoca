# FINDING-04000: `dcdc.diodeLS.Goff` in `ChopperBuckBoost_DutyCycle`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:73:d20a4fb6` |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.PowerConverters.Examples.DCDC.ChopperBuckBoost.ChopperBuckBoost_DutyCycle \
      --target dcdc.diodeLS.Goff --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "dcdc.diodeLS.Goff"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param dcdc.diodeLS.Goff=0
```
