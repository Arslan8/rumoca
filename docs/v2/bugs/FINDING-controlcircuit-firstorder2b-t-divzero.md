...
| **Signature** | `divisor:divisor-reachable-zero:exp:1953:896bdfc1` |
...
| `constraints` | firstOrder2B.T: unbounded |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.OpAmps.ControlCircuit \
      --target firstOrder2B.T --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "firstOrder2B.T"
```
