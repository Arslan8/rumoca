# DECL-0142: `Lm` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Electrical/Machines/BasicMachines/InductionMachines/IM_SquirrelCage.mo:26` |
| **Parameter** | `Lm` |
| **Type** | `SI.Inductance` |
...
```modelica
// Electrical/Machines/BasicMachines/InductionMachines/IM_SquirrelCage.mo:26
