# FINDING-01081: `zDiode.Vt` in `OvervoltageProtection`
...
| **Signature** | `divisor:divisor-zero-unresolved:exp:365:df8c5ee4` |
...
constraints consulted  zDiode.Vt: unbounded
```
...
| `constraints` | zDiode.Vt: unbounded |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.OvervoltageProtection \
      --target zDiode.Vt --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "zDiode.Vt"
```
