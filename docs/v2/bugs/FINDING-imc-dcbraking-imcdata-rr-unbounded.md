# FINDING-01718: `imcData.Rr` in `IMC_DCBraking`
...
| **Signature** | `physical:physical-domain-unenforced:var:45:066d7c2d` |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.InductionMachines.IMC_DCBraking \
      --target imcData.Rr --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "imcData.Rr"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param imcData.Rr=0
```
