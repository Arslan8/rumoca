# FINDING-04361: `stopper_xMax.c` in `TranslatoryArmatureAndStopper`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:39:dcb12ae4` |
...
$ python3 tools/sweep/check_one.py Modelica.Magnetic.FluxTubes.Examples.Utilities.TranslatoryArmatureAndStopper \
      --target stopper_xMax.c --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "stopper_xMax.c"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param stopper_xMax.c=0
```
