# DECL-0316: `Jr` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Electrical/Machines/Interfaces/PartialBasicMachine.mo:5` |
| **Parameter** | `Jr` |
| **Type** | `SI.Inertia` |
| **Declared modifiers** | `—` |
...
```console
$ grep -n -- "-1e40\|-1E40" "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Machines/Interfaces/PartialBasicMachine.mo" | head
```
...
```modelica
// Electrical/Machines/Interfaces/PartialBasicMachine.mo:5
