# FINDING-04187: `lowerYoke.material.B_myMax` in `QuadraticCoreAirgap`
...
| **Reached as** | `lowerYoke.material.B_myMax` |
...
| **Signature** | `divisor:divisor-reachable-zero:exp:705:d57da75e` |
...
```
denominator            lowerYoke.material.B_myMax
witness                lowerYoke.material.B_myMax = 0
  found by             set to zero
denominator at witness 0.0
at declared values     1.0
path condition         always evaluated
constraints consulted  lowerYoke.material.B_myMax: unbounded
```
...
| `constraints` | lowerYoke.material.B_myMax: unbounded |
...
$ python3 tools/sweep/check_one.py Modelica.Magnetic.FluxTubes.Examples.BasicExamples.QuadraticCoreAirgap \
      --target lowerYoke.material.B_myMax --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "lowerYoke.material.B_myMax"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check \
      --param lowerYoke.material.B_myMax=0
```
