...
```
predicate     inverseInductor3.inductor.L > 0
premise       refuted
...
| `required` | inverseInductor3.inductor.L &gt; 0 |
| `declared_min` | None |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.GenerationOfFMUs \
      --target inverseInductor3.inductor.L --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "inverseInductor3.inductor.L"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param inverseInductor3.inductor.L=0
```
