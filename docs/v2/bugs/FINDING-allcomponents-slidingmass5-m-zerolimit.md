...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:150:c2f19269` |
...
$ python3 tools/sweep/check_one.py ModelicaTest.Translational.AllComponents \
      --target slidingMass5.m --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "slidingMass5.m"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param slidingMass5.m=0
```
