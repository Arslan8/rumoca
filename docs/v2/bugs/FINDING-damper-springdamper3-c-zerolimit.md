...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:76:01639d3d` |
...
$ python3 tools/sweep/check_one.py Modelica.Mechanics.Translational.Examples.Damper \
      --target springDamper3.c --sanitizer physical
```
...
```console
$ python3 tools/sweep/check_one.py Modelica.Mechanics.Translational.Examples.Damper --keep-artifact /tmp/m.rbc \
      --sanitizer physical >/dev/null
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "springDamper3.c"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param springDamper3.c=0
```
