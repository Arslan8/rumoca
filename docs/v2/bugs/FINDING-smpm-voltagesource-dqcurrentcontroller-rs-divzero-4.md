# FINDING-02864: `dqCurrentController.Rs` in `SMPM_VoltageSource`
...
| **Severity** | high |
| **Declaration** | `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Machines/Utilities/DQCurrentController.mo:66` |
| **Signature** | `divisor:divisor-reachable-zero:exp:1340:8ac48bec` |
...
```console
$ sed -n '66p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Machines/Utilities/DQCurrentController.mo"
```
...
```console
$ grep -rl '| `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Machines/Utilities/DQCurrentController.mo:66` |' docs/v2/bugs/
```
