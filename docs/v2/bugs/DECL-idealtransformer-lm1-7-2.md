# DECL-0198: `Lm1` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Electrical/Polyphase/Ideal/IdealTransformer.mo:7` |
| **Parameter** | `Lm1` |
| **Type** | `SI.Inductance` |
...
It should declare `Lm1` with type `SI.Inductance` and no `min`.
...
```console
$ grep -n -- "-1e40\|-1E40" "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Polyphase/Ideal/IdealTransformer.mo" | head
```
...
```modelica
// Electrical/Polyphase/Ideal/IdealTransformer.mo:7
