# FINDING-04244: `pmActuator.g_mb.r_i` in `ArmatureStroke`
...
| **Reached as** | `pmActuator.g_mb.r_i` |
...
| **Signature** | `divisor:divisor-reachable-zero:exp:1143:378583bf` |
...
```
denominator            pmActuator.g_mb.r_i
witness                pmActuator.g_mb.r_i = 0
  found by             set to zero
denominator at witness 0.0
at declared values     0.0125
path condition         always evaluated
constraints consulted  pmActuator.g_mb.r_i: min=0
```
...
| `constraints` | pmActuator.g_mb.r_i: min=0 |
...
$ python3 tools/sweep/check_one.py Modelica.Magnetic.FluxTubes.Examples.MovingCoilActuator.ArmatureStroke \
      --target pmActuator.g_mb.r_i --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "pmActuator.g_mb.r_i"
```
