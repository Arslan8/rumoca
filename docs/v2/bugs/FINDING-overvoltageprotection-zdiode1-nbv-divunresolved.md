# FINDING-01086: `zDiode1.Nbv` in `OvervoltageProtection`
...
| **Severity** | medium |
| **Declaration** | `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Analog/Semiconductors/ZDiode.mo:17` |
| **Signature** | `divisor:divisor-zero-unresolved:exp:459:f62a9c63` |
...
path condition         not ((zDiode1.v > (zDiode1.Maxexp * zDiode1.Vt))) and (((zDiode1.v + zDiode1.Bv) < -(zDiode1.Maxexp * (zDiode1.Nbv * zDiode1.Vt))))
...
| `path_condition` | not ((zDiode1.v &gt; (zDiode1.Maxexp * zDiode1.Vt))) and (((zDiode1.v + zDiode1.Bv) &lt; -(zDiode1.Maxexp * (zDiode1.Nbv * zDiode1.Vt)))) |
| `verdict` | UNKNOWN |
...
```console
$ sed -n '17p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Analog/Semiconductors/ZDiode.mo"
```
...
```console
$ grep -rl '| `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Analog/Semiconductors/ZDiode.mo:17` |' docs/v2/bugs/
```
