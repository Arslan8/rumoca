# DECL-0101: `Linf` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Electrical/Analog/Basic/SaturatingInductor.mo:14` |
| **Parameter** | `Linf` |
| **Type** | `SI.Inductance` |
| **Declared modifiers** | `(start=Lnom/2)` |
...
```console
$ grep -n -- "-1e40\|-1E40" "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Analog/Basic/SaturatingInductor.mo" | head
```
...
```modelica
// Electrical/Analog/Basic/SaturatingInductor.mo:14
