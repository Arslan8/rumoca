# FINDING-00914: `k` in `InvertingSchmittTrigger`
...
| **Signature** | `divisor:divisor-reachable-zero:exp:22:0e07e78a` |
...
at declared values     0.06666666666666667
path condition         always evaluated
constraints consulted  k: unbounded
```
