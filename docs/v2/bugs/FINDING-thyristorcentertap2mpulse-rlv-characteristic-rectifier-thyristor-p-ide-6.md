# FINDING-03798: `rectifier.thyristor_p.idealThyristor[3].Goff` in `ThyristorCenterTap2mPulse_RLV_Characteristic`
...
| **Reached as** | `rectifier.thyristor_p.idealThyristor[3].Goff` |
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:217:f92febee` |
...
```
predicate     rectifier.thyristor_p.idealThyristor[3].Goff > 0
premise       refuted
...
| `required` | rectifier.thyristor_p.idealThyristor[3].Goff &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.PowerConverters.Examples.ACDC.RectifierCenterTap2mPulse.ThyristorCenterTap2mPulse_RLV_Characteristic \
      --target rectifier.thyristor_p.idealThyristor[3].Goff --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "rectifier.thyristor_p.idealThyristor[3].Goff"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param rectifier.thyristor_p.idealThyristor[3].Goff=0
```
