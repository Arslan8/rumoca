# FINDING-02077: `idealCommutingSwitch.idealCommutingSwitch[1].Ron` in `IMC_Transformer`
...
| **Reached as** | `idealCommutingSwitch.idealCommutingSwitch[1].Ron` |
...
| **Signature** | `physical:physical-rule-does-not-apply:var:1123:9f89a2f2` |
...
```
predicate     idealCommutingSwitch.idealCommutingSwitch[1].Ron > 0
premise       refuted
...
| `required` | idealCommutingSwitch.idealCommutingSwitch[1].Ron &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.InductionMachines.IMC_Transformer \
      --target idealCommutingSwitch.idealCommutingSwitch[1].Ron --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "idealCommutingSwitch.idealCommutingSwitch[1].Ron"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param idealCommutingSwitch.idealCommutingSwitch[1].Ron=0
```
