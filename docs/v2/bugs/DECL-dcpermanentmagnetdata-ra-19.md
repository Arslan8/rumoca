...
| **Declaration** | `Electrical/Machines/Utilities/ParameterRecords/DcPermanentMagnetData.mo:19` |
| **Parameter** | `Ra` |
| **Type** | `SI.Resistance` |
| **Declared modifiers** | `—` |
...
```modelica
// Electrical/Machines/Utilities/ParameterRecords/DcPermanentMagnetData.mo:19
