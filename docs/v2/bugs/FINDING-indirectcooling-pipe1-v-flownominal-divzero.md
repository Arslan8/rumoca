# FINDING-04807: `pipe1.V_flowNominal` in `IndirectCooling`
...
| **Signature** | `divisor:divisor-reachable-zero:exp:302:5b46a1e2` |
...
witness                pipe1.V_flowNominal = 1
  found by             at its declared minimum
denominator at witness 0.0
at declared values     1.0
path condition         always evaluated
constraints consulted  pipe1.V_flowNominal: min=1, assert pipe1.V_flowNominal greater 1
```
...
| `constraints` | pipe1.V_flowNominal: min=1, assert pipe1.V_flowNominal greater 1 |
