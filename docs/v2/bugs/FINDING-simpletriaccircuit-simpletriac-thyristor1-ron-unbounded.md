# FINDING-01150: `simpleTriac.thyristor1.Ron` in `SimpleTriacCircuit`
...
| **Signature** | `physical:physical-domain-unenforced:var:127:23b7e53d` |
...
```
predicate     simpleTriac.thyristor1.Ron > 0
premise       established
...
| `required` | simpleTriac.thyristor1.Ron &gt; 0 |
| `declared_min` | None |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.SimpleTriacCircuit \
      --target simpleTriac.thyristor1.Ron --sanitizer physical
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param simpleTriac.thyristor1.Ron=0
```
