# FINDING-05153: `C` in `DirectCapacity`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:0:c47cde30` |
...
```
contract    Modelica.Thermal.HeatTransfer.Components.HeatCapacitor.C: algebraic_limit (proven, from equation) — inherited from heatCapacitor.C, which it binds: the parameter multiplies a derivative, so at zero the differential relation becomes an algebraic constraint rather than an undefined quotient
