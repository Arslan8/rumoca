# FINDING-04505: `body1.m` in `PointGravityWithPointMasses`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:232:b7037885` |
...
$ python3 tools/sweep/check_one.py Modelica.Mechanics.MultiBody.Examples.Elementary.PointGravityWithPointMasses \
      --target body1.m --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "body1.m"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param body1.m=0
```
