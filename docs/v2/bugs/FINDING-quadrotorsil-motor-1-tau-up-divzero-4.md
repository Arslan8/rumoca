...
| **Signature** | `divisor:divisor-reachable-zero:exp:387:cacb30a4` |
...
| `constraints` | motor[1].tau_up: unbounded |
...
$ python3 tools/sweep/check_one.py RigidBody.Examples.QuadrotorSIL \
      --target motor[1].tau_up --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "motor[1].tau_up"
```
