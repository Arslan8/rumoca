# FINDING-02006: `cRun.C` in `IMC_Steinmetz`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:545:b85bb1d2` |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.InductionMachines.IMC_Steinmetz \
      --target cRun.C --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "cRun.C"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param cRun.C=0
```
