...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:108:d96bdeb2` |
...
$ python3 tools/sweep/check_one.py ModelicaTest.Rotational.TestBraking \
      --target inertia6.J --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "inertia6.J"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param inertia6.J=0
```
