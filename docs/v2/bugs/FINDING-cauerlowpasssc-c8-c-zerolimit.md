# FINDING-00140: `C8.C` in `CauerLowPassSC`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:96:f59710bf` |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.CauerLowPassSC \
      --target C8.C --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "C8.C"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param C8.C=0
```
