...
| **Signature** | `divisor:divisor-zero-unresolved:exp:487:f7f6f2a6` |
...
path condition         ((simpleTriac.thyristor.vGK < simpleTriac.thyristor.vRef))
...
| `path_condition` | ((simpleTriac.thyristor.vGK &lt; simpleTriac.thyristor.vRef)) |
| `verdict` | UNKNOWN |
