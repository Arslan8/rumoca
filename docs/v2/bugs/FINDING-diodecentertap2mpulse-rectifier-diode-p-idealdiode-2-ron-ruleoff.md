# FINDING-03756: `rectifier.diode_p.idealDiode[2].Ron` in `DiodeCenterTap2mPulse`
...
```
predicate     rectifier.diode_p.idealDiode[2].Ron > 0
premise       refuted
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.PowerConverters.Examples.ACDC.RectifierCenterTap2mPulse.DiodeCenterTap2mPulse \
      --target rectifier.diode_p.idealDiode[2].Ron --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "rectifier.diode_p.idealDiode[2].Ron"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param rectifier.diode_p.idealDiode[2].Ron=0
```
