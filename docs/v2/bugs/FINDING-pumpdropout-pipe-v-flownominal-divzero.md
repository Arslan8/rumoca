# FINDING-04994: `pipe.V_flowNominal` in `PumpDropOut`
...
| **Signature** | `divisor:divisor-reachable-zero:exp:223:0b8398b8` |
...
witness                pipe.V_flowNominal = 0.1
  found by             at its declared minimum
denominator at witness 0.0
at declared values     0.81
path condition         always evaluated
constraints consulted  pipe.V_flowNominal: min=0.1, assert pipe.V_flowNominal greater 0.1
```
...
| `constraints` | pipe.V_flowNominal: min=0.1, assert pipe.V_flowNominal greater 0.1 |
