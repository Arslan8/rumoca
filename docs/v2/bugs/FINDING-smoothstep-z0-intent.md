# FINDING-00570: `z0` in `SmoothStep`
...
| **Severity** | low |
| **Declaration** | `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Analog/Examples/Lines/SmoothStep.mo:17` |
| **Signature** | `physical:physical-intent-question:var:11:1b35a2c8` |
...
role          —
declaration   Modelica.Electrical.Analog.Examples.Lines.SmoothStep.z0
```
...
```
{'quantity': 'Resistance', 'unit': 'Ohm', 'confidence': 'QUANTITY_AND_UNIT', 'premise_state': 'unknown', 'authority': 'quantity_or_unit', 'canonical_declaration': 'Modelica.Electrical.Analog.Examples.Lines.SmoothStep.z0'}
```
...
| `authority` | quantity_or_unit |
| `canonical_declaration` | Modelica.Electrical.Analog.Examples.Lines.SmoothStep.z0 |
...
```console
$ sed -n '17p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Analog/Examples/Lines/SmoothStep.mo"
```
...
```console
$ grep -rl '| `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Analog/Examples/Lines/SmoothStep.mo:17` |' docs/v2/bugs/
```
