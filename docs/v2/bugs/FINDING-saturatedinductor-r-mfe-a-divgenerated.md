# FINDING-04196: `r_mFe.a` in `SaturatedInductor`
...
| **Signature** | `divisor:divisor-introduced-by-translation:exp:437:6ed3ac4d` |
...
constraints consulted  r_mFe.a: unbounded
```
...
$ python3 tools/sweep/check_one.py Modelica.Magnetic.FluxTubes.Examples.BasicExamples.SaturatedInductor \
      --target r_mFe.a --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "r_mFe.a"
```
