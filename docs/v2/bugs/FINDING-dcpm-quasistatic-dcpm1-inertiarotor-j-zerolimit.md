# FINDING-01543: `dcpm1.inertiaRotor.J` in `DCPM_QuasiStatic`
...
| **Reached as** | `dcpm1.inertiaRotor.J` |
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:206:e7e18808` |
...
```
predicate     dcpm1.inertiaRotor.J > 0
premise       refuted
...
| `required` | dcpm1.inertiaRotor.J &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.DCMachines.DCPM_QuasiStatic \
      --target dcpm1.inertiaRotor.J --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "dcpm1.inertiaRotor.J"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param dcpm1.inertiaRotor.J=0
```
