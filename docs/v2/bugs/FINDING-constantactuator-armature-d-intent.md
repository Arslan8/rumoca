# FINDING-04258: `armature.d` in `ConstantActuator`
...
| **Signature** | `physical:physical-intent-question:var:26:0687074d` |
...
```console
$ python3 tools/sweep/check_one.py Modelica.Magnetic.FluxTubes.Examples.MovingCoilActuator.Components.ConstantActuator \
...
```console
$ python3 tools/sweep/check_one.py Modelica.Magnetic.FluxTubes.Examples.MovingCoilActuator.Components.ConstantActuator --keep-artifact /tmp/m.rbc \
