...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:123:720f9e35` |
...
$ python3 tools/sweep/check_one.py ModelicaTest.Translational.AllComponents \
      --target slidingMass4.m --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "slidingMass4.m"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param slidingMass4.m=0
```
