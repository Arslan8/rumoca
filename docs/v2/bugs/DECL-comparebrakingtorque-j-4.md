# DECL-0365: `J` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Mechanics/Rotational/Examples/CompareBrakingTorque.mo:4` |
| **Parameter** | `J` |
| **Type** | `SI.Inertia` |
| **Declared modifiers** | `—` |
...
```console
$ grep -n -- "-1e40\|-1E40" "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Mechanics/Rotational/Examples/CompareBrakingTorque.mo" | head
```
...
```modelica
// Mechanics/Rotational/Examples/CompareBrakingTorque.mo:4
