# FINDING-00932: `f` in `LCOscillator`
...
| **Signature** | `divisor:divisor-reachable-zero:exp:21:6e9fb1ce` |
...
```
denominator            ((((2 * (2 * asin(1.0))) * f) ^ 2) * L)
witness                f = 0
  found by             set to zero
denominator at witness 0.0
at declared values     39478.417604357426
...
| `denominator_at_declared_values` | 39478.417604357426 |
