# FINDING-02166: `switchYDwithArc.idealOpener.openerWithArc[1].Goff` in `IMC_YDarc`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:808:bc892a61` |
...
```
predicate     switchYDwithArc.idealOpener.openerWithArc[1].Goff > 0
premise       refuted
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.InductionMachines.IMC_YDarc \
      --target switchYDwithArc.idealOpener.openerWithArc[1].Goff --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "switchYDwithArc.idealOpener.openerWithArc[1].Goff"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param switchYDwithArc.idealOpener.openerWithArc[1].Goff=0
```
