# DECL-0827: `R` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Magnetic/FluxTubes/Examples/MovingCoilActuator/Components/PermeanceActuator.mo:8` |
| **Parameter** | `R` |
| **Type** | `SI.Resistance` |
| **Declared modifiers** | `—` |
...
```modelica
// Magnetic/FluxTubes/Examples/MovingCoilActuator/Components/PermeanceActuator.mo:8
