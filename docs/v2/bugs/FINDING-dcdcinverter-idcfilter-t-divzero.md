...
| **Signature** | `divisor:divisor-reachable-zero:exp:439:0f1c7a94` |
...
| `constraints` | iDCFilter.T: unbounded |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.ControlledDCDrives.Utilities.DcdcInverter \
      --target iDCFilter.T --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "iDCFilter.T"
```
