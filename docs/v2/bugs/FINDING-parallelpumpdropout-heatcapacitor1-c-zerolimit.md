# FINDING-04901: `heatCapacitor1.C` in `ParallelPumpDropOut`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:259:bff1497c` |
...
$ python3 tools/sweep/check_one.py Modelica.Thermal.FluidHeatFlow.Examples.ParallelPumpDropOut \
      --target heatCapacitor1.C --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "heatCapacitor1.C"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param heatCapacitor1.C=0
```
