# FINDING-00320: `HeatCapacitor1.C` in `HeatingMOSInverter`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:27:c3d0f4e0` |
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.HeatingMOSInverter \
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.HeatingMOSInverter --keep-artifact /tmp/m.rbc \
