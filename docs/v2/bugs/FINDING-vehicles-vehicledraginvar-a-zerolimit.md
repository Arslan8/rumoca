...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:237:71b8cf3d` |
...
```
predicate     vehicleDragInVar.A > 0
premise       refuted
...
$ python3 tools/sweep/check_one.py ModelicaTest.Translational.Vehicles \
      --target vehicleDragInVar.A --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "vehicleDragInVar.A"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param vehicleDragInVar.A=0
```
