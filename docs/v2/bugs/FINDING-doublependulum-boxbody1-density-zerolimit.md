# FINDING-04385: `boxBody1.density` in `DoublePendulum`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:320:1deda0ae` |
...
$ python3 tools/sweep/check_one.py Modelica.Mechanics.MultiBody.Examples.Elementary.DoublePendulum \
      --target boxBody1.density --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "boxBody1.density"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param boxBody1.density=0
```
