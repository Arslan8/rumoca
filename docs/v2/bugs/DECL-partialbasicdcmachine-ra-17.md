...
| **Declaration** | `Electrical/Machines/Interfaces/PartialBasicDCMachine.mo:17` |
| **Parameter** | `Ra` |
| **Type** | `SI.Resistance` |
| **Declared modifiers** | `(start=0.05)` |
...
```modelica
// Electrical/Machines/Interfaces/PartialBasicDCMachine.mo:17
