# FINDING-00279: `Transistor1.Tr.Ccs` in `DifferenceAmplifier`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:203:d9437816` |
...
```
predicate     Transistor1.Tr.Ccs > 0
premise       refuted
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.DifferenceAmplifier \
      --target Transistor1.Tr.Ccs --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "Transistor1.Tr.Ccs"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param Transistor1.Tr.Ccs=0
```
