# FINDING-02958: `smr.damperCage.Rrd` in `SMR_Inverter`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:411:14173623` |
...
```
predicate     smr.damperCage.Rrd >= 0
premise       refuted
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.SynchronousMachines.SMR_Inverter \
      --target smr.damperCage.Rrd --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "smr.damperCage.Rrd"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param smr.damperCage.Rrd=0
```
