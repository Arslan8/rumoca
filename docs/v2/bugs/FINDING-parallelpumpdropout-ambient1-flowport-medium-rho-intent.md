...
| **Signature** | `physical:physical-intent-question:var:22:341988bb` |
...
```
predicate     ambient1.flowPort.medium.rho > 0
premise       unknown
...
| `required` | ambient1.flowPort.medium.rho &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Thermal.FluidHeatFlow.Examples.ParallelPumpDropOut \
      --target ambient1.flowPort.medium.rho --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "ambient1.flowPort.medium.rho"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param ambient1.flowPort.medium.rho=0
```
