# FINDING-01199: `thyristor_v4_1.Roff` in `ThyristorBehaviourTest`
...
| **Signature** | `physical:physical-domain-unenforced:var:87:dbda5e93` |
...
```
predicate     thyristor_v4_1.Roff > 0
premise       established
...
| `required` | thyristor_v4_1.Roff &gt; 0 |
| `declared_min` | None |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.ThyristorBehaviourTest \
      --target thyristor_v4_1.Roff --sanitizer physical
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param thyristor_v4_1.Roff=0
```
