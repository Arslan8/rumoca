# FINDING-00923: `f` in `InvertingSchmittTrigger`
...
| **Severity** | high |
| **Declaration** | `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Analog/Examples/OpAmps/InvertingSchmittTrigger.mo:23` |
| **Signature** | `divisor:divisor-reachable-zero:exp:128:3f42bd73` |
...
```console
$ sed -n '23p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Analog/Examples/OpAmps/InvertingSchmittTrigger.mo"
```
...
```console
$ grep -rl '| `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Analog/Examples/OpAmps/InvertingSchmittTrigger.mo:23` |' docs/v2/bugs/
```
