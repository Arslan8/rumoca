# FINDING-02976: `smr.fsNominal` in `SMR_Inverter`
...
| **Signature** | `divisor:divisor-reachable-zero:exp:1823:4b88432b` |
...
| `constraints` | smr.fsNominal: unbounded |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.SynchronousMachines.SMR_Inverter \
      --target smr.fsNominal --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "smr.fsNominal"
```
