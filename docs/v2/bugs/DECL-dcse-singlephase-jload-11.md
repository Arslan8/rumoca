# DECL-0295: `JLoad` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Electrical/Machines/Examples/DCMachines/DCSE_SinglePhase.mo:11` |
| **Parameter** | `JLoad` |
| **Type** | `SI.Inertia` |
| **Declared modifiers** | `—` |
...
```console
$ grep -n -- "-1e40\|-1E40" "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Machines/Examples/DCMachines/DCSE_SinglePhase.mo" | head
```
...
```modelica
// Electrical/Machines/Examples/DCMachines/DCSE_SinglePhase.mo:11
