# FINDING-03133: `diode2.idealDiode[2].Goff` in `Rectifier12pulse`
...
| **Reached as** | `diode2.idealDiode[2].Goff` |
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:250:48b53fa7` |
...
```
predicate     diode2.idealDiode[2].Goff > 0
premise       refuted
...
| `required` | diode2.idealDiode[2].Goff &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.Transformers.Rectifier12pulse \
      --target diode2.idealDiode[2].Goff --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "diode2.idealDiode[2].Goff"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param diode2.idealDiode[2].Goff=0
```
