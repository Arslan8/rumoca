# FINDING-04194: `r_mAirPar.l` in `SaturatedInductor`
...
| **Signature** | `divisor:divisor-reachable-zero:exp:392:c03ac8a5` |
...
| `constraints` | r_mAirPar.l: unbounded |
...
$ python3 tools/sweep/check_one.py Modelica.Magnetic.FluxTubes.Examples.BasicExamples.SaturatedInductor \
      --target r_mAirPar.l --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "r_mAirPar.l"
```
