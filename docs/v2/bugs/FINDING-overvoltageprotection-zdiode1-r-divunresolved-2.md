# FINDING-01087: `zDiode1.R` in `OvervoltageProtection`
...
| **Signature** | `divisor:divisor-zero-unresolved:exp:467:f6467348` |
...
| `denominator_at_declared_values` | 100000000.0 |
...
| `constraints` | zDiode1.R: unbounded |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.OvervoltageProtection \
      --target zDiode1.R --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "zDiode1.R"
```
