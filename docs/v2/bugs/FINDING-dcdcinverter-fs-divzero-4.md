# FINDING-01279: `fS` in `DcdcInverter`
...
| **Signature** | `divisor:divisor-reachable-zero:exp:13:2b23b494` |
...
constraints consulted  fS: unbounded
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "fS"
```
