# FINDING-03132: `diode2.idealDiode[2].Ron` in `Rectifier12pulse`
...
| **Reached as** | `diode2.idealDiode[2].Ron` |
...
| **Signature** | `physical:physical-rule-does-not-apply:var:249:11ea2a7c` |
...
```
predicate     diode2.idealDiode[2].Ron > 0
premise       refuted
...
| `required` | diode2.idealDiode[2].Ron &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.Transformers.Rectifier12pulse \
      --target diode2.idealDiode[2].Ron --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "diode2.idealDiode[2].Ron"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param diode2.idealDiode[2].Ron=0
```
