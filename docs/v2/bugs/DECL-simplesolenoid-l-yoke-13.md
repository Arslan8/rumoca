# DECL-0456: `l_yoke` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Magnetic/FluxTubes/Examples/SolenoidActuator/Components/SimpleSolenoid.mo:13` |
| **Parameter** | `l_yoke` |
| **Type** | `SI.Length` |
| **Declared modifiers** | `—` |
...
```console
$ sed -n '13p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/FluxTubes/Examples/SolenoidActuator/Components/SimpleSolenoid.mo"
```
...
```modelica
// Magnetic/FluxTubes/Examples/SolenoidActuator/Components/SimpleSolenoid.mo:13
