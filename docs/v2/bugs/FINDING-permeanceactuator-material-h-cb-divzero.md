...
| **Signature** | `divisor:divisor-reachable-zero:exp:46:e93caf96` |
...
```
denominator            (1.25663706212e-06 * material.H_cB)
witness                material.H_cB = 0
  found by             set to zero
denominator at witness 0.0
at declared values     1.25663706212e-06
path condition         always evaluated
constraints consulted  material.H_cB: unbounded
```
...
$ python3 tools/sweep/check_one.py Modelica.Magnetic.FluxTubes.Examples.MovingCoilActuator.Components.PermeanceActuator \
      --target material.H_cB --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "material.H_cB"
```
