# DECL-0520: `r3b` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Mechanics/MultiBody/Examples/Loops/PlanarLoops_analytic.mo:20` |
| **Parameter** | `r3b` |
| **Type** | `SI.Length` |
| **Declared modifiers** | `—` |
...
```console
$ sed -n '20p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Mechanics/MultiBody/Examples/Loops/PlanarLoops_analytic.mo"
```

It should declare `r3b` with type `SI.Length` and no `min`.
...
```modelica
// Mechanics/MultiBody/Examples/Loops/PlanarLoops_analytic.mo:20
parameter SI.Length r3b(min=0) = ...;
```
