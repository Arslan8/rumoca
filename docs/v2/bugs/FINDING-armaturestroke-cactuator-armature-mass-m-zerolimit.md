# FINDING-04235: `cActuator.armature.mass.m` in `ArmatureStroke`
...
| **Reached as** | `cActuator.armature.mass.m` |
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:282:d29e3881` |
...
```
predicate     cActuator.armature.mass.m > 0
premise       refuted
...
| `required` | cActuator.armature.mass.m &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Magnetic.FluxTubes.Examples.MovingCoilActuator.ArmatureStroke \
      --target cActuator.armature.mass.m --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "cActuator.armature.mass.m"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param cActuator.armature.mass.m=0
```
