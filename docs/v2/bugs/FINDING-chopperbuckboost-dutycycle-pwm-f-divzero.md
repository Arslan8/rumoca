# FINDING-04010: `pwm.f` in `ChopperBuckBoost_DutyCycle`
...
| **Signature** | `divisor:divisor-reachable-zero:exp:402:46c79c37` |
...
at declared values     40000.0
path condition         always evaluated
constraints consulted  pwm.f: unbounded
```
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.PowerConverters.Examples.DCDC.ChopperBuckBoost.ChopperBuckBoost_DutyCycle \
      --target pwm.f --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "pwm.f"
```
