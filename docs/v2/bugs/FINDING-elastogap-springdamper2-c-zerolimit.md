...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:40:ac8624af` |
...
$ python3 tools/sweep/check_one.py Modelica.Mechanics.Translational.Examples.ElastoGap \
      --target springDamper2.c --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "springDamper2.c"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param springDamper2.c=0
```
