# FINDING-04460: `body2.m` in `PointGravity`

|  |  |
|---|---|
| **Tier** | **Candidate** — static only, not execution-confirmed |
| **Model** | `Modelica.Mechanics.MultiBody.Examples.Elementary.PointGravity` |
| **Reached as** | `body2.m` |
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:303:ea5b5924` |
...
```console
$ python3 tools/sweep/check_one.py Modelica.Mechanics.MultiBody.Examples.Elementary.PointGravity \
...
```console
$ python3 tools/sweep/check_one.py Modelica.Mechanics.MultiBody.Examples.Elementary.PointGravity --keep-artifact /tmp/m.rbc \
