# FINDING-02356: `smee.Lrsigmaq` in `SMEE_DOL`
...
| **Signature** | `physical:physical-intent-question:var:416:3572d3a9` |
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.SynchronousMachines.SMEE_DOL \
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.SynchronousMachines.SMEE_DOL --keep-artifact /tmp/m.rbc \
