# FINDING-04716: `mass3a.m` in `GenerationOfFMUs`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:277:76420f06` |
...
$ python3 tools/sweep/check_one.py Modelica.Mechanics.Translational.Examples.GenerationOfFMUs \
      --target mass3a.m --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "mass3a.m"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param mass3a.m=0
```
