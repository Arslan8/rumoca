# FINDING-02444: `smee.inertiaRotor.J` in `SMEE_Generator`
...
| **Reached as** | `smee.inertiaRotor.J` |
...
```
predicate     smee.inertiaRotor.J > 0
premise       refuted
...
| `required` | smee.inertiaRotor.J &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.SynchronousMachines.SMEE_Generator \
      --target smee.inertiaRotor.J --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "smee.inertiaRotor.J"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param smee.inertiaRotor.J=0
```
