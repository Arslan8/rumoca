...
| **Signature** | `divisor:divisor-reachable-zero:exp:1129:4f34a90a` |
...
| `constraints` | g_mFeArm.r_o: min=0 |
...
$ python3 tools/sweep/check_one.py Modelica.Magnetic.FluxTubes.Examples.SolenoidActuator.Components.AdvancedSolenoid \
      --target g_mFeArm.r_o --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "g_mFeArm.r_o"
```
