# FINDING-03121: `diode1.Goff` in `Rectifier12pulse`
...
| **Signature** | `physical:physical-rule-does-not-apply:var:146:23ddbac0` |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.Transformers.Rectifier12pulse \
      --target diode1.Goff --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "diode1.Goff"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param diode1.Goff=0
```
