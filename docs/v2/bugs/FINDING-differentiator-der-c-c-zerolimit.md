# FINDING-00844: `der_.c.C` in `Differentiator`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:84:fe31d2d4` |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.OpAmps.Differentiator \
      --target der_.c.C --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "der_.c.C"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param der_.c.C=0
```
