# FINDING-04675: `inertia.J` in `DirectInertia`
...
```console
$ python3 tools/sweep/check_one.py Modelica.Mechanics.Rotational.Examples.Utilities.DirectInertia \
...
```console
$ python3 tools/sweep/check_one.py Modelica.Mechanics.Rotational.Examples.Utilities.DirectInertia --keep-artifact /tmp/m.rbc \
