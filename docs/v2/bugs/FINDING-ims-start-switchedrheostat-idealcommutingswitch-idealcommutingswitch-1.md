# FINDING-02300: `switchedRheostat.idealCommutingSwitch.idealCommutingSwitch[1].Ron` in `IMS_Start`
...
| **Reached as** | `switchedRheostat.idealCommutingSwitch.idealCommutingSwitch[1].Ron` |
...
| **Signature** | `physical:physical-rule-does-not-apply:var:940:26af91fc` |
...
```
predicate     switchedRheostat.idealCommutingSwitch.idealCommutingSwitch[1].Ron > 0
premise       refuted
...
| `required` | switchedRheostat.idealCommutingSwitch.idealCommutingSwitch[1].Ron &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.InductionMachines.IMS_Start \
      --target switchedRheostat.idealCommutingSwitch.idealCommutingSwitch[1].Ron --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "switchedRheostat.idealCommutingSwitch.idealCommutingSwitch[1].Ron"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param switchedRheostat.idealCommutingSwitch.idealCommutingSwitch[1].Ron=0
```
