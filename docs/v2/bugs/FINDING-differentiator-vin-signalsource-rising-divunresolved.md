# FINDING-00846: `vIn.signalSource.rising` in `Differentiator`
...
| **Signature** | `divisor:divisor-zero-unresolved:exp:283:6df3edc5` |
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.OpAmps.Differentiator \
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.OpAmps.Differentiator --keep-artifact /tmp/m.rbc \
