# FINDING-04668: `inertia1.J` in `First`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:20:36ec614e` |
...
```console
$ python3 tools/sweep/check_one.py Modelica.Mechanics.Rotational.Examples.First \
...
```console
$ python3 tools/sweep/check_one.py Modelica.Mechanics.Rotational.Examples.First --keep-artifact /tmp/m.rbc \
