# DECL-0072: `GoffTransistor` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Electrical/PowerConverters/DCDC/ChopperStepDown.mo:7` |
...
```console
$ grep -n -- "-1e40\|-1E40" "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/PowerConverters/DCDC/ChopperStepDown.mo" | head
```
...
```modelica
// Electrical/PowerConverters/DCDC/ChopperStepDown.mo:7
