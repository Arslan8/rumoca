# FINDING-01728: `imc.inertiaStator.J` in `IMC_DCBraking`
...
| **Reached as** | `imc.inertiaStator.J` |
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:378:7df15ef1` |
...
```
predicate     imc.inertiaStator.J > 0
premise       refuted
...
| `required` | imc.inertiaStator.J &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.InductionMachines.IMC_DCBraking \
      --target imc.inertiaStator.J --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "imc.inertiaStator.J"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param imc.inertiaStator.J=0
```
