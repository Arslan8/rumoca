# FINDING-00960: `R` in `Multivibrator`
...
| **Signature** | `divisor:divisor-reachable-zero:exp:27:7140b2f0` |
...
```
denominator            ((2 * R) * log((1 + ((2 * R1) / R2))))
witness                R = 0
  found by             set to zero
denominator at witness 0.0
at declared values     2197.2245773362197
...
| `denominator_at_declared_values` | 2197.2245773362197 |
