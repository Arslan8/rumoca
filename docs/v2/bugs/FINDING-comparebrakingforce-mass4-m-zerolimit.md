# FINDING-04689: `mass4.m` in `CompareBrakingForce`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:68:dfe7c773` |
...
$ python3 tools/sweep/check_one.py Modelica.Mechanics.Translational.Examples.CompareBrakingForce \
      --target mass4.m --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "mass4.m"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param mass4.m=0
```
