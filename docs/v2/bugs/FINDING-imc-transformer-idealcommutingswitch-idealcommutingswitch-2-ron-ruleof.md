# FINDING-02079: `idealCommutingSwitch.idealCommutingSwitch[2].Ron` in `IMC_Transformer`
...
| **Reached as** | `idealCommutingSwitch.idealCommutingSwitch[2].Ron` |
...
| **Signature** | `physical:physical-rule-does-not-apply:var:1140:1e7e3e93` |
...
```
predicate     idealCommutingSwitch.idealCommutingSwitch[2].Ron > 0
premise       refuted
...
| `required` | idealCommutingSwitch.idealCommutingSwitch[2].Ron &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.InductionMachines.IMC_Transformer \
      --target idealCommutingSwitch.idealCommutingSwitch[2].Ron --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "idealCommutingSwitch.idealCommutingSwitch[2].Ron"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param idealCommutingSwitch.idealCommutingSwitch[2].Ron=0
```
