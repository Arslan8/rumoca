...
| **Reached as** | `directCapacitor1.capacitor.C` |
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:14:9732c5d0` |
...
```
predicate     directCapacitor1.capacitor.C > 0
premise       refuted
...
| `required` | directCapacitor1.capacitor.C &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.GenerationOfFMUs \
      --target directCapacitor1.capacitor.C --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "directCapacitor1.capacitor.C"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param directCapacitor1.capacitor.C=0
```
