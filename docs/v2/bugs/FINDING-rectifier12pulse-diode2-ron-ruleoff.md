# FINDING-03128: `diode2.Ron` in `Rectifier12pulse`
...
| **Signature** | `physical:physical-rule-does-not-apply:var:229:026e648d` |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.Transformers.Rectifier12pulse \
      --target diode2.Ron --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "diode2.Ron"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param diode2.Ron=0
```
