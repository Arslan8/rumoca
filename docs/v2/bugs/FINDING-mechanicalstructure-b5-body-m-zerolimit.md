# FINDING-04615: `b5.body.m` in `MechanicalStructure`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:1068:79ff9ffb` |
...
$ python3 tools/sweep/check_one.py Modelica.Mechanics.MultiBody.Examples.Systems.RobotR3.Utilities.MechanicalStructure \
      --target b5.body.m --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "b5.body.m"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param b5.body.m=0
```
