# DECL-0705: `RL` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Electrical/Machines/Examples/Transformers/Rectifier6pulse.mo:8` |
| **Parameter** | `RL` |
| **Type** | `SI.Resistance` |
| **Declared modifiers** | `—` |
...
```console
$ grep -n -- "-1e40\|-1E40" "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Machines/Examples/Transformers/Rectifier6pulse.mo" | head
```
...
```modelica
// Electrical/Machines/Examples/Transformers/Rectifier6pulse.mo:8
