# FINDING-04613: `b4.body.m` in `MechanicalStructure`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:943:21cd8587` |
...
$ python3 tools/sweep/check_one.py Modelica.Mechanics.MultiBody.Examples.Systems.RobotR3.Utilities.MechanicalStructure \
      --target b4.body.m --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "b4.body.m"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param b4.body.m=0
```
