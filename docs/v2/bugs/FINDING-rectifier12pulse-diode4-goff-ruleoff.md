# FINDING-03165: `diode4.Goff` in `Rectifier12pulse`
...
| **Signature** | `physical:physical-rule-does-not-apply:var:884:7c854b42` |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.Transformers.Rectifier12pulse \
      --target diode4.Goff --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "diode4.Goff"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param diode4.Goff=0
```
