...
| **Signature** | `physical:physical-intent-question:var:764:cd528823` |
...
```
predicate     dcdcInverter2.GoffT > 0
premise       unknown
...
| `required` | dcdcInverter2.GoffT &gt; 0 |
| `declared_min` | None |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.DCMachines.DCPM_Drive \
      --target dcdcInverter2.GoffT --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "dcdcInverter2.GoffT"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param dcdcInverter2.GoffT=0
```
