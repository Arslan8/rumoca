# FINDING-02302: `switchedRheostat.idealCommutingSwitch.idealCommutingSwitch[2].Ron` in `IMS_Start`
...
| **Reached as** | `switchedRheostat.idealCommutingSwitch.idealCommutingSwitch[2].Ron` |
...
| **Signature** | `physical:physical-rule-does-not-apply:var:957:c5ff202b` |
...
```
predicate     switchedRheostat.idealCommutingSwitch.idealCommutingSwitch[2].Ron > 0
premise       refuted
...
| `required` | switchedRheostat.idealCommutingSwitch.idealCommutingSwitch[2].Ron &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.InductionMachines.IMS_Start \
      --target switchedRheostat.idealCommutingSwitch.idealCommutingSwitch[2].Ron --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "switchedRheostat.idealCommutingSwitch.idealCommutingSwitch[2].Ron"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param switchedRheostat.idealCommutingSwitch.idealCommutingSwitch[2].Ron=0
```
