...
| **Severity** | low |
| **Declaration** | `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Mechanics/Translational/Examples/ElastoGap.mo:45` |
| **Signature** | `physical:physical-intent-question:var:105:7809126a` |
...
role          —
declaration   Modelica.Mechanics.Translational.Examples.ElastoGap.d
```
...
```
{'quantity': 'TranslationalDampingConstant', 'unit': 'N.s/m', 'confidence': 'QUANTITY', 'premise_state': 'unknown', 'authority': 'quantity_or_unit', 'canonical_declaration': 'Modelica.Mechanics.Translational.Examples.ElastoGap.d'}
```
...
| `authority` | quantity_or_unit |
| `canonical_declaration` | Modelica.Mechanics.Translational.Examples.ElastoGap.d |
...
```console
$ sed -n '45p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Mechanics/Translational/Examples/ElastoGap.mo"
```
...
```console
$ grep -rl '| `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Mechanics/Translational/Examples/ElastoGap.mo:45` |' docs/v2/bugs/
```
