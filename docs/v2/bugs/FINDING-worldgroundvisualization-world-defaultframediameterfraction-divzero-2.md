# FINDING-05359: `world.defaultFrameDiameterFraction` in `WorldGroundVisualization`

|  |  |
|---|---|
| **Tier** | **Candidate** — static only, not execution-confirmed |
| **Model** | `ModelicaTest.MultiBody.WorldGroundVisualization` |
...
| **Signature** | `divisor:divisor-reachable-zero:exp:763:7ad99f60` |
...
```console
$ python3 tools/sweep/check_one.py ModelicaTest.MultiBody.WorldGroundVisualization \
...
```console
$ python3 tools/sweep/check_one.py ModelicaTest.MultiBody.WorldGroundVisualization --keep-artifact /tmp/m.rbc \
