# DECL-0089: `sigma` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Magnetic/FluxTubes/Material/HysteresisEverettParameter/BaseData.mo:17` |
| **Parameter** | `sigma` |
...
```console
$ sed -n '17p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/FluxTubes/Material/HysteresisEverettParameter/BaseData.mo"
```
...
```console
$ grep -n -- "-1e40\|-1E40" "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/FluxTubes/Material/HysteresisEverettParameter/BaseData.mo" | head
```
...
```modelica
// Magnetic/FluxTubes/Material/HysteresisEverettParameter/BaseData.mo:17
