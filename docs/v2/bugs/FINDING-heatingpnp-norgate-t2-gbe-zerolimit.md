# FINDING-00383: `T2.Gbe` in `HeatingPNP_NORGate`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:247:61bb6289` |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.HeatingPNP_NORGate \
      --target T2.Gbe --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "T2.Gbe"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param T2.Gbe=0
```
