# DECL-0253: `Lrsigma` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Magnetic/FundamentalWave/BasicMachines/InductionMachines/IM_SlipRing.mo:38` |
| **Parameter** | `Lrsigma` |
| **Type** | `SI.Inductance` |
...
```console
$ sed -n '38p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/FundamentalWave/BasicMachines/InductionMachines/IM_SlipRing.mo"
```
...
```console
$ grep -n -- "-1e40\|-1E40" "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/FundamentalWave/BasicMachines/InductionMachines/IM_SlipRing.mo" | head
```
...
```modelica
// Magnetic/FundamentalWave/BasicMachines/InductionMachines/IM_SlipRing.mo:38
