# FINDING-01699: `dcseData.Js` in `DCSE_Start`
...
| **Signature** | `physical:physical-intent-question:var:374:e0ab30e1` |
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.DCMachines.DCSE_Start \
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.DCMachines.DCSE_Start --keep-artifact /tmp/m.rbc \
