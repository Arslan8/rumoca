# FINDING-03998: `dcdc.transistorLS.Goff` in `ChopperBuckBoost_DutyCycle`
...
| **Reached as** | `dcdc.transistorLS.Goff` |
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:55:a1a0048e` |
...
```
predicate     dcdc.transistorLS.Goff > 0
premise       refuted
...
| `required` | dcdc.transistorLS.Goff &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.PowerConverters.Examples.DCDC.ChopperBuckBoost.ChopperBuckBoost_DutyCycle \
      --target dcdc.transistorLS.Goff --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "dcdc.transistorLS.Goff"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param dcdc.transistorLS.Goff=0
```
