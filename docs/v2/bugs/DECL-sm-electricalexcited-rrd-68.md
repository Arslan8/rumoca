# DECL-0684: `Rrd` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Electrical/Machines/BasicMachines/SynchronousMachines/SM_ElectricalExcited.mo:68` |
| **Parameter** | `Rrd` |
| **Type** | `SI.Resistance` |
...
```modelica
// Electrical/Machines/BasicMachines/SynchronousMachines/SM_ElectricalExcited.mo:68
