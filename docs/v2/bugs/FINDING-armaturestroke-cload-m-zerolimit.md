# FINDING-04239: `cLoad.m` in `ArmatureStroke`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:377:ee2ad546` |
...
$ python3 tools/sweep/check_one.py Modelica.Magnetic.FluxTubes.Examples.MovingCoilActuator.ArmatureStroke \
      --target cLoad.m --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "cLoad.m"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param cLoad.m=0
```
