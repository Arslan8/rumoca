# FINDING-05300: `rectifier.RonThyristor` in `ThyristorBridge2mPulse_R`
...
```console
$ python3 tools/sweep/check_one.py ModelicaTest.Electrical.PowerConverters.ThyristorBridge2mPulse_R \
...
```console
$ python3 tools/sweep/check_one.py ModelicaTest.Electrical.PowerConverters.ThyristorBridge2mPulse_R --keep-artifact /tmp/m.rbc \
