...
| **Declaration** | `Electrical/Analog/Basic/Conductor.mo:3` |
| **Parameter** | `G` |
| **Type** | `SI.Conductance` |
...
```console
$ sed -n '3p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Analog/Basic/Conductor.mo"
```
...
```console
$ grep -n -- "-1e40\|-1E40" "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Analog/Basic/Conductor.mo" | head
```
...
```modelica
// Electrical/Analog/Basic/Conductor.mo:3
