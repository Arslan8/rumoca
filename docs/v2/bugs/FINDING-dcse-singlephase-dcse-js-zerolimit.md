# FINDING-01663: `dcse.Js` in `DCSE_SinglePhase`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:189:97211102` |
...
```
{'quantity': 'MomentOfInertia', 'unit': 'kg.m2', 'confidence': 'QUANTITY_AND_UNIT', 'premise_state': 'unknown', 'authority': 'quantity_or_unit', 'canonical_declaration': 'Modelica.Electrical.Machines.BasicMachines.DCMachines.DC_SeriesExcited.Js'}
```
