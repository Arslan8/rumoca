# FINDING-04175: `leftLeg.material.B_myMax` in `QuadraticCoreAirgap`
...
| **Reached as** | `leftLeg.material.B_myMax` |
...
| **Signature** | `divisor:divisor-reachable-zero:exp:331:c917f503` |
...
```
denominator            leftLeg.material.B_myMax
witness                leftLeg.material.B_myMax = 0
  found by             set to zero
denominator at witness 0.0
at declared values     1.0
path condition         always evaluated
constraints consulted  leftLeg.material.B_myMax: unbounded
```
...
| `constraints` | leftLeg.material.B_myMax: unbounded |
...
$ python3 tools/sweep/check_one.py Modelica.Magnetic.FluxTubes.Examples.BasicExamples.QuadraticCoreAirgap \
      --target leftLeg.material.B_myMax --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "leftLeg.material.B_myMax"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check \
      --param leftLeg.material.B_myMax=0
```
