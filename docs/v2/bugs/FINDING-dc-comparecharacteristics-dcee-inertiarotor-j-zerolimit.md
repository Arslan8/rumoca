# FINDING-01327: `dcee.inertiaRotor.J` in `DC_CompareCharacteristics`
...
| **Reached as** | `dcee.inertiaRotor.J` |
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:663:170feee8` |
...
```
predicate     dcee.inertiaRotor.J > 0
premise       refuted
...
| `required` | dcee.inertiaRotor.J &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.DCMachines.DC_CompareCharacteristics \
      --target dcee.inertiaRotor.J --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "dcee.inertiaRotor.J"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param dcee.inertiaRotor.J=0
```
