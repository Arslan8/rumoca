# FINDING-04567: `body2.mi` in `PlanarFourbar`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:353:a188fa93` |
...
$ python3 tools/sweep/check_one.py Modelica.Mechanics.MultiBody.Examples.Loops.PlanarFourbar \
      --target body2.mi --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "body2.mi"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param body2.mi=0
```
