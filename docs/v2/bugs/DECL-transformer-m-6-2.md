# DECL-0239: `M` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Electrical/QuasiStatic/SinglePhase/Basic/Transformer.mo:6` |
| **Parameter** | `M` |
| **Type** | `SI.Inductance` |
...
```console
$ sed -n '6p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/QuasiStatic/SinglePhase/Basic/Transformer.mo"
```
...
```modelica
// Electrical/QuasiStatic/SinglePhase/Basic/Transformer.mo:6
