# FINDING-03164: `diode4.Ron` in `Rectifier12pulse`
...
| **Signature** | `physical:physical-rule-does-not-apply:var:883:7ebc2254` |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.Transformers.Rectifier12pulse \
      --target diode4.Ron --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "diode4.Ron"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param diode4.Ron=0
```
