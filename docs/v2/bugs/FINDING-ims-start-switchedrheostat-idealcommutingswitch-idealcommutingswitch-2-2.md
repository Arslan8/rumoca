# FINDING-02303: `switchedRheostat.idealCommutingSwitch.idealCommutingSwitch[2].Goff` in `IMS_Start`
...
| **Reached as** | `switchedRheostat.idealCommutingSwitch.idealCommutingSwitch[2].Goff` |
...
| **Signature** | `physical:physical-rule-does-not-apply:var:958:2ba6cb4d` |
...
```
predicate     switchedRheostat.idealCommutingSwitch.idealCommutingSwitch[2].Goff > 0
premise       refuted
...
| `required` | switchedRheostat.idealCommutingSwitch.idealCommutingSwitch[2].Goff &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.InductionMachines.IMS_Start \
      --target switchedRheostat.idealCommutingSwitch.idealCommutingSwitch[2].Goff --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "switchedRheostat.idealCommutingSwitch.idealCommutingSwitch[2].Goff"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param switchedRheostat.idealCommutingSwitch.idealCommutingSwitch[2].Goff=0
```
