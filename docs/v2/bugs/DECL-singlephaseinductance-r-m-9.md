...
| **Declaration** | `Magnetic/FundamentalWave/Examples/Components/SinglePhaseInductance.mo:9` |
| **Parameter** | `R_m` |
| **Type** | `SI.Reluctance` |
| **Declared modifiers** | `—` |
...
```console
$ sed -n '9p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/FundamentalWave/Examples/Components/SinglePhaseInductance.mo"
```
