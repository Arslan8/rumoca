# FINDING-04884: `pump.m` in `ParallelPumpDropOut`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:44:aec53e90` |
...
$ python3 tools/sweep/check_one.py Modelica.Thermal.FluidHeatFlow.Examples.ParallelPumpDropOut \
      --target pump.m --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "pump.m"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param pump.m=0
```
