...
| **Signature** | `divisor:divisor-zero-unresolved:exp:349:4836f73f` |
...
```
denominator            thyristor_v4_1.VGT
witness                thyristor_v4_1.VGT = 0
...
constraints consulted  thyristor_v4_1.VGT: unbounded
```
...
| `constraints` | thyristor_v4_1.VGT: unbounded |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.ThyristorBehaviourTest \
      --target thyristor_v4_1.VGT --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "thyristor_v4_1.VGT"
```
