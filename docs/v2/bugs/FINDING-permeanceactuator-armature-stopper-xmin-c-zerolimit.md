# FINDING-04272: `armature.stopper_xMin.c` in `PermeanceActuator`
...
| **Reached as** | `armature.stopper_xMin.c` |
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:88:8beeadba` |
...
```
predicate     armature.stopper_xMin.c > 0
premise       refuted
...
| `required` | armature.stopper_xMin.c &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Magnetic.FluxTubes.Examples.MovingCoilActuator.Components.PermeanceActuator \
      --target armature.stopper_xMin.c --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "armature.stopper_xMin.c"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param armature.stopper_xMin.c=0
```
