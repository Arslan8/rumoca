# FINDING-04684: `mass.m` in `Accelerate`
...
```console
$ python3 tools/sweep/check_one.py Modelica.Mechanics.Translational.Examples.Accelerate \
...
```console
$ python3 tools/sweep/check_one.py Modelica.Mechanics.Translational.Examples.Accelerate --keep-artifact /tmp/m.rbc \
