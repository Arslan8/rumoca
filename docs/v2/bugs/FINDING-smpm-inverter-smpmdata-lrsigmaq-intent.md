# FINDING-02673: `smpmData.Lrsigmaq` in `SMPM_Inverter`
...
| **Signature** | `physical:physical-intent-question:var:744:012293ad` |
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.SynchronousMachines.SMPM_Inverter \
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.SynchronousMachines.SMPM_Inverter --keep-artifact /tmp/m.rbc \
