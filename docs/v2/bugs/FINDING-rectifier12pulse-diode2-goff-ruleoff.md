# FINDING-03129: `diode2.Goff` in `Rectifier12pulse`
...
| **Signature** | `physical:physical-rule-does-not-apply:var:230:f09893b4` |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.Transformers.Rectifier12pulse \
      --target diode2.Goff --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "diode2.Goff"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param diode2.Goff=0
```
