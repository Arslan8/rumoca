# FINDING-00504: `ramp.duration` in `CompareLineTrunks`
...
| **Signature** | `divisor:divisor-unreachable-under-witness:exp:4232:12977c38` |
...
| `denominator_at_declared_values` | 5e-05 |
| `denominator_range` | [0, inf] |
| `path_condition` | not ((time &lt; ramp.startTime)) and ((time &lt; (ramp.startTime + ramp.duration))) |
| `verdict` | UNSAT |
| `proof` | the path conditions cannot hold together: time must be both &gt; 0.0004 and &lt; 0.0004 |
