...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:233:f6f29336` |
...
```
predicate     vehicleDragInVar.m > 0
premise       refuted
...
$ python3 tools/sweep/check_one.py ModelicaTest.Translational.Vehicles \
      --target vehicleDragInVar.m --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "vehicleDragInVar.m"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param vehicleDragInVar.m=0
```
