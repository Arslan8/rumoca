# FINDING-04598: `bodyBox.body.m` in `BevelGear1D`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:641:a4509a5e` |
...
$ python3 tools/sweep/check_one.py Modelica.Mechanics.MultiBody.Examples.Rotational3DEffects.BevelGear1D \
      --target bodyBox.body.m --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "bodyBox.body.m"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param bodyBox.body.m=0
```
