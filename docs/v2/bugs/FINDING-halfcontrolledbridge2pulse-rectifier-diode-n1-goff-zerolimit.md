# FINDING-03642: `rectifier.diode_n1.Goff` in `HalfControlledBridge2Pulse`
...
| **Reached as** | `rectifier.diode_n1.Goff` |
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:107:5087e74e` |
...
```
predicate     rectifier.diode_n1.Goff > 0
premise       refuted
...
| `required` | rectifier.diode_n1.Goff &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.PowerConverters.Examples.ACDC.RectifierBridge2Pulse.HalfControlledBridge2Pulse \
      --target rectifier.diode_n1.Goff --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "rectifier.diode_n1.Goff"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param rectifier.diode_n1.Goff=0
```
