# DECL-0154: `L1sigma` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Electrical/Machines/Interfaces/PartialBasicTransformer.mo:18` |
| **Parameter** | `L1sigma` |
| **Type** | `SI.Inductance` |
...
```modelica
// Electrical/Machines/Interfaces/PartialBasicTransformer.mo:18
