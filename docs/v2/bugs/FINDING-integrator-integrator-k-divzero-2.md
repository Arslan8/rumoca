...
| **Signature** | `divisor:divisor-reachable-zero:exp:76:e8a7f913` |
...
| `constraints` | integrator.k: min=0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.OpAmps.Integrator \
      --target integrator.k --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "integrator.k"
```
