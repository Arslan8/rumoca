# FINDING-00503: `tLine4.Z0` in `CompareLineTrunks`
...
| **Signature** | `physical:physical-domain-unenforced:var:1474:cee32093` |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.Lines.CompareLineTrunks \
      --target tLine4.Z0 --sanitizer physical
```
