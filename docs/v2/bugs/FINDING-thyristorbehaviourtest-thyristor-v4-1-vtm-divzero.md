# FINDING-01215: `thyristor_v4_1.VTM` in `ThyristorBehaviourTest`
...
| **Signature** | `divisor:divisor-reachable-zero:exp:144:c4685fd9` |
...
```
denominator            thyristor_v4_1.VTM
witness                thyristor_v4_1.VTM = 0
  found by             set to zero
denominator at witness 0.0
at declared values     1.7
path condition         always evaluated
constraints consulted  thyristor_v4_1.VTM: unbounded
```
...
| `constraints` | thyristor_v4_1.VTM: unbounded |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.ThyristorBehaviourTest \
      --target thyristor_v4_1.VTM --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "thyristor_v4_1.VTM"
```
