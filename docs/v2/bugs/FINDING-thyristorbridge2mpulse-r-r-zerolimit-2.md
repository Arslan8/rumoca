...
| **Severity** | low |
| **Declaration** | `target/corpus/ModelicaStandardLibrary-4.1.0/ModelicaTest/Electrical/PowerConverters.mo:131` |
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:682:35d57784` |
...
```
{'quantity': 'Resistance', 'unit': 'Ohm', 'confidence': 'QUANTITY_AND_UNIT', 'premise_state': 'unknown', 'authority': 'quantity_or_unit', 'canonical_declaration': 'ModelicaTest.Electrical.PowerConverters.ThyristorBridge2mPulse_R.R'}
```
...
```console
$ sed -n '131p' "target/corpus/ModelicaStandardLibrary-4.1.0/ModelicaTest/Electrical/PowerConverters.mo"
```
...
```console
$ grep -rl '| `target/corpus/ModelicaStandardLibrary-4.1.0/ModelicaTest/Electrical/PowerConverters.mo:131` |' docs/v2/bugs/
```
