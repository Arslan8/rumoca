# FINDING-00173: `R2.R` in `CauerLowPassSC`
...
| **Signature** | `physical:physical-rule-does-not-apply:var:504:781fbeec` |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.CauerLowPassSC \
      --target R2.R --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "R2.R"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param R2.R=0
```
