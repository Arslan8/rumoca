# FINDING-00929: `c.C` in `LCOscillator`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:80:d1146d43` |
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.OpAmps.LCOscillator --keep-artifact /tmp/m.rbc \
