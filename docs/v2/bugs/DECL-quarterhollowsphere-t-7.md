# DECL-0484: `t` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Magnetic/FluxTubes/Shapes/Leakage/QuarterHollowSphere.mo:7` |
| **Parameter** | `t` |
| **Type** | `SI.Length` |
...
```console
$ sed -n '7p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/FluxTubes/Shapes/Leakage/QuarterHollowSphere.mo"
```
...
```console
$ grep -n -- "-1e40\|-1E40" "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/FluxTubes/Shapes/Leakage/QuarterHollowSphere.mo" | head
```
...
```modelica
// Magnetic/FluxTubes/Shapes/Leakage/QuarterHollowSphere.mo:7
