# FINDING-04308: `g_mAirPar.l` in `AdvancedSolenoid`
...
| **Signature** | `divisor:divisor-introduced-by-translation:exp:1375:761dfea1` |
...
```
denominator            g_mAirPar.A
witness                g_mAirPar.l = 0
  found by             set to zero
denominator at witness 0.0
at declared values     0.00011710286616255953
path condition         always evaluated
constraints consulted  g_mAirPar.l: unbounded
```
...
$ python3 tools/sweep/check_one.py Modelica.Magnetic.FluxTubes.Examples.SolenoidActuator.Components.AdvancedSolenoid \
      --target g_mAirPar.l --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "g_mAirPar.l"
```
