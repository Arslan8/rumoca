# FINDING-00823: `T1` in `ControlCircuit`
...
| **Severity** | high |
| **Declaration** | `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Analog/Examples/OpAmps/ControlCircuit.mo:7` |
| **Signature** | `divisor:divisor-reachable-zero:exp:15:9d8c445c` |
...
constraints consulted  T1: unbounded
```
...
```console
$ sed -n '7p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Analog/Examples/OpAmps/ControlCircuit.mo"
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "T1"
```
...
```console
$ grep -rl '| `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Analog/Examples/OpAmps/ControlCircuit.mo:7` |' docs/v2/bugs/
```
