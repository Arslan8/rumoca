# FINDING-05188: `ramp1.duration` in `LimitersHomotopy`
...
| **Signature** | `divisor:divisor-unreachable-under-witness:exp:428:2d6d8125` |
...
| `verdict` | UNSAT |
| `proof` | the path conditions cannot hold together: time must be both &gt; 1 and &lt; 1 |
