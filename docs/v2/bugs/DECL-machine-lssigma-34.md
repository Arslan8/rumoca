# DECL-0275: `Lssigma` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Magnetic/QuasiStatic/FundamentalWave/BaseClasses/Machine.mo:34` |
| **Parameter** | `Lssigma` |
| **Type** | `SI.Inductance` |
| **Declared modifiers** | `(start=3*(1 - sqrt(1 - 0.0667)` |
...
```console
$ sed -n '34p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/QuasiStatic/FundamentalWave/BaseClasses/Machine.mo"
```
...
```console
$ grep -n -- "-1e40\|-1E40" "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/QuasiStatic/FundamentalWave/BaseClasses/Machine.mo" | head
```
...
```modelica
// Magnetic/QuasiStatic/FundamentalWave/BaseClasses/Machine.mo:34
