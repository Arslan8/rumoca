# DECL-0861: `Rs` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Magnetic/QuasiStatic/FundamentalWave/BaseClasses/Machine.mo:21` |
| **Parameter** | `Rs` |
| **Type** | `SI.Resistance` |
| **Declared modifiers** | `(start=0.03)` |
...
```console
$ sed -n '21p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/QuasiStatic/FundamentalWave/BaseClasses/Machine.mo"
```
...
```modelica
// Magnetic/QuasiStatic/FundamentalWave/BaseClasses/Machine.mo:21
