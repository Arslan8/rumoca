# FINDING-04607: `b1.body.m` in `MechanicalStructure`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:568:458d8227` |
...
$ python3 tools/sweep/check_one.py Modelica.Mechanics.MultiBody.Examples.Systems.RobotR3.Utilities.MechanicalStructure \
      --target b1.body.m --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "b1.body.m"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param b1.body.m=0
```
