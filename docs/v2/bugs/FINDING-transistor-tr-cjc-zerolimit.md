# FINDING-01252: `Tr.Cjc` in `Transistor`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:47:0b1ec64e` |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.Utilities.Transistor \
      --target Tr.Cjc --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "Tr.Cjc"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param Tr.Cjc=0
```
