...
| **Signature** | `divisor:divisor-zero-unresolved:exp:672:4ab7e5ef` |
...
```
denominator            V1.signalSource.falling
witness                V1.signalSource.falling = 0
  found by             set to zero
denominator at witness 0.0
at declared values     5.0
path condition         not ((((time < V1.signalSource.startTime) or (V1.signalSource.nperiod == 0)) or ((V1.signalSource.nperiod > 0) and (V1.signalSource.count >= V1.signalSource.nperiod)))) and not ((time < (V1.signalSource.T_start + V1.signalSource.T_rising))) and not ((time < (V1.signalSource.T_start + V1.signalSource.T_width))) and ((time < (V1.signalSource.T_start + V1.signalSource.T_falling)))
constraints consulted  V1.signalSource.falling: min=0
```
...
| `path_condition` | not ((((time &lt; V1.signalSource.startTime) or (V1.signalSource.nperiod == 0)) or ((V1.signalSource.nperiod &gt; 0) and (V1.signalSource.count &gt;= V1.signalSource.nperiod)))) and not ((time &lt; (V1.signalSource.T_start + V1.signalSource.T_rising))) and not ((time &lt; (V1.signalSource.T_start + V1.signalSource.T_width))) and ((time &lt; (V1.signalSource.T_start + V1.signalSource.T_falling))) |
| `verdict` | UNKNOWN |
| `proof` | the path depends on quantities the artifact does not determine: (time &lt; (V1.signalSource.T_start + V1.signalSource.T_falling)); (time &lt; (V1.signalSource.T_start + V1.signalSource.T_rising)); (time &lt; (V1.signalSource.T_start + V1.signalSource.T_width)) |
| `constraints` | V1.signalSource.falling: min=0 |
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.HeatingPNP_NORGate \
      --target V1.signalSource.falling --sanitizer divisor
```
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.HeatingPNP_NORGate --keep-artifact /tmp/m.rbc \
      --sanitizer divisor >/dev/null
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "V1.signalSource.falling"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check \
      --param V1.signalSource.falling=0
```
