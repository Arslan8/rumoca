# FINDING-02473: `smee.spacePhasorS.turnsRatio` in `SMEE_Generator`
...
| **Reached as** | `smee.spacePhasorS.turnsRatio` |
...
| **Signature** | `divisor:divisor-reachable-zero:exp:4908:723a3dc6` |
...
```
denominator            smee.spacePhasorS.turnsRatio
witness                smee.spacePhasorS.turnsRatio = 0
  found by             set to zero
denominator at witness 0.0
at declared values     1.0
path condition         always evaluated
constraints consulted  smee.spacePhasorS.turnsRatio: unbounded
```
...
| `constraints` | smee.spacePhasorS.turnsRatio: unbounded |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.SynchronousMachines.SMEE_Generator \
      --target smee.spacePhasorS.turnsRatio --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "smee.spacePhasorS.turnsRatio"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check \
      --param smee.spacePhasorS.turnsRatio=0
```
