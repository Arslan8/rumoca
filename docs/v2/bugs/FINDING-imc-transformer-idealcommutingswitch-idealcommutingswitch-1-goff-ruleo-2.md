# FINDING-03074: `idealCommutingSwitch.idealCommutingSwitch[1].Goff` in `IMC_Transformer`
...
| **Reached as** | `idealCommutingSwitch.idealCommutingSwitch[1].Goff` |
...
| **Signature** | `physical:physical-rule-does-not-apply:var:1124:404d6acc` |
...
```
predicate     idealCommutingSwitch.idealCommutingSwitch[1].Goff > 0
premise       refuted
...
| `required` | idealCommutingSwitch.idealCommutingSwitch[1].Goff &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.Transformers.IMC_Transformer \
      --target idealCommutingSwitch.idealCommutingSwitch[1].Goff --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "idealCommutingSwitch.idealCommutingSwitch[1].Goff"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param idealCommutingSwitch.idealCommutingSwitch[1].Goff=0
```
