# FINDING-04566: `body2.mo` in `PlanarFourbar`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:352:5fee0c8d` |
...
$ python3 tools/sweep/check_one.py Modelica.Mechanics.MultiBody.Examples.Loops.PlanarFourbar \
      --target body2.mo --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "body2.mo"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param body2.mo=0
```
