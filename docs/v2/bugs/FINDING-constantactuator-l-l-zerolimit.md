# FINDING-04262: `l.L` in `ConstantActuator`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:100:465fab1b` |
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "l.L"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param l.L=0
```
