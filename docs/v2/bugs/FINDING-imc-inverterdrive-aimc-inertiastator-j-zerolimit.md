# FINDING-01910: `aimc.inertiaStator.J` in `IMC_InverterDrive`
...
| **Reached as** | `aimc.inertiaStator.J` |
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:1281:3ecae4cb` |
...
```
predicate     aimc.inertiaStator.J > 0
premise       refuted
...
| `required` | aimc.inertiaStator.J &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.InductionMachines.IMC_InverterDrive \
      --target aimc.inertiaStator.J --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "aimc.inertiaStator.J"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param aimc.inertiaStator.J=0
```
