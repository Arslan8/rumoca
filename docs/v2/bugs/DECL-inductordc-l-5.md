...
| **Declaration** | `Electrical/Machines/BasicMachines/Components/InductorDC.mo:5` |
| **Parameter** | `L` |
| **Type** | `SI.Inductance` |
...
```console
$ grep -n -- "-1e40\|-1E40" "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Machines/BasicMachines/Components/InductorDC.mo" | head
```
...
```modelica
// Electrical/Machines/BasicMachines/Components/InductorDC.mo:5
