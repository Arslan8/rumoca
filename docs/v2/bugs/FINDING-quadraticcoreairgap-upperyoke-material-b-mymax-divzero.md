# FINDING-04178: `upperYoke.material.B_myMax` in `QuadraticCoreAirgap`
...
| **Reached as** | `upperYoke.material.B_myMax` |
...
| **Signature** | `divisor:divisor-reachable-zero:exp:410:9969d349` |
...
```
denominator            upperYoke.material.B_myMax
witness                upperYoke.material.B_myMax = 0
  found by             set to zero
denominator at witness 0.0
at declared values     1.0
path condition         always evaluated
constraints consulted  upperYoke.material.B_myMax: unbounded
```
...
| `constraints` | upperYoke.material.B_myMax: unbounded |
...
$ python3 tools/sweep/check_one.py Modelica.Magnetic.FluxTubes.Examples.BasicExamples.QuadraticCoreAirgap \
      --target upperYoke.material.B_myMax --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "upperYoke.material.B_myMax"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check \
      --param upperYoke.material.B_myMax=0
```
