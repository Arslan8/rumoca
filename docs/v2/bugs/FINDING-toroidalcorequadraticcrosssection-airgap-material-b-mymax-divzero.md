# FINDING-04210: `airGap.material.B_myMax` in `ToroidalCoreQuadraticCrossSection`
...
| **Reached as** | `airGap.material.B_myMax` |
...
| **Signature** | `divisor:divisor-reachable-zero:exp:360:2d2ae34e` |
...
```
denominator            airGap.material.B_myMax
witness                airGap.material.B_myMax = 0
  found by             set to zero
denominator at witness 0.0
at declared values     1.0
path condition         always evaluated
constraints consulted  airGap.material.B_myMax: unbounded
```
...
| `constraints` | airGap.material.B_myMax: unbounded |
...
$ python3 tools/sweep/check_one.py Modelica.Magnetic.FluxTubes.Examples.BasicExamples.ToroidalCoreQuadraticCrossSection \
      --target airGap.material.B_myMax --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "airGap.material.B_myMax"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check \
      --param airGap.material.B_myMax=0
```
