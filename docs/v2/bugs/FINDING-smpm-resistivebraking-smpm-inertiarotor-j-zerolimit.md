# FINDING-02770: `smpm.inertiaRotor.J` in `SMPM_ResistiveBraking`
...
| **Reached as** | `smpm.inertiaRotor.J` |
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:389:e935eaa5` |
...
```
predicate     smpm.inertiaRotor.J > 0
premise       refuted
...
| `required` | smpm.inertiaRotor.J &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.SynchronousMachines.SMPM_ResistiveBraking \
      --target smpm.inertiaRotor.J --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "smpm.inertiaRotor.J"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param smpm.inertiaRotor.J=0
```
