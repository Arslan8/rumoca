...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:64:2ce7031f` |
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.HeatingRectifier \
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.HeatingRectifier --keep-artifact /tmp/m.rbc \
