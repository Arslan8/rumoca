# DECL-0904: `V` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Fluid/Pipes.mo:244` |
| **Parameter** | `V` |
| **Type** | `SI.Volume` |
| **Declared modifiers** | `—` |
...
```console
$ sed -n '244p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Fluid/Pipes.mo"
```
