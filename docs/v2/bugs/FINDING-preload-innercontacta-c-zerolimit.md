...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:10:adbdf2a0` |
...
$ python3 tools/sweep/check_one.py Modelica.Mechanics.Translational.Examples.PreLoad \
      --target innerContactA.c --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "innerContactA.c"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param innerContactA.c=0
```
