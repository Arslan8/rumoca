...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:337:a6ec90fa` |
...
$ python3 tools/sweep/check_one.py Modelica.Mechanics.MultiBody.Examples.Elementary.DoublePendulum \
      --target boxBody1.mi --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "boxBody1.mi"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param boxBody1.mi=0
```
