# FINDING-01123: `capacitor2.C` in `ResonanceCircuits`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:100:9d4b0353` |
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.ResonanceCircuits \
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.ResonanceCircuits --keep-artifact /tmp/m.rbc \
