# FINDING-02007: `cStart.C` in `IMC_Steinmetz`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:552:4c57654f` |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.InductionMachines.IMC_Steinmetz \
      --target cStart.C --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "cStart.C"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param cStart.C=0
```
