...
| **Signature** | `divisor:divisor-reachable-zero:exp:537:000c04d3` |
...
| `constraints` | motor[4].tau_up: unbounded |
...
$ python3 tools/sweep/check_one.py RigidBody.Examples.QuadrotorSIL \
      --target motor[4].tau_up --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "motor[4].tau_up"
```
