# FINDING-04200: `core.r` in `ToroidalCoreAirgap`
...
| **Signature** | `divisor:divisor-reachable-zero:exp:344:9e7192e2` |
...
$ python3 tools/sweep/check_one.py Modelica.Magnetic.FluxTubes.Examples.BasicExamples.ToroidalCoreAirgap \
      --target core.r --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "core.r"
```
