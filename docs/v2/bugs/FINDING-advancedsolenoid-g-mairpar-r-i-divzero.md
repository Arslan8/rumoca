# FINDING-04309: `g_mAirPar.r_i` in `AdvancedSolenoid`
...
| **Signature** | `divisor:divisor-reachable-zero:exp:1418:6480b1ff` |
...
| `constraints` | g_mAirPar.r_i: min=0 |
...
$ python3 tools/sweep/check_one.py Modelica.Magnetic.FluxTubes.Examples.SolenoidActuator.Components.AdvancedSolenoid \
      --target g_mAirPar.r_i --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "g_mAirPar.r_i"
```
