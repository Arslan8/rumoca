# FINDING-04577: `body4.mi` in `PlanarFourbar`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:597:70dbb199` |
...
$ python3 tools/sweep/check_one.py Modelica.Mechanics.MultiBody.Examples.Loops.PlanarFourbar \
      --target body4.mi --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "body4.mi"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param body4.mi=0
```
