# FINDING-01345: `dcse.inertiaRotor.J` in `DC_CompareCharacteristics`
...
| **Reached as** | `dcse.inertiaRotor.J` |
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:1035:85babd71` |
...
```
predicate     dcse.inertiaRotor.J > 0
premise       refuted
...
| `required` | dcse.inertiaRotor.J &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.DCMachines.DC_CompareCharacteristics \
      --target dcse.inertiaRotor.J --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "dcse.inertiaRotor.J"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param dcse.inertiaRotor.J=0
```
