# FINDING-01222: `L` in `DirectInductor`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:0:91be26ce` |
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.Utilities.DirectInductor \
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.Utilities.DirectInductor --keep-artifact /tmp/m.rbc \
