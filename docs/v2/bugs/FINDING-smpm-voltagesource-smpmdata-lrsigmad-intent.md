# FINDING-02843: `smpmData.Lrsigmad` in `SMPM_VoltageSource`
...
| **Signature** | `physical:physical-intent-question:var:864:9d5e256b` |
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.SynchronousMachines.SMPM_VoltageSource \
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.SynchronousMachines.SMPM_VoltageSource --keep-artifact /tmp/m.rbc \
