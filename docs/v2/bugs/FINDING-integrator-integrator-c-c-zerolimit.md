...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:56:51b35385` |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.OpAmps.Integrator \
      --target integrator.c.C --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "integrator.c.C"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param integrator.c.C=0
```
