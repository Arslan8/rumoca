...
| **Declaration** | `Electrical/Machines/BasicMachines/DCMachines/DC_ElectricalExcited.mo:80` |
| **Parameter** | `Lme` |
| **Type** | `SI.Inductance` |
| **Declared modifiers** | `—` |
...
It should declare `Lme` with type `SI.Inductance` and no `min`.
...
```modelica
// Electrical/Machines/BasicMachines/DCMachines/DC_ElectricalExcited.mo:80
parameter SI.Inductance Lme(min=0) = ...;
```
