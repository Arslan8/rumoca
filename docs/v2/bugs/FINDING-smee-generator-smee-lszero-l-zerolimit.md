# FINDING-02440: `smee.lszero.L` in `SMEE_Generator`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:153:8ebefba6` |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.SynchronousMachines.SMEE_Generator \
      --target smee.lszero.L --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "smee.lszero.L"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param smee.lszero.L=0
```
