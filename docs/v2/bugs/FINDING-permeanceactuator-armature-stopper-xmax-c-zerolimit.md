# FINDING-04271: `armature.stopper_xMax.c` in `PermeanceActuator`
...
| **Reached as** | `armature.stopper_xMax.c` |
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:67:e69a980d` |
...
```
predicate     armature.stopper_xMax.c > 0
premise       refuted
...
| `required` | armature.stopper_xMax.c &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Magnetic.FluxTubes.Examples.MovingCoilActuator.Components.PermeanceActuator \
      --target armature.stopper_xMax.c --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "armature.stopper_xMax.c"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param armature.stopper_xMax.c=0
```
