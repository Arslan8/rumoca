# FINDING-05212: `ramp.duration` in `ZeroThresholds`
...
| **Signature** | `divisor:divisor-unreachable-under-witness:exp:149:5fbcbc2b` |
...
| `verdict` | UNSAT |
| `proof` | the path conditions cannot hold together: time must be both &gt; 0.3 and &lt; 0.3 |
...
```console
$ python3 tools/sweep/check_one.py ModelicaTest.Blocks.ZeroThresholds \
...
```console
$ python3 tools/sweep/check_one.py ModelicaTest.Blocks.ZeroThresholds --keep-artifact /tmp/m.rbc \
