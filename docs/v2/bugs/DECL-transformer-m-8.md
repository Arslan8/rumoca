# DECL-0188: `M` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Electrical/Polyphase/Basic/Transformer.mo:8` |
| **Parameter** | `M` |
| **Type** | `SI.Inductance` |
...
```console
$ sed -n '8p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Polyphase/Basic/Transformer.mo"
```
...
```modelica
// Electrical/Polyphase/Basic/Transformer.mo:8
