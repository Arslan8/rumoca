...
| **Signature** | `physical:physical-rule-does-not-apply:var:138:8f0e3b4e` |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.Rectifier \
      --target IdealDiode4.Ron --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "IdealDiode4.Ron"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param IdealDiode4.Ron=0
```
