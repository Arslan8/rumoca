# FINDING-00022: `mixingUnit.tau0` in `FilterOrder`
...
| **Signature** | `divisor:divisor-reachable-zero:exp:63:c256b804` |
...
```console
$ python3 tools/sweep/check_one.py Modelica.Clocked.Examples.Systems.Utilities.ComponentsMixingUnit.FilterOrder \
...
```console
$ python3 tools/sweep/check_one.py Modelica.Clocked.Examples.Systems.Utilities.ComponentsMixingUnit.FilterOrder --keep-artifact /tmp/m.rbc \
