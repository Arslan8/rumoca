...
| **Severity** | high |
| **Declaration** | `examples/models/SwitchedRLC.mo:18` |
| **Signature** | `divisor:divisor-reachable-zero:exp:24:7fc73cf2` |
...
```console
$ python3 tools/sweep/check_one.py SwitchedRLC \
...
```console
$ sed -n '18p' "examples/models/SwitchedRLC.mo"
```
...
```console
$ python3 tools/sweep/check_one.py SwitchedRLC --keep-artifact /tmp/m.rbc \
...
```console
$ grep -rl '| `examples/models/SwitchedRLC.mo:18` |' docs/v2/bugs/
```
