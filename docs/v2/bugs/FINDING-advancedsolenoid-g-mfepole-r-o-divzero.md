...
| **Signature** | `divisor:divisor-reachable-zero:exp:1555:0ac6ee08` |
...
| `constraints` | g_mFePole.r_o: min=0 |
...
$ python3 tools/sweep/check_one.py Modelica.Magnetic.FluxTubes.Examples.SolenoidActuator.Components.AdvancedSolenoid \
      --target g_mFePole.r_o --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "g_mFePole.r_o"
```
