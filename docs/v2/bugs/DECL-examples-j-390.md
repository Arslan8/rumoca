# DECL-0368: `J` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Utilities/Examples.mo:390` |
| **Parameter** | `J` |
| **Type** | `SI.Inertia` |
| **Declared modifiers** | `—` |
...
```console
$ sed -n '390p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Utilities/Examples.mo"
```
...
```console
$ grep -n -- "-1e40\|-1E40" "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Utilities/Examples.mo" | head
```
