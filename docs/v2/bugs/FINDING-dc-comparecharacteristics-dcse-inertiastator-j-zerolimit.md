# FINDING-01346: `dcse.inertiaStator.J` in `DC_CompareCharacteristics`
...
| **Reached as** | `dcse.inertiaStator.J` |
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:1043:020715b6` |
...
```
predicate     dcse.inertiaStator.J > 0
premise       refuted
...
| `required` | dcse.inertiaStator.J &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.DCMachines.DC_CompareCharacteristics \
      --target dcse.inertiaStator.J --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "dcse.inertiaStator.J"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param dcse.inertiaStator.J=0
```
