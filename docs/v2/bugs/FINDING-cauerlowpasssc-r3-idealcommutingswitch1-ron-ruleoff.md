...
| **Signature** | `physical:physical-rule-does-not-apply:var:590:fbc8dd57` |
...
```
predicate     R3.IdealCommutingSwitch1.Ron > 0
premise       refuted
...
| `required` | R3.IdealCommutingSwitch1.Ron &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.CauerLowPassSC \
      --target R3.IdealCommutingSwitch1.Ron --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "R3.IdealCommutingSwitch1.Ron"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param R3.IdealCommutingSwitch1.Ron=0
```
