# FINDING-01556: `dcpm2.inertiaStator.J` in `DCPM_QuasiStatic`
...
| **Reached as** | `dcpm2.inertiaStator.J` |
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:550:734dabdc` |
...
```
predicate     dcpm2.inertiaStator.J > 0
premise       refuted
...
| `required` | dcpm2.inertiaStator.J &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.DCMachines.DCPM_QuasiStatic \
      --target dcpm2.inertiaStator.J --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "dcpm2.inertiaStator.J"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param dcpm2.inertiaStator.J=0
```
