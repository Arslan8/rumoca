# FINDING-04748: `springDamper.c` in `SpringDamper`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:35:39ba7534` |
...
```console
$ python3 tools/sweep/check_one.py Modelica.Mechanics.Translational.Examples.Utilities.SpringDamper \
...
```console
$ python3 tools/sweep/check_one.py Modelica.Mechanics.Translational.Examples.Utilities.SpringDamper --keep-artifact /tmp/m.rbc \
