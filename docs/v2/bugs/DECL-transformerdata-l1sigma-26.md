# DECL-0172: `L1sigma` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Electrical/Machines/Utilities/ParameterRecords/TransformerData.mo:26` |
| **Parameter** | `L1sigma` |
| **Type** | `SI.Inductance` |
| **Declared modifiers** | `—` |
...
```console
$ sed -n '26p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Machines/Utilities/ParameterRecords/TransformerData.mo"
```
...
```modelica
// Electrical/Machines/Utilities/ParameterRecords/TransformerData.mo:26
