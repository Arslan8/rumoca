# FINDING-04611: `b3.body.m` in `MechanicalStructure`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:818:5ac92c60` |
...
$ python3 tools/sweep/check_one.py Modelica.Mechanics.MultiBody.Examples.Systems.RobotR3.Utilities.MechanicalStructure \
      --target b3.body.m --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "b3.body.m"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param b3.body.m=0
```
