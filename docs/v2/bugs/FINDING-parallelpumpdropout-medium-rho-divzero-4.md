# FINDING-04914: `medium.rho` in `ParallelPumpDropOut`
...
| **Signature** | `divisor:divisor-reachable-zero:exp:1101:7f8cfc0d` |
...
$ python3 tools/sweep/check_one.py Modelica.Thermal.FluidHeatFlow.Examples.ParallelPumpDropOut \
      --target medium.rho --sanitizer divisor
```
