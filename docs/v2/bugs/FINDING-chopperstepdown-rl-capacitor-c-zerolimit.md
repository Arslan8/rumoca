# FINDING-04024: `capacitor.C` in `ChopperStepDown_RL`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:169:9b38cab4` |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.PowerConverters.Examples.DCDC.ChopperStepDown.ChopperStepDown_RL \
      --target capacitor.C --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "capacitor.C"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param capacitor.C=0
```
