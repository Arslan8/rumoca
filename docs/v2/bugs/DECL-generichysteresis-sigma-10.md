# DECL-0086: `sigma` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Magnetic/FluxTubes/BaseClasses/GenericHysteresis.mo:10` |
| **Parameter** | `sigma` |
...
```console
$ sed -n '10p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/FluxTubes/BaseClasses/GenericHysteresis.mo"
```
...
```console
$ grep -n -- "-1e40\|-1E40" "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/FluxTubes/BaseClasses/GenericHysteresis.mo" | head
```
...
```modelica
// Magnetic/FluxTubes/BaseClasses/GenericHysteresis.mo:10
