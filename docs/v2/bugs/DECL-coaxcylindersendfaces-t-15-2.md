# DECL-0506: `t` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Magnetic/QuasiStatic/FluxTubes/Shapes/Leakage/CoaxCylindersEndFaces.mo:15` |
| **Parameter** | `t` |
| **Type** | `SI.Length` |
| **Declared modifiers** | `—` |
...
```console
$ sed -n '15p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/QuasiStatic/FluxTubes/Shapes/Leakage/CoaxCylindersEndFaces.mo"
```
...
```console
$ grep -n -- "-1e40\|-1E40" "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/QuasiStatic/FluxTubes/Shapes/Leakage/CoaxCylindersEndFaces.mo" | head
```
...
```modelica
// Magnetic/QuasiStatic/FluxTubes/Shapes/Leakage/CoaxCylindersEndFaces.mo:15
