# FINDING-01369: `dcee.Le` in `DCEE_Start`
...
| **Signature** | `physical:physical-intent-question:var:248:24adea6b` |
...
role          —
declaration   Modelica.Electrical.Machines.BasicMachines.DCMachines.DC_ElectricalExcited.Le
```
...
```
{'quantity': 'Inductance', 'unit': 'H', 'confidence': 'QUANTITY_AND_UNIT', 'premise_state': 'unknown', 'authority': 'quantity_or_unit', 'canonical_declaration': 'Modelica.Electrical.Machines.BasicMachines.DCMachines.DC_ElectricalExcited.Le'}
```
...
| `authority` | quantity_or_unit |
| `canonical_declaration` | Modelica.Electrical.Machines.BasicMachines.DCMachines.DC_ElectricalExcited.Le |
