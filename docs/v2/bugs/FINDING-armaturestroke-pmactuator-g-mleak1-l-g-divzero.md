# FINDING-04247: `pmActuator.g_mLeak1.l_g` in `ArmatureStroke`
...
| **Severity** | high |
| **Declaration** | `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/FluxTubes/Shapes/Leakage/CoaxCylindersEndFaces.mo:20` |
| **Signature** | `divisor:divisor-reachable-zero:exp:1224:e5ea1f9f` |
...
path condition         ((pmActuator.g_mLeak1.t <= pmActuator.g_mLeak1.r_0))
...
| `path_condition` | ((pmActuator.g_mLeak1.t &lt;= pmActuator.g_mLeak1.r_0)) |
| `verdict` | SAT |
...
```console
$ sed -n '20p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/FluxTubes/Shapes/Leakage/CoaxCylindersEndFaces.mo"
```
...
```console
$ grep -rl '| `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/FluxTubes/Shapes/Leakage/CoaxCylindersEndFaces.mo:20` |' docs/v2/bugs/
```
