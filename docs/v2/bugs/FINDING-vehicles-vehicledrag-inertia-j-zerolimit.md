...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:61:10649da4` |
...
```
predicate     vehicleDrag.inertia.J > 0
premise       refuted
...
| `required` | vehicleDrag.inertia.J &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py ModelicaTest.Translational.Vehicles \
      --target vehicleDrag.inertia.J --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "vehicleDrag.inertia.J"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param vehicleDrag.inertia.J=0
```
