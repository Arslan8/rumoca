# FINDING-01084: `zDiode1.Vt` in `OvervoltageProtection`
...
| **Signature** | `divisor:divisor-zero-unresolved:exp:424:b11a045d` |
...
path condition         ((zDiode1.v > (zDiode1.Maxexp * zDiode1.Vt)))
...
| `path_condition` | ((zDiode1.v &gt; (zDiode1.Maxexp * zDiode1.Vt))) |
| `verdict` | UNKNOWN |
| `proof` | the path depends on quantities the artifact does not determine: (zDiode1.v &gt; (zDiode1.Maxexp * zDiode1.Vt)) |
