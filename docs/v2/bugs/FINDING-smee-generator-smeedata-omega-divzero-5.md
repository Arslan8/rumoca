# FINDING-02506: `smeeData.omega` in `SMEE_Generator`
...
| **Severity** | high |
| **Declaration** | `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Machines/Utilities/SynchronousMachineData.mo:84` |
| **Signature** | `divisor:divisor-reachable-zero:exp:1994:dddd3ea0` |
...
```
denominator            (smeeData.omega * smeeData.Tq0Subtransient)
witness                smeeData.omega = 0
  found by             set to zero
denominator at witness 0.0
at declared values     38.7500000326038
...
| `denominator_at_declared_values` | 38.7500000326038 |
...
```console
$ sed -n '84p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Machines/Utilities/SynchronousMachineData.mo"
```
...
```console
$ grep -rl '| `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Machines/Utilities/SynchronousMachineData.mo:84` |' docs/v2/bugs/
```
