# FINDING-02250: `aimcData.Lrsigma` in `IMC_YD`
...
| **Signature** | `physical:physical-intent-question:var:915:2bd41bef` |
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.InductionMachines.IMC_YD \
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.InductionMachines.IMC_YD --keep-artifact /tmp/m.rbc \
