# FINDING-01648: `dcpm2.wNominal` in `DCPM_withLosses`
...
| **Signature** | `divisor:divisor-reachable-zero:exp:653:f0eedcf0` |
...
at declared values     148.44025288212
...
| `denominator_at_declared_values` | 148.44025288212 |
