# FINDING-00789: `Vps` in `Comparator`
...
| **Severity** | high |
| **Declaration** | `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Analog/Examples/OpAmps/Comparator.mo:9` |
| **Signature** | `divisor:divisor-zero-when-parameters-equal:exp:23:717d8872` |
...
| `denominator` | (Vps - Vns) |
| `witness` | Vps = -15 |
| `witness_rationale` | set equal to Vns |
...
```console
$ sed -n '9p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Analog/Examples/OpAmps/Comparator.mo"
```
...
```console
$ grep -rl '| `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Analog/Examples/OpAmps/Comparator.mo:9` |' docs/v2/bugs/
```
