...
| **Reached as** | `Transistor1.Tr.Phie` |
...
| **Signature** | `divisor:divisor-reachable-zero:exp:1235:1676f77d` |
...
```
denominator            Transistor1.Tr.Phie
witness                Transistor1.Tr.Phie = 0
  found by             set to zero
denominator at witness 0.0
at declared values     0.8
path condition         always evaluated
constraints consulted  Transistor1.Tr.Phie: unbounded
```
...
| `constraints` | Transistor1.Tr.Phie: unbounded |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.DifferenceAmplifier \
      --target Transistor1.Tr.Phie --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "Transistor1.Tr.Phie"
```
