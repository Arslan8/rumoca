...
| **Declaration** | `Electrical/Machines/Utilities/ParameterRecords/InductionMachineData.mo:20` |
| **Parameter** | `Lszero` |
| **Type** | `SI.Inductance` |
| **Declared modifiers** | `—` |
...
It should declare `Lszero` with type `SI.Inductance` and no `min`.
...
```modelica
// Electrical/Machines/Utilities/ParameterRecords/InductionMachineData.mo:20
parameter SI.Inductance Lszero(min=0) = ...;
```
