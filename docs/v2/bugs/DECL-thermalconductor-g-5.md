...
| **Declaration** | `Thermal/HeatTransfer/Components/ThermalConductor.mo:5` |
| **Parameter** | `G` |
...
```console
$ grep -n -- "-1e40\|-1E40" "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Thermal/HeatTransfer/Components/ThermalConductor.mo" | head
```
...
```modelica
// Thermal/HeatTransfer/Components/ThermalConductor.mo:5
