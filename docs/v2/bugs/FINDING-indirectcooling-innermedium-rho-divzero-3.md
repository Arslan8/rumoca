# FINDING-04804: `innerMedium.rho` in `IndirectCooling`
...
| **Signature** | `divisor:divisor-reachable-zero:exp:1320:1bc1366e` |
...
| `constraints` | innerMedium.rho: min=0 |
...
$ python3 tools/sweep/check_one.py Modelica.Thermal.FluidHeatFlow.Examples.IndirectCooling \
      --target innerMedium.rho --sanitizer divisor
```
