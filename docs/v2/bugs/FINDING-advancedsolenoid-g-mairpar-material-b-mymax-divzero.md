# FINDING-04307: `g_mAirPar.material.B_myMax` in `AdvancedSolenoid`
...
| **Reached as** | `g_mAirPar.material.B_myMax` |
...
| **Signature** | `divisor:divisor-reachable-zero:exp:1335:3a8f0bc1` |
...
```
denominator            g_mAirPar.material.B_myMax
witness                g_mAirPar.material.B_myMax = 0
  found by             set to zero
denominator at witness 0.0
at declared values     1.0
path condition         always evaluated
constraints consulted  g_mAirPar.material.B_myMax: unbounded
```
...
| `constraints` | g_mAirPar.material.B_myMax: unbounded |
...
$ python3 tools/sweep/check_one.py Modelica.Magnetic.FluxTubes.Examples.SolenoidActuator.Components.AdvancedSolenoid \
      --target g_mAirPar.material.B_myMax --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "g_mAirPar.material.B_myMax"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check \
      --param g_mAirPar.material.B_myMax=0
```
