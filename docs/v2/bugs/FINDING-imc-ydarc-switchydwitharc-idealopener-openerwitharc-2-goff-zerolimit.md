...
| **Reached as** | `switchYDwithArc.idealOpener.openerWithArc[2].Goff` |
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:827:cdd21806` |
...
```
predicate     switchYDwithArc.idealOpener.openerWithArc[2].Goff > 0
premise       refuted
...
| `required` | switchYDwithArc.idealOpener.openerWithArc[2].Goff &gt; 0 |
| `declared_min` | None |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.InductionMachines.IMC_YDarc \
      --target switchYDwithArc.idealOpener.openerWithArc[2].Goff --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "switchYDwithArc.idealOpener.openerWithArc[2].Goff"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param switchYDwithArc.idealOpener.openerWithArc[2].Goff=0
```
