# DECL-0071: `GoffDiode` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Electrical/PowerConverters/DCDC/ChopperBuckBoost.mo:14` |
| **Parameter** | `GoffDiode` |
| **Type** | `SI.Conductance` |
| **Declared modifiers** | `—` |
...
```modelica
// Electrical/PowerConverters/DCDC/ChopperBuckBoost.mo:14
