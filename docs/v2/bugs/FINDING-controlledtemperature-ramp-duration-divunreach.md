# FINDING-05138: `ramp.duration` in `ControlledTemperature`
...
| **Signature** | `divisor:divisor-unreachable-under-witness:exp:290:f56d9a4e` |
...
| `denominator_at_declared_values` | 6.0 |
| `denominator_range` | [0, inf] |
| `path_condition` | not ((time &lt; ramp.startTime)) and ((time &lt; (ramp.startTime + ramp.duration))) |
| `verdict` | UNSAT |
| `proof` | the path conditions cannot hold together: time must be both &gt; 2 and &lt; 2 |
