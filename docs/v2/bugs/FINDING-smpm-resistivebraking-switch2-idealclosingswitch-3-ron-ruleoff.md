# FINDING-02788: `switch2.idealClosingSwitch[3].Ron` in `SMPM_ResistiveBraking`
...
| **Reached as** | `switch2.idealClosingSwitch[3].Ron` |
...
| **Signature** | `physical:physical-rule-does-not-apply:var:903:7af6b46c` |
...
```
predicate     switch2.idealClosingSwitch[3].Ron > 0
premise       refuted
...
| `required` | switch2.idealClosingSwitch[3].Ron &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.SynchronousMachines.SMPM_ResistiveBraking \
      --target switch2.idealClosingSwitch[3].Ron --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "switch2.idealClosingSwitch[3].Ron"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param switch2.idealClosingSwitch[3].Ron=0
```
