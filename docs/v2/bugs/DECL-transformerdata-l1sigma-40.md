...
| **Declaration** | `Electrical/Machines/Utilities/TransformerData.mo:40` |
| **Parameter** | `L1sigma` |
| **Type** | `SI.Inductance` |
| **Declared modifiers** | `—` |
...
```console
$ grep -n -- "-1e40\|-1E40" "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Machines/Utilities/TransformerData.mo" | head
```
...
```modelica
// Electrical/Machines/Utilities/TransformerData.mo:40
