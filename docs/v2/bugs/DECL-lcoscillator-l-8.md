...
| **Declaration** | `Electrical/Analog/Examples/OpAmps/LCOscillator.mo:8` |
| **Parameter** | `L` |
| **Type** | `SI.Inductance` |
| **Declared modifiers** | `—` |
...
```console
$ grep -n -- "-1e40\|-1E40" "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Analog/Examples/OpAmps/LCOscillator.mo" | head
```
...
```modelica
// Electrical/Analog/Examples/OpAmps/LCOscillator.mo:8
