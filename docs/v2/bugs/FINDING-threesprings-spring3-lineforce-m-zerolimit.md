...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:620:ac87728b` |
...
```
predicate     spring3.lineForce.m > 0
premise       refuted
...
| `required` | spring3.lineForce.m &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Mechanics.MultiBody.Examples.Elementary.ThreeSprings \
      --target spring3.lineForce.m --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "spring3.lineForce.m"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param spring3.lineForce.m=0
```
