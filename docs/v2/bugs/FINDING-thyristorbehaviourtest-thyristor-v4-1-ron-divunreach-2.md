# FINDING-01211: `thyristor_v4_1.Ron` in `ThyristorBehaviourTest`
...
| **Signature** | `divisor:divisor-unreachable-under-witness:exp:489:92917306` |
...
```
denominator            thyristor_v4_1.Ron
witness                thyristor_v4_1.Ron = 0
  found by             set to zero
denominator at witness 0.0
at declared values     0.04
path condition         not ((thyristor_v4_1.vAK < -thyristor_v4_1.VRRM)) and not ((thyristor_v4_1.vControl < thyristor_v4_1.Voff)) and not ((thyristor_v4_1.vControl < thyristor_v4_1.Von))
constraints consulted  thyristor_v4_1.Ron: unbounded
```
...
| `path_condition` | not ((thyristor_v4_1.vAK &lt; -thyristor_v4_1.VRRM)) and not ((thyristor_v4_1.vControl &lt; thyristor_v4_1.Voff)) and not ((thyristor_v4_1.vControl &lt; thyristor_v4_1.Von)) |
| `verdict` | UNSAT |
| `proof` | the guard not ((thyristor_v4_1.vControl &lt; thyristor_v4_1.Voff)) is false under the witness |
| `constraints` | thyristor_v4_1.Ron: unbounded |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.ThyristorBehaviourTest \
      --target thyristor_v4_1.Ron --sanitizer divisor
```
