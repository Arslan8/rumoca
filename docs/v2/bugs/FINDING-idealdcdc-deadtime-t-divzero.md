...
| **Signature** | `divisor:divisor-reachable-zero:exp:184:ed85188f` |
...
| `constraints` | deadTime.T: unbounded |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.ControlledDCDrives.Utilities.IdealDcDc \
      --target deadTime.T --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "deadTime.T"
```
