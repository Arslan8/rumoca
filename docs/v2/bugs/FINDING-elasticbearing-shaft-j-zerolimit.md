# FINDING-04654: `shaft.J` in `ElasticBearing`
...
$ python3 tools/sweep/check_one.py Modelica.Mechanics.Rotational.Examples.ElasticBearing \
      --target shaft.J --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "shaft.J"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param shaft.J=0
```
