...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:40:3c072c27` |
...
$ python3 tools/sweep/check_one.py ModelicaTest.Translational.AllComponents \
      --target slidingMass1.m --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "slidingMass1.m"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param slidingMass1.m=0
```
