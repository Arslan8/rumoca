# FINDING-00369: `TC1.G` in `HeatingPNP_NORGate`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:13:4b14b1e3` |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.HeatingPNP_NORGate \
      --target TC1.G --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "TC1.G"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param TC1.G=0
```
