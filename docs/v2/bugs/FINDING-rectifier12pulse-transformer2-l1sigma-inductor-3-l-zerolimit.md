# FINDING-03179: `transformer2.l1sigma.inductor[3].L` in `Rectifier12pulse`
...
| **Reached as** | `transformer2.l1sigma.inductor[3].L` |
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:1103:aae4c65d` |
...
```
predicate     transformer2.l1sigma.inductor[3].L > 0
premise       refuted
...
| `required` | transformer2.l1sigma.inductor[3].L &gt; 0 |
| `declared_min` | None |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.Transformers.Rectifier12pulse \
      --target transformer2.l1sigma.inductor[3].L --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "transformer2.l1sigma.inductor[3].L"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param transformer2.l1sigma.inductor[3].L=0
```
