# DECL-0709: `R1` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Electrical/Machines/Interfaces/PartialBasicTransformer.mo:9` |
| **Parameter** | `R1` |
| **Type** | `SI.Resistance` |
...
```modelica
// Electrical/Machines/Interfaces/PartialBasicTransformer.mo:9
