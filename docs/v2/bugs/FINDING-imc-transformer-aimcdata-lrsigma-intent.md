# FINDING-02090: `aimcData.Lrsigma` in `IMC_Transformer`
...
| **Signature** | `physical:physical-intent-question:var:1258:8806a233` |
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.InductionMachines.IMC_Transformer \
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.InductionMachines.IMC_Transformer --keep-artifact /tmp/m.rbc \
