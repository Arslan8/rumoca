...
| **Declaration** | `Electrical/QuasiStatic/SinglePhase/Basic/Inductor.mo:5` |
| **Parameter** | `L` |
| **Type** | `SI.Inductance` |
...
```console
$ sed -n '5p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/QuasiStatic/SinglePhase/Basic/Inductor.mo"
```
...
```console
$ grep -n -- "-1e40\|-1E40" "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/QuasiStatic/SinglePhase/Basic/Inductor.mo" | head
```
...
```modelica
// Electrical/QuasiStatic/SinglePhase/Basic/Inductor.mo:5
