# FINDING-04722: `s1.c` in `InitialConditions`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:53:73aa3327` |
...
$ python3 tools/sweep/check_one.py Modelica.Mechanics.Translational.Examples.InitialConditions \
      --target s1.c --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "s1.c"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param s1.c=0
```
