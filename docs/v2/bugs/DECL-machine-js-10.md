# DECL-0324: `Js` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Magnetic/FundamentalWave/BaseClasses/Machine.mo:10` |
| **Parameter** | `Js` |
| **Type** | `SI.Inertia` |
...
```console
$ sed -n '10p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/FundamentalWave/BaseClasses/Machine.mo"
```
...
```modelica
// Magnetic/FundamentalWave/BaseClasses/Machine.mo:10
