# DECL-0358: `I22` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Mechanics/MultiBody/Parts/BodyCylinder.mo:105` |
| **Parameter** | `I22` |
| **Type** | `SI.Inertia` |
| **Declared modifiers** | `—` |
...
```console
$ sed -n '105p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Mechanics/MultiBody/Parts/BodyCylinder.mo"
```

It should declare `I22` with type `SI.Inertia` and no `min`.
...
```console
$ grep -n -- "-1e40\|-1E40" "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Mechanics/MultiBody/Parts/BodyCylinder.mo" | head
```
...
```modelica
// Mechanics/MultiBody/Parts/BodyCylinder.mo:105
parameter SI.Inertia I22(min=0) = ...;
```
