# FINDING-04226: `pmLoad.m` in `ArmatureStroke`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:225:e7926bfc` |
...
$ python3 tools/sweep/check_one.py Modelica.Magnetic.FluxTubes.Examples.MovingCoilActuator.ArmatureStroke \
      --target pmLoad.m --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "pmLoad.m"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param pmLoad.m=0
```
