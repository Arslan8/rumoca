# FINDING-04723: `m1.m` in `InitialConditions`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:61:ed68d93d` |
...
$ python3 tools/sweep/check_one.py Modelica.Mechanics.Translational.Examples.InitialConditions \
      --target m1.m --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "m1.m"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param m1.m=0
```
