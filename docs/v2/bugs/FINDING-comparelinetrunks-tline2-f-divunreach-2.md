# FINDING-00546: `tLine2.F` in `CompareLineTrunks`
...
| **Signature** | `divisor:divisor-unreachable-under-witness:exp:3761:e32c6f21` |
...
| `denominator_range` |  |
| `path_condition` | ((tLine2.F &gt; 0)) |
| `verdict` | UNSAT |
| `proof` | the denominator is zero as declared, and ((tLine2.F &gt; 0)) |
| `constraints` |  |
| `guard_that_excludes_it` | ((tLine2.F &gt; 0)) |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.Lines.CompareLineTrunks \
      --target tLine2.F --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "tLine2.F"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param tLine2.F=0
```
