...
| **Declaration** | `Electrical/Polyphase/Basic/Conductor.mo:4` |
| **Parameter** | `G` |
| **Type** | `SI.Conductance` |
...
```console
$ sed -n '4p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Polyphase/Basic/Conductor.mo"
```
...
```console
$ grep -n -- "-1e40\|-1E40" "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Polyphase/Basic/Conductor.mo" | head
```
...
```modelica
// Electrical/Polyphase/Basic/Conductor.mo:4
