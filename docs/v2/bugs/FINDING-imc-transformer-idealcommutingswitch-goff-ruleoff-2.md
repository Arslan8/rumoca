# FINDING-03072: `idealCommutingSwitch.Goff` in `IMC_Transformer`
...
| **Reached as** | `idealCommutingSwitch.Goff` |
...
| **Signature** | `physical:physical-rule-does-not-apply:var:1096:3c9a9695` |
...
```
predicate     idealCommutingSwitch.Goff > 0
premise       refuted
...
| `required` | idealCommutingSwitch.Goff &gt; 0 |
| `declared_min` | None |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.Transformers.IMC_Transformer \
      --target idealCommutingSwitch.Goff --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "idealCommutingSwitch.Goff"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param idealCommutingSwitch.Goff=0
```
