# FINDING-01727: `imc.inertiaRotor.J` in `IMC_DCBraking`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:370:3bee851e` |
...
```
predicate     imc.inertiaRotor.J > 0
premise       refuted
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.InductionMachines.IMC_DCBraking \
      --target imc.inertiaRotor.J --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "imc.inertiaRotor.J"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param imc.inertiaRotor.J=0
```
