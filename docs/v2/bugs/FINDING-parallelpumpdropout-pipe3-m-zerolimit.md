# FINDING-04896: `pipe3.m` in `ParallelPumpDropOut`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:188:bc992991` |
...
$ python3 tools/sweep/check_one.py Modelica.Thermal.FluidHeatFlow.Examples.ParallelPumpDropOut \
      --target pipe3.m --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "pipe3.m"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param pipe3.m=0
```
