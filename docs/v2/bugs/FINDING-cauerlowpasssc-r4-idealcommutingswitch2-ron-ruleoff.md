...
| **Signature** | `physical:physical-rule-does-not-apply:var:199:f2352dda` |
...
```
predicate     R4.IdealCommutingSwitch2.Ron > 0
premise       refuted
...
| `required` | R4.IdealCommutingSwitch2.Ron &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.CauerLowPassSC \
      --target R4.IdealCommutingSwitch2.Ron --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "R4.IdealCommutingSwitch2.Ron"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param R4.IdealCommutingSwitch2.Ron=0
```
