# FINDING-01659: `dcse.Ra` in `DCSE_SinglePhase`
...
| **Signature** | `physical:physical-domain-unenforced:var:11:90eecd78` |
...
declaration   Modelica.Electrical.Machines.BasicMachines.DCMachines.DC_SeriesExcited.Ra
```
...
```
{'quantity': 'Resistance', 'unit': 'Ohm', 'semantic_role': 'component.machine.winding_resistance', 'binding_source': 'component_type', 'confidence': 'QUANTITY_AND_UNIT', 'declaring_class': 'Modelica.Electrical.Machines.BasicMachines.DCMachines.DC_SeriesExcited', 'member': 'Ra', 'premise_state': 'established', 'authority': 'component_contract', 'canonical_declaration': 'Modelica.Electrical.Machines.BasicMachines.DCMachines.DC_SeriesExcited.Ra'}
```
...
| `canonical_declaration` | Modelica.Electrical.Machines.BasicMachines.DCMachines.DC_SeriesExcited.Ra |
