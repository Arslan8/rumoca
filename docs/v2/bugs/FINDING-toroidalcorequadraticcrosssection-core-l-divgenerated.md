# FINDING-04208: `core.l` in `ToroidalCoreQuadraticCrossSection`
...
| **Signature** | `divisor:divisor-introduced-by-translation:exp:313:bb5e34a7` |
...
constraints consulted  core.l: unbounded
```
...
$ python3 tools/sweep/check_one.py Modelica.Magnetic.FluxTubes.Examples.BasicExamples.ToroidalCoreQuadraticCrossSection \
      --target core.l --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "core.l"
```
