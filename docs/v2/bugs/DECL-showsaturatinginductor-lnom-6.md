# DECL-0118: `Lnom` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Electrical/Analog/Examples/ShowSaturatingInductor.mo:6` |
| **Parameter** | `Lnom` |
| **Type** | `SI.Inductance` |
| **Declared modifiers** | `—` |
...
```console
$ grep -n -- "-1e40\|-1E40" "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Analog/Examples/ShowSaturatingInductor.mo" | head
```
...
```modelica
// Electrical/Analog/Examples/ShowSaturatingInductor.mo:6
