...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:174:f2f6ec97` |
...
$ python3 tools/sweep/check_one.py ModelicaTest.Translational.AllComponents \
      --target slidingMass6.m --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "slidingMass6.m"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param slidingMass6.m=0
```
