# FINDING-03473: `dcpm.la.L` in `ThyristorBridge2mPulse_DC_Drive`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:755:748acfef` |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.PowerConverters.Examples.ACDC.RectifierBridge2mPulse.ThyristorBridge2mPulse_DC_Drive \
      --target dcpm.la.L --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "dcpm.la.L"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param dcpm.la.L=0
```
