# FINDING-02526: `JLoad` in `SMPM_Braking`
...
| **Severity** | low |
| **Declaration** | `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Machines/Examples/SynchronousMachines/SMPM_Braking.mo:11` |
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:4:1f9d7461` |
...
```
{'quantity': 'MomentOfInertia', 'unit': 'kg.m2', 'confidence': 'QUANTITY_AND_UNIT', 'premise_state': 'unknown', 'authority': 'quantity_or_unit', 'canonical_declaration': 'Modelica.Electrical.Machines.Examples.SynchronousMachines.SMPM_Braking.JLoad'}
```
...
```console
$ sed -n '11p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Machines/Examples/SynchronousMachines/SMPM_Braking.mo"
```
...
```console
$ grep -rl '| `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Machines/Examples/SynchronousMachines/SMPM_Braking.mo:11` |' docs/v2/bugs/
```
