# FINDING-00030: `c0` in `MixingUnit`
...
| **Signature** | `divisor:divisor-reachable-zero:exp:28:d388f1c3` |
...
constraints consulted  c0: unbounded
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "c0"
```
