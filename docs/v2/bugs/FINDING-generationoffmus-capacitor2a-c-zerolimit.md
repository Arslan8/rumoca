...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:165:b34255b8` |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.GenerationOfFMUs \
      --target capacitor2a.C --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "capacitor2a.C"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param capacitor2a.C=0
```
