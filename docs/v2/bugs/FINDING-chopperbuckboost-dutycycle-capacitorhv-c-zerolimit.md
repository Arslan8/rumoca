# FINDING-04007: `capacitorHV.C` in `ChopperBuckBoost_DutyCycle`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:181:1aee69e2` |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.PowerConverters.Examples.DCDC.ChopperBuckBoost.ChopperBuckBoost_DutyCycle \
      --target capacitorHV.C --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "capacitorHV.C"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param capacitorHV.C=0
```
