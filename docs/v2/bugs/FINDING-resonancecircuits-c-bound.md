# FINDING-01118: `C` in `ResonanceCircuits`
...
| **Severity** | low |
| **Declaration** | `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Analog/Examples/ResonanceCircuits.mo:6` |
| **Signature** | `physical:physical-bound-permits-zero:var:0:86fe8bc1` |
...
role          —
declaration   Modelica.Electrical.Analog.Examples.ResonanceCircuits.C
```
...
```
{'quantity': 'Capacitance', 'unit': 'F', 'confidence': 'QUANTITY_AND_UNIT', 'premise_state': 'unknown', 'authority': 'quantity_or_unit', 'canonical_declaration': 'Modelica.Electrical.Analog.Examples.ResonanceCircuits.C'}
```
...
| `authority` | source_arithmetic |
| `canonical_declaration` | Modelica.Electrical.Analog.Examples.ResonanceCircuits.C |
...
```console
$ sed -n '6p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Analog/Examples/ResonanceCircuits.mo"
```
...
```console
$ grep -rl '| `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Analog/Examples/ResonanceCircuits.mo:6` |' docs/v2/bugs/
```
