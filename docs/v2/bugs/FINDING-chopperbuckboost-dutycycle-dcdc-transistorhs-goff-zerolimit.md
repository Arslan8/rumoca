# FINDING-04002: `dcdc.transistorHS.Goff` in `ChopperBuckBoost_DutyCycle`
...
| **Reached as** | `dcdc.transistorHS.Goff` |
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:90:20d7754e` |
...
```
predicate     dcdc.transistorHS.Goff > 0
premise       refuted
...
| `required` | dcdc.transistorHS.Goff &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.PowerConverters.Examples.DCDC.ChopperBuckBoost.ChopperBuckBoost_DutyCycle \
      --target dcdc.transistorHS.Goff --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "dcdc.transistorHS.Goff"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param dcdc.transistorHS.Goff=0
```
