# FINDING-04740: `mass2.m` in `SignConvention`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:23:dd5a7f5a` |
...
```console
$ python3 tools/sweep/check_one.py Modelica.Mechanics.Translational.Examples.SignConvention \
...
```console
$ python3 tools/sweep/check_one.py Modelica.Mechanics.Translational.Examples.SignConvention --keep-artifact /tmp/m.rbc \
