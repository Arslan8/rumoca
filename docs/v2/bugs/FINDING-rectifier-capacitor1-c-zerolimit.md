# FINDING-01115: `Capacitor1.C` in `Rectifier`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:195:76bfe949` |
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.Rectifier \
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.Rectifier --keep-artifact /tmp/m.rbc \
