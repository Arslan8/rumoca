...
| **Declaration** | `Magnetic/QuasiStatic/FluxTubes/Basic/EddyCurrent.mo:14` |
| **Parameter** | `rho` |
| **Type** | `SI.Resistivity` |
| **Declared modifiers** | `—` |
...
```console
$ sed -n '14p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/QuasiStatic/FluxTubes/Basic/EddyCurrent.mo"
```
...
```console
$ grep -n -- "-1e40\|-1E40" "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/QuasiStatic/FluxTubes/Basic/EddyCurrent.mo" | head
```
...
```modelica
// Magnetic/QuasiStatic/FluxTubes/Basic/EddyCurrent.mo:14
