# FINDING-04507: `body3.m` in `PointGravityWithPointMasses`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:284:8c16d7d3` |
...
$ python3 tools/sweep/check_one.py Modelica.Mechanics.MultiBody.Examples.Elementary.PointGravityWithPointMasses \
      --target body3.m --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "body3.m"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param body3.m=0
```
