# DECL-0465: `L` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Magnetic/FluxTubes/Examples/Utilities/TranslatoryArmatureAndStopper.mo:5` |
| **Parameter** | `L` |
| **Type** | `SI.Length` |
| **Declared modifiers** | `(start=0)` |
...
```console
$ sed -n '5p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/FluxTubes/Examples/Utilities/TranslatoryArmatureAndStopper.mo"
```
...
```console
$ grep -n -- "-1e40\|-1E40" "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/FluxTubes/Examples/Utilities/TranslatoryArmatureAndStopper.mo" | head
```
...
```modelica
// Magnetic/FluxTubes/Examples/Utilities/TranslatoryArmatureAndStopper.mo:5
