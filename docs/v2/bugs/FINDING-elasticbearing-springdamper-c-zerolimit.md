...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:38:526dde96` |
...
```console
$ python3 tools/sweep/check_one.py Modelica.Mechanics.Rotational.Examples.ElasticBearing --keep-artifact /tmp/m.rbc \
