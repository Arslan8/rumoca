# FINDING-03682: `pulse2.twoPulse.filter[1].transferFunction[2].a_end` in `ThyristorBridge2Pulse_DC_Drive`
...
| **Signature** | `divisor:divisor-reachable-zero:exp:2268:b73bce0c` |
