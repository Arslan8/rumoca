# FINDING-00325: `TC3.G` in `HeatingMOSInverter`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:146:c5623c9b` |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.HeatingMOSInverter \
      --target TC3.G --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "TC3.G"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param TC3.G=0
```
