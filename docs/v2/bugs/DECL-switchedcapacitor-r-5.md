...
| **Declaration** | `Electrical/Analog/Examples/Utilities/SwitchedCapacitor.mo:5` |
| **Parameter** | `R` |
| **Type** | `SI.Resistance` |
...
```console
$ grep -n -- "-1e40\|-1E40" "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Analog/Examples/Utilities/SwitchedCapacitor.mo" | head
```
...
```modelica
// Electrical/Analog/Examples/Utilities/SwitchedCapacitor.mo:5
