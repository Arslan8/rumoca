# FINDING-00125: `R9.R` in `CauerLowPassSC`
...
| **Signature** | `physical:physical-rule-does-not-apply:var:368:018b8dcf` |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.CauerLowPassSC \
      --target R9.R --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "R9.R"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param R9.R=0
```
