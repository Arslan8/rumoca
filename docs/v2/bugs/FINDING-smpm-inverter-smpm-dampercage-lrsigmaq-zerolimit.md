# FINDING-02666: `smpm.damperCage.Lrsigmaq` in `SMPM_Inverter`
...
| **Reached as** | `smpm.damperCage.Lrsigmaq` |
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:455:1871e9d8` |
...
```
predicate     smpm.damperCage.Lrsigmaq > 0
premise       refuted
...
| `required` | smpm.damperCage.Lrsigmaq &gt; 0 |
| `declared_min` | None |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.SynchronousMachines.SMPM_Inverter \
      --target smpm.damperCage.Lrsigmaq --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "smpm.damperCage.Lrsigmaq"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param smpm.damperCage.Lrsigmaq=0
```
