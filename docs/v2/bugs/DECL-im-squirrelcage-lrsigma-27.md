# DECL-0256: `Lrsigma` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Magnetic/FundamentalWave/BasicMachines/InductionMachines/IM_SquirrelCage.mo:27` |
| **Parameter** | `Lrsigma` |
| **Type** | `SI.Inductance` |
...
```console
$ sed -n '27p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/FundamentalWave/BasicMachines/InductionMachines/IM_SquirrelCage.mo"
```
...
```console
$ grep -n -- "-1e40\|-1E40" "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/FundamentalWave/BasicMachines/InductionMachines/IM_SquirrelCage.mo" | head
```
...
```modelica
// Magnetic/FundamentalWave/BasicMachines/InductionMachines/IM_SquirrelCage.mo:27
