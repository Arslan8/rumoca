# FINDING-04029: `ILoad` in `ChopperStepDown_RL`
...
| **Signature** | `divisor:divisor-reachable-zero:exp:319:3b01c1a0` |
...
at declared values     1.2
path condition         always evaluated
constraints consulted  ILoad: unbounded
```
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.PowerConverters.Examples.DCDC.ChopperStepDown.ChopperStepDown_RL \
      --target ILoad --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "ILoad"
```
