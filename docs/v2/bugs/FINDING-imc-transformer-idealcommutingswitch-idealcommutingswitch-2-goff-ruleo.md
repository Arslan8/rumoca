# FINDING-02080: `idealCommutingSwitch.idealCommutingSwitch[2].Goff` in `IMC_Transformer`
...
| **Reached as** | `idealCommutingSwitch.idealCommutingSwitch[2].Goff` |
...
| **Signature** | `physical:physical-rule-does-not-apply:var:1141:f6688bc7` |
...
```
predicate     idealCommutingSwitch.idealCommutingSwitch[2].Goff > 0
premise       refuted
...
| `required` | idealCommutingSwitch.idealCommutingSwitch[2].Goff &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.InductionMachines.IMC_Transformer \
      --target idealCommutingSwitch.idealCommutingSwitch[2].Goff --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "idealCommutingSwitch.idealCommutingSwitch[2].Goff"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param idealCommutingSwitch.idealCommutingSwitch[2].Goff=0
```
