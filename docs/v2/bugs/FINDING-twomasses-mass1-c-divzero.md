...
| **Severity** | high |
| **Declaration** | `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Thermal/HeatTransfer/Examples/TwoMasses.mo:26` |
| **Signature** | `divisor:divisor-reachable-zero:exp:131:75bd585b` |
...
constraints consulted  mass1.C: unbounded
```
...
$ python3 tools/sweep/check_one.py Modelica.Thermal.HeatTransfer.Examples.TwoMasses \
      --target mass1.C --sanitizer divisor
```
...
```console
$ sed -n '26p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Thermal/HeatTransfer/Examples/TwoMasses.mo"
```
...
```console
$ grep -rl '| `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Thermal/HeatTransfer/Examples/TwoMasses.mo:26` |' docs/v2/bugs/
```
