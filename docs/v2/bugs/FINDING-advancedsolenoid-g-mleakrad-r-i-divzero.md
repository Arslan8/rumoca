...
| **Signature** | `divisor:divisor-reachable-zero:exp:2017:d9a59baf` |
...
| `constraints` | G_mLeakRad.r_i: min=0 |
...
$ python3 tools/sweep/check_one.py Modelica.Magnetic.FluxTubes.Examples.SolenoidActuator.Components.AdvancedSolenoid \
      --target G_mLeakRad.r_i --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "G_mLeakRad.r_i"
```
