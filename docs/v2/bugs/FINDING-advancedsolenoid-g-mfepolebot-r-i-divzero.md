...
| **Signature** | `divisor:divisor-reachable-zero:exp:1508:817292fd` |
...
| `constraints` | g_mFePoleBot.r_i: min=0 |
...
$ python3 tools/sweep/check_one.py Modelica.Magnetic.FluxTubes.Examples.SolenoidActuator.Components.AdvancedSolenoid \
      --target g_mFePoleBot.r_i --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "g_mFePoleBot.r_i"
```
