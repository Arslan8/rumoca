# DECL-0458: `l_pole` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Magnetic/FluxTubes/Examples/SolenoidActuator/Components/SimpleSolenoid.mo:17` |
| **Parameter** | `l_pole` |
| **Type** | `SI.Length` |
| **Declared modifiers** | `—` |
...
```console
$ sed -n '17p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/FluxTubes/Examples/SolenoidActuator/Components/SimpleSolenoid.mo"
```
...
```modelica
// Magnetic/FluxTubes/Examples/SolenoidActuator/Components/SimpleSolenoid.mo:17
