...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:45:e8120fa1` |
...
$ python3 tools/sweep/check_one.py Modelica.Mechanics.Rotational.Examples.CompareBrakingTorque \
      --target inertia3.J --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "inertia3.J"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param inertia3.J=0
```
