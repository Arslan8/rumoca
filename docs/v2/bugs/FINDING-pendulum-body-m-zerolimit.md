# FINDING-04454: `body.m` in `Pendulum`

|  |  |
|---|---|
| **Tier** | **Candidate** — static only, not execution-confirmed |
| **Model** | `Modelica.Mechanics.MultiBody.Examples.Elementary.Pendulum` |
| **Reached as** | `body.m` |
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:307:b264f73c` |
...
```console
$ python3 tools/sweep/check_one.py Modelica.Mechanics.MultiBody.Examples.Elementary.Pendulum \
...
```console
$ python3 tools/sweep/check_one.py Modelica.Mechanics.MultiBody.Examples.Elementary.Pendulum --keep-artifact /tmp/m.rbc \
