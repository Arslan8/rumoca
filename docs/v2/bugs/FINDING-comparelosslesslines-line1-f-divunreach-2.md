# FINDING-00564: `line1.F` in `CompareLosslessLines`
...
| **Signature** | `divisor:divisor-unreachable-under-witness:exp:101:646fd897` |
...
| `denominator_range` |  |
| `path_condition` | ((line1.F &gt; 0)) |
| `verdict` | UNSAT |
| `proof` | the denominator is zero as declared, and ((line1.F &gt; 0)) |
| `constraints` |  |
| `guard_that_excludes_it` | ((line1.F &gt; 0)) |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.Lines.CompareLosslessLines \
      --target line1.F --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "line1.F"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param line1.F=0
```
