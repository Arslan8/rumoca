# FINDING-04732: `spool.m` in `PreLoad`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:48:205779d4` |
...
$ python3 tools/sweep/check_one.py Modelica.Mechanics.Translational.Examples.PreLoad \
      --target spool.m --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "spool.m"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param spool.m=0
```
