# FINDING-02731: `ramp.duration` in `SMPM_NoLoad`
...
| **Signature** | `divisor:divisor-unreachable-under-witness:exp:2427:752a3129` |
...
| `denominator_at_declared_values` | 0.16 |
| `denominator_range` | [0, inf] |
| `path_condition` | not ((time &lt; ramp.startTime)) and ((time &lt; (ramp.startTime + ramp.duration))) |
| `verdict` | UNSAT |
| `proof` | the path conditions cannot hold together: time must be both &gt; 0.08 and &lt; 0.08 |
