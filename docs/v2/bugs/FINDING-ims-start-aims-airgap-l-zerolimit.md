# FINDING-02281: `aims.airGap.L` in `IMS_Start`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:417:d69eb661` |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.InductionMachines.IMS_Start \
      --target aims.airGap.L --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "aims.airGap.L"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param aims.airGap.L=0
```
