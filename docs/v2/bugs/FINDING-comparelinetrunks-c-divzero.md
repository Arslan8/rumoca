# FINDING-00541: `c` in `CompareLineTrunks`
...
| **Severity** | high |
| **Declaration** | `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Analog/Examples/Lines/CompareLineTrunks.mo:14` |
| **Signature** | `divisor:divisor-reachable-zero:exp:32:ecf214b4` |
...
at declared values     316227766.01683795
path condition         always evaluated
constraints consulted  c: unbounded
```
...
```console
$ sed -n '14p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Analog/Examples/Lines/CompareLineTrunks.mo"
```
...
```console
$ grep -rl '| `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Analog/Examples/Lines/CompareLineTrunks.mo:14` |' docs/v2/bugs/
```
