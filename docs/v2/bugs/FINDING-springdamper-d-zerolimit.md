# FINDING-04679: `d` in `SpringDamper`
...
| **Severity** | low |
| **Declaration** | `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Mechanics/Rotational/Examples/Utilities/SpringDamper.mo:6` |
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:1:52e3e43d` |
...
```
{'quantity': 'RotationalDampingConstant', 'unit': 'N.m.s/rad', 'confidence': 'QUANTITY', 'premise_state': 'unknown', 'authority': 'quantity_or_unit', 'canonical_declaration': 'Modelica.Mechanics.Rotational.Examples.Utilities.SpringDamper.d'}
```
...
```console
$ sed -n '6p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Mechanics/Rotational/Examples/Utilities/SpringDamper.mo"
```
...
```console
$ grep -rl '| `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Mechanics/Rotational/Examples/Utilities/SpringDamper.mo:6` |' docs/v2/bugs/
```
