# DECL-0041: `A` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Thermal/FluidHeatFlow/Components/Cylinder.mo:6` |
| **Parameter** | `A` |
| **Type** | `SI.Area` |
| **Declared modifiers** | `—` |
...
```console
$ sed -n '6p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Thermal/FluidHeatFlow/Components/Cylinder.mo"
```
...
```modelica
// Thermal/FluidHeatFlow/Components/Cylinder.mo:6
