# FINDING-00863: `vIn.signalSource.rising` in `HighPass`
...
| **Signature** | `divisor:divisor-zero-unresolved:exp:472:46456dbf` |
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.OpAmps.HighPass \
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.OpAmps.HighPass --keep-artifact /tmp/m.rbc \
