# DECL-0585: `samplePeriod` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Blocks/package.mo:1855` |
...
```console
$ sed -n '1855p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Blocks/package.mo"
```
...
```console
$ grep -n -- "-1e40\|-1E40" "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Blocks/package.mo" | head
```
