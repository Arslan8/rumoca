# DECL-0859: `R` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Magnetic/FundamentalWave/Examples/Components/SinglePhaseInductance.mo:6` |
| **Parameter** | `R` |
| **Type** | `SI.Resistance` |
| **Declared modifiers** | `—` |
...
```console
$ sed -n '6p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/FundamentalWave/Examples/Components/SinglePhaseInductance.mo"
```
...
```modelica
// Magnetic/FundamentalWave/Examples/Components/SinglePhaseInductance.mo:6
