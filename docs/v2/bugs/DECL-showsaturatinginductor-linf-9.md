# DECL-0119: `Linf` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Electrical/Analog/Examples/ShowSaturatingInductor.mo:9` |
| **Parameter** | `Linf` |
| **Type** | `SI.Inductance` |
| **Declared modifiers** | `—` |
...
```modelica
// Electrical/Analog/Examples/ShowSaturatingInductor.mo:9
