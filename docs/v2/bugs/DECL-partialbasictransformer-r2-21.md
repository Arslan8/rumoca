# DECL-0710: `R2` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Electrical/Machines/Interfaces/PartialBasicTransformer.mo:21` |
| **Parameter** | `R2` |
| **Type** | `SI.Resistance` |
...
```modelica
// Electrical/Machines/Interfaces/PartialBasicTransformer.mo:21
