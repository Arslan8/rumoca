# FINDING-03210: `transformerData2.V1ph` in `Rectifier12pulse`
...
| **Reached as** | `transformerData2.V1ph` |
...
| **Signature** | `divisor:divisor-reachable-zero:exp:2836:6633a673` |
...
```
denominator            (3 * transformerData2.V1ph)
witness                transformerData2.V1ph = 0
  found by             set to zero
denominator at witness 0.0
at declared values     None
path condition         always evaluated
constraints consulted  transformerData2.V1ph: unbounded
```
...
| `constraints` | transformerData2.V1ph: unbounded |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.Transformers.Rectifier12pulse \
      --target transformerData2.V1ph --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "transformerData2.V1ph"
```
