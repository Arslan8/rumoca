# DECL-0074: `GoffTransistor` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Electrical/PowerConverters/DCDC/HBridge.mo:10` |
...
```console
$ grep -n -- "-1e40\|-1E40" "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/PowerConverters/DCDC/HBridge.mo" | head
```
...
```modelica
// Electrical/PowerConverters/DCDC/HBridge.mo:10
