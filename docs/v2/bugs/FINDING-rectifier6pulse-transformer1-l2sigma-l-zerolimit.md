# FINDING-03260: `transformer1.l2sigma.L` in `Rectifier6pulse`
...
| **Reached as** | `transformer1.l2sigma.L` |
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:593:bef0e399` |
...
```
predicate     transformer1.l2sigma.L > 0
premise       refuted
...
| `required` | transformer1.l2sigma.L &gt; 0 |
| `declared_min` | None |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.Transformers.Rectifier6pulse \
      --target transformer1.l2sigma.L --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "transformer1.l2sigma.L"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param transformer1.l2sigma.L=0
```
