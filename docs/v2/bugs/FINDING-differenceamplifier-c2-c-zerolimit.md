# FINDING-00276: `C2.C` in `DifferenceAmplifier`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:132:a29129ff` |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.DifferenceAmplifier \
      --target C2.C --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "C2.C"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param C2.C=0
```
