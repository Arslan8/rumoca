# FINDING-00827: `PIA.k` in `ControlCircuit`
...
| **Signature** | `divisor:divisor-reachable-zero:exp:231:41c2ea49` |
...
constraints consulted  PIA.k: min=0
```
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.OpAmps.ControlCircuit \
      --target PIA.k --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "PIA.k"
```
