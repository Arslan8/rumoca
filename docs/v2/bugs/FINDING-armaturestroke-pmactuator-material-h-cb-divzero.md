...
| **Reached as** | `pmActuator.material.H_cB` |
| **Found by** | **DivisorSan** — `packages/modelsan/modelsan/sanitizers/divisor.py` |
| **Reported as** | `divisor-reachable-zero` |
| **Severity** | high |
| **Declaration** | `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/FluxTubes/Material/HardMagnetic/BaseData.mo:19` |
| **Signature** | `divisor:divisor-reachable-zero:exp:64:ae44f865` |
...
```
denominator            (1.25663706212e-06 * pmActuator.material.H_cB)
witness                pmActuator.material.H_cB = 0
  found by             set to zero
denominator at witness 0.0
at declared values     0.502654824848
path condition         always evaluated
constraints consulted  pmActuator.material.H_cB: unbounded
```
...
$ python3 tools/sweep/check_one.py Modelica.Magnetic.FluxTubes.Examples.MovingCoilActuator.ArmatureStroke \
      --target pmActuator.material.H_cB --sanitizer divisor
```
...
```console
$ sed -n '19p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/FluxTubes/Material/HardMagnetic/BaseData.mo"
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "pmActuator.material.H_cB"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check \
      --param pmActuator.material.H_cB=0
```
...
```console
$ grep -rl '| `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/FluxTubes/Material/HardMagnetic/BaseData.mo:19` |' docs/v2/bugs/
```
