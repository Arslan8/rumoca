...
| **Declaration** | `Electrical/Machines/Utilities/ParameterRecords/DcPermanentMagnetData.mo:6` |
| **Parameter** | `Js` |
| **Type** | `SI.Inertia` |
| **Declared modifiers** | `—` |
...
It should declare `Js` with type `SI.Inertia` and no `min`.
...
```modelica
// Electrical/Machines/Utilities/ParameterRecords/DcPermanentMagnetData.mo:6
parameter SI.Inertia Js(min=0) = ...;
```
