# FINDING-00327: `H_PMOS.L` in `HeatingMOSInverter`
...
| **Signature** | `divisor:divisor-guarded-by-assertion:exp:381:3dfb172c` |
...
| `denominator_at_declared_values` | 3.9e-06 |
| `denominator_range` |  |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.HeatingMOSInverter \
      --target H_PMOS.L --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "H_PMOS.L"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param H_PMOS.L=0
```
