# FINDING-04295: `c_par2.C` in `AdvancedSolenoid`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:400:f3d5a278` |
...
$ python3 tools/sweep/check_one.py Modelica.Magnetic.FluxTubes.Examples.SolenoidActuator.Components.AdvancedSolenoid \
      --target c_par2.C --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "c_par2.C"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param c_par2.C=0
```
