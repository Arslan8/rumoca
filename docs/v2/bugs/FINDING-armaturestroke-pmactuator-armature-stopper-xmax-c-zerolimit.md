# FINDING-04224: `pmActuator.armature.stopper_xMax.c` in `ArmatureStroke`
...
| **Reached as** | `pmActuator.armature.stopper_xMax.c` |
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:83:abae76cd` |
...
```
predicate     pmActuator.armature.stopper_xMax.c > 0
premise       refuted
...
| `required` | pmActuator.armature.stopper_xMax.c &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Magnetic.FluxTubes.Examples.MovingCoilActuator.ArmatureStroke \
      --target pmActuator.armature.stopper_xMax.c --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "pmActuator.armature.stopper_xMax.c"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param pmActuator.armature.stopper_xMax.c=0
```
