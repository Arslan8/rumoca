# FINDING-01672: `dcseData.Js` in `DCSE_SinglePhase`
...
| **Signature** | `physical:physical-intent-question:var:385:d71fafee` |
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.DCMachines.DCSE_SinglePhase \
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.DCMachines.DCSE_SinglePhase --keep-artifact /tmp/m.rbc \
