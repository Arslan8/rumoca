# DECL-0611: `Rload` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Electrical/Analog/Examples/Lines/LightningLosslessTransmissionLine.mo:7` |
| **Parameter** | `Rload` |
| **Type** | `SI.Resistance` |
| **Declared modifiers** | `—` |
...
```console
$ sed -n '7p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Analog/Examples/Lines/LightningLosslessTransmissionLine.mo"
```
...
```modelica
// Electrical/Analog/Examples/Lines/LightningLosslessTransmissionLine.mo:7
