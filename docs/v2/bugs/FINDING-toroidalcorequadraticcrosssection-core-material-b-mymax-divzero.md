# FINDING-04207: `core.material.B_myMax` in `ToroidalCoreQuadraticCrossSection`
...
| **Reached as** | `core.material.B_myMax` |
...
| **Signature** | `divisor:divisor-reachable-zero:exp:273:9ed6eaea` |
...
```
denominator            core.material.B_myMax
witness                core.material.B_myMax = 0
  found by             set to zero
denominator at witness 0.0
at declared values     1.0
path condition         always evaluated
constraints consulted  core.material.B_myMax: unbounded
```
...
| `constraints` | core.material.B_myMax: unbounded |
...
$ python3 tools/sweep/check_one.py Modelica.Magnetic.FluxTubes.Examples.BasicExamples.ToroidalCoreQuadraticCrossSection \
      --target core.material.B_myMax --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "core.material.B_myMax"
```
