# FINDING-00880: `vIn.signalSource.rising` in `Integrator`
...
| **Signature** | `divisor:divisor-zero-unresolved:exp:423:519be625` |
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.OpAmps.Integrator \
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.OpAmps.Integrator --keep-artifact /tmp/m.rbc \
