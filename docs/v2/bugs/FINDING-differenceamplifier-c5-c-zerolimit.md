# FINDING-00275: `C5.C` in `DifferenceAmplifier`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:125:e26fc3df` |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.DifferenceAmplifier \
      --target C5.C --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "C5.C"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param C5.C=0
```
