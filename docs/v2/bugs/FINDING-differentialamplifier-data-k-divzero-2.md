# FINDING-00840: `data.k` in `DifferentialAmplifier`
...
| **Signature** | `divisor:divisor-reachable-zero:exp:23:1e1b7a14` |
...
constraints consulted  data.k: unbounded
```
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.OpAmps.DifferentialAmplifier \
      --target data.k --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "data.k"
```
