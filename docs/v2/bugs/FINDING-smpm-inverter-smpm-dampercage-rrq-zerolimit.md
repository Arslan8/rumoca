# FINDING-02668: `smpm.damperCage.Rrq` in `SMPM_Inverter`
...
| **Reached as** | `smpm.damperCage.Rrq` |
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:457:57fb696b` |
...
```
predicate     smpm.damperCage.Rrq >= 0
premise       refuted
...
| `required` | smpm.damperCage.Rrq &gt;= 0 |
| `declared_min` | None |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.SynchronousMachines.SMPM_Inverter \
      --target smpm.damperCage.Rrq --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "smpm.damperCage.Rrq"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param smpm.damperCage.Rrq=0
```
