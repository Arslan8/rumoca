...
| **Declaration** | `Magnetic/FundamentalWave/BasicMachines/Components/SinglePhaseWinding.mo:39` |
| **Parameter** | `Lsigma` |
| **Type** | `SI.Inductance` |
| **Declared modifiers** | `—` |
...
```console
$ sed -n '39p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/FundamentalWave/BasicMachines/Components/SinglePhaseWinding.mo"
```
...
```console
$ grep -n -- "-1e40\|-1E40" "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/FundamentalWave/BasicMachines/Components/SinglePhaseWinding.mo" | head
```
...
```modelica
// Magnetic/FundamentalWave/BasicMachines/Components/SinglePhaseWinding.mo:39
