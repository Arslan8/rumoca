# FINDING-00201: `R10.R` in `CauerLowPassSC`
...
| **Signature** | `physical:physical-rule-does-not-apply:var:776:1863c388` |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.CauerLowPassSC \
      --target R10.R --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "R10.R"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param R10.R=0
```
