...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:60:0c3ea503` |
...
$ python3 tools/sweep/check_one.py Modelica.Magnetic.FluxTubes.Examples.Utilities.TranslatoryArmatureAndStopper \
      --target stopper_xMin.c --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "stopper_xMin.c"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param stopper_xMin.c=0
```
