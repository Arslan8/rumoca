# FINDING-03168: `diode4.idealDiode[2].Ron` in `Rectifier12pulse`
...
| **Reached as** | `diode4.idealDiode[2].Ron` |
...
| **Signature** | `physical:physical-rule-does-not-apply:var:903:91f975fc` |
...
```
predicate     diode4.idealDiode[2].Ron > 0
premise       refuted
...
| `required` | diode4.idealDiode[2].Ron &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.Transformers.Rectifier12pulse \
      --target diode4.idealDiode[2].Ron --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "diode4.idealDiode[2].Ron"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param diode4.idealDiode[2].Ron=0
```
