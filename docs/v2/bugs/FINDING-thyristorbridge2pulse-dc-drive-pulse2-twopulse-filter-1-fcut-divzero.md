# FINDING-03689: `pulse2.twoPulse.filter[1].fCut` in `ThyristorBridge2Pulse_DC_Drive`
...
| **Signature** | `divisor:divisor-reachable-zero:exp:472:2702e43a` |
...
```
denominator            pulse2.twoPulse.filter[1].fCut
