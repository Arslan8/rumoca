# FINDING-04749: `c` in `SpringDamperNoRelativeStates`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:8:f3b12c27` |
...
```console
$ python3 tools/sweep/check_one.py Modelica.Mechanics.Translational.Examples.Utilities.SpringDamperNoRelativeStates \
...
```console
$ python3 tools/sweep/check_one.py Modelica.Mechanics.Translational.Examples.Utilities.SpringDamperNoRelativeStates --keep-artifact /tmp/m.rbc \
