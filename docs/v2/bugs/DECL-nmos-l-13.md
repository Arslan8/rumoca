...
| **Declaration** | `Electrical/Analog/Semiconductors/NMOS.mo:13` |
| **Parameter** | `L` |
| **Type** | `SI.Length` |
| **Declared modifiers** | `—` |
...
```console
$ sed -n '13p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Analog/Semiconductors/NMOS.mo"
```
...
```modelica
// Electrical/Analog/Semiconductors/NMOS.mo:13
