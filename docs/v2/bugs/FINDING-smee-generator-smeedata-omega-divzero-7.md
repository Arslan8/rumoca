# FINDING-02508: `smeeData.omega` in `SMEE_Generator`
...
| **Severity** | high |
| **Declaration** | `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Machines/Utilities/SynchronousMachineData.mo:86` |
| **Signature** | `divisor:divisor-reachable-zero:exp:2004:b144d755` |
...
```
denominator            (smeeData.omega * smeeData.Td0Transient)
witness                smeeData.omega = 0
  found by             set to zero
denominator at witness 0.0
at declared values     82.05128220529016
...
| `denominator_at_declared_values` | 82.05128220529016 |
...
```console
$ sed -n '86p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Machines/Utilities/SynchronousMachineData.mo"
```
...
```console
$ grep -rl '| `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Machines/Utilities/SynchronousMachineData.mo:86` |' docs/v2/bugs/
```
