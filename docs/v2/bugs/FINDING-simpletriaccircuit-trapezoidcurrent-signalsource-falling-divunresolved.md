# FINDING-01179: `trapezoidCurrent.signalSource.falling` in `SimpleTriacCircuit`

|  |  |
|---|---|
| **Tier** | **Candidate** — static only, not execution-confirmed |
| **Model** | `Modelica.Electrical.Analog.Examples.SimpleTriacCircuit` |
| **Reached as** | `trapezoidCurrent.signalSource.falling` |
...
| **Signature** | `divisor:divisor-zero-unresolved:exp:1047:227b7342` |
...
```
denominator            trapezoidCurrent.signalSource.falling
witness                trapezoidCurrent.signalSource.falling = 0
  found by             set to zero
denominator at witness 0.0
at declared values     1e-06
path condition         not ((((time < trapezoidCurrent.signalSource.startTime) or (trapezoidCurrent.signalSource.nperiod == 0)) or ((trapezoidCurrent.signalSource.nperiod > 0) and (trapezoidCurrent.signalSource.count >= trapezoidCurrent.signalSource.nperiod)))) and not ((time < (trapezoidCurrent.signalSource.T_start + trapezoidCurrent.signalSource.T_rising))) and not ((time < (trapezoidCurrent.signalSource.T_start + trapezoidCurrent.signalSource.T_width))) and ((time < (trapezoidCurrent.signalSource.T_start + trapezoidCurrent.signalSource.T_falling)))
constraints consulted  trapezoidCurrent.signalSource.falling: min=0
```
...
| `denominator_at_declared_values` | 1e-06 |
| `denominator_range` | [0, inf] |
| `path_condition` | not ((((time &lt; trapezoidCurrent.signalSource.startTime) or (trapezoidCurrent.signalSource.nperiod == 0)) or ((trapezoidCurrent.signalSource.nperiod &gt; 0) and (trapezoidCurrent.signalSource.count &gt;= trapezoidCurrent.signalSource.nperiod)))) and not ((time &lt; (trapezoidCurrent.signalSource.T_start + trapezoidCurrent.signalSource.T_rising))) and not ((time &lt; (trapezoidCurrent.signalSource.T_start + trapezoidCurrent.signalSource.T_width))) and ((time &lt; (trapezoidCurrent.signalSource.T_start + trapezoidCurrent.signalSource.T_falling))) |
| `verdict` | UNKNOWN |
| `proof` | the path depends on quantities the artifact does not determine: (time &lt; (trapezoidCurrent.signalSource.T_start + trapezoidCurrent.signalSource.T_falling)); (time &lt; (trapezoidCurrent.signalSource.T_start + trapezoidCurrent.signalSource.T_rising)); (time &lt; (trapezoidCurrent.signalSource.T_start + trapezoidCurrent.signalSource.T_width)) |
| `constraints` | trapezoidCurrent.signalSource.falling: min=0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.SimpleTriacCircuit \
      --target trapezoidCurrent.signalSource.falling --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "trapezoidCurrent.signalSource.falling"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check \
      --param trapezoidCurrent.signalSource.falling=0
```
