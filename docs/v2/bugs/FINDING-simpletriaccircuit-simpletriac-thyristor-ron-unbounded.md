# FINDING-01148: `simpleTriac.thyristor.Ron` in `SimpleTriacCircuit`
...
| **Signature** | `physical:physical-domain-unenforced:var:94:85e9bce4` |
...
```
predicate     simpleTriac.thyristor.Ron > 0
premise       established
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.SimpleTriacCircuit \
      --target simpleTriac.thyristor.Ron --sanitizer physical
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param simpleTriac.thyristor.Ron=0
```
