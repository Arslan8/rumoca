...
| **Signature** | `physical:physical-domain-unenforced:var:20:e01cd62a` |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.Utilities.Nand \
      --target TP1.RDS --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "TP1.RDS"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param TP1.RDS=0
```
