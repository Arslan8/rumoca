# FINDING-03997: `dcdc.transistorLS.Ron` in `ChopperBuckBoost_DutyCycle`
...
| **Reached as** | `dcdc.transistorLS.Ron` |
...
| **Signature** | `physical:physical-rule-does-not-apply:var:54:a8b3235c` |
...
```
predicate     dcdc.transistorLS.Ron > 0
premise       refuted
...
| `required` | dcdc.transistorLS.Ron &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.PowerConverters.Examples.DCDC.ChopperBuckBoost.ChopperBuckBoost_DutyCycle \
      --target dcdc.transistorLS.Ron --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "dcdc.transistorLS.Ron"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param dcdc.transistorLS.Ron=0
```
