# DECL-0414: `l` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Magnetic/FluxTubes/Examples/BasicExamples/QuadraticCoreAirgap.mo:4` |
| **Parameter** | `l` |
| **Type** | `SI.Length` |
| **Declared modifiers** | `—` |
...
```console
$ sed -n '4p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/FluxTubes/Examples/BasicExamples/QuadraticCoreAirgap.mo"
```
...
```console
$ grep -n -- "-1e40\|-1E40" "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/FluxTubes/Examples/BasicExamples/QuadraticCoreAirgap.mo" | head
```
...
```modelica
// Magnetic/FluxTubes/Examples/BasicExamples/QuadraticCoreAirgap.mo:4
