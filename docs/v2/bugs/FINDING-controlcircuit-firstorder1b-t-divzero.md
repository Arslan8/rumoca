...
| **Signature** | `divisor:divisor-reachable-zero:exp:1925:cb551dab` |
...
| `constraints` | firstOrder1B.T: unbounded |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.OpAmps.ControlCircuit \
      --target firstOrder1B.T --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "firstOrder1B.T"
```
