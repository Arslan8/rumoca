# FINDING-02160: `switchYDwithArc.idealCloser.closerWithArc[2].Goff` in `IMC_YDarc`
...
| **Reached as** | `switchYDwithArc.idealCloser.closerWithArc[2].Goff` |
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:743:67c96040` |
...
```
predicate     switchYDwithArc.idealCloser.closerWithArc[2].Goff > 0
premise       refuted
...
| `required` | switchYDwithArc.idealCloser.closerWithArc[2].Goff &gt; 0 |
| `declared_min` | None |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.InductionMachines.IMC_YDarc \
      --target switchYDwithArc.idealCloser.closerWithArc[2].Goff --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "switchYDwithArc.idealCloser.closerWithArc[2].Goff"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param switchYDwithArc.idealCloser.closerWithArc[2].Goff=0
```
