...
| **Signature** | `physical:physical-domain-unenforced:var:85:da577067` |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.OvervoltageProtection \
      --target zDiode1.R --sanitizer physical
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param zDiode1.R=0
```
