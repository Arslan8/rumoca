# FINDING-04572: `body3.mi` in `PlanarFourbar`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:475:02dc2993` |
...
$ python3 tools/sweep/check_one.py Modelica.Mechanics.MultiBody.Examples.Loops.PlanarFourbar \
      --target body3.mi --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "body3.mi"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param body3.mi=0
```
