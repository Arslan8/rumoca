# FINDING-05006: `ambient2.medium.rho` in `SimpleCooling`
...
| **Signature** | `physical:physical-intent-question:var:127:4e2ea08f` |
...
```console
$ python3 tools/sweep/check_one.py Modelica.Thermal.FluidHeatFlow.Examples.SimpleCooling \
...
```console
$ python3 tools/sweep/check_one.py Modelica.Thermal.FluidHeatFlow.Examples.SimpleCooling --keep-artifact /tmp/m.rbc \
