# DECL-0603: `R` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Electrical/Analog/Basic/Potentiometer.mo:3` |
| **Parameter** | `R` |
| **Type** | `SI.Resistance` |
...
```console
$ grep -n -- "-1e40\|-1E40" "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Analog/Basic/Potentiometer.mo" | head
```
...
```modelica
// Electrical/Analog/Basic/Potentiometer.mo:3
