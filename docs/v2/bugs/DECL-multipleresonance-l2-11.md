# DECL-0241: `L2` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Electrical/QuasiStatic/SinglePhase/Examples/MultipleResonance.mo:11` |
| **Parameter** | `L2` |
| **Type** | `SI.Inductance` |
| **Declared modifiers** | `—` |
...
```console
$ sed -n '11p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/QuasiStatic/SinglePhase/Examples/MultipleResonance.mo"
```

It should declare `L2` with type `SI.Inductance` and no `min`.
...
```modelica
// Electrical/QuasiStatic/SinglePhase/Examples/MultipleResonance.mo:11
parameter SI.Inductance L2(min=0) = ...;
```
