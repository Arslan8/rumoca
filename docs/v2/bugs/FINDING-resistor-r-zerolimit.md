...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:0:29d16ba1` |
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.Utilities.Resistor \
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.Utilities.Resistor --keep-artifact /tmp/m.rbc \
