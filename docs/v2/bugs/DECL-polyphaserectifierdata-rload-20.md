# DECL-0743: `RLoad` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Electrical/Polyphase/Examples/Utilities/PolyphaseRectifierData.mo:20` |
| **Parameter** | `RLoad` |
| **Type** | `SI.Resistance` |
| **Declared modifiers** | `—` |
...
```console
$ sed -n '20p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Polyphase/Examples/Utilities/PolyphaseRectifierData.mo"
```
...
```modelica
// Electrical/Polyphase/Examples/Utilities/PolyphaseRectifierData.mo:20
