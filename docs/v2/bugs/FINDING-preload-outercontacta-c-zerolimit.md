...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:90:8246ab72` |
...
$ python3 tools/sweep/check_one.py Modelica.Mechanics.Translational.Examples.PreLoad \
      --target outerContactA.c --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "outerContactA.c"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param outerContactA.c=0
```
