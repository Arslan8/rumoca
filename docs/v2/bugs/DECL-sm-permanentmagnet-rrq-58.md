# DECL-0843: `Rrq` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Magnetic/FundamentalWave/BasicMachines/SynchronousMachines/SM_PermanentMagnet.mo:58` |
| **Parameter** | `Rrq` |
| **Type** | `SI.Resistance` |
| **Declared modifiers** | `—` |
...
```console
$ sed -n '58p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/FundamentalWave/BasicMachines/SynchronousMachines/SM_PermanentMagnet.mo"
```
...
```modelica
// Magnetic/FundamentalWave/BasicMachines/SynchronousMachines/SM_PermanentMagnet.mo:58
