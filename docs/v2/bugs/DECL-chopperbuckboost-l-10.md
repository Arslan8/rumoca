# DECL-0223: `L` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Electrical/PowerConverters/Examples/DCDC/ExampleTemplates/ChopperBuckBoost.mo:10` |
| **Parameter** | `L` |
| **Type** | `SI.Inductance` |
| **Declared modifiers** | `—` |
...
```console
$ grep -n -- "-1e40\|-1E40" "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/PowerConverters/Examples/DCDC/ExampleTemplates/ChopperBuckBoost.mo" | head
```
...
```modelica
// Electrical/PowerConverters/Examples/DCDC/ExampleTemplates/ChopperBuckBoost.mo:10
