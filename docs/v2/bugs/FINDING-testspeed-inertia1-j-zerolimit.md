# FINDING-05362: `inertia1.J` in `TestSpeed`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:15:b8f15504` |
...
```console
$ python3 tools/sweep/check_one.py ModelicaTest.Rotational.TestSpeed \
...
```console
$ python3 tools/sweep/check_one.py ModelicaTest.Rotational.TestSpeed --keep-artifact /tmp/m.rbc \
