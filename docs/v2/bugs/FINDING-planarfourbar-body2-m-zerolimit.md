# FINDING-04568: `body2.m` in `PlanarFourbar`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:354:7ad85190` |
...
```
contract    Modelica.Mechanics.MultiBody.Parts.Body.m: feature_disabled (proven, from equation) — inherited from body2.body.m, which it binds: the parameter appears only as a multiplier, so at zero the term it scales drops out and the rest of the model is unaffected
