# FINDING-01254: `Tr.Gbe` in `Transistor`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:53:f0885d97` |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.Utilities.Transistor \
      --target Tr.Gbe --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "Tr.Gbe"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param Tr.Gbe=0
```
