# FINDING-04202: `airGap.d` in `ToroidalCoreAirgap`
...
| **Signature** | `divisor:divisor-reachable-zero:exp:389:691f05ee` |
...
constraints consulted  airGap.d: min=0
```
...
$ python3 tools/sweep/check_one.py Modelica.Magnetic.FluxTubes.Examples.BasicExamples.ToroidalCoreAirgap \
      --target airGap.d --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "airGap.d"
```
