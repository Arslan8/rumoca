# FINDING-00897: `vIn.signalSource.rising` in `InvertingAmplifier`
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.OpAmps.InvertingAmplifier \
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.OpAmps.InvertingAmplifier --keep-artifact /tmp/m.rbc \
