# DECL-0145: `Lesigma` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Electrical/Machines/BasicMachines/SynchronousMachines/SM_ElectricalExcited.mo:161` |
| **Parameter** | `Lesigma` |
| **Type** | `SI.Inductance` |
| **Declared modifiers** | `—` |
...
```modelica
// Electrical/Machines/BasicMachines/SynchronousMachines/SM_ElectricalExcited.mo:161
