# DECL-0359: `I` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Mechanics/MultiBody/Parts/BodyCylinder.mo:114` |
| **Parameter** | `I` |
| **Type** | `SI.Inertia` |
| **Declared modifiers** | `—` |
...
```console
$ sed -n '114p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Mechanics/MultiBody/Parts/BodyCylinder.mo"
```

It should declare `I` with type `SI.Inertia` and no `min`.
...
```modelica
// Mechanics/MultiBody/Parts/BodyCylinder.mo:114
parameter SI.Inertia I(min=0) = ...;
```
