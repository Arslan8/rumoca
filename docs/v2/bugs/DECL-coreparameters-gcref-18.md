...
| **Declaration** | `Electrical/Machines/Losses/CoreParameters.mo:18` |
| **Parameter** | `GcRef` |
| **Type** | `SI.Conductance` |
| **Declared modifiers** | `—` |
...
```console
$ grep -n -- "-1e40\|-1E40" "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Machines/Losses/CoreParameters.mo" | head
```
...
```modelica
// Electrical/Machines/Losses/CoreParameters.mo:18
