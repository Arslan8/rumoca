# FINDING-01454: `dcpmData.Js` in `DCPM_CurrentControlled`
...
| **Signature** | `physical:physical-intent-question:var:311:d468e2aa` |
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.DCMachines.DCPM_CurrentControlled \
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.DCMachines.DCPM_CurrentControlled --keep-artifact /tmp/m.rbc \
