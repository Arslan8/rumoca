# FINDING-00180: `R3.R` in `CauerLowPassSC`
...
| **Signature** | `physical:physical-rule-does-not-apply:var:572:f3aa5e15` |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.CauerLowPassSC \
      --target R3.R --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "R3.R"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param R3.R=0
```
