...
| **Reached as** | `inverter.transistor_n.idealGTOThyristor[3].Goff` |
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:749:2e156c5f` |
...
```
predicate     inverter.transistor_n.idealGTOThyristor[3].Goff > 0
premise       refuted
...
| `required` | inverter.transistor_n.idealGTOThyristor[3].Goff &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.InductionMachines.IMC_InverterDrive \
      --target inverter.transistor_n.idealGTOThyristor[3].Goff --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "inverter.transistor_n.idealGTOThyristor[3].Goff"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param inverter.transistor_n.idealGTOThyristor[3].Goff=0
```
