...
| **Signature** | `divisor:divisor-reachable-zero:exp:194:c23d0a8e` |
...
witness                pipe.V_flowNominal = 2
  found by             at its declared minimum
denominator at witness 0.0
at declared values     4.0
path condition         always evaluated
constraints consulted  pipe.V_flowNominal: min=2, assert pipe.V_flowNominal greater 2
```
...
| `denominator_at_declared_values` | 4.0 |
| `denominator_range` | [0, inf] |
| `path_condition` | always evaluated |
| `verdict` | SAT |
| `proof` | the division is not inside any branch |
| `constraints` | pipe.V_flowNominal: min=2, assert pipe.V_flowNominal greater 2 |
