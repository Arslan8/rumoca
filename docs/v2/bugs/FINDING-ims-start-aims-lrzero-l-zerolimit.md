# FINDING-02287: `aims.lrzero.L` in `IMS_Start`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:570:ac57c4d7` |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.InductionMachines.IMS_Start \
      --target aims.lrzero.L --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "aims.lrzero.L"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param aims.lrzero.L=0
```
