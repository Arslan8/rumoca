# DECL-0483: `l` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Magnetic/FluxTubes/Shapes/Leakage/QuarterHollowCylinder.mo:7` |
| **Parameter** | `l` |
| **Type** | `SI.Length` |
| **Declared modifiers** | `—` |
...
```console
$ sed -n '7p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/FluxTubes/Shapes/Leakage/QuarterHollowCylinder.mo"
```
...
```console
$ grep -n -- "-1e40\|-1E40" "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/FluxTubes/Shapes/Leakage/QuarterHollowCylinder.mo" | head
```
...
```modelica
// Magnetic/FluxTubes/Shapes/Leakage/QuarterHollowCylinder.mo:7
