# FINDING-00975: `f` in `NonInvertingAmplifier`
...
| **Severity** | high |
| **Declaration** | `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Analog/Examples/OpAmps/NonInvertingAmplifier.mo:10` |
| **Signature** | `divisor:divisor-reachable-zero:exp:60:e5d17196` |
...
```console
$ sed -n '10p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Analog/Examples/OpAmps/NonInvertingAmplifier.mo"
```
...
```console
$ grep -rl '| `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Analog/Examples/OpAmps/NonInvertingAmplifier.mo:10` |' docs/v2/bugs/
```
