# FINDING-00379: `T2.Ccs` in `HeatingPNP_NORGate`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:239:e9599370` |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.HeatingPNP_NORGate \
      --target T2.Ccs --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "T2.Ccs"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param T2.Ccs=0
```
