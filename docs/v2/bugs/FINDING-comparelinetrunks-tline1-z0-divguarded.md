...
| **Signature** | `divisor:divisor-guarded-by-assertion:exp:7702:2a0d47b1` |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.Lines.CompareLineTrunks \
      --target tLine1.Z0 --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "tLine1.Z0"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param tLine1.Z0=0
```
