...
| **Reached as** | `dcdcInverter2.idealDcDc.deadTime.T` |
...
| **Signature** | `divisor:divisor-reachable-zero:exp:3018:d568f1f8` |
...
```
denominator            dcdcInverter2.idealDcDc.deadTime.T
witness                dcdcInverter2.idealDcDc.deadTime.T = 0
  found by             set to zero
denominator at witness 0.0
at declared values     0.0005
path condition         always evaluated
constraints consulted  dcdcInverter2.idealDcDc.deadTime.T: unbounded
```
...
| `constraints` | dcdcInverter2.idealDcDc.deadTime.T: unbounded |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.DCMachines.DCPM_Drive \
      --target dcdcInverter2.idealDcDc.deadTime.T --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "dcdcInverter2.idealDcDc.deadTime.T"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check \
      --param dcdcInverter2.idealDcDc.deadTime.T=0
```
