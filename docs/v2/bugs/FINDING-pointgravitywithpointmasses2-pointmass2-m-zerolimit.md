# FINDING-04466: `pointMass2.m` in `PointGravityWithPointMasses2`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:32:5192c560` |
...
$ python3 tools/sweep/check_one.py Modelica.Mechanics.MultiBody.Examples.Elementary.PointGravityWithPointMasses2 \
      --target pointMass2.m --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "pointMass2.m"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param pointMass2.m=0
```
