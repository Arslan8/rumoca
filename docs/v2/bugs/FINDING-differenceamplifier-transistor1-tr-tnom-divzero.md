# FINDING-00292: `Transistor1.Tr.Tnom` in `DifferenceAmplifier`
...
| **Severity** | high |
| **Declaration** | `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Analog/Semiconductors/NPN.mo:71` |
| **Signature** | `divisor:divisor-reachable-zero:exp:1115:88d7ce3b` |
...
```console
$ sed -n '71p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Analog/Semiconductors/NPN.mo"
```
...
```console
$ grep -rl '| `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Analog/Semiconductors/NPN.mo:71` |' docs/v2/bugs/
```
