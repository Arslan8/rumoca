...
| **Declaration** | `Electrical/Analog/Examples/OpAmps/OpAmpCircuits/Integrator.mo:7` |
| **Parameter** | `R` |
| **Type** | `SI.Resistance` |
| **Declared modifiers** | `—` |
...
```console
$ grep -n -- "-1e40\|-1E40" "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Analog/Examples/OpAmps/OpAmpCircuits/Integrator.mo" | head
```
...
```modelica
// Electrical/Analog/Examples/OpAmps/OpAmpCircuits/Integrator.mo:7
