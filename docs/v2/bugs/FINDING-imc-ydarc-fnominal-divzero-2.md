# FINDING-02186: `fNominal` in `IMC_YDarc`
...
| **Signature** | `divisor:divisor-reachable-zero:exp:27:c651d7f0` |
...
| `constraints` | fNominal: unbounded |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.InductionMachines.IMC_YDarc \
      --target fNominal --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "fNominal"
```
