# FINDING-03715: `rectifier.thyristor_p2.Ron` in `ThyristorBridge2Pulse_RLV_Characteristic`
...
| **Reached as** | `rectifier.thyristor_p2.Ron` |
...
```
predicate     rectifier.thyristor_p2.Ron > 0
premise       refuted
...
| `required` | rectifier.thyristor_p2.Ron &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.PowerConverters.Examples.ACDC.RectifierBridge2Pulse.ThyristorBridge2Pulse_RLV_Characteristic \
      --target rectifier.thyristor_p2.Ron --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "rectifier.thyristor_p2.Ron"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param rectifier.thyristor_p2.Ron=0
```
