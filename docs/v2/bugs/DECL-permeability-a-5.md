# DECL-0036: `A` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Magnetic/QuasiStatic/FluxTubes/Sensors/Transient/Permeability.mo:5` |
| **Parameter** | `A` |
| **Type** | `SI.Area` |
| **Declared modifiers** | `—` |
...
```console
$ sed -n '5p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/QuasiStatic/FluxTubes/Sensors/Transient/Permeability.mo"
```
...
```modelica
// Magnetic/QuasiStatic/FluxTubes/Sensors/Transient/Permeability.mo:5
