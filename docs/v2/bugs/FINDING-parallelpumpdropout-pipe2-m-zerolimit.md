# FINDING-04892: `pipe2.m` in `ParallelPumpDropOut`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:136:18f2bbe4` |
...
$ python3 tools/sweep/check_one.py Modelica.Thermal.FluidHeatFlow.Examples.ParallelPumpDropOut \
      --target pipe2.m --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "pipe2.m"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param pipe2.m=0
```
