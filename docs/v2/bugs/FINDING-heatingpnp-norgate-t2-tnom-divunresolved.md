# FINDING-00396: `T2.Tnom` in `HeatingPNP_NORGate`
...
| **Severity** | medium |
| **Declaration** | `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Analog/Semiconductors/PNP.mo:74` |
| **Signature** | `divisor:divisor-zero-unresolved:exp:1280:a9f5deb8` |
...
```console
$ sed -n '74p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Analog/Semiconductors/PNP.mo"
```
...
```console
$ grep -rl '| `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Analog/Semiconductors/PNP.mo:74` |' docs/v2/bugs/
```
