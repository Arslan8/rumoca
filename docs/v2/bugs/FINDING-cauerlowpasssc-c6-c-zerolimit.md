# FINDING-00138: `C6.C` in `CauerLowPassSC`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:70:57f9bfbf` |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.CauerLowPassSC \
      --target C6.C --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "C6.C"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param C6.C=0
```
