# FINDING-03501: `pulse2.twomPulse.filter[2].transferFunction[1].a_end` in `ThyristorBridge2mPulse_DC_Drive`
...
| **Signature** | `divisor:divisor-reachable-zero:exp:4209:dde4b14e` |
