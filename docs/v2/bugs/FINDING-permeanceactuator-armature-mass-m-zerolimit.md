# FINDING-04270: `armature.mass.m` in `PermeanceActuator`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:44:b7084a01` |
...
$ python3 tools/sweep/check_one.py Modelica.Magnetic.FluxTubes.Examples.MovingCoilActuator.Components.PermeanceActuator \
      --target armature.mass.m --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "armature.mass.m"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param armature.mass.m=0
```
