# DECL-0133: `Le` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Electrical/Machines/BasicMachines/DCMachines/DC_ElectricalExcited.mo:33` |
| **Parameter** | `Le` |
| **Type** | `SI.Inductance` |
...
```modelica
// Electrical/Machines/BasicMachines/DCMachines/DC_ElectricalExcited.mo:33
