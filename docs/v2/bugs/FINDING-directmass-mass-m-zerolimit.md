# FINDING-04743: `mass.m` in `DirectMass`
...
```console
$ python3 tools/sweep/check_one.py Modelica.Mechanics.Translational.Examples.Utilities.DirectMass \
...
```console
$ python3 tools/sweep/check_one.py Modelica.Mechanics.Translational.Examples.Utilities.DirectMass --keep-artifact /tmp/m.rbc \
