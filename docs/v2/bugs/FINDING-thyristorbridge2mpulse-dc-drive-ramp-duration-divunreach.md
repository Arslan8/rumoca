# FINDING-03498: `ramp.duration` in `ThyristorBridge2mPulse_DC_Drive`
...
| **Signature** | `divisor:divisor-unreachable-under-witness:exp:4780:cef0bc11` |
...
| `verdict` | UNSAT |
| `proof` | the path conditions cannot hold together: time must be both &gt; 5 and &lt; 5 |
