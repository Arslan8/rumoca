# FINDING-05352: `genericFluxTube.material.B_myMax` in `Sensors`
...
| **Signature** | `divisor:divisor-reachable-zero:exp:71:cfed9b84` |
...
```
denominator            genericFluxTube.material.B_myMax
witness                genericFluxTube.material.B_myMax = 0
  found by             set to zero
denominator at witness 0.0
at declared values     1.0
path condition         always evaluated
constraints consulted  genericFluxTube.material.B_myMax: unbounded
```
...
| `constraints` | genericFluxTube.material.B_myMax: unbounded |
...
$ python3 tools/sweep/check_one.py ModelicaTest.Magnetic.FluxTubes.Sensors \
      --target genericFluxTube.material.B_myMax --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "genericFluxTube.material.B_myMax"
```
