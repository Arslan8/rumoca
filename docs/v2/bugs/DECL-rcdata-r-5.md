# DECL-0676: `R` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Electrical/Batteries/ParameterRecords/TransientData/RCData.mo:5` |
| **Parameter** | `R` |
| **Type** | `SI.Resistance` |
| **Declared modifiers** | `—` |
...
```console
$ sed -n '5p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Batteries/ParameterRecords/TransientData/RCData.mo"
```
...
```console
$ grep -n -- "-1e40\|-1E40" "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Batteries/ParameterRecords/TransientData/RCData.mo" | head
```
...
```modelica
// Electrical/Batteries/ParameterRecords/TransientData/RCData.mo:5
