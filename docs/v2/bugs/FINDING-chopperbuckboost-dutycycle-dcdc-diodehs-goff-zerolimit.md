# FINDING-04004: `dcdc.diodeHS.Goff` in `ChopperBuckBoost_DutyCycle`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:108:e02d549a` |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.PowerConverters.Examples.DCDC.ChopperBuckBoost.ChopperBuckBoost_DutyCycle \
      --target dcdc.diodeHS.Goff --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "dcdc.diodeHS.Goff"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param dcdc.diodeHS.Goff=0
```
