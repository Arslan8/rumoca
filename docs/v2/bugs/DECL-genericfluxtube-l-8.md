...
| **Declaration** | `Magnetic/FluxTubes/Shapes/FixedShape/GenericFluxTube.mo:8` |
| **Parameter** | `l` |
| **Type** | `SI.Length` |
| **Declared modifiers** | `—` |
...
```console
$ sed -n '8p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/FluxTubes/Shapes/FixedShape/GenericFluxTube.mo"
```
...
```console
$ grep -n -- "-1e40\|-1E40" "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/FluxTubes/Shapes/FixedShape/GenericFluxTube.mo" | head
```
...
```modelica
// Magnetic/FluxTubes/Shapes/FixedShape/GenericFluxTube.mo:8
