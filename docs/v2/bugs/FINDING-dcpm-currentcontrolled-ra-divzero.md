# FINDING-01460: `Ra` in `DCPM_CurrentControlled`
...
| **Severity** | high |
| **Declaration** | `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Machines/Examples/DCMachines/DCPM_CurrentControlled.mo:14` |
| **Signature** | `divisor:divisor-reachable-zero:exp:739:7c2e50c4` |
...
constraints consulted  Ra: unbounded
```
...
```console
$ sed -n '14p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Machines/Examples/DCMachines/DCPM_CurrentControlled.mo"
```
...
```console
$ grep -rl '| `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Machines/Examples/DCMachines/DCPM_CurrentControlled.mo:14` |' docs/v2/bugs/
```
