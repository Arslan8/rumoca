# FINDING-03657: `rectifier.thyristor_p2.Goff` in `ThyristorBridge2Pulse_DC_Drive`
...
| **Reached as** | `rectifier.thyristor_p2.Goff` |
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:95:e84dae2e` |
...
```
predicate     rectifier.thyristor_p2.Goff > 0
premise       refuted
...
| `required` | rectifier.thyristor_p2.Goff &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.PowerConverters.Examples.ACDC.RectifierBridge2Pulse.ThyristorBridge2Pulse_DC_Drive \
      --target rectifier.thyristor_p2.Goff --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "rectifier.thyristor_p2.Goff"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param rectifier.thyristor_p2.Goff=0
```
