# FINDING-01351: `dcee.wNominal` in `DC_CompareCharacteristics`
...
| **Signature** | `divisor:divisor-reachable-zero:exp:1056:84a6b9da` |
...
| `constraints` | dcee.wNominal: unbounded |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.DCMachines.DC_CompareCharacteristics \
      --target dcee.wNominal --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "dcee.wNominal"
```
