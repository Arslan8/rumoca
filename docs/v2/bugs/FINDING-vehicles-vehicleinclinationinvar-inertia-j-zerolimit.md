# FINDING-05449: `vehicleInclinationInVar.inertia.J` in `Vehicles`

|  |  |
|---|---|
| **Tier** | **Candidate** — static only, not execution-confirmed |
| **Model** | `ModelicaTest.Translational.Vehicles` |
| **Reached as** | `vehicleInclinationInVar.inertia.J` |
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:1000:b6fa6313` |
...
```
predicate     vehicleInclinationInVar.inertia.J > 0
premise       refuted
...
| `required` | vehicleInclinationInVar.inertia.J &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py ModelicaTest.Translational.Vehicles \
      --target vehicleInclinationInVar.inertia.J --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "vehicleInclinationInVar.inertia.J"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param vehicleInclinationInVar.inertia.J=0
```
