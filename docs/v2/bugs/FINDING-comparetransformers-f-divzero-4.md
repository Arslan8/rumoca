# FINDING-00248: `f` in `CompareTransformers`
...
| **Signature** | `divisor:divisor-reachable-zero:exp:61:8b283dd2` |
...
at declared values     62.83185307179586
...
| `denominator_at_declared_values` | 62.83185307179586 |
