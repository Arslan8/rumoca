# FINDING-02949: `smr.airGap.L` in `SMR_Inverter`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:392:9620d077` |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.SynchronousMachines.SMR_Inverter \
      --target smr.airGap.L --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "smr.airGap.L"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param smr.airGap.L=0
```
