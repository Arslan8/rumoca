# FINDING-04472: `referenceSystem.pointMass2.m` in `PointGravityWithPointMasses2`
...
| **Reached as** | `referenceSystem.pointMass2.m` |
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:717:4bb6dad9` |
...
```
predicate     referenceSystem.pointMass2.m > 0
premise       refuted
...
| `required` | referenceSystem.pointMass2.m &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Mechanics.MultiBody.Examples.Elementary.PointGravityWithPointMasses2 \
      --target referenceSystem.pointMass2.m --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "referenceSystem.pointMass2.m"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param referenceSystem.pointMass2.m=0
```
