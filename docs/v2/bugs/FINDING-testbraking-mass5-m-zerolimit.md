# FINDING-05394: `mass5.m` in `TestBraking`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:100:d5567abf` |
...
$ python3 tools/sweep/check_one.py ModelicaTest.Translational.TestBraking \
      --target mass5.m --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "mass5.m"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param mass5.m=0
```
