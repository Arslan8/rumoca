# FINDING-02058: `transformer.L1sigma` in `IMC_Transformer`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:648:952e5a47` |
...
```
{'quantity': 'Inductance', 'unit': 'H', 'confidence': 'QUANTITY_AND_UNIT', 'premise_state': 'unknown', 'authority': 'quantity_or_unit', 'canonical_declaration': 'Modelica.Electrical.Machines.BasicMachines.Transformers.Yy.Yy00.L1sigma'}
```
