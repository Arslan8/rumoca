...
| **Declaration** | `Electrical/Analog/Basic/Resistor.mo:3` |
| **Parameter** | `R` |
| **Type** | `SI.Resistance` |
...
```console
$ sed -n '3p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Analog/Basic/Resistor.mo"
```
...
```console
$ grep -n -- "-1e40\|-1E40" "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Analog/Basic/Resistor.mo" | head
```
...
```modelica
// Electrical/Analog/Basic/Resistor.mo:3
