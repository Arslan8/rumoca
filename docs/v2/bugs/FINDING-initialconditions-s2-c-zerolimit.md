# FINDING-04718: `s2.c` in `InitialConditions`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:9:6c721c31` |
...
$ python3 tools/sweep/check_one.py Modelica.Mechanics.Translational.Examples.InitialConditions \
      --target s2.c --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "s2.c"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param s2.c=0
```
