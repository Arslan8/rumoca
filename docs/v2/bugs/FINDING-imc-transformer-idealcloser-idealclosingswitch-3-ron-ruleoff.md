# FINDING-02055: `idealCloser.idealClosingSwitch[3].Ron` in `IMC_Transformer`
...
| **Reached as** | `idealCloser.idealClosingSwitch[3].Ron` |
...
| **Signature** | `physical:physical-rule-does-not-apply:var:625:7c0d7cf9` |
...
```
predicate     idealCloser.idealClosingSwitch[3].Ron > 0
premise       refuted
...
| `required` | idealCloser.idealClosingSwitch[3].Ron &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.InductionMachines.IMC_Transformer \
      --target idealCloser.idealClosingSwitch[3].Ron --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "idealCloser.idealClosingSwitch[3].Ron"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param idealCloser.idealClosingSwitch[3].Ron=0
```
