# DECL-0092: `Ca` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Electrical/Machines/Examples/DCMachines/DCPM_Cooling.mo:13` |
| **Parameter** | `Ca` |
...
It should declare `Ca` with type `SI.HeatCapacity` and no `min`.
...
```modelica
// Electrical/Machines/Examples/DCMachines/DCPM_Cooling.mo:13
parameter SI.HeatCapacity Ca(min=0) = ...;
```
