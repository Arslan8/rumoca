# FINDING-05346: `genericFluxTube2.area` in `Sources`
...
| **Signature** | `divisor:divisor-reachable-zero:exp:459:6c400ce0` |
...
```
denominator            genericFluxTube2.A
witness                genericFluxTube2.area = 0
  found by             set to zero
denominator at witness 0.0
at declared values     0.0001
path condition         always evaluated
constraints consulted  genericFluxTube2.area: unbounded
```
...
| `constraints` | genericFluxTube2.area: unbounded |
...
$ python3 tools/sweep/check_one.py ModelicaTest.Magnetic.FluxTubes.Sources \
      --target genericFluxTube2.area --sanitizer divisor
```
