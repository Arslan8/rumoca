# FINDING-02068: `transformer.l2sigma.inductor[3].L` in `IMC_Transformer`
...
| **Reached as** | `transformer.l2sigma.inductor[3].L` |
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:914:bab78f1b` |
...
```
predicate     transformer.l2sigma.inductor[3].L > 0
premise       refuted
...
| `required` | transformer.l2sigma.inductor[3].L &gt; 0 |
| `declared_min` | None |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.InductionMachines.IMC_Transformer \
      --target transformer.l2sigma.inductor[3].L --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "transformer.l2sigma.inductor[3].L"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param transformer.l2sigma.inductor[3].L=0
```
