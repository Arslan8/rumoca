# DECL-0246: `Lssigma` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Magnetic/FundamentalWave/BaseClasses/Machine.mo:33` |
| **Parameter** | `Lssigma` |
| **Type** | `SI.Inductance` |
...
```console
$ sed -n '33p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/FundamentalWave/BaseClasses/Machine.mo"
```
...
```console
$ grep -n -- "-1e40\|-1E40" "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/FundamentalWave/BaseClasses/Machine.mo" | head
```
...
```modelica
// Magnetic/FundamentalWave/BaseClasses/Machine.mo:33
