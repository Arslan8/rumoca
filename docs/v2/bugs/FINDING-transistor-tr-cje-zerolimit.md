# FINDING-01251: `Tr.Cje` in `Transistor`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:46:4bf522f2` |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.Utilities.Transistor \
      --target Tr.Cje --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "Tr.Cje"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param Tr.Cje=0
```
