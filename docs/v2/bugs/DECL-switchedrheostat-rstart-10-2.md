# DECL-0879: `RStart` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Magnetic/QuasiStatic/FundamentalWave/Utilities/SwitchedRheostat.mo:10` |
| **Parameter** | `RStart` |
| **Type** | `SI.Resistance` |
| **Declared modifiers** | `—` |
...
```console
$ sed -n '10p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/QuasiStatic/FundamentalWave/Utilities/SwitchedRheostat.mo"
```
...
```console
$ grep -n -- "-1e40\|-1E40" "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/QuasiStatic/FundamentalWave/Utilities/SwitchedRheostat.mo" | head
```
...
```modelica
// Magnetic/QuasiStatic/FundamentalWave/Utilities/SwitchedRheostat.mo:10
