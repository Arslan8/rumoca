# DECL-0609: `R2` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Electrical/Analog/Examples/InvertingAmp.mo:10` |
| **Parameter** | `R2` |
| **Type** | `SI.Resistance` |
| **Declared modifiers** | `—` |
...
```console
$ grep -n -- "-1e40\|-1E40" "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Analog/Examples/InvertingAmp.mo" | head
```
...
```modelica
// Electrical/Analog/Examples/InvertingAmp.mo:10
