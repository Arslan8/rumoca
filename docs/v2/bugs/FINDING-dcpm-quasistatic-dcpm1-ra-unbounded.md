# FINDING-01538: `dcpm1.Ra` in `DCPM_QuasiStatic`
...
| **Signature** | `physical:physical-domain-unenforced:var:10:c6bb2dad` |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.DCMachines.DCPM_QuasiStatic \
      --target dcpm1.Ra --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "dcpm1.Ra"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param dcpm1.Ra=0
```
