# FINDING-05044: `thermalConductor2.G` in `TwoMass`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:284:d3925d6e` |
...
```
predicate     thermalConductor2.G > 0
premise       refuted
...
$ python3 tools/sweep/check_one.py Modelica.Thermal.FluidHeatFlow.Examples.TwoMass \
      --target thermalConductor2.G --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "thermalConductor2.G"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param thermalConductor2.G=0
```
