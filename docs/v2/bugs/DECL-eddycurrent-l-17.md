# DECL-0486: `l` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Magnetic/QuasiStatic/FluxTubes/Basic/EddyCurrent.mo:17` |
| **Parameter** | `l` |
| **Type** | `SI.Length` |
| **Declared modifiers** | `—` |
...
```console
$ sed -n '17p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/QuasiStatic/FluxTubes/Basic/EddyCurrent.mo"
```
...
```modelica
// Magnetic/QuasiStatic/FluxTubes/Basic/EddyCurrent.mo:17
