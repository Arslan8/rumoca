# DECL-0062: `Goff` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Electrical/Machines/Utilities/SwitchYD.mo:5` |
| **Parameter** | `Goff` |
| **Type** | `SI.Conductance` |
| **Declared modifiers** | `—` |
...
```console
$ grep -n -- "-1e40\|-1E40" "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Machines/Utilities/SwitchYD.mo" | head
```
...
```modelica
// Electrical/Machines/Utilities/SwitchYD.mo:5
