...
| **Signature** | `physical:physical-domain-unenforced:var:1:e1501654` |
...
role          —
declaration   Modelica.Thermal.HeatTransfer.Components.HeatCapacitor.C
```
...
| `authority` | source_arithmetic |
| `canonical_declaration` | Modelica.Thermal.HeatTransfer.Components.HeatCapacitor.C |
...
$ python3 tools/sweep/check_one.py Modelica.Thermal.HeatTransfer.Examples.TwoMasses \
      --target mass1.C --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "mass1.C"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param mass1.C=0
```
