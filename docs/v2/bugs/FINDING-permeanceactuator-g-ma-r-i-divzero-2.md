# FINDING-04274: `g_ma.r_i` in `PermeanceActuator`
...
| **Signature** | `divisor:divisor-reachable-zero:exp:760:221b414b` |
...
$ python3 tools/sweep/check_one.py Modelica.Magnetic.FluxTubes.Examples.MovingCoilActuator.Components.PermeanceActuator \
      --target g_ma.r_i --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "g_ma.r_i"
```
