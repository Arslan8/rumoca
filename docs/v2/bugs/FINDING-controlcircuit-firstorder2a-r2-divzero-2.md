# FINDING-00831: `firstOrder2A.R2` in `ControlCircuit`
...
| **Signature** | `divisor:divisor-reachable-zero:exp:587:9421cf37` |
...
| `constraints` | firstOrder2A.R2: unbounded |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.OpAmps.ControlCircuit \
      --target firstOrder2A.R2 --sanitizer divisor
```
