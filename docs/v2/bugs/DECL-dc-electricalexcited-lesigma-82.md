# DECL-0135: `Lesigma` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Electrical/Machines/BasicMachines/DCMachines/DC_ElectricalExcited.mo:82` |
| **Parameter** | `Lesigma` |
| **Type** | `SI.Inductance` |
| **Declared modifiers** | `—` |
...
```console
$ grep -n -- "-1e40\|-1E40" "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Machines/BasicMachines/DCMachines/DC_ElectricalExcited.mo" | head
```
...
```modelica
// Electrical/Machines/BasicMachines/DCMachines/DC_ElectricalExcited.mo:82
