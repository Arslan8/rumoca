# DECL-0176: `Lmq` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Electrical/Machines/Utilities/SynchronousMachineData.mo:104` |
| **Parameter** | `Lmq` |
| **Type** | `SI.Inductance` |
| **Declared modifiers** | `—` |
...
```modelica
// Electrical/Machines/Utilities/SynchronousMachineData.mo:104
