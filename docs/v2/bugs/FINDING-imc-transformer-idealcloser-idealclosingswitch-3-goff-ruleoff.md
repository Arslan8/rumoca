# FINDING-02056: `idealCloser.idealClosingSwitch[3].Goff` in `IMC_Transformer`
...
| **Reached as** | `idealCloser.idealClosingSwitch[3].Goff` |
...
| **Signature** | `physical:physical-rule-does-not-apply:var:626:5243c7c1` |
...
```
predicate     idealCloser.idealClosingSwitch[3].Goff > 0
premise       refuted
...
| `required` | idealCloser.idealClosingSwitch[3].Goff &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.InductionMachines.IMC_Transformer \
      --target idealCloser.idealClosingSwitch[3].Goff --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "idealCloser.idealClosingSwitch[3].Goff"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param idealCloser.idealClosingSwitch[3].Goff=0
```
