# FINDING-03758: `rectifier.diode_p.idealDiode[3].Ron` in `DiodeCenterTap2mPulse`
...
| **Reached as** | `rectifier.diode_p.idealDiode[3].Ron` |
...
| **Signature** | `physical:physical-rule-does-not-apply:var:180:7d3729f1` |
...
```
predicate     rectifier.diode_p.idealDiode[3].Ron > 0
premise       refuted
...
| `required` | rectifier.diode_p.idealDiode[3].Ron &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.PowerConverters.Examples.ACDC.RectifierCenterTap2mPulse.DiodeCenterTap2mPulse \
      --target rectifier.diode_p.idealDiode[3].Ron --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "rectifier.diode_p.idealDiode[3].Ron"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param rectifier.diode_p.idealDiode[3].Ron=0
```
