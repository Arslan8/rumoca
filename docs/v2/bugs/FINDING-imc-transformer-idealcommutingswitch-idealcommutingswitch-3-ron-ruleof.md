# FINDING-02081: `idealCommutingSwitch.idealCommutingSwitch[3].Ron` in `IMC_Transformer`
...
| **Reached as** | `idealCommutingSwitch.idealCommutingSwitch[3].Ron` |
...
| **Signature** | `physical:physical-rule-does-not-apply:var:1157:915679bb` |
...
```
predicate     idealCommutingSwitch.idealCommutingSwitch[3].Ron > 0
premise       refuted
...
| `required` | idealCommutingSwitch.idealCommutingSwitch[3].Ron &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.InductionMachines.IMC_Transformer \
      --target idealCommutingSwitch.idealCommutingSwitch[3].Ron --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "idealCommutingSwitch.idealCommutingSwitch[3].Ron"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param idealCommutingSwitch.idealCommutingSwitch[3].Ron=0
```
