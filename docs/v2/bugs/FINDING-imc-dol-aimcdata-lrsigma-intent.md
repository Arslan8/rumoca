# FINDING-01783: `aimcData.Lrsigma` in `IMC_DOL`
...
| **Signature** | `physical:physical-intent-question:var:729:131705e0` |
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.InductionMachines.IMC_DOL \
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.InductionMachines.IMC_DOL --keep-artifact /tmp/m.rbc \
