# FINDING-02009: `idealOpener.Goff` in `IMC_Steinmetz`
...
| **Signature** | `physical:physical-rule-does-not-apply:var:554:321d0dce` |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.InductionMachines.IMC_Steinmetz \
      --target idealOpener.Goff --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "idealOpener.Goff"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param idealOpener.Goff=0
```
