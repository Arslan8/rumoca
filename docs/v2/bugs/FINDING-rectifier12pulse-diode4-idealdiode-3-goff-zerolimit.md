# FINDING-03171: `diode4.idealDiode[3].Goff` in `Rectifier12pulse`
...
| **Reached as** | `diode4.idealDiode[3].Goff` |
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:921:5ed7bde4` |
...
```
predicate     diode4.idealDiode[3].Goff > 0
premise       refuted
...
| `required` | diode4.idealDiode[3].Goff &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.Transformers.Rectifier12pulse \
      --target diode4.idealDiode[3].Goff --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "diode4.idealDiode[3].Goff"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param diode4.idealDiode[3].Goff=0
```
