# DECL-0075: `GoffDiode` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Electrical/PowerConverters/DCDC/HBridge.mo:16` |
| **Parameter** | `GoffDiode` |
| **Type** | `SI.Conductance` |
| **Declared modifiers** | `—` |
...
```modelica
// Electrical/PowerConverters/DCDC/HBridge.mo:16
