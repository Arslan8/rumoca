...
| **Signature** | `divisor:divisor-guarded-by-assertion:exp:12295:fcd14e0b` |
...
```
denominator            (1 + (oLine50.G[10].alpha * (oLine50.G[10].T_heatPort - oLine50.G[10].T_ref)))
witness                none needed
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.Lines.SmoothStep \
      --target oLine50.G[10].alpha --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "oLine50.G[10].alpha"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param oLine50.G[10].alpha=0
```
