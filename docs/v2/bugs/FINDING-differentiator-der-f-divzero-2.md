# FINDING-00857: `der_.f` in `Differentiator`
...
| **Signature** | `divisor:divisor-reachable-zero:exp:159:40d0af51` |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.OpAmps.Differentiator \
      --target der_.f --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "der_.f"
```
