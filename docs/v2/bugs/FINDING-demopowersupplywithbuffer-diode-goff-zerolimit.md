...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:39:6ce36a03` |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.DemoPowerSupplyWithBuffer \
      --target diode.Goff --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "diode.Goff"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param diode.Goff=0
```
