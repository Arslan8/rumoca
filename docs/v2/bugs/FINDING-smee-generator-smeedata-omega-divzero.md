# FINDING-02496: `smeeData.omega` in `SMEE_Generator`
...
| **Signature** | `divisor:divisor-reachable-zero:exp:1954:0b4ebf4b` |
...
```
denominator            (smeeData.omega * smeeData.Ta)
witness                smeeData.omega = 0
  found by             set to zero
denominator at witness 0.0
at declared values     4.452035144085213
...
| `denominator_at_declared_values` | 4.452035144085213 |
