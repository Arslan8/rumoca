# FINDING-01464: `dcpmData.wNominal` in `DCPM_CurrentControlled`
...
| **Severity** | high |
| **Declaration** | `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Machines/Examples/DCMachines/DCPM_CurrentControlled.mo:18` |
| **Signature** | `divisor:divisor-reachable-zero:exp:745:8666001b` |
...
```console
$ sed -n '18p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Machines/Examples/DCMachines/DCPM_CurrentControlled.mo"
```
...
```console
$ grep -rl '| `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Machines/Examples/DCMachines/DCPM_CurrentControlled.mo:18` |' docs/v2/bugs/
```
