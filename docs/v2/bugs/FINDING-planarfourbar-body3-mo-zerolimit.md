# FINDING-04571: `body3.mo` in `PlanarFourbar`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:474:2dc0e0a0` |
...
$ python3 tools/sweep/check_one.py Modelica.Mechanics.MultiBody.Examples.Loops.PlanarFourbar \
      --target body3.mo --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "body3.mo"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param body3.mo=0
```
