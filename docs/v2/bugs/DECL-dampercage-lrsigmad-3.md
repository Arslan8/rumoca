# DECL-0128: `Lrsigmad` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Electrical/Machines/BasicMachines/Components/DamperCage.mo:3` |
| **Parameter** | `Lrsigmad` |
| **Type** | `SI.Inductance` |
| **Declared modifiers** | `—` |
...
```console
$ grep -n -- "-1e40\|-1E40" "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Machines/BasicMachines/Components/DamperCage.mo" | head
```
...
```modelica
// Electrical/Machines/BasicMachines/Components/DamperCage.mo:3
