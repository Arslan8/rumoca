# FINDING-01159: `simpleTriac.thyristor.Roff` in `SimpleTriacCircuit`
...
| **Severity** | medium |
| **Declaration** | `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Analog/Semiconductors/Thyristor.mo:57` |
| **Signature** | `divisor:divisor-zero-unresolved:exp:565:037478b4` |
...
path condition         ((simpleTriac.thyristor.vAK < -simpleTriac.thyristor.VRRM))
...
| `path_condition` | ((simpleTriac.thyristor.vAK &lt; -simpleTriac.thyristor.VRRM)) |
| `verdict` | UNKNOWN |
...
```console
$ sed -n '57p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Analog/Semiconductors/Thyristor.mo"
```
...
```console
$ grep -rl '| `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Analog/Semiconductors/Thyristor.mo:57` |' docs/v2/bugs/
```
