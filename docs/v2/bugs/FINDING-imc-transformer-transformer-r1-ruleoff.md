# FINDING-02057: `transformer.R1` in `IMC_Transformer`
...
| **Signature** | `physical:physical-rule-does-not-apply:var:645:ddd8b1e4` |
...
```
{'quantity': 'Resistance', 'unit': 'Ohm', 'confidence': 'QUANTITY_AND_UNIT', 'premise_state': 'unknown', 'authority': 'quantity_or_unit', 'canonical_declaration': 'Modelica.Electrical.Machines.BasicMachines.Transformers.Yy.Yy00.R1'}
```
