...
| **Declaration** | `Electrical/Machines/BasicMachines/Components/AirGapDC.mo:4` |
| **Parameter** | `Le` |
| **Type** | `SI.Inductance` |
| **Declared modifiers** | `—` |
...
```console
$ grep -n -- "-1e40\|-1E40" "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Machines/BasicMachines/Components/AirGapDC.mo" | head
```
...
```modelica
// Electrical/Machines/BasicMachines/Components/AirGapDC.mo:4
