# FINDING-05439: `vehicleInclination.inertia.J` in `Vehicles`

|  |  |
|---|---|
| **Tier** | **Candidate** — static only, not execution-confirmed |
| **Model** | `ModelicaTest.Translational.Vehicles` |
| **Reached as** | `vehicleInclination.inertia.J` |
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:765:ece88e09` |
...
```
predicate     vehicleInclination.inertia.J > 0
premise       refuted
...
| `required` | vehicleInclination.inertia.J &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py ModelicaTest.Translational.Vehicles \
      --target vehicleInclination.inertia.J --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "vehicleInclination.inertia.J"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param vehicleInclination.inertia.J=0
```
