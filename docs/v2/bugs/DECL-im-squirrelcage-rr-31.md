# DECL-0838: `Rr` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Magnetic/FundamentalWave/BasicMachines/InductionMachines/IM_SquirrelCage.mo:31` |
| **Parameter** | `Rr` |
| **Type** | `SI.Resistance` |
...
```console
$ sed -n '31p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/FundamentalWave/BasicMachines/InductionMachines/IM_SquirrelCage.mo"
```
...
```modelica
// Magnetic/FundamentalWave/BasicMachines/InductionMachines/IM_SquirrelCage.mo:31
