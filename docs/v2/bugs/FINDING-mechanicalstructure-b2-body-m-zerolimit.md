# FINDING-04609: `b2.body.m` in `MechanicalStructure`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:693:74368466` |
...
$ python3 tools/sweep/check_one.py Modelica.Mechanics.MultiBody.Examples.Systems.RobotR3.Utilities.MechanicalStructure \
      --target b2.body.m --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "b2.body.m"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param b2.body.m=0
```
