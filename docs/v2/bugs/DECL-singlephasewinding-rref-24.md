# DECL-0834: `RRef` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Magnetic/FundamentalWave/BasicMachines/Components/SinglePhaseWinding.mo:24` |
| **Parameter** | `RRef` |
| **Type** | `SI.Resistance` |
| **Declared modifiers** | `—` |
...
```console
$ sed -n '24p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/FundamentalWave/BasicMachines/Components/SinglePhaseWinding.mo"
```
...
```modelica
// Magnetic/FundamentalWave/BasicMachines/Components/SinglePhaseWinding.mo:24
