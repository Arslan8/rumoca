# DECL-0747: `RonDiode` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Electrical/PowerConverters/DCAC/Polyphase2Level.mo:11` |
| **Parameter** | `RonDiode` |
| **Type** | `SI.Resistance` |
| **Declared modifiers** | `—` |
...
```modelica
// Electrical/PowerConverters/DCAC/Polyphase2Level.mo:11
