# FINDING-04204: `rampCurrent.signalSource.duration` in `ToroidalCoreAirgap`
...
| **Signature** | `divisor:divisor-unreachable-under-witness:exp:515:2bdf92e4` |
...
```console
$ python3 tools/sweep/check_one.py Modelica.Magnetic.FluxTubes.Examples.BasicExamples.ToroidalCoreAirgap \
...
```console
$ python3 tools/sweep/check_one.py Modelica.Magnetic.FluxTubes.Examples.BasicExamples.ToroidalCoreAirgap --keep-artifact /tmp/m.rbc \
