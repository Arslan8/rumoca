...
| **Signature** | `divisor:divisor-reachable-zero:exp:207:97821685` |
...
| `constraints` | HeatingDiode1.R: unbounded |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.HeatingRectifier \
      --target HeatingDiode1.R --sanitizer divisor
```
