# FINDING-05281: `rectifier.RonThyristor` in `HalfControlledBridge2mPulse`
...
```console
$ python3 tools/sweep/check_one.py ModelicaTest.Electrical.PowerConverters.HalfControlledBridge2mPulse \
...
```console
$ python3 tools/sweep/check_one.py ModelicaTest.Electrical.PowerConverters.HalfControlledBridge2mPulse --keep-artifact /tmp/m.rbc \
