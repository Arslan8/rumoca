# FINDING-04470: `pointMass6.m` in `PointGravityWithPointMasses2`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:136:976128e7` |
...
$ python3 tools/sweep/check_one.py Modelica.Mechanics.MultiBody.Examples.Elementary.PointGravityWithPointMasses2 \
      --target pointMass6.m --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "pointMass6.m"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param pointMass6.m=0
```
