# FINDING-04177: `leftLeg.l` in `QuadraticCoreAirgap`
...
| **Signature** | `divisor:divisor-reachable-zero:exp:405:c558e1e3` |
...
| `constraints` | leftLeg.l: unbounded |
...
$ python3 tools/sweep/check_one.py Modelica.Magnetic.FluxTubes.Examples.BasicExamples.QuadraticCoreAirgap \
      --target leftLeg.l --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "leftLeg.l"
```
