...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:18:225ae494` |
...
```
predicate     With_Ron_Goff.Goff > 0
premise       refuted
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.CharacteristicIdealDiodes \
      --target With_Ron_Goff.Goff --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "With_Ron_Goff.Goff"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param With_Ron_Goff.Goff=0
```
