# FINDING-04294: `c_par1.C` in `AdvancedSolenoid`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:343:85515379` |
...
$ python3 tools/sweep/check_one.py Modelica.Magnetic.FluxTubes.Examples.SolenoidActuator.Components.AdvancedSolenoid \
      --target c_par1.C --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "c_par1.C"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param c_par1.C=0
```
