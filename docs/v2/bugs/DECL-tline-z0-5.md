...
| **Declaration** | `Electrical/Analog/Lines/TLine.mo:5` |
| **Parameter** | `Z0` |
| **Type** | `SI.Resistance` |
...
```console
$ grep -n -- "-1e40\|-1E40" "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Analog/Lines/TLine.mo" | head
```
...
```modelica
// Electrical/Analog/Lines/TLine.mo:5
