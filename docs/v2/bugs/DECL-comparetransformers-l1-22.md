# DECL-0111: `L1` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Electrical/Analog/Examples/CompareTransformers.mo:22` |
| **Parameter** | `L1` |
| **Type** | `SI.Inductance` |
| **Declared modifiers** | `—` |
...
```modelica
// Electrical/Analog/Examples/CompareTransformers.mo:22
