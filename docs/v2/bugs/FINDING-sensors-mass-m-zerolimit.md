# FINDING-04738: `mass.m` in `Sensors`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:31:19440cc8` |
...
```console
$ python3 tools/sweep/check_one.py Modelica.Mechanics.Translational.Examples.Sensors \
...
```console
$ python3 tools/sweep/check_one.py Modelica.Mechanics.Translational.Examples.Sensors --keep-artifact /tmp/m.rbc \
