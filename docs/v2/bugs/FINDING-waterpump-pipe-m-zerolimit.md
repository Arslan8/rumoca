# FINDING-05105: `pipe.m` in `WaterPump`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:212:a80a65a4` |
...
$ python3 tools/sweep/check_one.py Modelica.Thermal.FluidHeatFlow.Examples.WaterPump \
      --target pipe.m --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "pipe.m"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param pipe.m=0
```
