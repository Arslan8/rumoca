# FINDING-03566: `rectifier.thyristor_n.Ron` in `ThyristorBridge2mPulse_RLV_Characteristic`
...
| **Reached as** | `rectifier.thyristor_n.Ron` |
...
| **Signature** | `physical:physical-rule-does-not-apply:var:237:f493f9d5` |
...
```
predicate     rectifier.thyristor_n.Ron > 0
premise       refuted
...
| `required` | rectifier.thyristor_n.Ron &gt; 0 |
| `declared_min` | None |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.PowerConverters.Examples.ACDC.RectifierBridge2mPulse.ThyristorBridge2mPulse_RLV_Characteristic \
      --target rectifier.thyristor_n.Ron --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "rectifier.thyristor_n.Ron"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param rectifier.thyristor_n.Ron=0
```
