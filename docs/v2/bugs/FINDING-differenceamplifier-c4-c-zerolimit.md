# FINDING-00274: `C4.C` in `DifferenceAmplifier`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:118:16826730` |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.DifferenceAmplifier \
      --target C4.C --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "C4.C"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param C4.C=0
```
