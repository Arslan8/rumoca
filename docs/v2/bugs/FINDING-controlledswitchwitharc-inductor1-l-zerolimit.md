...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:15:a56e10c0` |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.ControlledSwitchWithArc \
      --target inductor1.L --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "inductor1.L"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param inductor1.L=0
```
