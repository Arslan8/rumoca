...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:264:f3d00e57` |
...
```
predicate     inertia1.rotorWith3DEffects.J > 0
premise       refuted
...
$ python3 tools/sweep/check_one.py Modelica.Mechanics.MultiBody.Examples.Rotational3DEffects.BevelGear1D \
      --target inertia1.rotorWith3DEffects.J --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "inertia1.rotorWith3DEffects.J"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param inertia1.rotorWith3DEffects.J=0
```
