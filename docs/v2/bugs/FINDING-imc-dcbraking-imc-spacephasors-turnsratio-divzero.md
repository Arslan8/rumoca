# FINDING-01737: `imc.spacePhasorS.turnsRatio` in `IMC_DCBraking`
...
| **Reached as** | `imc.spacePhasorS.turnsRatio` |
...
| **Signature** | `divisor:divisor-reachable-zero:exp:2893:d70c5c3b` |
...
```
denominator            imc.spacePhasorS.turnsRatio
witness                imc.spacePhasorS.turnsRatio = 0
  found by             set to zero
denominator at witness 0.0
at declared values     1.0
path condition         always evaluated
constraints consulted  imc.spacePhasorS.turnsRatio: unbounded
```
...
| `constraints` | imc.spacePhasorS.turnsRatio: unbounded |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.InductionMachines.IMC_DCBraking \
      --target imc.spacePhasorS.turnsRatio --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "imc.spacePhasorS.turnsRatio"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check \
      --param imc.spacePhasorS.turnsRatio=0
```
