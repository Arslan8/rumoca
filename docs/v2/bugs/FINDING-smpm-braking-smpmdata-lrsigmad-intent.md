# FINDING-02549: `smpmData.Lrsigmad` in `SMPM_Braking`
...
| **Signature** | `physical:physical-intent-question:var:492:4e0d1015` |
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.SynchronousMachines.SMPM_Braking \
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.SynchronousMachines.SMPM_Braking --keep-artifact /tmp/m.rbc \
