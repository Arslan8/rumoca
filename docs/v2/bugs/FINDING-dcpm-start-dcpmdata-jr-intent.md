# FINDING-01580: `dcpmData.Jr` in `DCPM_Start`
...
| **Signature** | `physical:physical-intent-question:var:306:a9513b2c` |
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.DCMachines.DCPM_Start \
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.DCMachines.DCPM_Start --keep-artifact /tmp/m.rbc \
