# FINDING-03761: `rectifier.diode_n.Goff` in `DiodeCenterTap2mPulse`
...
| **Signature** | `physical:physical-rule-does-not-apply:var:218:8b5317d4` |
...
```
predicate     rectifier.diode_n.Goff > 0
premise       refuted
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.PowerConverters.Examples.ACDC.RectifierCenterTap2mPulse.DiodeCenterTap2mPulse \
      --target rectifier.diode_n.Goff --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "rectifier.diode_n.Goff"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param rectifier.diode_n.Goff=0
```
