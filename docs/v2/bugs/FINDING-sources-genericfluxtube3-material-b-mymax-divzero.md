# FINDING-05348: `genericFluxTube3.material.B_myMax` in `Sources`

|  |  |
|---|---|
| **Tier** | **Candidate** — static only, not execution-confirmed |
| **Model** | `ModelicaTest.Magnetic.FluxTubes.Sources` |
| **Reached as** | `genericFluxTube3.material.B_myMax` |
...
| **Signature** | `divisor:divisor-reachable-zero:exp:496:2068f779` |
...
$ python3 tools/sweep/check_one.py ModelicaTest.Magnetic.FluxTubes.Sources \
      --target genericFluxTube3.material.B_myMax --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "genericFluxTube3.material.B_myMax"
```
