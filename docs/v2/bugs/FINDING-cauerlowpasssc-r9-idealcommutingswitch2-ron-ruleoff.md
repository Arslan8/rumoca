...
| **Signature** | `physical:physical-rule-does-not-apply:var:403:fa97bd8e` |
...
```
predicate     R9.IdealCommutingSwitch2.Ron > 0
premise       refuted
...
| `required` | R9.IdealCommutingSwitch2.Ron &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.CauerLowPassSC \
      --target R9.IdealCommutingSwitch2.Ron --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "R9.IdealCommutingSwitch2.Ron"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param R9.IdealCommutingSwitch2.Ron=0
```
