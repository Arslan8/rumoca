# FINDING-00123: `R5.R` in `CauerLowPassSC`
...
| **Signature** | `physical:physical-rule-does-not-apply:var:232:4813c321` |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.CauerLowPassSC \
      --target R5.R --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "R5.R"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param R5.R=0
```
