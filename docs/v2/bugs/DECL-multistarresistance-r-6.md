...
| **Declaration** | `Electrical/Polyphase/Basic/MultiStarResistance.mo:6` |
| **Parameter** | `R` |
| **Type** | `SI.Resistance` |
| **Declared modifiers** | `—` |
...
```console
$ grep -n -- "-1e40\|-1E40" "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Polyphase/Basic/MultiStarResistance.mo" | head
```
...
```modelica
// Electrical/Polyphase/Basic/MultiStarResistance.mo:6
