# FINDING-00124: `R8.R` in `CauerLowPassSC`
...
| **Signature** | `physical:physical-rule-does-not-apply:var:300:c0b418a1` |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.CauerLowPassSC \
      --target R8.R --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "R8.R"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param R8.R=0
```
