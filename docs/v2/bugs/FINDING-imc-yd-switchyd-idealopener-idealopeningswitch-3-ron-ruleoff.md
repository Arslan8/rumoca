# FINDING-02241: `switchYD.idealOpener.idealOpeningSwitch[3].Ron` in `IMC_YD`

|  |  |
|---|---|
| **Tier** | **Candidate** — static only, not execution-confirmed |
| **Model** | `Modelica.Electrical.Machines.Examples.InductionMachines.IMC_YD` |
| **Reached as** | `switchYD.idealOpener.idealOpeningSwitch[3].Ron` |
...
| **Signature** | `physical:physical-rule-does-not-apply:var:824:32b2188a` |
...
```
predicate     switchYD.idealOpener.idealOpeningSwitch[3].Ron > 0
premise       refuted
...
| `required` | switchYD.idealOpener.idealOpeningSwitch[3].Ron &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.InductionMachines.IMC_YD \
      --target switchYD.idealOpener.idealOpeningSwitch[3].Ron --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "switchYD.idealOpener.idealOpeningSwitch[3].Ron"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param switchYD.idealOpener.idealOpeningSwitch[3].Ron=0
```
