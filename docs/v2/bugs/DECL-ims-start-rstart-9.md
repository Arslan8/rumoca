# DECL-0700: `Rstart` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Electrical/Machines/Examples/InductionMachines/IMS_Start.mo:9` |
| **Parameter** | `Rstart` |
| **Type** | `SI.Resistance` |
| **Declared modifiers** | `—` |
...
```modelica
// Electrical/Machines/Examples/InductionMachines/IMS_Start.mo:9
