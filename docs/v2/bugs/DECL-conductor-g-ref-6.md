# DECL-0078: `G_ref` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Electrical/QuasiStatic/SinglePhase/Basic/Conductor.mo:6` |
| **Parameter** | `G_ref` |
| **Type** | `SI.Conductance` |
...
```console
$ sed -n '6p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/QuasiStatic/SinglePhase/Basic/Conductor.mo"
```
...
```console
$ grep -n -- "-1e40\|-1E40" "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/QuasiStatic/SinglePhase/Basic/Conductor.mo" | head
```
...
```modelica
// Electrical/QuasiStatic/SinglePhase/Basic/Conductor.mo:6
