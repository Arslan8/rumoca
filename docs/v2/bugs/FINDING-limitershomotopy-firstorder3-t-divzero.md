...
| **Signature** | `divisor:divisor-reachable-zero:exp:619:897659c5` |
...
| `constraints` | firstOrder3.T: unbounded |
...
$ python3 tools/sweep/check_one.py ModelicaTest.Blocks.LimitersHomotopy \
      --target firstOrder3.T --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "firstOrder3.T"
```
