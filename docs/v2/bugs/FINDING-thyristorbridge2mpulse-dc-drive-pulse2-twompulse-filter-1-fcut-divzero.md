# FINDING-03511: `pulse2.twomPulse.filter[1].fCut` in `ThyristorBridge2mPulse_DC_Drive`
...
| **Signature** | `divisor:divisor-reachable-zero:exp:972:2f902c1e` |
...
```
denominator            pulse2.twomPulse.filter[1].fCut
