# DECL-0155: `L2sigma` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Electrical/Machines/Interfaces/PartialBasicTransformer.mo:30` |
| **Parameter** | `L2sigma` |
| **Type** | `SI.Inductance` |
...
```console
$ grep -n -- "-1e40\|-1E40" "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Machines/Interfaces/PartialBasicTransformer.mo" | head
```
...
```modelica
// Electrical/Machines/Interfaces/PartialBasicTransformer.mo:30
