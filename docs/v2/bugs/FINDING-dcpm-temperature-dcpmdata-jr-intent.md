# FINDING-01601: `dcpmData.Jr` in `DCPM_Temperature`
...
| **Signature** | `physical:physical-intent-question:var:321:14343eed` |
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.DCMachines.DCPM_Temperature \
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.DCMachines.DCPM_Temperature --keep-artifact /tmp/m.rbc \
