# FINDING-04474: `referenceSystem.pointMass4.m` in `PointGravityWithPointMasses2`
...
| **Reached as** | `referenceSystem.pointMass4.m` |
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:857:98aebacb` |
...
```
predicate     referenceSystem.pointMass4.m > 0
premise       refuted
...
| `required` | referenceSystem.pointMass4.m &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Mechanics.MultiBody.Examples.Elementary.PointGravityWithPointMasses2 \
      --target referenceSystem.pointMass4.m --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "referenceSystem.pointMass4.m"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param referenceSystem.pointMass4.m=0
```
