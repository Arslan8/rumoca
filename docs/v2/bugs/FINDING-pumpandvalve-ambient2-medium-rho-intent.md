# FINDING-04940: `ambient2.medium.rho` in `PumpAndValve`
...
| **Signature** | `physical:physical-intent-question:var:181:c15dc291` |
...
```console
$ python3 tools/sweep/check_one.py Modelica.Thermal.FluidHeatFlow.Examples.PumpAndValve \
...
```console
$ python3 tools/sweep/check_one.py Modelica.Thermal.FluidHeatFlow.Examples.PumpAndValve --keep-artifact /tmp/m.rbc \
