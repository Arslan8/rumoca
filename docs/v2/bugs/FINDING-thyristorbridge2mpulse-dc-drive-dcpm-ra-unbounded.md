...
| **Signature** | `physical:physical-domain-unenforced:var:698:7a696e98` |
...
declaration   Modelica.Electrical.Machines.BasicMachines.DCMachines.DC_PermanentMagnet.Ra
```
...
| `canonical_declaration` | Modelica.Electrical.Machines.BasicMachines.DCMachines.DC_PermanentMagnet.Ra |
