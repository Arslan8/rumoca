# FINDING-01558: `dcpmData.Jr` in `DCPM_QuasiStatic`
...
| **Signature** | `physical:physical-intent-question:var:590:c8386005` |
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.DCMachines.DCPM_QuasiStatic \
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.DCMachines.DCPM_QuasiStatic --keep-artifact /tmp/m.rbc \
