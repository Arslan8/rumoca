# FINDING-03678: `pulse2.twoPulse.filter[1].transferFunction[1].a_end` in `ThyristorBridge2Pulse_DC_Drive`
...
| **Signature** | `divisor:divisor-reachable-zero:exp:2211:52c4be1a` |
