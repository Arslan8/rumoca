# FINDING-01054: `VAmp` in `SignalGenerator`
...
| **Signature** | `divisor:divisor-reachable-zero:exp:16:59eecc94` |
...
constraints consulted  VAmp: unbounded
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "VAmp"
```
