# FINDING-02704: `smpmData.Lrsigmaq` in `SMPM_NoLoad`
...
| **Signature** | `physical:physical-intent-question:var:5:f507c2dc` |
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.SynchronousMachines.SMPM_NoLoad \
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.SynchronousMachines.SMPM_NoLoad --keep-artifact /tmp/m.rbc \
