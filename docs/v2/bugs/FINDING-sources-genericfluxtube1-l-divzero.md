...
| **Signature** | `divisor:divisor-reachable-zero:exp:365:2b7ee1a9` |
...
```
denominator            genericFluxTube1.l
witness                genericFluxTube1.l = 0
  found by             set to zero
denominator at witness 0.0
at declared values     0.01
path condition         always evaluated
constraints consulted  genericFluxTube1.l: unbounded
```
...
| `constraints` | genericFluxTube1.l: unbounded |
...
$ python3 tools/sweep/check_one.py ModelicaTest.Magnetic.FluxTubes.Sources \
      --target genericFluxTube1.l --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "genericFluxTube1.l"
```
