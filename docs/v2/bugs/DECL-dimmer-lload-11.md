# DECL-0199: `LLoad` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Electrical/PowerConverters/Examples/ACAC/ExampleTemplates/Dimmer.mo:11` |
| **Parameter** | `LLoad` |
| **Type** | `SI.Inductance` |
| **Declared modifiers** | `—` |
...
```console
$ sed -n '11p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/PowerConverters/Examples/ACAC/ExampleTemplates/Dimmer.mo"
```
...
```console
$ grep -n -- "-1e40\|-1E40" "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/PowerConverters/Examples/ACAC/ExampleTemplates/Dimmer.mo" | head
```
...
```modelica
// Electrical/PowerConverters/Examples/ACAC/ExampleTemplates/Dimmer.mo:11
