# FINDING-03137: `cDC2.C` in `Rectifier12pulse`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:320:ca978fb4` |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.Transformers.Rectifier12pulse \
      --target cDC2.C --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "cDC2.C"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param cDC2.C=0
```
