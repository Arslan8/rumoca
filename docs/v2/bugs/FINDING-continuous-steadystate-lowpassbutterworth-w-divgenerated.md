# FINDING-05169: `lowpassButterworth.w` in `Continuous_SteadyState`
...
| **Signature** | `divisor:divisor-introduced-by-translation:exp:1102:af59ad08` |
...
```console
$ python3 tools/sweep/check_one.py ModelicaTest.Blocks.Continuous_SteadyState \
...
```console
$ python3 tools/sweep/check_one.py ModelicaTest.Blocks.Continuous_SteadyState --keep-artifact /tmp/m.rbc \
