# FINDING-00215: `l1` in `CauerLowPassSC`
...
| **Signature** | `divisor:divisor-reachable-zero:exp:15:12c7b307` |
...
```
denominator            ((1.704992 ^ 2) * l1)
witness                l1 = 0
  found by             set to zero
denominator at witness 0.0
at declared values     3.790725026963456
path condition         always evaluated
constraints consulted  l1: min=0
```
