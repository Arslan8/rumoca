...
| **Signature** | `divisor:divisor-reachable-zero:exp:536:2e6f8de5` |
...
```
denominator            genericFluxTube3.A
witness                genericFluxTube3.area = 0
  found by             set to zero
denominator at witness 0.0
at declared values     0.0001
path condition         always evaluated
constraints consulted  genericFluxTube3.area: unbounded
```
...
| `constraints` | genericFluxTube3.area: unbounded |
...
$ python3 tools/sweep/check_one.py ModelicaTest.Magnetic.FluxTubes.Sources \
      --target genericFluxTube3.area --sanitizer divisor
```
