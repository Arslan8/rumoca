...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:304:c943d234` |
...
```
predicate     Transistor2.Tr.Cjc > 0
premise       refuted
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.DifferenceAmplifier \
      --target Transistor2.Tr.Cjc --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "Transistor2.Tr.Cjc"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param Transistor2.Tr.Cjc=0
```
