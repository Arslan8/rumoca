# FINDING-05413: `vehicleDragInConst.inertia.J` in `Vehicles`

|  |  |
|---|---|
| **Tier** | **Candidate** — static only, not execution-confirmed |
| **Model** | `ModelicaTest.Translational.Vehicles` |
| **Reached as** | `vehicleDragInConst.inertia.J` |
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:178:2f906162` |
...
```
predicate     vehicleDragInConst.inertia.J > 0
premise       refuted
...
| `required` | vehicleDragInConst.inertia.J &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py ModelicaTest.Translational.Vehicles \
      --target vehicleDragInConst.inertia.J --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "vehicleDragInConst.inertia.J"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param vehicleDragInConst.inertia.J=0
```
