# FINDING-03518: `pulse2.twomPulse.filter[2].fCut` in `ThyristorBridge2mPulse_DC_Drive`
...
| **Severity** | high |
| **Declaration** | `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/PowerConverters/ACDC/Control/Filter.mo:9` |
| **Signature** | `divisor:divisor-reachable-zero:exp:1294:76c6f77b` |
...
| `denominator_at_declared_values` | 100.0 |
...
```console
$ sed -n '9p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/PowerConverters/ACDC/Control/Filter.mo"
```
...
```console
$ grep -rl '| `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/PowerConverters/ACDC/Control/Filter.mo:9` |' docs/v2/bugs/
```
