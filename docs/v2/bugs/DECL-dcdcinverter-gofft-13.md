# DECL-0057: `GoffT` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Electrical/Machines/Examples/ControlledDCDrives/Utilities/DcdcInverter.mo:13` |
| **Parameter** | `GoffT` |
| **Type** | `SI.Conductance` |
| **Declared modifiers** | `—` |
...
```modelica
// Electrical/Machines/Examples/ControlledDCDrives/Utilities/DcdcInverter.mo:13
