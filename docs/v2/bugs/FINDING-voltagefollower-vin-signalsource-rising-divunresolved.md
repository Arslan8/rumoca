# FINDING-01064: `vIn.signalSource.rising` in `VoltageFollower`
...
| **Signature** | `divisor:divisor-zero-unresolved:exp:308:468c57fc` |
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.OpAmps.VoltageFollower \
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.OpAmps.VoltageFollower --keep-artifact /tmp/m.rbc \
