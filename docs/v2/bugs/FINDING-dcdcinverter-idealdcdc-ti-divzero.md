...
| **Signature** | `divisor:divisor-reachable-zero:exp:208:39092cf6` |
...
| `constraints` | idealDcDc.Ti: unbounded |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.ControlledDCDrives.Utilities.DcdcInverter \
      --target idealDcDc.Ti --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "idealDcDc.Ti"
```
