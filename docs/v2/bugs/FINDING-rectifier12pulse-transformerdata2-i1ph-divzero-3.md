# FINDING-03216: `transformerData2.I1ph` in `Rectifier12pulse`
...
| **Reached as** | `transformerData2.I1ph` |
...
| **Signature** | `divisor:divisor-reachable-zero:exp:2892:007832ac` |
...
```
denominator            (3 * (transformerData2.I1ph ^ 2))
witness                transformerData2.I1ph = 0
  found by             set to zero
denominator at witness 0.0
at declared values     None
path condition         always evaluated
constraints consulted  transformerData2.I1ph: unbounded
```
...
| `constraints` | transformerData2.I1ph: unbounded |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.Transformers.Rectifier12pulse \
      --target transformerData2.I1ph --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "transformerData2.I1ph"
```
