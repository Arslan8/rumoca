# FINDING-03135: `diode2.idealDiode[3].Goff` in `Rectifier12pulse`
...
| **Reached as** | `diode2.idealDiode[3].Goff` |
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:267:500a28bc` |
...
```
predicate     diode2.idealDiode[3].Goff > 0
premise       refuted
...
| `required` | diode2.idealDiode[3].Goff &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.Transformers.Rectifier12pulse \
      --target diode2.idealDiode[3].Goff --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "diode2.idealDiode[3].Goff"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param diode2.idealDiode[3].Goff=0
```
