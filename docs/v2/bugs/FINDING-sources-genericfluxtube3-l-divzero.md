...
| **Signature** | `divisor:divisor-reachable-zero:exp:568:8cb271dd` |
...
```
denominator            genericFluxTube3.l
witness                genericFluxTube3.l = 0
  found by             set to zero
denominator at witness 0.0
at declared values     0.01
path condition         always evaluated
constraints consulted  genericFluxTube3.l: unbounded
```
...
| `constraints` | genericFluxTube3.l: unbounded |
...
$ python3 tools/sweep/check_one.py ModelicaTest.Magnetic.FluxTubes.Sources \
      --target genericFluxTube3.l --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "genericFluxTube3.l"
```
