...
| **Signature** | `physical:physical-intent-question:var:391:6192cd49` |
...
```console
$ python3 tools/sweep/check_one.py Modelica.Mechanics.MultiBody.Examples.Elementary.HeatLosses \
...
```console
$ python3 tools/sweep/check_one.py Modelica.Mechanics.MultiBody.Examples.Elementary.HeatLosses --keep-artifact /tmp/m.rbc \
