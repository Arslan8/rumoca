# DECL-0525: `crankLength` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Mechanics/MultiBody/Examples/Loops/Utilities/Cylinder.mo:8` |
...
```console
$ sed -n '8p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Mechanics/MultiBody/Examples/Loops/Utilities/Cylinder.mo"
```
...
```modelica
// Mechanics/MultiBody/Examples/Loops/Utilities/Cylinder.mo:8
