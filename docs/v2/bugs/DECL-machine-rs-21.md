# DECL-0833: `Rs` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Magnetic/FundamentalWave/BaseClasses/Machine.mo:21` |
| **Parameter** | `Rs` |
| **Type** | `SI.Resistance` |
| **Declared modifiers** | `(start=ZsRef*0.03)` |
...
```console
$ sed -n '21p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/FundamentalWave/BaseClasses/Machine.mo"
```
...
```modelica
// Magnetic/FundamentalWave/BaseClasses/Machine.mo:21
