# FINDING-03387: `idealTransformer.idealTransformer[2].Lm1` in `TransformerYY`

|  |  |
|---|---|
| **Tier** | **Candidate** — static only, not execution-confirmed |
| **Model** | `Modelica.Electrical.Polyphase.Examples.TransformerYY` |
| **Reached as** | `idealTransformer.idealTransformer[2].Lm1` |
...
| **Signature** | `physical:physical-intent-question:var:163:3a59c40e` |
...
```
predicate     idealTransformer.idealTransformer[2].Lm1 > 0
premise       unknown
...
| `required` | idealTransformer.idealTransformer[2].Lm1 &gt; 0 |
| `declared_min` | None |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Polyphase.Examples.TransformerYY \
      --target idealTransformer.idealTransformer[2].Lm1 --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "idealTransformer.idealTransformer[2].Lm1"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param idealTransformer.idealTransformer[2].Lm1=0
```
