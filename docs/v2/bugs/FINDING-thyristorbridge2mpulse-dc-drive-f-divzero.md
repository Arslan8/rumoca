# FINDING-03507: `f` in `ThyristorBridge2mPulse_DC_Drive`
...
| **Signature** | `divisor:divisor-reachable-zero:exp:45:e85fce38` |
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "f"
```
