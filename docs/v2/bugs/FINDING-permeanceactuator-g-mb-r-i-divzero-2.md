# FINDING-04276: `g_mb.r_i` in `PermeanceActuator`
...
| **Signature** | `divisor:divisor-reachable-zero:exp:854:883e7156` |
...
$ python3 tools/sweep/check_one.py Modelica.Magnetic.FluxTubes.Examples.MovingCoilActuator.Components.PermeanceActuator \
      --target g_mb.r_i --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "g_mb.r_i"
```
