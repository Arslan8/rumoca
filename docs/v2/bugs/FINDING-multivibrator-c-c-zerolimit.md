# FINDING-00958: `c.C` in `Multivibrator`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:83:8cfcdb43` |
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.OpAmps.Multivibrator \
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.OpAmps.Multivibrator --keep-artifact /tmp/m.rbc \
