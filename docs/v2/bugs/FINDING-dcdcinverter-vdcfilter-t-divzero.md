# FINDING-01271: `vDCFilter.T` in `DcdcInverter`
...
| **Signature** | `divisor:divisor-reachable-zero:exp:287:1afa4479` |
...
| `constraints` | vDCFilter.T: unbounded |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.ControlledDCDrives.Utilities.DcdcInverter \
      --target vDCFilter.T --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "vDCFilter.T"
```
