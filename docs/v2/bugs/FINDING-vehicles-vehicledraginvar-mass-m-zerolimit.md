...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:325:4285fe67` |
...
```
predicate     vehicleDragInVar.mass.m > 0
premise       refuted
...
| `required` | vehicleDragInVar.mass.m &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py ModelicaTest.Translational.Vehicles \
      --target vehicleDragInVar.mass.m --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "vehicleDragInVar.mass.m"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param vehicleDragInVar.mass.m=0
```
