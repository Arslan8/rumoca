# FINDING-03397: `idealthyristor.Goff` in `Thyristor1Pulse_R_Characteristic`
...
| **Reached as** | `idealthyristor.Goff` |
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:142:3097ba68` |
...
```
predicate     idealthyristor.Goff > 0
premise       refuted
...
| `required` | idealthyristor.Goff &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.PowerConverters.Examples.ACDC.Rectifier1Pulse.Thyristor1Pulse_R_Characteristic \
      --target idealthyristor.Goff --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "idealthyristor.Goff"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param idealthyristor.Goff=0
```
