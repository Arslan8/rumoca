# DECL-0109: `Lm1` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Electrical/Analog/Examples/CompareTransformers.mo:15` |
| **Parameter** | `Lm1` |
| **Type** | `SI.Inductance` |
| **Declared modifiers** | `—` |
...
```modelica
// Electrical/Analog/Examples/CompareTransformers.mo:15
