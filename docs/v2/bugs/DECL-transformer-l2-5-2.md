...
| **Declaration** | `Electrical/QuasiStatic/SinglePhase/Basic/Transformer.mo:5` |
| **Parameter** | `L2` |
| **Type** | `SI.Inductance` |
...
```console
$ sed -n '5p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/QuasiStatic/SinglePhase/Basic/Transformer.mo"
```
...
```modelica
// Electrical/QuasiStatic/SinglePhase/Basic/Transformer.mo:5
