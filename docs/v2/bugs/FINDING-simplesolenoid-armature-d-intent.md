# FINDING-04332: `armature.d` in `SimpleSolenoid`
...
| **Signature** | `physical:physical-intent-question:var:230:0854926f` |
...
```console
$ python3 tools/sweep/check_one.py Modelica.Magnetic.FluxTubes.Examples.SolenoidActuator.Components.SimpleSolenoid \
...
```console
$ python3 tools/sweep/check_one.py Modelica.Magnetic.FluxTubes.Examples.SolenoidActuator.Components.SimpleSolenoid --keep-artifact /tmp/m.rbc \
