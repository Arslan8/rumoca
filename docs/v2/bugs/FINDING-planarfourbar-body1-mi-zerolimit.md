# FINDING-04562: `body1.mi` in `PlanarFourbar`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:231:9e6aeaf7` |
...
$ python3 tools/sweep/check_one.py Modelica.Mechanics.MultiBody.Examples.Loops.PlanarFourbar \
      --target body1.mi --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "body1.mi"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param body1.mi=0
```
