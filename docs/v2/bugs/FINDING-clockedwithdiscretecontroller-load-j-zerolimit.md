# FINDING-00001: `load.J` in `ClockedWithDiscreteController`

|  |  |
|---|---|
| **Tier** | **Candidate** — static only, not execution-confirmed |
| **Model** | `Modelica.Clocked.Examples.SimpleControlledDrive.ClockedWithDiscreteController` |
| **Reached as** | `load.J` |
...
```console
$ python3 tools/sweep/check_one.py Modelica.Clocked.Examples.SimpleControlledDrive.ClockedWithDiscreteController \
...
```console
$ python3 tools/sweep/check_one.py Modelica.Clocked.Examples.SimpleControlledDrive.ClockedWithDiscreteController --keep-artifact /tmp/m.rbc \
