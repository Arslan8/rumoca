...
| **Signature** | `divisor:divisor-reachable-zero:exp:134:b32bf8a6` |
...
```
denominator            thyristor_v4_1.ITM
witness                thyristor_v4_1.ITM = 0
  found by             set to zero
denominator at witness 0.0
at declared values     25.0
path condition         always evaluated
constraints consulted  thyristor_v4_1.ITM: unbounded
```
...
| `constraints` | thyristor_v4_1.ITM: unbounded |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.ThyristorBehaviourTest \
      --target thyristor_v4_1.ITM --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "thyristor_v4_1.ITM"
```
