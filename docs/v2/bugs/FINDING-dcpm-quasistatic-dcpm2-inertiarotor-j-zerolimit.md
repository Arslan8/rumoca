# FINDING-01555: `dcpm2.inertiaRotor.J` in `DCPM_QuasiStatic`
...
| **Reached as** | `dcpm2.inertiaRotor.J` |
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:542:02f7b8b8` |
...
```
predicate     dcpm2.inertiaRotor.J > 0
premise       refuted
...
| `required` | dcpm2.inertiaRotor.J &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.DCMachines.DCPM_QuasiStatic \
      --target dcpm2.inertiaRotor.J --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "dcpm2.inertiaRotor.J"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param dcpm2.inertiaRotor.J=0
```
