# DECL-0910: `V` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Media/package.mo:2312` |
| **Parameter** | `V` |
| **Type** | `SI.Volume` |
| **Declared modifiers** | `—` |
...
```console
$ sed -n '2312p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Media/package.mo"
```
...
```console
$ grep -n -- "-1e40\|-1E40" "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Media/package.mo" | head
```
