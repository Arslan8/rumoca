...
| **Signature** | `physical:physical-intent-question:var:14:b259f20c` |
...
```
predicate     openTank1.flowPort.medium.rho > 0
premise       unknown
...
| `required` | openTank1.flowPort.medium.rho &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Thermal.FluidHeatFlow.Examples.TwoTanks \
      --target openTank1.flowPort.medium.rho --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "openTank1.flowPort.medium.rho"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param openTank1.flowPort.medium.rho=0
```
