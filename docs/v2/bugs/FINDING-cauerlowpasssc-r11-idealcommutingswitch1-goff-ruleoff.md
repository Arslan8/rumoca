...
| **Signature** | `physical:physical-rule-does-not-apply:var:863:e7fa582a` |
...
```
predicate     R11.IdealCommutingSwitch1.Goff > 0
premise       refuted
...
| `required` | R11.IdealCommutingSwitch1.Goff &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.CauerLowPassSC \
      --target R11.IdealCommutingSwitch1.Goff --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "R11.IdealCommutingSwitch1.Goff"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param R11.IdealCommutingSwitch1.Goff=0
```
