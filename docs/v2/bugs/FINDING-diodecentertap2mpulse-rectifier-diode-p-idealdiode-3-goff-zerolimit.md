# FINDING-03759: `rectifier.diode_p.idealDiode[3].Goff` in `DiodeCenterTap2mPulse`
...
| **Reached as** | `rectifier.diode_p.idealDiode[3].Goff` |
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:181:f1297910` |
...
```
predicate     rectifier.diode_p.idealDiode[3].Goff > 0
premise       refuted
...
| `required` | rectifier.diode_p.idealDiode[3].Goff &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.PowerConverters.Examples.ACDC.RectifierCenterTap2mPulse.DiodeCenterTap2mPulse \
      --target rectifier.diode_p.idealDiode[3].Goff --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "rectifier.diode_p.idealDiode[3].Goff"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param rectifier.diode_p.idealDiode[3].Goff=0
```
