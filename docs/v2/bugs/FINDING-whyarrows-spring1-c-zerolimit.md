# FINDING-04752: `spring1.c` in `WhyArrows`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:39:f9dc3ede` |
...
```console
$ python3 tools/sweep/check_one.py Modelica.Mechanics.Translational.Examples.WhyArrows \
...
```console
$ python3 tools/sweep/check_one.py Modelica.Mechanics.Translational.Examples.WhyArrows --keep-artifact /tmp/m.rbc \
