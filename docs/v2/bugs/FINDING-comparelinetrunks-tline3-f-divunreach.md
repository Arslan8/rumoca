# FINDING-00547: `tLine3.F` in `CompareLineTrunks`
...
| **Signature** | `divisor:divisor-unreachable-under-witness:exp:3794:e2f85027` |
...
| `denominator_range` |  |
| `path_condition` | ((tLine3.F &gt; 0)) |
| `verdict` | UNSAT |
| `proof` | the denominator is zero as declared, and ((tLine3.F &gt; 0)) |
| `constraints` |  |
| `guard_that_excludes_it` | ((tLine3.F &gt; 0)) |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.Lines.CompareLineTrunks \
      --target tLine3.F --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "tLine3.F"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param tLine3.F=0
```
