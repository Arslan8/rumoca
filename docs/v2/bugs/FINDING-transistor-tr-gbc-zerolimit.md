# FINDING-01253: `Tr.Gbc` in `Transistor`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:52:afc2ced4` |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.Utilities.Transistor \
      --target Tr.Gbc --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "Tr.Gbc"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param Tr.Gbc=0
```
