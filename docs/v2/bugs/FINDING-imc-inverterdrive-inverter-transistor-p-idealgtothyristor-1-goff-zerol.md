# FINDING-01872: `inverter.transistor_p.idealGTOThyristor[1].Goff` in `IMC_InverterDrive`
...
| **Reached as** | `inverter.transistor_p.idealGTOThyristor[1].Goff` |
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:551:166e4e98` |
...
```
predicate     inverter.transistor_p.idealGTOThyristor[1].Goff > 0
premise       refuted
...
| `required` | inverter.transistor_p.idealGTOThyristor[1].Goff &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.InductionMachines.IMC_InverterDrive \
      --target inverter.transistor_p.idealGTOThyristor[1].Goff --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "inverter.transistor_p.idealGTOThyristor[1].Goff"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param inverter.transistor_p.idealGTOThyristor[1].Goff=0
```
