...
| **Signature** | `physical:physical-domain-unenforced:var:6:2efc04b8` |
...
$ python3 tools/sweep/check_one.py Modelica.Thermal.HeatTransfer.Examples.TwoMasses \
      --target mass2.C --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "mass2.C"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param mass2.C=0
```
