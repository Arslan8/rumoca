# FINDING-01452: `loadInertia.J` in `DCPM_CurrentControlled`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:296:6bf2cfd9` |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.DCMachines.DCPM_CurrentControlled \
      --target loadInertia.J --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "loadInertia.J"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param loadInertia.J=0
```
