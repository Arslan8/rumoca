# FINDING-03207: `transformerData1.I2ph` in `Rectifier12pulse`
...
| **Reached as** | `transformerData1.I2ph` |
...
| **Signature** | `divisor:divisor-reachable-zero:exp:813:e1ed1a32` |
...
```
denominator            (3 * (transformerData1.I2ph ^ 2))
witness                transformerData1.I2ph = 0
  found by             set to zero
denominator at witness 0.0
at declared values     None
path condition         always evaluated
constraints consulted  transformerData1.I2ph: unbounded
```
...
| `constraints` | transformerData1.I2ph: unbounded |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.Transformers.Rectifier12pulse \
      --target transformerData1.I2ph --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "transformerData1.I2ph"
```
