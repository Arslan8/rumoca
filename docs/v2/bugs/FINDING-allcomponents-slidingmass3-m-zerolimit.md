...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:94:e465a49e` |
...
$ python3 tools/sweep/check_one.py ModelicaTest.Translational.AllComponents \
      --target slidingMass3.m --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "slidingMass3.m"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param slidingMass3.m=0
```
