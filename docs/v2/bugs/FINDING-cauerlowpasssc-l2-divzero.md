# FINDING-00217: `l2` in `CauerLowPassSC`
...
| **Signature** | `divisor:divisor-reachable-zero:exp:33:c0a0a19a` |
...
```
denominator            ((1.179945 ^ 2) * l2)
witness                l2 = 0
  found by             set to zero
denominator at witness 0.0
at declared values     1.195403196317265
path condition         always evaluated
constraints consulted  l2: min=0
```
