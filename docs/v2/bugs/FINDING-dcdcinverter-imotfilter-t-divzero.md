# FINDING-01272: `iMotFilter.T` in `DcdcInverter`
...
| **Signature** | `divisor:divisor-reachable-zero:exp:296:61ec168c` |
...
| `constraints` | iMotFilter.T: unbounded |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.ControlledDCDrives.Utilities.DcdcInverter \
      --target iMotFilter.T --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "iMotFilter.T"
```
