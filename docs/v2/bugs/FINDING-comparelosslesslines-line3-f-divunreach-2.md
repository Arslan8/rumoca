# FINDING-00568: `line3.F` in `CompareLosslessLines`
...
| **Signature** | `divisor:divisor-unreachable-under-witness:exp:247:5f63e8d2` |
...
| `denominator_range` |  |
| `path_condition` | ((line3.F &gt; 0)) |
| `verdict` | UNSAT |
| `proof` | the denominator is zero as declared, and ((line3.F &gt; 0)) |
| `constraints` |  |
| `guard_that_excludes_it` | ((line3.F &gt; 0)) |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.Lines.CompareLosslessLines \
      --target line3.F --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "line3.F"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param line3.F=0
```
