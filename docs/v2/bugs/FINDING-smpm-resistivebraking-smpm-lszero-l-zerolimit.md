# FINDING-02766: `smpm.lszero.L` in `SMPM_ResistiveBraking`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:200:35a303c0` |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.SynchronousMachines.SMPM_ResistiveBraking \
      --target smpm.lszero.L --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "smpm.lszero.L"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param smpm.lszero.L=0
```
