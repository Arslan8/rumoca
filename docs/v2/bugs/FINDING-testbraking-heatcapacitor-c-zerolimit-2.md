# FINDING-05395: `heatCapacitor.C` in `TestBraking`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:103:e7b04efe` |
...
```console
$ python3 tools/sweep/check_one.py ModelicaTest.Translational.TestBraking \
...
```console
$ python3 tools/sweep/check_one.py ModelicaTest.Translational.TestBraking --keep-artifact /tmp/m.rbc \
