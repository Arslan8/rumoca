# FINDING-04506: `body2.m` in `PointGravityWithPointMasses`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:258:c7a69cb4` |
...
$ python3 tools/sweep/check_one.py Modelica.Mechanics.MultiBody.Examples.Elementary.PointGravityWithPointMasses \
      --target body2.m --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "body2.m"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param body2.m=0
```
