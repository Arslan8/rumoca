# FINDING-03434: `rectifier.thyristor_p.idealThyristor[3].Ron` in `HalfControlledBridge2mPulse`
...
| **Signature** | `physical:physical-rule-does-not-apply:var:213:7507a458` |
