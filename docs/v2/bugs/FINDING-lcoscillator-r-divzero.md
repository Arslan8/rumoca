# FINDING-00934: `R` in `LCOscillator`
...
| **Severity** | high |
| **Declaration** | `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Analog/Examples/OpAmps/LCOscillator.mo:13` |
| **Signature** | `divisor:divisor-reachable-zero:exp:59:ecad0f54` |
...
at declared values     0.506605918211689
...
| `denominator_at_declared_values` | 0.506605918211689 |
...
```console
$ sed -n '13p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Analog/Examples/OpAmps/LCOscillator.mo"
```
...
```console
$ grep -rl '| `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Analog/Examples/OpAmps/LCOscillator.mo:13` |' docs/v2/bugs/
```
