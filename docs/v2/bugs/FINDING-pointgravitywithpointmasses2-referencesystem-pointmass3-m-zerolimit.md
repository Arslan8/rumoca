# FINDING-04473: `referenceSystem.pointMass3.m` in `PointGravityWithPointMasses2`
...
| **Reached as** | `referenceSystem.pointMass3.m` |
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:787:5f5131d4` |
...
```
predicate     referenceSystem.pointMass3.m > 0
premise       refuted
...
| `required` | referenceSystem.pointMass3.m &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Mechanics.MultiBody.Examples.Elementary.PointGravityWithPointMasses2 \
      --target referenceSystem.pointMass3.m --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "referenceSystem.pointMass3.m"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param referenceSystem.pointMass3.m=0
```
