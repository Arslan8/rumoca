# FINDING-03753: `rectifier.diode_p.Goff` in `DiodeCenterTap2mPulse`
...
| **Reached as** | `rectifier.diode_p.Goff` |
...
| **Signature** | `physical:physical-rule-does-not-apply:var:144:139f3b41` |
...
```
predicate     rectifier.diode_p.Goff > 0
premise       refuted
...
| `required` | rectifier.diode_p.Goff &gt; 0 |
| `declared_min` | None |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.PowerConverters.Examples.ACDC.RectifierCenterTap2mPulse.DiodeCenterTap2mPulse \
      --target rectifier.diode_p.Goff --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "rectifier.diode_p.Goff"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param rectifier.diode_p.Goff=0
```
