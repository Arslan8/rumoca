...
| **Signature** | `divisor:divisor-unreachable-under-witness:exp:477:0e65e88c` |
...
```
denominator            (2 * (thyristor_v4_1.Von - thyristor_v4_1.Voff))
witness                thyristor_v4_1.Von = 1.5
...
constraints consulted  thyristor_v4_1.Von: unbounded
```
...
| `constraints` | thyristor_v4_1.Von: unbounded |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.ThyristorBehaviourTest \
      --target thyristor_v4_1.Von --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "thyristor_v4_1.Von"
```
