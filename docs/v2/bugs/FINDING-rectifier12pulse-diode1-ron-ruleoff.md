# FINDING-03120: `diode1.Ron` in `Rectifier12pulse`
...
| **Signature** | `physical:physical-rule-does-not-apply:var:145:974dc0f3` |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.Transformers.Rectifier12pulse \
      --target diode1.Ron --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "diode1.Ron"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param diode1.Ron=0
```
