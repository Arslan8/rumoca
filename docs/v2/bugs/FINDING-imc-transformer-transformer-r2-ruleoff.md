# FINDING-02059: `transformer.R2` in `IMC_Transformer`
...
| **Signature** | `physical:physical-rule-does-not-apply:var:649:435f4780` |
...
```
{'quantity': 'Resistance', 'unit': 'Ohm', 'confidence': 'QUANTITY_AND_UNIT', 'premise_state': 'unknown', 'authority': 'quantity_or_unit', 'canonical_declaration': 'Modelica.Electrical.Machines.BasicMachines.Transformers.Yy.Yy00.R2'}
```
