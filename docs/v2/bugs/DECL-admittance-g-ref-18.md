# DECL-0077: `G_ref` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Electrical/QuasiStatic/SinglePhase/Basic/Admittance.mo:18` |
| **Parameter** | `G_ref` |
| **Type** | `SI.Conductance` |
| **Declared modifiers** | `—` |
...
```console
$ sed -n '18p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/QuasiStatic/SinglePhase/Basic/Admittance.mo"
```
...
```console
$ grep -n -- "-1e40\|-1E40" "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/QuasiStatic/SinglePhase/Basic/Admittance.mo" | head
```
...
```modelica
// Electrical/QuasiStatic/SinglePhase/Basic/Admittance.mo:18
