# FINDING-04955: `valve.y1` in `PumpAndValve`
...
| **Signature** | `divisor:divisor-guarded-by-assertion:exp:754:690ed2cf` |
...
path condition         (valve.LinearCharacteristic)
...
| `denominator_range` |  |
| `path_condition` | (valve.LinearCharacteristic) |
| `verdict` | UNSAT |
