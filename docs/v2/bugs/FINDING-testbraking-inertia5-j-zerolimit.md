...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:95:b209c5ad` |
...
$ python3 tools/sweep/check_one.py ModelicaTest.Rotational.TestBraking \
      --target inertia5.J --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "inertia5.J"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param inertia5.J=0
```
