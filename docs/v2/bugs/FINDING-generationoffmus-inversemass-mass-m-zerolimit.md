...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:57:9e65c826` |
...
```
predicate     inverseMass.mass.m > 0
premise       refuted
...
$ python3 tools/sweep/check_one.py Modelica.Mechanics.Translational.Examples.GenerationOfFMUs \
      --target inverseMass.mass.m --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "inverseMass.mass.m"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param inverseMass.mass.m=0
```
