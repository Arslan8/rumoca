# FINDING-01733: `imc.Rr` in `IMC_DCBraking`
...
| **Signature** | `physical:physical-domain-unenforced:var:430:37f7b72b` |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.InductionMachines.IMC_DCBraking \
      --target imc.Rr --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "imc.Rr"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param imc.Rr=0
```
