# FINDING-00322: `H_PMOS.RDS` in `HeatingMOSInverter`
...
| **Signature** | `physical:physical-domain-unenforced:var:61:47750ada` |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.HeatingMOSInverter \
      --target H_PMOS.RDS --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "H_PMOS.RDS"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param H_PMOS.RDS=0
```
