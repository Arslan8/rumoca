...
| **Declaration** | `Electrical/Polyphase/Basic/Resistor.mo:4` |
| **Parameter** | `R` |
| **Type** | `SI.Resistance` |
...
```console
$ sed -n '4p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Polyphase/Basic/Resistor.mo"
```
...
```console
$ grep -n -- "-1e40\|-1E40" "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Polyphase/Basic/Resistor.mo" | head
```
...
```modelica
// Electrical/Polyphase/Basic/Resistor.mo:4
