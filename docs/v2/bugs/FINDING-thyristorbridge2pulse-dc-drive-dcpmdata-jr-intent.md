# FINDING-03672: `dcpmData.Jr` in `ThyristorBridge2Pulse_DC_Drive`
...
| **Signature** | `physical:physical-intent-question:var:585:6e301400` |
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.PowerConverters.Examples.ACDC.RectifierBridge2Pulse.ThyristorBridge2Pulse_DC_Drive \
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.PowerConverters.Examples.ACDC.RectifierBridge2Pulse.ThyristorBridge2Pulse_DC_Drive --keep-artifact /tmp/m.rbc \
