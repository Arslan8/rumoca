# FINDING-02619: `smpmData.Lrsigmaq` in `SMPM_CurrentSource`
...
| **Signature** | `physical:physical-intent-question:var:760:137ac3f0` |
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.SynchronousMachines.SMPM_CurrentSource \
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.SynchronousMachines.SMPM_CurrentSource --keep-artifact /tmp/m.rbc \
