...
| **Reached as** | `dcdcInverter2.vMotFilter.T` |
...
| **Signature** | `divisor:divisor-reachable-zero:exp:3065:a53aeb84` |
...
```
denominator            dcdcInverter2.vMotFilter.T
witness                dcdcInverter2.vMotFilter.T = 0
  found by             set to zero
denominator at witness 0.0
at declared values     0.002
path condition         always evaluated
constraints consulted  dcdcInverter2.vMotFilter.T: unbounded
```
...
| `constraints` | dcdcInverter2.vMotFilter.T: unbounded |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.DCMachines.DCPM_Drive \
      --target dcdcInverter2.vMotFilter.T --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "dcdcInverter2.vMotFilter.T"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check \
      --param dcdcInverter2.vMotFilter.T=0
```
