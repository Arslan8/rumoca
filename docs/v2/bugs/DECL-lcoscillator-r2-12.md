# DECL-0619: `R2` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Electrical/Analog/Examples/OpAmps/LCOscillator.mo:12` |
| **Parameter** | `R2` |
| **Type** | `SI.Resistance` |
| **Declared modifiers** | `—` |
...
```modelica
// Electrical/Analog/Examples/OpAmps/LCOscillator.mo:12
