# DECL-0187: `L2` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Electrical/Polyphase/Basic/Transformer.mo:6` |
| **Parameter** | `L2` |
| **Type** | `SI.Inductance` |
...
```console
$ sed -n '6p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Polyphase/Basic/Transformer.mo"
```
...
```modelica
// Electrical/Polyphase/Basic/Transformer.mo:6
