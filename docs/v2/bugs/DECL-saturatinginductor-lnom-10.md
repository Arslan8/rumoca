# DECL-0099: `Lnom` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Electrical/Analog/Basic/SaturatingInductor.mo:10` |
| **Parameter** | `Lnom` |
| **Type** | `SI.Inductance` |
...
```modelica
// Electrical/Analog/Basic/SaturatingInductor.mo:10
