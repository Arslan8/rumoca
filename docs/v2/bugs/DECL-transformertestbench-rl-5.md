# DECL-0800: `RL` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Electrical/QuasiStatic/Machines/Examples/TransformerTestbench.mo:5` |
| **Parameter** | `RL` |
| **Type** | `SI.Resistance` |
| **Declared modifiers** | `—` |
...
```console
$ sed -n '5p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/QuasiStatic/Machines/Examples/TransformerTestbench.mo"
```
...
```console
$ grep -n -- "-1e40\|-1E40" "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/QuasiStatic/Machines/Examples/TransformerTestbench.mo" | head
```
...
```modelica
// Electrical/QuasiStatic/Machines/Examples/TransformerTestbench.mo:5
