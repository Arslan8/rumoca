# FINDING-01034: `Vps` in `SchmittTrigger`
...
| **Severity** | high |
| **Declaration** | `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Analog/Examples/OpAmps/SchmittTrigger.mo:9` |
| **Signature** | `divisor:divisor-reachable-zero:exp:12:8a921cd5` |
...
```console
$ sed -n '9p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Analog/Examples/OpAmps/SchmittTrigger.mo"
```
...
```console
$ grep -rl '| `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Analog/Examples/OpAmps/SchmittTrigger.mo:9` |' docs/v2/bugs/
```
