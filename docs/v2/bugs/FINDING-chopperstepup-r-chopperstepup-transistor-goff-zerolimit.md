...
| **Reached as** | `chopperStepUp.transistor.Goff` |
...
```
predicate     chopperStepUp.transistor.Goff > 0
premise       refuted
...
| `required` | chopperStepUp.transistor.Goff &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.PowerConverters.Examples.DCDC.ChopperStepUp.ChopperStepUp_R \
      --target chopperStepUp.transistor.Goff --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "chopperStepUp.transistor.Goff"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param chopperStepUp.transistor.Goff=0
```
