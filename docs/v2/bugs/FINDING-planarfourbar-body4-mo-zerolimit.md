# FINDING-04576: `body4.mo` in `PlanarFourbar`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:596:6ed98018` |
...
$ python3 tools/sweep/check_one.py Modelica.Mechanics.MultiBody.Examples.Loops.PlanarFourbar \
      --target body4.mo --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "body4.mo"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param body4.mo=0
```
