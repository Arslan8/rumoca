...
| **Signature** | `divisor:divisor-reachable-zero:exp:1109:f34350b6` |
...
constraints consulted  T1.Phie: unbounded
```
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.HeatingPNP_NORGate \
      --target T1.Phie --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "T1.Phie"
```
