# DECL-0040: `a` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `StateGraph.mo:1539` |
| **Parameter** | `a` |
| **Type** | `SI.Area` |
| **Declared modifiers** | `—` |
...
```console
$ sed -n '1539p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/StateGraph.mo"
```
