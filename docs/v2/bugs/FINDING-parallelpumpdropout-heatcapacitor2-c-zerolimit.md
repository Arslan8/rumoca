...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:276:001053ad` |
...
$ python3 tools/sweep/check_one.py Modelica.Thermal.FluidHeatFlow.Examples.ParallelPumpDropOut \
      --target heatCapacitor2.C --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "heatCapacitor2.C"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param heatCapacitor2.C=0
```
