# DECL-0547: `length` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Mechanics/MultiBody/Parts/BodyCylinder.mo:27` |
| **Parameter** | `length` |
| **Type** | `SI.Length` |
| **Declared modifiers** | `—` |
...
```console
$ sed -n '27p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Mechanics/MultiBody/Parts/BodyCylinder.mo"
```
...
```modelica
// Mechanics/MultiBody/Parts/BodyCylinder.mo:27
