...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:429:f19bf456` |
...
$ python3 tools/sweep/check_one.py Modelica.Mechanics.MultiBody.Examples.Elementary.FreeBody \
      --target body.body.m --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "body.body.m"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param body.body.m=0
```
