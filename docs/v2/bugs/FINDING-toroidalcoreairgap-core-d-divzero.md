# FINDING-04199: `core.d` in `ToroidalCoreAirgap`
...
| **Signature** | `divisor:divisor-reachable-zero:exp:301:758ede2d` |
...
constraints consulted  core.d: min=0
```
...
$ python3 tools/sweep/check_one.py Modelica.Magnetic.FluxTubes.Examples.BasicExamples.ToroidalCoreAirgap \
      --target core.d --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "core.d"
```
