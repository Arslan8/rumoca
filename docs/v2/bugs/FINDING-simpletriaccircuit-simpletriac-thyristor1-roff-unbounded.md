# FINDING-01151: `simpleTriac.thyristor1.Roff` in `SimpleTriacCircuit`
...
| **Signature** | `physical:physical-domain-unenforced:var:128:fe89fd0d` |
...
```
predicate     simpleTriac.thyristor1.Roff > 0
premise       established
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.SimpleTriacCircuit \
      --target simpleTriac.thyristor1.Roff --sanitizer physical
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param simpleTriac.thyristor1.Roff=0
```
