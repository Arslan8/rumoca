# DECL-0906: `V` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Magnetic/FluxTubes/BaseClasses/Generic.mo:12` |
| **Parameter** | `V` |
| **Type** | `SI.Volume` |
| **Declared modifiers** | `—` |
...
```console
$ sed -n '12p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/FluxTubes/BaseClasses/Generic.mo"
```

It should declare `V` with type `SI.Volume` and no `min`.
...
```modelica
// Magnetic/FluxTubes/BaseClasses/Generic.mo:12
