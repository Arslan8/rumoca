...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:29:9c770750` |
...
```console
$ python3 tools/sweep/check_one.py Modelica.Thermal.HeatTransfer.Examples.Utilities.Conduction \
...
```console
$ python3 tools/sweep/check_one.py Modelica.Thermal.HeatTransfer.Examples.Utilities.Conduction --keep-artifact /tmp/m.rbc \
