...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:64:379abdd9` |
...
```
predicate     idealTriac.idealThyristor1.Goff > 0
premise       refuted
...
| `required` | idealTriac.idealThyristor1.Goff &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.IdealTriacCircuit \
      --target idealTriac.idealThyristor1.Goff --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "idealTriac.idealThyristor1.Goff"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param idealTriac.idealThyristor1.Goff=0
```
