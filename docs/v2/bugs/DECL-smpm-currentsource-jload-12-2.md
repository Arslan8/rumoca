# DECL-0339: `JLoad` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Magnetic/FundamentalWave/Examples/BasicMachines/SynchronousMachines/SMPM_CurrentSource.mo:12` |
| **Parameter** | `JLoad` |
| **Type** | `SI.Inertia` |
| **Declared modifiers** | `—` |
...
```console
$ sed -n '12p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/FundamentalWave/Examples/BasicMachines/SynchronousMachines/SMPM_CurrentSource.mo"
```
...
```console
$ grep -n -- "-1e40\|-1E40" "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/FundamentalWave/Examples/BasicMachines/SynchronousMachines/SMPM_CurrentSource.mo" | head
```
...
```modelica
// Magnetic/FundamentalWave/Examples/BasicMachines/SynchronousMachines/SMPM_CurrentSource.mo:12
