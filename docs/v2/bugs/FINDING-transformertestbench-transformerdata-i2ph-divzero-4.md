# FINDING-03316: `transformerData.I2ph` in `TransformerTestbench`
...
| **Reached as** | `transformerData.I2ph` |
...
| **Signature** | `divisor:divisor-reachable-zero:exp:1294:2be4a9b2` |
...
```
denominator            (3 * (transformerData.I2ph ^ 2))
witness                transformerData.I2ph = 0
  found by             set to zero
denominator at witness 0.0
at declared values     None
path condition         always evaluated
constraints consulted  transformerData.I2ph: unbounded
```
...
| `constraints` | transformerData.I2ph: unbounded |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.Transformers.TransformerTestbench \
      --target transformerData.I2ph --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "transformerData.I2ph"
```
