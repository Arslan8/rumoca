...
| **Reached as** | `simpleTriac.thyristor1.Nbv` |
...
| **Signature** | `divisor:divisor-zero-unresolved:exp:780:c22f08bc` |
...
```
denominator            (simpleTriac.thyristor1.Nbv * simpleTriac.thyristor1.Vt)
witness                simpleTriac.thyristor1.Nbv = 0
...
constraints consulted  simpleTriac.thyristor1.Nbv: unbounded
```
...
| `constraints` | simpleTriac.thyristor1.Nbv: unbounded |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.SimpleTriacCircuit \
      --target simpleTriac.thyristor1.Nbv --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "simpleTriac.thyristor1.Nbv"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check \
      --param simpleTriac.thyristor1.Nbv=0
```
