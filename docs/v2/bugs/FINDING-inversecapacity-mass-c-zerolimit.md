# FINDING-05156: `mass.C` in `InverseCapacity`
...
$ python3 tools/sweep/check_one.py Modelica.Thermal.HeatTransfer.Examples.Utilities.InverseCapacity \
      --target mass.C --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "mass.C"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param mass.C=0
```
