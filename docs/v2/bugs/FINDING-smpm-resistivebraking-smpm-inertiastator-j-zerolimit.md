# FINDING-02771: `smpm.inertiaStator.J` in `SMPM_ResistiveBraking`
...
| **Reached as** | `smpm.inertiaStator.J` |
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:397:c809be4b` |
...
```
predicate     smpm.inertiaStator.J > 0
premise       refuted
...
| `required` | smpm.inertiaStator.J &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.SynchronousMachines.SMPM_ResistiveBraking \
      --target smpm.inertiaStator.J --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "smpm.inertiaStator.J"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param smpm.inertiaStator.J=0
```
