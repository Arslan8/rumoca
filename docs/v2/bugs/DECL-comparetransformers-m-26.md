# DECL-0113: `M` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Electrical/Analog/Examples/CompareTransformers.mo:26` |
| **Parameter** | `M` |
| **Type** | `SI.Inductance` |
| **Declared modifiers** | `—` |
...
```modelica
// Electrical/Analog/Examples/CompareTransformers.mo:26
