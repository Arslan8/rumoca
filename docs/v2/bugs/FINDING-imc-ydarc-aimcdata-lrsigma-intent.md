# FINDING-02178: `aimcData.Lrsigma` in `IMC_YDarc`
...
| **Signature** | `physical:physical-intent-question:var:938:713cab02` |
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.InductionMachines.IMC_YDarc \
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.InductionMachines.IMC_YDarc --keep-artifact /tmp/m.rbc \
