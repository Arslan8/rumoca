# FINDING-01225: `capacitor.C` in `InverseCapacitor`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:7:7f6b0a82` |
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.Utilities.InverseCapacitor \
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.Utilities.InverseCapacitor --keep-artifact /tmp/m.rbc \
