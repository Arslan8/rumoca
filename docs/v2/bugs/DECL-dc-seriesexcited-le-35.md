# DECL-0136: `Le` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Electrical/Machines/BasicMachines/DCMachines/DC_SeriesExcited.mo:35` |
| **Parameter** | `Le` |
| **Type** | `SI.Inductance` |
| **Declared modifiers** | `(start=0.0005)` |
...
```console
$ grep -n -- "-1e40\|-1E40" "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Machines/BasicMachines/DCMachines/DC_SeriesExcited.mo" | head
```
...
```modelica
// Electrical/Machines/BasicMachines/DCMachines/DC_SeriesExcited.mo:35
