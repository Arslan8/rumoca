# FINDING-03422: `multiStarResistance.R` in `DiodeBridge2mPulse`
...
| **Signature** | `physical:physical-rule-does-not-apply:var:324:02d25606` |
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.PowerConverters.Examples.ACDC.RectifierBridge2mPulse.DiodeBridge2mPulse \
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.PowerConverters.Examples.ACDC.RectifierBridge2mPulse.DiodeBridge2mPulse --keep-artifact /tmp/m.rbc \
