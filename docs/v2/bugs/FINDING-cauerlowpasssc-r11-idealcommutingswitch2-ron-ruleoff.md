...
| **Signature** | `physical:physical-rule-does-not-apply:var:879:9a0da7a1` |
...
```
predicate     R11.IdealCommutingSwitch2.Ron > 0
premise       refuted
...
| `required` | R11.IdealCommutingSwitch2.Ron &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.CauerLowPassSC \
      --target R11.IdealCommutingSwitch2.Ron --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "R11.IdealCommutingSwitch2.Ron"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param R11.IdealCommutingSwitch2.Ron=0
```
