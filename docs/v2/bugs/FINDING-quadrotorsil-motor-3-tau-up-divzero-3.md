...
| **Signature** | `divisor:divisor-reachable-zero:exp:478:48b41420` |
...
| `constraints` | motor[3].tau_up: unbounded |
...
$ python3 tools/sweep/check_one.py RigidBody.Examples.QuadrotorSIL \
      --target motor[3].tau_up --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "motor[3].tau_up"
```
