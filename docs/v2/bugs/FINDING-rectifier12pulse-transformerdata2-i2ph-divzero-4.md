# FINDING-03223: `transformerData2.I2ph` in `Rectifier12pulse`
...
| **Reached as** | `transformerData2.I2ph` |
...
| **Signature** | `divisor:divisor-reachable-zero:exp:2967:28cd70b1` |
...
```
denominator            (3 * (transformerData2.I2ph ^ 2))
witness                transformerData2.I2ph = 0
  found by             set to zero
denominator at witness 0.0
at declared values     None
path condition         always evaluated
constraints consulted  transformerData2.I2ph: unbounded
```
...
| `constraints` | transformerData2.I2ph: unbounded |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.Transformers.Rectifier12pulse \
      --target transformerData2.I2ph --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "transformerData2.I2ph"
```
