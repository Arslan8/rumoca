# DECL-0674: `Ri` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Electrical/Batteries/ParameterRecords/CellData.mo:26` |
| **Parameter** | `Ri` |
| **Type** | `SI.Resistance` |
| **Declared modifiers** | `—` |
...
```console
$ sed -n '26p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Batteries/ParameterRecords/CellData.mo"
```
...
```modelica
// Electrical/Batteries/ParameterRecords/CellData.mo:26
