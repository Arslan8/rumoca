# DECL-0141: `Lrzero` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Electrical/Machines/BasicMachines/InductionMachines/IM_SlipRing.mo:34` |
| **Parameter** | `Lrzero` |
| **Type** | `SI.Inductance` |
| **Declared modifiers** | `—` |
...
```modelica
// Electrical/Machines/BasicMachines/InductionMachines/IM_SlipRing.mo:34
