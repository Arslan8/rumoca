# FINDING-01900: `inverter.diode_n.idealDiode[3].Goff` in `IMC_InverterDrive`
...
| **Reached as** | `inverter.diode_n.idealDiode[3].Goff` |
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:824:8b540752` |
...
```
predicate     inverter.diode_n.idealDiode[3].Goff > 0
premise       refuted
...
| `required` | inverter.diode_n.idealDiode[3].Goff &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.InductionMachines.IMC_InverterDrive \
      --target inverter.diode_n.idealDiode[3].Goff --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "inverter.diode_n.idealDiode[3].Goff"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param inverter.diode_n.idealDiode[3].Goff=0
```
