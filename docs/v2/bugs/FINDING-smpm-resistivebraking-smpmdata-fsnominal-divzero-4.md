# FINDING-02802: `smpmData.fsNominal` in `SMPM_ResistiveBraking`
...
| **Severity** | high |
| **Declaration** | `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Machines/Utilities/ParameterRecords/SM_PermanentMagnetData.mo:4` |
| **Signature** | `divisor:divisor-reachable-zero:exp:2301:e689569c` |
...
```console
$ sed -n '4p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Machines/Utilities/ParameterRecords/SM_PermanentMagnetData.mo"
```
...
```console
$ grep -rl '| `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Machines/Utilities/ParameterRecords/SM_PermanentMagnetData.mo:4` |' docs/v2/bugs/
```
