...
| **Signature** | `physical:physical-rule-does-not-apply:var:46:101e94b9` |
...
$ python3 tools/sweep/check_one.py Modelica.Thermal.HeatTransfer.Examples.ControlledTemperature \
      --target idealSwitch.Ron --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "idealSwitch.Ron"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param idealSwitch.Ron=0
```
