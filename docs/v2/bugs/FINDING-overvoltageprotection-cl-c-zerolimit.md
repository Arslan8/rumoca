# FINDING-01074: `CL.C` in `OvervoltageProtection`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:54:24eed8cf` |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.OvervoltageProtection \
      --target CL.C --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "CL.C"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param CL.C=0
```
