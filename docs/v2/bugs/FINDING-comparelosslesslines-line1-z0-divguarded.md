# FINDING-00555: `line1.Z0` in `CompareLosslessLines`
...
| **Signature** | `divisor:divisor-guarded-by-assertion:exp:404:affb0364` |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.Lines.CompareLosslessLines \
      --target line1.Z0 --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "line1.Z0"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param line1.Z0=0
```
