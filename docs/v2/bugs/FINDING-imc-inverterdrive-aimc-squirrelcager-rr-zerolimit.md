# FINDING-01917: `aimc.squirrelCageR.Rr` in `IMC_InverterDrive`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:1344:b24a9de7` |
...
```
predicate     aimc.squirrelCageR.Rr >= 0
premise       refuted
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.InductionMachines.IMC_InverterDrive \
      --target aimc.squirrelCageR.Rr --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "aimc.squirrelCageR.Rr"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param aimc.squirrelCageR.Rr=0
```
