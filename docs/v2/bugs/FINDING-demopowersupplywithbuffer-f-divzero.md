# FINDING-00272: `f` in `DemoPowerSupplyWithBuffer`
...
| **Severity** | high |
| **Declaration** | `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Analog/Examples/DemoPowerSupplyWithBuffer.mo:23` |
| **Signature** | `divisor:divisor-reachable-zero:exp:253:3ef08f18` |
...
```console
$ sed -n '23p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Analog/Examples/DemoPowerSupplyWithBuffer.mo"
```
...
```console
$ grep -rl '| `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Analog/Examples/DemoPowerSupplyWithBuffer.mo:23` |' docs/v2/bugs/
```
