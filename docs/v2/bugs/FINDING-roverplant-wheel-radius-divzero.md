...
| **Severity** | high |
| **Declaration** | `target/cmm/CMM-a642c381/RigidBody/Examples/RoverPlant.mo:66` |
| **Signature** | `divisor:divisor-reachable-zero:exp:520:d597cc3f` |
...
```console
$ sed -n '66p' "target/cmm/CMM-a642c381/RigidBody/Examples/RoverPlant.mo"
```
...
```console
$ grep -rl '| `target/cmm/CMM-a642c381/RigidBody/Examples/RoverPlant.mo:66` |' docs/v2/bugs/
```
