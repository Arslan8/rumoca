# DECL-0796: `RLoad` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Electrical/PowerConverters/Examples/DCDC/ExampleTemplates/ChopperStepUp.mo:10` |
| **Parameter** | `RLoad` |
| **Type** | `SI.Resistance` |
| **Declared modifiers** | `—` |
...
```modelica
// Electrical/PowerConverters/Examples/DCDC/ExampleTemplates/ChopperStepUp.mo:10
