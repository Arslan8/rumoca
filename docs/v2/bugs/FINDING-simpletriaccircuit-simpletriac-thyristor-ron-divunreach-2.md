# FINDING-01166: `simpleTriac.thyristor.Ron` in `SimpleTriacCircuit`
...
| **Signature** | `divisor:divisor-unreachable-under-witness:exp:634:9c5d119b` |
...
```
denominator            simpleTriac.thyristor.Ron
witness                simpleTriac.thyristor.Ron = 0
  found by             set to zero
denominator at witness 0.0
at declared values     0.04
path condition         not ((simpleTriac.thyristor.vAK < -simpleTriac.thyristor.VRRM)) and not ((simpleTriac.thyristor.vControl < simpleTriac.thyristor.Voff)) and not ((simpleTriac.thyristor.vControl < simpleTriac.thyristor.Von))
...
| `path_condition` | not ((simpleTriac.thyristor.vAK &lt; -simpleTriac.thyristor.VRRM)) and not ((simpleTriac.thyristor.vControl &lt; simpleTriac.thyristor.Voff)) and not ((simpleTriac.thyristor.vControl &lt; simpleTriac.thyristor.Von)) |
| `verdict` | UNSAT |
