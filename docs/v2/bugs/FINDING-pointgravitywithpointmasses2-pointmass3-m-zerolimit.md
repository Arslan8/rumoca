# FINDING-04467: `pointMass3.m` in `PointGravityWithPointMasses2`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:58:6f69b9e8` |
...
$ python3 tools/sweep/check_one.py Modelica.Mechanics.MultiBody.Examples.Elementary.PointGravityWithPointMasses2 \
      --target pointMass3.m --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "pointMass3.m"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param pointMass3.m=0
```
