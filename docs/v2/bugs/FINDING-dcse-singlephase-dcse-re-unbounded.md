# FINDING-01666: `dcse.Re` in `DCSE_SinglePhase`
...
| **Signature** | `physical:physical-domain-unenforced:var:243:4ae709a6` |
...
declaration   Modelica.Electrical.Machines.BasicMachines.DCMachines.DC_SeriesExcited.Re
```
...
```
{'quantity': 'Resistance', 'unit': 'Ohm', 'semantic_role': 'component.machine.winding_resistance', 'binding_source': 'component_type', 'confidence': 'QUANTITY_AND_UNIT', 'declaring_class': 'Modelica.Electrical.Machines.BasicMachines.DCMachines.DC_SeriesExcited', 'member': 'Re', 'premise_state': 'established', 'authority': 'component_contract', 'canonical_declaration': 'Modelica.Electrical.Machines.BasicMachines.DCMachines.DC_SeriesExcited.Re'}
```
...
| `canonical_declaration` | Modelica.Electrical.Machines.BasicMachines.DCMachines.DC_SeriesExcited.Re |
