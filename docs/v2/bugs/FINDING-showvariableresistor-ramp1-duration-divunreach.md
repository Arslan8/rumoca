# FINDING-01146: `Ramp1.duration` in `ShowVariableResistor`
...
| **Signature** | `divisor:divisor-unreachable-under-witness:exp:479:ed56f26f` |
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.ShowVariableResistor \
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.ShowVariableResistor --keep-artifact /tmp/m.rbc \
