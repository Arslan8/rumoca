...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:92:b016aedc` |
...
```
predicate     vehicleDrag.mass.m > 0
premise       refuted
...
$ python3 tools/sweep/check_one.py ModelicaTest.Translational.Vehicles \
      --target vehicleDrag.mass.m --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "vehicleDrag.mass.m"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param vehicleDrag.mass.m=0
```
