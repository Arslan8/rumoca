# FINDING-01078: `zDiode.R` in `OvervoltageProtection`
...
| **Severity** | medium |
| **Declaration** | `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Analog/Semiconductors/ZDiode.mo:15` |
| **Signature** | `divisor:divisor-zero-unresolved:exp:327:21c08a00` |
...
path condition         ((zDiode.v > (zDiode.Maxexp * zDiode.Vt)))
...
| `path_condition` | ((zDiode.v &gt; (zDiode.Maxexp * zDiode.Vt))) |
| `verdict` | UNKNOWN |
| `proof` | the path depends on quantities the artifact does not determine: (zDiode.v &gt; (zDiode.Maxexp * zDiode.Vt)) |
...
```console
$ sed -n '15p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Analog/Semiconductors/ZDiode.mo"
```
...
```console
$ grep -rl '| `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Analog/Semiconductors/ZDiode.mo:15` |' docs/v2/bugs/
```
