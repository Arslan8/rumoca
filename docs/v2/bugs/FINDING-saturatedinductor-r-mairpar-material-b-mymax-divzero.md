# FINDING-04192: `r_mAirPar.material.B_myMax` in `SaturatedInductor`
...
| **Reached as** | `r_mAirPar.material.B_myMax` |
...
| **Signature** | `divisor:divisor-reachable-zero:exp:318:2b152be3` |
...
```
denominator            r_mAirPar.material.B_myMax
witness                r_mAirPar.material.B_myMax = 0
  found by             set to zero
denominator at witness 0.0
at declared values     1.0
path condition         always evaluated
constraints consulted  r_mAirPar.material.B_myMax: unbounded
```
...
| `constraints` | r_mAirPar.material.B_myMax: unbounded |
...
$ python3 tools/sweep/check_one.py Modelica.Magnetic.FluxTubes.Examples.BasicExamples.SaturatedInductor \
      --target r_mAirPar.material.B_myMax --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "r_mAirPar.material.B_myMax"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check \
      --param r_mAirPar.material.B_myMax=0
```
