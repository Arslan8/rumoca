# DECL-0411: `d` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Magnetic/FluxTubes/BaseClasses/GenericHysteresis.mo:11` |
| **Parameter** | `d` |
| **Type** | `SI.Length` |
| **Declared modifiers** | `—` |
...
```console
$ sed -n '11p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/FluxTubes/BaseClasses/GenericHysteresis.mo"
```
...
```modelica
// Magnetic/FluxTubes/BaseClasses/GenericHysteresis.mo:11
