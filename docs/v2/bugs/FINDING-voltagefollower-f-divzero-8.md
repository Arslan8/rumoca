# FINDING-01073: `f` in `VoltageFollower`
...
| **Severity** | high |
| **Declaration** | `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Analog/Examples/OpAmps/VoltageFollower.mo:23` |
| **Signature** | `divisor:divisor-reachable-zero:exp:108:c0533f7a` |
...
```console
$ sed -n '23p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Analog/Examples/OpAmps/VoltageFollower.mo"
```
...
```console
$ grep -rl '| `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Analog/Examples/OpAmps/VoltageFollower.mo:23` |' docs/v2/bugs/
```
