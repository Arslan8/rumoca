# FINDING-01259: `Tr.Phic` in `Transistor`
...
| **Signature** | `divisor:divisor-reachable-zero:exp:433:28119e19` |
...
constraints consulted  Tr.Phic: unbounded
```
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.Utilities.Transistor \
      --target Tr.Phic --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "Tr.Phic"
```
