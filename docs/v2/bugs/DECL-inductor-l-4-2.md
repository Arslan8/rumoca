...
| **Declaration** | `Electrical/Polyphase/Basic/Inductor.mo:4` |
| **Parameter** | `L` |
| **Type** | `SI.Inductance` |
...
```console
$ grep -n -- "-1e40\|-1E40" "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Polyphase/Basic/Inductor.mo" | head
```
...
```modelica
// Electrical/Polyphase/Basic/Inductor.mo:4
