# FINDING-01080: `zDiode.R` in `OvervoltageProtection`
...
| **Signature** | `divisor:divisor-zero-unresolved:exp:360:dcc27be4` |
...
constraints consulted  zDiode.R: unbounded
```
...
| `constraints` | zDiode.R: unbounded |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.OvervoltageProtection \
      --target zDiode.R --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "zDiode.R"
```
