# DECL-0580: `L` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Mechanics/Translational/Interfaces/PartialRigid.mo:6` |
| **Parameter** | `L` |
| **Type** | `SI.Length` |
...
```console
$ sed -n '6p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Mechanics/Translational/Interfaces/PartialRigid.mo"
```
...
```console
$ grep -n -- "-1e40\|-1E40" "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Mechanics/Translational/Interfaces/PartialRigid.mo" | head
```
...
```modelica
// Mechanics/Translational/Interfaces/PartialRigid.mo:6
