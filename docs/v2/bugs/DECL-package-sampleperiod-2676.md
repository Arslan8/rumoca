# DECL-0586: `samplePeriod` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Blocks/package.mo:2676` |
...
```console
$ sed -n '2676p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Blocks/package.mo"
```
