# FINDING-00692: `tLine.Z0` in `SmoothStep`
...
| **Signature** | `physical:physical-domain-unenforced:var:2576:c0cf0897` |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.Lines.SmoothStep \
      --target tLine.Z0 --sanitizer physical
```
