...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:64:f0bfd734` |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.ControlledSwitchWithArc \
      --target inductor2.L --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "inductor2.L"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param inductor2.L=0
```
