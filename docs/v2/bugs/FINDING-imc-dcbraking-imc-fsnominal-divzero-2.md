# FINDING-01745: `imc.fsNominal` in `IMC_DCBraking`
...
| **Signature** | `divisor:divisor-reachable-zero:exp:1253:f00b7352` |
...
| `constraints` | imc.fsNominal: unbounded |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.InductionMachines.IMC_DCBraking \
      --target imc.fsNominal --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "imc.fsNominal"
```
