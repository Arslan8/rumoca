...
| **Signature** | `divisor:divisor-reachable-zero:exp:872:7f6bb6d6` |
...
| `constraints` | firstOrder6.T: unbounded |
...
$ python3 tools/sweep/check_one.py ModelicaTest.Blocks.LimitersHomotopy \
      --target firstOrder6.T --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "firstOrder6.T"
```
