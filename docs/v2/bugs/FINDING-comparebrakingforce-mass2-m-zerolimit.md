# FINDING-04687: `mass2.m` in `CompareBrakingForce`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:30:961a01da` |
...
$ python3 tools/sweep/check_one.py Modelica.Mechanics.Translational.Examples.CompareBrakingForce \
      --target mass2.m --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "mass2.m"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param mass2.m=0
```
