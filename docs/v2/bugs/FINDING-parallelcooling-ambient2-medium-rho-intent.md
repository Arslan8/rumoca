# FINDING-04857: `ambient2.medium.rho` in `ParallelCooling`
...
```console
$ python3 tools/sweep/check_one.py Modelica.Thermal.FluidHeatFlow.Examples.ParallelCooling \
...
```console
$ python3 tools/sweep/check_one.py Modelica.Thermal.FluidHeatFlow.Examples.ParallelCooling --keep-artifact /tmp/m.rbc \
