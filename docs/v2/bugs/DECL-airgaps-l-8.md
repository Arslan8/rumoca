# DECL-0127: `L` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Electrical/Machines/BasicMachines/Components/AirGapS.mo:8` |
| **Parameter** | `L` |
| **Type** | `SI.Inductance` |
| **Declared modifiers** | `—` |
...
```modelica
// Electrical/Machines/BasicMachines/Components/AirGapS.mo:8
