# FINDING-05039: `ambient2.medium.rho` in `TwoMass`
...
| **Signature** | `physical:physical-intent-question:var:235:f7ec1a53` |
...
```console
$ python3 tools/sweep/check_one.py Modelica.Thermal.FluidHeatFlow.Examples.TwoMass \
...
```console
$ python3 tools/sweep/check_one.py Modelica.Thermal.FluidHeatFlow.Examples.TwoMass --keep-artifact /tmp/m.rbc \
