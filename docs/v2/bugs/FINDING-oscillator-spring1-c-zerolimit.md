# FINDING-04727: `spring1.c` in `Oscillator`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:15:7c575d7e` |
...
```console
$ python3 tools/sweep/check_one.py Modelica.Mechanics.Translational.Examples.Oscillator \
...
```console
$ python3 tools/sweep/check_one.py Modelica.Mechanics.Translational.Examples.Oscillator --keep-artifact /tmp/m.rbc \
