...
| **Signature** | `divisor:divisor-unreachable-under-witness:exp:839:1714c925` |
...
```
denominator            (sqrt((simpleTriac.thyristor1.Ron * simpleTriac.thyristor1.Roff)) * ((simpleTriac.thyristor1.Ron / simpleTriac.thyristor1.Roff) ^ (((3 * ((((2 * simpleTriac.thyristor1.vControl) - simpleTriac.thyristor1.Von) - simpleTriac.thyristor1.Voff) / (2 * (simpleTriac.thyristor1.Von - simpleTriac.thyristor1.V
