# FINDING-03628: `rectifier.diode_n1.Ron` in `DiodeBridge2Pulse`
...
| **Reached as** | `rectifier.diode_n1.Ron` |
...
| **Signature** | `physical:physical-rule-does-not-apply:var:78:52a12a38` |
...
```
predicate     rectifier.diode_n1.Ron > 0
premise       refuted
...
| `required` | rectifier.diode_n1.Ron &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.PowerConverters.Examples.ACDC.RectifierBridge2Pulse.DiodeBridge2Pulse \
      --target rectifier.diode_n1.Ron --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "rectifier.diode_n1.Ron"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param rectifier.diode_n1.Ron=0
```
