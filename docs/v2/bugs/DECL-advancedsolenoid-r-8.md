# DECL-0828: `R` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Magnetic/FluxTubes/Examples/SolenoidActuator/Components/AdvancedSolenoid.mo:8` |
| **Parameter** | `R` |
| **Type** | `SI.Resistance` |
| **Declared modifiers** | `—` |
...
```modelica
// Magnetic/FluxTubes/Examples/SolenoidActuator/Components/AdvancedSolenoid.mo:8
