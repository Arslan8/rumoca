# DECL-0156: `Ld` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Electrical/Machines/Utilities/DQCurrentController.mo:12` |
| **Parameter** | `Ld` |
| **Type** | `SI.Inductance` |
| **Declared modifiers** | `—` |
...
```modelica
// Electrical/Machines/Utilities/DQCurrentController.mo:12
