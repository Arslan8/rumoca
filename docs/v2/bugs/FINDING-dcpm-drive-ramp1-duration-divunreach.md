# FINDING-01516: `ramp1.duration` in `DCPM_Drive`
...
| **Signature** | `divisor:divisor-unreachable-under-witness:exp:3093:3b937edc` |
...
| `denominator_at_declared_values` | 0.5 |
| `denominator_range` | [0, inf] |
| `path_condition` | not ((time &lt; ramp1.startTime)) and ((time &lt; (ramp1.startTime + ramp1.duration))) |
| `verdict` | UNSAT |
| `proof` | the path conditions cannot hold together: time must be both &gt; 0.25 and &lt; 0.25 |
