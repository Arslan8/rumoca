...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:67:b8c89f2e` |
...
$ python3 tools/sweep/check_one.py Modelica.Mechanics.Translational.Examples.WhyArrows \
      --target inertia2.m --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "inertia2.m"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param inertia2.m=0
```
