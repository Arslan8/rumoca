# DECL-0418: `d` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Magnetic/FluxTubes/Examples/BasicExamples/ToroidalCoreAirgap.mo:6` |
| **Parameter** | `d` |
| **Type** | `SI.Length` |
| **Declared modifiers** | `—` |
...
```console
$ sed -n '6p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/FluxTubes/Examples/BasicExamples/ToroidalCoreAirgap.mo"
```
...
```modelica
// Magnetic/FluxTubes/Examples/BasicExamples/ToroidalCoreAirgap.mo:6
