# FINDING-02809: `smpm.fsNominal` in `SMPM_ResistiveBraking`
...
| **Signature** | `divisor:divisor-reachable-zero:exp:1060:297d3f91` |
...
| `constraints` | smpm.fsNominal: unbounded |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.SynchronousMachines.SMPM_ResistiveBraking \
      --target smpm.fsNominal --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "smpm.fsNominal"
```
