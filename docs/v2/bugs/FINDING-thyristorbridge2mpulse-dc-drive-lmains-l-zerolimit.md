# FINDING-03484: `lMains.L` in `ThyristorBridge2mPulse_DC_Drive`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:1089:fbeeff7f` |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.PowerConverters.Examples.ACDC.RectifierBridge2mPulse.ThyristorBridge2mPulse_DC_Drive \
      --target lMains.L --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "lMains.L"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param lMains.L=0
```
