# FINDING-01362: `dcee.La` in `DCEE_Start`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:15:a77683cd` |
...
```
{'quantity': 'Inductance', 'unit': 'H', 'confidence': 'QUANTITY_AND_UNIT', 'premise_state': 'unknown', 'authority': 'quantity_or_unit', 'canonical_declaration': 'Modelica.Electrical.Machines.BasicMachines.DCMachines.DC_ElectricalExcited.La'}
```
