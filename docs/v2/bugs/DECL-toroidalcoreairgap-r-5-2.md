# DECL-0490: `r` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Magnetic/QuasiStatic/FluxTubes/Examples/BasicExamples/ToroidalCoreAirgap.mo:5` |
| **Parameter** | `r` |
| **Type** | `SI.Length` |
| **Declared modifiers** | `—` |
...
```console
$ sed -n '5p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/QuasiStatic/FluxTubes/Examples/BasicExamples/ToroidalCoreAirgap.mo"
```
...
```modelica
// Magnetic/QuasiStatic/FluxTubes/Examples/BasicExamples/ToroidalCoreAirgap.mo:5
