# DECL-0252: `Lm` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Magnetic/FundamentalWave/BasicMachines/InductionMachines/IM_SlipRing.mo:34` |
| **Parameter** | `Lm` |
| **Type** | `SI.Inductance` |
...
```console
$ sed -n '34p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/FundamentalWave/BasicMachines/InductionMachines/IM_SlipRing.mo"
```
...
```modelica
// Magnetic/FundamentalWave/BasicMachines/InductionMachines/IM_SlipRing.mo:34
