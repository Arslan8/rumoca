# FINDING-02274: `aims.lszero.L` in `IMS_Start`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:154:3f233735` |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.InductionMachines.IMS_Start \
      --target aims.lszero.L --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "aims.lszero.L"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param aims.lszero.L=0
```
