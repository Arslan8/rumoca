...
| **Declaration** | `Electrical/Machines/Utilities/SynchronousMachineData.mo:107` |
| **Parameter** | `Lrsigmad` |
| **Type** | `SI.Inductance` |
| **Declared modifiers** | `—` |
...
```console
$ grep -n -- "-1e40\|-1E40" "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Machines/Utilities/SynchronousMachineData.mo" | head
```
...
```modelica
// Electrical/Machines/Utilities/SynchronousMachineData.mo:107
