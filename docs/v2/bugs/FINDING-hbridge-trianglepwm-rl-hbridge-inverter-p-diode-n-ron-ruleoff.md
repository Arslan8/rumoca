# FINDING-04150: `hbridge.inverter_p.diode_n.Ron` in `HBridge_TrianglePWM_RL`
...
| **Reached as** | `hbridge.inverter_p.diode_n.Ron` |
...
| **Signature** | `physical:physical-rule-does-not-apply:var:140:0c264d92` |
...
```
predicate     hbridge.inverter_p.diode_n.Ron > 0
premise       refuted
...
| `required` | hbridge.inverter_p.diode_n.Ron &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.PowerConverters.Examples.DCDC.HBridge.HBridge_TrianglePWM_RL \
      --target hbridge.inverter_p.diode_n.Ron --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "hbridge.inverter_p.diode_n.Ron"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param hbridge.inverter_p.diode_n.Ron=0
```
