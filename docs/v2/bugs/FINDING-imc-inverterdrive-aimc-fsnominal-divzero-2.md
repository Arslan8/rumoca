# FINDING-01932: `aimc.fsNominal` in `IMC_InverterDrive`
...
| **Signature** | `divisor:divisor-reachable-zero:exp:3504:393ddadf` |
...
| `constraints` | aimc.fsNominal: unbounded |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.InductionMachines.IMC_InverterDrive \
      --target aimc.fsNominal --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "aimc.fsNominal"
```
