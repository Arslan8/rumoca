# DECL-0286: `JLoad` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Blocks/package.mo:2727` |
| **Parameter** | `JLoad` |
| **Type** | `SI.Inertia` |
| **Declared modifiers** | `—` |
...
```console
$ sed -n '2727p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Blocks/package.mo"
```
