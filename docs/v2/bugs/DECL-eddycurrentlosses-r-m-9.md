# DECL-0592: `R_m` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Magnetic/FundamentalWave/Examples/Components/EddyCurrentLosses.mo:9` |
| **Parameter** | `R_m` |
| **Type** | `SI.Reluctance` |
| **Declared modifiers** | `—` |
...
```console
$ sed -n '9p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/FundamentalWave/Examples/Components/EddyCurrentLosses.mo"
```
...
```modelica
// Magnetic/FundamentalWave/Examples/Components/EddyCurrentLosses.mo:9
