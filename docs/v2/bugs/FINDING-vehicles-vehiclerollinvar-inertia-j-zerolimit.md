...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:647:aabe6478` |
...
```
predicate     vehicleRollInVar.inertia.J > 0
premise       refuted
...
| `required` | vehicleRollInVar.inertia.J &gt; 0 |
| `declared_min` | 0.0 |
...
$ python3 tools/sweep/check_one.py ModelicaTest.Translational.Vehicles \
      --target vehicleRollInVar.inertia.J --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "vehicleRollInVar.inertia.J"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param vehicleRollInVar.inertia.J=0
```
