# DECL-0369: `L` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Blocks/package.mo:2364` |
| **Parameter** | `L` |
| **Type** | `SI.Length` |
| **Declared modifiers** | `—` |
...
```console
$ sed -n '2364p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Blocks/package.mo"
```
