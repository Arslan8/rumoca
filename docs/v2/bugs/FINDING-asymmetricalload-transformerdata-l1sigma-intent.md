# FINDING-02990: `transformerData.L1sigma` in `AsymmetricalLoad`
...
| **Signature** | `physical:physical-intent-question:var:137:6f9051c1` |
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.Transformers.AsymmetricalLoad \
...
```console
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.Transformers.AsymmetricalLoad --keep-artifact /tmp/m.rbc \
