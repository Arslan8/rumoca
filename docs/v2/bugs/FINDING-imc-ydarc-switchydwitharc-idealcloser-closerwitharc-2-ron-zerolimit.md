# FINDING-02159: `switchYDwithArc.idealCloser.closerWithArc[2].Ron` in `IMC_YDarc`
...
| **Reached as** | `switchYDwithArc.idealCloser.closerWithArc[2].Ron` |
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:742:87390985` |
...
```
predicate     switchYDwithArc.idealCloser.closerWithArc[2].Ron > 0
premise       refuted
...
| `required` | switchYDwithArc.idealCloser.closerWithArc[2].Ron &gt; 0 |
| `declared_min` | None |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Machines.Examples.InductionMachines.IMC_YDarc \
      --target switchYDwithArc.idealCloser.closerWithArc[2].Ron --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "switchYDwithArc.idealCloser.closerWithArc[2].Ron"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param switchYDwithArc.idealCloser.closerWithArc[2].Ron=0
```
