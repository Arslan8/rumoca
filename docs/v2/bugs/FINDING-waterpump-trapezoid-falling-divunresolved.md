...
| **Signature** | `divisor:divisor-zero-unresolved:exp:584:b67d6733` |
...
```
denominator            trapezoid.falling
witness                trapezoid.falling = 0
  found by             set to zero
denominator at witness 0.0
at declared values     0.6
path condition         not ((((time < trapezoid.startTime) or (trapezoid.nperiod == 0)) or ((trapezoid.nperiod > 0) and (trapezoid.count >= trapezoid.nperiod)))) and not ((time < (trapezoid.T_start + trapezoid.T_rising))) and not ((time < (trapezoid.T_start + trapezoid.T_width))) and ((time < (trapezoid.T_start + trapezoid.T_falling)))
constraints consulted  trapezoid.falling: min=0
```
...
| `denominator_at_declared_values` | 0.6 |
| `denominator_range` | [0, inf] |
| `path_condition` | not ((((time &lt; trapezoid.startTime) or (trapezoid.nperiod == 0)) or ((trapezoid.nperiod &gt; 0) and (trapezoid.count &gt;= trapezoid.nperiod)))) and not ((time &lt; (trapezoid.T_start + trapezoid.T_rising))) and not ((time &lt; (trapezoid.T_start + trapezoid.T_width))) and ((time &lt; (trapezoid.T_start + trapezoid.T_falling))) |
| `verdict` | UNKNOWN |
| `proof` | the path depends on quantities the artifact does not determine: (time &lt; (trapezoid.T_start + trapezoid.T_falling)); (time &lt; (trapezoid.T_start + trapezoid.T_rising)); (time &lt; (trapezoid.T_start + trapezoid.T_width)) |
| `constraints` | trapezoid.falling: min=0 |
...
$ python3 tools/sweep/check_one.py Modelica.Thermal.FluidHeatFlow.Examples.WaterPump \
      --target trapezoid.falling --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "trapezoid.falling"
```
