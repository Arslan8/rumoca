# FINDING-01170: `simpleTriac.thyristor1.Roff` in `SimpleTriacCircuit`
...
| **Signature** | `divisor:divisor-zero-unresolved:exp:773:5def4e68` |
...
path condition         ((simpleTriac.thyristor1.vAK < -simpleTriac.thyristor1.VRRM))
...
| `path_condition` | ((simpleTriac.thyristor1.vAK &lt; -simpleTriac.thyristor1.VRRM)) |
| `verdict` | UNKNOWN |
