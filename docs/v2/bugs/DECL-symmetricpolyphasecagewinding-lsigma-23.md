# DECL-0249: `Lsigma` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Magnetic/FundamentalWave/BasicMachines/Components/SymmetricPolyphaseCageWinding.mo:23` |
| **Parameter** | `Lsigma` |
| **Type** | `SI.Inductance` |
| **Declared modifiers** | `—` |
...
```console
$ sed -n '23p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/FundamentalWave/BasicMachines/Components/SymmetricPolyphaseCageWinding.mo"
```
...
```console
$ grep -n -- "-1e40\|-1E40" "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/FundamentalWave/BasicMachines/Components/SymmetricPolyphaseCageWinding.mo" | head
```
...
```modelica
// Magnetic/FundamentalWave/BasicMachines/Components/SymmetricPolyphaseCageWinding.mo:23
