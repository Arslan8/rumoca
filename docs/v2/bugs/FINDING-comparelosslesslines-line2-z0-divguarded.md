# FINDING-00557: `line2.Z0` in `CompareLosslessLines`
...
| **Signature** | `divisor:divisor-guarded-by-assertion:exp:535:df57ab57` |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.Lines.CompareLosslessLines \
      --target line2.Z0 --sanitizer divisor
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "line2.Z0"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param line2.Z0=0
```
