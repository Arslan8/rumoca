# DECL-0516: `r1b` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Mechanics/MultiBody/Examples/Loops/PlanarLoops_analytic.mo:10` |
| **Parameter** | `r1b` |
| **Type** | `SI.Length` |
| **Declared modifiers** | `—` |
...
```console
$ sed -n '10p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Mechanics/MultiBody/Examples/Loops/PlanarLoops_analytic.mo"
```

It should declare `r1b` with type `SI.Length` and no `min`.
...
```modelica
// Mechanics/MultiBody/Examples/Loops/PlanarLoops_analytic.mo:10
parameter SI.Length r1b(min=0) = ...;
```
