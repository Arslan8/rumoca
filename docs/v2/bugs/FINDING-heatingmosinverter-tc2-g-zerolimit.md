# FINDING-00324: `TC2.G` in `HeatingMOSInverter`
...
| **Signature** | `physical:physical-zero-is-a-supported-limit:var:136:7601fe78` |
...
$ python3 tools/sweep/check_one.py Modelica.Electrical.Analog.Examples.HeatingMOSInverter \
      --target TC2.G --sanitizer physical
```
...
$ ./target/debug/rumoca bitcode disasm /tmp/m.rbc | grep -n "TC2.G"
```
...
$ ./target/debug/rumoca compile-bitcode /tmp/m.rbc --simulate --check --param TC2.G=0
```
