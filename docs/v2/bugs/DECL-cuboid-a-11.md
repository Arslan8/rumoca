# DECL-0467: `a` declared without a lower bound

|  |  |
|---|---|
| **Tier** | **Latent** — a permitted value, not an observed failure |
| **Declaration** | `Magnetic/FluxTubes/Shapes/FixedShape/Cuboid.mo:11` |
| **Parameter** | `a` |
| **Type** | `SI.Length` |
| **Declared modifiers** | `—` |
...
```console
$ sed -n '11p' "target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/FluxTubes/Shapes/FixedShape/Cuboid.mo"
```
...
```modelica
// Magnetic/FluxTubes/Shapes/FixedShape/Cuboid.mo:11
