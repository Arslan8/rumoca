...
| Original report | [FINDING-pi-opamp-vps-divequal.md](../../bugs/FINDING-pi-opamp-vps-divequal.md) |
| Original SHA-256 | `92b6813b7779c87ac9cfa08cf59bbd49b6beb14adef50c35bfceedbbf464934d` |
...
```modelica
model V2OMC_d81f6a9578790400
  extends Modelica.Electrical.Analog.Examples.OpAmps.OpAmpCircuits.PI(opAmp.Vps=-15);
end V2OMC_d81f6a9578790400;
```

Relevant OMC diagnostic:

```text
messages = "Failed to build model: V2OMC_d81f6a9578790400",
