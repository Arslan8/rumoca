...
| Original report | [FINDING-invertingamplifier-gain-opamp-vps-divequal.md](../../bugs/FINDING-invertingamplifier-gain-opamp-vps-divequal.md) |
| Original SHA-256 | `ff9d0281f1ba50c766a7d62340f100d81819a3df9562afbb68ffb4307ba68dbf` |
...
```modelica
model V2OMC_5e5e998a782c05f0
  extends Modelica.Electrical.Analog.Examples.OpAmps.InvertingAmplifier(gain.opAmp.Vps=-15);
end V2OMC_5e5e998a782c05f0;
```

Relevant OMC diagnostic:

```text
messages = "Failed to build model: V2OMC_5e5e998a782c05f0",
