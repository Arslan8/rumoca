...
| Original report | [FINDING-lowpass-firstorder-opamp-vps-divequal.md](../../bugs/FINDING-lowpass-firstorder-opamp-vps-divequal.md) |
| Original SHA-256 | `59c951707f3068be5edd3d425bbc0f7344d4d9b1d5e7f04ddb53acb56d4648e8` |
...
```modelica
model V2OMC_a55673361e2f87da
  extends Modelica.Electrical.Analog.Examples.OpAmps.LowPass(firstOrder.opAmp.Vps=-15);
end V2OMC_a55673361e2f87da;
```

Relevant OMC diagnostic:

```text
messages = "Failed to build model: V2OMC_a55673361e2f87da",
