...
| Original report | [FINDING-buffer-opamp-vps-divequal.md](../../bugs/FINDING-buffer-opamp-vps-divequal.md) |
| Original SHA-256 | `10724bec518a0d30704e892f4fe8f50a110febfc97778a1c4879c7db6550ee23` |
...
```modelica
model V2OMC_7ee45177f042a6dc
  extends Modelica.Electrical.Analog.Examples.OpAmps.OpAmpCircuits.Buffer(opAmp.Vps=-15);
end V2OMC_7ee45177f042a6dc;
```

Relevant OMC diagnostic:

```text
messages = "Failed to build model: V2OMC_7ee45177f042a6dc",
