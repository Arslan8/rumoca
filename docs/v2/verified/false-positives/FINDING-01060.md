...
| Original report | [FINDING-subtracter-feedback-opamp-vps-divequal.md](../../bugs/FINDING-subtracter-feedback-opamp-vps-divequal.md) |
| Original SHA-256 | `c96ac1626831c0b7e4937e8aa4a7fef312deabaf14a85e3e072f54cb16ec8945` |
...
```modelica
model V2OMC_45e6761088c543d7
  extends Modelica.Electrical.Analog.Examples.OpAmps.Subtracter(feedback.opAmp.Vps=-15);
end V2OMC_45e6761088c543d7;
```

Relevant OMC diagnostic:

```text
messages = "Failed to build model: V2OMC_45e6761088c543d7",
