...
| Original report | [FINDING-controlcircuit-firstorder2a-opamp-vps-divequal.md](../../bugs/FINDING-controlcircuit-firstorder2a-opamp-vps-divequal.md) |
| Original SHA-256 | `43bef324b3e5a4cab7edb60b0e85f4885eaffd9ffbaa25ca303f3bf2816ce695` |
...
```modelica
model V2OMC_45fc6493a51f816d
  extends Modelica.Electrical.Analog.Examples.OpAmps.ControlCircuit(firstOrder2A.opAmp.Vps=-15);
end V2OMC_45fc6493a51f816d;
```

Relevant OMC diagnostic:

```text
messages = "Failed to build model: V2OMC_45fc6493a51f816d",
