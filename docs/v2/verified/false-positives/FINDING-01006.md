...
| Original report | [FINDING-firstorder-opamp-vps-divequal.md](../../bugs/FINDING-firstorder-opamp-vps-divequal.md) |
| Original SHA-256 | `41d145deb756cccb2fd02af80e595388cd59c05ce1186c213c5a46d2eee19a15` |
...
```modelica
model V2OMC_0c03f342b83ce563
  extends Modelica.Electrical.Analog.Examples.OpAmps.OpAmpCircuits.FirstOrder(opAmp.Vps=-15);
end V2OMC_0c03f342b83ce563;
```

Relevant OMC diagnostic:

```text
messages = "Failed to build model: V2OMC_0c03f342b83ce563",
