...
| Original report | [FINDING-permeanceactuator-g-mb-r-i-divzero-2.md](../../bugs/FINDING-permeanceactuator-g-mb-r-i-divzero-2.md) |
| Original SHA-256 | `c1d5017086c7beae3fc8f7b20f9f608be386f1c67db4eaa279e691f2cf6ae0a6` |
...
```modelica
model V2OMC_53bbed7e43da7685
  extends Modelica.Magnetic.FluxTubes.Examples.MovingCoilActuator.Components.PermeanceActuator(g_mb.r_i=0);
end V2OMC_53bbed7e43da7685;
```

Relevant OMC diagnostic:

```text
messages = "Failed to build model: V2OMC_53bbed7e43da7685",
