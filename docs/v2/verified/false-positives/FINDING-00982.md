...
| Original report | [FINDING-add-opamp-vps-divequal.md](../../bugs/FINDING-add-opamp-vps-divequal.md) |
| Original SHA-256 | `acc3d57780e5af4d074659a23f7f3998d983b60496f8478ce173358b9d45a686` |
...
```modelica
model V2OMC_8e95bc620716bbf0
  extends Modelica.Electrical.Analog.Examples.OpAmps.OpAmpCircuits.Add(opAmp.Vps=-15);
end V2OMC_8e95bc620716bbf0;
```

Relevant OMC diagnostic:

```text
messages = "Failed to build model: V2OMC_8e95bc620716bbf0",
