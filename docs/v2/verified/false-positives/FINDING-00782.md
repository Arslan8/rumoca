...
| Original report | [FINDING-adder-add-opamp-vps-divequal.md](../../bugs/FINDING-adder-add-opamp-vps-divequal.md) |
| Original SHA-256 | `ca7445b716bf3e7f273d5e4ebd5c94c217bbf919d371dafe93a2dca950ce8a63` |
...
```modelica
model V2OMC_941f61dcd61b1307
  extends Modelica.Electrical.Analog.Examples.OpAmps.Adder(add.opAmp.Vps=-15);
end V2OMC_941f61dcd61b1307;
```

Relevant OMC diagnostic:

```text
messages = "Failed to build model: V2OMC_941f61dcd61b1307",
