...
| Original report | [FINDING-highpass-derivative-opamp-vps-divequal.md](../../bugs/FINDING-highpass-derivative-opamp-vps-divequal.md) |
| Original SHA-256 | `e907706f400943b18ba698fd5ccaa202520424babc9348130020d9cb5c01d089` |
...
```modelica
model V2OMC_15382fd9f5b215a6
  extends Modelica.Electrical.Analog.Examples.OpAmps.HighPass(derivative.opAmp.Vps=-15);
end V2OMC_15382fd9f5b215a6;
```

Relevant OMC diagnostic:

```text
messages = "Failed to build model: V2OMC_15382fd9f5b215a6",
