...
| Original report | [FINDING-noninvertingamplifier-buffer-opamp-vps-divequal.md](../../bugs/FINDING-noninvertingamplifier-buffer-opamp-vps-divequal.md) |
| Original SHA-256 | `cd5ca5ec13def6242b160fe982a4874de13487a9c39e5ba483496e1150653329` |
...
```modelica
model V2OMC_aef744cbbb4647b8
  extends Modelica.Electrical.Analog.Examples.OpAmps.NonInvertingAmplifier(buffer.opAmp.Vps=-15);
end V2OMC_aef744cbbb4647b8;
```

Relevant OMC diagnostic:

```text
messages = "Failed to build model: V2OMC_aef744cbbb4647b8",
