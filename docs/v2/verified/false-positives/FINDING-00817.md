...
| Original report | [FINDING-controlcircuit-firstorder1a-opamp-vps-divequal.md](../../bugs/FINDING-controlcircuit-firstorder1a-opamp-vps-divequal.md) |
| Original SHA-256 | `e2d9eca089eca327072512a622ffe2d572650f407d323066c45b65e95526b7c1` |
...
```modelica
model V2OMC_dc2dde248f079f74
  extends Modelica.Electrical.Analog.Examples.OpAmps.ControlCircuit(firstOrder1A.opAmp.Vps=-15);
end V2OMC_dc2dde248f079f74;
```

Relevant OMC diagnostic:

```text
messages = "Failed to build model: V2OMC_dc2dde248f079f74",
