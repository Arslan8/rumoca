...
| Original report | [FINDING-der-opamp-vps-divequal.md](../../bugs/FINDING-der-opamp-vps-divequal.md) |
| Original SHA-256 | `b9c39401a89828fb71454a75f3ffaaea58eaafff99ed7d8cb5d7c183edbdbceb` |
...
```modelica
model V2OMC_e2d8579638fb8c61
  extends Modelica.Electrical.Analog.Examples.OpAmps.OpAmpCircuits.Der(opAmp.Vps=-15);
end V2OMC_e2d8579638fb8c61;
```

Relevant OMC diagnostic:

```text
messages = "Failed to build model: V2OMC_e2d8579638fb8c61",
