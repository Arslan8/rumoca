...
| Original report | [FINDING-feedback-opamp-vps-divequal.md](../../bugs/FINDING-feedback-opamp-vps-divequal.md) |
| Original SHA-256 | `568546d7e52a4482124199b27459d3b0287a4644a3df4e4a949f3a0dd6a5e413` |
...
```modelica
model V2OMC_5c80d9944d10f10a
  extends Modelica.Electrical.Analog.Examples.OpAmps.OpAmpCircuits.Feedback(opAmp.Vps=-15);
end V2OMC_5c80d9944d10f10a;
```

Relevant OMC diagnostic:

```text
messages = "Failed to build model: V2OMC_5c80d9944d10f10a",
