...
| Original report | [BUG-damper-mass1-m.md](../../bugs/BUG-damper-mass1-m.md) |
| Original SHA-256 | `7d1771baa9d2693aaf3e497c54648f35c50c2d1178f5d885b95e8dd2942c054a` |
...
`Modelica.Mechanics.Translational.Examples.Damper` runs cleanly at its declared values. Setting `mass1.m = 0` — a value the declaration permits — makes it fail, in Rumoca and in OpenModelica. The defect is in the **declaration**, not in this model. This model is the witness.

## Earlier independent review

[Prior report](../../../verifiedBugs/false-positives/BUG-001.md)
