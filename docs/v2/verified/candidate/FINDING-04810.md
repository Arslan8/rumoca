...
| Original report | [FINDING-onemass-medium-rho-bound.md](../../bugs/FINDING-onemass-medium-rho-bound.md) |
| Original SHA-256 | `c51731593dc0e145b70db10e70057d2a81b76a546185da04dc3950fa2cb8d9f4` |
...
```modelica
model V2OMC_55a21f16b37dd25f
  extends Modelica.Thermal.FluidHeatFlow.Examples.OneMass(medium.rho=0);
end V2OMC_55a21f16b37dd25f;
```
...
[Prior report](../../../verifiedBugs/confirmed/FINDING-04530.md)
