...
| Target | `cooling.medium.rho` |
| Declaration/site | `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Thermal/FluidHeatFlow/Media/Medium.mo:4` |
| Original report | [FINDING-dcpm-cooling-cooling-medium-rho-bound.md](../../bugs/FINDING-dcpm-cooling-cooling-medium-rho-bound.md) |
| Original SHA-256 | `d467267b082e493166ae18b2ab318a6716f0486ad73986d6047c90b27f0501a4` |
...
```modelica
model V2OMC_6e1a7819bf56cc11
  extends Modelica.Electrical.Machines.Examples.DCMachines.DCPM_Cooling(cooling.medium.rho=0);
end V2OMC_6e1a7819bf56cc11;
```
...
[Prior report](../../../verifiedBugs/confirmed/FINDING-01246.md)
