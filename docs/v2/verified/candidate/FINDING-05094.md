...
| Original report | [FINDING-waterpump-volumeflowsensor-medium-rho-bound.md](../../bugs/FINDING-waterpump-volumeflowsensor-medium-rho-bound.md) |
| Original SHA-256 | `58a7de44a87decaf2f7b844c15eebd6dbc4d303852d401a2dd944230ca2dc6ea` |
...
```modelica
model V2OMC_7d64a29eb0399105
  extends Modelica.Thermal.FluidHeatFlow.Examples.WaterPump(volumeFlowSensor.medium.rho=0);
end V2OMC_7d64a29eb0399105;
```
...
[Prior report](../../../verifiedBugs/confirmed/FINDING-04718.md)
