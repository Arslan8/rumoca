...
| Original report | [FINDING-waterpump-pipe-medium-rho-bound.md](../../bugs/FINDING-waterpump-pipe-medium-rho-bound.md) |
| Original SHA-256 | `d2e946e9d82b591fdde65dc4cc6f461db541158167992656bf4a5a7670f30a65` |
...
```modelica
model V2OMC_469141f0ba7388ff
  extends Modelica.Thermal.FluidHeatFlow.Examples.WaterPump(pipe.medium.rho=0);
end V2OMC_469141f0ba7388ff;
```
...
[Prior report](../../../verifiedBugs/confirmed/FINDING-04728.md)
