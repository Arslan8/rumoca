...
| Original report | [FINDING-pumpandvalve-medium-rho-bound.md](../../bugs/FINDING-pumpandvalve-medium-rho-bound.md) |
| Original SHA-256 | `677ddb4a4eca139fd2873e50a67f82459848667ccc6b238aac1d8a4297e21ae6` |
...
```modelica
model V2OMC_69659ed463ef8615
  extends Modelica.Thermal.FluidHeatFlow.Examples.PumpAndValve(medium.rho=0);
end V2OMC_69659ed463ef8615;
```
...
[Prior report](../../../verifiedBugs/confirmed/FINDING-04604.md)
