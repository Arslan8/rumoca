...
| Original report | [FINDING-twotanks-pipe-medium-rho-bound.md](../../bugs/FINDING-twotanks-pipe-medium-rho-bound.md) |
| Original SHA-256 | `a2383961e78c593d5874afbd77d8a0a1322253e97cba9fb150148f7ffd21e7b6` |
...
```modelica
model V2OMC_4a5a7b6550c65559
  extends Modelica.Thermal.FluidHeatFlow.Examples.TwoTanks(pipe.medium.rho=0);
end V2OMC_4a5a7b6550c65559;
```
...
[Prior report](../../../verifiedBugs/confirmed/FINDING-04701.md)
