...
| Target | `volumeFlow.medium.rho` |
| Declaration/site | `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Thermal/FluidHeatFlow/Media/Medium.mo:4` |
| Original report | [FINDING-dcpm-cooling-volumeflow-medium-rho-bound.md](../../bugs/FINDING-dcpm-cooling-volumeflow-medium-rho-bound.md) |
| Original SHA-256 | `ddf8df149a6dfe63b8f940690f7700ff052dbc400b9e35a743016a1632873b2a` |
...
```modelica
model V2OMC_4589f03833005ff3
  extends Modelica.Electrical.Machines.Examples.DCMachines.DCPM_Cooling(volumeFlow.medium.rho=0);
end V2OMC_4589f03833005ff3;
```
...
[Prior report](../../../verifiedBugs/confirmed/FINDING-01242.md)
