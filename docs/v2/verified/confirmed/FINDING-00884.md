...
| Original report | [FINDING-integrator-integrator-f-divzero-2.md](../../bugs/FINDING-integrator-integrator-f-divzero-2.md) |
| Original SHA-256 | `2e6c33f06be6491b2fc51782f44131bf58ee14638e9fdea150bd759b05ba7e1c` |
...
```modelica
model V2OMC_16c90b09789b4a28
  extends Modelica.Electrical.Analog.Examples.OpAmps.Integrator(integrator.f=0);
end V2OMC_16c90b09789b4a28;
```

Relevant OMC diagnostic:

```text
messages = "Simulation execution failed for model: V2OMC_16c90b09789b4a28
