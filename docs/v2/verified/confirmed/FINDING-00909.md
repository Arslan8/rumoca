# FINDING-00909: `opAmp.Vps` in `InvertingSchmittTrigger`
...
| Original report | [FINDING-invertingschmitttrigger-opamp-vps-divequal.md](../../bugs/FINDING-invertingschmitttrigger-opamp-vps-divequal.md) |
| Original SHA-256 | `323497569600b3d3de4df731a8bd9bd3866fc1093ec1208e774f16105cf21bdc` |
...
```modelica
model V2OMC_6358c9f580d02452
  extends Modelica.Electrical.Analog.Examples.OpAmps.InvertingSchmittTrigger(opAmp.Vps=-15);
end V2OMC_6358c9f580d02452;
```

Relevant OMC diagnostic:

```text
messages = "Simulation execution failed for model: V2OMC_6358c9f580d02452
LOG_ASSERT        | debug   | division by zero at time 0, (a=0.015) / (b=0), where divisor b expression is: opAmp.Vps - opAmp.Vns
