...
| Original report | [FINDING-chopperstepdown-r-iload-divzero-2.md](../../bugs/FINDING-chopperstepdown-r-iload-divzero-2.md) |
| Original SHA-256 | `e6c37749331d613f693c8c5a60ed892234bd48f128951ecfa7e5a7f72b9c1fd1` |
...
```modelica
model V2OMC_81c6fec3a9fedf82
  extends Modelica.Electrical.PowerConverters.Examples.DCDC.ChopperStepDown.ChopperStepDown_R(ILoad=0);
end V2OMC_81c6fec3a9fedf82;
```

Relevant OMC diagnostic:

```text
messages = "Simulation execution failed for model: V2OMC_81c6fec3a9fedf82
