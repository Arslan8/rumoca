# FINDING-01052: `opAmp2.Vps` in `SignalGenerator`
...
| Original report | [FINDING-signalgenerator-opamp2-vps-divequal.md](../../bugs/FINDING-signalgenerator-opamp2-vps-divequal.md) |
| Original SHA-256 | `71fff3e0028c582a2c7b4ce9742cb9e31e63f5ef13fe4e961300e2ffa11cd256` |
...
```modelica
model V2OMC_df88dcb7263aa8d6
  extends Modelica.Electrical.Analog.Examples.OpAmps.SignalGenerator(opAmp2.Vps=-15);
end V2OMC_df88dcb7263aa8d6;
```

Relevant OMC diagnostic:

```text
messages = "Simulation execution failed for model: V2OMC_df88dcb7263aa8d6
LOG_SUCCESS       | info    | The initialization finished successfully with 3 homotopy steps.
LOG_ASSERT        | debug   | division by zero at time 0.01, (a=0) / (b=0), where divisor b expression is: opAmp2.Vps - opAmp2.Vns
LOG_ASSERT        | debug   | division by zero at time 0, (a=0) / (b=0), where divisor b expression is: opAmp2.Vps - opAmp2.Vns
```
