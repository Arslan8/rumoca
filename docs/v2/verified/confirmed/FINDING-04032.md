...
| Original report | [FINDING-chopperstepdown-rl-signalpwm-f-divzero-2.md](../../bugs/FINDING-chopperstepdown-rl-signalpwm-f-divzero-2.md) |
| Original SHA-256 | `16319a06e3887c093dbd536afd59d5abe863b043141d44db58b16e7d8c5c4bb7` |
...
```modelica
model V2OMC_d6c1d0555cf67883
  extends Modelica.Electrical.PowerConverters.Examples.DCDC.ChopperStepDown.ChopperStepDown_RL(signalPWM.f=0);
end V2OMC_d6c1d0555cf67883;
```

Relevant OMC diagnostic:

```text
messages = "Simulation execution failed for model: V2OMC_d6c1d0555cf67883
