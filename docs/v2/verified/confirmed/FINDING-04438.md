...
| Original report | [FINDING-heatlosses-world-defaultwidthfraction-divzero-7.md](../../bugs/FINDING-heatlosses-world-defaultwidthfraction-divzero-7.md) |
| Original SHA-256 | `7df1d59cc56b7028d7552f1c688f8387d9e0ed6a8d855d9f05f4bd40e91b5f11` |
...
```modelica
model V2OMC_47ca7477cfed2104
  extends Modelica.Mechanics.MultiBody.Examples.Elementary.HeatLosses(world.defaultWidthFraction=0);
end V2OMC_47ca7477cfed2104;
```

Relevant OMC diagnostic:

```text
messages = "Simulation execution failed for model: V2OMC_47ca7477cfed2104
