...
| Original report | [FINDING-springwithmass-world-defaultwidthfraction-divzero-2.md](../../bugs/FINDING-springwithmass-world-defaultwidthfraction-divzero-2.md) |
| Original SHA-256 | `b733119e806b92e0d43326ca84f7473608373838d101cc3005288568a0b78f2b` |
...
```modelica
model V2OMC_dd409f41177f0d3b
  extends Modelica.Mechanics.MultiBody.Examples.Elementary.SpringWithMass(world.defaultWidthFraction=0);
end V2OMC_dd409f41177f0d3b;
```

Relevant OMC diagnostic:

```text
messages = "Simulation execution failed for model: V2OMC_dd409f41177f0d3b
