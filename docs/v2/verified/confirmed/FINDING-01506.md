...
| Target | `dcdcInverter1.vDCFilter.T` |
| Declaration/site | `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Blocks/Continuous.mo:370` |
| Original report | [FINDING-dcpm-drive-dcdcinverter1-vdcfilter-t-divzero.md](../../bugs/FINDING-dcpm-drive-dcdcinverter1-vdcfilter-t-divzero.md) |
| Original SHA-256 | `2355760fc383a90d184985bc5740242ac8156aa9859d0151b8f86f5aa3e9ae27` |
...
```modelica
model V2OMC_270aa20e20928cf6
  extends Modelica.Electrical.Machines.Examples.DCMachines.DCPM_Drive(dcdcInverter1.vDCFilter.T=0);
end V2OMC_270aa20e20928cf6;
```

Relevant OMC diagnostic:

```text
messages = "Simulation execution failed for model: V2OMC_270aa20e20928cf6
