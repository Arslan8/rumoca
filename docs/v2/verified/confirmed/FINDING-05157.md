...
| Original report | [FINDING-continuous-firstorder-t-divzero.md](../../bugs/FINDING-continuous-firstorder-t-divzero.md) |
| Original SHA-256 | `4e3c54f8d3d5c31c186a2ae16121f6703f95c287b16a87e47f6188577a0f06d6` |
...
```modelica
model V2OMC_a456de72cff18b64
  extends ModelicaTest.Blocks.Continuous(firstOrder.T=0);
end V2OMC_a456de72cff18b64;
```

Relevant OMC diagnostic:

```text
messages = "Simulation execution failed for model: V2OMC_a456de72cff18b64
