...
| Original report | [FINDING-transistor-tr-phic-divzero.md](../../bugs/FINDING-transistor-tr-phic-divzero.md) |
| Original SHA-256 | `493ebae701b10df5cbd70fc56d8f4d20fbbfe9c2f2490afabbd14562cac173bc` |
...
```modelica
model V2OMC_14b1ab420628683f
  extends Modelica.Electrical.Analog.Examples.Utilities.Transistor(Tr.Phic=0);
end V2OMC_14b1ab420628683f;
```

Relevant OMC diagnostic:

```text
LOG_ASSERT        | debug   | t_14b1ab420628683f_functions.c:119: Invalid root: (-nan)^(-0.333)
LOG_ASSERT        | debug   | t_14b1ab420628683f_functions.c:119: Invalid root: (-nan)^(-0.333)
LOG_ASSERT        | debug   | t_14b1ab420628683f_functions.c:119: Invalid root: (-nan)^(-0.333)
LOG_ASSERT        | debug   | t_14b1ab420628683f_functions.c:119: Invalid root: (-nan)^(-0.333)
LOG_ASSERT        | debug   | t_14b1ab420628683f_functions.c:119: Invalid root: (-nan)^(-0.333)
