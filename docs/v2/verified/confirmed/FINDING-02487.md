...
| Original report | [FINDING-smee-generator-smeedata-xd-divequal-2.md](../../bugs/FINDING-smee-generator-smeedata-xd-divequal-2.md) |
| Original SHA-256 | `57daee72f0a71cb6b4b88e2de199599c448d313a2cd3f94b97429c719a7b3d47` |
...
```modelica
model V2OMC_19fc57db2dfcc66a
  extends Modelica.Electrical.Machines.Examples.SynchronousMachines.SMEE_Generator(smeeData.xd=0.13750000000000001);
end V2OMC_19fc57db2dfcc66a;
```

Relevant OMC diagnostic:

```text
messages = "Simulation execution failed for model: V2OMC_19fc57db2dfcc66a
