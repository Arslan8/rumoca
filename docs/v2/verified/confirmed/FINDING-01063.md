# FINDING-01063: `opAmp.Vps` in `VoltageFollower`
...
| Original report | [FINDING-voltagefollower-opamp-vps-divequal.md](../../bugs/FINDING-voltagefollower-opamp-vps-divequal.md) |
| Original SHA-256 | `10007c01edfd15ae40f7dd2670a69ddbd710c5fa91a8797e8a47f3b50df090bb` |
...
```modelica
model V2OMC_695d7609e0b752d7
  extends Modelica.Electrical.Analog.Examples.OpAmps.VoltageFollower(opAmp.Vps=-15);
end V2OMC_695d7609e0b752d7;
```

Relevant OMC diagnostic:

```text
messages = "Simulation execution failed for model: V2OMC_695d7609e0b752d7
LOG_ASSERT        | debug   | division by zero at time 0, (a=225) / (b=0), where divisor b expression is: opAmp.Vps - opAmp.Vns
