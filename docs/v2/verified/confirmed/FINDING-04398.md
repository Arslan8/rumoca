...
| Original report | [FINDING-doublependulum-world-defaultwidthfraction-divzero-2.md](../../bugs/FINDING-doublependulum-world-defaultwidthfraction-divzero-2.md) |
| Original SHA-256 | `213a2d12c045fee26666f4cb8de6d55a66275ae1d38b9407333909a345d194cf` |
...
```modelica
model V2OMC_82783028d1792490
  extends Modelica.Mechanics.MultiBody.Examples.Elementary.DoublePendulum(world.defaultWidthFraction=0);
end V2OMC_82783028d1792490;
```

Relevant OMC diagnostic:

```text
messages = "Simulation execution failed for model: V2OMC_82783028d1792490
