...
| Original report | [FINDING-singlephasetwolevel-rl-signalpwm-f-divzero-2.md](../../bugs/FINDING-singlephasetwolevel-rl-signalpwm-f-divzero-2.md) |
| Original SHA-256 | `bb455bb7e1776c4ed60dbb72fd7679b1114aefeae27bfe014934a6ffb826c649` |
...
```modelica
model V2OMC_e6c9c2dedb02b673
  extends Modelica.Electrical.PowerConverters.Examples.DCAC.SinglePhaseTwoLevel.SinglePhaseTwoLevel_RL(signalPWM.f=0);
end V2OMC_e6c9c2dedb02b673;
```

Relevant OMC diagnostic:

```text
messages = "Simulation execution failed for model: V2OMC_e6c9c2dedb02b673
