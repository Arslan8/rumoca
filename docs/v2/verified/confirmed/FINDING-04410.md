...
| Original report | [FINDING-freebody-world-defaultframediameterfraction-divzero-2.md](../../bugs/FINDING-freebody-world-defaultframediameterfraction-divzero-2.md) |
| Original SHA-256 | `eff7502feb3c5ca9715528ba0d73c15594cb995c0b06f8dfbd5427e8b4f88d16` |
...
```modelica
model V2OMC_112c214bc1504b9b
  extends Modelica.Mechanics.MultiBody.Examples.Elementary.FreeBody(world.defaultFrameDiameterFraction=0);
end V2OMC_112c214bc1504b9b;
```

Relevant OMC diagnostic:

```text
messages = "Simulation execution failed for model: V2OMC_112c214bc1504b9b
