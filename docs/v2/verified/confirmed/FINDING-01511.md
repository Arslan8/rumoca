...
| Target | `dcdcInverter2.vDCFilter.T` |
| Declaration/site | `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Blocks/Continuous.mo:370` |
| Original report | [FINDING-dcpm-drive-dcdcinverter2-vdcfilter-t-divzero.md](../../bugs/FINDING-dcpm-drive-dcdcinverter2-vdcfilter-t-divzero.md) |
| Original SHA-256 | `f5db191fef35c3cabbd995de504419ccd23431b6f31a0852fe0a070b8a60cb13` |
...
```modelica
model V2OMC_937ec4a0e2f6dd88
  extends Modelica.Electrical.Machines.Examples.DCMachines.DCPM_Drive(dcdcInverter2.vDCFilter.T=0);
end V2OMC_937ec4a0e2f6dd88;
```

Relevant OMC diagnostic:

```text
messages = "Simulation execution failed for model: V2OMC_937ec4a0e2f6dd88
