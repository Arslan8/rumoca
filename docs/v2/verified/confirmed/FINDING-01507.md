...
| Target | `dcdcInverter1.iMotFilter.T` |
| Declaration/site | `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Blocks/Continuous.mo:370` |
| Original report | [FINDING-dcpm-drive-dcdcinverter1-imotfilter-t-divzero.md](../../bugs/FINDING-dcpm-drive-dcdcinverter1-imotfilter-t-divzero.md) |
| Original SHA-256 | `07c2c116378122e4b9879633ae67bf35c571d2fcc4cd1a7692b6273007afa027` |
...
```modelica
model V2OMC_db0826c7a4968298
  extends Modelica.Electrical.Machines.Examples.DCMachines.DCPM_Drive(dcdcInverter1.iMotFilter.T=0);
end V2OMC_db0826c7a4968298;
```

Relevant OMC diagnostic:

```text
messages = "Simulation execution failed for model: V2OMC_db0826c7a4968298
