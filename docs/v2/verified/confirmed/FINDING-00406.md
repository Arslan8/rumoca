...
| Original report | [FINDING-heatingrectifier-heatingdiode1-n-divzero.md](../../bugs/FINDING-heatingrectifier-heatingdiode1-n-divzero.md) |
| Original SHA-256 | `96e2e65571a221fd1e1766404aaa7d9bf7013e61bd94d37fdb8d85c5b92dacda` |
...
```modelica
model V2OMC_420524723c2dc1cc
  extends Modelica.Electrical.Analog.Examples.HeatingRectifier(HeatingDiode1.N=0);
end V2OMC_420524723c2dc1cc;
```

Relevant OMC diagnostic:

```text
LOG_ASSERT        | debug   | t_420524723c2dc1cc_functions.c:94: Invalid root: (1.07663)^(inf)
