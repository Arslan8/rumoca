...
| Original report | [FINDING-dcpm-currentcontrolled-firstorder-t-divzero.md](../../bugs/FINDING-dcpm-currentcontrolled-firstorder-t-divzero.md) |
| Original SHA-256 | `2e48afee42b68a4b24bfb872d15c2453d22992fbe3711c7f9b0973209847a7ca` |
...
```modelica
model V2OMC_47da7bd78e42e068
  extends Modelica.Electrical.Machines.Examples.DCMachines.DCPM_CurrentControlled(firstOrder.T=0);
end V2OMC_47da7bd78e42e068;
```

Relevant OMC diagnostic:

```text
messages = "Simulation execution failed for model: V2OMC_47da7bd78e42e068
