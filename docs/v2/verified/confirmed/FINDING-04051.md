...
| Original report | [FINDING-chopperstepdown-r-signalpwm-f-divzero-2.md](../../bugs/FINDING-chopperstepdown-r-signalpwm-f-divzero-2.md) |
| Original SHA-256 | `319be0e6a4a0411e1a0bcb53f73da303b6bf270a5991797d798b351b5dcb39ee` |
...
```modelica
model V2OMC_86f23fcab5bca4e8
  extends Modelica.Electrical.PowerConverters.Examples.DCDC.ChopperStepDown.ChopperStepDown_R(signalPWM.f=0);
end V2OMC_86f23fcab5bca4e8;
```

Relevant OMC diagnostic:

```text
messages = "Simulation execution failed for model: V2OMC_86f23fcab5bca4e8
