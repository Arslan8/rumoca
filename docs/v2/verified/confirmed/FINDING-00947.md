...
| Target | `f` |
| Declaration/site | `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Analog/Examples/OpAmps/LowPass.mo:21` |
| Original report | [FINDING-lowpass-f-divzero-2.md](../../bugs/FINDING-lowpass-f-divzero-2.md) |
| Original SHA-256 | `89f2cd0d803352d342d42869eb6ef5ece25a5919fdb51648fec603f0aa6c58d2` |
...
```modelica
model V2OMC_45ce45b4b3434201
  extends Modelica.Electrical.Analog.Examples.OpAmps.LowPass(f=0);
end V2OMC_45ce45b4b3434201;
```

Relevant OMC diagnostic:

```text
messages = "Simulation execution failed for model: V2OMC_45ce45b4b3434201
