...
| Target | `f` |
| Declaration/site | `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Analog/Examples/OpAmps/Integrator.mo:23` |
| Original report | [FINDING-integrator-f-divzero-4.md](../../bugs/FINDING-integrator-f-divzero-4.md) |
| Original SHA-256 | `d7efaf7c890c63d98c7c0bc5834ff32d903a45852eaefc233438033146723ff9` |
...
```modelica
model V2OMC_e04e4a2bbaf19456
  extends Modelica.Electrical.Analog.Examples.OpAmps.Integrator(f=0);
end V2OMC_e04e4a2bbaf19456;
```

Relevant OMC diagnostic:

```text
messages = "Simulation execution failed for model: V2OMC_e04e4a2bbaf19456
