...
| Target | `dcdcInverter2.iDCFilter.T` |
| Declaration/site | `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Blocks/Continuous.mo:370` |
| Original report | [FINDING-dcpm-drive-dcdcinverter2-idcfilter-t-divzero.md](../../bugs/FINDING-dcpm-drive-dcdcinverter2-idcfilter-t-divzero.md) |
| Original SHA-256 | `07e5f09cd0648052ebd4b37dedb9a80487b56a121f3f0fed320b0a85b13721cc` |
...
```modelica
model V2OMC_cb53c2a6eb17a86a
  extends Modelica.Electrical.Machines.Examples.DCMachines.DCPM_Drive(dcdcInverter2.iDCFilter.T=0);
end V2OMC_cb53c2a6eb17a86a;
```

Relevant OMC diagnostic:

```text
messages = "Simulation execution failed for model: V2OMC_cb53c2a6eb17a86a
