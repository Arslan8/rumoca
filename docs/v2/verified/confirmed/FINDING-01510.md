...
| Target | `dcdcInverter1.iDCFilter.T` |
| Declaration/site | `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Blocks/Continuous.mo:370` |
| Original report | [FINDING-dcpm-drive-dcdcinverter1-idcfilter-t-divzero.md](../../bugs/FINDING-dcpm-drive-dcdcinverter1-idcfilter-t-divzero.md) |
| Original SHA-256 | `d5585b44b9da8dadc945321b340f5ab4df9b63a50925500abf49d7933207e46b` |
...
```modelica
model V2OMC_f14ac5a27c642b9a
  extends Modelica.Electrical.Machines.Examples.DCMachines.DCPM_Drive(dcdcInverter1.iDCFilter.T=0);
end V2OMC_f14ac5a27c642b9a;
```

Relevant OMC diagnostic:

```text
messages = "Simulation execution failed for model: V2OMC_f14ac5a27c642b9a
