...
| Target | `dcdcInverter1.vMotFilter.T` |
| Declaration/site | `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Blocks/Continuous.mo:370` |
| Original report | [FINDING-dcpm-drive-dcdcinverter1-vmotfilter-t-divzero.md](../../bugs/FINDING-dcpm-drive-dcdcinverter1-vmotfilter-t-divzero.md) |
| Original SHA-256 | `f2ea8ff2de0439efaad11994923666df0db5d0f74194da514e08090670a5eb78` |
...
```modelica
model V2OMC_e438ca5e677c7036
  extends Modelica.Electrical.Machines.Examples.DCMachines.DCPM_Drive(dcdcInverter1.vMotFilter.T=0);
end V2OMC_e438ca5e677c7036;
```

Relevant OMC diagnostic:

```text
messages = "Simulation execution failed for model: V2OMC_e438ca5e677c7036
