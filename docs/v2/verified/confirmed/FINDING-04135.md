...
| Original report | [FINDING-hbridge-r-signalpwm-f-divzero-2.md](../../bugs/FINDING-hbridge-r-signalpwm-f-divzero-2.md) |
| Original SHA-256 | `7b03ff2aa5dfc4e35c8b1269eda625032eedad16b9395a2e96cc95bde6d97d80` |
...
```modelica
model V2OMC_127172b7385b5ea5
  extends Modelica.Electrical.PowerConverters.Examples.DCDC.HBridge.HBridge_R(signalPWM.f=0);
end V2OMC_127172b7385b5ea5;
```

Relevant OMC diagnostic:

```text
messages = "Simulation execution failed for model: V2OMC_127172b7385b5ea5
