# FINDING-00959: `opAmp.Vps` in `Multivibrator`
...
| Original report | [FINDING-multivibrator-opamp-vps-divequal.md](../../bugs/FINDING-multivibrator-opamp-vps-divequal.md) |
| Original SHA-256 | `d938556ed3a64b5c3df55d53a5b85ef838978c3a60c63cb52e9f599556d952ff` |
...
```modelica
model V2OMC_4c58f7b79fcee770
  extends Modelica.Electrical.Analog.Examples.OpAmps.Multivibrator(opAmp.Vps=-15);
end V2OMC_4c58f7b79fcee770;
```

Relevant OMC diagnostic:

```text
messages = "Simulation execution failed for model: V2OMC_4c58f7b79fcee770
LOG_ASSERT        | debug   | division by zero at time 0, (a=0.3525) / (b=0), where divisor b expression is: opAmp.Vps - opAmp.Vns
