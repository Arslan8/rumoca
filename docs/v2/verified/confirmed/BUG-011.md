...
| Original report | [BUG-sensors-genericfluxtube-l.md](../../bugs/BUG-sensors-genericfluxtube-l.md) |
| Original SHA-256 | `94e318f08dbc981ee95ebded07fecc0a4cc2d5776d91075f653d4480b1a76a08` |
...
`ModelicaTest.Magnetic.FluxTubes.Sensors` runs cleanly at its declared values. Setting `genericFluxTube.l = 0` — a value the declaration permits — makes it fail, in Rumoca and in OpenModelica. The defect is in the **declaration**, not in this model. This model is the witness.

## Earlier independent review

[Prior report](../../../verifiedBugs/confirmed/BUG-011.md)
