...
| Original report | [FINDING-lowpass-firstorder-r2-divzero-2.md](../../bugs/FINDING-lowpass-firstorder-r2-divzero-2.md) |
| Original SHA-256 | `9339e8fc8681d23c85ec7496ce9b4b26c18b5d949abdf91f42089fc3ef3696d3` |
...
```modelica
model V2OMC_ffe148ff99949c3e
  extends Modelica.Electrical.Analog.Examples.OpAmps.LowPass(firstOrder.R2=0);
end V2OMC_ffe148ff99949c3e;
```

Relevant OMC diagnostic:

```text
messages = "Simulation execution failed for model: V2OMC_ffe148ff99949c3e
LOG_ASSERT        | debug   | division by zero at time 0, (a=0.1591549430918953) / (b=0), where divisor b expression is: firstOrder.R2
