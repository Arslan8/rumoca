...
| Original report | [FINDING-bevelgear1d-world-defaultwidthfraction-divzero-2.md](../../bugs/FINDING-bevelgear1d-world-defaultwidthfraction-divzero-2.md) |
| Original SHA-256 | `d16023a6f70a9052aa3df703ce380afebac4f8e7dd330671bf5fab77118b1735` |
...
```modelica
model V2OMC_af42af482a1d328c
  extends Modelica.Mechanics.MultiBody.Examples.Rotational3DEffects.BevelGear1D(world.defaultWidthFraction=0);
end V2OMC_af42af482a1d328c;
```

Relevant OMC diagnostic:

```text
messages = "Simulation execution failed for model: V2OMC_af42af482a1d328c
