...
| Original report | [FINDING-chopperstepup-r-signalpwm-f-divzero-2.md](../../bugs/FINDING-chopperstepup-r-signalpwm-f-divzero-2.md) |
| Original SHA-256 | `1253f3e130724e2526cba0a9c269f799a250cc015dab6c301de71aa905375321` |
...
```modelica
model V2OMC_3aa75453a543415f
  extends Modelica.Electrical.PowerConverters.Examples.DCDC.ChopperStepUp.ChopperStepUp_R(signalPWM.f=0);
end V2OMC_3aa75453a543415f;
```

Relevant OMC diagnostic:

```text
messages = "Simulation execution failed for model: V2OMC_3aa75453a543415f
