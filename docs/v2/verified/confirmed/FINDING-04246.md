...
| Original report | [FINDING-armaturestroke-pmactuator-t-divzero-2.md](../../bugs/FINDING-armaturestroke-pmactuator-t-divzero-2.md) |
| Original SHA-256 | `6e0cefbb66ed9b5ff3893a4d32f0c44a2f01252f41f3be68a3299dd2823b646f` |
...
```modelica
model V2OMC_403936a7212e6243
  extends Modelica.Magnetic.FluxTubes.Examples.MovingCoilActuator.ArmatureStroke(pmActuator.t=-0.0080000000000000002);
end V2OMC_403936a7212e6243;
```

Relevant OMC diagnostic:

```text
messages = "Simulation execution failed for model: V2OMC_403936a7212e6243
LOG_ASSERT        | debug   | division by zero at time 0, (a=1) / (b=0), where divisor b expression is: pmActuator.g_mb.G_m
