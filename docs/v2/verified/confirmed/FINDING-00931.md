# FINDING-00931: `opAmp.Vps` in `LCOscillator`
...
| Original report | [FINDING-lcoscillator-opamp-vps-divequal.md](../../bugs/FINDING-lcoscillator-opamp-vps-divequal.md) |
| Original SHA-256 | `08373c26afb58104518f732c55b2a4f96ac8b63001714dee00e644648d60a34a` |
...
```modelica
model V2OMC_6cb1fafcd1afa19a
  extends Modelica.Electrical.Analog.Examples.OpAmps.LCOscillator(opAmp.Vps=-15);
end V2OMC_6cb1fafcd1afa19a;
```

Relevant OMC diagnostic:

```text
messages = "Simulation execution failed for model: V2OMC_6cb1fafcd1afa19a
LOG_ASSERT        | debug   | division by zero at time 0, (a=0.05997752247752248) / (b=0), where divisor b expression is: opAmp.Vps - opAmp.Vns
