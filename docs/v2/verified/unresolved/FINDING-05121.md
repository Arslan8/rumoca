...
| Original report | [FINDING-waterpump-volumeflowsensor-medium-cp-divzero.md](../../bugs/FINDING-waterpump-volumeflowsensor-medium-cp-divzero.md) |
| Original SHA-256 | `89b87b7cc45c49b8c7edecbeed868ce5934dddebfd5be63d3d57171b3fd41fdb` |
...
```modelica
model V2OMC_7fd78098bfc9296d
  extends Modelica.Thermal.FluidHeatFlow.Examples.WaterPump(volumeFlowSensor.medium.cp=0);
end V2OMC_7fd78098bfc9296d;
```
