...
| Target | `airGap.material.B_myMax` |
| Declaration/site | `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/FluxTubes/BaseClasses/FixedShape.mo:31` |
| Original report | [FINDING-toroidalcorequadraticcrosssection-airgap-material-b-mymax-divzero.md](../../bugs/FINDING-toroidalcorequadraticcrosssection-airgap-material-b-mymax-divzero.md) |
| Original SHA-256 | `50e489ca72200ecb53d71657c7064377b3d108be248d0a2cc4b4961be682dbbc` |
...
```modelica
model V2OMC_3a502bf73c55d7a4
  extends Modelica.Magnetic.FluxTubes.Examples.BasicExamples.ToroidalCoreQuadraticCrossSection(airGap.material.B_myMax=0);
end V2OMC_3a502bf73c55d7a4;
```
