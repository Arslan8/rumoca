...
| Target | `g_mAirPar.material.B_myMax` |
| Declaration/site | `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/FluxTubes/BaseClasses/FixedShape.mo:31` |
| Original report | [FINDING-advancedsolenoid-g-mairpar-material-b-mymax-divzero.md](../../bugs/FINDING-advancedsolenoid-g-mairpar-material-b-mymax-divzero.md) |
| Original SHA-256 | `a86445baf162d3161c4b2eb5aaf485863e14a17a38899d882def36b2aa42a0b1` |
...
```modelica
model V2OMC_c09a18b3ddb6d421
  extends Modelica.Magnetic.FluxTubes.Examples.SolenoidActuator.Components.AdvancedSolenoid(g_mAirPar.material.B_myMax=0);
end V2OMC_c09a18b3ddb6d421;
```

Relevant OMC diagnostic:

```text
messages = "Failed to build model: V2OMC_c09a18b3ddb6d421",
