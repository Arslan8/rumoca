...
| Target | `idealDcDc.deadTime.T` |
| Declaration/site | `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Blocks/Continuous.mo:370` |
| Original report | [FINDING-dcdcinverter-idealdcdc-deadtime-t-divzero.md](../../bugs/FINDING-dcdcinverter-idealdcdc-deadtime-t-divzero.md) |
| Original SHA-256 | `3996fb101a2a9539492440160711e6a2e88453a4173bf87cdcd722e943e7bc51` |
...
```modelica
model V2OMC_931c177a8999b8ae
  extends Modelica.Electrical.Machines.Examples.ControlledDCDrives.Utilities.DcdcInverter(idealDcDc.deadTime.T=0);
end V2OMC_931c177a8999b8ae;
```

Relevant OMC diagnostic:

```text
messages = "Failed to build model: V2OMC_931c177a8999b8ae",
