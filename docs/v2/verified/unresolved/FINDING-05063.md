...
| Original report | [FINDING-twomass-pipe1-v-flownominal-divzero.md](../../bugs/FINDING-twomass-pipe1-v-flownominal-divzero.md) |
| Original SHA-256 | `adc21c6146af524c3498ab5a7ebab4af1d5cfb538056e5bc2b4172cb3fd2cc6c` |
...
```modelica
model V2OMC_9e0c4d79f9d2a911
  extends Modelica.Thermal.FluidHeatFlow.Examples.TwoMass(pipe1.V_flowNominal=0.10000000000000001);
end V2OMC_9e0c4d79f9d2a911;
```

Relevant OMC diagnostic:

```text
messages = "Simulation execution failed for model: V2OMC_9e0c4d79f9d2a911
