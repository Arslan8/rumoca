...
| Original report | [FINDING-indirectcooling-innermedium-cp-divzero-5.md](../../bugs/FINDING-indirectcooling-innermedium-cp-divzero-5.md) |
| Original SHA-256 | `a75ffd50d9761c0df65916bafd4d85d273928b302d5ffb47fb7bd7af2afdf2d4` |
...
```modelica
model V2OMC_b25a630f728fda20
  extends Modelica.Thermal.FluidHeatFlow.Examples.IndirectCooling(innerMedium.cp=0);
end V2OMC_b25a630f728fda20;
```
