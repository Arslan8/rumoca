...
| Original report | [FINDING-simplecooling-medium-cp-divzero-3.md](../../bugs/FINDING-simplecooling-medium-cp-divzero-3.md) |
| Original SHA-256 | `fd95aee055abddc3fbdb14aadda505d7489947995a2af5f8ce6a992f73b7484a` |
...
```modelica
model V2OMC_e218c8493bfa5903
  extends Modelica.Thermal.FluidHeatFlow.Examples.SimpleCooling(medium.cp=0);
end V2OMC_e218c8493bfa5903;
```
