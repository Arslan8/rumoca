...
| Original report | [FINDING-comparator-opamp-vps-divequal.md](../../bugs/FINDING-comparator-opamp-vps-divequal.md) |
| Original SHA-256 | `cd302c0c5774b0ed4be484c9863611e52f0dd538e99401673b350269633f1410` |
...
```modelica
model V2OMC_8ad171d5bc6bff64
  extends Modelica.Electrical.Analog.Examples.OpAmps.Comparator(opAmp.Vps=-15);
end V2OMC_8ad171d5bc6bff64;
```
