...
| Target | `leftLeg.material.B_myMax` |
| Declaration/site | `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/FluxTubes/BaseClasses/FixedShape.mo:31` |
| Original report | [FINDING-quadraticcoreairgap-leftleg-material-b-mymax-divzero.md](../../bugs/FINDING-quadraticcoreairgap-leftleg-material-b-mymax-divzero.md) |
| Original SHA-256 | `71e786cf6c9e605b16fbe9322cb94d9ceb31796dbeecb7e9262dc0f3d5faa683` |
...
```modelica
model V2OMC_481ea3b342cf7460
  extends Modelica.Magnetic.FluxTubes.Examples.BasicExamples.QuadraticCoreAirgap(leftLeg.material.B_myMax=0);
end V2OMC_481ea3b342cf7460;
```
