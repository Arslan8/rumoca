...
| Original report | [FINDING-onemass-pipe-v-flownominal-divzero.md](../../bugs/FINDING-onemass-pipe-v-flownominal-divzero.md) |
| Original SHA-256 | `b963b5944b49cd945a10fbd30878a8e6e717a112592c2262d23651c53f751e2a` |
...
```modelica
model V2OMC_3b3d159e10a9bd9f
  extends Modelica.Thermal.FluidHeatFlow.Examples.OneMass(pipe.V_flowNominal=0.10000000000000001);
end V2OMC_3b3d159e10a9bd9f;
```

Relevant OMC diagnostic:

```text
messages = "Simulation execution failed for model: V2OMC_3b3d159e10a9bd9f
