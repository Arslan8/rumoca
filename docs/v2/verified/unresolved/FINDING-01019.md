...
| Original report | [FINDING-integrator-k-divzero-2.md](../../bugs/FINDING-integrator-k-divzero-2.md) |
| Original SHA-256 | `ca8cac086dd89466c85dc3cc47f998aaef7c33ad9c6202e8e605d2b08e27354f` |
...
```modelica
model V2OMC_4e1f11161ab20ade
  extends Modelica.Electrical.Analog.Examples.OpAmps.OpAmpCircuits.Integrator(k=0);
end V2OMC_4e1f11161ab20ade;
```

Relevant OMC diagnostic:

```text
messages = "Failed to build model: V2OMC_4e1f11161ab20ade",
