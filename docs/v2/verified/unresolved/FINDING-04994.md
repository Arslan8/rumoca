...
| Original report | [FINDING-pumpdropout-pipe-v-flownominal-divzero.md](../../bugs/FINDING-pumpdropout-pipe-v-flownominal-divzero.md) |
| Original SHA-256 | `696000842b02444d2a4bb5ebbf03f7162e968c5beb56ba61501c7584ce933946` |
...
```modelica
model V2OMC_7339bbfcbb208f7f
  extends Modelica.Thermal.FluidHeatFlow.Examples.PumpDropOut(pipe.V_flowNominal=0.10000000000000001);
end V2OMC_7339bbfcbb208f7f;
```

Relevant OMC diagnostic:

```text
messages = "Simulation execution failed for model: V2OMC_7339bbfcbb208f7f
