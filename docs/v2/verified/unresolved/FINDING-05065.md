...
| Original report | [FINDING-twomass-pipe3-v-flownominal-divzero.md](../../bugs/FINDING-twomass-pipe3-v-flownominal-divzero.md) |
| Original SHA-256 | `a18bbbbee9cf7211be682f2ef8cdfa75352e010d3d5f53ce6287b3276333a218` |
...
```modelica
model V2OMC_1db8621447755d7e
  extends Modelica.Thermal.FluidHeatFlow.Examples.TwoMass(pipe3.V_flowNominal=0.10000000000000001);
end V2OMC_1db8621447755d7e;
```

Relevant OMC diagnostic:

```text
messages = "Simulation execution failed for model: V2OMC_1db8621447755d7e
