...
| Original report | [FINDING-indirectcooling-pipe1-v-flownominal-divzero.md](../../bugs/FINDING-indirectcooling-pipe1-v-flownominal-divzero.md) |
| Original SHA-256 | `a04aca77dbde2f16e2188d3dd80c92f552cc4ff1f5f9156242d73a41a47efcbf` |
...
```modelica
model V2OMC_54e5e5dc4e6bb2b8
  extends Modelica.Thermal.FluidHeatFlow.Examples.IndirectCooling(pipe1.V_flowNominal=1);
end V2OMC_54e5e5dc4e6bb2b8;
```

Relevant OMC diagnostic:

```text
messages = "Simulation execution failed for model: V2OMC_54e5e5dc4e6bb2b8
