...
| Declaration/site | `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Machines/BasicMachines/SynchronousMachines/SM_ReluctanceRotor.mo:45` |
| Original report | [FINDING-smr-dol-smr-fsnominal-divzero-3.md](../../bugs/FINDING-smr-dol-smr-fsnominal-divzero-3.md) |
| Original SHA-256 | `86c456d262d9696575c379561a3f0fedadc354e9b09381bbc1a37da4e98ba8c7` |
...
```modelica
model V2OMC_d3684763752d5dad
  extends Modelica.Electrical.Machines.Examples.SynchronousMachines.SMR_DOL(smr.fsNominal=0);
end V2OMC_d3684763752d5dad;
```
