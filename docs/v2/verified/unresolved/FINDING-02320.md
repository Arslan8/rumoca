...
| Target | `aims.fsNominal` |
| Declaration/site | `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Machines/BasicMachines/InductionMachines/IM_SlipRing.mo:27` |
| Original report | [FINDING-ims-start-aims-fsnominal-divzero-2.md](../../bugs/FINDING-ims-start-aims-fsnominal-divzero-2.md) |
| Original SHA-256 | `d08423e6c82a35829a94f9237f849c7705f9c6aa6e4104ce374d8a606c4320af` |
...
```modelica
model V2OMC_73383ab4ba6ad860
  extends Modelica.Electrical.Machines.Examples.InductionMachines.IMS_Start(aims.fsNominal=0);
end V2OMC_73383ab4ba6ad860;
```
