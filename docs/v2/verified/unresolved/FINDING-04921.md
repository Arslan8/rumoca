...
| Original report | [FINDING-parallelpumpdropout-pipe1-v-flownominal-divzero.md](../../bugs/FINDING-parallelpumpdropout-pipe1-v-flownominal-divzero.md) |
| Original SHA-256 | `56b364fc634cc80fae8b3cc72f26bc3121b2463aa97a67b2a60d016c775c5d6d` |
...
```modelica
model V2OMC_b8c0421aa907cd26
  extends Modelica.Thermal.FluidHeatFlow.Examples.ParallelPumpDropOut(pipe1.V_flowNominal=0.10000000000000001);
end V2OMC_b8c0421aa907cd26;
```

Relevant OMC diagnostic:

```text
messages = "Simulation execution failed for model: V2OMC_b8c0421aa907cd26
