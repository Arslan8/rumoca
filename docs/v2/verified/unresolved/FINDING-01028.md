...
| Original report | [FINDING-pi-k-divzero-2.md](../../bugs/FINDING-pi-k-divzero-2.md) |
| Original SHA-256 | `7da032347b700bd8c6e5e952533459b5ae4d972df1dc97cc0491c87d7ad3c8a1` |
...
```modelica
model V2OMC_572854fe85361dc1
  extends Modelica.Electrical.Analog.Examples.OpAmps.OpAmpCircuits.PI(k=0);
end V2OMC_572854fe85361dc1;
```

Relevant OMC diagnostic:

```text
messages = "Failed to build model: V2OMC_572854fe85361dc1",
