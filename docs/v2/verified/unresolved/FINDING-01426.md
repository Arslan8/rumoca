...
| Target | `cooling.medium.cp` |
| Declaration/site | `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Thermal/FluidHeatFlow/BaseClasses/TwoPort.mo:35` |
| Original report | [FINDING-dcpm-cooling-cooling-medium-cp-divzero.md](../../bugs/FINDING-dcpm-cooling-cooling-medium-cp-divzero.md) |
| Original SHA-256 | `cb4c0701f9130a54ea1778ed0e9be1d2e10b6c02668c4d34fd7cd9332fa3a0ff` |
...
```modelica
model V2OMC_f8e0602871e65423
  extends Modelica.Electrical.Machines.Examples.DCMachines.DCPM_Cooling(cooling.medium.cp=0);
end V2OMC_f8e0602871e65423;
```
