...
| Original report | [FINDING-parallelpumpdropout-pipe2-v-flownominal-divzero.md](../../bugs/FINDING-parallelpumpdropout-pipe2-v-flownominal-divzero.md) |
| Original SHA-256 | `780f444885a04ea84d611823d197883d4df1daa98d0ec55699a369d17391ec45` |
...
```modelica
model V2OMC_2b9a93e98619422d
  extends Modelica.Thermal.FluidHeatFlow.Examples.ParallelPumpDropOut(pipe2.V_flowNominal=0.10000000000000001);
end V2OMC_2b9a93e98619422d;
```

Relevant OMC diagnostic:

```text
messages = "Simulation execution failed for model: V2OMC_2b9a93e98619422d
