...
| Original report | [FINDING-dcdcinverter-vdcfilter-t-divzero.md](../../bugs/FINDING-dcdcinverter-vdcfilter-t-divzero.md) |
| Original SHA-256 | `7685fc4b094c438cc4eb36cd21c7313db2deef8cfd86fc756e5d3eb38b474838` |
...
```modelica
model V2OMC_86b0197358ddcb9e
  extends Modelica.Electrical.Machines.Examples.ControlledDCDrives.Utilities.DcdcInverter(vDCFilter.T=0);
end V2OMC_86b0197358ddcb9e;
```

Relevant OMC diagnostic:

```text
messages = "Failed to build model: V2OMC_86b0197358ddcb9e",
