...
| Target | `r_mAirPar.material.B_myMax` |
| Declaration/site | `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/FluxTubes/BaseClasses/FixedShape.mo:31` |
| Original report | [FINDING-saturatedinductor-r-mairpar-material-b-mymax-divzero.md](../../bugs/FINDING-saturatedinductor-r-mairpar-material-b-mymax-divzero.md) |
| Original SHA-256 | `f0907552e01190421fe78af138fba76f464d1fb42dbb44270410491d9f56a48c` |
...
```modelica
model V2OMC_3fe5d4e5a0ebf22a
  extends Modelica.Magnetic.FluxTubes.Examples.BasicExamples.SaturatedInductor(r_mAirPar.material.B_myMax=0);
end V2OMC_3fe5d4e5a0ebf22a;
```
