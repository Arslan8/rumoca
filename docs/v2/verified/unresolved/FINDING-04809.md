...
| Original report | [FINDING-indirectcooling-innerpipe-v-flownominal-divzero.md](../../bugs/FINDING-indirectcooling-innerpipe-v-flownominal-divzero.md) |
| Original SHA-256 | `6507f4edd65d9849d6a0d9080bfbda1a709a64dd45f2f212e139e99a5142cf65` |
...
```modelica
model V2OMC_bef8e109e8872514
  extends Modelica.Thermal.FluidHeatFlow.Examples.IndirectCooling(innerPipe.V_flowNominal=0.10000000000000001);
end V2OMC_bef8e109e8872514;
```

Relevant OMC diagnostic:

```text
messages = "Simulation execution failed for model: V2OMC_bef8e109e8872514
