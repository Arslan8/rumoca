...
| Original report | [FINDING-derivative-r1-divzero-2.md](../../bugs/FINDING-derivative-r1-divzero-2.md) |
| Original SHA-256 | `d4ba26327cdbd2df0f8ca3fc5d1bfddad39342a6fd206d7b15dc58e63f45d58a` |
...
```modelica
model V2OMC_1d1702d2fcc11bbe
  extends Modelica.Electrical.Analog.Examples.OpAmps.OpAmpCircuits.Derivative(R1=0);
end V2OMC_1d1702d2fcc11bbe;
```

Relevant OMC diagnostic:

```text
messages = "Failed to build model: V2OMC_1d1702d2fcc11bbe",
