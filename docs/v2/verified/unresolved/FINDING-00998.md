...
| Original report | [FINDING-der-f-divzero-2.md](../../bugs/FINDING-der-f-divzero-2.md) |
| Original SHA-256 | `8d387ba11cd2580de461e067887611031145ce90a9ba2e4928fbcf38c479d655` |
...
```modelica
model V2OMC_51aa20d5a4b29fac
  extends Modelica.Electrical.Analog.Examples.OpAmps.OpAmpCircuits.Der(f=0);
end V2OMC_51aa20d5a4b29fac;
```

Relevant OMC diagnostic:

```text
messages = "Failed to build model: V2OMC_51aa20d5a4b29fac",
