...
| Original report | [FINDING-waterpump-ambient2-medium-cp-divzero-2.md](../../bugs/FINDING-waterpump-ambient2-medium-cp-divzero-2.md) |
| Original SHA-256 | `32e5991de1987995c1c7c49c0f22b90b9a1bbc383f06c83d3fb78766925812d8` |
...
```modelica
model V2OMC_89bd467b54149daa
  extends Modelica.Thermal.FluidHeatFlow.Examples.WaterPump(ambient2.medium.cp=0);
end V2OMC_89bd467b54149daa;
```
