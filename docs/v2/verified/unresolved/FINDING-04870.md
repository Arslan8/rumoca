...
| Original report | [FINDING-parallelcooling-medium-cp-divzero-7.md](../../bugs/FINDING-parallelcooling-medium-cp-divzero-7.md) |
| Original SHA-256 | `c0de8f0cca485ebf31aee31705230853fe11ebdbb43fd9bbaaf4fc5dee4b20d2` |
...
```modelica
model V2OMC_8656843d1880fdf4
  extends Modelica.Thermal.FluidHeatFlow.Examples.ParallelCooling(medium.cp=0);
end V2OMC_8656843d1880fdf4;
```
