...
| Original report | [FINDING-nand-tp1-rds-divzero.md](../../bugs/FINDING-nand-tp1-rds-divzero.md) |
| Original SHA-256 | `b0ef1c96067c51d7d8319c436f6f200eeaaefbadf6614a8f61555b939bf92043` |
...
```modelica
model V2OMC_6b1d4338ce9c8ee6
  extends Modelica.Electrical.Analog.Examples.Utilities.Nand(TP1.RDS=0);
end V2OMC_6b1d4338ce9c8ee6;
```

Relevant OMC diagnostic:

```text
messages = "Failed to build model: V2OMC_6b1d4338ce9c8ee6",
