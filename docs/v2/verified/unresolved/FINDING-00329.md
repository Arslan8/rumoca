...
| Original report | [FINDING-heatingmosinverter-h-nmos-rds-divzero.md](../../bugs/FINDING-heatingmosinverter-h-nmos-rds-divzero.md) |
| Original SHA-256 | `84e8e3a82f7a027616ec6e63db9686bb402f8f8ad65672a0e59d5098a9e3da01` |
...
```modelica
model V2OMC_c1932c23b3d185e1
  extends Modelica.Electrical.Analog.Examples.HeatingMOSInverter(H_NMOS.RDS=0);
end V2OMC_c1932c23b3d185e1;
```
