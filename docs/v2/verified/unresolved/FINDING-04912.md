...
| Original report | [FINDING-parallelpumpdropout-medium-cp-divzero-7.md](../../bugs/FINDING-parallelpumpdropout-medium-cp-divzero-7.md) |
| Original SHA-256 | `a3679d3967efc4a5be7b256a7b0ae84075973219a3a4c19584e4e09bf864f6ac` |
...
```modelica
model V2OMC_1385847165558a02
  extends Modelica.Thermal.FluidHeatFlow.Examples.ParallelPumpDropOut(medium.cp=0);
end V2OMC_1385847165558a02;
```
