...
| Original report | [FINDING-waterpump-onewayvalve-medium-cp-divzero.md](../../bugs/FINDING-waterpump-onewayvalve-medium-cp-divzero.md) |
| Original SHA-256 | `26cea14daa517e4b055b9c50df4b08f0c476bd22295c94f1856b824b8de1e8ab` |
...
```modelica
model V2OMC_aed4fb2cc865a470
  extends Modelica.Thermal.FluidHeatFlow.Examples.WaterPump(oneWayValve.medium.cp=0);
end V2OMC_aed4fb2cc865a470;
```
