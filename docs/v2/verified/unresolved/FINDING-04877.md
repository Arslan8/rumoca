...
| Original report | [FINDING-parallelcooling-pipe1-v-flownominal-divzero.md](../../bugs/FINDING-parallelcooling-pipe1-v-flownominal-divzero.md) |
| Original SHA-256 | `417e111ac996b25b16cc73f248369e962d310447f9893c056ad5681f1aedbe09` |
...
```modelica
model V2OMC_c73603e01b3a2b8c
  extends Modelica.Thermal.FluidHeatFlow.Examples.ParallelCooling(pipe1.V_flowNominal=0.10000000000000001);
end V2OMC_c73603e01b3a2b8c;
```

Relevant OMC diagnostic:

```text
messages = "Simulation execution failed for model: V2OMC_c73603e01b3a2b8c
