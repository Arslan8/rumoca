...
| Target | `G_mLeakRad.material.B_myMax` |
| Declaration/site | `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/FluxTubes/BaseClasses/FixedShape.mo:31` |
| Original report | [FINDING-advancedsolenoid-g-mleakrad-material-b-mymax-divzero.md](../../bugs/FINDING-advancedsolenoid-g-mleakrad-material-b-mymax-divzero.md) |
| Original SHA-256 | `2e8041a2400e34a13b9d22a6cf69e90772308c2caf9ad8aff68028d6ad85f03a` |
...
```modelica
model V2OMC_fe36b2bf5d226f4b
  extends Modelica.Magnetic.FluxTubes.Examples.SolenoidActuator.Components.AdvancedSolenoid(G_mLeakRad.material.B_myMax=0);
end V2OMC_fe36b2bf5d226f4b;
```

Relevant OMC diagnostic:

```text
messages = "Failed to build model: V2OMC_fe36b2bf5d226f4b",
