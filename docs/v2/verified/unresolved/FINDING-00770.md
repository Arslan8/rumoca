...
| Original report | [FINDING-nandgate-nand-tp2-rds-divzero.md](../../bugs/FINDING-nandgate-nand-tp2-rds-divzero.md) |
| Original SHA-256 | `956e3001a28abbad34c803fd3d882a8a3c7437367c24d1713bd815f0a060d793` |
...
```modelica
model V2OMC_2541887486da4bfb
  extends Modelica.Electrical.Analog.Examples.NandGate(Nand.TP2.RDS=0);
end V2OMC_2541887486da4bfb;
```

Relevant OMC diagnostic:

```text
messages = "Simulation execution failed for model: V2OMC_2541887486da4bfb
