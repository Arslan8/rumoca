...
| Original report | [FINDING-nand-tn1-rds-divzero.md](../../bugs/FINDING-nand-tn1-rds-divzero.md) |
| Original SHA-256 | `debe7d13d5f4390a4434b9c81004575b062b07ec039c8767720a5ff7d23d5309` |
...
```modelica
model V2OMC_f67de0321f447518
  extends Modelica.Electrical.Analog.Examples.Utilities.Nand(TN1.RDS=0);
end V2OMC_f67de0321f447518;
```

Relevant OMC diagnostic:

```text
messages = "Failed to build model: V2OMC_f67de0321f447518",
