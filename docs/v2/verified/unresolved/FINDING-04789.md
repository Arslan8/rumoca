...
| Original report | [FINDING-indirectcooling-outermedium-cp-divzero-3.md](../../bugs/FINDING-indirectcooling-outermedium-cp-divzero-3.md) |
| Original SHA-256 | `7b0cecc2add4b98ec277ce863f58f2ad80a11f1d1cce26906866c7a55fc18f7e` |
...
```modelica
model V2OMC_28ba82a8e6881ed2
  extends Modelica.Thermal.FluidHeatFlow.Examples.IndirectCooling(outerMedium.cp=0);
end V2OMC_28ba82a8e6881ed2;
```
