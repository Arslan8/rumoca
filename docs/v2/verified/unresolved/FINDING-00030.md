...
| Original report | [FINDING-mixingunit-c0-divzero-2.md](../../bugs/FINDING-mixingunit-c0-divzero-2.md) |
| Original SHA-256 | `ac1e6b8275b88292df9720bbd3a898a3937b80c6ac5f8512a4fc168d3f13cc99` |
...
```modelica
model V2OMC_187da8776ef7980f
  extends Modelica.Clocked.Examples.Systems.Utilities.ComponentsMixingUnit.MixingUnit(c0=0);
end V2OMC_187da8776ef7980f;
```

Relevant OMC diagnostic:

```text
messages = "Simulation execution failed for model: V2OMC_187da8776ef7980f
LOG_ASSERT        | debug   | division by zero at time 0, (a=105000000000000) / (b=0), where divisor b expression is: c0
