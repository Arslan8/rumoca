...
| Original report | [FINDING-waterpump-pipe-medium-cp-divzero.md](../../bugs/FINDING-waterpump-pipe-medium-cp-divzero.md) |
| Original SHA-256 | `4eef94d75ddac420cc717aec809627d8a894f3a6d253e957e6d8f0fd9df79ee8` |
...
```modelica
model V2OMC_563f2980341c288c
  extends Modelica.Thermal.FluidHeatFlow.Examples.WaterPump(pipe.medium.cp=0);
end V2OMC_563f2980341c288c;
```
