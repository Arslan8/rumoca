...
| Original report | [FINDING-parallelcooling-pipe3-v-flownominal-divzero.md](../../bugs/FINDING-parallelcooling-pipe3-v-flownominal-divzero.md) |
| Original SHA-256 | `c2836e4e16afe928664f911ae13f0e426259782e8c0398cf6c4df9b4c7153ff7` |
...
```modelica
model V2OMC_29d290e0e102304c
  extends Modelica.Thermal.FluidHeatFlow.Examples.ParallelCooling(pipe3.V_flowNominal=0.10000000000000001);
end V2OMC_29d290e0e102304c;
```

Relevant OMC diagnostic:

```text
messages = "Simulation execution failed for model: V2OMC_29d290e0e102304c
