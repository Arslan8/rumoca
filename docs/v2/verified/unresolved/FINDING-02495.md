...
| Target | `smeeData.xq` |
| Declaration/site | `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Machines/Utilities/SynchronousMachineData.mo:78` |
| Original report | [FINDING-smee-generator-smeedata-xq-divequal-2.md](../../bugs/FINDING-smee-generator-smeedata-xq-divequal-2.md) |
| Original SHA-256 | `7d59d05b6945b5a08bb849d6892170ca892b3a9e34326256d73151f836e9c737` |
...
```modelica
model V2OMC_1acba90bfcea1d90
  extends Modelica.Electrical.Machines.Examples.SynchronousMachines.SMEE_Generator(smeeData.xq=0.14838699999999999);
end V2OMC_1acba90bfcea1d90;
```
