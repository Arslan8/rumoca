...
| Original report | [FINDING-twotanks-pipe-medium-cp-divzero.md](../../bugs/FINDING-twotanks-pipe-medium-cp-divzero.md) |
| Original SHA-256 | `af7b17952abfc0599d20078bdb51519a110c8a83bb62256d4ec7bbf2112a523a` |
...
```modelica
model V2OMC_339212c9950546c6
  extends Modelica.Thermal.FluidHeatFlow.Examples.TwoTanks(pipe.medium.cp=0);
end V2OMC_339212c9950546c6;
```
