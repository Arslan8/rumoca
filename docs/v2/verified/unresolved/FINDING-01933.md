...
| Declaration/site | `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Electrical/Machines/BasicMachines/InductionMachines/IM_SquirrelCage.mo:29` |
| Original report | [FINDING-imc-inverterdrive-aimc-fsnominal-divzero-3.md](../../bugs/FINDING-imc-inverterdrive-aimc-fsnominal-divzero-3.md) |
| Original SHA-256 | `e0e021ef3a9dc2c59286e79fb39ebbd810198a77b0c5418ee2d0280c20274b53` |
...
```modelica
model V2OMC_bd231930ca26a2a4
  extends Modelica.Electrical.Machines.Examples.InductionMachines.IMC_InverterDrive(aimc.fsNominal=0);
end V2OMC_bd231930ca26a2a4;
```
