...
| Original report | [FINDING-parallelpumpdropout-pipe3-v-flownominal-divzero.md](../../bugs/FINDING-parallelpumpdropout-pipe3-v-flownominal-divzero.md) |
| Original SHA-256 | `a88e2c3ca09d6177a314e654639c5f46c9ce986e40491e0ef09db0aaa608a775` |
...
```modelica
model V2OMC_46e3f7c63ebd0701
  extends Modelica.Thermal.FluidHeatFlow.Examples.ParallelPumpDropOut(pipe3.V_flowNominal=0.10000000000000001);
end V2OMC_46e3f7c63ebd0701;
```

Relevant OMC diagnostic:

```text
messages = "Simulation execution failed for model: V2OMC_46e3f7c63ebd0701
