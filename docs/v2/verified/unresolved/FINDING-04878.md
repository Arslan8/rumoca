...
| Original report | [FINDING-parallelcooling-pipe2-v-flownominal-divzero.md](../../bugs/FINDING-parallelcooling-pipe2-v-flownominal-divzero.md) |
| Original SHA-256 | `5403c2a36ed2f354397acce34c16d192050bcf6ca8a39dcb6e712624ad5810ae` |
...
```modelica
model V2OMC_9511aa65273bddc5
  extends Modelica.Thermal.FluidHeatFlow.Examples.ParallelCooling(pipe2.V_flowNominal=0.10000000000000001);
end V2OMC_9511aa65273bddc5;
```

Relevant OMC diagnostic:

```text
messages = "Simulation execution failed for model: V2OMC_9511aa65273bddc5
