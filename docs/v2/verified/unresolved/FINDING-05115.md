...
| Original report | [FINDING-waterpump-idealpump-medium-cp-divzero.md](../../bugs/FINDING-waterpump-idealpump-medium-cp-divzero.md) |
| Original SHA-256 | `f763e63d6e4d1cf1a59ac1cc4aae78c81c55540bbc84db240188e85fd4e58082` |
...
```modelica
model V2OMC_91216ba1cddd5ae6
  extends Modelica.Thermal.FluidHeatFlow.Examples.WaterPump(idealPump.medium.cp=0);
end V2OMC_91216ba1cddd5ae6;
```
