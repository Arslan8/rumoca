...
| Original report | [FINDING-pi-r1-divzero-2.md](../../bugs/FINDING-pi-r1-divzero-2.md) |
| Original SHA-256 | `fdb27de6c8f8aa371c5933517831f50f340c7b841ea2117024585031345445da` |
...
```modelica
model V2OMC_1fdce484fd4afe5f
  extends Modelica.Electrical.Analog.Examples.OpAmps.OpAmpCircuits.PI(R1=0);
end V2OMC_1fdce484fd4afe5f;
```

Relevant OMC diagnostic:

```text
messages = "Failed to build model: V2OMC_1fdce484fd4afe5f",
