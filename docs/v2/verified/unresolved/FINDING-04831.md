...
| Original report | [FINDING-onemass-medium-cp-divzero-5.md](../../bugs/FINDING-onemass-medium-cp-divzero-5.md) |
| Original SHA-256 | `2e893c4818c33f29aaf8d56ecacbe9e5360ba89798c657419d74108f2dbcb53a` |
...
```modelica
model V2OMC_2ed97eb93994a16a
  extends Modelica.Thermal.FluidHeatFlow.Examples.OneMass(medium.cp=0);
end V2OMC_2ed97eb93994a16a;
```
