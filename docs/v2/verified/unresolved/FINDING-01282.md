...
| Original report | [FINDING-idealdcdc-ti-divzero.md](../../bugs/FINDING-idealdcdc-ti-divzero.md) |
| Original SHA-256 | `d4865f185f37f783646f5cb3519a5adf377385733d3b18d245703ff3a636fe03` |
...
```modelica
model V2OMC_cf1bfacddbcdd284
  extends Modelica.Electrical.Machines.Examples.ControlledDCDrives.Utilities.IdealDcDc(Ti=0);
end V2OMC_cf1bfacddbcdd284;
```

Relevant OMC diagnostic:

```text
messages = "Failed to build model: V2OMC_cf1bfacddbcdd284",
