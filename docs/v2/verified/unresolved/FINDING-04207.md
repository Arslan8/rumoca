...
| Target | `core.material.B_myMax` |
| Declaration/site | `target/msl/ModelicaStandardLibrary-4.1.0/Modelica 4.1.0/Magnetic/FluxTubes/BaseClasses/FixedShape.mo:31` |
| Original report | [FINDING-toroidalcorequadraticcrosssection-core-material-b-mymax-divzero.md](../../bugs/FINDING-toroidalcorequadraticcrosssection-core-material-b-mymax-divzero.md) |
| Original SHA-256 | `123a9f05d8a167a298473a706cee1018789b14797bc8d766fc1f8eb3a3afea94` |
...
```modelica
model V2OMC_4df40b821122453a
  extends Modelica.Magnetic.FluxTubes.Examples.BasicExamples.ToroidalCoreQuadraticCrossSection(core.material.B_myMax=0);
end V2OMC_4df40b821122453a;
```
