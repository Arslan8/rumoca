...
| Original report | [FINDING-simplesolenoid-g-mairpar-material-b-mymax-divzero.md](../../bugs/FINDING-simplesolenoid-g-mairpar-material-b-mymax-divzero.md) |
| Original SHA-256 | `6a994bd540f111eaec20b6e9a1d2f815d79eab6a34dbbd56c019730804e8bb47` |
...
```modelica
model V2OMC_774cf72b8bcc32ef
  extends Modelica.Magnetic.FluxTubes.Examples.SolenoidActuator.Components.SimpleSolenoid(g_mAirPar.material.B_myMax=0);
end V2OMC_774cf72b8bcc32ef;
```

Relevant OMC diagnostic:

```text
messages = "Failed to build model: V2OMC_774cf72b8bcc32ef",
