...
| Original report | [FINDING-pumpandvalve-medium-cp-divzero-3.md](../../bugs/FINDING-pumpandvalve-medium-cp-divzero-3.md) |
| Original SHA-256 | `2c5683cc03decc86799594f2f013499f16181b0c416afe043db51439f1dd75de` |
...
```modelica
model V2OMC_0437c4db42561db5
  extends Modelica.Thermal.FluidHeatFlow.Examples.PumpAndValve(medium.cp=0);
end V2OMC_0437c4db42561db5;
```
