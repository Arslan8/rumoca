...
| Original report | [FINDING-sensors-genericfluxtube-material-b-mymax-divzero.md](../../bugs/FINDING-sensors-genericfluxtube-material-b-mymax-divzero.md) |
| Original SHA-256 | `f0d3d3a2534314a77d3b5167e97f5fbf68dbec501e1861ef0165a188e022fc4a` |
...
```modelica
model V2OMC_cacff23479890800
  extends ModelicaTest.Magnetic.FluxTubes.Sensors(genericFluxTube.material.B_myMax=0);
end V2OMC_cacff23479890800;
```
