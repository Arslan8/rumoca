...
| Original report | [FINDING-pumpdropout-medium-cp-divzero-3.md](../../bugs/FINDING-pumpdropout-medium-cp-divzero-3.md) |
| Original SHA-256 | `468d0447e96499f20fe5ca7bef9511e171697112206649870b27843a4d4a7310` |
...
```modelica
model V2OMC_ad9a54c696f96d01
  extends Modelica.Thermal.FluidHeatFlow.Examples.PumpDropOut(medium.cp=0);
end V2OMC_ad9a54c696f96d01;
```
