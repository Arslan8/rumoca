...
| Original report | [FINDING-dcdcinverter-imotfilter-t-divzero.md](../../bugs/FINDING-dcdcinverter-imotfilter-t-divzero.md) |
| Original SHA-256 | `bd9eeeef339e3418985e46048fb0988d5e831ff3f6aeb67113c9a64b60bc2fc8` |
...
```modelica
model V2OMC_e63a91ec817216bf
  extends Modelica.Electrical.Machines.Examples.ControlledDCDrives.Utilities.DcdcInverter(iMotFilter.T=0);
end V2OMC_e63a91ec817216bf;
```

Relevant OMC diagnostic:

```text
messages = "Failed to build model: V2OMC_e63a91ec817216bf",
