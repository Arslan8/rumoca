# SITE-0008: `Jr` — nothing bounds this declaration at all

| | |
|---|---|
| **Declaration** | `PartialBasicMachine.mo:5` |
| **Parameter** | `Jr` |
| **Reached as** | `aimc.Jr`, `aims.Jr`, `dcee.Jr`, `dcpm.Jr` … |
| **Finding** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Models reaching it** | 35 |
...
…and 15 more; the full list is in `docs/runs/data/`.
