# SITE-0142: `GoffTransistor` — nothing bounds this declaration at all

| | |
|---|---|
| **Declaration** | `SinglePhase2Level.mo:6` |
| **Parameter** | `GoffTransistor` |
| **Reached as** | `hbridge.inverter_n.GoffTransistor`, `hbridge.inverter_p.GoffTransistor`, `inverter.GoffTransistor` |
