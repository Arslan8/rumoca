# SITE-0136: `Lrsigmaq` — nothing bounds this declaration at all

| | |
|---|---|
| **Declaration** | `DamperCage.mo:5` |
| **Parameter** | `Lrsigmaq` |
| **Reached as** | `smee.damperCage.Lrsigmaq`, `smpm.damperCage.Lrsigmaq`, `smr.damperCage.Lrsigmaq` |
