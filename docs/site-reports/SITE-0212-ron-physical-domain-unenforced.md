# SITE-0212: `Ron` — nothing bounds this declaration at all

| | |
|---|---|
| **Declaration** | `IdealCommutingSwitch.mo:4` |
| **Parameter** | `Ron` |
| **Reached as** | `idealCommutingSwitch.Ron`, `switchedRheostat.idealCommutingSwitch.Ron` |
