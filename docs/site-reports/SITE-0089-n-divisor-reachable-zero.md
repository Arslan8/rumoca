# SITE-0089: `n` — a settable parameter reaches a denominator with nothing excluding zero

| | |
|---|---|
| **Declaration** | `BaseData.mo:13` |
| **Parameter** | `n` |
| **Reached as** | `G_mLeakRad.material.n`, `airGap.material.n`, `core.material.n`, `g_mAirPar.material.n` … |
...
## How it was matched
- **parameter**: `leftLeg.material.n`
- **shape**: `sum`
- **path**: `leftLeg.material.n`
- **declared_min**: `None`
- **divisor_sites**: `1`
