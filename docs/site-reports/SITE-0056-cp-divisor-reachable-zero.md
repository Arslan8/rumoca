# SITE-0056: `cp` — a settable parameter reaches a denominator with nothing excluding zero

| | |
|---|---|
| **Declaration** | `Medium.mo:5` |
| **Parameter** | `cp` |
| **Reached as** | `ambient1.medium.cp`, `ambient2.medium.cp`, `cooling.medium.cp`, `idealPump.medium.cp` … |
...
## How it was matched
- **parameter**: `inlet.medium.cp`
- **shape**: `direct`
- **path**: `inlet.medium.cp`
- **declared_min**: `None`
- **divisor_sites**: `2`
