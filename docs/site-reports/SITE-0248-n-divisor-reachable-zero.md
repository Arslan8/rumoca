# SITE-0248: `n` — a settable parameter reaches a denominator with nothing excluding zero

| | |
|---|---|
| **Declaration** | `IdealTransformer.mo:4` |
| **Parameter** | `n` |
| **Reached as** | `idealTransformer.idealTransformer[1].n`, `idealTransformer.idealTransformer[2].n`, `idealTransformer.idealTransformer[3].n` |
