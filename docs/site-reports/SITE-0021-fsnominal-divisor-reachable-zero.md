# SITE-0021: `fsNominal` — a settable parameter reaches a denominator with nothing excluding zero

| | |
|---|---|
| **Declaration** | `InductionMachineData.mo:9` |
| **Parameter** | `fsNominal` |
| **Reached as** | `aimcData.fsNominal`, `aimsData.fsNominal`, `imcData.fsNominal`, `smpmData.fsNominal` … |
| **Finding** | `divisor-reachable-zero` |
| **Severity** | medium |
| **Sanitizer** | `divisor` |
| **Models reaching it** | 20 |
...
## How it was matched
- **parameter**: `imcData.fsNominal`
- **shape**: `product`
- **path**: `imcData.fsNominal`
- **declared_min**: `None`
- **divisor_sites**: `6`
