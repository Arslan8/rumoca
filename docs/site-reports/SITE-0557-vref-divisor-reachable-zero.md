# SITE-0557: `vRef` — a settable parameter reaches a denominator with nothing excluding zero

| | |
|---|---|
| **Declaration** | `Vehicle.mo:31` |
| **Parameter** | `vRef` |
| **Reached as** | `vehicleDrag.vRef`, `vehicleDragInConst.vRef`, `vehicleDragInVar.vRef`, `vehicleInclination.vRef` … |
