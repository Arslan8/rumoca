# SITE-0135: `Lrsigmad` — nothing bounds this declaration at all

| | |
|---|---|
| **Declaration** | `DamperCage.mo:3` |
| **Parameter** | `Lrsigmad` |
| **Reached as** | `smee.damperCage.Lrsigmad`, `smpm.damperCage.Lrsigmad`, `smr.damperCage.Lrsigmad` |
