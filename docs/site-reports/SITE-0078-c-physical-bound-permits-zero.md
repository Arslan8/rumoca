# SITE-0078: `c` — the declaration explicitly permits zero, via `min=0`

| | |
|---|---|
| **Declaration** | `ElastoGap.mo:4` |
| **Parameter** | `c` |
| **Reached as** | `armature.stopper_xMax.c`, `armature.stopper_xMin.c`, `cActuator.armature.stopper_xMax.c`, `cActuator.armature.stopper_xMin.c` … |
...
`pmActuator.armature.stopper_xMax.c > 0`
