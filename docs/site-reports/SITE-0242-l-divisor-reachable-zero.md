# SITE-0242: `l` — a settable parameter reaches a denominator with nothing excluding zero

| | |
|---|---|
| **Declaration** | `GenericFluxTube.mo:8` |
| **Parameter** | `l` |
| **Reached as** | `genericFluxTube.l`, `genericFluxTube1.l`, `genericFluxTube2.l`, `genericFluxTube3.l` |
