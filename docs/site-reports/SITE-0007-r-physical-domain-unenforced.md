# SITE-0007: `R` — nothing bounds this declaration at all

| | |
|---|---|
| **Declaration** | `Resistor.mo:4` |
| **Parameter** | `R` |
| **Reached as** | `R`, `aimc.rs.R`, `aims.rr.R`, `aims.rs.R` … |
| **Finding** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Models reaching it** | 40 |
...
…and 20 more; the full list is in `docs/runs/data/`.
