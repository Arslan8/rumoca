# SITE-0043: `IaNominal` — a settable parameter reaches a denominator with nothing excluding zero

| | |
|---|---|
| **Declaration** | `DcPermanentMagnetData.mo:10` |
| **Parameter** | `IaNominal` |
| **Reached as** | `dceeData.IaNominal`, `dcpmData.IaNominal`, `dcpmData1.IaNominal`, `dcpmData2.IaNominal` … |
