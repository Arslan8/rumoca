# SITE-0111: `m` — the declaration explicitly permits zero, via `min=0`

| | |
|---|---|
| **Declaration** | `TranslatoryArmatureAndStopper.mo:7` |
| **Parameter** | `m` |
| **Reached as** | `armature.m`, `cActuator.armature.m`, `m`, `pmActuator.armature.m` |
