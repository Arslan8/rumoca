# SITE-0129: `unitTime` — a settable parameter reaches a denominator with nothing excluding zero

| | |
|---|---|
| **Declaration** | `Continuous.mo:817` |
| **Parameter** | `unitTime` |
| **Reached as** | `PID1.unitTime`, `PID2.unitTime`, `limPID.unitTime` |
...
| `ModelicaTest.Blocks.StrictLimiters` |
