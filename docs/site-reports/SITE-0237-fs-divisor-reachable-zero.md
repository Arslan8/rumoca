# SITE-0237: `fS` — a settable parameter reaches a denominator with nothing excluding zero

| | |
|---|---|
| **Declaration** | `DcdcInverter.mo:4` |
| **Parameter** | `fS` |
| **Reached as** | `dcdcInverter1.fS`, `dcdcInverter2.fS`, `fS` |
