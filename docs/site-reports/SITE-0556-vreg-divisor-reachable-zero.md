# SITE-0556: `vReg` — a settable parameter reaches a denominator with nothing excluding zero

| | |
|---|---|
| **Declaration** | `Vehicle.mo:21` |
| **Parameter** | `vReg` |
| **Reached as** | `vehicleDrag.vReg`, `vehicleDragInConst.vReg`, `vehicleDragInVar.vReg`, `vehicleInclination.vReg` … |
