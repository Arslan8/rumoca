# SITE-0171: `unitVoltage` — a settable parameter reaches a denominator with nothing excluding zero

| | |
|---|---|
| **Declaration** | `IdealDcDc.mo:49` |
| **Parameter** | `unitVoltage` |
| **Reached as** | `dcdcInverter1.idealDcDc.unitVoltage`, `dcdcInverter2.idealDcDc.unitVoltage`, `idealDcDc.unitVoltage`, `unitVoltage` |
