# SITE-0141: `RonTransistor` — nothing bounds this declaration at all

| | |
|---|---|
| **Declaration** | `SinglePhase2Level.mo:4` |
| **Parameter** | `RonTransistor` |
| **Reached as** | `hbridge.inverter_n.RonTransistor`, `hbridge.inverter_p.RonTransistor`, `inverter.RonTransistor` |
