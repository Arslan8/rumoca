# SITE-0091: `T_ref` — a settable parameter reaches a denominator with nothing excluding zero

| | |
|---|---|
| **Declaration** | `Conductor.mo:5` |
| **Parameter** | `T_ref` |
| **Reached as** | `G.T_ref`, `conductor.T_ref`, `conductor1.T_ref`, `conductor4.conductor.T_ref` … |
