# SITE-0055: `rho` — a settable parameter reaches a denominator with nothing excluding zero

| | |
|---|---|
| **Declaration** | `Medium.mo:4` |
| **Parameter** | `rho` |
| **Reached as** | `cooling.medium.rho`, `idealPump.medium.rho`, `innerMedium.rho`, `medium.rho` … |
