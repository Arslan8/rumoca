# SITE-0146: `V1` — a settable parameter reaches a denominator with nothing excluding zero

| | |
|---|---|
| **Declaration** | `TransformerData.mo:5` |
| **Parameter** | `V1` |
| **Reached as** | `transformerData.V1`, `transformerData1.V1`, `transformerData2.V1` |
