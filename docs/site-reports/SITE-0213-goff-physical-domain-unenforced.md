# SITE-0213: `Goff` — nothing bounds this declaration at all

| | |
|---|---|
| **Declaration** | `IdealCommutingSwitch.mo:6` |
| **Parameter** | `Goff` |
| **Reached as** | `idealCommutingSwitch.Goff`, `switchedRheostat.idealCommutingSwitch.Goff` |
