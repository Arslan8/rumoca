# SITE-0103: `C2` — a settable parameter reaches a denominator with nothing excluding zero

| | |
|---|---|
| **Declaration** | `TransformerData.mo:11` |
| **Parameter** | `C2` |
| **Reached as** | `transformerData.C2`, `transformerData1.C2`, `transformerData2.C2` |
