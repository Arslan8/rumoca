# SITE-0045: `VaNominal` — a settable parameter reaches a denominator with nothing excluding zero

| | |
|---|---|
| **Declaration** | `DcPermanentMagnetData.mo:7` |
| **Parameter** | `VaNominal` |
| **Reached as** | `dceeData.VaNominal`, `dcpmData.VaNominal`, `dcpmData1.VaNominal`, `dcpmData2.VaNominal` … |
