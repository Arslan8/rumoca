# SITE-0106: `m` — the declaration explicitly permits zero, via `min=0`

| | |
|---|---|
| **Declaration** | `LineForceWithMass.mo:23` |
| **Parameter** | `m` |
| **Reached as** | `spring.lineForce.m`, `spring1.lineForce.m`, `spring2.lineForce.m`, `spring3.lineForce.m` |
