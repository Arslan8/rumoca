# SITE-0152: `Ron` — the declaration explicitly permits zero, via `min=0`

| | |
|---|---|
| **Declaration** | `IdealTwoWaySwitch.mo:3` |
| **Parameter** | `Ron` |
| **Reached as** | `R1.IdealCommutingSwitch1.Ron`, `R1.IdealCommutingSwitch2.Ron`, `R10.IdealCommutingSwitch1.Ron`, `R10.IdealCommutingSwitch2.Ron` … |
...
`R4.IdealCommutingSwitch1.Ron > 0`
