# SITE-0140: `GoffDiode` — nothing bounds this declaration at all

| | |
|---|---|
| **Declaration** | `SinglePhase2Level.mo:12` |
| **Parameter** | `GoffDiode` |
| **Reached as** | `hbridge.inverter_n.GoffDiode`, `hbridge.inverter_p.GoffDiode`, `inverter.GoffDiode` |
