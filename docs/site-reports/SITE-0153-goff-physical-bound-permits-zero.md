# SITE-0153: `Goff` — the declaration explicitly permits zero, via `min=0`

| | |
|---|---|
| **Declaration** | `IdealTwoWaySwitch.mo:4` |
| **Parameter** | `Goff` |
| **Reached as** | `R1.IdealCommutingSwitch1.Goff`, `R1.IdealCommutingSwitch2.Goff`, `R10.IdealCommutingSwitch1.Goff`, `R10.IdealCommutingSwitch2.Goff` … |
...
`R4.IdealCommutingSwitch1.Goff > 0`
