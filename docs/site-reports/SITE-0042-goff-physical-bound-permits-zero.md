# SITE-0042: `Goff` — the declaration explicitly permits zero, via `min=0`

| | |
|---|---|
| **Declaration** | `IdealSwitch.mo:6` |
| **Parameter** | `Goff` |
| **Reached as** | `idealCloser.Goff`, `idealCloser.idealClosingSwitch[1].Goff`, `idealCloser.idealClosingSwitch[2].Goff`, `idealCloser.idealClosingSwitch[3].Goff` … |
