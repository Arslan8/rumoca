# SITE-0118: `L1sigma` — nothing bounds this declaration at all

| | |
|---|---|
| **Declaration** | `TransformerData.mo:40` |
| **Parameter** | `L1sigma` |
| **Reached as** | `transformerData.L1sigma`, `transformerData1.L1sigma`, `transformerData2.L1sigma` |
