# SITE-0780: `nJ` — nothing bounds this declaration at all

| | |
|---|---|
| **Declaration** | `Rotor1D.mo:147` |
| **Parameter** | `nJ` |
| **Reached as** | `inertia1.rotorWith3DEffects.nJ`, `inertia2.rotorWith3DEffects.nJ` |
...
`inertia1.rotorWith3DEffects.nJ > 0`
