# SITE-0631: `J` — the declaration explicitly permits zero, via `min=0`

| | |
|---|---|
| **Declaration** | `Rotor1D.mo:78` |
| **Parameter** | `J` |
| **Reached as** | `inertia1.rotorWith3DEffects.J`, `inertia2.rotorWith3DEffects.J` |
...
`inertia1.rotorWith3DEffects.J > 0`
