# SITE-0088: `c_b` — a settable parameter reaches a denominator with nothing excluding zero

| | |
|---|---|
| **Declaration** | `BaseData.mo:12` |
| **Parameter** | `c_b` |
| **Reached as** | `G_mLeakRad.material.c_b`, `airGap.material.c_b`, `core.material.c_b`, `g_mAirPar.material.c_b` … |
...
## How it was matched
- **parameter**: `leftLeg.material.c_b`
- **shape**: `sum`
- **path**: `leftLeg.material.c_b`
- **declared_min**: `None`
- **divisor_sites**: `1`
