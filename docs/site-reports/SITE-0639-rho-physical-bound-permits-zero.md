# SITE-0639: `rho` — the declaration explicitly permits zero, via `min=0`

| | |
|---|---|
| **Declaration** | `Vehicle.mo:11` |
| **Parameter** | `rho` |
| **Reached as** | `vehicleDrag.rho`, `vehicleDragInConst.rho`, `vehicleDragInVar.rho`, `vehicleInclination.rho` … |
