# SITE-0365: `Roff` — nothing bounds this declaration at all

| | |
|---|---|
| **Declaration** | `Thyristor.mo:40` |
| **Parameter** | `Roff` |
| **Reached as** | `simpleTriac.thyristor.Roff`, `simpleTriac.thyristor1.Roff`, `thyristor_v4_1.Roff` |
