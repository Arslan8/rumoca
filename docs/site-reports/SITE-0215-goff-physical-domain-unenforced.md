# SITE-0215: `Goff` — nothing bounds this declaration at all

| | |
|---|---|
| **Declaration** | `IdealSwitchWithArc.mo:5` |
| **Parameter** | `Goff` |
| **Reached as** | `switch2.Goff`, `switchYDwithArc.idealCloser.closerWithArc[1].Goff`, `switchYDwithArc.idealCloser.closerWithArc[2].Goff`, `switchYDwithArc.idealCloser.closerWithArc[3].Goff` … |
