# SITE-0119: `Z2ph` — nothing bounds this declaration at all

| | |
|---|---|
| **Declaration** | `TransformerData.mo:43` |
| **Parameter** | `Z2ph` |
| **Reached as** | `transformerData.Z2ph`, `transformerData1.Z2ph`, `transformerData2.Z2ph` |
