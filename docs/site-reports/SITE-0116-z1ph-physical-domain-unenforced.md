# SITE-0116: `Z1ph` — nothing bounds this declaration at all

| | |
|---|---|
| **Declaration** | `TransformerData.mo:35` |
| **Parameter** | `Z1ph` |
| **Reached as** | `transformerData.Z1ph`, `transformerData1.Z1ph`, `transformerData2.Z1ph` |
