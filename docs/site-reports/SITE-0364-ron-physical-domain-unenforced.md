# SITE-0364: `Ron` — nothing bounds this declaration at all

| | |
|---|---|
| **Declaration** | `Thyristor.mo:38` |
| **Parameter** | `Ron` |
| **Reached as** | `simpleTriac.thyristor.Ron`, `simpleTriac.thyristor1.Ron`, `thyristor_v4_1.Ron` |
