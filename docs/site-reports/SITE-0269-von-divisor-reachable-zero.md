# SITE-0269: `Von` — a settable parameter reaches a denominator with nothing excluding zero

| | |
|---|---|
| **Declaration** | `Thyristor.mo:36` |
| **Parameter** | `Von` |
| **Reached as** | `simpleTriac.thyristor.Von`, `simpleTriac.thyristor1.Von`, `thyristor_v4_1.Von` |
