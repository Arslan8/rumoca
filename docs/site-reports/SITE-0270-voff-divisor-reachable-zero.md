# SITE-0270: `Voff` — a settable parameter reaches a denominator with nothing excluding zero

| | |
|---|---|
| **Declaration** | `Thyristor.mo:37` |
| **Parameter** | `Voff` |
| **Reached as** | `simpleTriac.thyristor.Voff`, `simpleTriac.thyristor1.Voff`, `thyristor_v4_1.Voff` |
