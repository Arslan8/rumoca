# SITE-0147: `V2` — a settable parameter reaches a denominator with nothing excluding zero

| | |
|---|---|
| **Declaration** | `TransformerData.mo:9` |
| **Parameter** | `V2` |
| **Reached as** | `transformerData.V2`, `transformerData1.V2`, `transformerData2.V2` |
