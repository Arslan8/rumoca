# SITE-0104: `SNominal` — a settable parameter reaches a denominator with nothing excluding zero

| | |
|---|---|
| **Declaration** | `TransformerData.mo:16` |
| **Parameter** | `SNominal` |
| **Reached as** | `transformerData.SNominal`, `transformerData1.SNominal`, `transformerData2.SNominal` |
