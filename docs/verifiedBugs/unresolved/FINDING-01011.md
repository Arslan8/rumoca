# FINDING-01011: Not yet established as a bug or a false positive
...
| Target | simpleTriac.IGT |
| Student classification | divisor-reachable-zero |
| Original report | `FINDING-01011-simpletriaccircuit-simpletriac-igt.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | f35af5b610bbf3fde23d1cb9d6ee18605c374d631a2ae4e581b2d6126effb6e6 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Semiconductors/SimpleTriac.mo:13`. Role: `parameter`; binding: `0.005`; effective min: `None`; effective max: `None`. 
