# FINDING-01497: Not yet established as a bug or a false positive
...
| Original report | `FINDING-01497-dcse-singlephase-tramp.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 1073c42295c8d69976e840d2008a0f796bfccb7ac457bc15931850fc7140672f |
...
Compiler/source-resolved declaration: `Electrical/Machines/Examples/DCMachines/DCSE_SinglePhase.mo:7`. Role: `parameter`; binding: `0.9`; effective min: `None`; effective max: `None`. 
...
```modelica
5:   parameter SI.Voltage Va=100 "Actual armature voltage RMS";
