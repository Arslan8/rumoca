# FINDING-00836: Not yet established as a bug or a false positive
...
| Original report | [FINDING-invertingamplifier-gain-r2-zerolimit.md](../../v2/bugs/FINDING-invertingamplifier-gain-r2-zerolimit.md) — reviewed as `FINDING-00836-invertingamplifier-gain-r2.md`, which a later run renamed |
| Original SHA-256 | f584072dbb458ef697982720b33f6bdcb1d1d01e6b6581a5067dbdc6e8c54c37 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Examples/OpAmps/OpAmpCircuits/Gain.mo:6`. Role: `parameter`; binding: `2000`; effective min: `None`; effective max: `None`. 
