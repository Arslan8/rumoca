# FINDING-03569: Not yet established as a bug or a false positive
...
| Original report | [FINDING-chopperstepdown-rl-rload-zerolimit.md](../../v2/bugs/FINDING-chopperstepdown-rl-rload-zerolimit.md) — reviewed as `FINDING-03569-chopperstepdown-rl-rload.md`, which a later run renamed |
| Original SHA-256 | 5cb8698d1fbe9f2b53282899a7e1e4e9a687b1e6e547d36a0bfee377441469cd |
...
Compiler/source-resolved declaration: `Electrical/PowerConverters/Examples/DCDC/ExampleTemplates/ChopperStepDown.mo:10`. Role: `parameter`; binding: `(V0 / ILoad)`; effective min: `None`; effective max: `None`. 
