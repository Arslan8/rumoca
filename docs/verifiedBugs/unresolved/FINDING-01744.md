# FINDING-01744: Not yet established as a bug or a false positive
...
| Original report | `FINDING-01744-imc-inverterdrive-wload.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | a8c7f6dd33fc9de9754bf215e4c64bf8fbcb568d5197f6d89ad6cc920ab9fac9 |
...
Compiler/source-resolved declaration: `Electrical/Machines/Examples/InductionMachines/IMC_InverterDrive.mo:16`. Role: `parameter`; binding: `(((1440.45 * 2) * (2 * asin(1.0))) / 60)`; effective min: `None`; effective max: `None`. 
