# FINDING-01742: Not yet established as a bug or a false positive
...
| Original report | [FINDING-imc-inverterdrive-aimcdata-rr-unbounded.md](../../v2/bugs/FINDING-imc-inverterdrive-aimcdata-rr-unbounded.md) — reviewed as `FINDING-01742-imc-inverterdrive-aimcdata-rr.md`, which a later run renamed |
| Original SHA-256 | 6bc311d04001a66706c0d6f17c96e8c46009d39759c8aa0fcbee41ab1d7bc6cc |
...
Compiler/source-resolved declaration: `Electrical/Machines/Utilities/ParameterRecords/IM_SquirrelCageData.mo:13`. Role: `parameter`; binding: `(0.04 * 16)`; effective min: `None`; effective max: `None`. 
