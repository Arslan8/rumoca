# FINDING-04235: Not yet established as a bug or a false positive
...
| Original report | [FINDING-bevelgear1d-bodybox-mi-zerolimit.md](../../v2/bugs/FINDING-bevelgear1d-bodybox-mi-zerolimit.md) — reviewed as `FINDING-04235-bevelgear1d-bodybox-mi.md`, which a later run renamed |
| Original SHA-256 | d3cd3df4bd115a6f89605afb8261492a119796e7b56d6a96b134d04c15267076 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/BodyBox.mo:103`. Role: `parameter`; binding: `(((bodyBox.density * bodyBox.length) * bodyBox.innerWidth) * bodyBox.innerHeight)`; effective min: `0`; effective max: `None`. 
