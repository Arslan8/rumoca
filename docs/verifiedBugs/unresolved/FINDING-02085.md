# FINDING-02085: Not yet established as a bug or a false positive
...
| Original report | [FINDING-ims-start-switchedrheostat-idealcommutingswitch-ron-ruleoff.md](../../v2/bugs/FINDING-ims-start-switchedrheostat-idealcommutingswitch-ron-ruleoff.md) — reviewed as `FINDING-02085-ims-start-switchedrheostat-idealcommutingswitch-ron.md`, which a later run renamed |
| Original SHA-256 | 0eda98dc30a24ac5b617651093f0ee231479a6ca07d7d4c69353399e62cece76 |
...
Compiler/source-resolved declaration: `Electrical/Polyphase/Ideal/IdealCommutingSwitch.mo:4`. Role: `parameter`; binding: `fill(1e-05, switchedRheostat.m)`; effective min: `zeros(3)`; effective max: `None`. 
