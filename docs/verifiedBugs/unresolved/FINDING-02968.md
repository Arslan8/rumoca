# FINDING-02968: Not yet established as a bug or a false positive
...
| Original report | [FINDING-transformeryd-rl-ruleoff.md](../../v2/bugs/FINDING-transformeryd-rl-ruleoff.md) — reviewed as `FINDING-02968-transformeryd-rl.md`, which a later run renamed |
| Original SHA-256 | ea16feda58c8678031bfc40ddcd1cacb8695b8aebe1fbd777c62acdbd207ed2f |
...
Compiler/source-resolved declaration: `Electrical/Polyphase/Examples/TransformerYD.mo:11`. Role: `parameter`; binding: `1`; effective min: `None`; effective max: `None`. 
