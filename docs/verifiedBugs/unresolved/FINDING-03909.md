# FINDING-03909: Not yet established as a bug or a false positive
...
| Original report | [FINDING-doublependuluminittip-boxbody2-m-zerolimit.md](../../v2/bugs/FINDING-doublependuluminittip-boxbody2-m-zerolimit.md) — reviewed as `FINDING-03909-doublependuluminittip-boxbody2-m.md`, which a later run renamed |
| Original SHA-256 | 626ab26f3e1693fd87e489eed705395e2ad907807ceb6f47f720898db6bb7649 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/BodyBox.mo:105`. Role: `parameter`; binding: `(boxBody2.mo - boxBody2.mi)`; effective min: `0`; effective max: `None`. 
