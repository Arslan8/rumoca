# FINDING-02790: Not yet established as a bug or a false positive
...
| Target | transformer1.L1sigma |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-rectifier12pulse-transformer1-l1sigma-zerolimit.md](../../v2/bugs/FINDING-rectifier12pulse-transformer1-l1sigma-zerolimit.md) — reviewed as `FINDING-02790-rectifier12pulse-transformer1-l1sigma.md`, which a later run renamed |
| Original SHA-256 | 99da86641ade3b34452b6cb29cecd63b7b8a17a6a9db108258a69f5849ee44f4 |
...
Compiler/source-resolved declaration: `Electrical/Machines/Interfaces/PartialBasicTransformer.mo:18`. Role: `parameter`; binding: `transformerData1.L1sigma`; effective min: `None`; effective max: `None`. 
