# FINDING-02984: Not yet established as a bug or a false positive
...
| Original report | [FINDING-transformeryy-rl-ruleoff.md](../../v2/bugs/FINDING-transformeryy-rl-ruleoff.md) — reviewed as `FINDING-02984-transformeryy-rl.md`, which a later run renamed |
| Original SHA-256 | 0e3ea0c9c691db4f905c38ff15e4734385d1abe4b5cded2808ceda185ee9469d |
...
Compiler/source-resolved declaration: `Electrical/Polyphase/Examples/TransformerYY.mo:11`. Role: `parameter`; binding: `1`; effective min: `None`; effective max: `None`. 
