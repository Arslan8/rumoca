# FINDING-02380: Not yet established as a bug or a false positive
...
| Target | smpm.damperCage.Lrsigmad |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-smpm-inverter-smpm-dampercage-lrsigmad-zerolimit.md](../../v2/bugs/FINDING-smpm-inverter-smpm-dampercage-lrsigmad-zerolimit.md) — reviewed as `FINDING-02380-smpm-inverter-smpm-dampercage-lrsigmad.md`, which a later run renamed |
| Original SHA-256 | f7e21bb191ca91e88452251a9020908ae4d1cffbd4c47b6dda4a60d83e32fc35 |
...
Compiler/source-resolved declaration: `Electrical/Machines/BasicMachines/Components/DamperCage.mo:3`. Role: `parameter`; binding: `smpmData.Lrsigmad`; effective min: `None`; effective max: `None`. 
