# FINDING-00189: Not yet established as a bug or a false positive
...
| Original report | [FINDING-comparetransformers-lm1-intent.md](../../v2/bugs/FINDING-comparetransformers-lm1-intent.md) — reviewed as `FINDING-00189-comparetransformers-lm1.md`, which a later run renamed |
| Original SHA-256 | 261175021add0265943167096bdb14365eb4e1db19333cff23937d2c46787a04 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Examples/CompareTransformers.mo:15`. Role: `parameter`; binding: `(10.0 / ((2 * (2 * asin(1.0))) * f))`; effective min: `None`; effective max: `None`. 
