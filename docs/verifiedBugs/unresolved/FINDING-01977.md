# FINDING-01977: Not yet established as a bug or a false positive
...
| Original report | `FINDING-01977-imc-ydarc-wload.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | a6d15ff76d67a9cab45b611d7276f00eaf041b3bb73fc35fc8af4c7ebf0a14c2 |
...
Compiler/source-resolved declaration: `Electrical/Machines/Examples/InductionMachines/IMC_YDarc.mo:14`. Role: `parameter`; binding: `(((1440.45 * 2) * (2 * asin(1.0))) / 60)`; effective min: `None`; effective max: `None`. 
