# FINDING-00808: Not yet established as a bug or a false positive
...
| Original report | [FINDING-differentialamplifier-data-r1-intent.md](../../v2/bugs/FINDING-differentialamplifier-data-r1-intent.md) — reviewed as `FINDING-00808-differentialamplifier-data-r1.md`, which a later run renamed |
| Original SHA-256 | 59535a56ae112b29f9606f1c8ef34bbddafbc2c4cd6df9b36e9e881b785fe13c |
...
Compiler/source-resolved declaration: `Electrical/Analog/Examples/OpAmps/OpAmpCircuits/DifferentialAmplifierData.mo:18`. Role: `parameter`; binding: `100000.0`; effective min: `None`; effective max: `None`. 
