# FINDING-03252: Not yet established as a bug or a false positive
...
| Original report | [FINDING-thyristorbridge2pulse-dc-drive-smains-divzero-2.md](../../v2/bugs/FINDING-thyristorbridge2pulse-dc-drive-smains-divzero-2.md) — reviewed as `FINDING-03252-thyristorbridge2pulse-dc-drive-smains.md`, which a later run renamed |
| Original SHA-256 | 96a98ad25ee030178e3a99d5ba3f8cb1dd3a0708499ea547ada19576985668d1 |
...
Compiler/source-resolved declaration: `Electrical/PowerConverters/Examples/ACDC/RectifierBridge2Pulse/ThyristorBridge2Pulse_DC_Drive.mo:9`. Role: `parameter`; binding: `250000.0`; effective min: `None`; effective max: `None`. 
