# FINDING-01017: Not yet established as a bug or a false positive
...
| Target | simpleTriac.IH |
| Student classification | divisor-reachable-zero |
| Original report | `FINDING-01017-simpletriaccircuit-simpletriac-ih.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 5979d6249e48b3980b9cfe862cdf041fb8293959695e99713376a3e128b44c89 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Semiconductors/SimpleTriac.mo:9`. Role: `parameter`; binding: `0.006`; effective min: `None`; effective max: `None`. 
