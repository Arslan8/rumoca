# FINDING-05134: Not yet established as a bug or a false positive
...
| Original report | [FINDING-roverplant-speed-tau-divzero.md](../../v2/bugs/FINDING-roverplant-speed-tau-divzero.md) — reviewed as `FINDING-05134-roverplant-speed-tau.md`, which a later run renamed |
| Original SHA-256 | 83f18162d15a599925c061d25ebc78d12b043c8a60f5fddda61afdb7a8a3a819 |
...
Compiler/source-resolved declaration: `/data/mrumoca/rumoca/target/cmm/CMM-a642c381/RigidBody/Examples/RoverPlant.mo:18`. Role: `parameter`; binding: `0.35`; effective min: `None`; effective max: `None`. 
