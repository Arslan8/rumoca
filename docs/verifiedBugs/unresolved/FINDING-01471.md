# FINDING-01471: Not yet established as a bug or a false positive
...
| Target | dcpmData2.TaRef |
| Student classification | divisor-reachable-zero |
| Original report | `FINDING-01471-dcpm-withlosses-dcpmdata2-taref.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 2bbda4f3dca3106a20b5152d8eac206923e0bb01d6d6d461cced1554943b828a |
...
Compiler/source-resolved declaration: `Electrical/Machines/Utilities/ParameterRecords/DcPermanentMagnetData.mo:22`. Role: `parameter`; binding: `293.15`; effective min: `0.0`; effective max: `None`. 
