# FINDING-05137: Not yet established as a bug or a false positive
...
| Original report | [FINDING-roverplant-height-tau-divzero.md](../../v2/bugs/FINDING-roverplant-height-tau-divzero.md) — reviewed as `FINDING-05137-roverplant-height-tau.md`, which a later run renamed |
| Original SHA-256 | f85654675271a12233753a324fde53c3f98cbe8c0fc447befdbd5c230d110ca6 |
...
Compiler/source-resolved declaration: `/data/mrumoca/rumoca/target/cmm/CMM-a642c381/RigidBody/Examples/RoverPlant.mo:22`. Role: `parameter`; binding: `0.08`; effective min: `None`; effective max: `None`. 
