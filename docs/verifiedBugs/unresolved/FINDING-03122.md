# FINDING-03122: Not yet established as a bug or a false positive
...
| Original report | [FINDING-thyristorbridge2mpulse-rl-r-zerolimit.md](../../v2/bugs/FINDING-thyristorbridge2mpulse-rl-r-zerolimit.md) — reviewed as `FINDING-03122-thyristorbridge2mpulse-rl-r.md`, which a later run renamed |
| Original SHA-256 | 62fc6aa648262df4475e63da75f0f00d56bfff443b12ca2485c4b2dc0d908f8d |
...
Compiler/source-resolved declaration: `Electrical/PowerConverters/Examples/ACDC/RectifierBridge2mPulse/ThyristorBridge2mPulse_RL.mo:11`. Role: `parameter`; binding: `20`; effective min: `None`; effective max: `None`. 
