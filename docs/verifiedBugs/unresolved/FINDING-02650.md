# FINDING-02650: Not yet established as a bug or a false positive
...
| Original report | [FINDING-smr-inverter-smrdata-rrq-unbounded.md](../../v2/bugs/FINDING-smr-inverter-smrdata-rrq-unbounded.md) — reviewed as `FINDING-02650-smr-inverter-smrdata-rrq.md`, which a later run renamed |
| Original SHA-256 | e2d5a595e3d209858701bb2813d9075d844ca52b00b0df06eed2d4dd4f36417a |
...
Compiler/source-resolved declaration: `Electrical/Machines/Utilities/ParameterRecords/SM_ReluctanceRotorData.mo:30`. Role: `parameter`; binding: `smrData.Rrd`; effective min: `None`; effective max: `None`. 
