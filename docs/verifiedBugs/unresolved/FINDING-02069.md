# FINDING-02069: Not yet established as a bug or a false positive
...
| Original report | [FINDING-ims-start-aims-lrsigma-zerolimit.md](../../v2/bugs/FINDING-ims-start-aims-lrsigma-zerolimit.md) — reviewed as `FINDING-02069-ims-start-aims-lrsigma.md`, which a later run renamed |
| Original SHA-256 | 8413adfd81795ffc0e3949e58d53c73b73c7641cbcd7817d1d2f8f101f9614ef |
...
Compiler/source-resolved declaration: `Electrical/Machines/BasicMachines/InductionMachines/IM_SlipRing.mo:30`. Role: `parameter`; binding: `aimsData.Lrsigma`; effective min: `None`; effective max: `None`. 
