# FINDING-05141: Not yet established as a bug or a false positive
...
| Original report | `FINDING-05141-quadrotorsil-tau-up.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 5dc834c44300f8080e0b03c7305212b543be5e6929446ed8ba30096dac29b074 |
...
Compiler/source-resolved declaration: `/data/mrumoca/rumoca/target/cmm/CMM-a642c381/RigidBody/Examples/QuadrotorSIL.mo:66`. Role: `parameter`; binding: `0.0125`; effective min: `None`; effective max: `None`. 
