# FINDING-01101: Not yet established as a bug or a false positive
...
| Original report | [FINDING-supercapdischargecharge-supercap-rs-zerolimit.md](../../v2/bugs/FINDING-supercapdischargecharge-supercap-rs-zerolimit.md) — reviewed as `FINDING-01101-supercapdischargecharge-supercap-rs.md`, which a later run renamed |
| Original SHA-256 | 23de8868f2fce7c5ef57887162857f3e07fe6c02b78d42fc032751e09569f068 |
...
Compiler/source-resolved declaration: `Electrical/Batteries/BatteryStacks/SuperCap.mo:9`. Role: `parameter`; binding: `0.002`; effective min: `None`; effective max: `None`. 
...
12:   parameter SI.Current Idis=0 "Self-discharge current at nominal voltage"
```
