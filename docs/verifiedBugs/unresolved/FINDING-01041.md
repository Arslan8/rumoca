# FINDING-01041: Not yet established as a bug or a false positive
...
| Target | thyristor_v4_1.VDRM |
| Student classification | divisor-reachable-zero |
| Original report | `FINDING-01041-thyristorbehaviourtest-thyristor-v4-1-vdrm.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | eafc5c8e16eca25b69fb28c5b7851302d3f07faddd4bee9d739c84380a49e617 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Semiconductors/Thyristor.mo:3`. Role: `parameter`; binding: `100`; effective min: `0`; effective max: `None`. 
