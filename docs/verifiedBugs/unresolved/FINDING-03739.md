# FINDING-03739: Not yet established as a bug or a false positive
...
| Original report | [FINDING-saturatedinductor-r-mfe-l-divzero.md](../../v2/bugs/FINDING-saturatedinductor-r-mfe-l-divzero.md) — reviewed as `FINDING-03739-saturatedinductor-r-mfe-l.md`, which a later run renamed |
| Original SHA-256 | aab991fd0485355b4c0094dabd260e749c46a79324882a72e71c4617823e9339 |
...
Compiler/source-resolved declaration: `Magnetic/FluxTubes/Shapes/FixedShape/Cuboid.mo:8`. Role: `parameter`; binding: `(4 * 0.065)`; effective min: `None`; effective max: `None`. 
