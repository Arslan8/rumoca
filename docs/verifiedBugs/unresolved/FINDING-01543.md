# FINDING-01543: Not yet established as a bug or a false positive
...
| Target | imcData.Lrsigma |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-imc-dcbraking-imcdata-lrsigma-intent.md](../../v2/bugs/FINDING-imc-dcbraking-imcdata-lrsigma-intent.md) — reviewed as `FINDING-01543-imc-dcbraking-imcdata-lrsigma.md`, which a later run renamed |
| Original SHA-256 | fbf94da61df36000d17ea94d368404bbbc6d54805235828b57702f64eaa0496a |
...
Compiler/source-resolved declaration: `Electrical/Machines/Utilities/ParameterRecords/IM_SquirrelCageData.mo:9`. Role: `parameter`; binding: `((3 * (1 - sqrt((1 - 0.0667)))) / ((2 * (2 * asin(1.0))) * imcData.fsNominal))`; effective min: `None`; effective max: `None`. 
