# FINDING-02252: Not yet established as a bug or a false positive
...
| Target | smeeData.Td0Transient |
| Student classification | divisor-reachable-zero |
| Original report | `FINDING-02252-smee-generator-smeedata-td0transient.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 7e03ca1e2f7d4ccc82caa80312d5826fe8ca52c21ac05b3e6a9b3f85c96df7d7 |
...
Compiler/source-resolved declaration: `Electrical/Machines/Utilities/SynchronousMachineData.mo:37`. Role: `parameter`; binding: `0.261177343`; effective min: `None`; effective max: `None`. 
