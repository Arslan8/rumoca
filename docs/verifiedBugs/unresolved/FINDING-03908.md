# FINDING-03908: Not yet established as a bug or a false positive
...
| Original report | [FINDING-doublependuluminittip-boxbody2-mi-zerolimit.md](../../v2/bugs/FINDING-doublependuluminittip-boxbody2-mi-zerolimit.md) — reviewed as `FINDING-03908-doublependuluminittip-boxbody2-mi.md`, which a later run renamed |
| Original SHA-256 | 279237bfd24e170d40079edff85a3b8485ac185253f3e234fb9a83a4d264a9aa |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/BodyBox.mo:103`. Role: `parameter`; binding: `(((boxBody2.density * boxBody2.length) * boxBody2.innerWidth) * boxBody2.innerHeight)`; effective min: `0`; effective max: `None`. 
