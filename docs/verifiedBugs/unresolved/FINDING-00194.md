# FINDING-00194: Not yet established as a bug or a false positive
...
| Original report | [FINDING-comparetransformers-l2-intent.md](../../v2/bugs/FINDING-comparetransformers-l2-intent.md) — reviewed as `FINDING-00194-comparetransformers-l2.md`, which a later run renamed |
| Original SHA-256 | b07f93a38a112c645f2505ce5e1ae4b838c91759b955087a923e73303bbf1b15 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Examples/CompareTransformers.mo:24`. Role: `parameter`; binding: `(L2sigma + (M / n))`; effective min: `None`; effective max: `None`. 
