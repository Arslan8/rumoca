# FINDING-03551: Not yet established as a bug or a false positive
...
| Original report | [FINDING-chopperbuckboost-dutycycle-dcdc-gofftransistor-zerolimit.md](../../v2/bugs/FINDING-chopperbuckboost-dutycycle-dcdc-gofftransistor-zerolimit.md) — reviewed as `FINDING-03551-chopperbuckboost-dutycycle-dcdc-gofftransistor.md`, which a later run renamed |
| Original SHA-256 | 059d972a177f0794a8e89242e2e7d7b9ec8c1018143aa60b478124ececcb6cb4 |
...
Compiler/source-resolved declaration: `Electrical/PowerConverters/DCDC/ChopperBuckBoost.mo:8`. Role: `parameter`; binding: `1e-05`; effective min: `None`; effective max: `None`. 
