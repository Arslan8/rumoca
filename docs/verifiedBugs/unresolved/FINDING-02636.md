# FINDING-02636: Not yet established as a bug or a false positive
...
| Target | smr.damperCage.Lrsigmaq |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-smr-inverter-smr-dampercage-lrsigmaq-zerolimit.md](../../v2/bugs/FINDING-smr-inverter-smr-dampercage-lrsigmaq-zerolimit.md) — reviewed as `FINDING-02636-smr-inverter-smr-dampercage-lrsigmaq.md`, which a later run renamed |
| Original SHA-256 | 7779e04b4ffb260d5fb0c19e78ae44af94e036e577a35ebb1830b5b73f305be9 |
...
Compiler/source-resolved declaration: `Electrical/Machines/BasicMachines/Components/DamperCage.mo:5`. Role: `parameter`; binding: `smrData.Lrsigmaq`; effective min: `None`; effective max: `None`. 
