# FINDING-01014: Not yet established as a bug or a false positive
...
| Target | simpleTriac.TOFF |
| Student classification | divisor-reachable-zero |
| Original report | `FINDING-01014-simpletriaccircuit-simpletriac-toff.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 5376304d89c4bcd4c8dfbdc4defc9397efb8381334e960bfd2944dfd497b618d |
...
Compiler/source-resolved declaration: `Electrical/Analog/Semiconductors/SimpleTriac.mo:16`. Role: `parameter`; binding: `1.5e-05`; effective min: `None`; effective max: `None`. 
