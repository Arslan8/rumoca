# FINDING-04213: Not yet established as a bug or a false positive
...
| Original report | [FINDING-planarfourbar-body4-m-zerolimit.md](../../v2/bugs/FINDING-planarfourbar-body4-m-zerolimit.md) — reviewed as `FINDING-04213-planarfourbar-body4-m.md`, which a later run renamed |
| Original SHA-256 | 75e800cf5f85778109d0d2e6d7e0944006d4df2400c4f6e860906fa8ccd7acf3 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/BodyBox.mo:105`. Role: `parameter`; binding: `(body4.mo - body4.mi)`; effective min: `0`; effective max: `None`. 
