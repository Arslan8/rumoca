# FINDING-03843: Not yet established as a bug or a false positive
...
| Original report | `FINDING-03843-advancedsolenoid-l-pole.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | cddbcd31ac0061c74d6a316c64c6baab9ffc2da09812cddce0c3681cf15f3024 |
...
Compiler/source-resolved declaration: `Magnetic/FluxTubes/Examples/SolenoidActuator/Components/AdvancedSolenoid.mo:21`. Role: `parameter`; binding: `0.0065`; effective min: `None`; effective max: `None`. 
