# FINDING-02791: Not yet established as a bug or a false positive
...
| Target | transformer1.R2 |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-rectifier12pulse-transformer1-r2-ruleoff.md](../../v2/bugs/FINDING-rectifier12pulse-transformer1-r2-ruleoff.md) — reviewed as `FINDING-02791-rectifier12pulse-transformer1-r2.md`, which a later run renamed |
| Original SHA-256 | 42efbfa9f616ccc174b4fe0ce51c49fdc5bc546e1a1987ee40f63453f72ce076 |
...
Compiler/source-resolved declaration: `Electrical/Machines/Interfaces/PartialBasicTransformer.mo:21`. Role: `parameter`; binding: `transformerData1.R2`; effective min: `None`; effective max: `None`. 
