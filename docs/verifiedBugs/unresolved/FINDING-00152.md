# FINDING-00152: Not yet established as a bug or a false positive
...
| Original report | [FINDING-cauerlowpasssc-l1-divzero-2.md](../../v2/bugs/FINDING-cauerlowpasssc-l1-divzero-2.md) — reviewed as `FINDING-00152-cauerlowpasssc-l1.md`, which a later run renamed |
| Original SHA-256 | 02e1e0e9dc3a1684bd4669c622fc4c34946a41c93bc942fb81863b2f583464af |
...
Compiler/source-resolved declaration: `Electrical/Analog/Examples/CauerLowPassSC.mo:5`. Role: `parameter`; binding: `1.304`; effective min: `0`; effective max: `None`. 
