# FINDING-00065: Not yet established as a bug or a false positive
...
| Original report | [FINDING-cauerlowpasssc-c1-zerolimit.md](../../v2/bugs/FINDING-cauerlowpasssc-c1-zerolimit.md) — reviewed as `FINDING-00065-cauerlowpasssc-c1.md`, which a later run renamed |
| Original SHA-256 | f43cdb35d9405bc405191f3bfabc36cae71ef2518cc16715598f1602328ee7da |
...
Compiler/source-resolved declaration: `Electrical/Analog/Examples/CauerLowPassSC.mo:7`. Role: `parameter`; binding: `1.072`; effective min: `0`; effective max: `None`. 
