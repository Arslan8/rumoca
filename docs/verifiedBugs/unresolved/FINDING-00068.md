# FINDING-00068: Not yet established as a bug or a false positive
...
| Original report | [FINDING-cauerlowpasssc-c4-zerolimit.md](../../v2/bugs/FINDING-cauerlowpasssc-c4-zerolimit.md) — reviewed as `FINDING-00068-cauerlowpasssc-c4.md`, which a later run renamed |
| Original SHA-256 | 504c48ba06b4a38d31c51131bd74cdc0ae30e8c899b97e33352d0d52a8ac2864 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Examples/CauerLowPassSC.mo:11`. Role: `parameter`; binding: `(1 / ((1.179945 ^ 2) * l2))`; effective min: `0`; effective max: `None`. 
