# FINDING-03098: Not yet established as a bug or a false positive
...
| Original report | [FINDING-thyristorbridge2mpulse-dc-drive-f-divzero-2.md](../../v2/bugs/FINDING-thyristorbridge2mpulse-dc-drive-f-divzero-2.md) — reviewed as `FINDING-03098-thyristorbridge2mpulse-dc-drive-f.md`, which a later run renamed |
| Original SHA-256 | 917d28fdd8fff0819bfeee6e7e6a39355fcc6d932aeaa7bb8601e4ed4ac3adb8 |
...
Compiler/source-resolved declaration: `Electrical/PowerConverters/Examples/ACDC/RectifierBridge2mPulse/ThyristorBridge2mPulse_DC_Drive.mo:10`. Role: `parameter`; binding: `50`; effective min: `None`; effective max: `None`. 
...
```modelica
8:       Modelica.Electrical.Polyphase.Functions.factorY2DC(m)
