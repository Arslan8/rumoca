# FINDING-00926: Not yet established as a bug or a false positive
...
| Original report | [FINDING-signalgenerator-c-zerolimit.md](../../v2/bugs/FINDING-signalgenerator-c-zerolimit.md) — reviewed as `FINDING-00926-signalgenerator-c.md`, which a later run renamed |
| Original SHA-256 | 9040ce9329d979a91fbeaf118e5ee2831ce173880462aa1139f69ffe1ee7119b |
...
Compiler/source-resolved declaration: `Electrical/Analog/Examples/OpAmps/SignalGenerator.mo:12`. Role: `parameter`; binding: `((Vps / VAmp) / ((4 * f) * R))`; effective min: `0`; effective max: `None`. 
