# FINDING-00905: Not yet established as a bug or a false positive
...
| Original report | [FINDING-integrator-c-zerolimit.md](../../v2/bugs/FINDING-integrator-c-zerolimit.md) — reviewed as `FINDING-00905-integrator-c.md`, which a later run renamed |
| Original SHA-256 | 852320ee20db7e6579a8c7c469b8c923efc75f17a9c7c0615e6f018e179f0ce1 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Examples/OpAmps/OpAmpCircuits/Integrator.mo:8`. Role: `parameter`; binding: `((1 / k) / (((2 * (2 * asin(1.0))) * f) * R))`; effective min: `0`; effective max: `None`. 
