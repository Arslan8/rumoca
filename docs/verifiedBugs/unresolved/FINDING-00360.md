# FINDING-00360: Not yet established as a bug or a false positive
...
| Original report | [FINDING-invertingamp-r1-zerolimit.md](../../v2/bugs/FINDING-invertingamp-r1-zerolimit.md) — reviewed as `FINDING-00360-invertingamp-r1.md`, which a later run renamed |
| Original SHA-256 | df5d3fb40b00af9e8fe66bf54bb6d2bee12375bd837340ebba520c6747941c12 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Examples/InvertingAmp.mo:9`. Role: `parameter`; binding: `1000`; effective min: `None`; effective max: `None`. 
