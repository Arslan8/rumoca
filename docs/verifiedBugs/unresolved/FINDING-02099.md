# FINDING-02099: Not yet established as a bug or a false positive
...
| Original report | [FINDING-ims-start-aimsdata-lm-unbounded.md](../../v2/bugs/FINDING-ims-start-aimsdata-lm-unbounded.md) — reviewed as `FINDING-02099-ims-start-aimsdata-lm.md`, which a later run renamed |
| Original SHA-256 | 9459a3a5c322f9d437a6f08a68a6f49618cb57387694cc9c31d55a1cdb7bef35 |
...
Compiler/source-resolved declaration: `Electrical/Machines/Utilities/ParameterRecords/IM_SlipRingData.mo:6`. Role: `parameter`; binding: `((3 * sqrt((1 - 0.0667))) / ((2 * (2 * asin(1.0))) * aimsData.fsNominal))`; effective min: `None`; effective max: `None`. 
