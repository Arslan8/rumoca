# FINDING-01559: Not yet established as a bug or a false positive
...
| Original report | [FINDING-imc-dcbraking-imc-lrsigma-intent.md](../../v2/bugs/FINDING-imc-dcbraking-imc-lrsigma-intent.md) — reviewed as `FINDING-01559-imc-dcbraking-imc-lrsigma.md`, which a later run renamed |
| Original SHA-256 | b97558a001c6c630e6d235f026477806c96725ed6309eb1f5cb62237e1538ad5 |
...
Compiler/source-resolved declaration: `Electrical/Machines/BasicMachines/InductionMachines/IM_SquirrelCage.mo:29`. Role: `parameter`; binding: `imcData.Lrsigma`; effective min: `None`; effective max: `None`. 
