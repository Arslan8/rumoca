# FINDING-00066: Not yet established as a bug or a false positive
...
| Original report | [FINDING-cauerlowpasssc-c2-zerolimit.md](../../v2/bugs/FINDING-cauerlowpasssc-c2-zerolimit.md) — reviewed as `FINDING-00066-cauerlowpasssc-c2.md`, which a later run renamed |
| Original SHA-256 | aeb6853cddf71fdea19bbe1ddbb12c15112cacb505842250f9c0a34e9f97ae52 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Examples/CauerLowPassSC.mo:8`. Role: `parameter`; binding: `(1 / ((1.704992 ^ 2) * l1))`; effective min: `0`; effective max: `None`. 
