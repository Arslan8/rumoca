# FINDING-04186: Not yet established as a bug or a false positive
...
| Original report | [FINDING-planarfourbar-body2-mi-zerolimit.md](../../v2/bugs/FINDING-planarfourbar-body2-mi-zerolimit.md) — reviewed as `FINDING-04186-planarfourbar-body2-mi.md`, which a later run renamed |
| Original SHA-256 | 4cdbd5fac68d8f55da08a4b0d6a3bf1b7089c74b41073656bdbd34ac3d960b59 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/BodyBox.mo:103`. Role: `parameter`; binding: `(((body2.density * body2.length) * body2.innerWidth) * body2.innerHeight)`; effective min: `0`; effective max: `None`. 
