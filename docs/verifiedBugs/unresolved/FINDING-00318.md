# FINDING-00318: Not yet established as a bug or a false positive
...
| Original report | [FINDING-heatingpnp-norgate-t1-ccs-zerolimit.md](../../v2/bugs/FINDING-heatingpnp-norgate-t1-ccs-zerolimit.md) — reviewed as `FINDING-00318-heatingpnp-norgate-t1-ccs.md`, which a later run renamed |
| Original SHA-256 | 3b573d5e2d2dc977fee244a1a9ea0cb7cdb2296a5ea3e09a7391c51a73d0ead4 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Semiconductors/PNP.mo:9`. Role: `parameter`; binding: `CapVal`; effective min: `0`; effective max: `None`. 
