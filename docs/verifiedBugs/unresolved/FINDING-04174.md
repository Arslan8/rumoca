# FINDING-04174: Not yet established as a bug or a false positive
...
| Original report | [FINDING-planarfourbar-body1-m-zerolimit.md](../../v2/bugs/FINDING-planarfourbar-body1-m-zerolimit.md) — reviewed as `FINDING-04174-planarfourbar-body1-m.md`, which a later run renamed |
| Original SHA-256 | ae1ae51ae9f1f6bd66aab8968755e5f6d0be2b3cdec8e57e00995400edc7d7fa |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/BodyBox.mo:105`. Role: `parameter`; binding: `(body1.mo - body1.mi)`; effective min: `0`; effective max: `None`. 
