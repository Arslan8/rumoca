# FINDING-01560: Not yet established as a bug or a false positive
...
| Original report | [FINDING-imc-dcbraking-imc-rr-unbounded.md](../../v2/bugs/FINDING-imc-dcbraking-imc-rr-unbounded.md) — reviewed as `FINDING-01560-imc-dcbraking-imc-rr.md`, which a later run renamed |
| Original SHA-256 | e971b94c9f18726baf788b6344a7341ef2fa86a3212e2ed7fd55c6d6169e408f |
...
Compiler/source-resolved declaration: `Electrical/Machines/BasicMachines/InductionMachines/IM_SquirrelCage.mo:33`. Role: `parameter`; binding: `imcData.Rr`; effective min: `None`; effective max: `None`. 
