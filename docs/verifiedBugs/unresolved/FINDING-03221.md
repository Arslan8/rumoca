# FINDING-03221: Not yet established as a bug or a false positive
...
| Original report | [FINDING-thyristorbridge2pulse-dc-drive-rmains-zerolimit.md](../../v2/bugs/FINDING-thyristorbridge2pulse-dc-drive-rmains-zerolimit.md) — reviewed as `FINDING-03221-thyristorbridge2pulse-dc-drive-rmains.md`, which a later run renamed |
| Original SHA-256 | 608ec686b93014d7a2ca1336d5fa7681bec184c092fa8e453f577ccb34d7c5b1 |
...
Compiler/source-resolved declaration: `Electrical/PowerConverters/Examples/ACDC/RectifierBridge2Pulse/ThyristorBridge2Pulse_DC_Drive.mo:14`. Role: `parameter`; binding: `(ZMains * lamdaMains)`; effective min: `None`; effective max: `None`. 
