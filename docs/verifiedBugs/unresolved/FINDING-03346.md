# FINDING-03346: Not yet established as a bug or a false positive
...
| Original report | [FINDING-thyristorcentertap2mpulse-rl-l-zerolimit.md](../../v2/bugs/FINDING-thyristorcentertap2mpulse-rl-l-zerolimit.md) — reviewed as `FINDING-03346-thyristorcentertap2mpulse-rl-l.md`, which a later run renamed |
| Original SHA-256 | a8760f1ce874bbaece03d864302ae71cec339f82a809ae815ffe31c47053c312 |
...
Compiler/source-resolved declaration: `Electrical/PowerConverters/Examples/ACDC/RectifierCenterTap2mPulse/ThyristorCenterTap2mPulse_RL.mo:11`. Role: `parameter`; binding: `1`; effective min: `None`; effective max: `None`. 
