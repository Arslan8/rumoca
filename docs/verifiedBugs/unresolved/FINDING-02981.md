# FINDING-02981: Not yet established as a bug or a false positive
...
| Original report | [FINDING-transformeryy-lm-intent.md](../../v2/bugs/FINDING-transformeryy-lm-intent.md) — reviewed as `FINDING-02981-transformeryy-lm.md`, which a later run renamed |
| Original SHA-256 | 7dad5438a6ff3c2f249700b9ad737b29a6fd88a61a86770f68297d3d2a8bcb98 |
...
Compiler/source-resolved declaration: `Electrical/Polyphase/Examples/TransformerYY.mo:7`. Role: `parameter`; binding: `1`; effective min: `None`; effective max: `None`. 
