# FINDING-05138: Not yet established as a bug or a false positive
...
| Original report | [FINDING-roverplant-yaw-tau-divzero.md](../../v2/bugs/FINDING-roverplant-yaw-tau-divzero.md) — reviewed as `FINDING-05138-roverplant-yaw-tau.md`, which a later run renamed |
| Original SHA-256 | f98b6b475667ecc2d5dada8c511c5ff41234276ab9e5decabac2c1bd7dcf64ce |
...
Compiler/source-resolved declaration: `/data/mrumoca/rumoca/target/cmm/CMM-a642c381/RigidBody/Examples/RoverPlant.mo:19`. Role: `parameter`; binding: `0.25`; effective min: `None`; effective max: `None`. 
