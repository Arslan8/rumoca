# FINDING-00273: Not yet established as a bug or a false positive
...
| Original report | [FINDING-heatingmosinverter-h-pmos-tnom-divunresolved.md](../../v2/bugs/FINDING-heatingmosinverter-h-pmos-tnom-divunresolved.md) — reviewed as `FINDING-00273-heatingmosinverter-h-pmos-tnom.md`, which a later run renamed |
| Original SHA-256 | b6fbbe4058c0ee3c493b62b9fb5ec6e88468e3320eab1beb248fc0c183bb7584 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Semiconductors/PMOS.mo:22`. Role: `parameter`; binding: `300.15`; effective min: `0.0`; effective max: `None`. 
...
24:   parameter Real kk2=6.2e-4 "Fitting parameter for K2" annotation(Dialog(enable=useTemperatureDependency));
