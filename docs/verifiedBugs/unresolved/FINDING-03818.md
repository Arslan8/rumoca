# FINDING-03818: Not yet established as a bug or a false positive
...
| Target | material.T_ref |
| Student classification | divisor-reachable-zero |
| Original report | `FINDING-03818-permeanceactuator-material-t-ref.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | a4bdafcc3e7c2bd3d4ae6f6500e9da38cfb9c7e68c923e7df330277f12c357f4 |
...
Compiler/source-resolved declaration: `Magnetic/FluxTubes/Material/HardMagnetic/BaseData.mo:9`. Role: `parameter`; binding: `293.15`; effective min: `0.0`; effective max: `None`. 
