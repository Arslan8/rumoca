# FINDING-02983: Not yet established as a bug or a false positive
...
| Original report | [FINDING-transformeryy-rt-ruleoff.md](../../v2/bugs/FINDING-transformeryy-rt-ruleoff.md) — reviewed as `FINDING-02983-transformeryy-rt.md`, which a later run renamed |
| Original SHA-256 | d4b143506bfc194a5a82b4a0d3a55b74cdbcc05bd900931c419e0074abe59e20 |
...
Compiler/source-resolved declaration: `Electrical/Polyphase/Examples/TransformerYY.mo:10`. Role: `parameter`; binding: `0.05`; effective min: `None`; effective max: `None`. 
