# FINDING-01561: Not yet established as a bug or a false positive
...
| Target | imc.squirrelCageR.Lrsigma |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-imc-dcbraking-imc-squirrelcager-lrsigma-zerolimit.md](../../v2/bugs/FINDING-imc-dcbraking-imc-squirrelcager-lrsigma-zerolimit.md) — reviewed as `FINDING-01561-imc-dcbraking-imc-squirrelcager-lrsigma.md`, which a later run renamed |
| Original SHA-256 | 4de24f62f5c75395969b465a20ebdfafffcf4b8d55745e01f2a0390790585c03 |
...
Compiler/source-resolved declaration: `Electrical/Machines/BasicMachines/Components/SquirrelCage.mo:3`. Role: `parameter`; binding: `imcData.Lrsigma`; effective min: `None`; effective max: `None`. 
