# FINDING-01469: Not yet established as a bug or a false positive
...
| Target | dcpmData2.TaNominal |
| Student classification | divisor-reachable-zero |
| Original report | `FINDING-01469-dcpm-withlosses-dcpmdata2-tanominal.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | e5ca5b4b2356ed4ac67f373e2c2406434009315aa6539709a75a48db2fb93c2f |
...
Compiler/source-resolved declaration: `Electrical/Machines/Utilities/ParameterRecords/DcPermanentMagnetData.mo:16`. Role: `parameter`; binding: `368.15`; effective min: `0.0`; effective max: `None`. 
