# FINDING-05142: Not yet established as a bug or a false positive
...
| Original report | `FINDING-05142-quadrotorsil-tau-down.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 44b4621c5cc038ca569e9edef996a68caa80cf75362aec5104431ade447c731d |
...
Compiler/source-resolved declaration: `/data/mrumoca/rumoca/target/cmm/CMM-a642c381/RigidBody/Examples/QuadrotorSIL.mo:67`. Role: `parameter`; binding: `0.025`; effective min: `None`; effective max: `None`. 
