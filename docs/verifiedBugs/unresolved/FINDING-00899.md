# FINDING-00899: Not yet established as a bug or a false positive
...
| Original report | [FINDING-firstorder-c-zerolimit.md](../../v2/bugs/FINDING-firstorder-c-zerolimit.md) — reviewed as `FINDING-00899-firstorder-c.md`, which a later run renamed |
| Original SHA-256 | dd4f4fe72dfb5a2e1bbe7e245753a095178b8846c4c959213d2fe2e0cf1000b1 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Examples/OpAmps/OpAmpCircuits/FirstOrder.mo:9`. Role: `parameter`; binding: `(T / R2)`; effective min: `0`; effective max: `None`. 
