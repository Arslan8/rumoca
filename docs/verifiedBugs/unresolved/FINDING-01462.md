# FINDING-01462: Not yet established as a bug or a false positive
...
| Original report | `FINDING-01462-dcpm-withlosses-wload2.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 46fff5472fa2044052c4a25f9f62a521a12a5cfc9e33181d4f5650aea4f5988e |
...
Compiler/source-resolved declaration: `Electrical/Machines/Examples/DCMachines/DCPM_withLosses.mo:14`. Role: `parameter`; binding: `(((1417.5 * 2) * (2 * asin(1.0))) / 60)`; effective min: `None`; effective max: `None`. 
