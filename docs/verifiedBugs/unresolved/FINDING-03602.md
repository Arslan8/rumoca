# FINDING-03602: Not yet established as a bug or a false positive
...
| Original report | [FINDING-chopperstepup-r-c-zerolimit.md](../../v2/bugs/FINDING-chopperstepup-r-c-zerolimit.md) — reviewed as `FINDING-03602-chopperstepup-r-c.md`, which a later run renamed |
| Original SHA-256 | 72bee9af76b28444cdfd9f63ca694c5413f8aaf4ad89c6298751148e6e2b7203 |
...
Compiler/source-resolved declaration: `Electrical/PowerConverters/Examples/DCDC/ExampleTemplates/ChopperStepUp.mo:7`. Role: `parameter`; binding: `2e-05`; effective min: `0`; effective max: `None`. 
