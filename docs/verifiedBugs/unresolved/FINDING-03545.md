# FINDING-03545: Not yet established as a bug or a false positive
...
| Original report | [FINDING-chopperbuckboost-dutycycle-rihv-zerolimit.md](../../v2/bugs/FINDING-chopperbuckboost-dutycycle-rihv-zerolimit.md) — reviewed as `FINDING-03545-chopperbuckboost-dutycycle-rihv.md`, which a later run renamed |
| Original SHA-256 | 7f5cac808675ac8acaa4fbcce79c1306c20359585eb3f21c6b9982a5ca345a14 |
...
Compiler/source-resolved declaration: `Electrical/PowerConverters/Examples/DCDC/ExampleTemplates/ChopperBuckBoost.mo:7`. Role: `parameter`; binding: `0.01`; effective min: `None`; effective max: `None`. 
