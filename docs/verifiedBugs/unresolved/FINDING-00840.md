# FINDING-00840: Not yet established as a bug or a false positive
...
| Original report | [FINDING-invertingschmitttrigger-r2-zerolimit.md](../../v2/bugs/FINDING-invertingschmitttrigger-r2-zerolimit.md) — reviewed as `FINDING-00840-invertingschmitttrigger-r2.md`, which a later run renamed |
| Original SHA-256 | d8f3446ebb6d353c7834418fc4c8474e287586f5b87363ea874d5dbf6a9c8c88 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Examples/OpAmps/InvertingSchmittTrigger.mo:11`. Role: `parameter`; binding: `(((1 - k) / k) * R1)`; effective min: `None`; effective max: `None`. 
