# FINDING-03547: Not yet established as a bug or a false positive
...
| Original report | [FINDING-chopperbuckboost-dutycycle-chv-zerolimit.md](../../v2/bugs/FINDING-chopperbuckboost-dutycycle-chv-zerolimit.md) — reviewed as `FINDING-03547-chopperbuckboost-dutycycle-chv.md`, which a later run renamed |
| Original SHA-256 | 2f2b84b8e2489457427ada6fec6149cda8cc58d1bc3a42def450d196f7efcff3 |
...
Compiler/source-resolved declaration: `Electrical/PowerConverters/Examples/DCDC/ExampleTemplates/ChopperBuckBoost.mo:9`. Role: `parameter`; binding: `0.00025`; effective min: `0`; effective max: `None`. 
