# FINDING-03366: Not yet established as a bug or a false positive
...
| Original report | [FINDING-thyristorcentertap2mpulse-rlv-characteristic-r-zerolimit.md](../../v2/bugs/FINDING-thyristorcentertap2mpulse-rlv-characteristic-r-zerolimit.md) — reviewed as `FINDING-03366-thyristorcentertap2mpulse-rlv-characteristic-r.md`, which a later run renamed |
| Original SHA-256 | b0766a80f67f06151563b50765c94e282ca8dd850ce8e0aba54b0eb5ac261ac3 |
...
Compiler/source-resolved declaration: `Electrical/PowerConverters/Examples/ACDC/RectifierCenterTap2mPulse/ThyristorCenterTap2mPulse_RLV_Characteristic.mo:8`. Role: `parameter`; binding: `20`; effective min: `None`; effective max: `None`. 
