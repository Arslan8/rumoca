# FINDING-04200: Not yet established as a bug or a false positive
...
| Original report | [FINDING-planarfourbar-body3-m-zerolimit.md](../../v2/bugs/FINDING-planarfourbar-body3-m-zerolimit.md) — reviewed as `FINDING-04200-planarfourbar-body3-m.md`, which a later run renamed |
| Original SHA-256 | eaf93fec90abd337a813ddaea1fe20b151045448ef8d9e8d67ff37c2c1d10100 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/BodyBox.mo:105`. Role: `parameter`; binding: `(body3.mo - body3.mi)`; effective min: `0`; effective max: `None`. 
