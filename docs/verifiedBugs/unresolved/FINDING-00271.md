# FINDING-00271: Not yet established as a bug or a false positive
...
| Original report | [FINDING-heatingmosinverter-h-pmos-l-divguarded.md](../../v2/bugs/FINDING-heatingmosinverter-h-pmos-l-divguarded.md) — reviewed as `FINDING-00271-heatingmosinverter-h-pmos-l.md`, which a later run renamed |
| Original SHA-256 | 81cc2126391dac5ff30620f01b3f2426f11beb2f730a7438a48fed8a28d6a68c |
...
Compiler/source-resolved declaration: `Electrical/Analog/Semiconductors/PMOS.mo:13`. Role: `parameter`; binding: `6e-06`; effective min: `None`; effective max: `None`. 
