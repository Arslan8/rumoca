# FINDING-00324: Not yet established as a bug or a false positive
...
| Original report | [FINDING-heatingpnp-norgate-t2-cje-zerolimit.md](../../v2/bugs/FINDING-heatingpnp-norgate-t2-cje-zerolimit.md) — reviewed as `FINDING-00324-heatingpnp-norgate-t2-cje.md`, which a later run renamed |
| Original SHA-256 | 7fb05100d65ec463a6e9a341d5b258953f83c1648654d4f177cb0789b22b0390 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Semiconductors/PNP.mo:10`. Role: `parameter`; binding: `CapVal`; effective min: `0`; effective max: `None`. 
