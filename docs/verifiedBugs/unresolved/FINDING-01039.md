# FINDING-01039: Not yet established as a bug or a false positive
...
| Target | thyristor_v4_1.TON |
| Student classification | divisor-reachable-zero |
| Original report | `FINDING-01039-thyristorbehaviourtest-thyristor-v4-1-ton.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 8df91c3ee48a52daf1f39c62cfe9f638965122bb4abb480af833e35ebedf8e95 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Semiconductors/Thyristor.mo:15`. Role: `parameter`; binding: `1e-06`; effective min: `None`; effective max: `None`. 
