# FINDING-00276: Not yet established as a bug or a false positive
...
| Original report | `FINDING-00276-heatingmosinverter-h-nmos-dl.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 1ac94a028cd43a21a76d42bb0d58ed53d79af20ec1db6f0ba31a7c522d5a93a8 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Semiconductors/NMOS.mo:19`. Role: `parameter`; binding: `-1.5e-06`; effective min: `None`; effective max: `None`. 

[Electrical/Analog/Semiconductors/NMOS.mo — source snapshot](../evidence/sources/d5a51528e9ae70f5-NMOS.mo)

```modelica
17:         parameter Real K5=0.7311 "Reduction of pinch-off region";
