# FINDING-00191: Not yet established as a bug or a false positive
...
| Original report | [FINDING-comparetransformers-r2-zerolimit.md](../../v2/bugs/FINDING-comparetransformers-r2-zerolimit.md) — reviewed as `FINDING-00191-comparetransformers-r2.md`, which a later run renamed |
| Original SHA-256 | ade4578116780bda7760dc1913de136776a5cae428c25d4025a3f1c495eca114 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Examples/CompareTransformers.mo:19`. Role: `parameter`; binding: `(0.01 / (n ^ 2))`; effective min: `None`; effective max: `None`. 
