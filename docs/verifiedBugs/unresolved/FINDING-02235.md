# FINDING-02235: Not yet established as a bug or a false positive
...
| Original report | `FINDING-02235-smee-generator-smeedata-x0.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 73c3b2d26c1072699f17f37f00057dbebc4a33aa720828ccf5265957a572edfe |
...
Compiler/source-resolved declaration: `Electrical/Machines/Utilities/SynchronousMachineData.mo:23`. Role: `parameter`; binding: `0.1`; effective min: `None`; effective max: `None`. 
...
22:       IeOpenCircuit) "Stator current / excitation current";
