# FINDING-04896: Not yet established as a bug or a false positive
...
| Target | smpm.TsOperational |
| Student classification | divisor-reachable-zero |
| Original report | `FINDING-04896-smpm-voltagesourcewithlosses-smpm-tsoperational.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | f7c782ba0e69a473165f2badc54aaa8cd8c0fd756cd293024af07331d3d4282d |
...
Compiler/source-resolved declaration: `Electrical/Machines/Interfaces/PartialBasicInductionMachine.mo:8`. Role: `parameter`; binding: `293.15`; effective min: `0.0`; effective max: `None`. 
