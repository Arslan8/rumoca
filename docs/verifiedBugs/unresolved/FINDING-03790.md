# FINDING-03790: Not yet established as a bug or a false positive
...
| Target | pmActuator.material.alpha_Br |
| Student classification | divisor-reachable-zero |
| Original report | `FINDING-03790-armaturestroke-pmactuator-material-alpha-br.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 7318bd30dd557ed934c6c0bdc8d185cb49ae1569943e9a239f2fd1db38b62dae |
...
Compiler/source-resolved declaration: `Magnetic/FluxTubes/Material/HardMagnetic/BaseData.mo:10`. Role: `parameter`; binding: `-0.001`; effective min: `None`; effective max: `None`. 
