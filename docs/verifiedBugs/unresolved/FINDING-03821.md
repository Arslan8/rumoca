# FINDING-03821: Not yet established as a bug or a false positive
...
| Target | material.H_cBRef |
| Student classification | divisor-reachable-zero |
| Original report | `FINDING-03821-permeanceactuator-material-h-cbref.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | e27b09fbcddbeedbb94e47ef488c40ebb78d5e79e19a613107170787fc1a2269 |
...
Compiler/source-resolved declaration: `Magnetic/FluxTubes/Material/HardMagnetic/BaseData.mo:5`. Role: `parameter`; binding: `1`; effective min: `None`; effective max: `None`. 
