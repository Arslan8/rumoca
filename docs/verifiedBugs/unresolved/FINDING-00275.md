# FINDING-00275: Not yet established as a bug or a false positive
...
| Original report | [FINDING-heatingmosinverter-h-nmos-l-divguarded.md](../../v2/bugs/FINDING-heatingmosinverter-h-nmos-l-divguarded.md) — reviewed as `FINDING-00275-heatingmosinverter-h-nmos-l.md`, which a later run renamed |
| Original SHA-256 | f5507932cb2aa74e2f8a9a49dc45d5897bd0e6282b48acd1a769d93152747cbf |
...
Compiler/source-resolved declaration: `Electrical/Analog/Semiconductors/NMOS.mo:13`. Role: `parameter`; binding: `6e-06`; effective min: `None`; effective max: `None`. 
