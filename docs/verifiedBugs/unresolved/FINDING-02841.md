# FINDING-02841: Not yet established as a bug or a false positive
...
| Target | transformer2.VectorGroup |
| Student classification | divisor-reachable-zero |
| Original report | `FINDING-02841-rectifier12pulse-transformer2-vectorgroup.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 2cef45d5dcfd1801a769bb37842ca472e491174513b6e5c4e9b37df488326ac5 |
...
Compiler/source-resolved declaration: `Electrical/Machines/Interfaces/PartialBasicTransformer.mo:6`. Role: `constant`; binding: `'Dd00'`; effective min: `None`; effective max: `None`. 
