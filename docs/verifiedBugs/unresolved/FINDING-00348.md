# FINDING-00348: Not yet established as a bug or a false positive
...
| Original report | [FINDING-heatingrectifier-heatingdiode1-tnom-divzero-2.md](../../v2/bugs/FINDING-heatingrectifier-heatingdiode1-tnom-divzero-2.md) — reviewed as `FINDING-00348-heatingrectifier-heatingdiode1-tnom.md`, which a later run renamed |
| Original SHA-256 | fb44e5135fe43fd6f648eee4a9adf3757e3e8dc7ad497e9c5e3e2ca77355326c |
...
Compiler/source-resolved declaration: `Electrical/Analog/Semiconductors/Diode.mo:11`. Role: `parameter`; binding: `300.15`; effective min: `0.0`; effective max: `None`. 
