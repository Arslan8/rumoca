# FINDING-03474: Not yet established as a bug or a false positive
...
| Original report | [FINDING-thyristorcentertapmpulse-rl-l-zerolimit.md](../../v2/bugs/FINDING-thyristorcentertapmpulse-rl-l-zerolimit.md) — reviewed as `FINDING-03474-thyristorcentertapmpulse-rl-l.md`, which a later run renamed |
| Original SHA-256 | 3e1ec0d8db3b712fa4cc01f1c66a76d1cb09525db3766e7bbdcfd0a2fa3a7c7f |
...
Compiler/source-resolved declaration: `Electrical/PowerConverters/Examples/ACDC/RectifierCenterTapmPulse/ThyristorCenterTapmPulse_RL.mo:11`. Role: `parameter`; binding: `1`; effective min: `None`; effective max: `None`. 
