# FINDING-00810: Not yet established as a bug or a false positive
...
| Original report | [FINDING-differentialamplifier-data-r3-intent.md](../../v2/bugs/FINDING-differentialamplifier-data-r3-intent.md) — reviewed as `FINDING-00810-differentialamplifier-data-r3.md`, which a later run renamed |
| Original SHA-256 | 63a6ddaee3b573b6c6bdbf80e878e9012410a2acdd36307869e3a41d1152d7eb |
...
Compiler/source-resolved declaration: `Electrical/Analog/Examples/OpAmps/OpAmpCircuits/DifferentialAmplifierData.mo:22`. Role: `parameter`; binding: `(data.R1 / data.k)`; effective min: `None`; effective max: `None`. 
