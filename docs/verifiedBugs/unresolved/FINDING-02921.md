# FINDING-02921: Not yet established as a bug or a false positive
...
| Target | transformerData.V1 |
| Student classification | divisor-reachable-zero |
| Original report | `FINDING-02921-transformertestbench-transformerdata-v1.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 9b730680e64b6acdbba35493a5f214a51434af6a69f25445261338b215dac570 |
...
Compiler/source-resolved declaration: `Electrical/Machines/Utilities/TransformerData.mo:5`. Role: `parameter`; binding: `100`; effective min: `None`; effective max: `None`. 
