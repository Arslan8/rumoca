# FINDING-02955: Not yet established as a bug or a false positive
...
| Original report | [FINDING-testsensors-l-zerolimit.md](../../v2/bugs/FINDING-testsensors-l-zerolimit.md) — reviewed as `FINDING-02955-testsensors-l.md`, which a later run renamed |
| Original SHA-256 | 6549bf48181cf85ed408ec4ddd04f1fcbee4a83f976b6570afa4efdf37c49632 |
...
Compiler/source-resolved declaration: `Electrical/Polyphase/Examples/TestSensors.mo:10`. Role: `parameter`; binding: `((1 / sqrt(2)) / ((2 * (2 * asin(1.0))) * f))`; effective min: `None`; effective max: `None`. 
