# FINDING-05135: Not yet established as a bug or a false positive
...
| Original report | [FINDING-roverplant-side-tau-divzero.md](../../v2/bugs/FINDING-roverplant-side-tau-divzero.md) — reviewed as `FINDING-05135-roverplant-side-tau.md`, which a later run renamed |
| Original SHA-256 | 502dc0418873f3e14a49cc9c200bfe0c2fc06015059acbed8c86fe14e6c48110 |
...
Compiler/source-resolved declaration: `/data/mrumoca/rumoca/target/cmm/CMM-a642c381/RigidBody/Examples/RoverPlant.mo:20`. Role: `parameter`; binding: `0.12`; effective min: `None`; effective max: `None`. 
