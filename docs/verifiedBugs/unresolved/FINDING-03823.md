# FINDING-03823: Not yet established as a bug or a false positive
...
| Original report | [FINDING-advancedsolenoid-r-par-zerolimit.md](../../v2/bugs/FINDING-advancedsolenoid-r-par-zerolimit.md) — reviewed as `FINDING-03823-advancedsolenoid-r-par.md`, which a later run renamed |
| Original SHA-256 | 0ba97b51b4ce581d644d9afd9816a55b0c0b670ec02ad366aa938aacbc5b3b38 |
...
Compiler/source-resolved declaration: `Magnetic/FluxTubes/Examples/SolenoidActuator/Components/AdvancedSolenoid.mo:9`. Role: `parameter`; binding: `100000.0`; effective min: `None`; effective max: `None`. 
