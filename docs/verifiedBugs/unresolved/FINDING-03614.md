# FINDING-03614: Not yet established as a bug or a false positive
...
| Original report | `FINDING-03614-chopperstepup-r-f.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | fefd5b600f69f8060ef698326047892a34481f24288af74dab71af371771fee6 |
...
Compiler/source-resolved declaration: `Electrical/PowerConverters/Examples/DCDC/ExampleTemplates/ChopperStepUp.mo:4`. Role: `parameter`; binding: `1000`; effective min: `None`; effective max: `None`. 
...
```modelica
2: partial model ChopperStepUp "Step up chopper including control"
