# FINDING-01116: Not yet established as a bug or a false positive
...
| Original report | [FINDING-idealdcdc-ti-divzero.md](../../v2/bugs/FINDING-idealdcdc-ti-divzero.md) — reviewed as `FINDING-01116-idealdcdc-ti.md`, which a later run renamed |
| Original SHA-256 | e515bb53b94bf676aad38dafa5e68de430c26eb5cfb1f5ba1c716bff666c769b |
...
Compiler/source-resolved declaration: `Electrical/Machines/Examples/ControlledDCDrives/Utilities/IdealDcDc.mo:4`. Role: `parameter`; binding: `1e-06`; effective min: `None`; effective max: `None`. 
...
7:   Modelica.Electrical.Analog.Sources.SignalCurrent signalCurrent annotation (
```
