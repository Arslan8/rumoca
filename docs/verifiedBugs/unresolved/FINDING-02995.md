# FINDING-02995: Not yet established as a bug or a false positive
...
| Original report | `FINDING-02995-transformeryy-m.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 08e168db81b9bafa9d29451eb8a616011993057622f661c04bed40e76facdd79 |
...
Compiler/source-resolved declaration: `Electrical/Polyphase/Examples/TransformerYY.mo:4`. Role: `parameter`; binding: `3`; effective min: `None`; effective max: `None`. 

[Electrical/Polyphase/Examples/TransformerYY.mo — source snapshot](../evidence/sources/9f59ff1cc167961b-TransformerYY.mo)

```modelica
2: model TransformerYY "Test example with polyphase components"
