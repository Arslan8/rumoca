# FINDING-03486: Not yet established as a bug or a false positive
...
| Original report | [FINDING-thyristorcentertapmpulse-rlv-characteristic-r-zerolimit.md](../../v2/bugs/FINDING-thyristorcentertapmpulse-rlv-characteristic-r-zerolimit.md) — reviewed as `FINDING-03486-thyristorcentertapmpulse-rlv-characteristic-r.md`, which a later run renamed |
| Original SHA-256 | c0a4b78312df70efd8b2e45be0fc4715287448e1dffea3459ff9b470a4d50c6a |
...
Compiler/source-resolved declaration: `Electrical/PowerConverters/Examples/ACDC/RectifierCenterTapmPulse/ThyristorCenterTapmPulse_RLV_Characteristic.mo:8`. Role: `parameter`; binding: `20`; effective min: `None`; effective max: `None`. 
