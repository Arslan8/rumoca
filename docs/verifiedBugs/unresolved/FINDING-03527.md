# FINDING-03527: Not yet established as a bug or a false positive
...
| Original report | [FINDING-singlephasetwolevel-rl-l-zerolimit.md](../../v2/bugs/FINDING-singlephasetwolevel-rl-l-zerolimit.md) — reviewed as `FINDING-03527-singlephasetwolevel-rl-l.md`, which a later run renamed |
| Original SHA-256 | 4b6864b693050a8602449f5855320cff5eb75fcd6844d6a831e1e9fb5cf3a2a5 |
...
Compiler/source-resolved declaration: `Electrical/PowerConverters/Examples/DCAC/SinglePhaseTwoLevel/SinglePhaseTwoLevel_RL.mo:10`. Role: `parameter`; binding: `1`; effective min: `None`; effective max: `None`. 
