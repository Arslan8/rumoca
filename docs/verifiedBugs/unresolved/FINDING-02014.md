# FINDING-02014: Not yet established as a bug or a false positive
...
| Original report | [FINDING-imc-yd-switchyd-ron-ruleoff.md](../../v2/bugs/FINDING-imc-yd-switchyd-ron-ruleoff.md) — reviewed as `FINDING-02014-imc-yd-switchyd-ron.md`, which a later run renamed |
| Original SHA-256 | 3fedd22489b4b222478ce070d4d2bdc599a41885d522407a68d0427ad204788c |
...
Compiler/source-resolved declaration: `Electrical/Machines/Utilities/SwitchYD.mo:4`. Role: `parameter`; binding: `1e-05`; effective min: `None`; effective max: `None`. 

[Electrical/Machines/Utilities/SwitchYD.mo — source snapshot](../evidence/sources/dee3d978f63daa43-SwitchYD.mo)

```modelica
2: model SwitchYD "Y-D-switch"
