# FINDING-03892: Not yet established as a bug or a false positive
...
| Original report | `FINDING-03892-fieldweakeningcontroller-kp.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 10d324fdcd375b9d5479edb41e88a7bb0d174e1fb8fd4fa1205b2b07535e3196 |
...
Compiler/source-resolved declaration: `Magnetic/QuasiStatic/FundamentalWave/Examples/ExampleUtilities/FieldWeakeningController.mo:6`. Role: `parameter`; binding: `1`; effective min: `None`; effective max: `None`. 
...
```modelica
4:   parameter Modelica.Units.SI.Voltage VNominal "Nominal rms voltage per phase";
