# FINDING-02638: Not yet established as a bug or a false positive
...
| Original report | [FINDING-smr-inverter-smr-dampercage-rrq-zerolimit.md](../../v2/bugs/FINDING-smr-inverter-smr-dampercage-rrq-zerolimit.md) — reviewed as `FINDING-02638-smr-inverter-smr-dampercage-rrq.md`, which a later run renamed |
| Original SHA-256 | 7bb4a9cd77eb37640da3a22fbd4d8b0bda8c2f1b3d48c5b02bd490931eb68b2a |
...
Compiler/source-resolved declaration: `Electrical/Machines/BasicMachines/Components/DamperCage.mo:9`. Role: `parameter`; binding: `smrData.Rrq`; effective min: `None`; effective max: `None`. 
