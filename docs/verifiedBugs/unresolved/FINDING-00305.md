# FINDING-00305: Not yet established as a bug or a false positive
...
| Original report | [FINDING-heatingnpn-norgate-t1-phie-divzero.md](../../v2/bugs/FINDING-heatingnpn-norgate-t1-phie-divzero.md) — reviewed as `FINDING-00305-heatingnpn-norgate-t1-phie.md`, which a later run renamed |
| Original SHA-256 | 7ebd3305a8ac06b1dce8a50e0b74befb367617151bf806a55fda42935f0e8274 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Semiconductors/NPN.mo:12`. Role: `parameter`; binding: `1`; effective min: `None`; effective max: `None`. 
