# FINDING-01542: Not yet established as a bug or a false positive
...
| Original report | [FINDING-imc-dcbraking-imcdata-lm-intent.md](../../v2/bugs/FINDING-imc-dcbraking-imcdata-lm-intent.md) — reviewed as `FINDING-01542-imc-dcbraking-imcdata-lm.md`, which a later run renamed |
| Original SHA-256 | e4492512c485136e5b6afcc1242a160b9bfcfac950d2ea66f9b0e65ef9105522 |
...
Compiler/source-resolved declaration: `Electrical/Machines/Utilities/ParameterRecords/IM_SquirrelCageData.mo:6`. Role: `parameter`; binding: `((3 * sqrt((1 - 0.0667))) / ((2 * (2 * asin(1.0))) * imcData.fsNominal))`; effective min: `None`; effective max: `None`. 
