# FINDING-03607: Not yet established as a bug or a false positive
...
| Target | chopperStepUp.GoffDiode |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-chopperstepup-r-chopperstepup-goffdiode-zerolimit.md](../../v2/bugs/FINDING-chopperstepup-r-chopperstepup-goffdiode-zerolimit.md) — reviewed as `FINDING-03607-chopperstepup-r-chopperstepup-goffdiode.md`, which a later run renamed |
| Original SHA-256 | 1715fa2e66dc563bf10a11eded982a3a6dd7d67e03f772afacbb01e8ade6c23f |
...
Compiler/source-resolved declaration: `Electrical/PowerConverters/DCDC/ChopperStepUp.mo:13`. Role: `parameter`; binding: `1e-05`; effective min: `0`; effective max: `None`. 
