# FINDING-02904: Not yet established as a bug or a false positive
...
| Original report | [FINDING-transformertestbench-transformerdata-l2sigma-intent.md](../../v2/bugs/FINDING-transformertestbench-transformerdata-l2sigma-intent.md) — reviewed as `FINDING-02904-transformertestbench-transformerdata-l2sigma.md`, which a later run renamed |
| Original SHA-256 | bb154f63d7a016fe52e3e34eebed5ff6caa5b92c6c4b343dc0660ec82c93cd6e |
...
Compiler/source-resolved declaration: `Electrical/Machines/Utilities/TransformerData.mo:48`. Role: `parameter`; binding: `(sqrt(((transformerData.Z2ph ^ 2) - (transformerData.R2 ^ 2))) / ((2 * (2 * asin(1.0))) * transformerData.f))`; effective min: `None`; effective max: `None`. 
