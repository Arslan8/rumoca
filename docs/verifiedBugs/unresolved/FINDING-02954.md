# FINDING-02954: Not yet established as a bug or a false positive
...
| Original report | [FINDING-testsensors-r-zerolimit.md](../../v2/bugs/FINDING-testsensors-r-zerolimit.md) — reviewed as `FINDING-02954-testsensors-r.md`, which a later run renamed |
| Original SHA-256 | 7397802a7dc86b832e74b0e0a2a2b7bf2f2686a42ae57a7c0f33dcfcee947d50 |
...
Compiler/source-resolved declaration: `Electrical/Polyphase/Examples/TestSensors.mo:9`. Role: `parameter`; binding: `(1 / sqrt(2))`; effective min: `None`; effective max: `None`. 
