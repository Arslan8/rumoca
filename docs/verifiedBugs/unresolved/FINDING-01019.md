# FINDING-01019: Not yet established as a bug or a false positive
...
| Target | simpleTriac.Vt |
| Student classification | divisor-reachable-zero |
| Original report | `FINDING-01019-simpletriaccircuit-simpletriac-vt.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | cb0e3a78d4a6012f4b483843630018b6dba613559a273fa5c098863aa8b1048a |
...
Compiler/source-resolved declaration: `Electrical/Analog/Semiconductors/SimpleTriac.mo:17`. Role: `parameter`; binding: `0.04`; effective min: `None`; effective max: `None`. 
