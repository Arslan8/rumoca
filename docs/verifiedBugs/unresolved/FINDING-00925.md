# FINDING-00925: Not yet established as a bug or a false positive
...
| Original report | [FINDING-signalgenerator-r-unbounded.md](../../v2/bugs/FINDING-signalgenerator-r-unbounded.md) — reviewed as `FINDING-00925-signalgenerator-r.md`, which a later run renamed |
| Original SHA-256 | c044b43b312e5b98693bc282ca5e84fdcd6f33db4f1ce0959310939f8caceceb |
...
Compiler/source-resolved declaration: `Electrical/Analog/Examples/OpAmps/SignalGenerator.mo:11`. Role: `parameter`; binding: `1000`; effective min: `None`; effective max: `None`. 
