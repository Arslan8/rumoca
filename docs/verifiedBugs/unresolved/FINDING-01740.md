# FINDING-01740: Not yet established as a bug or a false positive
...
| Original report | [FINDING-imc-inverterdrive-aimcdata-lm-intent.md](../../v2/bugs/FINDING-imc-inverterdrive-aimcdata-lm-intent.md) — reviewed as `FINDING-01740-imc-inverterdrive-aimcdata-lm.md`, which a later run renamed |
| Original SHA-256 | d18a2a3076a0cee6426f6e23c20fc475c9ceab921e62bc2528369c4a913cf064 |
...
Compiler/source-resolved declaration: `Electrical/Machines/Utilities/ParameterRecords/IM_SquirrelCageData.mo:6`. Role: `parameter`; binding: `(((3 * sqrt((1 - 0.0667))) / ((2 * (2 * asin(1.0))) * aimcData.fsNominal)) * 16)`; effective min: `None`; effective max: `None`. 
