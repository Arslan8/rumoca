# FINDING-01741: Not yet established as a bug or a false positive
...
| Original report | [FINDING-imc-inverterdrive-aimcdata-lrsigma-intent.md](../../v2/bugs/FINDING-imc-inverterdrive-aimcdata-lrsigma-intent.md) — reviewed as `FINDING-01741-imc-inverterdrive-aimcdata-lrsigma.md`, which a later run renamed |
| Original SHA-256 | fe4e717ea8d9bfef54d13c14a818c1abe912d9b227ac88bf834730ca6256b43b |
...
Compiler/source-resolved declaration: `Electrical/Machines/Utilities/ParameterRecords/IM_SquirrelCageData.mo:9`. Role: `parameter`; binding: `(((3 * (1 - sqrt((1 - 0.0667)))) / ((2 * (2 * asin(1.0))) * aimcData.fsNominal)) * 16)`; effective min: `None`; effective max: `None`. 
