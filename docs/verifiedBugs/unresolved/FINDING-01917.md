# FINDING-01917: Not yet established as a bug or a false positive
...
| Original report | [FINDING-imc-ydarc-lline-zerolimit.md](../../v2/bugs/FINDING-imc-ydarc-lline-zerolimit.md) — reviewed as `FINDING-01917-imc-ydarc-lline.md`, which a later run renamed |
| Original SHA-256 | 389da2fd5d374842ff5bd2b673cb2924b416ffb6a91acfc734e90db94fe83572 |
...
Compiler/source-resolved declaration: `Electrical/Machines/Examples/InductionMachines/IMC_YDarc.mo:10`. Role: `parameter`; binding: `(0.0001 / ((2 * (2 * asin(1.0))) * fNominal))`; effective min: `None`; effective max: `None`. 
