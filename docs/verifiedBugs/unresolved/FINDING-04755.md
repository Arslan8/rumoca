# FINDING-04755: Not yet established as a bug or a false positive
...
| Target | directCapacity.C |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-generationoffmus-directcapacity-c-intent.md](../../v2/bugs/FINDING-generationoffmus-directcapacity-c-intent.md) — reviewed as `FINDING-04755-generationoffmus-directcapacity-c.md`, which a later run renamed |
| Original SHA-256 | 270a3936767620b20850ff9d629c2ef3b613bcb7e24cc6b52a548ba5e96731e1 |
...
Compiler/source-resolved declaration: `Thermal/HeatTransfer/Examples/Utilities/DirectCapacity.mo:5`. Role: `parameter`; binding: `1.1`; effective min: `0`; effective max: `None`. 
