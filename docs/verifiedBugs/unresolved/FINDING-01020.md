# FINDING-01020: Not yet established as a bug or a false positive
...
| Target | simpleTriac.ITM |
| Student classification | divisor-reachable-zero |
| Original report | `FINDING-01020-simpletriaccircuit-simpletriac-itm.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | b5580d65eb53958825a7b7e9dddb338e516abfcd71de04b3c902bd626459b258 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Semiconductors/SimpleTriac.mo:10`. Role: `parameter`; binding: `25`; effective min: `None`; effective max: `None`. 
