# FINDING-03873: Not yet established as a bug or a false positive
...
| Original report | `FINDING-03873-simplesolenoid-t-polebot.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 9abc85a58cf7e46172279f865a8bbe2bd8b8784a888725a670ba7f802e9b3df4 |
...
Compiler/source-resolved declaration: `Magnetic/FluxTubes/Examples/SolenoidActuator/Components/SimpleSolenoid.mo:18`. Role: `parameter`; binding: `0.0035`; effective min: `None`; effective max: `None`. 
