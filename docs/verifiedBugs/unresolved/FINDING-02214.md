# FINDING-02214: Not yet established as a bug or a false positive
...
| Target | smee.damperCage.Rrd |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-smee-generator-smee-dampercage-rrd-zerolimit.md](../../v2/bugs/FINDING-smee-generator-smee-dampercage-rrd-zerolimit.md) — reviewed as `FINDING-02214-smee-generator-smee-dampercage-rrd.md`, which a later run renamed |
| Original SHA-256 | 4b1d43e7dcba03ab3269fdf5375db54e92865ba20a544f5668f82332345f9b6e |
...
Compiler/source-resolved declaration: `Electrical/Machines/BasicMachines/Components/DamperCage.mo:7`. Role: `parameter`; binding: `smeeData.Rrd`; effective min: `None`; effective max: `None`. 
