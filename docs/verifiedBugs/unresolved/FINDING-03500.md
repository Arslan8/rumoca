# FINDING-03500: Not yet established as a bug or a false positive
...
| Original report | [FINDING-thyristorcentertapmpulse-rlv-r-zerolimit.md](../../v2/bugs/FINDING-thyristorcentertapmpulse-rlv-r-zerolimit.md) — reviewed as `FINDING-03500-thyristorcentertapmpulse-rlv-r.md`, which a later run renamed |
| Original SHA-256 | 8fc42b5e852622942a49b8c78456980609994807c38ccea43c551e2686ff49cc |
...
Compiler/source-resolved declaration: `Electrical/PowerConverters/Examples/ACDC/RectifierCenterTapmPulse/ThyristorCenterTapmPulse_RLV.mo:10`. Role: `parameter`; binding: `20`; effective min: `None`; effective max: `None`. 
