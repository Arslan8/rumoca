# FINDING-02086: Not yet established as a bug or a false positive
...
| Original report | [FINDING-ims-start-switchedrheostat-idealcommutingswitch-goff-ruleoff.md](../../v2/bugs/FINDING-ims-start-switchedrheostat-idealcommutingswitch-goff-ruleoff.md) — reviewed as `FINDING-02086-ims-start-switchedrheostat-idealcommutingswitch-goff.md`, which a later run renamed |
| Original SHA-256 | 253fb38698c1f5b9db7e807be43b5a311796979fa9b9caf4c170e304aa86400c |
...
Compiler/source-resolved declaration: `Electrical/Polyphase/Ideal/IdealCommutingSwitch.mo:6`. Role: `parameter`; binding: `fill(1e-05, switchedRheostat.m)`; effective min: `zeros(3)`; effective max: `None`. 
