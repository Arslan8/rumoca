# FINDING-04212: Not yet established as a bug or a false positive
...
| Original report | [FINDING-planarfourbar-body4-mi-zerolimit.md](../../v2/bugs/FINDING-planarfourbar-body4-mi-zerolimit.md) — reviewed as `FINDING-04212-planarfourbar-body4-mi.md`, which a later run renamed |
| Original SHA-256 | 80f9e33dc8797fe92b999657f1835c4677ed04a53379bf2492fe429eac99a577 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/BodyBox.mo:103`. Role: `parameter`; binding: `(((body4.density * body4.length) * body4.innerWidth) * body4.innerHeight)`; effective min: `0`; effective max: `None`. 
