# FINDING-03442: Not yet established as a bug or a false positive
...
| Original report | [FINDING-thyristorcentertap2pulse-rlv-r-zerolimit.md](../../v2/bugs/FINDING-thyristorcentertap2pulse-rlv-r-zerolimit.md) — reviewed as `FINDING-03442-thyristorcentertap2pulse-rlv-r.md`, which a later run renamed |
| Original SHA-256 | e25c8bfd8ee74d3871ccd404e3e40e0391f8ba2fddf0fdabb1c43657166dab7d |
...
Compiler/source-resolved declaration: `Electrical/PowerConverters/Examples/ACDC/RectifierCenterTap2Pulse/ThyristorCenterTap2Pulse_RLV.mo:10`. Role: `parameter`; binding: `20`; effective min: `None`; effective max: `None`. 
