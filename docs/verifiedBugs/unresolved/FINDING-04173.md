# FINDING-04173: Not yet established as a bug or a false positive
...
| Original report | [FINDING-planarfourbar-body1-mi-zerolimit.md](../../v2/bugs/FINDING-planarfourbar-body1-mi-zerolimit.md) — reviewed as `FINDING-04173-planarfourbar-body1-mi.md`, which a later run renamed |
| Original SHA-256 | 85e793a9315548123042c57adb526d76ef3c132bded4a65a52a1e4dd0a659317 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/BodyBox.mo:103`. Role: `parameter`; binding: `(((body1.density * body1.length) * body1.innerWidth) * body1.innerHeight)`; effective min: `0`; effective max: `None`. 
