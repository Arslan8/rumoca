# FINDING-01295: Not yet established as a bug or a false positive
...
| Original report | [FINDING-dcpm-currentcontrolled-ts-divzero-2.md](../../v2/bugs/FINDING-dcpm-currentcontrolled-ts-divzero-2.md) — reviewed as `FINDING-01295-dcpm-currentcontrolled-ts.md`, which a later run renamed |
| Original SHA-256 | eb3f834e5e10f8f9e1e66a2e5cc2c2da7b2c63044950ae396fd8d69eccb014bf |
...
Compiler/source-resolved declaration: `Electrical/Machines/Examples/DCMachines/DCPM_CurrentControlled.mo:15`. Role: `parameter`; binding: `0.001`; effective min: `None`; effective max: `None`. 
...
```modelica
13:   parameter SI.Voltage ViNominal=dcpmData.VaNominal - Ra*dcpmData.IaNominal "Nominal induced voltage";
