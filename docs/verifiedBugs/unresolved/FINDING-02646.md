# FINDING-02646: Not yet established as a bug or a false positive
...
| Original report | [FINDING-smr-inverter-smrdata-lmq-intent.md](../../v2/bugs/FINDING-smr-inverter-smrdata-lmq-intent.md) — reviewed as `FINDING-02646-smr-inverter-smrdata-lmq.md`, which a later run renamed |
| Original SHA-256 | 9f2c0d07f37d130b1c7e90906b5d64c9021f5e5254c82376457a8c8a491b8374 |
...
Compiler/source-resolved declaration: `Electrical/Machines/Utilities/ParameterRecords/SM_ReluctanceRotorData.mo:9`. Role: `parameter`; binding: `(0.9 / ((2 * (2 * asin(1.0))) * smrData.fsNominal))`; effective min: `None`; effective max: `None`. 
