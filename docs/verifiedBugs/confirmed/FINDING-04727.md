# FINDING-04727: Zero medium density enters an unguarded division
...
| Target | oneWayValve.flowPort_b.medium.rho |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-waterpump-onewayvalve-flowport-b-medium-rho-intent.md](../../v2/bugs/FINDING-waterpump-onewayvalve-flowport-b-medium-rho-intent.md) — reviewed as `FINDING-04727-waterpump-onewayvalve-flowport-b-medium-rho.md`, which a later run renamed |
| Original SHA-256 | ded104d95546ce25331d8b9d4e1eacf1c901034683521fb5b820731bf52b4a1c |
...
| Probe | Outcome |
|---|---|
| `oneWayValve.flowPort_b.medium.rho=0` | clean |
