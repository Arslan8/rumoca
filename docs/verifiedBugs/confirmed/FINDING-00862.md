# FINDING-00862: Example waveform timing divides by zero frequency
...
| Original report | [FINDING-lowpass-f-divzero-2.md](../../v2/bugs/FINDING-lowpass-f-divzero-2.md) — reviewed as `FINDING-00862-lowpass-f.md`, which a later run renamed |
| Original SHA-256 | 4a6aebcc65fa518ca63bc2cc5d3a8b1a418bdce93bc590db528ead83ee93491e |
...
Compiler/source-resolved declaration: `Electrical/Analog/Examples/OpAmps/LowPass.mo:6`. Role: `parameter`; binding: `10`; effective min: `None`; effective max: `None`. 

[Electrical/Analog/Examples/OpAmps/LowPass.mo — source snapshot](../evidence/sources/8de86ff761d082f1-LowPass.mo)
...
2: model LowPass "Low-pass filter"
...
13:         rotation=270,
14:         origin={40,0})));
15:   OpAmpCircuits.FirstOrder firstOrder(
16:     T=1/(2*pi*fG), v(fixed=true))
...
31:         origin={-40,0})));
32: equation
33:   connect(firstOrder.n1, ground.p)
34:     annotation (Line(points={{-10,-10},{-10,-20},{-10,-20}}, color={0,0,255}));
35:   connect(firstOrder.p2, vOut.p)
36:     annotation (Line(points={{10,10},{40,10}}, color={0,0,255}));
37:   connect(firstOrder.n2, vOut.n)
38:     annotation (Line(points={{10,-10},{40,-10}}, color={0,0,255}));
39:   connect(vIn.p, firstOrder.p1)
40:     annotation (Line(points={{-40,10},{-10,10}}, color={0,0,255}));
41:   connect(vIn.n, firstOrder.n1)
42:     annotation (Line(points={{-40,-10},{-10,-10}}, color={0,0,255}));
43:   annotation (Documentation(info="<html>
44: <p>This is a (inverting) low pass filter. Resistance R1 can be chosen, resistance R2 is defined by the desired amplification k, capacitance C is defined by the desired cut-off frequency.</p>
...
[Independent OpenModelica wrappers and complete output](../evidence/omc-extra-0328afa01e2550ef.json). Baseline: simulation succeeded.
