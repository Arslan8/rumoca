# FINDING-04716: Zero medium density enters an unguarded division
...
| Target | idealPump.flowPort_a.medium.rho |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-waterpump-idealpump-flowport-a-medium-rho-intent.md](../../v2/bugs/FINDING-waterpump-idealpump-flowport-a-medium-rho-intent.md) — reviewed as `FINDING-04716-waterpump-idealpump-flowport-a-medium-rho.md`, which a later run renamed |
| Original SHA-256 | 8209681ff590c2355b8587f96e8177f9995be8472d78e62bd56e2f6e425f58a4 |
...
| Probe | Outcome |
|---|---|
| `idealPump.flowPort_a.medium.rho=0` | clean |
