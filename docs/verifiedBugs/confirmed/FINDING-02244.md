# FINDING-02244: Equal machine reactances divide by zero
...
| Original report | [FINDING-smee-generator-smeedata-xq-divequal-2.md](../../v2/bugs/FINDING-smee-generator-smeedata-xq-divequal-2.md) — reviewed as `FINDING-02244-smee-generator-smeedata-xq.md`, which a later run renamed |
| Original SHA-256 | cbcb1230016f65482d61d5cab741e3fff97c7a5f80d4feb61235de6b96736f68 |
...
Compiler/source-resolved declaration: `Electrical/Machines/Utilities/SynchronousMachineData.mo:27`. Role: `parameter`; binding: `1.6`; effective min: `None`; effective max: `None`. 
