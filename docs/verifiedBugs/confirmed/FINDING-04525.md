# FINDING-04525: Zero medium density enters an unguarded division
...
| Target | innerMedium.rho |
| Student classification | divisor-reachable-zero |
| Original report | [FINDING-indirectcooling-innermedium-rho-divzero-2.md](../../v2/bugs/FINDING-indirectcooling-innermedium-rho-divzero-2.md) — reviewed as `FINDING-04525-indirectcooling-innermedium-rho.md`, which a later run renamed |
| Original SHA-256 | 627536ef1e88c41ea3a57c404585921d4bd67a7dd1e2b4e2a8fa1ba6a7b0fc1f |
...
| Probe | Outcome |
|---|---|
| `innerMedium.rho=0` | reported-failure |

Diagnostic: solve-IR evaluation failed: algebraic projection did not converge at event boundary: worst scaled residual row=104 target=innerPipe.V_flow value=NaN ratio=NaN norm=inf row_scale=1.000000e0 scaled_tolerance=1.000000e-10
