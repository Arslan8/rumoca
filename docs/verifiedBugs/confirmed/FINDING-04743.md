# FINDING-04743: Zero medium specific heat capacity enters an unguarded division
...
| Target | oneWayValve.medium.cp |
| Student classification | divisor-reachable-zero |
| Original report | [FINDING-waterpump-onewayvalve-medium-cp-divzero-2.md](../../v2/bugs/FINDING-waterpump-onewayvalve-medium-cp-divzero-2.md) — reviewed as `FINDING-04743-waterpump-onewayvalve-medium-cp.md`, which a later run renamed |
| Original SHA-256 | 05f6c6815ca0a4f169dc61aeffc6874f46b17fc030cf952958820b60d8866a59 |
...
| Probe | Outcome |
|---|---|
| `oneWayValve.medium.cp=0` | reported-failure |

Diagnostic: solve-IR evaluation failed: algebraic projection did not converge at event boundary: worst scaled residual row=61 target=oneWayValve.T_b value=-inf ratio=inf norm=inf row_scale=3.000000e2 scaled_tolerance=3.000000e-8
