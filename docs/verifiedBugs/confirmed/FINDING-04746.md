# FINDING-04746: Zero medium density enters an unguarded division
...
| Original report | [FINDING-waterpump-pipe-medium-rho-divzero.md](../../v2/bugs/FINDING-waterpump-pipe-medium-rho-divzero.md) — reviewed as `FINDING-04746-waterpump-pipe-medium-rho.md`, which a later run renamed |
| Original SHA-256 | 8d77996338fa6afe1865df76a10598883eee99b1037055e2ceb6744bba158df8 |
...
| Probe | Outcome |
|---|---|
| `pipe.medium.rho=0` | reported-failure |

Diagnostic: solve-IR evaluation failed: algebraic projection did not converge at event boundary: worst scaled residual row=73 target=pipe.V_flow value=NaN ratio=NaN norm=inf row_scale=1.000000e0 scaled_tolerance=1.000000e-10
