# FINDING-04985: Inactive material data still enter an unguarded division
...
| Target | genericFluxTube3.material.B_myMax |
| Student classification | divisor-reachable-zero |
| Original report | [BUG-sources-genericfluxtube3-material-b-mymax.md](../../v2/bugs/BUG-sources-genericfluxtube3-material-b-mymax.md) — reviewed as `FINDING-04985-sources-genericfluxtube3-material-b-mymax.md`, which a later run renamed |
| Original SHA-256 | 608e1fccc08181563329fa987443dd0d9b40390632c007812722df03ac6ea9ad |
...
| Probe | Outcome |
|---|---|
| `genericFluxTube3.material.B_myMax=0` | reported-failure |

Diagnostic: algebraic projection did not converge at event boundary: worst scaled residual row=49 target=genericFluxTube3.B_N value=NaN ratio=NaN norm=inf row_scale=1.000000e0 scaled_tolerance=1.000000e-10

[Independent OpenModelica wrappers and complete output](../evidence/omc-8bb9ef7f1f1c7179.json). Baseline: simulation succeeded.

- `genericFluxTube3.material.B_myMax=0` set before translation: simulation succeeded.
