# FINDING-00874: Multivibrator capacitance formula has zero divisors
...
| Original report | [FINDING-multivibrator-f-divzero-2.md](../../v2/bugs/FINDING-multivibrator-f-divzero-2.md) — reviewed as `FINDING-00874-multivibrator-f.md`, which a later run renamed |
| Original SHA-256 | ca430ea8f745d96d746e5a18f30004d106cecbe0d950027e9f487ae9878fd7f9 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Examples/OpAmps/Multivibrator.mo:6`. Role: `parameter`; binding: `10`; effective min: `None`; effective max: `None`. 
...
- `f=0` set before translation: LOG_ASSERT        | debug   | division by zero at time 0, (a=0.5) / (b=0), where divisor b expression is: log(1.0 + 2.0 * R1 / R2) * R * f.
