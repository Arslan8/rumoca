# FINDING-03736: Zero magnetic normalization scale divides by zero
...
| Target | r_mFe.material.B_myMax |
| Student classification | divisor-reachable-zero |
| Original report | [FINDING-saturatedinductor-r-mfe-material-b-mymax-divzero.md](../../v2/bugs/FINDING-saturatedinductor-r-mfe-material-b-mymax-divzero.md) — reviewed as `FINDING-03736-saturatedinductor-r-mfe-material-b-mymax.md`, which a later run renamed |
| Original SHA-256 | 0091d0c2a1d047e6ba55ccd58b3f063b9838028e4f3156520b2ccd76f1e9cb73 |
...
Compiler/source-resolved declaration: `Magnetic/FluxTubes/Material/SoftMagnetic/BaseData.mo:9`. Role: `parameter`; binding: `1.16`; effective min: `None`; effective max: `None`. 
