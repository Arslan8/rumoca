# FINDING-04740: Zero medium density enters an unguarded division
...
| Target | volumeFlowSensor.medium.rho |
| Student classification | divisor-reachable-zero |
| Original report | [FINDING-waterpump-volumeflowsensor-medium-rho-divzero.md](../../v2/bugs/FINDING-waterpump-volumeflowsensor-medium-rho-divzero.md) — reviewed as `FINDING-04740-waterpump-volumeflowsensor-medium-rho.md`, which a later run renamed |
| Original SHA-256 | 948806aa8c54525666c29e961a39fb76e2093587c71edbe07aef3594677c203c |
...
Compiler/source-resolved declaration: `Thermal/FluidHeatFlow/Media/Medium.mo:4`. Role: `parameter`; binding: `995.6`; effective min: `0.0`; effective max: `None`. 
...
| Probe | Outcome |
|---|---|
| `volumeFlowSensor.medium.rho=0` | reported-failure |

Diagnostic: solve-IR evaluation failed: algebraic projection did not converge at event boundary: worst scaled residual row=44 target=volumeFlowSensor.V_flow value=inf ratio=inf norm=inf row_scale=1.000000e0 scaled_tolerance=1.000000e-10
