# FINDING-04599: Zero medium specific heat capacity enters an unguarded division
...
| Original report | [FINDING-parallelpumpdropout-medium-cp-divzero-10.md](../../v2/bugs/FINDING-parallelpumpdropout-medium-cp-divzero-10.md) — reviewed as `FINDING-04599-parallelpumpdropout-medium-cp.md`, which a later run renamed |
| Original SHA-256 | 88a0bcabd534c92d9bd16fb87e021078685d43a24bf602fc9a1ad7d5a315d091 |
...
[Rumoca commands, return codes, integrity hashes, bounded output and metadata](../evidence/b4337df4d65e043b.json). Baseline: **clean**.

| Probe | Outcome |
|---|---|
| `medium.cp=0` | reported-failure |

Diagnostic: solve-IR evaluation failed: algebraic projection did not converge at event boundary: worst scaled residual row=67 target=pipe3.T_b value=NaN ratio=NaN norm=inf row_scale=3.000000e2 scaled_tolerance=3.000000e-8
