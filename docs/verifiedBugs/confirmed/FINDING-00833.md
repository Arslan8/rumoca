# FINDING-00833: Integrator circuit has an unguarded design denominator
...
| Original report | [FINDING-integrator-integrator-k-divzero-2.md](../../v2/bugs/FINDING-integrator-integrator-k-divzero-2.md) — reviewed as `FINDING-00833-integrator-integrator-k.md`, which a later run renamed |
| Original SHA-256 | 6831a5699bd7d2d88b4844bbcf69705356c23e2cb8ebdba069d7096655cc3b8b |
...
Compiler/source-resolved declaration: `Electrical/Analog/Examples/OpAmps/OpAmpCircuits/Integrator.mo:5`. Role: `parameter`; binding: `2`; effective min: `0`; effective max: `None`. 
...
| Probe | Outcome |
|---|---|
| `integrator.k=0` | reported-failure |
...
- `integrator.k=0` set before translation: LOG_ASSERT        | debug   | division by zero at time 0, (a=0.1591549430918953) / (b=0), where divisor b expression is: 0.0.
