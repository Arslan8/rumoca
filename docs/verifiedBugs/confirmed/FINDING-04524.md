# FINDING-04524: Zero medium density enters an unguarded division
...
| Original report | [FINDING-indirectcooling-outermedium-rho-divzero-2.md](../../v2/bugs/FINDING-indirectcooling-outermedium-rho-divzero-2.md) — reviewed as `FINDING-04524-indirectcooling-outermedium-rho.md`, which a later run renamed |
| Original SHA-256 | dc9088c99d59b7a3d1ca3d257d225bc081f9b1391311695825b87b5b7707f6e0 |
...
| Probe | Outcome |
|---|---|
| `outerMedium.rho=0` | reported-failure |

Diagnostic: solve-IR evaluation failed: algebraic projection did not converge at event boundary: worst scaled residual row=88 target=outerPipe.V_flow value=NaN ratio=NaN norm=inf row_scale=1.000000e0 scaled_tolerance=1.000000e-10
