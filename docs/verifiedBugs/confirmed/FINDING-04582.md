# FINDING-04582: Zero medium density enters an unguarded division
...
| Target | pump.flowPort_b.medium.rho |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-parallelpumpdropout-pump-flowport-b-medium-rho-intent.md](../../v2/bugs/FINDING-parallelpumpdropout-pump-flowport-b-medium-rho-intent.md) — reviewed as `FINDING-04582-parallelpumpdropout-pump-flowport-b-medium-rho.md`, which a later run renamed |
| Original SHA-256 | 8dacd0124bc197a3b64d8e2c480871946d6e199a761c5a2ccc7a32c690e3e38e |
...
| Probe | Outcome |
|---|---|
| `pump.flowPort_b.medium.rho=0` | clean |
