# FINDING-05111: Vehicle exposes zero regularization speed to reciprocal equations
...
| Target | vehicleInclination.vReg |
| Student classification | divisor-reachable-zero |
| Original report | `FINDING-05111-vehicles-vehicleinclination-vreg.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | d84672a917b654c4791f090cb58693c0f9aa5ea82b329a7884870bc504e67203 |
