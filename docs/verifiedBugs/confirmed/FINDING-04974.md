# FINDING-04974: Zero flux-tube length divides by zero
...
| Original report | [FINDING-sources-genericfluxtube-l-divzero.md](../../v2/bugs/FINDING-sources-genericfluxtube-l-divzero.md) — reviewed as `FINDING-04974-sources-genericfluxtube-l.md`, which a later run renamed |
| Original SHA-256 | ab140cfcb048a72eadd33983368c4975874809e1cb99630c59626097dec109f9 |
...
Diagnostic: algebraic projection did not converge at event boundary: worst scaled residual row=22 target=genericFluxTube.mu_r value=-inf ratio=inf norm=inf row_scale=1.000000e0 scaled_tolerance=1.000000e-10
