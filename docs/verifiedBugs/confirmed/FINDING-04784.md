# FINDING-04784: CriticalDamping accepts zero order then divides by it
...
| Original report | [FINDING-continuous-criticaldamping-n-divunresolved-2.md](../../v2/bugs/FINDING-continuous-criticaldamping-n-divunresolved-2.md) — reviewed as `FINDING-04784-continuous-criticaldamping-n.md`, which a later run renamed |
| Original SHA-256 | c57cd86cf49c9b4df2e2056b80edfe43a507e2ab2d97da71eb4ae071c40d2de5 |
