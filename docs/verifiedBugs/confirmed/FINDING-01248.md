# FINDING-01248: Zero medium density enters an unguarded division
...
| Target | cooling.flowPort_a.medium.rho |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-dcpm-cooling-cooling-flowport-a-medium-rho-intent.md](../../v2/bugs/FINDING-dcpm-cooling-cooling-flowport-a-medium-rho-intent.md) — reviewed as `FINDING-01248-dcpm-cooling-cooling-flowport-a-medium-rho.md`, which a later run renamed |
| Original SHA-256 | 22d51ca2978bd595b685b90f909dafa8415439094f746c729f1591e6159db91d |
...
Compiler/source-resolved declaration: `Thermal/FluidHeatFlow/Media/Medium.mo:4`. Role: `parameter`; binding: `cooling.medium.rho`; effective min: `0.0`; effective max: `None`. 
