# FINDING-04600: Zero medium density enters an unguarded division
...
| Original report | [FINDING-parallelpumpdropout-medium-rho-divzero-2.md](../../v2/bugs/FINDING-parallelpumpdropout-medium-rho-divzero-2.md) — reviewed as `FINDING-04600-parallelpumpdropout-medium-rho.md`, which a later run renamed |
| Original SHA-256 | f8ddee053c1686a7e3c2866a0e6df362b51ffb04ea12faed9a91a50a7bf7e3c6 |
...
| Probe | Outcome |
|---|---|
| `medium.rho=0` | reported-failure |

Diagnostic: solve-IR evaluation failed: algebraic projection did not converge at event boundary: worst scaled residual row=33 target=pipe1.V_flow value=NaN ratio=NaN norm=inf row_scale=1.000000e0 scaled_tolerance=1.000000e-10
