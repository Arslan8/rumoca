# FINDING-04662: Zero medium specific heat capacity enters an unguarded division
...
| Original report | [FINDING-simplecooling-medium-cp-divzero-2.md](../../v2/bugs/FINDING-simplecooling-medium-cp-divzero-2.md) — reviewed as `FINDING-04662-simplecooling-medium-cp.md`, which a later run renamed |
| Original SHA-256 | f1c70cf0ae9d772456a1215c5702e3f604ca9b744074be79b516fc76b6cbcd78 |
...
Diagnostic: solve-IR evaluation failed: algebraic projection did not converge at event boundary: worst scaled residual row=42 target=ambient2.T_port value=NaN ratio=NaN norm=inf row_scale=3.000000e2 scaled_tolerance=3.000000e-8
