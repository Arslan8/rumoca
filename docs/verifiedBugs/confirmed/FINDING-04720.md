# FINDING-04720: Zero medium density enters an unguarded division
...
| Target | volumeFlowSensor.flowPort_a.medium.rho |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-waterpump-volumeflowsensor-flowport-a-medium-rho-intent.md](../../v2/bugs/FINDING-waterpump-volumeflowsensor-flowport-a-medium-rho-intent.md) — reviewed as `FINDING-04720-waterpump-volumeflowsensor-flowport-a-medium-rho.md`, which a later run renamed |
| Original SHA-256 | 32664b7363a1036adaa7bb09b31ad2ae452417c2b8ed36c202ef1f5219359157 |
...
| Probe | Outcome |
|---|---|
| `volumeFlowSensor.flowPort_a.medium.rho=0` | clean |
