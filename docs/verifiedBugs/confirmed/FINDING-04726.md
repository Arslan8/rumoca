# FINDING-04726: Zero medium density enters an unguarded division
...
| Target | oneWayValve.flowPort_a.medium.rho |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-waterpump-onewayvalve-flowport-a-medium-rho-intent.md](../../v2/bugs/FINDING-waterpump-onewayvalve-flowport-a-medium-rho-intent.md) — reviewed as `FINDING-04726-waterpump-onewayvalve-flowport-a-medium-rho.md`, which a later run renamed |
| Original SHA-256 | 0f06aba13fa771af603fe7c388a2b802a284ab04d36629998413de7b32d0dfcf |
...
| Probe | Outcome |
|---|---|
| `oneWayValve.flowPort_a.medium.rho=0` | clean |
