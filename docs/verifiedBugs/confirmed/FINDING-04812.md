# FINDING-04812: CriticalDamping accepts zero order then divides by it
...
| Original report | [FINDING-continuous-initialstate-criticaldamping-n-divunresolved-2.md](../../v2/bugs/FINDING-continuous-initialstate-criticaldamping-n-divunresolved-2.md) — reviewed as `FINDING-04812-continuous-initialstate-criticaldamping-n.md`, which a later run renamed |
| Original SHA-256 | 99bd8b75309281d878c8b9fc215b446dfc5c4d20ccae16748da287a77a81369f |
...
Compiler/source-resolved declaration: `Blocks/Continuous.mo:1504`. Role: `parameter`; binding: `2`; effective min: `None`; effective max: `None`. 
