# FINDING-04838: FirstOrder divides by an unconstrained zero time constant
...
| Original report | [FINDING-unitdeduction-firstorder-t-divzero.md](../../v2/bugs/FINDING-unitdeduction-firstorder-t-divzero.md) — reviewed as `FINDING-04838-unitdeduction-firstorder-t.md`, which a later run renamed |
| Original SHA-256 | 6c28497efa2f913351f53de1d436a40cfcbc684d87d1a285c91c7afb8c2d6599 |
...
Compiler/source-resolved declaration: `Blocks/Continuous.mo:354`. Role: `parameter`; binding: `2`; effective min: `None`; effective max: `None`. 
