# FINDING-04722: Zero medium density enters an unguarded division
...
| Target | pressureSensor.medium.rho |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-waterpump-pressuresensor-medium-rho-intent.md](../../v2/bugs/FINDING-waterpump-pressuresensor-medium-rho-intent.md) — reviewed as `FINDING-04722-waterpump-pressuresensor-medium-rho.md`, which a later run renamed |
| Original SHA-256 | 5f7dd13e274056653591000f7dc9485ad3bb94e497756597c89ec182139c992c |
...
| Probe | Outcome |
|---|---|
| `pressureSensor.medium.rho=0` | clean |
