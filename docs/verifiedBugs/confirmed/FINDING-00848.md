# FINDING-00848: LC oscillator design divides by zero
...
| Original report | [FINDING-lcoscillator-r-unbounded.md](../../v2/bugs/FINDING-lcoscillator-r-unbounded.md) — reviewed as `FINDING-00848-lcoscillator-r.md`, which a later run renamed |
| Original SHA-256 | 4b4005e8a19e883f6d5913259c8a52e6f458cd2a7e8f30ebcaaf16d5353c6d24 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Examples/OpAmps/LCOscillator.mo:10`. Role: `parameter`; binding: `10000.0`; effective min: `None`; effective max: `None`. 
...
- `R=0` set before translation: LOG_ASSERT        | debug   | division by zero at time 0, (a=-0.0009999999999998899) / (b=0), where divisor b expression is: C * R.
