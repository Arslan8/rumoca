# FINDING-01251: Zero medium density enters an unguarded division
...
| Target | outlet.flowPort.medium.rho |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-dcpm-cooling-outlet-flowport-medium-rho-intent.md](../../v2/bugs/FINDING-dcpm-cooling-outlet-flowport-medium-rho-intent.md) — reviewed as `FINDING-01251-dcpm-cooling-outlet-flowport-medium-rho.md`, which a later run renamed |
| Original SHA-256 | 48eb52241d5cd3465e2be6d9f677d5f4af02543baf87cb1036a6561bbaae91b8 |
...
Compiler/source-resolved declaration: `Thermal/FluidHeatFlow/Media/Medium.mo:4`. Role: `parameter`; binding: `outlet.medium.rho`; effective min: `0.0`; effective max: `None`. 
