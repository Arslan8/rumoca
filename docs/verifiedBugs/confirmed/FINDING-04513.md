# FINDING-04513: Zero medium density enters an unguarded division
...
| Target | innerPump.flowPort_a.medium.rho |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-indirectcooling-innerpump-flowport-a-medium-rho-intent.md](../../v2/bugs/FINDING-indirectcooling-innerpump-flowport-a-medium-rho-intent.md) — reviewed as `FINDING-04513-indirectcooling-innerpump-flowport-a-medium-rho.md`, which a later run renamed |
| Original SHA-256 | 6a989d58ab28a908e3152dbdc1258de240abc14d3d86da6ca65b4b9739124128 |
...
| Probe | Outcome |
|---|---|
| `innerPump.flowPort_a.medium.rho=0` | clean |
