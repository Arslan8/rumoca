# FINDING-00802: Control-circuit time constants create zero divisions
...
| Original report | [FINDING-controlcircuit-t1-divzero-2.md](../../v2/bugs/FINDING-controlcircuit-t1-divzero-2.md) — reviewed as `FINDING-00802-controlcircuit-t1.md`, which a later run renamed |
| Original SHA-256 | 057816eebd335707b1caffc90c0bb3810c64ac0599cc5cf7d7d05adf88a1f7c5 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Examples/OpAmps/ControlCircuit.mo:4`. Role: `parameter`; binding: `0.01`; effective min: `None`; effective max: `None`. 

[Electrical/Analog/Examples/OpAmps/ControlCircuit.mo — source snapshot](../evidence/sources/2006c2afcee8deb4-ControlCircuit.mo)

```modelica
2: model ControlCircuit "Control circuit"
...
- `T1=0` set before translation: LOG_ASSERT        | debug   | division by zero at time 0, (a=0.01) / (b=0), where divisor b expression is: T1.
