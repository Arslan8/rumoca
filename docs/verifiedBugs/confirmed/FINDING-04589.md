# FINDING-04589: Zero medium density enters an unguarded division
...
| Target | pipe2.flowPort_a.medium.rho |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-parallelpumpdropout-pipe2-flowport-a-medium-rho-intent.md](../../v2/bugs/FINDING-parallelpumpdropout-pipe2-flowport-a-medium-rho-intent.md) — reviewed as `FINDING-04589-parallelpumpdropout-pipe2-flowport-a-medium-rho.md`, which a later run renamed |
| Original SHA-256 | 085e151628cfeaa61ba05b05628fe522542ecc21782d140fd06788cbdffe9ad1 |
...
| Probe | Outcome |
|---|---|
| `pipe2.flowPort_a.medium.rho=0` | clean |
