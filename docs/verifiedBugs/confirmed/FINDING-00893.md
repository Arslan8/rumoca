# FINDING-00893: Der circuit has an unguarded design denominator
...
| Original report | [FINDING-der-f-divzero-2.md](../../v2/bugs/FINDING-der-f-divzero-2.md) — reviewed as `FINDING-00893-der-f.md`, which a later run renamed |
| Original SHA-256 | 1426ab7fd15f5a83d521ce09bddcf5bdaf1a8bace4fcd96c6d9d5ac15748deb5 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Examples/OpAmps/OpAmpCircuits/Der.mo:6`. Role: `parameter`; binding: `None`; effective min: `None`; effective max: `None`. 
