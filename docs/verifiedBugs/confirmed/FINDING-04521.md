# FINDING-04521: Zero medium density enters an unguarded division
...
| Target | innerPipe.flowPort_a.medium.rho |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-indirectcooling-innerpipe-flowport-a-medium-rho-intent.md](../../v2/bugs/FINDING-indirectcooling-innerpipe-flowport-a-medium-rho-intent.md) — reviewed as `FINDING-04521-indirectcooling-innerpipe-flowport-a-medium-rho.md`, which a later run renamed |
| Original SHA-256 | b6f5939bf4b35af64b0b731cc9b37cc88b912f5176ee29ce9e0ee0241c7388d4 |
...
| Probe | Outcome |
|---|---|
| `innerPipe.flowPort_a.medium.rho=0` | clean |
