# FINDING-04594: Zero medium density enters an unguarded division
...
| Target | pipe3.flowPort_b.medium.rho |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-parallelpumpdropout-pipe3-flowport-b-medium-rho-intent.md](../../v2/bugs/FINDING-parallelpumpdropout-pipe3-flowport-b-medium-rho-intent.md) — reviewed as `FINDING-04594-parallelpumpdropout-pipe3-flowport-b-medium-rho.md`, which a later run renamed |
| Original SHA-256 | 0a2ff54cae3fd1867c8174039f5bca7449da80c8ba380c3acd62140b56a98d4e |
...
| Probe | Outcome |
|---|---|
| `pipe3.flowPort_b.medium.rho=0` | clean |
