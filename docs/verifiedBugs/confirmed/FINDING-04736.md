# FINDING-04736: Zero medium specific heat capacity enters an unguarded division
...
| Original report | [FINDING-waterpump-ambient1-medium-cp-divzero-2.md](../../v2/bugs/FINDING-waterpump-ambient1-medium-cp-divzero-2.md) — reviewed as `FINDING-04736-waterpump-ambient1-medium-cp.md`, which a later run renamed |
| Original SHA-256 | 839ecbba88a00affd62b5c0a5e48f7f7ac450311d75e7f1e6dd090b30b7fa146 |
...
| Probe | Outcome |
|---|---|
| `ambient1.medium.cp=0` | reported-failure |

Diagnostic: solve-IR evaluation failed: algebraic projection did not converge at event boundary: worst scaled residual row=18 target=ambient1.T_port value=-inf ratio=inf norm=inf row_scale=3.000000e2 scaled_tolerance=3.000000e-8
