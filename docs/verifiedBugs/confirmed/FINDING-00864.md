# FINDING-00864: FirstOrder circuit has an unguarded design denominator
...
| Target | firstOrder.R2 |
| Student classification | divisor-reachable-zero |
| Original report | [FINDING-lowpass-firstorder-r2-divzero-2.md](../../v2/bugs/FINDING-lowpass-firstorder-r2-divzero-2.md) — reviewed as `FINDING-00864-lowpass-firstorder-r2.md`, which a later run renamed |
| Original SHA-256 | 723813ee98964df27245f724cdeff1734c9abb7753f51440bc338c0b30e2b985 |
...
| Probe | Outcome |
|---|---|
| `firstOrder.R2=0` | reported-failure |
...
- `firstOrder.R2=0` set before translation: LOG_ASSERT        | debug   | division by zero at time 0, (a=0.1591549430918953) / (b=0), where divisor b expression is: firstOrder.R2.
