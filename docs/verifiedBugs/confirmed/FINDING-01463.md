# FINDING-01463: Zero nominal speed makes DC-machine scaling undefined
...
| Target | dcpmData1.wNominal |
| Student classification | divisor-reachable-zero |
| Original report | `FINDING-01463-dcpm-withlosses-dcpmdata1-wnominal.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 2f266e03403a935cef1fcd7060eb1fe32786a565bfb07508a99c523b3f8986e5 |
