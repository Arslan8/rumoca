# FINDING-04170: Zero MultiBody visualization fraction divides geometry by zero
...
| Original report | [FINDING-userdefinedgravityfield-world-defaultwidthfraction-divzero-2.md](../../v2/bugs/FINDING-userdefinedgravityfield-world-defaultwidthfraction-divzero-2.md) — reviewed as `FINDING-04170-userdefinedgravityfield-world-defaultwidthfraction.md`, which a later run renamed |
| Original SHA-256 | 079d9ebb8f840791f72006bace5d4a47199e905b08a20c9706cc6f975bb53e56 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/package.mo:128`. Role: `parameter`; binding: `20`; effective min: `None`; effective max: `None`. 
...
[Rumoca commands, return codes, integrity hashes, bounded output and metadata](../evidence/baaf110c9617f6c6.json). Baseline: **tool-error**.
