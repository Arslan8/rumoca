# FINDING-03837: Zero magnetic normalization scale divides by zero
...
| Original report | [FINDING-advancedsolenoid-material-b-mymax-divzero-2.md](../../v2/bugs/FINDING-advancedsolenoid-material-b-mymax-divzero-2.md) — reviewed as `FINDING-03837-advancedsolenoid-material-b-mymax.md`, which a later run renamed |
| Original SHA-256 | b77f9946de9c2508039b729323a487d78952d037e98d646724c9133df0e02d45 |
...
Compiler/source-resolved declaration: `Magnetic/FluxTubes/Material/SoftMagnetic/BaseData.mo:9`. Role: `parameter`; binding: `1.488`; effective min: `None`; effective max: `None`. 
