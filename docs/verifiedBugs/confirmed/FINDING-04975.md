# FINDING-04975: Inactive material data still enter an unguarded division
...
| Target | genericFluxTube1.material.B_myMax |
| Student classification | divisor-reachable-zero |
| Original report | [BUG-sources-genericfluxtube1-material-b-mymax.md](../../v2/bugs/BUG-sources-genericfluxtube1-material-b-mymax.md) — reviewed as `FINDING-04975-sources-genericfluxtube1-material-b-mymax.md`, which a later run renamed |
| Original SHA-256 | 63310fa1bc405d33ba655dae36f9260aefd88c496688d489bb9763db8272fa70 |
...
| Probe | Outcome |
|---|---|
| `genericFluxTube1.material.B_myMax=0` | reported-failure |

Diagnostic: algebraic projection did not converge at event boundary: worst scaled residual row=24 target=genericFluxTube1.B value=NaN ratio=NaN norm=inf row_scale=1.000000e0 scaled_tolerance=1.000000e-10

[Independent OpenModelica wrappers and complete output](../evidence/omc-8bb9ef7f1f1c7179.json). Baseline: simulation succeeded.

- `genericFluxTube1.material.B_myMax=0` set before translation: simulation succeeded.
