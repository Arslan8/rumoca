# FINDING-04723: Zero medium density enters an unguarded division
...
| Target | pressureSensor.flowPort.medium.rho |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-waterpump-pressuresensor-flowport-medium-rho-intent.md](../../v2/bugs/FINDING-waterpump-pressuresensor-flowport-medium-rho-intent.md) — reviewed as `FINDING-04723-waterpump-pressuresensor-flowport-medium-rho.md`, which a later run renamed |
| Original SHA-256 | c12cc970d96fd8589a43775f3e75c3ff19191c19dc5404adc063831555ec3b50 |
...
| Probe | Outcome |
|---|---|
| `pressureSensor.flowPort.medium.rho=0` | clean |
