# FINDING-04571: Zero medium specific heat capacity enters an unguarded division
...
| Original report | [FINDING-parallelcooling-medium-cp-divzero-10.md](../../v2/bugs/FINDING-parallelcooling-medium-cp-divzero-10.md) — reviewed as `FINDING-04571-parallelcooling-medium-cp.md`, which a later run renamed |
| Original SHA-256 | b24ac5da03d70bbb44114b46c1f758b9665426687ccafddeae497c35de168be0 |
...
[Rumoca commands, return codes, integrity hashes, bounded output and metadata](../evidence/0a51b764098d5e36.json). Baseline: **clean**.
