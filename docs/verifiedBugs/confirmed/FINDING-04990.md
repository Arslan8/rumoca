# FINDING-04990: Inactive material data still enter an unguarded division
...
| Original report | [BUG-sensors-genericfluxtube-material-b-mymax.md](../../v2/bugs/BUG-sensors-genericfluxtube-material-b-mymax.md) — reviewed as `FINDING-04990-sensors-genericfluxtube-material-b-mymax.md`, which a later run renamed |
| Original SHA-256 | 1e9a973f9b04f51152af4056054b4afddf2e5ce8793a27a0e7c86788101019f7 |
...
| Probe | Outcome |
|---|---|
| `genericFluxTube.material.B_myMax=0` | reported-failure |

Diagnostic: algebraic projection did not converge at event boundary: worst scaled residual row=3 target=genericFluxTube.B value=NaN ratio=NaN norm=inf row_scale=1.000000e0 scaled_tolerance=1.000000e-10

[Independent OpenModelica wrappers and complete output](../evidence/omc-7254fa9ac1def6d7.json). Baseline: simulation succeeded.

- `genericFluxTube.material.B_myMax=0` set before translation: simulation succeeded.
