# FINDING-04581: Zero medium density enters an unguarded division
...
| Target | pump.flowPort_a.medium.rho |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-parallelpumpdropout-pump-flowport-a-medium-rho-intent.md](../../v2/bugs/FINDING-parallelpumpdropout-pump-flowport-a-medium-rho-intent.md) — reviewed as `FINDING-04581-parallelpumpdropout-pump-flowport-a-medium-rho.md`, which a later run renamed |
| Original SHA-256 | ec7063f4505408770cd1c7ed0c51ddd18919e31bd306f1e22a273242171c4e1b |
...
| Probe | Outcome |
|---|---|
| `pump.flowPort_a.medium.rho=0` | clean |
