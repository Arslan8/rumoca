# FINDING-04731: Zero medium density enters an unguarded division
...
| Target | pipe.flowPort_b.medium.rho |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-waterpump-pipe-flowport-b-medium-rho-intent.md](../../v2/bugs/FINDING-waterpump-pipe-flowport-b-medium-rho-intent.md) — reviewed as `FINDING-04731-waterpump-pipe-flowport-b-medium-rho.md`, which a later run renamed |
| Original SHA-256 | eb157985f808f2b213ec8200a2254359291cd9c9c80f5193ea68e906f0c07e5c |
...
| Probe | Outcome |
|---|---|
| `pipe.flowPort_b.medium.rho=0` | clean |
