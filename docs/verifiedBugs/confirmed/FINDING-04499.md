# FINDING-04499: Zero medium density enters an unguarded division
...
| Target | outerPump.flowPort_a.medium.rho |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-indirectcooling-outerpump-flowport-a-medium-rho-intent.md](../../v2/bugs/FINDING-indirectcooling-outerpump-flowport-a-medium-rho-intent.md) — reviewed as `FINDING-04499-indirectcooling-outerpump-flowport-a-medium-rho.md`, which a later run renamed |
| Original SHA-256 | 56443f25c750d12fcaf41f1cef9c6695470a5a33329ba918d4445f8b220a61e2 |
...
| Probe | Outcome |
|---|---|
| `outerPump.flowPort_a.medium.rho=0` | clean |
