# FINDING-04509: Zero medium density enters an unguarded division
...
| Target | absolutePressure.medium.rho |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-indirectcooling-absolutepressure-medium-rho-intent.md](../../v2/bugs/FINDING-indirectcooling-absolutepressure-medium-rho-intent.md) — reviewed as `FINDING-04509-indirectcooling-absolutepressure-medium-rho.md`, which a later run renamed |
| Original SHA-256 | 33c656cd7b6853dbed8db229a513de21ac08af2c9498f9de0ff57912f8af5595 |
...
| Probe | Outcome |
|---|---|
| `absolutePressure.medium.rho=0` | clean |
