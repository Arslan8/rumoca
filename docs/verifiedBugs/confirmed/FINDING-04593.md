# FINDING-04593: Zero medium density enters an unguarded division
...
| Target | pipe3.flowPort_a.medium.rho |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-parallelpumpdropout-pipe3-flowport-a-medium-rho-intent.md](../../v2/bugs/FINDING-parallelpumpdropout-pipe3-flowport-a-medium-rho-intent.md) — reviewed as `FINDING-04593-parallelpumpdropout-pipe3-flowport-a-medium-rho.md`, which a later run renamed |
| Original SHA-256 | 8bbf8db658bf8af133f2e035dfd42e9c4529c227408ffe32897858875b33883d |
...
| Probe | Outcome |
|---|---|
| `pipe3.flowPort_a.medium.rho=0` | clean |
