# FINDING-00797: FirstOrder circuit has an unguarded design denominator
...
| Original report | [FINDING-controlcircuit-firstorder2a-r2-unbounded.md](../../v2/bugs/FINDING-controlcircuit-firstorder2a-r2-unbounded.md) — reviewed as `FINDING-00797-controlcircuit-firstorder2a-r2.md`, which a later run renamed |
| Original SHA-256 | 096a98ce7f196311898270471060b62131143693743c68e4d9af1a4069830b04 |
...
| Probe | Outcome |
|---|---|
| `firstOrder2A.R2=0` | reported-failure |
...
- `firstOrder2A.R2=0` set before translation: LOG_ASSERT        | debug   | division by zero at time 0, (a=0.01) / (b=0), where divisor b expression is: firstOrder2A.R2.
