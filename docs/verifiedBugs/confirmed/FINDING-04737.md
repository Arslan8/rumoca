# FINDING-04737: Zero medium density enters an unguarded division
...
| Original report | [FINDING-waterpump-idealpump-medium-rho-divzero.md](../../v2/bugs/FINDING-waterpump-idealpump-medium-rho-divzero.md) — reviewed as `FINDING-04737-waterpump-idealpump-medium-rho.md`, which a later run renamed |
| Original SHA-256 | b28563dd9424b9feb7d44689137081671df32b43e5ab956d58a741a7b091063a |
...
| Probe | Outcome |
|---|---|
| `idealPump.medium.rho=0` | reported-failure |

Diagnostic: solve-IR evaluation failed: algebraic projection did not converge at event boundary: worst scaled residual row=26 target=idealPump.V_flow value=NaN ratio=NaN norm=inf row_scale=1.000000e0 scaled_tolerance=1.000000e-10
