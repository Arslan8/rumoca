# FINDING-04747: Zero medium specific heat capacity enters an unguarded division
...
| Target | pipe.medium.cp |
| Student classification | divisor-reachable-zero |
| Original report | [FINDING-waterpump-pipe-medium-cp-divzero-2.md](../../v2/bugs/FINDING-waterpump-pipe-medium-cp-divzero-2.md) — reviewed as `FINDING-04747-waterpump-pipe-medium-cp.md`, which a later run renamed |
| Original SHA-256 | e8186c323a2db62ed1254b22e1bd42eab65ea5983cf4a202955462cebaeef579 |
...
| Probe | Outcome |
|---|---|
| `pipe.medium.cp=0` | reported-failure |

Diagnostic: solve-IR evaluation failed: algebraic projection did not converge at event boundary: worst scaled residual row=75 target=pipe.T_b value=-inf ratio=inf norm=inf row_scale=3.000000e2 scaled_tolerance=3.000000e-8
