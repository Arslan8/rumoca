# FINDING-04797: CriticalDamping accepts zero order then divides by it
...
| Original report | [FINDING-continuous-steadystate-criticaldamping-n-divunresolved-2.md](../../v2/bugs/FINDING-continuous-steadystate-criticaldamping-n-divunresolved-2.md) — reviewed as `FINDING-04797-continuous-steadystate-criticaldamping-n.md`, which a later run renamed |
| Original SHA-256 | 4f35f5da535e0fbfa72685ecef785c26b575521082353b025e7a56d73126dc7a |
