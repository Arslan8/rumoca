# FINDING-01185: Zero nominal speed makes DC-machine scaling undefined
...
| Target | dceeData.wNominal |
| Student classification | divisor-reachable-zero |
| Original report | `FINDING-01185-dc-comparecharacteristics-dceedata-wnominal.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 6303a9ec52a49f647779fabebc8ef4c82bdac0088ce504c4eee8f16c7bb797cd |
