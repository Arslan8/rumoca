# FINDING-04748: Zero medium specific heat capacity enters an unguarded division
...
| Target | ambient2.medium.cp |
| Student classification | divisor-reachable-zero |
| Original report | [FINDING-waterpump-ambient2-medium-cp-divzero-2.md](../../v2/bugs/FINDING-waterpump-ambient2-medium-cp-divzero-2.md) — reviewed as `FINDING-04748-waterpump-ambient2-medium-cp.md`, which a later run renamed |
| Original SHA-256 | fd89f97cacf1a71549de96c7520d73fc3b528353bb54efae4d3b804f4b7b93ef |
...
| Probe | Outcome |
|---|---|
| `ambient2.medium.cp=0` | reported-failure |

Diagnostic: solve-IR evaluation failed: algebraic projection did not converge at event boundary: worst scaled residual row=89 target=ambient2.T_port value=NaN ratio=NaN norm=inf row_scale=3.000000e2 scaled_tolerance=3.000000e-8
