# FINDING-04742: Zero medium density enters an unguarded division
...
| Target | oneWayValve.medium.rho |
| Student classification | divisor-reachable-zero |
| Original report | [FINDING-waterpump-onewayvalve-medium-rho-divzero.md](../../v2/bugs/FINDING-waterpump-onewayvalve-medium-rho-divzero.md) — reviewed as `FINDING-04742-waterpump-onewayvalve-medium-rho.md`, which a later run renamed |
| Original SHA-256 | 9fef4d1a0dc9521be45934cc8862b65f6ff6fad436938e98c5aa74b8e07e964b |
...
| Probe | Outcome |
|---|---|
| `oneWayValve.medium.rho=0` | reported-failure |

Diagnostic: solve-IR evaluation failed: algebraic projection did not converge at event boundary: worst scaled residual row=59 target=oneWayValve.flowPort_a.m_flow value=NaN ratio=NaN norm=inf row_scale=1.000000e0 scaled_tolerance=1.000000e-10
