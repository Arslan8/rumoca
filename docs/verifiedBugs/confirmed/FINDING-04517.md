# FINDING-04517: Zero medium density enters an unguarded division
...
| Target | outerPipe.flowPort_a.medium.rho |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-indirectcooling-outerpipe-flowport-a-medium-rho-intent.md](../../v2/bugs/FINDING-indirectcooling-outerpipe-flowport-a-medium-rho-intent.md) — reviewed as `FINDING-04517-indirectcooling-outerpipe-flowport-a-medium-rho.md`, which a later run renamed |
| Original SHA-256 | c90c5f32b28e5a0a58660c26fe001be17c8fb3ca2633d2105678757d4f070e1a |
...
| Probe | Outcome |
|---|---|
| `outerPipe.flowPort_a.medium.rho=0` | clean |
