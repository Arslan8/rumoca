# FINDING-04496: Zero medium density enters an unguarded division
...
| Target | ambient1.flowPort.medium.rho |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-indirectcooling-ambient1-flowport-medium-rho-intent.md](../../v2/bugs/FINDING-indirectcooling-ambient1-flowport-medium-rho-intent.md) — reviewed as `FINDING-04496-indirectcooling-ambient1-flowport-medium-rho.md`, which a later run renamed |
| Original SHA-256 | 2b2fb452fb42b93db51d6c4158171b033350316d266d3d8b962db83ac58db011 |
...
| Probe | Outcome |
|---|---|
| `ambient1.flowPort.medium.rho=0` | clean |
