# FINDING-04507: Zero medium density enters an unguarded division
...
| Target | pipe1.flowPort_a.medium.rho |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-indirectcooling-pipe1-flowport-a-medium-rho-intent.md](../../v2/bugs/FINDING-indirectcooling-pipe1-flowport-a-medium-rho-intent.md) — reviewed as `FINDING-04507-indirectcooling-pipe1-flowport-a-medium-rho.md`, which a later run renamed |
| Original SHA-256 | d6c0519e7a477b028042842c530cf70cf3bf9bc7f22f01815f791c964c1bd3dd |
...
| Probe | Outcome |
|---|---|
| `pipe1.flowPort_a.medium.rho=0` | clean |
