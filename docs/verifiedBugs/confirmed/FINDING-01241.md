# FINDING-01241: Zero medium density enters an unguarded division
...
| Target | inlet.flowPort.medium.rho |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-dcpm-cooling-inlet-flowport-medium-rho-intent.md](../../v2/bugs/FINDING-dcpm-cooling-inlet-flowport-medium-rho-intent.md) — reviewed as `FINDING-01241-dcpm-cooling-inlet-flowport-medium-rho.md`, which a later run renamed |
| Original SHA-256 | 42d3fefb1dc86d01f422d59f9abd569eb2b6a4c62eefdd85939bdb643d0f5010 |
...
Compiler/source-resolved declaration: `Thermal/FluidHeatFlow/Media/Medium.mo:4`. Role: `parameter`; binding: `inlet.medium.rho`; effective min: `0.0`; effective max: `None`. 
