# FINDING-00907: Integrator circuit has an unguarded design denominator
...
| Original report | [FINDING-integrator-f-divzero-10.md](../../v2/bugs/FINDING-integrator-f-divzero-10.md) — reviewed as `FINDING-00907-integrator-f.md`, which a later run renamed |
| Original SHA-256 | 6682bae572c49bfce535e1cc72bd6c6580c4eb98ab39a85945c2122b5341a759 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Examples/OpAmps/OpAmpCircuits/Integrator.mo:6`. Role: `parameter`; binding: `None`; effective min: `None`; effective max: `None`. 
