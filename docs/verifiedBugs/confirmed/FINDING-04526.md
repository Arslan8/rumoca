# FINDING-04526: Zero medium specific heat capacity enters an unguarded division
...
| Target | innerMedium.cp |
| Student classification | divisor-reachable-zero |
| Original report | [FINDING-indirectcooling-innermedium-cp-divzero-2.md](../../v2/bugs/FINDING-indirectcooling-innermedium-cp-divzero-2.md) — reviewed as `FINDING-04526-indirectcooling-innermedium-cp.md`, which a later run renamed |
| Original SHA-256 | 694d1756821d81fa5b3fd6c2d1bc0fde836b6b227ffe98a7fc8effa8d7bafe27 |
...
| Probe | Outcome |
|---|---|
| `innerMedium.cp=0` | reported-failure |

Diagnostic: solve-IR evaluation failed: algebraic projection did not converge at event boundary: worst scaled residual row=72 target=innerPump.T_b value=NaN ratio=NaN norm=inf row_scale=3.000000e2 scaled_tolerance=3.000000e-8
