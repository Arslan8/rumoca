# FINDING-04971: Inactive material data still enter an unguarded division
...
| Original report | [FINDING-sources-genericfluxtube-material-b-mymax-divzero.md](../../v2/bugs/FINDING-sources-genericfluxtube-material-b-mymax-divzero.md) — reviewed as `FINDING-04971-sources-genericfluxtube-material-b-mymax.md`, which a later run renamed |
| Original SHA-256 | ddfbc1922143c3dac21d0fc28ade9bf8a0f6ef0ae526beefcfae0c524b2d60b5 |
...
Diagnostic: algebraic projection did not converge at event boundary: worst scaled residual row=12 target=genericFluxTube.B value=-inf ratio=inf norm=inf row_scale=1.000000e0 scaled_tolerance=1.000000e-10
