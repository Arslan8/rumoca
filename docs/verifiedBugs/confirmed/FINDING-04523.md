# FINDING-04523: Zero medium specific heat capacity enters an unguarded division
...
| Target | outerMedium.cp |
| Student classification | divisor-reachable-zero |
| Original report | [FINDING-indirectcooling-outermedium-cp-divzero-2.md](../../v2/bugs/FINDING-indirectcooling-outermedium-cp-divzero-2.md) — reviewed as `FINDING-04523-indirectcooling-outermedium-cp.md`, which a later run renamed |
| Original SHA-256 | 7af9739d8eb02f7b3a7f88b4d3093b675b2fda4ded086c94a9929a24e710b8cb |
...
Compiler/source-resolved declaration: `Thermal/FluidHeatFlow/Media/Medium.mo:5`. Role: `parameter`; binding: `1`; effective min: `None`; effective max: `None`. 
...
[Rumoca commands, return codes, integrity hashes, bounded output and metadata](../evidence/059fe3ee5587753c.json). Baseline: **clean**.

| Probe | Outcome |
|---|---|
| `outerMedium.cp=0` | reported-failure |

Diagnostic: solve-IR evaluation failed: algebraic projection did not converge at event boundary: worst scaled residual row=33 target=ambient2.T_port value=NaN ratio=NaN norm=inf row_scale=3.000000e2 scaled_tolerance=3.000000e-8
