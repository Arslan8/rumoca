# FINDING-01245: Zero medium density enters an unguarded division
...
| Target | volumeFlow.flowPort_b.medium.rho |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-dcpm-cooling-volumeflow-flowport-b-medium-rho-intent.md](../../v2/bugs/FINDING-dcpm-cooling-volumeflow-flowport-b-medium-rho-intent.md) — reviewed as `FINDING-01245-dcpm-cooling-volumeflow-flowport-b-medium-rho.md`, which a later run renamed |
| Original SHA-256 | 5556076b701eeef067f5efb0e5cd1554dcf5062135db9eefa4cc1b63179220fd |
...
Compiler/source-resolved declaration: `Thermal/FluidHeatFlow/Media/Medium.mo:4`. Role: `parameter`; binding: `volumeFlow.medium.rho`; effective min: `0.0`; effective max: `None`. 
