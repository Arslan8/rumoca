# FINDING-04500: Zero medium density enters an unguarded division
...
| Target | outerPump.flowPort_b.medium.rho |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-indirectcooling-outerpump-flowport-b-medium-rho-intent.md](../../v2/bugs/FINDING-indirectcooling-outerpump-flowport-b-medium-rho-intent.md) — reviewed as `FINDING-04500-indirectcooling-outerpump-flowport-b-medium-rho.md`, which a later run renamed |
| Original SHA-256 | a961e4a89752b1d2cad6b5d064ef01cb647dc604bffe69f1edf2a0f708f45926 |
...
Compiler/source-resolved declaration: `Thermal/FluidHeatFlow/Media/Medium.mo:4`. Role: `parameter`; binding: `outerMedium.rho`; effective min: `0.0`; effective max: `None`. 
...
| Probe | Outcome |
|---|---|
| `outerPump.flowPort_b.medium.rho=0` | clean |
