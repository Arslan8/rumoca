# FINDING-00631: FirstOrder divides by an unconstrained zero time constant
...
| Original report | [FINDING-smoothstep-firstorder-t-divzero.md](../../v2/bugs/FINDING-smoothstep-firstorder-t-divzero.md) — reviewed as `FINDING-00631-smoothstep-firstorder-t.md`, which a later run renamed |
| Original SHA-256 | b3aff547a4a36c2cde90b74f1e08235161c068f0f9eb066067e46bc5f4b7f50f |
...
Compiler/source-resolved declaration: `Blocks/Continuous.mo:354`. Role: `parameter`; binding: `1e-09`; effective min: `None`; effective max: `None`. 
