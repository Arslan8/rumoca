# FINDING-00020: CriticalDamping accepts zero order then divides by it
...
| Original report | [FINDING-mixingunitwithcontinuouscontrol-filter-n-divunresolved-2.md](../../v2/bugs/FINDING-mixingunitwithcontinuouscontrol-filter-n-divunresolved-2.md) — reviewed as `FINDING-00020-mixingunitwithcontinuouscontrol-filter-n.md`, which a later run renamed |
| Original SHA-256 | 42a2d0f9d7ce60f6215bf97ad555c345def94a171eb5150c2fb9f2fd4496ce64 |
