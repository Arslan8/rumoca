# FINDING-04738: Zero medium specific heat capacity enters an unguarded division
...
| Target | idealPump.medium.cp |
| Student classification | divisor-reachable-zero |
| Original report | [FINDING-waterpump-idealpump-medium-cp-divzero-2.md](../../v2/bugs/FINDING-waterpump-idealpump-medium-cp-divzero-2.md) — reviewed as `FINDING-04738-waterpump-idealpump-medium-cp.md`, which a later run renamed |
| Original SHA-256 | 510901b6d970cc4851de25e5e734c4340df0eaec62d8800d1dc8590639fb973d |
...
| Probe | Outcome |
|---|---|
| `idealPump.medium.cp=0` | reported-failure |

Diagnostic: solve-IR evaluation failed: algebraic projection did not converge at event boundary: worst scaled residual row=28 target=idealPump.T_b value=-inf ratio=inf norm=inf row_scale=3.000000e2 scaled_tolerance=3.000000e-8
