# FINDING-04518: Zero medium density enters an unguarded division
...
| Target | outerPipe.flowPort_b.medium.rho |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-indirectcooling-outerpipe-flowport-b-medium-rho-intent.md](../../v2/bugs/FINDING-indirectcooling-outerpipe-flowport-b-medium-rho-intent.md) — reviewed as `FINDING-04518-indirectcooling-outerpipe-flowport-b-medium-rho.md`, which a later run renamed |
| Original SHA-256 | c1cd9075c26979abd6374e097e0ef0bc7925c7df78a72da9c9a9a7fbb022a98f |
...
| Probe | Outcome |
|---|---|
| `outerPipe.flowPort_b.medium.rho=0` | clean |
