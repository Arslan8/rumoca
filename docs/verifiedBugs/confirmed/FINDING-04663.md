# FINDING-04663: Zero medium density enters an unguarded division
...
| Original report | [FINDING-simplecooling-medium-rho-divzero-2.md](../../v2/bugs/FINDING-simplecooling-medium-rho-divzero-2.md) — reviewed as `FINDING-04663-simplecooling-medium-rho.md`, which a later run renamed |
| Original SHA-256 | 3bfc3ae7d56c1fd068f84541ed3ce49d9384812062a9e871a0b6f74e19b7fa11 |
...
Diagnostic: solve-IR evaluation failed: algebraic projection did not converge at event boundary: worst scaled residual row=27 target=pipe.V_flow value=NaN ratio=NaN norm=inf row_scale=1.000000e0 scaled_tolerance=1.000000e-10
