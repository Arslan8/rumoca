# FINDING-04696: Zero medium density enters an unguarded division
...
| Target | openTank1.flowPort.medium.rho |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-twotanks-opentank1-flowport-medium-rho-intent.md](../../v2/bugs/FINDING-twotanks-opentank1-flowport-medium-rho-intent.md) — reviewed as `FINDING-04696-twotanks-opentank1-flowport-medium-rho.md`, which a later run renamed |
| Original SHA-256 | 642215eaa304801d6ada8ff7ef4e2f39bed6307d7d12cf9ad167a380c96822b0 |
...
Compiler/source-resolved declaration: `Thermal/FluidHeatFlow/Media/Medium.mo:4`. Role: `parameter`; binding: `openTank1.medium.rho`; effective min: `0.0`; effective max: `None`. 
