# FINDING-04730: Zero medium density enters an unguarded division
...
| Target | pipe.flowPort_a.medium.rho |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-waterpump-pipe-flowport-a-medium-rho-intent.md](../../v2/bugs/FINDING-waterpump-pipe-flowport-a-medium-rho-intent.md) — reviewed as `FINDING-04730-waterpump-pipe-flowport-a-medium-rho.md`, which a later run renamed |
| Original SHA-256 | 16876cea395a4e7d944f885969e399bc8dd8c4db839fdc22391b12e18bd66ddc |
...
| Probe | Outcome |
|---|---|
| `pipe.flowPort_a.medium.rho=0` | clean |
