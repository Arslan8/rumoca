# FINDING-04699: Zero medium density enters an unguarded division
...
| Target | openTank2.flowPort.medium.rho |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-twotanks-opentank2-flowport-medium-rho-intent.md](../../v2/bugs/FINDING-twotanks-opentank2-flowport-medium-rho-intent.md) — reviewed as `FINDING-04699-twotanks-opentank2-flowport-medium-rho.md`, which a later run renamed |
| Original SHA-256 | 6ebf6618f109382bd64578f1ef5c77a1766c6484fefc44ca783c3696d2d08394 |
...
Compiler/source-resolved declaration: `Thermal/FluidHeatFlow/Media/Medium.mo:4`. Role: `parameter`; binding: `openTank2.medium.rho`; effective min: `0.0`; effective max: `None`. 
