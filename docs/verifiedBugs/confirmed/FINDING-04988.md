# FINDING-04988: Zero flux-tube length divides by zero
...
| Target | genericFluxTube3.l |
| Student classification | divisor-reachable-zero |
| Original report | [BUG-sources-genericfluxtube3-l.md](../../v2/bugs/BUG-sources-genericfluxtube3-l.md) — reviewed as `FINDING-04988-sources-genericfluxtube3-l.md`, which a later run renamed |
| Original SHA-256 | b3a390230cfa0e83bd00ac64424f2bd6ad94f48ff4c4004fb90f3c5b61bdc2d2 |
...
| Probe | Outcome |
|---|---|
| `genericFluxTube3.l=0` | reported-failure |

Diagnostic: algebraic projection did not converge at event boundary: worst scaled residual row=51 target=genericFluxTube3.R_m value=-inf ratio=inf norm=inf row_scale=1.000000e0 scaled_tolerance=1.000000e-10

[Independent OpenModelica wrappers and complete output](../evidence/omc-8bb9ef7f1f1c7179.json). Baseline: simulation succeeded.

- `genericFluxTube3.l=0` set before translation: LOG_ASSERT        | debug   | division by zero at time 0, (a=0.0001) / (b=0), where divisor b expression is: genericFluxTube3.l.
