# FINDING-04786: CriticalDamping accepts zero order then divides by it
...
| Original report | [FINDING-continuous-criticaldamping-n-divunresolved-2.md](../../v2/bugs/FINDING-continuous-criticaldamping-n-divunresolved-2.md) — reviewed as `FINDING-04786-continuous-criticaldamping-n.md`, which a later run renamed |
| Original SHA-256 | b25586f59de026460d538d0faf196567b853b1e8fb043c4cec5df55df15013c5 |
