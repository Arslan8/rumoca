# FINDING-04508: Zero medium density enters an unguarded division
...
| Target | pipe1.flowPort_b.medium.rho |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-indirectcooling-pipe1-flowport-b-medium-rho-intent.md](../../v2/bugs/FINDING-indirectcooling-pipe1-flowport-b-medium-rho-intent.md) — reviewed as `FINDING-04508-indirectcooling-pipe1-flowport-b-medium-rho.md`, which a later run renamed |
| Original SHA-256 | 00aa4ea2e20aba4bf59890f964d8c62129ac4c66cca75393c53733d28c56b6ae |
...
| Probe | Outcome |
|---|---|
| `pipe1.flowPort_b.medium.rho=0` | clean |
