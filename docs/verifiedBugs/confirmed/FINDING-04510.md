# FINDING-04510: Zero medium density enters an unguarded division
...
| Target | absolutePressure.flowPort.medium.rho |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-indirectcooling-absolutepressure-flowport-medium-rho-intent.md](../../v2/bugs/FINDING-indirectcooling-absolutepressure-flowport-medium-rho-intent.md) — reviewed as `FINDING-04510-indirectcooling-absolutepressure-flowport-medium-rho.md`, which a later run renamed |
| Original SHA-256 | 6be7b67e49996a653ddb53fcb390c2ac4ad6c883c1343b5e63f9d66e1259a740 |
...
Compiler/source-resolved declaration: `Thermal/FluidHeatFlow/Media/Medium.mo:4`. Role: `parameter`; binding: `innerMedium.rho`; effective min: `0.0`; effective max: `None`. 
...
| Probe | Outcome |
|---|---|
| `absolutePressure.flowPort.medium.rho=0` | clean |
