# FINDING-04984: Zero flux-tube length divides by zero
...
| Target | genericFluxTube2.l |
| Student classification | divisor-reachable-zero |
| Original report | [BUG-sources-genericfluxtube2-l.md](../../v2/bugs/BUG-sources-genericfluxtube2-l.md) — reviewed as `FINDING-04984-sources-genericfluxtube2-l.md`, which a later run renamed |
| Original SHA-256 | bff225d2b4241f7073e64821e2dfb2ef853e9f2b711c049f434546d5c0bdb5ce |
...
| Probe | Outcome |
|---|---|
| `genericFluxTube2.l=0` | reported-failure |

Diagnostic: algebraic projection did not converge at event boundary: worst scaled residual row=40 target=genericFluxTube2.R_m value=-inf ratio=inf norm=inf row_scale=1.000000e0 scaled_tolerance=1.000000e-10

[Independent OpenModelica wrappers and complete output](../evidence/omc-8bb9ef7f1f1c7179.json). Baseline: simulation succeeded.

- `genericFluxTube2.l=0` set before translation: LOG_ASSERT        | debug   | division by zero at time 0, (a=0.0001) / (b=0), where divisor b expression is: genericFluxTube2.l.
