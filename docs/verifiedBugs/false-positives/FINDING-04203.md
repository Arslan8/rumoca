# FINDING-04203: MultiBody Newton/Euler equations use mass and inertia multiplicatively
...
| Target | body3.body.I_11 |
| Student classification | physical-bound-permits-zero |
| Original report | `FINDING-04203-planarfourbar-body3-body-i-11.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 68ed6e8921f86448f70ffdbc50985a08e75458326a2cb1389de50121bda35296 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:17`. Role: `parameter`; binding: `body3.I[1, 1]`; effective min: `0`; effective max: `None`. 
