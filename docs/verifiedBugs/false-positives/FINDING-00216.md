# FINDING-00216: Zero capacitance is an explicitly supported algebraic limit
...
| Target | bufferCapacitor.C |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-demopowersupplywithbuffer-buffercapacitor-c-zerolimit.md](../../v2/bugs/FINDING-demopowersupplywithbuffer-buffercapacitor-c-zerolimit.md) — reviewed as `FINDING-00216-demopowersupplywithbuffer-buffercapacitor-c.md`, which a later run renamed |
| Original SHA-256 | 0d24a2c1c78bec426ad29fb33b760fd19355397cc85112adf33de9f5d51dbbdb |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Capacitor.mo:4`. Role: `parameter`; binding: `0.1`; effective min: `0`; effective max: `None`. 
