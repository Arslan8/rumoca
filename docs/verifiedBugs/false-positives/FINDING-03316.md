# FINDING-03316: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | rectifier.diode_p.idealDiode[2].Goff |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-diodecentertap2mpulse-rectifier-diode-p-idealdiode-2-goff-zerolimit.md](../../v2/bugs/FINDING-diodecentertap2mpulse-rectifier-diode-p-idealdiode-2-goff-zerolimit.md) — reviewed as `FINDING-03316-diodecentertap2mpulse-rectifier-diode-p-idealdiode-2-goff.md`, which a later run renamed |
| Original SHA-256 | cd22cd802fa026c10397d61e05b9005360f4abe9a33f61ac5fe67eb8d36aa2e7 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:6`. Role: `parameter`; binding: `rectifier.diode_p.Goff[2]`; effective min: `0`; effective max: `None`. 
