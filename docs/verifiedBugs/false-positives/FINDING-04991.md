# FINDING-04991: Zeroing this operand does not zero the complete denominator
...
| Target | genericFluxTube.material.c_b |
| Student classification | divisor-reachable-zero |
| Original report | `FINDING-04991-sensors-genericfluxtube-material-c-b.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 247f7d717029f36663590f77ff7d2227a7accdd52722c3d022065b07df2940d2 |
...
| Probe | Outcome |
|---|---|
| `genericFluxTube.material.c_b=0` | clean |
