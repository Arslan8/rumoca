# FINDING-03886: Armature example delegates to zero-capable mechanical terms
...
| Original report | [FINDING-translatoryarmatureandstopper-c-zerolimit.md](../../v2/bugs/FINDING-translatoryarmatureandstopper-c-zerolimit.md) — reviewed as `FINDING-03886-translatoryarmatureandstopper-c.md`, which a later run renamed |
| Original SHA-256 | 1a761cbab2989ed46ff38b347e9f888bf9595da99639a418f639e23d9bb31c1e |
...
Compiler/source-resolved declaration: `Magnetic/FluxTubes/Examples/Utilities/TranslatoryArmatureAndStopper.mo:9`. Role: `parameter`; binding: `None`; effective min: `None`; effective max: `None`. 
