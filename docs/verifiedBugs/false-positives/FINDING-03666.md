# FINDING-03666: Converter switch parameters delegate to ideal semiconductor limits
...
| Original report | [FINDING-hbridge-r-hbridge-inverter-n-rontransistor-ruleoff.md](../../v2/bugs/FINDING-hbridge-r-hbridge-inverter-n-rontransistor-ruleoff.md) — reviewed as `FINDING-03666-hbridge-r-hbridge-inverter-n-rontransistor.md`, which a later run renamed |
| Original SHA-256 | 2ce344d529c419e73bca65193c02df329d7d7817d9ed2499666f169c80609547 |
