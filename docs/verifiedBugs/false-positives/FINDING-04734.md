# FINDING-04734: Zero trapezoid edge duration is handled by branch reachability
...
| Original report | [FINDING-waterpump-trapezoid-rising-divunresolved.md](../../v2/bugs/FINDING-waterpump-trapezoid-rising-divunresolved.md) — reviewed as `FINDING-04734-waterpump-trapezoid-rising.md`, which a later run renamed |
| Original SHA-256 | 468018895ead715cb875a08d83df628376e7c3e39abe7b6db340b212d36ae54b |
...
Compiler/source-resolved declaration: `Blocks/Sources.mo:894`. Role: `parameter`; binding: `0.6`; effective min: `0`; effective max: `None`. 
