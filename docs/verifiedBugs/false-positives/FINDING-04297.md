# FINDING-04297: MultiBody Newton/Euler equations use mass and inertia multiplicatively
...
| Original report | `FINDING-04297-mechanicalstructure-b3-i-33.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | aeeb06e1f978c608426ce4aec6e0203515535f856f93aa2bd3cd4f8a45d888e2 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/BodyShape.mo:28`. Role: `parameter`; binding: `0.413`; effective min: `0`; effective max: `None`. 
