# FINDING-03670: Zero on-resistance/off-conductance is an intended ideal limit
...
| Original report | [FINDING-hbridge-r-hbridge-inverter-n-transistor-p-ron-ruleoff.md](../../v2/bugs/FINDING-hbridge-r-hbridge-inverter-n-transistor-p-ron-ruleoff.md) — reviewed as `FINDING-03670-hbridge-r-hbridge-inverter-n-transistor-p-ron.md`, which a later run renamed |
| Original SHA-256 | cd1958c8237e5b341b66ec4543a050455f79f1a2ff5cf58d27750abedf19c374 |
