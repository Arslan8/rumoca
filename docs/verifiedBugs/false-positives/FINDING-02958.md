# FINDING-02958: Polyphase inductance delegates to zero-capable scalar inductors
...
| Original report | [FINDING-testsensors-inductor-l-zerolimit.md](../../v2/bugs/FINDING-testsensors-inductor-l-zerolimit.md) — reviewed as `FINDING-02958-testsensors-inductor-l.md`, which a later run renamed |
| Original SHA-256 | ddd9266f9dc56c5d18883e1e168fd1d9770f7e4efb35ae26321572c5c349ae74 |
...
Compiler/source-resolved declaration: `Electrical/Polyphase/Basic/Inductor.mo:4`. Role: `parameter`; binding: `fill(L, m)`; effective min: `None`; effective max: `None`. 
