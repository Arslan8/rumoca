# FINDING-04504: Zero heat capacity is a no-storage algebraic limit
...
| Original report | [FINDING-indirectcooling-heatcapacitor-c-zerolimit.md](../../v2/bugs/FINDING-indirectcooling-heatcapacitor-c-zerolimit.md) — reviewed as `FINDING-04504-indirectcooling-heatcapacitor-c.md`, which a later run renamed |
| Original SHA-256 | c3704b66295af97e5b3ad4e55ba98cfd889aec53b0e766cc082c86fce8affc4f |
...
Compiler/source-resolved declaration: `Thermal/HeatTransfer/Components/HeatCapacitor.mo:3`. Role: `parameter`; binding: `0.05`; effective min: `None`; effective max: `None`. 
