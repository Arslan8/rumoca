# FINDING-02935: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | idealDiode1.Ron |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-rectifier-idealdiode1-ron-ruleoff-2.md](../../v2/bugs/FINDING-rectifier-idealdiode1-ron-ruleoff-2.md) — reviewed as `FINDING-02935-rectifier-idealdiode1-ron.md`, which a later run renamed |
| Original SHA-256 | 129e383d602a5a4c385dae7532cd16691e20ec2b694adb86fe609c4d14977dbe |
...
Compiler/source-resolved declaration: `Electrical/Polyphase/Ideal/IdealDiode.mo:4`. Role: `parameter`; binding: `fill(Ron, m)`; effective min: `zeros(3)`; effective max: `None`. 
