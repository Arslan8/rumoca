# FINDING-02941: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | idealDiode1.idealDiode[3].Ron |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-rectifier-idealdiode1-idealdiode-3-ron-ruleoff.md](../../v2/bugs/FINDING-rectifier-idealdiode1-idealdiode-3-ron-ruleoff.md) — reviewed as `FINDING-02941-rectifier-idealdiode1-idealdiode-3-ron.md`, which a later run renamed |
| Original SHA-256 | c37b882e5e05299f9ca7ad0e29c84455530c386b5c21d327c968e70e3d9e5a24 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:4`. Role: `parameter`; binding: `idealDiode1.Ron[3]`; effective min: `0`; effective max: `None`. 
