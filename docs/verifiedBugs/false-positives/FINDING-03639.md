# FINDING-03639: Zero on-resistance/off-conductance is an intended ideal limit
...
| Original report | [FINDING-hbridge-rl-hbridge-inverter-n-transistor-p-goff-zerolimit.md](../../v2/bugs/FINDING-hbridge-rl-hbridge-inverter-n-transistor-p-goff-zerolimit.md) — reviewed as `FINDING-03639-hbridge-rl-hbridge-inverter-n-transistor-p-goff.md`, which a later run renamed |
| Original SHA-256 | 1feaffe1794e798f7a7b968d143cd2b40d39f46ffa789c242525de9e31205c6d |
