# FINDING-01972: Polyphase resistance/conductance delegates to signed scalar elements
...
| Original report | `FINDING-01972-imc-ydarc-resistor-r.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | a840fbe9da25b7cfc0beee1f304f8c221e2c1581d681dbec9d045a03d897bf63 |
...
Compiler/source-resolved declaration: `Electrical/Polyphase/Basic/Resistor.mo:4`. Role: `parameter`; binding: `fill(RLine, m)`; effective min: `None`; effective max: `None`. 
