# FINDING-03197: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | rectifier.diode_p1.Goff |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-diodebridge2pulse-rectifier-diode-p1-goff-zerolimit.md](../../v2/bugs/FINDING-diodebridge2pulse-rectifier-diode-p1-goff-zerolimit.md) — reviewed as `FINDING-03197-diodebridge2pulse-rectifier-diode-p1-goff.md`, which a later run renamed |
| Original SHA-256 | 48253944d80c641ed7e5e39e0ddf50867339cca502720bc8141bbfa9ff062178 |
