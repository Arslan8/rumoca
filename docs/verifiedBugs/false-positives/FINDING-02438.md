# FINDING-02438: A zero-duration ramp is a supported step
...
| Original report | [FINDING-smpm-noload-ramp-duration-divunreach.md](../../v2/bugs/FINDING-smpm-noload-ramp-duration-divunreach.md) — reviewed as `FINDING-02438-smpm-noload-ramp-duration.md`, which a later run renamed |
| Original SHA-256 | 7a75d06365602b8b454a8b78b7b00191778dcbf3f422a60e2013d9333e736e72 |
...
Compiler/source-resolved declaration: `Blocks/Sources.mo:247`. Role: `parameter`; binding: `0.16`; effective min: `0.0`; effective max: `None`. 
