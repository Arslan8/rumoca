# FINDING-01819: Zero capacitance is an explicitly supported algebraic limit
...
| Original report | [FINDING-imc-steinmetz-cstart-c-zerolimit.md](../../v2/bugs/FINDING-imc-steinmetz-cstart-c-zerolimit.md) — reviewed as `FINDING-01819-imc-steinmetz-cstart-c.md`, which a later run renamed |
| Original SHA-256 | 9b902e6f65021fa87b0e4c888aa2ff486704a564ab9464aedc65d7b99a617337 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Capacitor.mo:4`. Role: `parameter`; binding: `Cs`; effective min: `0`; effective max: `None`. 
