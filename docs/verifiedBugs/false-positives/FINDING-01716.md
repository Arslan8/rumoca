# FINDING-01716: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | inverter.diode_n.idealDiode[3].Goff |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-imc-inverterdrive-inverter-diode-n-idealdiode-3-goff-zerolimit.md](../../v2/bugs/FINDING-imc-inverterdrive-inverter-diode-n-idealdiode-3-goff-zerolimit.md) — reviewed as `FINDING-01716-imc-inverterdrive-inverter-diode-n-idealdiode-3-goff.md`, which a later run renamed |
| Original SHA-256 | af832639de0afe778a33e756dd4203861374e3a757d3048f37c8412f660aae82 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:6`. Role: `parameter`; binding: `inverter.diode_n.Goff[3]`; effective min: `0`; effective max: `None`. 
