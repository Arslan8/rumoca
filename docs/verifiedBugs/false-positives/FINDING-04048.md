# FINDING-04048: Tensor entries are not all strictly positive scalars
...
| Original report | `FINDING-04048-pointgravity-body1-i.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | bad7384c8594f6b970f1bfc18462f678869078ac2134ffa91e0dd522b267ca7b |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:114`. Role: `parameter`; binding: `cat1(cat2(body1.I_11, body1.I_21, body1.I_31), cat2(body1.I_21, body1.I_22, body1.I_32), cat2(body1.I_31, body1.I_32, body1.I_33))`; effective min: `None`; effective max: `None`. 
