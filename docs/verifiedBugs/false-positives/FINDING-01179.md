# FINDING-01179: Zero inertia is a massless algebraic component, not an intrinsic division
...
| Target | dcse.inertiaRotor.J |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-dc-comparecharacteristics-dcse-inertiarotor-j-zerolimit.md](../../v2/bugs/FINDING-dc-comparecharacteristics-dcse-inertiarotor-j-zerolimit.md) — reviewed as `FINDING-01179-dc-comparecharacteristics-dcse-inertiarotor-j.md`, which a later run renamed |
| Original SHA-256 | 2f46fa8f7cb853cf47ccf632cffa1d7fa022bde60105c8a156f1589316693343 |
...
Compiler/source-resolved declaration: `Mechanics/Rotational/Components/Inertia.mo:4`. Role: `parameter`; binding: `dcse.Jr`; effective min: `0`; effective max: `None`. 
