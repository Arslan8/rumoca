# FINDING-00556: Zero inductance is an explicitly supported algebraic limit
...
| Target | oLine50.L[30].L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-smoothstep-oline50-l-30-l-zerolimit.md](../../v2/bugs/FINDING-smoothstep-oline50-l-30-l-zerolimit.md) — reviewed as `FINDING-00556-smoothstep-oline50-l-30-l.md`, which a later run renamed |
| Original SHA-256 | f875ff2348ba78730893f4861f92d00b81ffeb12ba4fc69ac97bdc7043088ec7 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `oLine50.lm[30]`; effective min: `None`; effective max: `None`. 
