# FINDING-01717: Zero stator resistance is a supported ideal-loss limit
...
| Original report | [FINDING-imc-inverterdrive-aimc-rs-ruleoff.md](../../v2/bugs/FINDING-imc-inverterdrive-aimc-rs-ruleoff.md) — reviewed as `FINDING-01717-imc-inverterdrive-aimc-rs.md`, which a later run renamed |
| Original SHA-256 | f13383cde8fd18b34148dc8ebf5042625d3c770dbf1af0e0a3d79b517053b752 |
...
Compiler/source-resolved declaration: `Electrical/Machines/Interfaces/PartialBasicInductionMachine.mo:11`. Role: `parameter`; binding: `aimcData.Rs`; effective min: `None`; effective max: `None`. 
