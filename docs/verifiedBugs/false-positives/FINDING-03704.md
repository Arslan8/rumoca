# FINDING-03704: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | hbridge.inverter_n.transistor_n.Ron |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-hbridge-trianglepwm-rl-hbridge-inverter-n-transistor-n-ron-ruleoff.md](../../v2/bugs/FINDING-hbridge-trianglepwm-rl-hbridge-inverter-n-transistor-n-ron-ruleoff.md) — reviewed as `FINDING-03704-hbridge-trianglepwm-rl-hbridge-inverter-n-transistor-n-ron.md`, which a later run renamed |
| Original SHA-256 | 7e46321b430a695ffd9c1c84b3adb4e961139755112cf1db980c927708ae4ae3 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:4`. Role: `parameter`; binding: `hbridge.inverter_n.RonTransistor`; effective min: `0`; effective max: `None`. 
