# FINDING-05082: Zero mass is a massless algebraic component, not an intrinsic division
...
| Target | vehicleRollInVar.mass.m |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-vehicles-vehiclerollinvar-mass-m-zerolimit.md](../../v2/bugs/FINDING-vehicles-vehiclerollinvar-mass-m-zerolimit.md) — reviewed as `FINDING-05082-vehicles-vehiclerollinvar-mass-m.md`, which a later run renamed |
| Original SHA-256 | 380591180babc30bdc440b0bcb29617f77b7e86582a5d7869aab06ec3c06927e |
