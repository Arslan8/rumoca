# FINDING-01160: Machine inertia delegates to the zero-capable algebraic inertia component
...
| Original report | [FINDING-dc-comparecharacteristics-dcee-js-zerolimit.md](../../v2/bugs/FINDING-dc-comparecharacteristics-dcee-js-zerolimit.md) — reviewed as `FINDING-01160-dc-comparecharacteristics-dcee-js.md`, which a later run renamed |
| Original SHA-256 | 536f360299b8c6249a6fa89367908fdd80942ba60d849fbaf2391f5e3f6e3990 |
...
Compiler/source-resolved declaration: `Electrical/Machines/Interfaces/PartialBasicMachine.mo:8`. Role: `parameter`; binding: `dceeData.Js`; effective min: `None`; effective max: `None`. 
