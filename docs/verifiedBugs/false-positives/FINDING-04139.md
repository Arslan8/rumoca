# FINDING-04139: MultiBody Newton/Euler equations use mass and inertia multiplicatively
...
| Original report | [FINDING-threesprings-body1-m-zerolimit.md](../../v2/bugs/FINDING-threesprings-body1-m-zerolimit.md) — reviewed as `FINDING-04139-threesprings-body1-m.md`, which a later run renamed |
| Original SHA-256 | 239f21ea993031c379427425d3ba7d82f5e71d076c40aa081ce59249437fdd8d |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:16`. Role: `parameter`; binding: `0.8`; effective min: `0`; effective max: `None`. 
