# FINDING-04316: MultiBody Newton/Euler equations use mass and inertia multiplicatively
...
| Original report | [FINDING-mechanicalstructure-b4-body-m-zerolimit.md](../../v2/bugs/FINDING-mechanicalstructure-b4-body-m-zerolimit.md) — reviewed as `FINDING-04316-mechanicalstructure-b4-body-m.md`, which a later run renamed |
| Original SHA-256 | 62586328b51004b1874fec763cff4042bfb1f51725a148f595b5437cacbef11a |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:16`. Role: `parameter`; binding: `28.7`; effective min: `0`; effective max: `None`. 
