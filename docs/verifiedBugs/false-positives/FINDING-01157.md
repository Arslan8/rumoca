# FINDING-01157: Zero armature inductance is an ideal algebraic limit
...
| Original report | [FINDING-dc-comparecharacteristics-dcee-la-zerolimit.md](../../v2/bugs/FINDING-dc-comparecharacteristics-dcee-la-zerolimit.md) — reviewed as `FINDING-01157-dc-comparecharacteristics-dcee-la.md`, which a later run renamed |
| Original SHA-256 | d8ff2efcc1c61866f5b7237a4972aa3f6a9ee0d2ca9db4d803b352d0c3bd3758 |
...
Compiler/source-resolved declaration: `Electrical/Machines/Interfaces/PartialBasicDCMachine.mo:26`. Role: `parameter`; binding: `dceeData.La`; effective min: `None`; effective max: `None`. 
