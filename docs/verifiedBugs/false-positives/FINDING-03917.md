# FINDING-03917: Tensor entries are not all strictly positive scalars
...
| Target | boxBody2.body.I_32 |
| Student classification | physical-domain-unenforced |
| Original report | `FINDING-03917-doublependuluminittip-boxbody2-body-i-32.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | f03ff2accd439a9f76cc1a291aa01ba3445bd0f7c54b85cf6aeed1ae0d98da99 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:27`. Role: `parameter`; binding: `boxBody2.I[3, 2]`; effective min: `-1.7976931348623157e+308`; effective max: `None`. 
