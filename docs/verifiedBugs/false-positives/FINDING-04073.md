# FINDING-04073: MultiBody Newton/Euler equations use mass and inertia multiplicatively
...
| Target | referenceSystem.pointMass2.m |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-pointgravitywithpointmasses2-referencesystem-pointmass2-m-zerolimit.md](../../v2/bugs/FINDING-pointgravitywithpointmasses2-referencesystem-pointmass2-m-zerolimit.md) — reviewed as `FINDING-04073-pointgravitywithpointmasses2-referencesystem-pointmass2-m.md`, which a later run renamed |
| Original SHA-256 | 2bf86471f60f11043f43970ead7cd48ec96d2f877eeb9c337550723dc51279e7 |
