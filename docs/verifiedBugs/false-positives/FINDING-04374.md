# FINDING-04374: Zero inertia is a massless algebraic component, not an intrinsic division
...
| Original report | [FINDING-backlash-inertia3-j-zerolimit.md](../../v2/bugs/FINDING-backlash-inertia3-j-zerolimit.md) — reviewed as `FINDING-04374-backlash-inertia3-j.md`, which a later run renamed |
| Original SHA-256 | 5fb7b8ab7dbc58bf377563a8693dcecb4e8e5d00abf0708a8ddb13bddfbca559 |
...
Diagnostic: solve-IR evaluation failed: algebraic projection did not converge at event boundary: worst scaled residual row=46 target=inertia3.a value=2.356194e4 ratio=2.356194e14 norm=2.356194e4 row_scale=1.000000e0 scaled_tolerance=1.000000e-10
