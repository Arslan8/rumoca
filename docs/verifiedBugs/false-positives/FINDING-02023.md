# FINDING-02023: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | switchYD.idealCloser.idealClosingSwitch[3].Goff |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-imc-yd-switchyd-idealcloser-idealclosingswitch-3-goff-ruleoff.md](../../v2/bugs/FINDING-imc-yd-switchyd-idealcloser-idealclosingswitch-3-goff-ruleoff.md) — reviewed as `FINDING-02023-imc-yd-switchyd-idealcloser-idealclosingswitch-3-goff.md`, which a later run renamed |
| Original SHA-256 | ff2380e8c129d4958448b918d5c5121a5faf826936c9d15d6d55ccbea01fcac0 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSwitch.mo:6`. Role: `parameter`; binding: `switchYD.idealCloser.Goff[3]`; effective min: `0`; effective max: `None`. 
