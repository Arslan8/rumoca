# FINDING-01165: DC machine-data field has a supported ideal limit
...
| Original report | [FINDING-dc-comparecharacteristics-dcsedata-js-intent.md](../../v2/bugs/FINDING-dc-comparecharacteristics-dcsedata-js-intent.md) — reviewed as `FINDING-01165-dc-comparecharacteristics-dcsedata-js.md`, which a later run renamed |
| Original SHA-256 | 7f9eff7b804ce1266ab79311abd7dee95873fba8f2fc2651fbd9b6914968b1f1 |
...
Compiler/source-resolved declaration: `Electrical/Machines/Utilities/ParameterRecords/DcPermanentMagnetData.mo:6`. Role: `parameter`; binding: `dcseData.Jr`; effective min: `None`; effective max: `None`. 
