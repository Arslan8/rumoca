# FINDING-00118: Zero capacitance is an explicitly supported algebraic limit
...
| Target | R3.Capacitor.C |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-cauerlowpasssc-r3-capacitor-c-zerolimit.md](../../v2/bugs/FINDING-cauerlowpasssc-r3-capacitor-c-zerolimit.md) — reviewed as `FINDING-00118-cauerlowpasssc-r3-capacitor-c.md`, which a later run renamed |
| Original SHA-256 | 1b022e9b0f762f0e42ab8787a69ad17cecc4c657b06e9f4ac38bd518cf850f1e |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Capacitor.mo:4`. Role: `parameter`; binding: `(R3.clock / max((2.220446049250313e-16 * R3.oneOhm), abs(R3.R)))`; effective min: `0`; effective max: `None`. 
