# FINDING-05010: Tensor entries are not all strictly positive scalars
...
| Original report | `FINDING-05010-testmove-body1-i.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | f44c228f90b42765a7ca754712694fa248d583c048f3c216a5ea12b164aca0a5 |
...
[Rumoca commands, return codes, integrity hashes, bounded output and metadata](../evidence/e6a035dd739a7abd.json). Baseline: **tool-error**.
