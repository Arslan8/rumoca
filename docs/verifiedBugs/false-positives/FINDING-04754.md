# FINDING-04754: A zero-duration ramp is a supported step
...
| Original report | [FINDING-controlledtemperature-ramp-duration-divunreach.md](../../v2/bugs/FINDING-controlledtemperature-ramp-duration-divunreach.md) — reviewed as `FINDING-04754-controlledtemperature-ramp-duration.md`, which a later run renamed |
| Original SHA-256 | 189f8c1892b3ab24a64c8e201d5b394b63584ea733201dd7ee73bfef21331f19 |
...
Compiler/source-resolved declaration: `Blocks/Sources.mo:247`. Role: `parameter`; binding: `6`; effective min: `0.0`; effective max: `None`. 
