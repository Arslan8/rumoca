# FINDING-04263: Tensor entries are not all strictly positive scalars
...
| Original report | `FINDING-04263-mechanicalstructure-b0-body-i.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 2bdbe52866c1e017adc6f29f337ebf3d72797990595529f547a94b6e279b80c0 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:114`. Role: `parameter`; binding: `cat1(cat2(b0.body.I_11, b0.body.I_21, b0.body.I_31), cat2(b0.body.I_21, b0.body.I_22, b0.body.I_32), cat2(b0.body.I_31, b0.body.I_32, b0.body.I_33))`; effective min: `None`; effective max: `None`. 
