# FINDING-02201: Zero inertia is a massless algebraic component, not an intrinsic division
...
| Target | smee.inertiaStator.J |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-smee-generator-smee-inertiastator-j-zerolimit.md](../../v2/bugs/FINDING-smee-generator-smee-inertiastator-j-zerolimit.md) — reviewed as `FINDING-02201-smee-generator-smee-inertiastator-j.md`, which a later run renamed |
| Original SHA-256 | c2163b986626ddfaa2d41e8e04dad31edcf6052e1462fe65c7234ee3f2cf3335 |
...
Compiler/source-resolved declaration: `Mechanics/Rotational/Components/Inertia.mo:4`. Role: `parameter`; binding: `smee.Js`; effective min: `0`; effective max: `None`. 
