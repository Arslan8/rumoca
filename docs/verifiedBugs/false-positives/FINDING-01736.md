# FINDING-01736: Machine-data inertia is not intrinsically a positive divisor
...
| Original report | [FINDING-imc-inverterdrive-aimcdata-js-intent.md](../../v2/bugs/FINDING-imc-inverterdrive-aimcdata-js-intent.md) — reviewed as `FINDING-01736-imc-inverterdrive-aimcdata-js.md`, which a later run renamed |
| Original SHA-256 | 46139b96a2f3701cc5181307069dace25206e6181f7dcb81b8a2e97b07d46d82 |
...
Compiler/source-resolved declaration: `Electrical/Machines/Utilities/ParameterRecords/InductionMachineData.mo:7`. Role: `parameter`; binding: `aimcData.Jr`; effective min: `None`; effective max: `None`. 
