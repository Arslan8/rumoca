# FINDING-02495: Zero on-resistance/off-conductance is an intended ideal limit
...
| Original report | [FINDING-smpm-resistivebraking-switch3-idealclosingswitch-1-ron-ruleoff.md](../../v2/bugs/FINDING-smpm-resistivebraking-switch3-idealclosingswitch-1-ron-ruleoff.md) — reviewed as `FINDING-02495-smpm-resistivebraking-switch3-idealclosingswitch-1-ron.md`, which a later run renamed |
| Original SHA-256 | 08853bfa740de9346af48f7c9c769f23c69acf3d11cf4bd7b7ca33a1c80f9bf6 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSwitch.mo:4`. Role: `parameter`; binding: `switch3.Ron[1]`; effective min: `0`; effective max: `None`. 
