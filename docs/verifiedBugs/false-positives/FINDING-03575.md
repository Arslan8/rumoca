# FINDING-03575: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | chopperStepDown.transistor.Goff |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-chopperstepdown-rl-chopperstepdown-transistor-goff-zerolimit.md](../../v2/bugs/FINDING-chopperstepdown-rl-chopperstepdown-transistor-goff-zerolimit.md) — reviewed as `FINDING-03575-chopperstepdown-rl-chopperstepdown-transistor-goff.md`, which a later run renamed |
| Original SHA-256 | 71f25f94787efd959ef05ebc55c4c60ac4c21d8d07aa8251f11ca9ac548c5035 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:6`. Role: `parameter`; binding: `chopperStepDown.GoffTransistor`; effective min: `0`; effective max: `None`. 
