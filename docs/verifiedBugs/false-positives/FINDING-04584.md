# FINDING-04584: Zero stored fluid mass is explicitly supported
...
| Original report | [FINDING-parallelpumpdropout-pipe1-m-zerolimit.md](../../v2/bugs/FINDING-parallelpumpdropout-pipe1-m-zerolimit.md) — reviewed as `FINDING-04584-parallelpumpdropout-pipe1-m.md`, which a later run renamed |
| Original SHA-256 | 12b35e89e45f54e11d41f4aac2738c8fd137f1c693029640c703aabe24dfcae9 |
...
| Probe | Outcome |
|---|---|
| `pipe1.m=0` | reported-failure |

Diagnostic: solve-IR evaluation failed: non-finite derivative evaluation for state 'dTSource1'
