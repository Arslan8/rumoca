# FINDING-02799: Polyphase inductance delegates to zero-capable scalar inductors
...
| Original report | [FINDING-rectifier12pulse-transformer1-l2sigma-l-zerolimit.md](../../v2/bugs/FINDING-rectifier12pulse-transformer1-l2sigma-l-zerolimit.md) — reviewed as `FINDING-02799-rectifier12pulse-transformer1-l2sigma-l.md`, which a later run renamed |
| Original SHA-256 | 3ca66275e1daefdbd758cfdf5d08b207b7d5fc28c510b1cd33f2325e8dfc569c |
...
Compiler/source-resolved declaration: `Electrical/Polyphase/Basic/Inductor.mo:4`. Role: `parameter`; binding: `fill(transformer1.L2sigma, transformer1.m)`; effective min: `None`; effective max: `None`. 
