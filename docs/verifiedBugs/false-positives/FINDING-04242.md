# FINDING-04242: Tensor entries are not all strictly positive scalars
...
| Target | bodyBox.body.I_21 |
| Student classification | physical-domain-unenforced |
| Original report | `FINDING-04242-bevelgear1d-bodybox-body-i-21.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 50850447c11e64f231dc64bdf219011fa39665d2507dd0c552d4da8ae13b8b33 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:23`. Role: `parameter`; binding: `bodyBox.I[2, 1]`; effective min: `-1.7976931348623157e+308`; effective max: `None`. 
