# FINDING-03609: Zero on-resistance/off-conductance is an intended ideal limit
...
| Original report | [FINDING-chopperstepup-r-chopperstepup-transistor-goff-zerolimit.md](../../v2/bugs/FINDING-chopperstepup-r-chopperstepup-transistor-goff-zerolimit.md) — reviewed as `FINDING-03609-chopperstepup-r-chopperstepup-transistor-goff.md`, which a later run renamed |
| Original SHA-256 | 64ab97104ba925cb62fa8e96d3bdc59ee6e134b86fe5a3d156b5050b8d818db5 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:6`. Role: `parameter`; binding: `chopperStepUp.GoffTransistor`; effective min: `0`; effective max: `None`. 
