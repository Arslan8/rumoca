# FINDING-04859: Polyphase resistance/conductance delegates to signed scalar elements
...
| Original report | `FINDING-04859-smpm-voltagesourcewithlosses-smpm-rs-r.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 8be42adca55f6387dcbfef3143aa22e5a02ee178c646277bc7c895a16912de98 |
...
Compiler/source-resolved declaration: `Electrical/Polyphase/Basic/Resistor.mo:4`. Role: `parameter`; binding: `fill(smpm.Rs, smpm.m)`; effective min: `None`; effective max: `None`. 
