# FINDING-01178: Machine inertia delegates to the zero-capable algebraic inertia component
...
| Original report | [FINDING-dc-comparecharacteristics-dcse-js-zerolimit.md](../../v2/bugs/FINDING-dc-comparecharacteristics-dcse-js-zerolimit.md) — reviewed as `FINDING-01178-dc-comparecharacteristics-dcse-js.md`, which a later run renamed |
| Original SHA-256 | 3204325fffc772cc35ff1f5cc1e89d945de21da8bc6355d41fb1e15b5c4d938a |
...
Compiler/source-resolved declaration: `Electrical/Machines/Interfaces/PartialBasicMachine.mo:8`. Role: `parameter`; binding: `dcseData.Js`; effective min: `None`; effective max: `None`. 
