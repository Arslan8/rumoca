# FINDING-02489: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | switch2.idealClosingSwitch[2].Ron |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-smpm-resistivebraking-switch2-idealclosingswitch-2-ron-ruleoff.md](../../v2/bugs/FINDING-smpm-resistivebraking-switch2-idealclosingswitch-2-ron-ruleoff.md) — reviewed as `FINDING-02489-smpm-resistivebraking-switch2-idealclosingswitch-2-ron.md`, which a later run renamed |
| Original SHA-256 | 50186703a22bd03438960654ce981ed02f4caef8e33be7c1fec3c21b3940debe |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSwitch.mo:4`. Role: `parameter`; binding: `switch2.Ron[2]`; effective min: `0`; effective max: `None`. 
