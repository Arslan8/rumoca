# FINDING-03767: Armature example delegates to zero-capable mechanical terms
...
| Target | pmActuator.armature.c |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-armaturestroke-pmactuator-armature-c-intent.md](../../v2/bugs/FINDING-armaturestroke-pmactuator-armature-c-intent.md) — reviewed as `FINDING-03767-armaturestroke-pmactuator-armature-c.md`, which a later run renamed |
| Original SHA-256 | 6d0a0e3bc4098e252686d1c85c994f578213bd9e4b3153078c22faa9727f2367 |
...
Compiler/source-resolved declaration: `Magnetic/FluxTubes/Examples/Utilities/TranslatoryArmatureAndStopper.mo:9`. Role: `parameter`; binding: `pmActuator.c`; effective min: `None`; effective max: `None`. 
