# FINDING-00420: Zero inductance is an explicitly supported algebraic limit
...
| Original report | [FINDING-comparelinetrunks-oline4-l-4-l-zerolimit.md](../../v2/bugs/FINDING-comparelinetrunks-oline4-l-4-l-zerolimit.md) — reviewed as `FINDING-00420-comparelinetrunks-oline4-l-4-l.md`, which a later run renamed |
| Original SHA-256 | c25366c6f89eb16f398e0d397c28f753d597fbb5cf3207819c85fdce5f30a04d |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `oLine4.lm[4]`; effective min: `None`; effective max: `None`. 
