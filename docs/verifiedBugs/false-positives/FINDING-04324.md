# FINDING-04324: MultiBody Newton/Euler equations use mass and inertia multiplicatively
...
| Original report | [FINDING-mechanicalstructure-b5-m-intent.md](../../v2/bugs/FINDING-mechanicalstructure-b5-m-intent.md) — reviewed as `FINDING-04324-mechanicalstructure-b5-m.md`, which a later run renamed |
| Original SHA-256 | a4fce62551e6d5af49a486ae8aabea5e63976fa3255adf04161cf461ebff296c |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/BodyShape.mo:23`. Role: `parameter`; binding: `5.2`; effective min: `0`; effective max: `None`. 
