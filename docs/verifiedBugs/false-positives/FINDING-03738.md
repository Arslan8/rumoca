# FINDING-03738: Zeroing this operand does not zero the complete denominator
...
| Target | r_mFe.material.n |
| Student classification | divisor-reachable-zero |
| Original report | `FINDING-03738-saturatedinductor-r-mfe-material-n.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | b42a23850f45561961414da9eedb3cc99e3d37a93a3219b798ec42e294c75327 |
...
Compiler/source-resolved declaration: `Magnetic/FluxTubes/Material/SoftMagnetic/BaseData.mo:13`. Role: `parameter`; binding: `14`; effective min: `None`; effective max: `None`. 
