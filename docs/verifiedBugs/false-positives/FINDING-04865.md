# FINDING-04865: Machine inertia delegates to the zero-capable algebraic inertia component
...
| Original report | [FINDING-smpm-voltagesourcewithlosses-smpm-js-zerolimit.md](../../v2/bugs/FINDING-smpm-voltagesourcewithlosses-smpm-js-zerolimit.md) — reviewed as `FINDING-04865-smpm-voltagesourcewithlosses-smpm-js.md`, which a later run renamed |
| Original SHA-256 | 73fa8164e4f6540b1f5ad0897ae05e72f597af809696934e4bc3f17d62a2a99b |
...
Compiler/source-resolved declaration: `Electrical/Machines/Interfaces/PartialBasicMachine.mo:8`. Role: `parameter`; binding: `smpmData.Js`; effective min: `None`; effective max: `None`. 
