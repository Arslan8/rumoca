# FINDING-03407: Zero on-resistance/off-conductance is an intended ideal limit
...
| Original report | [FINDING-thyristorcentertap2mpulse-r-rectifier-thyristor-n-idealthyristor-3-ron.md](../../v2/bugs/FINDING-thyristorcentertap2mpulse-r-rectifier-thyristor-n-idealthyristor-3-ron.md) — reviewed as `FINDING-03407-thyristorcentertap2mpulse-r-rectifier-thyristor-n-idealthyristor-3-ron.md`, which a later run renamed |
| Original SHA-256 | c40a501d8f413fc9415db82f34a12b998e8473bf5b5ce5f8a419d744a0e989d7 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:4`. Role: `parameter`; binding: `rectifier.thyristor_n.Ron[3]`; effective min: `0`; effective max: `None`. 
