# FINDING-00155: Signed resistance is intentional and the divisor is bounded away from zero
...
| Original report | [FINDING-cauerlowpasssc-r4-r-ruleoff.md](../../v2/bugs/FINDING-cauerlowpasssc-r4-r-ruleoff.md) — reviewed as `FINDING-00155-cauerlowpasssc-r4-r.md`, which a later run renamed |
| Original SHA-256 | 96b1e6cd19c24f74a8f1e51a0b3c0211485ac0208c0d7fca4e43007ba521a932 |
