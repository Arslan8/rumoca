# FINDING-00261: The complete conductor denominator is already asserted positive
...
| Target | conductor4.conductor.alpha |
| Student classification | divisor-reachable-zero |
| Original report | [FINDING-generationoffmus-conductor4-conductor-alpha-divguarded.md](../../v2/bugs/FINDING-generationoffmus-conductor4-conductor-alpha-divguarded.md) — reviewed as `FINDING-00261-generationoffmus-conductor4-conductor-alpha.md`, which a later run renamed |
| Original SHA-256 | 5809737488429edb42537f633a9ab88d63d4e1fe426b73397b47c9f43518e1e5 |
