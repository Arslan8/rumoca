# FINDING-03901: MultiBody Newton/Euler equations use mass and inertia multiplicatively
...
| Target | boxBody1.body.I_33 |
| Student classification | physical-bound-permits-zero |
| Original report | `FINDING-03901-doublependuluminittip-boxbody1-body-i-33.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | b6b346cfeaa6b5b1e2b55e77571628e48396fb681be494d6636b7957a6fb872b |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:21`. Role: `parameter`; binding: `boxBody1.I[3, 3]`; effective min: `0`; effective max: `None`. 
