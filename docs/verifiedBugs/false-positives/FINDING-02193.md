# FINDING-02193: Zero stator leakage inductance is supported
...
| Original report | [FINDING-smee-generator-smee-lssigma-intent.md](../../v2/bugs/FINDING-smee-generator-smee-lssigma-intent.md) — reviewed as `FINDING-02193-smee-generator-smee-lssigma.md`, which a later run renamed |
| Original SHA-256 | f01a4c553344d6596245229aacd9f321a5cbe18bd4818e72731be1e802f91c50 |
...
Compiler/source-resolved declaration: `Electrical/Machines/Interfaces/PartialBasicInductionMachine.mo:23`. Role: `parameter`; binding: `smeeData.Lssigma`; effective min: `None`; effective max: `None`. 
