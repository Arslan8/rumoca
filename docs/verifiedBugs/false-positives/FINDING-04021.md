# FINDING-04021: Tensor entries are not all strictly positive scalars
...
| Target | body.body.I_21 |
| Student classification | physical-domain-unenforced |
| Original report | `FINDING-04021-initspringconstant-body-body-i-21.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | c13e1586748feea462df773c9d129771ec301f875baff2d76ce484f61e511b0c |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:23`. Role: `parameter`; binding: `body.I_21`; effective min: `-1.7976931348623157e+308`; effective max: `None`. 
