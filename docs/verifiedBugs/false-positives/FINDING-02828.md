# FINDING-02828: Polyphase resistance/conductance delegates to signed scalar elements
...
| Target | transformer2.r2.R |
| Student classification | physical-domain-unenforced |
| Original report | `FINDING-02828-rectifier12pulse-transformer2-r2-r.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | fbc7f106e9f552c5aa89bf55d827cdc38536412bf2cae01c22f2050e9d781318 |
...
Compiler/source-resolved declaration: `Electrical/Polyphase/Basic/Resistor.mo:4`. Role: `parameter`; binding: `fill(transformer2.R2, transformer2.m)`; effective min: `None`; effective max: `None`. 
