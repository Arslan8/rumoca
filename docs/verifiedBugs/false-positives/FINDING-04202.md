# FINDING-04202: MultiBody Newton/Euler equations use mass and inertia multiplicatively
...
| Original report | [FINDING-planarfourbar-body3-body-m-zerolimit.md](../../v2/bugs/FINDING-planarfourbar-body3-body-m-zerolimit.md) — reviewed as `FINDING-04202-planarfourbar-body3-body-m.md`, which a later run renamed |
| Original SHA-256 | c36af692b9bb6acfa65c5172bb1f96dae5e88a7c2962788315572621870777f2 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:16`. Role: `parameter`; binding: `body3.m`; effective min: `0`; effective max: `None`. 
