# FINDING-00573: Zero inductance is an explicitly supported algebraic limit
...
| Target | oLine50.L[47].L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-smoothstep-oline50-l-47-l-zerolimit.md](../../v2/bugs/FINDING-smoothstep-oline50-l-47-l-zerolimit.md) — reviewed as `FINDING-00573-smoothstep-oline50-l-47-l.md`, which a later run renamed |
| Original SHA-256 | 3141d3b4e453c570d67408830b1caf29d239a7972110f80811306deffe0fcc56 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `oLine50.lm[47]`; effective min: `None`; effective max: `None`. 
