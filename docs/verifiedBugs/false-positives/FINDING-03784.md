# FINDING-03784: Zero inductance is an explicitly supported algebraic limit
...
| Target | cActuator.l.L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-armaturestroke-cactuator-l-l-zerolimit.md](../../v2/bugs/FINDING-armaturestroke-cactuator-l-l-zerolimit.md) — reviewed as `FINDING-03784-armaturestroke-cactuator-l-l.md`, which a later run renamed |
| Original SHA-256 | 384ee72d020f75bfecfe63b966b650c0a4364cdec683a277460293e83d0794b9 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `cActuator.L`; effective min: `None`; effective max: `None`. 
