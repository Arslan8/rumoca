# FINDING-01698: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | inverter.diode_p.idealDiode[2].Goff |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-imc-inverterdrive-inverter-diode-p-idealdiode-2-goff-zerolimit.md](../../v2/bugs/FINDING-imc-inverterdrive-inverter-diode-p-idealdiode-2-goff-zerolimit.md) — reviewed as `FINDING-01698-imc-inverterdrive-inverter-diode-p-idealdiode-2-goff.md`, which a later run renamed |
| Original SHA-256 | 8f398d7830dbeb54010da7921dfa83d3a1caec1ba446c015719448a8550f0788 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:6`. Role: `parameter`; binding: `inverter.diode_p.Goff[2]`; effective min: `0`; effective max: `None`. 
