# FINDING-01690: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | inverter.transistor_p.idealGTOThyristor[2].Goff |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-imc-inverterdrive-inverter-transistor-p-idealgtothyristor-2-goff-zerol.md](../../v2/bugs/FINDING-imc-inverterdrive-inverter-transistor-p-idealgtothyristor-2-goff-zerol.md) — reviewed as `FINDING-01690-imc-inverterdrive-inverter-transistor-p-idealgtothyristor-2-goff.md`, which a later run renamed |
| Original SHA-256 | 4c424f2a3e281ccfa4cb4f95de285856535778e00955e7e64d1841fff342fbde |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:6`. Role: `parameter`; binding: `inverter.transistor_p.Goff[2]`; effective min: `0`; effective max: `None`. 
