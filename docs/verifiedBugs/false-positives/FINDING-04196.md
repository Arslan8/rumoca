# FINDING-04196: Tensor entries are not all strictly positive scalars
...
| Original report | [FINDING-planarfourbar-body2-body-i-tensorunknown.md](../../v2/bugs/FINDING-planarfourbar-body2-body-i-tensorunknown.md) — reviewed as `FINDING-04196-planarfourbar-body2-body-i.md`, which a later run renamed |
| Original SHA-256 | 7d0f7e41c5f1d6004592cf59034fa27b943e450e1c83df4c9f34c853fea29fa4 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:114`. Role: `parameter`; binding: `cat1(cat2(body2.body.I_11, body2.body.I_21, body2.body.I_31), cat2(body2.body.I_21, body2.body.I_22, body2.body.I_32), cat2(body2.body.I_31, body2.body.I_32, body2.body.I_33))`; effective min: `None`; effective max: `None`. 
