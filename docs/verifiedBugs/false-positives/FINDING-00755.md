# FINDING-00755: Zero trapezoid edge duration is handled by branch reachability
...
| Original report | [FINDING-nandgate-vin1-signalsource-falling-divunresolved.md](../../v2/bugs/FINDING-nandgate-vin1-signalsource-falling-divunresolved.md) — reviewed as `FINDING-00755-nandgate-vin1-signalsource-falling.md`, which a later run renamed |
| Original SHA-256 | 0ddd6e613d5873052002ee8fb0db3f0c2dff4875b43be46cfd6881b036109f67 |
...
Compiler/source-resolved declaration: `Blocks/Sources.mo:898`. Role: `parameter`; binding: `1e-09`; effective min: `0`; effective max: `None`. 
