# FINDING-01665: Zero on-resistance/off-conductance is an intended ideal limit
...
| Original report | [FINDING-imc-inverterdrive-rectifier-diode-p-goff-ruleoff.md](../../v2/bugs/FINDING-imc-inverterdrive-rectifier-diode-p-goff-ruleoff.md) — reviewed as `FINDING-01665-imc-inverterdrive-rectifier-diode-p-goff.md`, which a later run renamed |
| Original SHA-256 | 0f63c568c5928644ab3391a386af76ed7e3a196ac520e73b11a15453cd978883 |
