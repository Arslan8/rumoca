# FINDING-02918: Zero inductance is an explicitly supported algebraic limit
...
| Original report | [FINDING-transformertestbench-transformer-l2sigma-inductor-3-l-zerolimit.md](../../v2/bugs/FINDING-transformertestbench-transformer-l2sigma-inductor-3-l-zerolimit.md) — reviewed as `FINDING-02918-transformertestbench-transformer-l2sigma-inductor-3-l.md`, which a later run renamed |
| Original SHA-256 | 352ac935e9c02488e9e4d90040d8e6705fbf1047f5eec0c557859e69e06ec9aa |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `transformer.l2sigma.L[3]`; effective min: `None`; effective max: `None`. 
