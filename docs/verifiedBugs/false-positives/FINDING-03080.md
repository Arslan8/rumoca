# FINDING-03080: Zero inertia is a massless algebraic component, not an intrinsic division
...
| Target | dcpm.inertiaStator.J |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-thyristorbridge2mpulse-dc-drive-dcpm-inertiastator-j-zerolimit.md](../../v2/bugs/FINDING-thyristorbridge2mpulse-dc-drive-dcpm-inertiastator-j-zerolimit.md) — reviewed as `FINDING-03080-thyristorbridge2mpulse-dc-drive-dcpm-inertiastator-j.md`, which a later run renamed |
| Original SHA-256 | 8c6bac4e2384f76c3444aa618965b26b4b486caaf1feb7dfcff56b890da9500b |
...
Compiler/source-resolved declaration: `Mechanics/Rotational/Components/Inertia.mo:4`. Role: `parameter`; binding: `dcpm.Js`; effective min: `0`; effective max: `None`. 
