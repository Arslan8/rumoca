# FINDING-04405: Zero inertia is a massless algebraic component, not an intrinsic division
...
| Original report | [FINDING-rollingwheel-inertia-j-zerolimit.md](../../v2/bugs/FINDING-rollingwheel-inertia-j-zerolimit.md) — reviewed as `FINDING-04405-rollingwheel-inertia-j.md`, which a later run renamed |
| Original SHA-256 | b841c6fbb4d55d5ca7586336baf61efba533b7d8baba42848910deee637d7053 |
...
[Rumoca commands, return codes, integrity hashes, bounded output and metadata](../evidence/51c26a7ca6db79c1.json). Baseline: **reported-failure**.
