# FINDING-02957: Polyphase resistance/conductance delegates to signed scalar elements
...
| Original report | `FINDING-02957-testsensors-resistor-r.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | a8f3e32125a6b1efdde7190ccb2e9490000e2829484bd9532fb498dce6181274 |
...
Compiler/source-resolved declaration: `Electrical/Polyphase/Basic/Resistor.mo:4`. Role: `parameter`; binding: `fill(R, m)`; effective min: `None`; effective max: `None`. 
