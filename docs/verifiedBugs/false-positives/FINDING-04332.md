# FINDING-04332: MultiBody Newton/Euler equations use mass and inertia multiplicatively
...
| Original report | `FINDING-04332-mechanicalstructure-b5-body-i-11.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 333bcf600429e3a382e12a9990c6c41efe71f2adb68532fdd5570095d9abe079 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:17`. Role: `parameter`; binding: `1.25`; effective min: `0`; effective max: `None`. 
