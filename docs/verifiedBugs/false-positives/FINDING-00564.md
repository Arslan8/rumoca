# FINDING-00564: Zero inductance is an explicitly supported algebraic limit
...
| Target | oLine50.L[38].L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-smoothstep-oline50-l-38-l-zerolimit.md](../../v2/bugs/FINDING-smoothstep-oline50-l-38-l-zerolimit.md) — reviewed as `FINDING-00564-smoothstep-oline50-l-38-l.md`, which a later run renamed |
| Original SHA-256 | 1402f5564e310a967d39b0b679ba1ea88a2544a34974e85790ad26be96f0fa8c |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `oLine50.lm[38]`; effective min: `None`; effective max: `None`. 
