# FINDING-00517: Zero inductance is an explicitly supported algebraic limit
...
| Original report | [FINDING-smoothstep-oline5-l-4-l-zerolimit.md](../../v2/bugs/FINDING-smoothstep-oline5-l-4-l-zerolimit.md) — reviewed as `FINDING-00517-smoothstep-oline5-l-4-l.md`, which a later run renamed |
| Original SHA-256 | 81ecd984b8f74ac54283c883182ea6ce50da233187388edea8d74271bfd6f17a |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `oLine5.lm[4]`; effective min: `None`; effective max: `None`. 
