# FINDING-04348: MultiBody Newton/Euler equations use mass and inertia multiplicatively
...
| Original report | `FINDING-04348-mechanicalstructure-b6-body-i-22.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | dc8cbaeab1ec8333e24c11d85e1174a66a412e9bb595902f145f6fa19309efd1 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:19`. Role: `parameter`; binding: `b6.I_22`; effective min: `0`; effective max: `None`. 
