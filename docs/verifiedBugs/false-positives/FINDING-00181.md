# FINDING-00181: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | With_Ron_Goff_Vknee.Goff |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-characteristicidealdiodes-with-ron-goff-vknee-goff-zerolimit.md](../../v2/bugs/FINDING-characteristicidealdiodes-with-ron-goff-vknee-goff-zerolimit.md) — reviewed as `FINDING-00181-characteristicidealdiodes-with-ron-goff-vknee-goff.md`, which a later run renamed |
| Original SHA-256 | 7a9240c4dd6e91a41630ea039a26c77a36d801f2e1ad3b38e50af1fbc47dea42 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:6`. Role: `parameter`; binding: `0.2`; effective min: `0`; effective max: `None`. 
...
[Rumoca commands, return codes, integrity hashes, bounded output and metadata](../evidence/01e9fa97b348ca1c.json). Baseline: **tool-error**.
