# FINDING-05090: Vehicle parameter has a multiplicative zero limit
...
| Target | vehicleInclinationInConst.rho |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-vehicles-vehicleinclinationinconst-rho-zerolimit.md](../../v2/bugs/FINDING-vehicles-vehicleinclinationinconst-rho-zerolimit.md) — reviewed as `FINDING-05090-vehicles-vehicleinclinationinconst-rho.md`, which a later run renamed |
| Original SHA-256 | 857f9c225c145ad57381757b43cad9b4df99d1b2b3a528e4ceec6cc18e5f22dc |

## Why this is a false positive

rho only multiplies the aerodynamic force coefficient. At zero it removes that inertia or aerodynamic term; the Vehicle source does not divide by it. A physical production vehicle has positive values, but this component also supports idealized/lumped configurations, so a blanket strictly-positive sanitizer finding is not a verified bug.

## Source evidence

Compiler/source-resolved declaration: `Mechanics/Translational/Components/Vehicle.mo:11`. Role: `parameter`; binding: `1.2`; effective min: `0.0`; effective max: `None`. 
