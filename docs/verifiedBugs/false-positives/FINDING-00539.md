# FINDING-00539: Zero inductance is an explicitly supported algebraic limit
...
| Target | oLine50.L[13].L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-smoothstep-oline50-l-13-l-zerolimit.md](../../v2/bugs/FINDING-smoothstep-oline50-l-13-l-zerolimit.md) — reviewed as `FINDING-00539-smoothstep-oline50-l-13-l.md`, which a later run renamed |
| Original SHA-256 | bfa961bb071c875ae3eceb4d22a62344d8f23e4a05beb52a9da9dccfc73cc77f |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `oLine50.lm[13]`; effective min: `None`; effective max: `None`. 
