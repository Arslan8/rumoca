# FINDING-03703: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | hbridge.inverter_n.diode_p.Goff |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-hbridge-trianglepwm-rl-hbridge-inverter-n-diode-p-goff-zerolimit.md](../../v2/bugs/FINDING-hbridge-trianglepwm-rl-hbridge-inverter-n-diode-p-goff-zerolimit.md) — reviewed as `FINDING-03703-hbridge-trianglepwm-rl-hbridge-inverter-n-diode-p-goff.md`, which a later run renamed |
| Original SHA-256 | 0a6921b57d6684aaa0f856735a13c6a85d60f32eae3a7585a2991b0745cc22b2 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:6`. Role: `parameter`; binding: `hbridge.inverter_n.GoffDiode`; effective min: `0`; effective max: `None`. 
