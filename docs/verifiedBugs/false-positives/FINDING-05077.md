# FINDING-05077: Zero mass is a massless algebraic component, not an intrinsic division
...
| Target | vehicleRollInConst.mass.m |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-vehicles-vehiclerollinconst-mass-m-zerolimit.md](../../v2/bugs/FINDING-vehicles-vehiclerollinconst-mass-m-zerolimit.md) — reviewed as `FINDING-05077-vehicles-vehiclerollinconst-mass-m.md`, which a later run renamed |
| Original SHA-256 | bd6392feac1641a64c0b19b2c28b3f44c0989d87800ed90257eebee1bd616c2a |
