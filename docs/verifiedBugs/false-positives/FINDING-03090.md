# FINDING-03090: Zero inductance is an explicitly supported algebraic limit
...
| Target | lMains.inductor[2].L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-thyristorbridge2mpulse-dc-drive-lmains-inductor-2-l-zerolimit.md](../../v2/bugs/FINDING-thyristorbridge2mpulse-dc-drive-lmains-inductor-2-l-zerolimit.md) — reviewed as `FINDING-03090-thyristorbridge2mpulse-dc-drive-lmains-inductor-2-l.md`, which a later run renamed |
| Original SHA-256 | 91ad4a9c435c3597f83b5f092ae6f1073ad8022b343894720c9d0f3afb5a3fd5 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `lMains.L[2]`; effective min: `None`; effective max: `None`. 
