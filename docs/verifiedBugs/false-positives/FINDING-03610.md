# FINDING-03610: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | chopperStepUp.diode.Ron |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-chopperstepup-r-chopperstepup-diode-ron-ruleoff.md](../../v2/bugs/FINDING-chopperstepup-r-chopperstepup-diode-ron-ruleoff.md) — reviewed as `FINDING-03610-chopperstepup-r-chopperstepup-diode-ron.md`, which a later run renamed |
| Original SHA-256 | f84f1accf85e015868563350ce5360039c78b740203921c4630a0b1a3aa487ff |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:4`. Role: `parameter`; binding: `chopperStepUp.RonDiode`; effective min: `0`; effective max: `None`. 
