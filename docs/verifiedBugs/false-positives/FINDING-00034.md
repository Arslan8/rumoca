# FINDING-00034: Zero capacitance is an explicitly supported algebraic limit
...
| Original report | [FINDING-cauerlowpassanalog-c3-c-zerolimit.md](../../v2/bugs/FINDING-cauerlowpassanalog-c3-c-zerolimit.md) — reviewed as `FINDING-00034-cauerlowpassanalog-c3-c.md`, which a later run renamed |
| Original SHA-256 | 33047117d5fb0113eff7ee63111e85b9372f7af9d9d651bce430995bcd56bac5 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Capacitor.mo:4`. Role: `parameter`; binding: `c3`; effective min: `0`; effective max: `None`. 
