# FINDING-00938: Zero capacitance is an explicitly supported algebraic limit
...
| Original report | [FINDING-overvoltageprotection-cl-c-zerolimit.md](../../v2/bugs/FINDING-overvoltageprotection-cl-c-zerolimit.md) — reviewed as `FINDING-00938-overvoltageprotection-cl-c.md`, which a later run renamed |
| Original SHA-256 | f724d12fa7c62e833110e751b5ea12a52364a6e4af2942482be63e562beac021 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Capacitor.mo:4`. Role: `parameter`; binding: `1e-07`; effective min: `0`; effective max: `None`. 
