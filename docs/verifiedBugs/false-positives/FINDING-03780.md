# FINDING-03780: Armature example delegates to zero-capable mechanical terms
...
| Target | cActuator.armature.d |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-armaturestroke-cactuator-armature-d-intent.md](../../v2/bugs/FINDING-armaturestroke-cactuator-armature-d-intent.md) — reviewed as `FINDING-03780-armaturestroke-cactuator-armature-d.md`, which a later run renamed |
| Original SHA-256 | 1b74c5ee9421d7a1b3aff11f1f5ba4ab356552514b9ab05fd140d5519ca1ba75 |
...
Compiler/source-resolved declaration: `Magnetic/FluxTubes/Examples/Utilities/TranslatoryArmatureAndStopper.mo:11`. Role: `parameter`; binding: `cActuator.d`; effective min: `None`; effective max: `None`. 
