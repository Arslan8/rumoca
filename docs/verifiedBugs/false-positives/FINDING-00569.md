# FINDING-00569: Zero inductance is an explicitly supported algebraic limit
...
| Target | oLine50.L[43].L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-smoothstep-oline50-l-43-l-zerolimit.md](../../v2/bugs/FINDING-smoothstep-oline50-l-43-l-zerolimit.md) — reviewed as `FINDING-00569-smoothstep-oline50-l-43-l.md`, which a later run renamed |
| Original SHA-256 | 21d968baba66093d964dc524bf9bab95d4f30548d73a4a7b2095aa423d3c0ae5 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `oLine50.lm[43]`; effective min: `None`; effective max: `None`. 
