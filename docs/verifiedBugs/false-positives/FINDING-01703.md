# FINDING-01703: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | inverter.transistor_n.idealGTOThyristor[1].Ron |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-imc-inverterdrive-inverter-transistor-n-idealgtothyristor-1-ron-ruleof.md](../../v2/bugs/FINDING-imc-inverterdrive-inverter-transistor-n-idealgtothyristor-1-ron-ruleof.md) — reviewed as `FINDING-01703-imc-inverterdrive-inverter-transistor-n-idealgtothyristor-1-ron.md`, which a later run renamed |
| Original SHA-256 | dba7fee60364161a5350ebc10f29ad2678161bb1f158b5d3fd644567e6cdd490 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:4`. Role: `parameter`; binding: `inverter.transistor_n.Ron[1]`; effective min: `0`; effective max: `None`. 
