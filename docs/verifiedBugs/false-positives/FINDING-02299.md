# FINDING-02299: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | diodeBridge2mPulse.diode_p.idealDiode[3].Goff |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-smpm-braking-diodebridge2mpulse-diode-p-idealdiode-3-goff-zerolimit.md](../../v2/bugs/FINDING-smpm-braking-diodebridge2mpulse-diode-p-idealdiode-3-goff-zerolimit.md) — reviewed as `FINDING-02299-smpm-braking-diodebridge2mpulse-diode-p-idealdiode-3-goff.md`, which a later run renamed |
| Original SHA-256 | 050956bd15ca58d571ae84147cb6729e4556165be1244f16be0ba671249c52a2 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:6`. Role: `parameter`; binding: `diodeBridge2mPulse.diode_p.Goff[3]`; effective min: `0`; effective max: `None`. 
