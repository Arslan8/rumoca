# FINDING-00532: Zero inductance is an explicitly supported algebraic limit
...
| Target | oLine50.L[6].L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-smoothstep-oline50-l-6-l-zerolimit.md](../../v2/bugs/FINDING-smoothstep-oline50-l-6-l-zerolimit.md) — reviewed as `FINDING-00532-smoothstep-oline50-l-6-l.md`, which a later run renamed |
| Original SHA-256 | 8aae1f8d70d493d4eaf329aa52f3872b023b45f711754d12a25575df62d68477 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `oLine50.lm[6]`; effective min: `None`; effective max: `None`. 
