# FINDING-04869: Air-gap inductance is used as a flux multiplier
...
| Target | smpm.airGap.Lmq |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-smpm-voltagesourcewithlosses-smpm-airgap-lmq-intent.md](../../v2/bugs/FINDING-smpm-voltagesourcewithlosses-smpm-airgap-lmq-intent.md) — reviewed as `FINDING-04869-smpm-voltagesourcewithlosses-smpm-airgap-lmq.md`, which a later run renamed |
| Original SHA-256 | f5843e1933c36d999915c3f384835c7dc43b4d97d6fa3acf1840e0ebf7a99860 |
...
Compiler/source-resolved declaration: `Electrical/Machines/BasicMachines/Components/AirGapR.mo:5`. Role: `parameter`; binding: `smpmData.Lmq`; effective min: `None`; effective max: `None`. 
