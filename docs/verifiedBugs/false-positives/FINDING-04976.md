# FINDING-04976: Zeroing this operand does not zero the complete denominator
...
| Target | genericFluxTube1.material.c_b |
| Student classification | divisor-reachable-zero |
| Original report | `FINDING-04976-sources-genericfluxtube1-material-c-b.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | aac71b7534e0ace7dc91b969e7a48c2d3b34a3f982eaa8387c0d682a19ac7a41 |
...
| Probe | Outcome |
|---|---|
| `genericFluxTube1.material.c_b=0` | clean |
