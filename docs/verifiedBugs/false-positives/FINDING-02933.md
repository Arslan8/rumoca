# FINDING-02933: Zero inductance is an explicitly supported algebraic limit
...
| Target | supplyL.inductor[2].L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-rectifier-supplyl-inductor-2-l-zerolimit.md](../../v2/bugs/FINDING-rectifier-supplyl-inductor-2-l-zerolimit.md) — reviewed as `FINDING-02933-rectifier-supplyl-inductor-2-l.md`, which a later run renamed |
| Original SHA-256 | 8cb875e74f199ed487b56c9754e8b7fbc392f6997af2e0d6d2087d5776a21453 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `supplyL.L[2]`; effective min: `None`; effective max: `None`. 
