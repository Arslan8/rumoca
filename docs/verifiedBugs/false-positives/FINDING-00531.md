# FINDING-00531: Zero inductance is an explicitly supported algebraic limit
...
| Target | oLine50.L[5].L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-smoothstep-oline50-l-5-l-zerolimit.md](../../v2/bugs/FINDING-smoothstep-oline50-l-5-l-zerolimit.md) — reviewed as `FINDING-00531-smoothstep-oline50-l-5-l.md`, which a later run renamed |
| Original SHA-256 | ab9cb6e123a5017eef6f19dd983ec34cccd7da6cecc900c174254dd2c7b32626 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `oLine50.lm[5]`; effective min: `None`; effective max: `None`. 
