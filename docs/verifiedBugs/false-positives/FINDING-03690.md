# FINDING-03690: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | hbridge.inverter_p.diode_p.Ron |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-hbridge-trianglepwm-rl-hbridge-inverter-p-diode-p-ron-ruleoff.md](../../v2/bugs/FINDING-hbridge-trianglepwm-rl-hbridge-inverter-p-diode-p-ron-ruleoff.md) — reviewed as `FINDING-03690-hbridge-trianglepwm-rl-hbridge-inverter-p-diode-p-ron.md`, which a later run renamed |
| Original SHA-256 | ae309a3a4750f7d1c60182a98dfbc4af8fd61e48be225181cb697ce40b09f6fe |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:4`. Role: `parameter`; binding: `hbridge.inverter_p.RonDiode`; effective min: `0`; effective max: `None`. 
