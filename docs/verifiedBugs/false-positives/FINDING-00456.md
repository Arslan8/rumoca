# FINDING-00456: The complete conductor denominator is already asserted positive
...
| Target | oLine2.G[2].T_ref |
| Student classification | divisor-reachable-zero |
| Original report | `FINDING-00456-comparelinetrunks-oline2-g-2-t-ref.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 54c20436d5142e5a57a10498db2fd1356f2099967501f0c7001428893b43d20a |
