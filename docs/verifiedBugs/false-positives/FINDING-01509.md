# FINDING-01509: Zero armature resistance is an ideal algebraic limit
...
| Original report | [FINDING-dcse-start-dcse-ra-unbounded.md](../../v2/bugs/FINDING-dcse-start-dcse-ra-unbounded.md) — reviewed as `FINDING-01509-dcse-start-dcse-ra.md`, which a later run renamed |
| Original SHA-256 | eb6e496acbb3c029676d1590b9a51f65f5aa571276147480560f69428936758e |
