# FINDING-02026: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | switchYD.idealOpener.idealOpeningSwitch[1].Ron |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-imc-yd-switchyd-idealopener-idealopeningswitch-1-ron-ruleoff.md](../../v2/bugs/FINDING-imc-yd-switchyd-idealopener-idealopeningswitch-1-ron-ruleoff.md) — reviewed as `FINDING-02026-imc-yd-switchyd-idealopener-idealopeningswitch-1-ron.md`, which a later run renamed |
| Original SHA-256 | 09f38d875c6821f91ee7d5ea1c937a82cd763346b1fca7a40ef01034cc26b236 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSwitch.mo:4`. Role: `parameter`; binding: `switchYD.idealOpener.Ron[1]`; effective min: `0`; effective max: `None`. 
