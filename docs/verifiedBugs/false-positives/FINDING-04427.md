# FINDING-04427: Zero mass is a massless algebraic component, not an intrinsic division
...
| Original report | [BUG-damper-mass3-m.md](../../v2/bugs/BUG-damper-mass3-m.md) — reviewed as `FINDING-04427-damper-mass3-m.md`, which a later run renamed |
| Original SHA-256 | 45f00887b7b67643a41bcc5d9b5ecb45bd4e56583b66f60249f83d65a0520d9d |
...
Diagnostic: solve-IR evaluation failed: algebraic projection did not converge at event boundary: worst scaled residual row=28 target=mass3.a value=2.500000e2 ratio=2.500000e12 norm=2.500000e2 row_scale=1.000000e0 scaled_tolerance=1.000000e-10

[Independent OpenModelica wrappers and complete output](../evidence/omc-2f5c9ac506c1b046.json). Baseline: simulation succeeded.

- `mass3.m=0` set before translation: LOG_ASSERT        | debug   | division by zero at time 0, (a=-250) / (b=0), where divisor b expression is: mass3.m.
- Same value declared final, with final-parameter evaluation: LOG_INIT          | error   | The initialization problem is inconsistent due to the following equation: 0 != 250 = $START.mass3.s - mass3.s.
