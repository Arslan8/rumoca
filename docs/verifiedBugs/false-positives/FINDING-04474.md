# FINDING-04474: Zero ElastoGap stiffness is handled without division
...
| Target | outerContactB.c |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-preload-outercontactb-c-zerolimit.md](../../v2/bugs/FINDING-preload-outercontactb-c-zerolimit.md) — reviewed as `FINDING-04474-preload-outercontactb-c.md`, which a later run renamed |
| Original SHA-256 | c53ca7c4a994b74e390e48abe76325f684313b0d3b2c75d917484c00c6a28530 |
...
Compiler/source-resolved declaration: `Mechanics/Translational/Components/ElastoGap.mo:4`. Role: `parameter`; binding: `1000000.0`; effective min: `0`; effective max: `None`. 
