# FINDING-03705: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | hbridge.inverter_n.transistor_n.Goff |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-hbridge-trianglepwm-rl-hbridge-inverter-n-transistor-n-goff-zerolimit.md](../../v2/bugs/FINDING-hbridge-trianglepwm-rl-hbridge-inverter-n-transistor-n-goff-zerolimit.md) — reviewed as `FINDING-03705-hbridge-trianglepwm-rl-hbridge-inverter-n-transistor-n-goff.md`, which a later run renamed |
| Original SHA-256 | 87afe4a6bd0da8f29ffd4acd73656b66195065621702ea21d618198e818a159b |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:6`. Role: `parameter`; binding: `hbridge.inverter_n.GoffTransistor`; effective min: `0`; effective max: `None`. 
