# FINDING-02295: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | diodeBridge2mPulse.diode_p.idealDiode[1].Goff |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-smpm-braking-diodebridge2mpulse-diode-p-idealdiode-1-goff-zerolimit.md](../../v2/bugs/FINDING-smpm-braking-diodebridge2mpulse-diode-p-idealdiode-1-goff-zerolimit.md) — reviewed as `FINDING-02295-smpm-braking-diodebridge2mpulse-diode-p-idealdiode-1-goff.md`, which a later run renamed |
| Original SHA-256 | 204faf4ec4946535c1e84bb9216f6db3e522baa3a47dd3b8fc3d3e9895316a91 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:6`. Role: `parameter`; binding: `diodeBridge2mPulse.diode_p.Goff[1]`; effective min: `0`; effective max: `None`. 
