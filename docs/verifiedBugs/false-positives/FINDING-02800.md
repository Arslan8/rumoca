# FINDING-02800: Zero inductance is an explicitly supported algebraic limit
...
| Target | transformer1.l2sigma.inductor[1].L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-rectifier12pulse-transformer1-l2sigma-inductor-1-l-zerolimit.md](../../v2/bugs/FINDING-rectifier12pulse-transformer1-l2sigma-inductor-1-l-zerolimit.md) — reviewed as `FINDING-02800-rectifier12pulse-transformer1-l2sigma-inductor-1-l.md`, which a later run renamed |
| Original SHA-256 | 7ae18abd06d77c4ae7292b33a80c8ad93c9aee0d5de5b57a2d0f551aea30ea65 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `transformer1.l2sigma.L[1]`; effective min: `None`; effective max: `None`. 
