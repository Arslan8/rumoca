# FINDING-01441: Machine inertia delegates to the zero-capable algebraic inertia component
...
| Original report | [FINDING-dcpm-withlosses-dcpm2-jr-zerolimit.md](../../v2/bugs/FINDING-dcpm-withlosses-dcpm2-jr-zerolimit.md) — reviewed as `FINDING-01441-dcpm-withlosses-dcpm2-jr.md`, which a later run renamed |
| Original SHA-256 | 3a847b74f2bf97ed83c0b5f75af783c1f8b6eef92e2045c664aed52a9f144c96 |
...
Compiler/source-resolved declaration: `Electrical/Machines/Interfaces/PartialBasicMachine.mo:5`. Role: `parameter`; binding: `dcpmData2.Jr`; effective min: `None`; effective max: `None`. 
