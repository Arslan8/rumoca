# FINDING-01442: Machine inertia delegates to the zero-capable algebraic inertia component
...
| Original report | [FINDING-dcpm-withlosses-dcpm2-js-zerolimit.md](../../v2/bugs/FINDING-dcpm-withlosses-dcpm2-js-zerolimit.md) — reviewed as `FINDING-01442-dcpm-withlosses-dcpm2-js.md`, which a later run renamed |
| Original SHA-256 | 3f8c286b2b02652bac5fdc062a720b015d6fbfa7c0c4dd414f5ce07bfddc7d30 |
...
Compiler/source-resolved declaration: `Electrical/Machines/Interfaces/PartialBasicMachine.mo:8`. Role: `parameter`; binding: `dcpmData2.Js`; effective min: `None`; effective max: `None`. 
