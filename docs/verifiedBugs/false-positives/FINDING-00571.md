# FINDING-00571: Zero inductance is an explicitly supported algebraic limit
...
| Target | oLine50.L[45].L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-smoothstep-oline50-l-45-l-zerolimit.md](../../v2/bugs/FINDING-smoothstep-oline50-l-45-l-zerolimit.md) — reviewed as `FINDING-00571-smoothstep-oline50-l-45-l.md`, which a later run renamed |
| Original SHA-256 | 258232c198e7aca80a541f39ee67b75276b48c2db8c44321cc07567eacab3aaf |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `oLine50.lm[45]`; effective min: `None`; effective max: `None`. 
