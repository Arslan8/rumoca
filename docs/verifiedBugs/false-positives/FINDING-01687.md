# FINDING-01687: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | inverter.transistor_p.idealGTOThyristor[1].Ron |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-imc-inverterdrive-inverter-transistor-p-idealgtothyristor-1-ron-ruleof.md](../../v2/bugs/FINDING-imc-inverterdrive-inverter-transistor-p-idealgtothyristor-1-ron-ruleof.md) — reviewed as `FINDING-01687-imc-inverterdrive-inverter-transistor-p-idealgtothyristor-1-ron.md`, which a later run renamed |
| Original SHA-256 | 062eac55a59a2208fca72f0889f547801c9a9fd1a41a057aeceaeca3ec74cff3 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:4`. Role: `parameter`; binding: `inverter.transistor_p.Ron[1]`; effective min: `0`; effective max: `None`. 
