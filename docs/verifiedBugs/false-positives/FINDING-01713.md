# FINDING-01713: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | inverter.diode_n.idealDiode[2].Ron |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-imc-inverterdrive-inverter-diode-n-idealdiode-2-ron-ruleoff.md](../../v2/bugs/FINDING-imc-inverterdrive-inverter-diode-n-idealdiode-2-ron-ruleoff.md) — reviewed as `FINDING-01713-imc-inverterdrive-inverter-diode-n-idealdiode-2-ron.md`, which a later run renamed |
| Original SHA-256 | e08e9f908796edf713ed4e1505e0b0cf97ba3ce5f8d04bd7e93b72febd133990 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:4`. Role: `parameter`; binding: `inverter.diode_n.Ron[2]`; effective min: `0`; effective max: `None`. 
