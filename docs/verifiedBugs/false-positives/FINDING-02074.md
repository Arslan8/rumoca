# FINDING-02074: Zero inductance is an explicitly supported algebraic limit
...
| Target | aims.lrzero.L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-ims-start-aims-lrzero-l-zerolimit.md](../../v2/bugs/FINDING-ims-start-aims-lrzero-l-zerolimit.md) — reviewed as `FINDING-02074-ims-start-aims-lrzero-l.md`, which a later run renamed |
| Original SHA-256 | d47b1a3537da470ab7932f1af8939ca44270fe256e9722389b5c1d12acf1d788 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `((aims.internalTurnsRatio ^ 2) * aims.Lrzero)`; effective min: `None`; effective max: `None`. 
