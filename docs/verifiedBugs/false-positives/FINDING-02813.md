# FINDING-02813: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | diode4.idealDiode[1].Ron |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-rectifier12pulse-diode4-idealdiode-1-ron-ruleoff.md](../../v2/bugs/FINDING-rectifier12pulse-diode4-idealdiode-1-ron-ruleoff.md) — reviewed as `FINDING-02813-rectifier12pulse-diode4-idealdiode-1-ron.md`, which a later run renamed |
| Original SHA-256 | cfc088a138cf5047ca924dbbb35a8de71491e8286555ddd25648d3689ad9d637 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:4`. Role: `parameter`; binding: `diode4.Ron[1]`; effective min: `0`; effective max: `None`. 
