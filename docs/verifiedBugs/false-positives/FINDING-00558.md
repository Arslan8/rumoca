# FINDING-00558: Zero inductance is an explicitly supported algebraic limit
...
| Target | oLine50.L[32].L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-smoothstep-oline50-l-32-l-zerolimit.md](../../v2/bugs/FINDING-smoothstep-oline50-l-32-l-zerolimit.md) — reviewed as `FINDING-00558-smoothstep-oline50-l-32-l.md`, which a later run renamed |
| Original SHA-256 | dea6111c9d34b68d52a7663360d4eaf54e9f19d61090e57948b2c275e8dc0011 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `oLine50.lm[32]`; effective min: `None`; effective max: `None`. 
