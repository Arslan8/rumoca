# FINDING-02909: Polyphase resistance/conductance delegates to signed scalar elements
...
| Target | transformer.r1.R |
| Student classification | physical-domain-unenforced |
| Original report | `FINDING-02909-transformertestbench-transformer-r1-r.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 4710815832c6711ad17fc05cb6694f1b18aa0756e9c54a411493f1c6c64ce53b |
...
Compiler/source-resolved declaration: `Electrical/Polyphase/Basic/Resistor.mo:4`. Role: `parameter`; binding: `fill(transformer.R1, transformer.m)`; effective min: `None`; effective max: `None`. 
