# FINDING-02192: Zero stator leakage inductance is supported
...
| Original report | [FINDING-smee-generator-smee-lszero-zerolimit.md](../../v2/bugs/FINDING-smee-generator-smee-lszero-zerolimit.md) — reviewed as `FINDING-02192-smee-generator-smee-lszero.md`, which a later run renamed |
| Original SHA-256 | 461ab7c9c8a0c03e9a7482e7b07c75cf61fb85c7e27170a3b1ad95c9c6339d74 |
...
Compiler/source-resolved declaration: `Electrical/Machines/Interfaces/PartialBasicInductionMachine.mo:20`. Role: `parameter`; binding: `smee.Lssigma`; effective min: `None`; effective max: `None`. 
