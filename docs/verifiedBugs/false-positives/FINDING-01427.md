# FINDING-01427: Zero armature inductance is an ideal algebraic limit
...
| Original report | [FINDING-dcpm-withlosses-dcpm1-la-zerolimit.md](../../v2/bugs/FINDING-dcpm-withlosses-dcpm1-la-zerolimit.md) — reviewed as `FINDING-01427-dcpm-withlosses-dcpm1-la.md`, which a later run renamed |
| Original SHA-256 | 4a4cb262435739d187dc3f8a6e2b9e5af4983819f731f55ee74aa1f6fc22557e |
...
Compiler/source-resolved declaration: `Electrical/Machines/Interfaces/PartialBasicDCMachine.mo:26`. Role: `parameter`; binding: `dcpmData1.La`; effective min: `None`; effective max: `None`. 
