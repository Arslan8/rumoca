# FINDING-00007: Zero inertia is a massless algebraic component, not an intrinsic division
...
| Original report | [FINDING-exactlyclockedwithdiscretecontroller-load-j-zerolimit.md](../../v2/bugs/FINDING-exactlyclockedwithdiscretecontroller-load-j-zerolimit.md) — reviewed as `FINDING-00007-exactlyclockedwithdiscretecontroller-load-j.md`, which a later run renamed |
| Original SHA-256 | 83577933b180c6512557f751a2ceacfaafb23bdee18fc5a67660ec7ca39d4d7f |
