# FINDING-01696: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | inverter.diode_p.idealDiode[1].Goff |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-imc-inverterdrive-inverter-diode-p-idealdiode-1-goff-zerolimit.md](../../v2/bugs/FINDING-imc-inverterdrive-inverter-diode-p-idealdiode-1-goff-zerolimit.md) — reviewed as `FINDING-01696-imc-inverterdrive-inverter-diode-p-idealdiode-1-goff.md`, which a later run renamed |
| Original SHA-256 | b94223211e273a3aed6c5b9ef9d4c0d6a2fc1d19efe775e4ff8b9f4767ef86f8 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:6`. Role: `parameter`; binding: `inverter.diode_p.Goff[1]`; effective min: `0`; effective max: `None`. 
