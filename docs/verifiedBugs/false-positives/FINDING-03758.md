# FINDING-03758: Zeroing this operand does not zero the complete denominator
...
| Target | airGap.material.n |
| Student classification | divisor-reachable-zero |
| Original report | `FINDING-03758-toroidalcorequadraticcrosssection-airgap-material-n.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 197057ea5b64b4b4a175148a5c16020d18734cd5d686eb72f464a762e0f24847 |
