# FINDING-01706: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | inverter.transistor_n.idealGTOThyristor[2].Goff |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-imc-inverterdrive-inverter-transistor-n-idealgtothyristor-2-goff-zerol.md](../../v2/bugs/FINDING-imc-inverterdrive-inverter-transistor-n-idealgtothyristor-2-goff-zerol.md) — reviewed as `FINDING-01706-imc-inverterdrive-inverter-transistor-n-idealgtothyristor-2-goff.md`, which a later run renamed |
| Original SHA-256 | 4055d4c95f94f2e5edd621902cf36c13827aa2e287fbf90e2be5c3634130e122 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:6`. Role: `parameter`; binding: `inverter.transistor_n.Goff[2]`; effective min: `0`; effective max: `None`. 
