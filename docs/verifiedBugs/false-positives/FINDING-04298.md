# FINDING-04298: Tensor entries are not all strictly positive scalars
...
| Original report | `FINDING-04298-mechanicalstructure-b3-i-21.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 568799b844c49f567ec379b886a018144dfb629d11af7afb74f3a13950f4af62 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/BodyShape.mo:30`. Role: `parameter`; binding: `-0.07`; effective min: `-1.7976931348623157e+308`; effective max: `None`. 
