# FINDING-01159: Machine inertia delegates to the zero-capable algebraic inertia component
...
| Original report | [FINDING-dc-comparecharacteristics-dcee-jr-zerolimit.md](../../v2/bugs/FINDING-dc-comparecharacteristics-dcee-jr-zerolimit.md) — reviewed as `FINDING-01159-dc-comparecharacteristics-dcee-jr.md`, which a later run renamed |
| Original SHA-256 | 060c3f57ee544140ff791f70b4aba021161724b6c7da9af8904fbe77b36c0b6d |
...
Compiler/source-resolved declaration: `Electrical/Machines/Interfaces/PartialBasicMachine.mo:5`. Role: `parameter`; binding: `dceeData.Jr`; effective min: `None`; effective max: `None`. 
