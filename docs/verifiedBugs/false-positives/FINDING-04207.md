# FINDING-04207: Tensor entries are not all strictly positive scalars
...
| Target | body3.body.I_31 |
| Student classification | physical-domain-unenforced |
| Original report | `FINDING-04207-planarfourbar-body3-body-i-31.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | f31cb7ceb0af604a527e077138dcfa783abff9155d0037045a969ee549c44af9 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:25`. Role: `parameter`; binding: `body3.I[3, 1]`; effective min: `-1.7976931348623157e+308`; effective max: `None`. 
