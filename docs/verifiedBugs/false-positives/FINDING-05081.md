# FINDING-05081: Zero inertia is a massless algebraic component, not an intrinsic division
...
| Target | vehicleRollInVar.inertia.J |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-vehicles-vehiclerollinvar-inertia-j-zerolimit.md](../../v2/bugs/FINDING-vehicles-vehiclerollinvar-inertia-j-zerolimit.md) — reviewed as `FINDING-05081-vehicles-vehiclerollinvar-inertia-j.md`, which a later run renamed |
| Original SHA-256 | 32bdd214d85c422ba7c7b74e8b86ce5daec0e17f6e2d965eaf2fa6b0e6e40120 |
