# FINDING-00566: Zero inductance is an explicitly supported algebraic limit
...
| Target | oLine50.L[40].L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-smoothstep-oline50-l-40-l-zerolimit.md](../../v2/bugs/FINDING-smoothstep-oline50-l-40-l-zerolimit.md) — reviewed as `FINDING-00566-smoothstep-oline50-l-40-l.md`, which a later run renamed |
| Original SHA-256 | 4078f75c8a85ef2f6624aecd7bee998d05b0ab35d1980a0245dd024774ffc2d6 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `oLine50.lm[40]`; effective min: `None`; effective max: `None`. 
