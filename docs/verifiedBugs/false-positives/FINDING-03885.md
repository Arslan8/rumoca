# FINDING-03885: Armature example delegates to zero-capable mechanical terms
...
| Original report | [FINDING-translatoryarmatureandstopper-m-zerolimit.md](../../v2/bugs/FINDING-translatoryarmatureandstopper-m-zerolimit.md) — reviewed as `FINDING-03885-translatoryarmatureandstopper-m.md`, which a later run renamed |
| Original SHA-256 | 86b6f221b577629fd68cc58a73568350c5c576ee373dbe46db44cdbe337421e1 |
...
Compiler/source-resolved declaration: `Magnetic/FluxTubes/Examples/Utilities/TranslatoryArmatureAndStopper.mo:7`. Role: `parameter`; binding: `None`; effective min: `0`; effective max: `None`. 
