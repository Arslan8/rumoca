# FINDING-05028: Zero ElastoGap stiffness is handled without division
...
| Original report | [FINDING-allcomponents-elastogap-c-intent.md](../../v2/bugs/FINDING-allcomponents-elastogap-c-intent.md) — reviewed as `FINDING-05028-allcomponents-elastogap-c.md`, which a later run renamed |
| Original SHA-256 | 5ebd38ee0876cd2a15227c0cb4ef1547270c2ba7a5a4ca7eb4aff96aedecf272 |
...
Compiler/source-resolved declaration: `Mechanics/Translational/Components/ElastoGap.mo:4`. Role: `parameter`; binding: `1`; effective min: `0`; effective max: `None`. 
