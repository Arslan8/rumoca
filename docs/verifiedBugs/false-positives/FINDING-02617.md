# FINDING-02617: Zero stator leakage inductance is supported
...
| Original report | [FINDING-smr-inverter-smr-lssigma-intent.md](../../v2/bugs/FINDING-smr-inverter-smr-lssigma-intent.md) — reviewed as `FINDING-02617-smr-inverter-smr-lssigma.md`, which a later run renamed |
| Original SHA-256 | 3c2a0672bf1f5dbcf46346ffc983424d88dd1860f94600a762bee3dcbf6da0d6 |
...
Compiler/source-resolved declaration: `Electrical/Machines/Interfaces/PartialBasicInductionMachine.mo:23`. Role: `parameter`; binding: `smrData.Lssigma`; effective min: `None`; effective max: `None`. 
