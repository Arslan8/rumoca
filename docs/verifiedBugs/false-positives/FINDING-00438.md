# FINDING-00438: A zero-duration ramp is a supported step
...
| Original report | [FINDING-comparelinetrunks-ramp-duration-divunreach.md](../../v2/bugs/FINDING-comparelinetrunks-ramp-duration-divunreach.md) — reviewed as `FINDING-00438-comparelinetrunks-ramp-duration.md`, which a later run renamed |
| Original SHA-256 | 88275664e8554de47817db56168ff172eaf05b5778069830a67c94b7416e6526 |
...
Compiler/source-resolved declaration: `Blocks/Sources.mo:247`. Role: `parameter`; binding: `5e-05`; effective min: `0.0`; effective max: `None`. 
