# FINDING-01236: Zero heat capacity is a no-storage algebraic limit
...
| Original report | [FINDING-dcpm-cooling-armature-c-zerolimit.md](../../v2/bugs/FINDING-dcpm-cooling-armature-c-zerolimit.md) — reviewed as `FINDING-01236-dcpm-cooling-armature-c.md`, which a later run renamed |
| Original SHA-256 | f08387255a6b778d4ddfcb862ef0576a2dfae301c62dccad45b8c6b4d0b156fa |
...
Compiler/source-resolved declaration: `Thermal/HeatTransfer/Components/HeatCapacitor.mo:3`. Role: `parameter`; binding: `Ca`; effective min: `None`; effective max: `None`. 
