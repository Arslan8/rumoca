# FINDING-00541: Zero inductance is an explicitly supported algebraic limit
...
| Target | oLine50.L[15].L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-smoothstep-oline50-l-15-l-zerolimit.md](../../v2/bugs/FINDING-smoothstep-oline50-l-15-l-zerolimit.md) — reviewed as `FINDING-00541-smoothstep-oline50-l-15-l.md`, which a later run renamed |
| Original SHA-256 | 29ebaf7bf1a093bc8e8216e4338c7687a85db4f3043c2a0d3774a8475ae64ba0 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `oLine50.lm[15]`; effective min: `None`; effective max: `None`. 
