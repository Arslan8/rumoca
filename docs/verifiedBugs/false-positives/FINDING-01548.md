# FINDING-01548: Polyphase resistance/conductance delegates to signed scalar elements
...
| Original report | `FINDING-01548-imc-dcbraking-imc-rs-r.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 28f73d266c9755399ff030f228a1352b5a4c500681f90c76841554ebd0eb0261 |
...
Compiler/source-resolved declaration: `Electrical/Polyphase/Basic/Resistor.mo:4`. Role: `parameter`; binding: `fill(imc.Rs, imc.m)`; effective min: `None`; effective max: `None`. 
