# FINDING-02029: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | switchYD.idealOpener.idealOpeningSwitch[2].Goff |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-imc-yd-switchyd-idealopener-idealopeningswitch-2-goff-ruleoff.md](../../v2/bugs/FINDING-imc-yd-switchyd-idealopener-idealopeningswitch-2-goff-ruleoff.md) — reviewed as `FINDING-02029-imc-yd-switchyd-idealopener-idealopeningswitch-2-goff.md`, which a later run renamed |
| Original SHA-256 | 0d5e41a9099bdf6af92a80c90b373a701b0872227d8c0159751aff993fec71b2 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSwitch.mo:6`. Role: `parameter`; binding: `switchYD.idealOpener.Goff[2]`; effective min: `0`; effective max: `None`. 
