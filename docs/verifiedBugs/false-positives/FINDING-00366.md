# FINDING-00366: Zero inductance is an explicitly supported algebraic limit
...
| Original report | [FINDING-comparelinetrunks-oline1-l-1-l-zerolimit.md](../../v2/bugs/FINDING-comparelinetrunks-oline1-l-1-l-zerolimit.md) — reviewed as `FINDING-00366-comparelinetrunks-oline1-l-1-l.md`, which a later run renamed |
| Original SHA-256 | 0c439de27280074f3cf889975ba3e4e4a82a1bc8ea4733e04a34b54dc3ee2034 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `oLine1.lm[1]`; effective min: `None`; effective max: `None`. 
