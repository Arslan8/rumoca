# FINDING-02768: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | diode1.idealDiode[1].Goff |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-rectifier12pulse-diode1-idealdiode-1-goff-zerolimit.md](../../v2/bugs/FINDING-rectifier12pulse-diode1-idealdiode-1-goff-zerolimit.md) — reviewed as `FINDING-02768-rectifier12pulse-diode1-idealdiode-1-goff.md`, which a later run renamed |
| Original SHA-256 | 4e5e6733f3935931e8b152a3c1d7acf9999b698782ad57471f156150c9671ed1 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:6`. Role: `parameter`; binding: `diode1.Goff[1]`; effective min: `0`; effective max: `None`. 
