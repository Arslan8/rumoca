# FINDING-02912: Zero inductance is an explicitly supported algebraic limit
...
| Target | transformer.l1sigma.inductor[2].L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-transformertestbench-transformer-l1sigma-inductor-2-l-zerolimit.md](../../v2/bugs/FINDING-transformertestbench-transformer-l1sigma-inductor-2-l-zerolimit.md) — reviewed as `FINDING-02912-transformertestbench-transformer-l1sigma-inductor-2-l.md`, which a later run renamed |
| Original SHA-256 | 8b88b56d1c786083402e8d81f4606e97c73f4592968cb4b6e2e7c943d62abd96 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `transformer.l1sigma.L[2]`; effective min: `None`; effective max: `None`. 
