# FINDING-01437: Zero armature inductance is an ideal algebraic limit
...
| Original report | [FINDING-dcpm-withlosses-dcpm2-la-zerolimit.md](../../v2/bugs/FINDING-dcpm-withlosses-dcpm2-la-zerolimit.md) — reviewed as `FINDING-01437-dcpm-withlosses-dcpm2-la.md`, which a later run renamed |
| Original SHA-256 | 7d6591cb05d4d6a5234da1dc8fe022bc427d1f7f719ea8d650cb9afb085daea4 |
...
Compiler/source-resolved declaration: `Electrical/Machines/Interfaces/PartialBasicDCMachine.mo:26`. Role: `parameter`; binding: `dcpmData2.La`; effective min: `None`; effective max: `None`. 
