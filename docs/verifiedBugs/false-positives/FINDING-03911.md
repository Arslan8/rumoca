# FINDING-03911: MultiBody Newton/Euler equations use mass and inertia multiplicatively
...
| Target | boxBody2.body.m |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-doublependuluminittip-boxbody2-body-m-zerolimit.md](../../v2/bugs/FINDING-doublependuluminittip-boxbody2-body-m-zerolimit.md) — reviewed as `FINDING-03911-doublependuluminittip-boxbody2-body-m.md`, which a later run renamed |
| Original SHA-256 | e2781b760278061dc8992d4854441ea77daf61451038983e4da93497155c0e97 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:16`. Role: `parameter`; binding: `boxBody2.m`; effective min: `0`; effective max: `None`. 
