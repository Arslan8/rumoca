# FINDING-02793: Polyphase resistance/conductance delegates to signed scalar elements
...
| Target | transformer1.r1.R |
| Student classification | physical-domain-unenforced |
| Original report | `FINDING-02793-rectifier12pulse-transformer1-r1-r.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 7b36b188853b149133e0d35edff0a8e06e43ba95384b3b90d5c3971c50ec2506 |
...
Compiler/source-resolved declaration: `Electrical/Polyphase/Basic/Resistor.mo:4`. Role: `parameter`; binding: `fill(transformer1.R1, transformer1.m)`; effective min: `None`; effective max: `None`. 
