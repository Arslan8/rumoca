# FINDING-00329: Zero trapezoid edge duration is handled by branch reachability
...
| Target | V1.signalSource.rising |
| Student classification | divisor-reachable-zero |
| Original report | [FINDING-heatingpnp-norgate-v1-signalsource-rising-divunresolved.md](../../v2/bugs/FINDING-heatingpnp-norgate-v1-signalsource-rising-divunresolved.md) — reviewed as `FINDING-00329-heatingpnp-norgate-v1-signalsource-rising.md`, which a later run renamed |
| Original SHA-256 | 8e950dd23ecd5696c5a1d0188647776cf148d617c28d215a750ce3770917c4b5 |
...
Compiler/source-resolved declaration: `Blocks/Sources.mo:894`. Role: `parameter`; binding: `5`; effective min: `0`; effective max: `None`. 
