# FINDING-00367: Zero inductance is an explicitly supported algebraic limit
...
| Original report | [FINDING-comparelinetrunks-oline1-l-2-l-zerolimit.md](../../v2/bugs/FINDING-comparelinetrunks-oline1-l-2-l-zerolimit.md) — reviewed as `FINDING-00367-comparelinetrunks-oline1-l-2-l.md`, which a later run renamed |
| Original SHA-256 | 8185fec1cde9ae551a543cdb9d3dbdae3edb745e1c4e851aed851d583a7a38b6 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `oLine1.lm[2]`; effective min: `None`; effective max: `None`. 
