# FINDING-04373: Zero inertia is a massless algebraic component, not an intrinsic division
...
| Original report | [FINDING-backlash-inertia2-j-zerolimit.md](../../v2/bugs/FINDING-backlash-inertia2-j-zerolimit.md) — reviewed as `FINDING-04373-backlash-inertia2-j.md`, which a later run renamed |
| Original SHA-256 | 418d0bdd900a7d38115456edf7f58b07a547f6fff4ec8084764b6b0624bc50a9 |
...
Diagnostic: solve-IR evaluation failed: algebraic projection did not converge at event boundary: worst scaled residual row=31 target=inertia2.a value=2.356194e4 ratio=2.356194e14 norm=2.356194e4 row_scale=1.000000e0 scaled_tolerance=1.000000e-10
