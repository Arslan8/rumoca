# FINDING-02826: Zero inductance is an explicitly supported algebraic limit
...
| Target | transformer2.l1sigma.inductor[2].L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-rectifier12pulse-transformer2-l1sigma-inductor-2-l-zerolimit.md](../../v2/bugs/FINDING-rectifier12pulse-transformer2-l1sigma-inductor-2-l-zerolimit.md) — reviewed as `FINDING-02826-rectifier12pulse-transformer2-l1sigma-inductor-2-l.md`, which a later run renamed |
| Original SHA-256 | 5b4699289e0738eda3485e1e35ee00837a75e947fa0b8d28075e1a074edce975 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `transformer2.l1sigma.L[2]`; effective min: `None`; effective max: `None`. 
