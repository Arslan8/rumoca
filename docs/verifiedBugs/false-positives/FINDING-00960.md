# FINDING-00960: Zero inductance is an explicitly supported algebraic limit
...
| Original report | [FINDING-rectifier-inductor3-l-zerolimit.md](../../v2/bugs/FINDING-rectifier-inductor3-l-zerolimit.md) — reviewed as `FINDING-00960-rectifier-inductor3-l.md`, which a later run renamed |
| Original SHA-256 | c966979d0229dc7d75ebd35152e7a2ed9f475a7acb87afa3cd52c6f13cd7cd42 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `LAC`; effective min: `None`; effective max: `None`. 
