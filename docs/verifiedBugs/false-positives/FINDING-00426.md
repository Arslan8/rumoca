# FINDING-00426: Zero capacitance is an explicitly supported algebraic limit
...
| Original report | [FINDING-comparelinetrunks-oline4-c-2-c-zerolimit.md](../../v2/bugs/FINDING-comparelinetrunks-oline4-c-2-c-zerolimit.md) — reviewed as `FINDING-00426-comparelinetrunks-oline4-c-2-c.md`, which a later run renamed |
| Original SHA-256 | 6a2d2deed919e2584cb685a47ac36f4dd36168255ad8d82d886b4a70fc931edb |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Capacitor.mo:4`. Role: `parameter`; binding: `((oLine4.c * oLine4.length) / oLine4.N)`; effective min: `0`; effective max: `None`. 
