# FINDING-04243: Tensor entries are not all strictly positive scalars
...
| Target | bodyBox.body.I_31 |
| Student classification | physical-domain-unenforced |
| Original report | `FINDING-04243-bevelgear1d-bodybox-body-i-31.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 1148d416ceb421001407c0bb8d90df31f2f8aae3ed605d10452fd7a02fd2e1ac |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:25`. Role: `parameter`; binding: `bodyBox.I[3, 1]`; effective min: `-1.7976931348623157e+308`; effective max: `None`. 
