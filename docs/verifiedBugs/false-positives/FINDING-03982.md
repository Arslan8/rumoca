# FINDING-03982: MultiBody spring mass/stiffness has an intentional zero limit
...
| Original report | [FINDING-heatlosses-spring1-c-intent.md](../../v2/bugs/FINDING-heatlosses-spring1-c-intent.md) — reviewed as `FINDING-03982-heatlosses-spring1-c.md`, which a later run renamed |
| Original SHA-256 | af37af57c522631547608a002afbe1afb4bd4f4112a2420a5ddee0d1791aa406 |
