# FINDING-02018: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | switchYD.idealCloser.idealClosingSwitch[1].Ron |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-imc-yd-switchyd-idealcloser-idealclosingswitch-1-ron-ruleoff.md](../../v2/bugs/FINDING-imc-yd-switchyd-idealcloser-idealclosingswitch-1-ron-ruleoff.md) — reviewed as `FINDING-02018-imc-yd-switchyd-idealcloser-idealclosingswitch-1-ron.md`, which a later run renamed |
| Original SHA-256 | 9ff3eb7b196205e55351f07ae4440458872f494232df54d62bf22911843cc5c4 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSwitch.mo:4`. Role: `parameter`; binding: `switchYD.idealCloser.Ron[1]`; effective min: `0`; effective max: `None`. 
