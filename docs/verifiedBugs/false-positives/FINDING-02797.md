# FINDING-02797: Zero inductance is an explicitly supported algebraic limit
...
| Target | transformer1.l1sigma.inductor[3].L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-rectifier12pulse-transformer1-l1sigma-inductor-3-l-zerolimit.md](../../v2/bugs/FINDING-rectifier12pulse-transformer1-l1sigma-inductor-3-l-zerolimit.md) — reviewed as `FINDING-02797-rectifier12pulse-transformer1-l1sigma-inductor-3-l.md`, which a later run renamed |
| Original SHA-256 | 496e97c10ccb73b5b53363765b2d42f6f9c2c44f68bcb298d558b469050d39ca |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `transformer1.l1sigma.L[3]`; effective min: `None`; effective max: `None`. 
