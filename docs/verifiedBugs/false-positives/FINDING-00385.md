# FINDING-00385: Zero inductance is an explicitly supported algebraic limit
...
| Original report | [FINDING-comparelinetrunks-oline2-l-3-l-zerolimit.md](../../v2/bugs/FINDING-comparelinetrunks-oline2-l-3-l-zerolimit.md) — reviewed as `FINDING-00385-comparelinetrunks-oline2-l-3-l.md`, which a later run renamed |
| Original SHA-256 | ad9e5ab833299a8938ddad93a3865d7a2078d50969a59a3727f620b2cdfe92aa |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `oLine2.lm[3]`; effective min: `None`; effective max: `None`. 
