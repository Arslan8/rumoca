# FINDING-00554: Zero inductance is an explicitly supported algebraic limit
...
| Target | oLine50.L[28].L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-smoothstep-oline50-l-28-l-zerolimit.md](../../v2/bugs/FINDING-smoothstep-oline50-l-28-l-zerolimit.md) — reviewed as `FINDING-00554-smoothstep-oline50-l-28-l.md`, which a later run renamed |
| Original SHA-256 | acf5d75bdff5cadf1fb6ab6b6e08f5fa5ca008d321cd771f68b3bbbfa7b60ed5 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `oLine50.lm[28]`; effective min: `None`; effective max: `None`. 
