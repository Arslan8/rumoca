# FINDING-01718: Zero stator leakage inductance is supported
...
| Original report | [FINDING-imc-inverterdrive-aimc-lszero-zerolimit.md](../../v2/bugs/FINDING-imc-inverterdrive-aimc-lszero-zerolimit.md) — reviewed as `FINDING-01718-imc-inverterdrive-aimc-lszero.md`, which a later run renamed |
| Original SHA-256 | 7287e94be7a719719206b0af66fe3fb75d286f3abaafdf1ed46eca7415351a83 |
...
Compiler/source-resolved declaration: `Electrical/Machines/Interfaces/PartialBasicInductionMachine.mo:20`. Role: `parameter`; binding: `aimcData.Lszero`; effective min: `None`; effective max: `None`. 
