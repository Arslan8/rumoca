# FINDING-00423: Zero inductance is an explicitly supported algebraic limit
...
| Original report | [FINDING-comparelinetrunks-oline4-l-7-l-zerolimit.md](../../v2/bugs/FINDING-comparelinetrunks-oline4-l-7-l-zerolimit.md) — reviewed as `FINDING-00423-comparelinetrunks-oline4-l-7-l.md`, which a later run renamed |
| Original SHA-256 | 16edbcd0ec125f91f862ae4ff582b5c9f10985f98ab6c6afe4ddc320833c430b |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `oLine4.lm[7]`; effective min: `None`; effective max: `None`. 
