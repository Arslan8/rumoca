# FINDING-01552: Machine inertia delegates to the zero-capable algebraic inertia component
...
| Original report | [FINDING-imc-dcbraking-imc-jr-zerolimit.md](../../v2/bugs/FINDING-imc-dcbraking-imc-jr-zerolimit.md) — reviewed as `FINDING-01552-imc-dcbraking-imc-jr.md`, which a later run renamed |
| Original SHA-256 | 473d71e2b20000f77c76f742ad5916184d1f0d0af377ee5d4653d2346acd060a |
...
Compiler/source-resolved declaration: `Electrical/Machines/Interfaces/PartialBasicMachine.mo:5`. Role: `parameter`; binding: `imcData.Jr`; effective min: `None`; effective max: `None`. 
