# FINDING-01162: Zero inertia is a massless algebraic component, not an intrinsic division
...
| Target | dcee.inertiaStator.J |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-dc-comparecharacteristics-dcee-inertiastator-j-zerolimit.md](../../v2/bugs/FINDING-dc-comparecharacteristics-dcee-inertiastator-j-zerolimit.md) — reviewed as `FINDING-01162-dc-comparecharacteristics-dcee-inertiastator-j.md`, which a later run renamed |
| Original SHA-256 | c9b41518d9605b9abb6f0672a9708a6b584dace4fdb7e5494bcefc2bf82a3626 |
...
Compiler/source-resolved declaration: `Mechanics/Rotational/Components/Inertia.mo:4`. Role: `parameter`; binding: `dcee.Js`; effective min: `0`; effective max: `None`. 
