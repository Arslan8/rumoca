# FINDING-04735: Zero trapezoid edge duration is handled by branch reachability
...
| Target | trapezoid.falling |
| Student classification | divisor-reachable-zero |
| Original report | [FINDING-waterpump-trapezoid-falling-divunresolved.md](../../v2/bugs/FINDING-waterpump-trapezoid-falling-divunresolved.md) — reviewed as `FINDING-04735-waterpump-trapezoid-falling.md`, which a later run renamed |
| Original SHA-256 | 67faf0d536bb22c3e02b77bf657533dcdc892e5785295f12b3d4e3b9196af0a2 |
...
Compiler/source-resolved declaration: `Blocks/Sources.mo:898`. Role: `parameter`; binding: `0.6`; effective min: `0`; effective max: `None`. 
