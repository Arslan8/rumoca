# FINDING-01429: Machine inertia delegates to the zero-capable algebraic inertia component
...
| Original report | [FINDING-dcpm-withlosses-dcpm1-jr-zerolimit.md](../../v2/bugs/FINDING-dcpm-withlosses-dcpm1-jr-zerolimit.md) — reviewed as `FINDING-01429-dcpm-withlosses-dcpm1-jr.md`, which a later run renamed |
| Original SHA-256 | e40f2336289b44b84bc850f5fc7d267857d80c3ab62c1d36dab84eabd85ed86e |
...
Compiler/source-resolved declaration: `Electrical/Machines/Interfaces/PartialBasicMachine.mo:5`. Role: `parameter`; binding: `dcpmData1.Jr`; effective min: `None`; effective max: `None`. 
