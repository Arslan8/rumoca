# FINDING-01691: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | inverter.transistor_p.idealGTOThyristor[3].Ron |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-imc-inverterdrive-inverter-transistor-p-idealgtothyristor-3-ron-ruleof.md](../../v2/bugs/FINDING-imc-inverterdrive-inverter-transistor-p-idealgtothyristor-3-ron-ruleof.md) — reviewed as `FINDING-01691-imc-inverterdrive-inverter-transistor-p-idealgtothyristor-3-ron.md`, which a later run renamed |
| Original SHA-256 | b49a0feb43ebd08fc341eafb3e784ddaed9315d787aef36f1599548733cbbe8e |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:4`. Role: `parameter`; binding: `inverter.transistor_p.Ron[3]`; effective min: `0`; effective max: `None`. 
