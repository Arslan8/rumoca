# FINDING-00561: Zero inductance is an explicitly supported algebraic limit
...
| Target | oLine50.L[35].L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-smoothstep-oline50-l-35-l-zerolimit.md](../../v2/bugs/FINDING-smoothstep-oline50-l-35-l-zerolimit.md) — reviewed as `FINDING-00561-smoothstep-oline50-l-35-l.md`, which a later run renamed |
| Original SHA-256 | 5e9b70716cede6284add5a96b694dfa04d6abadf1037dd8eed2d83a223f0f08a |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `oLine50.lm[35]`; effective min: `None`; effective max: `None`. 
