# FINDING-00530: Zero inductance is an explicitly supported algebraic limit
...
| Target | oLine50.L[4].L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-smoothstep-oline50-l-4-l-zerolimit.md](../../v2/bugs/FINDING-smoothstep-oline50-l-4-l-zerolimit.md) — reviewed as `FINDING-00530-smoothstep-oline50-l-4-l.md`, which a later run renamed |
| Original SHA-256 | bdcd7c73d9e041e80d8cc37a5ec386f5599c9ab24d193b5a5c229386a5ff6139 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `oLine50.lm[4]`; effective min: `None`; effective max: `None`. 
