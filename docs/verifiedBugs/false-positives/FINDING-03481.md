# FINDING-03481: Zero on-resistance/off-conductance is an intended ideal limit
...
| Original report | [FINDING-thyristorcentertapmpulse-rlv-characteristic-rectifier-thyristor-idealt-2.md](../../v2/bugs/FINDING-thyristorcentertapmpulse-rlv-characteristic-rectifier-thyristor-idealt-2.md) — reviewed as `FINDING-03481-thyristorcentertapmpulse-rlv-characteristic-rectifier-thyristor-idealt.md`, which a later run renamed |
| Original SHA-256 | 3a8fbb9549440315014e995ad7cfbc19787425226a86006e59e3e691a1b97fb0 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:6`. Role: `parameter`; binding: `rectifier.thyristor.Goff[1]`; effective min: `0`; effective max: `None`. 
