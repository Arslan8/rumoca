# FINDING-02806: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | diode3.idealDiode[1].Goff |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-rectifier12pulse-diode3-idealdiode-1-goff-zerolimit.md](../../v2/bugs/FINDING-rectifier12pulse-diode3-idealdiode-1-goff-zerolimit.md) — reviewed as `FINDING-02806-rectifier12pulse-diode3-idealdiode-1-goff.md`, which a later run renamed |
| Original SHA-256 | 230c5286563a7bd89be0d70a21bf7e0c9d3c30f7eb68b48a50f5730839e3ac9b |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:6`. Role: `parameter`; binding: `diode3.Goff[1]`; effective min: `0`; effective max: `None`. 
