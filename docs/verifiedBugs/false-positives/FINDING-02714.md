# FINDING-02714: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | idealCloser.idealClosingSwitch[3].Ron |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-imc-transformer-idealcloser-idealclosingswitch-3-ron-ruleoff-2.md](../../v2/bugs/FINDING-imc-transformer-idealcloser-idealclosingswitch-3-ron-ruleoff-2.md) — reviewed as `FINDING-02714-imc-transformer-idealcloser-idealclosingswitch-3-ron.md`, which a later run renamed |
| Original SHA-256 | b255bb89608e6262dc7efd7a7293bd367a24e9f685d5e46e6ffabd39a6e67a8e |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSwitch.mo:4`. Role: `parameter`; binding: `idealCloser.Ron[3]`; effective min: `0`; effective max: `None`. 
