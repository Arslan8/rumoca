# FINDING-04217: MultiBody Newton/Euler equations use mass and inertia multiplicatively
...
| Target | body4.body.I_22 |
| Student classification | physical-bound-permits-zero |
| Original report | `FINDING-04217-planarfourbar-body4-body-i-22.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 61b0a650a8f8c23016d78c149084bbabdbde6db533798310a65b0aa09ff874a4 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:19`. Role: `parameter`; binding: `body4.I[2, 2]`; effective min: `0`; effective max: `None`. 
