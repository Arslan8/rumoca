# FINDING-03904: Tensor entries are not all strictly positive scalars
...
| Target | boxBody1.body.I_32 |
| Student classification | physical-domain-unenforced |
| Original report | `FINDING-03904-doublependuluminittip-boxbody1-body-i-32.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 38694c936a30f543bc4297e58e2b65b238fd86e5150358d9c8ff12ebe65c6b00 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:27`. Role: `parameter`; binding: `boxBody1.I[3, 2]`; effective min: `-1.7976931348623157e+308`; effective max: `None`. 
