# FINDING-01658: Polyphase inductance delegates to zero-capable scalar inductors
...
| Original report | [FINDING-imc-inverterdrive-inductor-l-zerolimit.md](../../v2/bugs/FINDING-imc-inverterdrive-inductor-l-zerolimit.md) — reviewed as `FINDING-01658-imc-inverterdrive-inductor-l.md`, which a later run renamed |
| Original SHA-256 | ac74ac5193e35bc3a3230d85e9007c89930d253a459fafd55704e4fa2d8cc984 |
...
Compiler/source-resolved declaration: `Electrical/Polyphase/Basic/Inductor.mo:4`. Role: `parameter`; binding: `fill(LGrid, m)`; effective min: `None`; effective max: `None`. 
