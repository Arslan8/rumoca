# FINDING-02810: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | diode3.idealDiode[3].Goff |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-rectifier12pulse-diode3-idealdiode-3-goff-zerolimit.md](../../v2/bugs/FINDING-rectifier12pulse-diode3-idealdiode-3-goff-zerolimit.md) — reviewed as `FINDING-02810-rectifier12pulse-diode3-idealdiode-3-goff.md`, which a later run renamed |
| Original SHA-256 | a6b0259b3e78a70994fd8a4e52053fe233d263de909c5aae5cc72c10b550e443 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:6`. Role: `parameter`; binding: `diode3.Goff[3]`; effective min: `0`; effective max: `None`. 
