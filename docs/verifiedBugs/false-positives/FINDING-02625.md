# FINDING-02625: Zero inertia is a massless algebraic component, not an intrinsic division
...
| Target | smr.inertiaStator.J |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-smr-inverter-smr-inertiastator-j-zerolimit.md](../../v2/bugs/FINDING-smr-inverter-smr-inertiastator-j-zerolimit.md) — reviewed as `FINDING-02625-smr-inverter-smr-inertiastator-j.md`, which a later run renamed |
| Original SHA-256 | 0a7807c3962bcd15451c472d354d13090d5b39cf7467033252f2564534e3fb78 |
...
Compiler/source-resolved declaration: `Mechanics/Rotational/Components/Inertia.mo:4`. Role: `parameter`; binding: `smr.Js`; effective min: `0`; effective max: `None`. 
