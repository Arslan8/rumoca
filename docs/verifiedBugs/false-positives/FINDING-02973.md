# FINDING-02973: Polyphase resistance/conductance delegates to signed scalar elements
...
| Target | transformerR.R |
| Student classification | physical-domain-unenforced |
| Original report | `FINDING-02973-transformeryd-transformerr-r.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | ebb3213ef4227d1b54e0ff5882c0c3f1b2862e4db82e2a8654c613ed8237e635 |
...
Compiler/source-resolved declaration: `Electrical/Polyphase/Basic/Resistor.mo:4`. Role: `parameter`; binding: `fill((RT / (nT ^ 2)), m)`; effective min: `None`; effective max: `None`. 
