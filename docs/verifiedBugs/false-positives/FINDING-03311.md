# FINDING-03311: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | rectifier.diode_p.Ron |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-diodecentertap2mpulse-rectifier-diode-p-ron-ruleoff.md](../../v2/bugs/FINDING-diodecentertap2mpulse-rectifier-diode-p-ron-ruleoff.md) — reviewed as `FINDING-03311-diodecentertap2mpulse-rectifier-diode-p-ron.md`, which a later run renamed |
| Original SHA-256 | f612db4acea886f558a903f71a98cd59974ac02669c044188d2649d98ea2d920 |
...
Compiler/source-resolved declaration: `Electrical/Polyphase/Ideal/IdealDiode.mo:4`. Role: `parameter`; binding: `fill(rectifier.RonDiode, rectifier.m)`; effective min: `zeros(3)`; effective max: `None`. 
