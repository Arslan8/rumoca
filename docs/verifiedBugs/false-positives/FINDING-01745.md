# FINDING-01745: A zero-duration ramp is a supported step
...
| Original report | [FINDING-imc-inverterdrive-ramp-duration-divunreach.md](../../v2/bugs/FINDING-imc-inverterdrive-ramp-duration-divunreach.md) — reviewed as `FINDING-01745-imc-inverterdrive-ramp-duration.md`, which a later run renamed |
| Original SHA-256 | f213646a9506df11feceebb6723e77a374e6433a0bc09f838c1955fe817fe381 |
...
Compiler/source-resolved declaration: `Blocks/Sources.mo:247`. Role: `parameter`; binding: `1.2`; effective min: `0.0`; effective max: `None`. 
