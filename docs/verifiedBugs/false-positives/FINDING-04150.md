# FINDING-04150: Zero stiffness is a force-free spring limit
...
| Target | spring1.spring.c |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-threesprings-spring1-spring-c-zerolimit.md](../../v2/bugs/FINDING-threesprings-spring1-spring-c-zerolimit.md) — reviewed as `FINDING-04150-threesprings-spring1-spring-c.md`, which a later run renamed |
| Original SHA-256 | 05c233526e537c9d3828d145fc0e5e33497c42f8cfe4fb2f856d6f90d799aea9 |
...
Compiler/source-resolved declaration: `Mechanics/Translational/Components/Spring.mo:4`. Role: `parameter`; binding: `20`; effective min: `0`; effective max: `None`. 
