# FINDING-02643: Zero leakage inductance is a supported ideal limit
...
| Target | smrData.Lszero |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-smr-inverter-smrdata-lszero-intent.md](../../v2/bugs/FINDING-smr-inverter-smrdata-lszero-intent.md) — reviewed as `FINDING-02643-smr-inverter-smrdata-lszero.md`, which a later run renamed |
| Original SHA-256 | 282616b6b8d93e50f23b8d60dbbc493aa270b88492e2c6763c6f8fe810401b79 |
...
Compiler/source-resolved declaration: `Electrical/Machines/Utilities/ParameterRecords/InductionMachineData.mo:20`. Role: `parameter`; binding: `smrData.Lssigma`; effective min: `None`; effective max: `None`. 
