# FINDING-01027: Zero trapezoid edge duration is handled by branch reachability
...
| Target | trapezoidCurrent.signalSource.falling |
| Student classification | divisor-reachable-zero |
| Original report | [FINDING-simpletriaccircuit-trapezoidcurrent-signalsource-falling-divunresolved.md](../../v2/bugs/FINDING-simpletriaccircuit-trapezoidcurrent-signalsource-falling-divunresolved.md) — reviewed as `FINDING-01027-simpletriaccircuit-trapezoidcurrent-signalsource-falling.md`, which a later run renamed |
| Original SHA-256 | a73febe818166ba7cf0b2f8cb8c40d5127c01c7d4d6b93b3ac4ad4f62d5e54b8 |
...
Compiler/source-resolved declaration: `Blocks/Sources.mo:898`. Role: `parameter`; binding: `1e-06`; effective min: `0`; effective max: `None`. 
