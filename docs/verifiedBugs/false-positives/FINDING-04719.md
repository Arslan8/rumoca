# FINDING-04719: Zero stored fluid mass is explicitly supported
...
| Target | volumeFlowSensor.m |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-waterpump-volumeflowsensor-m-zerolimit.md](../../v2/bugs/FINDING-waterpump-volumeflowsensor-m-zerolimit.md) — reviewed as `FINDING-04719-waterpump-volumeflowsensor-m.md`, which a later run renamed |
| Original SHA-256 | 96e7327d594fd37dacc3ceb763ee8863199e2493b1113c08c14e123a574f8202 |
...
| Probe | Outcome |
|---|---|
| `volumeFlowSensor.m=0` | reported-failure |

Diagnostic: `volumeFlowSensor.m` is structural or constant; change it by recompiling
