# FINDING-04218: MultiBody Newton/Euler equations use mass and inertia multiplicatively
...
| Target | body4.body.I_33 |
| Student classification | physical-bound-permits-zero |
| Original report | `FINDING-04218-planarfourbar-body4-body-i-33.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | b569cef8e1ca6aed7805be92dfc9f308f7c32ee9e66f7df3d4ba3bc9fc45f87a |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:21`. Role: `parameter`; binding: `body4.I[3, 3]`; effective min: `0`; effective max: `None`. 
