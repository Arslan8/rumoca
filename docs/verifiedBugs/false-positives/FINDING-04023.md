# FINDING-04023: Tensor entries are not all strictly positive scalars
...
| Target | body.body.I_32 |
| Student classification | physical-domain-unenforced |
| Original report | `FINDING-04023-initspringconstant-body-body-i-32.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 7c4595b1892b9a2dee7d890b16dda9b4ad28e8d9a98b98d6069b3f16ee9779b4 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:27`. Role: `parameter`; binding: `body.I_32`; effective min: `-1.7976931348623157e+308`; effective max: `None`. 
