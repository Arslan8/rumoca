# FINDING-00424: Zero inductance is an explicitly supported algebraic limit
...
| Original report | [FINDING-comparelinetrunks-oline4-l-8-l-zerolimit.md](../../v2/bugs/FINDING-comparelinetrunks-oline4-l-8-l-zerolimit.md) — reviewed as `FINDING-00424-comparelinetrunks-oline4-l-8-l.md`, which a later run renamed |
| Original SHA-256 | a60ec82bb208691fa3fa6c72f54f3ec073658dd9df30bb1736c32b98277c2145 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `oLine4.lm[8]`; effective min: `None`; effective max: `None`. 
