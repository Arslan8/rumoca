# FINDING-04520: Zero stored fluid mass is explicitly supported
...
| Original report | [FINDING-indirectcooling-innerpipe-m-zerolimit.md](../../v2/bugs/FINDING-indirectcooling-innerpipe-m-zerolimit.md) — reviewed as `FINDING-04520-indirectcooling-innerpipe-m.md`, which a later run renamed |
| Original SHA-256 | 3869b3745106751d7fd925a8f6ff886f54eebdd97b20008b31fa2650991c023b |
...
| Probe | Outcome |
|---|---|
| `innerPipe.m=0` | reported-failure |

Diagnostic: solve-IR evaluation failed: non-finite derivative evaluation for state 'dTCooler'
