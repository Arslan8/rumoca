# FINDING-05061: Zero mass is a massless algebraic component, not an intrinsic division
...
| Target | vehicleDragInConst.mass.m |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-vehicles-vehicledraginconst-mass-m-zerolimit.md](../../v2/bugs/FINDING-vehicles-vehicledraginconst-mass-m-zerolimit.md) — reviewed as `FINDING-05061-vehicles-vehicledraginconst-mass-m.md`, which a later run renamed |
| Original SHA-256 | 8eacfd5643a43ed48147408fc973917baf9004897ab03f80dd4ec951ccc82204 |
