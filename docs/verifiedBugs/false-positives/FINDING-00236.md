# FINDING-00236: A zero-duration ramp is a supported step
...
| Target | I1.signalSource.duration |
| Student classification | divisor-reachable-zero |
| Original report | [FINDING-differenceamplifier-i1-signalsource-duration-divunreach.md](../../v2/bugs/FINDING-differenceamplifier-i1-signalsource-duration-divunreach.md) — reviewed as `FINDING-00236-differenceamplifier-i1-signalsource-duration.md`, which a later run renamed |
| Original SHA-256 | c33c93d19818238789835eb662a6fa61f7423924bb8c693e5d769d1213c6b722 |
...
Compiler/source-resolved declaration: `Blocks/Sources.mo:247`. Role: `parameter`; binding: `1e-09`; effective min: `0.0`; effective max: `None`. 
