# FINDING-02482: Polyphase resistance/conductance delegates to signed scalar elements
...
| Original report | `FINDING-02482-smpm-resistivebraking-resistor1-r.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | e4928a025d965ab0b42860dbd909ed3febc072e0c53f332685c3ef39d34a6c18 |
...
Compiler/source-resolved declaration: `Electrical/Polyphase/Basic/Resistor.mo:4`. Role: `parameter`; binding: `(k[1] * fill(smpmData.Rs, m))`; effective min: `None`; effective max: `None`. 
