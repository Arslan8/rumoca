# FINDING-01550: Zero inductance is an explicitly supported algebraic limit
...
| Original report | [FINDING-imc-dcbraking-imc-lszero-l-zerolimit.md](../../v2/bugs/FINDING-imc-dcbraking-imc-lszero-l-zerolimit.md) — reviewed as `FINDING-01550-imc-dcbraking-imc-lszero-l.md`, which a later run renamed |
| Original SHA-256 | 9e1acff4822029279df43294a2310fa5b6a43b0a0e3461d0dbc78abc663a402b |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `imc.Lszero`; effective min: `None`; effective max: `None`. 
