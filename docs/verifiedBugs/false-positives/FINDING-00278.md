# FINDING-00278: A zero-duration ramp is a supported step
...
| Original report | [FINDING-heatingmosinverter-v-signalsource-duration-divunreach.md](../../v2/bugs/FINDING-heatingmosinverter-v-signalsource-duration-divunreach.md) — reviewed as `FINDING-00278-heatingmosinverter-v-signalsource-duration.md`, which a later run renamed |
| Original SHA-256 | f429cb2cefb6b16727d67529d86cb42728daabbc14b8bc4fbd4a3438ace90c3c |
...
Compiler/source-resolved declaration: `Blocks/Sources.mo:247`. Role: `parameter`; binding: `0.01`; effective min: `0.0`; effective max: `None`. 
