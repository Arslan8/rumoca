# FINDING-02031: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | switchYD.idealOpener.idealOpeningSwitch[3].Goff |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-imc-yd-switchyd-idealopener-idealopeningswitch-3-goff-ruleoff.md](../../v2/bugs/FINDING-imc-yd-switchyd-idealopener-idealopeningswitch-3-goff-ruleoff.md) — reviewed as `FINDING-02031-imc-yd-switchyd-idealopener-idealopeningswitch-3-goff.md`, which a later run renamed |
| Original SHA-256 | c961a7fbb630deb1c580a77a8f7ec2dc575c6e1d80cd2d5dc80268d5f585a9d6 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSwitch.mo:6`. Role: `parameter`; binding: `switchYD.idealOpener.Goff[3]`; effective min: `0`; effective max: `None`. 
