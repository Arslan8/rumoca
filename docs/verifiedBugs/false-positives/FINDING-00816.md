# FINDING-00816: Zero capacitance is an explicitly supported algebraic limit
...
| Original report | [FINDING-differentiator-der-c-c-zerolimit.md](../../v2/bugs/FINDING-differentiator-der-c-c-zerolimit.md) — reviewed as `FINDING-00816-differentiator-der-c-c.md`, which a later run renamed |
| Original SHA-256 | 8062a37f3ae518719d7d19660409ae27ea66eb627ea4841156228749ab2469a7 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Capacitor.mo:4`. Role: `parameter`; binding: `der_.C`; effective min: `0`; effective max: `None`. 
