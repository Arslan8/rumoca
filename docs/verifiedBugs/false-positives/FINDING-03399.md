# FINDING-03399: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | rectifier.thyristor_p.idealThyristor[3].Ron |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-thyristorcentertap2mpulse-r-rectifier-thyristor-p-idealthyristor-3-ron.md](../../v2/bugs/FINDING-thyristorcentertap2mpulse-r-rectifier-thyristor-p-idealthyristor-3-ron.md) — reviewed as `FINDING-03399-thyristorcentertap2mpulse-r-rectifier-thyristor-p-idealthyristor-3-ron.md`, which a later run renamed |
| Original SHA-256 | 76f22e4ac0e13819cd9583638f1371d3396a51a7f9a4b2e4b3c725ab47e24ca3 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:4`. Role: `parameter`; binding: `rectifier.thyristor_p.Ron[3]`; effective min: `0`; effective max: `None`. 
