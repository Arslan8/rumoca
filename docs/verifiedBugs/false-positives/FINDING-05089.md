# FINDING-05089: Vehicle parameter has a multiplicative zero limit
...
| Target | vehicleInclinationInConst.J |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-vehicles-vehicleinclinationinconst-j-intent.md](../../v2/bugs/FINDING-vehicles-vehicleinclinationinconst-j-intent.md) — reviewed as `FINDING-05089-vehicles-vehicleinclinationinconst-j.md`, which a later run renamed |
| Original SHA-256 | 690ef78052fa37f5cf333831a81052f6c8b98a02fe0660a7eda5b282c93d4f22 |
...
Compiler/source-resolved declaration: `Mechanics/Translational/Components/Vehicle.mo:5`. Role: `parameter`; binding: `2.3`; effective min: `None`; effective max: `None`. 
