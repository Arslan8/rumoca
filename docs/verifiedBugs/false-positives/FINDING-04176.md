# FINDING-04176: MultiBody Newton/Euler equations use mass and inertia multiplicatively
...
| Original report | [FINDING-planarfourbar-body1-body-m-zerolimit.md](../../v2/bugs/FINDING-planarfourbar-body1-body-m-zerolimit.md) — reviewed as `FINDING-04176-planarfourbar-body1-body-m.md`, which a later run renamed |
| Original SHA-256 | 0c925695e5e4c55aaf0dcc3cd8129517789ad103b5575260c9c486790fa53035 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:16`. Role: `parameter`; binding: `body1.m`; effective min: `0`; effective max: `None`. 
