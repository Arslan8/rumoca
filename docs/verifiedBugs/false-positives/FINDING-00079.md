# FINDING-00079: Zero capacitance is an explicitly supported algebraic limit
...
| Target | R4.Capacitor.C |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-cauerlowpasssc-r4-capacitor-c-zerolimit.md](../../v2/bugs/FINDING-cauerlowpasssc-r4-capacitor-c-zerolimit.md) — reviewed as `FINDING-00079-cauerlowpasssc-r4-capacitor-c.md`, which a later run renamed |
| Original SHA-256 | d3aaaa9ffee6b271f5b90db7007a75c9f228ad28a2737504195ffc6e2f79cb9c |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Capacitor.mo:4`. Role: `parameter`; binding: `(R4.clock / max((2.220446049250313e-16 * R4.oneOhm), abs(R4.R)))`; effective min: `0`; effective max: `None`. 
