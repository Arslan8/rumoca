# FINDING-00358: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | idealTriac.idealThyristor1.Goff |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-idealtriaccircuit-idealtriac-idealthyristor1-goff-zerolimit.md](../../v2/bugs/FINDING-idealtriaccircuit-idealtriac-idealthyristor1-goff-zerolimit.md) — reviewed as `FINDING-00358-idealtriaccircuit-idealtriac-idealthyristor1-goff.md`, which a later run renamed |
| Original SHA-256 | ebe3122e31d0a0621954aedadf7ca9b1fa2d2df800b7acfbfdb5da49a71eae9b |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:6`. Role: `parameter`; binding: `idealTriac.Goff`; effective min: `0`; effective max: `None`. 
