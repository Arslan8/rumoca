# FINDING-00177: Zero on-resistance/off-conductance is an intended ideal limit
...
| Original report | [FINDING-characteristicidealdiodes-ideal-goff-zerolimit.md](../../v2/bugs/FINDING-characteristicidealdiodes-ideal-goff-zerolimit.md) — reviewed as `FINDING-00177-characteristicidealdiodes-ideal-goff.md`, which a later run renamed |
| Original SHA-256 | b5e942e5a606a450f78bdc280c568394feb7760f7e909f80ccf733aa1ea4d08a |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:6`. Role: `parameter`; binding: `0`; effective min: `0`; effective max: `None`. 
