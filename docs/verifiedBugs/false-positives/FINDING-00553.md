# FINDING-00553: Zero inductance is an explicitly supported algebraic limit
...
| Original report | [FINDING-smoothstep-oline50-l-27-l-zerolimit.md](../../v2/bugs/FINDING-smoothstep-oline50-l-27-l-zerolimit.md) — reviewed as `FINDING-00553-smoothstep-oline50-l-27-l.md`, which a later run renamed |
| Original SHA-256 | ab1f1f39ca475c27caee4c245e086491c729bb6f2fdc4bcbe5ad8b9417101220 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `oLine50.lm[27]`; effective min: `None`; effective max: `None`. 
