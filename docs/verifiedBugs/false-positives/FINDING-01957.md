# FINDING-01957: Arc-switch resistance/conductance are multiplicative ideal limits
...
| Target | switchYDwithArc.idealOpener.openerWithArc[1].Ron |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-imc-ydarc-switchydwitharc-idealopener-openerwitharc-1-ron-zerolimit.md](../../v2/bugs/FINDING-imc-ydarc-switchydwitharc-idealopener-openerwitharc-1-ron-zerolimit.md) — reviewed as `FINDING-01957-imc-ydarc-switchydwitharc-idealopener-openerwitharc-1-ron.md`, which a later run renamed |
| Original SHA-256 | 70510ab52de093c0857602cfbca088b1477e34e5a2294ec63ba79d7900807ba8 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSwitchWithArc.mo:4`. Role: `parameter`; binding: `switchYDwithArc.idealOpener.Ron[1]`; effective min: `None`; effective max: `None`. 
