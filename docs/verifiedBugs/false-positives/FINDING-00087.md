# FINDING-00087: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | R5.IdealCommutingSwitch1.Goff |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-cauerlowpasssc-r5-idealcommutingswitch1-goff-ruleoff.md](../../v2/bugs/FINDING-cauerlowpasssc-r5-idealcommutingswitch1-goff-ruleoff.md) — reviewed as `FINDING-00087-cauerlowpasssc-r5-idealcommutingswitch1-goff.md`, which a later run renamed |
| Original SHA-256 | 3b14cfeffd3a0ff2882ad54bd486b8a1cfb22363364f7136e9e8bd755b7beb77 |
