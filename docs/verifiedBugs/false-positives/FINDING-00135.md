# FINDING-00135: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | R7.IdealCommutingSwitch2.Ron |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-cauerlowpasssc-r7-idealcommutingswitch2-ron-ruleoff.md](../../v2/bugs/FINDING-cauerlowpasssc-r7-idealcommutingswitch2-ron-ruleoff.md) — reviewed as `FINDING-00135-cauerlowpasssc-r7-idealcommutingswitch2-ron.md`, which a later run renamed |
| Original SHA-256 | fa133e670f36c49f4e41aec7b73cb08df24187ca0a6725f819ab4eee12437e8e |
