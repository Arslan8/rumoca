# FINDING-04749: The friction denominator is protected by an ordering assertion
...
| Original report | [FINDING-waterpump-pipe-v-flownominal-divzero.md](../../v2/bugs/FINDING-waterpump-pipe-v-flownominal-divzero.md) — reviewed as `FINDING-04749-waterpump-pipe-v-flownominal.md`, which a later run renamed |
| Original SHA-256 | 54b0d6d3a293944910d96517d638d9048c572f45637b1123c7170a89456b5bf8 |
...
Compiler/source-resolved declaration: `Thermal/FluidHeatFlow/BaseClasses/SimpleFriction.mo:9`. Role: `parameter`; binding: `0.18`; effective min: `None`; effective max: `None`. 
...
| Probe | Outcome |
|---|---|
| `pipe.V_flowNominal=0` | reported-failure |
