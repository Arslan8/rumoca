# FINDING-01557: Air-gap inductance is used as a flux multiplier
...
| Original report | [FINDING-imc-dcbraking-imc-airgap-l-zerolimit.md](../../v2/bugs/FINDING-imc-dcbraking-imc-airgap-l-zerolimit.md) — reviewed as `FINDING-01557-imc-dcbraking-imc-airgap-l.md`, which a later run renamed |
| Original SHA-256 | b36cd39f07b51cb0c4c17d17e3c04c02c7e12b0e666a88f6da1e827f68ba3319 |
...
Compiler/source-resolved declaration: `Electrical/Machines/BasicMachines/Components/AirGapS.mo:8`. Role: `parameter`; binding: `{{imc.airGap.Lm, 0}, {0, imc.airGap.Lm}}`; effective min: `None`; effective max: `None`. 
