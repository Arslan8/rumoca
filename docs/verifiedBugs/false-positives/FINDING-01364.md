# FINDING-01364: AirGapDC uses excitation inductance only as a multiplier
...
| Target | dcpm2.airGapDC.Le |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-dcpm-quasistatic-dcpm2-airgapdc-le-zerolimit.md](../../v2/bugs/FINDING-dcpm-quasistatic-dcpm2-airgapdc-le-zerolimit.md) — reviewed as `FINDING-01364-dcpm-quasistatic-dcpm2-airgapdc-le.md`, which a later run renamed |
| Original SHA-256 | 5d33d7870f1d0e59af995623cade70f28c2b8f3dee3c40577bd5c8b9bdaa5933 |
...
Compiler/source-resolved declaration: `Electrical/Machines/BasicMachines/Components/AirGapDC.mo:4`. Role: `parameter`; binding: `dcpm2.Lme`; effective min: `None`; effective max: `None`. 
