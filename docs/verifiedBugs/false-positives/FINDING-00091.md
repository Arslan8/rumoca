# FINDING-00091: Zero capacitance is an explicitly supported algebraic limit
...
| Target | R8.Capacitor.C |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-cauerlowpasssc-r8-capacitor-c-zerolimit.md](../../v2/bugs/FINDING-cauerlowpasssc-r8-capacitor-c-zerolimit.md) — reviewed as `FINDING-00091-cauerlowpasssc-r8-capacitor-c.md`, which a later run renamed |
| Original SHA-256 | def43998567b7ed3162611fcde44d8e3c8c8923556a8a9361d09dfadf2592d5c |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Capacitor.mo:4`. Role: `parameter`; binding: `(R8.clock / max((2.220446049250313e-16 * R8.oneOhm), abs(R8.R)))`; effective min: `0`; effective max: `None`. 
