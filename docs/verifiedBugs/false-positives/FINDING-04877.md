# FINDING-04877: Zero inertia is a massless algebraic component, not an intrinsic division
...
| Target | inertiaLoad.J |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-smpm-voltagesourcewithlosses-inertiaload-j-zerolimit.md](../../v2/bugs/FINDING-smpm-voltagesourcewithlosses-inertiaload-j-zerolimit.md) — reviewed as `FINDING-04877-smpm-voltagesourcewithlosses-inertiaload-j.md`, which a later run renamed |
| Original SHA-256 | 6ba3c569abaceb80572405b9dd7fadcd11aeb219e39ca46a6f302701d6088b88 |
...
Compiler/source-resolved declaration: `Mechanics/Rotational/Components/Inertia.mo:4`. Role: `parameter`; binding: `JLoad`; effective min: `0`; effective max: `None`. 
