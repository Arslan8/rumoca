# FINDING-04516: Zero stored fluid mass is explicitly supported
...
| Original report | [FINDING-indirectcooling-outerpipe-m-zerolimit.md](../../v2/bugs/FINDING-indirectcooling-outerpipe-m-zerolimit.md) — reviewed as `FINDING-04516-indirectcooling-outerpipe-m.md`, which a later run renamed |
| Original SHA-256 | ec8ca4e4ecad2c6bf2d7f1093eaab83159dfb5e2865359d7c40d6dbd363e56cf |
...
| Probe | Outcome |
|---|---|
| `outerPipe.m=0` | reported-failure |

Diagnostic: solve-IR evaluation failed: non-finite derivative evaluation for state 'dTinnerCoolant'
