# FINDING-04122: Zero stiffness is a force-free spring limit
...
| Target | spring.spring.c |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-pointgravitywithpointmasses-spring-spring-c-zerolimit.md](../../v2/bugs/FINDING-pointgravitywithpointmasses-spring-spring-c-zerolimit.md) — reviewed as `FINDING-04122-pointgravitywithpointmasses-spring-spring-c.md`, which a later run renamed |
| Original SHA-256 | 79309d77eca62808c177044987795823f56b649a7e08c8478e68c1bab9d39437 |
...
Compiler/source-resolved declaration: `Mechanics/Translational/Components/Spring.mo:4`. Role: `parameter`; binding: `10`; effective min: `0`; effective max: `None`. 
