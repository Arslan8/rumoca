# FINDING-04025: MultiBody spring mass/stiffness has an intentional zero limit
...
| Original report | [FINDING-initspringconstant-spring-c-zerolimit.md](../../v2/bugs/FINDING-initspringconstant-spring-c-zerolimit.md) — reviewed as `FINDING-04025-initspringconstant-spring-c.md`, which a later run renamed |
| Original SHA-256 | ebc10b5cba80a2847db092055cd7fc62d494dc92bd3ed26dc2ca0f2a6f7535cf |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Forces/Spring.mo:9`. Role: `parameter`; binding: `None`; effective min: `0`; effective max: `None`. 
