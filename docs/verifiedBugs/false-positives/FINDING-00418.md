# FINDING-00418: Zero inductance is an explicitly supported algebraic limit
...
| Original report | [FINDING-comparelinetrunks-oline4-l-2-l-zerolimit.md](../../v2/bugs/FINDING-comparelinetrunks-oline4-l-2-l-zerolimit.md) — reviewed as `FINDING-00418-comparelinetrunks-oline4-l-2-l.md`, which a later run renamed |
| Original SHA-256 | d339d55caedfb2f676a5dfb331e87484de396a9f2e0f5e1ab3633445623a94cb |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `oLine4.lm[2]`; effective min: `None`; effective max: `None`. 
