# FINDING-04860: Zero space-phasor inductance is an algebraic ideal limit
...
| Target | smpm.lssigma.L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-smpm-voltagesourcewithlosses-smpm-lssigma-l-intent.md](../../v2/bugs/FINDING-smpm-voltagesourcewithlosses-smpm-lssigma-l-intent.md) — reviewed as `FINDING-04860-smpm-voltagesourcewithlosses-smpm-lssigma-l.md`, which a later run renamed |
| Original SHA-256 | 3cea3184c58a181c644e27c3b356db98ee6f0dfa0291ff603b342b8695f9d8c3 |
...
Compiler/source-resolved declaration: `Electrical/Machines/BasicMachines/Components/Inductor.mo:3`. Role: `parameter`; binding: `fill(smpm.Lssigma, 2)`; effective min: `None`; effective max: `None`. 
