# FINDING-02816: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | diode4.idealDiode[2].Goff |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-rectifier12pulse-diode4-idealdiode-2-goff-zerolimit.md](../../v2/bugs/FINDING-rectifier12pulse-diode4-idealdiode-2-goff-zerolimit.md) — reviewed as `FINDING-02816-rectifier12pulse-diode4-idealdiode-2-goff.md`, which a later run renamed |
| Original SHA-256 | 8d63a6a5c7bbb890b7d6bf35d49ec998eb714bb7128951022426dec6bdd7c03e |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:6`. Role: `parameter`; binding: `diode4.Goff[2]`; effective min: `0`; effective max: `None`. 
