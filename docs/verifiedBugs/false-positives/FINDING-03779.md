# FINDING-03779: Armature example delegates to zero-capable mechanical terms
...
| Target | cActuator.armature.c |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-armaturestroke-cactuator-armature-c-intent.md](../../v2/bugs/FINDING-armaturestroke-cactuator-armature-c-intent.md) — reviewed as `FINDING-03779-armaturestroke-cactuator-armature-c.md`, which a later run renamed |
| Original SHA-256 | 778fa576bec8fe4f8b35a2a288aa913e5380d02f37e50f05d7f97ff2a8f5a355 |
...
Compiler/source-resolved declaration: `Magnetic/FluxTubes/Examples/Utilities/TranslatoryArmatureAndStopper.mo:9`. Role: `parameter`; binding: `cActuator.c`; effective min: `None`; effective max: `None`. 
