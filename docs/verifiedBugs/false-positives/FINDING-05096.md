# FINDING-05096: Zero inertia is a massless algebraic component, not an intrinsic division
...
| Target | vehicleInclinationInVar.inertia.J |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-vehicles-vehicleinclinationinvar-inertia-j-zerolimit.md](../../v2/bugs/FINDING-vehicles-vehicleinclinationinvar-inertia-j-zerolimit.md) — reviewed as `FINDING-05096-vehicles-vehicleinclinationinvar-inertia-j.md`, which a later run renamed |
| Original SHA-256 | f732b7f63cf7bbf192d6f642f6685de85eaeda3e3ce0b24f796168e249584dfa |
