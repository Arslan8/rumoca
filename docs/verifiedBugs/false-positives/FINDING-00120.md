# FINDING-00120: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | R3.IdealCommutingSwitch1.Goff |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-cauerlowpasssc-r3-idealcommutingswitch1-goff-ruleoff.md](../../v2/bugs/FINDING-cauerlowpasssc-r3-idealcommutingswitch1-goff-ruleoff.md) — reviewed as `FINDING-00120-cauerlowpasssc-r3-idealcommutingswitch1-goff.md`, which a later run renamed |
| Original SHA-256 | 34e301349028e439e6920401ada0883a044206b35dbdbea56a5ccdb55a9dc9d4 |
