# FINDING-02088: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | switchedRheostat.idealCommutingSwitch.idealCommutingSwitch[1].Goff |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-ims-start-switchedrheostat-idealcommutingswitch-idealcommutingswitch-1-2.md](../../v2/bugs/FINDING-ims-start-switchedrheostat-idealcommutingswitch-idealcommutingswitch-1-2.md) — reviewed as `FINDING-02088-ims-start-switchedrheostat-idealcommutingswitch-idealcommutingswitch-1.md`, which a later run renamed |
| Original SHA-256 | 54ec28f1fa88443c626584c9085f8fbd8a22cc3bf46d4b0ba09896fb1fb76ca8 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Ideal/IdealTwoWaySwitch.mo:4`. Role: `parameter`; binding: `switchedRheostat.idealCommutingSwitch.Goff[1]`; effective min: `0`; effective max: `None`. 
