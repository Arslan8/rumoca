# FINDING-02462: Zero stator leakage inductance is supported
...
| Original report | [FINDING-smpm-resistivebraking-smpm-lszero-zerolimit.md](../../v2/bugs/FINDING-smpm-resistivebraking-smpm-lszero-zerolimit.md) — reviewed as `FINDING-02462-smpm-resistivebraking-smpm-lszero.md`, which a later run renamed |
| Original SHA-256 | e22670946871cacae756e7f7a4e9e7485360f6d1d9691a8b892258a6a4a48569 |
...
Compiler/source-resolved declaration: `Electrical/Machines/Interfaces/PartialBasicInductionMachine.mo:20`. Role: `parameter`; binding: `smpm.Lssigma`; effective min: `None`; effective max: `None`. 
