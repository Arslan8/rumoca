# FINDING-04443: Zero mass is a massless algebraic component, not an intrinsic division
...
| Target | directMass.mass.m |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-generationoffmus-directmass-mass-m-zerolimit.md](../../v2/bugs/FINDING-generationoffmus-directmass-mass-m-zerolimit.md) — reviewed as `FINDING-04443-generationoffmus-directmass-mass-m.md`, which a later run renamed |
| Original SHA-256 | 4ea896b0c75f575e3394e1eb9b62d70332ea38290f3fb92e080a38d91436fbac |
...
Compiler/source-resolved declaration: `Mechanics/Translational/Components/Mass.mo:3`. Role: `parameter`; binding: `1.1`; effective min: `0`; effective max: `None`. 
