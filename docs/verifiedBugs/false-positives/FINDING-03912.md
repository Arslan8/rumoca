# FINDING-03912: MultiBody Newton/Euler equations use mass and inertia multiplicatively
...
| Target | boxBody2.body.I_11 |
| Student classification | physical-bound-permits-zero |
| Original report | `FINDING-03912-doublependuluminittip-boxbody2-body-i-11.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 80dd90f66d7585347597780321e1f4fd2d527ce70ad1fe2f02f86290f1ae1111 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:17`. Role: `parameter`; binding: `boxBody2.I[1, 1]`; effective min: `0`; effective max: `None`. 
