# FINDING-01545: Zero stator resistance is a supported ideal-loss limit
...
| Original report | [FINDING-imc-dcbraking-imc-rs-ruleoff.md](../../v2/bugs/FINDING-imc-dcbraking-imc-rs-ruleoff.md) — reviewed as `FINDING-01545-imc-dcbraking-imc-rs.md`, which a later run renamed |
| Original SHA-256 | c78d5d563dbd502750d7e1aa02aaffbc7ca9319c3b2e3c59bce1d4009eadfc81 |
...
Compiler/source-resolved declaration: `Electrical/Machines/Interfaces/PartialBasicInductionMachine.mo:11`. Role: `parameter`; binding: `imcData.Rs`; effective min: `None`; effective max: `None`. 
