# FINDING-00197: Zero inductance is an explicitly supported algebraic limit
...
| Original report | [FINDING-comparetransformers-inductor22-l-zerolimit.md](../../v2/bugs/FINDING-comparetransformers-inductor22-l-zerolimit.md) — reviewed as `FINDING-00197-comparetransformers-inductor22-l.md`, which a later run renamed |
| Original SHA-256 | 9663e5f685d24b814b40935886d5e89b8dea04d0643ab7357ed8fea4a472b443 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `L2sigma`; effective min: `None`; effective max: `None`. 
