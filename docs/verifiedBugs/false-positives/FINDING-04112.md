# FINDING-04112: Tensor entries are not all strictly positive scalars
...
| Target | referenceSystem.pointMass6.I |
| Student classification | physical-domain-unenforced |
| Original report | `FINDING-04112-pointgravitywithpointmasses2-referencesystem-pointmass6-i.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 4178f1fd521454bf02508c0d8998f4a02b54efa81215de65d95d811a84c049c9 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:114`. Role: `parameter`; binding: `cat1(cat2(referenceSystem.pointMass6.I_11, referenceSystem.pointMass6.I_21, referenceSystem.pointMass6.I_31), cat2(referenceSystem.pointMass6.I_21, referenceSystem.pointMass6.I_22, referenceSystem.pointMass6.I_32), cat2(referenceSystem.pointMass6.I_31, referenceSystem.pointMass6.I_32, referenceSystem.pointMass6.I_33))`; effective min: `None`; effective max: `None`. 
