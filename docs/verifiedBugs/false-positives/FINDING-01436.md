# FINDING-01436: Zero armature resistance is an ideal algebraic limit
...
| Original report | [FINDING-dcpm-withlosses-dcpm2-ra-unbounded.md](../../v2/bugs/FINDING-dcpm-withlosses-dcpm2-ra-unbounded.md) — reviewed as `FINDING-01436-dcpm-withlosses-dcpm2-ra.md`, which a later run renamed |
| Original SHA-256 | d3f175e9439713bdd13d8913859fd9395d986f45cd423ca4ede1b934cdc241a7 |
...
Compiler/source-resolved declaration: `Electrical/Machines/Interfaces/PartialBasicDCMachine.mo:17`. Role: `parameter`; binding: `dcpmData2.Ra`; effective min: `None`; effective max: `None`. 
