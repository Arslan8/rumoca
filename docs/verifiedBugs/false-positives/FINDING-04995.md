# FINDING-04995: A zero-duration ramp is a supported step
...
| Target | rampPermeance.duration |
| Student classification | divisor-reachable-zero |
| Original report | [FINDING-variablecomponents-ramppermeance-duration-divunreach.md](../../v2/bugs/FINDING-variablecomponents-ramppermeance-duration-divunreach.md) — reviewed as `FINDING-04995-variablecomponents-ramppermeance-duration.md`, which a later run renamed |
| Original SHA-256 | f2b247a44eb848ce9b5a9302db913acb51f1a999c8a5f7b6a4d373e4397774fd |
...
| Probe | Outcome |
|---|---|
| `rampPermeance.duration=0` | clean |
