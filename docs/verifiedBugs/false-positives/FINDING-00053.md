# FINDING-00053: Zero capacitance is an explicitly supported algebraic limit
...
| Original report | [FINDING-cauerlowpassopv-c6-c-zerolimit.md](../../v2/bugs/FINDING-cauerlowpassopv-c6-c-zerolimit.md) — reviewed as `FINDING-00053-cauerlowpassopv-c6-c.md`, which a later run renamed |
| Original SHA-256 | 596444391d85fe1be51bfa44d061c5b4766cc067cebb639f9b1f245f6b7063aa |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Capacitor.mo:4`. Role: `parameter`; binding: `((c2 + c3) + c4)`; effective min: `0`; effective max: `None`. 
