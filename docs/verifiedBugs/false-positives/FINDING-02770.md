# FINDING-02770: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | diode1.idealDiode[2].Goff |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-rectifier12pulse-diode1-idealdiode-2-goff-zerolimit.md](../../v2/bugs/FINDING-rectifier12pulse-diode1-idealdiode-2-goff-zerolimit.md) — reviewed as `FINDING-02770-rectifier12pulse-diode1-idealdiode-2-goff.md`, which a later run renamed |
| Original SHA-256 | 67237fac2e654139e929419aa64e1f1886868e3cef8a292cd69961a1db4cf795 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:6`. Role: `parameter`; binding: `diode1.Goff[2]`; effective min: `0`; effective max: `None`. 
