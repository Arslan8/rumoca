# FINDING-02090: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | switchedRheostat.idealCommutingSwitch.idealCommutingSwitch[2].Goff |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-ims-start-switchedrheostat-idealcommutingswitch-idealcommutingswitch-2-2.md](../../v2/bugs/FINDING-ims-start-switchedrheostat-idealcommutingswitch-idealcommutingswitch-2-2.md) — reviewed as `FINDING-02090-ims-start-switchedrheostat-idealcommutingswitch-idealcommutingswitch-2.md`, which a later run renamed |
| Original SHA-256 | 71919a165c95262e943c9373f9b76c677467ca11cf97ba8c973f89de05d6d297 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Ideal/IdealTwoWaySwitch.mo:4`. Role: `parameter`; binding: `switchedRheostat.idealCommutingSwitch.Goff[2]`; effective min: `0`; effective max: `None`. 
