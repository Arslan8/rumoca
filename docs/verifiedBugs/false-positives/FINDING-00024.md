# FINDING-00024: A zero-duration ramp is a supported step
...
| Original report | [FINDING-testconversionblock-phi-duration-divunreach.md](../../v2/bugs/FINDING-testconversionblock-phi-duration-divunreach.md) — reviewed as `FINDING-00024-testconversionblock-phi-duration.md`, which a later run renamed |
| Original SHA-256 | b9f578efbc315e3580e068ad2809ab6a8af24accc93c2e4826dd3d86d85c3ce7 |
...
[Rumoca commands, return codes, integrity hashes, bounded output and metadata](../evidence/c6e8ca128b390f59.json). Baseline: **clean**.

| Probe | Outcome |
|---|---|
| `phi.duration=0` | clean |
