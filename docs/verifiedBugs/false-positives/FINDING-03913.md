# FINDING-03913: MultiBody Newton/Euler equations use mass and inertia multiplicatively
...
| Target | boxBody2.body.I_22 |
| Student classification | physical-bound-permits-zero |
| Original report | `FINDING-03913-doublependuluminittip-boxbody2-body-i-22.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | bec4a7d5ec49ad495a8fb07d6f5d9e0177b90f49a4d6eecbcdb8c046ad49d542 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:19`. Role: `parameter`; binding: `boxBody2.I[2, 2]`; effective min: `0`; effective max: `None`. 
