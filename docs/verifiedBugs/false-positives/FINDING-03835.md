# FINDING-03835: Zero capacitance is an explicitly supported algebraic limit
...
| Original report | [FINDING-advancedsolenoid-c-par1-c-zerolimit.md](../../v2/bugs/FINDING-advancedsolenoid-c-par1-c-zerolimit.md) — reviewed as `FINDING-03835-advancedsolenoid-c-par1-c.md`, which a later run renamed |
| Original SHA-256 | 5e3676ab6cf5803dcb6d5ece20cb6031670c8e8256e479c9e841172b337a39e3 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Capacitor.mo:4`. Role: `parameter`; binding: `C_par`; effective min: `0`; effective max: `None`. 
