# FINDING-04257: MultiBody Newton/Euler equations use mass and inertia multiplicatively
...
| Original report | `FINDING-04257-mechanicalstructure-b0-body-i-11.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | f35a8d80051ca27f1d70f647ada049da7845020fa439150fb3ff6fae001ffd49 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:17`. Role: `parameter`; binding: `b0.I_11`; effective min: `0`; effective max: `None`. 
