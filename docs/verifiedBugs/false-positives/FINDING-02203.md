# FINDING-02203: Air-gap inductance is used as a flux multiplier
...
| Target | smee.airGap.Lmq |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-smee-generator-smee-airgap-lmq-intent.md](../../v2/bugs/FINDING-smee-generator-smee-airgap-lmq-intent.md) — reviewed as `FINDING-02203-smee-generator-smee-airgap-lmq.md`, which a later run renamed |
| Original SHA-256 | c1362e5f8bd07419d9e36c016f66a2b3a771894a64db754b883762bd2fe199cf |
...
Compiler/source-resolved declaration: `Electrical/Machines/BasicMachines/Components/AirGapR.mo:5`. Role: `parameter`; binding: `smeeData.Lmq`; effective min: `None`; effective max: `None`. 
