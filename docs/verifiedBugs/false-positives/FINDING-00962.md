# FINDING-00962: Zero on-resistance/off-conductance is an intended ideal limit
...
| Original report | [FINDING-rectifier-idealdiode1-goff-zerolimit.md](../../v2/bugs/FINDING-rectifier-idealdiode1-goff-zerolimit.md) — reviewed as `FINDING-00962-rectifier-idealdiode1-goff.md`, which a later run renamed |
| Original SHA-256 | c54ebd0e5a73f771dfd8a3780d99afa48f9909d4a17d096551bda55eeebf61d4 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:6`. Role: `parameter`; binding: `Goff`; effective min: `0`; effective max: `None`. 
