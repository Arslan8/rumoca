# FINDING-00298: Zero trapezoid edge duration is handled by branch reachability
...
| Target | V1.signalSource.falling |
| Student classification | divisor-reachable-zero |
| Original report | [FINDING-heatingnpn-norgate-v1-signalsource-falling-divunresolved.md](../../v2/bugs/FINDING-heatingnpn-norgate-v1-signalsource-falling-divunresolved.md) — reviewed as `FINDING-00298-heatingnpn-norgate-v1-signalsource-falling.md`, which a later run renamed |
| Original SHA-256 | 95514132576a5365c2528312f23462664883c654564d9ea6784b8c8698450631 |
