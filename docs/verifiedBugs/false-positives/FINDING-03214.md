# FINDING-03214: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | rectifier.diode_n1.Goff |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-halfcontrolledbridge2pulse-rectifier-diode-n1-goff-zerolimit.md](../../v2/bugs/FINDING-halfcontrolledbridge2pulse-rectifier-diode-n1-goff-zerolimit.md) — reviewed as `FINDING-03214-halfcontrolledbridge2pulse-rectifier-diode-n1-goff.md`, which a later run renamed |
| Original SHA-256 | 7c9ae29502d960a64ce4a0bb1c91d32c7833ab4e832fd5a068ae16c90dd8f56d |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:6`. Role: `parameter`; binding: `rectifier.GoffDiode`; effective min: `0`; effective max: `None`. 
