# FINDING-01177: Machine inertia delegates to the zero-capable algebraic inertia component
...
| Original report | [FINDING-dc-comparecharacteristics-dcse-jr-zerolimit.md](../../v2/bugs/FINDING-dc-comparecharacteristics-dcse-jr-zerolimit.md) — reviewed as `FINDING-01177-dc-comparecharacteristics-dcse-jr.md`, which a later run renamed |
| Original SHA-256 | 1d5efa77ac56ae2fbcda145e410be47eb980756ab6f6837b329fb45dee9ac54d |
...
Compiler/source-resolved declaration: `Electrical/Machines/Interfaces/PartialBasicMachine.mo:5`. Role: `parameter`; binding: `dcseData.Jr`; effective min: `None`; effective max: `None`. 
