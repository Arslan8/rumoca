# FINDING-00421: Zero inductance is an explicitly supported algebraic limit
...
| Original report | [FINDING-comparelinetrunks-oline4-l-5-l-zerolimit.md](../../v2/bugs/FINDING-comparelinetrunks-oline4-l-5-l-zerolimit.md) — reviewed as `FINDING-00421-comparelinetrunks-oline4-l-5-l.md`, which a later run renamed |
| Original SHA-256 | 4a848da3975fe6926789f720e5a90d3d2f69db4cc345fc9ffa65e082802dc3bc |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `oLine4.lm[5]`; effective min: `None`; effective max: `None`. 
