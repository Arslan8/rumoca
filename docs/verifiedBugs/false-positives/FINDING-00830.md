# FINDING-00830: Zero capacitance is an explicitly supported algebraic limit
...
| Target | integrator.c.C |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-integrator-integrator-c-c-zerolimit.md](../../v2/bugs/FINDING-integrator-integrator-c-c-zerolimit.md) — reviewed as `FINDING-00830-integrator-integrator-c-c.md`, which a later run renamed |
| Original SHA-256 | 441d6bde75d1ea4366823515274bc8f5e008dff780927ea7f387e08e488366ba |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Capacitor.mo:4`. Role: `parameter`; binding: `integrator.C`; effective min: `0`; effective max: `None`. 
...
| Probe | Outcome |
|---|---|
| `integrator.c.C=0` | reported-failure |
