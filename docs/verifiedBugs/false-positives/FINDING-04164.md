# FINDING-04164: MultiBody Newton/Euler equations use mass and inertia multiplicatively
...
| Original report | `FINDING-04164-userdefinedgravityfield-body-i-33.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | a33f378569cc24854b538868cacd1ed892b4a0afbc5f8fa2888bee7b0efd2265 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:21`. Role: `parameter`; binding: `0.001`; effective min: `0`; effective max: `None`. 
