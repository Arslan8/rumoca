# FINDING-04168: Tensor entries are not all strictly positive scalars
...
| Original report | `FINDING-04168-userdefinedgravityfield-body-i.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | d9a68ddd7bf467f5337109bdd678b31737c404e547a29a2e2c2c234acbcd6196 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:114`. Role: `parameter`; binding: `cat1(cat2(body.I_11, body.I_21, body.I_31), cat2(body.I_21, body.I_22, body.I_32), cat2(body.I_31, body.I_32, body.I_33))`; effective min: `None`; effective max: `None`. 
