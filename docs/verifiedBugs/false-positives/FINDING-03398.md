# FINDING-03398: Zero on-resistance/off-conductance is an intended ideal limit
...
| Original report | [FINDING-thyristorcentertap2mpulse-r-rectifier-thyristor-p-idealthyristor-2-gof.md](../../v2/bugs/FINDING-thyristorcentertap2mpulse-r-rectifier-thyristor-p-idealthyristor-2-gof.md) — reviewed as `FINDING-03398-thyristorcentertap2mpulse-r-rectifier-thyristor-p-idealthyristor-2-gof.md`, which a later run renamed |
| Original SHA-256 | 077aee696af412d1386f6aa08e248d62da19cb33f0283edae4f4f6163814d508 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:6`. Role: `parameter`; binding: `rectifier.thyristor_p.Goff[2]`; effective min: `0`; effective max: `None`. 
