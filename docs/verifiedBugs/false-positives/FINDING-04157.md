# FINDING-04157: The line-force point mass is explicitly optional
...
| Target | spring3.lineForce.m |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-threesprings-spring3-lineforce-m-zerolimit.md](../../v2/bugs/FINDING-threesprings-spring3-lineforce-m-zerolimit.md) — reviewed as `FINDING-04157-threesprings-spring3-lineforce-m.md`, which a later run renamed |
| Original SHA-256 | 7bd09ef4bf14d6780a1f77880b9d24772b594668b5972fa04c514c2876571dcb |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Forces/LineForceWithMass.mo:23`. Role: `parameter`; binding: `spring3.m`; effective min: `0`; effective max: `None`. 
