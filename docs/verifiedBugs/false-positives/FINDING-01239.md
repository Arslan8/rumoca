# FINDING-01239: Zero thermal conductance is an insulating limit
...
| Target | coreCooling.G |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-dcpm-cooling-corecooling-g-zerolimit.md](../../v2/bugs/FINDING-dcpm-cooling-corecooling-g-zerolimit.md) — reviewed as `FINDING-01239-dcpm-cooling-corecooling-g.md`, which a later run renamed |
| Original SHA-256 | 43930445b0620d54d70fa70516e41940a71a5a2c4b03fcc84ff903312a721d84 |
...
Compiler/source-resolved declaration: `Thermal/HeatTransfer/Components/ThermalConductor.mo:5`. Role: `parameter`; binding: `G_core_cooling`; effective min: `None`; effective max: `None`. 
