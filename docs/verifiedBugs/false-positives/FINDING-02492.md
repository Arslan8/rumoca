# FINDING-02492: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | switch2.idealClosingSwitch[3].Goff |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-smpm-resistivebraking-switch2-idealclosingswitch-3-goff-ruleoff.md](../../v2/bugs/FINDING-smpm-resistivebraking-switch2-idealclosingswitch-3-goff-ruleoff.md) — reviewed as `FINDING-02492-smpm-resistivebraking-switch2-idealclosingswitch-3-goff.md`, which a later run renamed |
| Original SHA-256 | 674f1e16f7661539d99fa57efce5539a9c19965d3c4d216587dd1dfe6d32c7b6 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSwitch.mo:6`. Role: `parameter`; binding: `switch2.Goff[3]`; effective min: `0`; effective max: `None`. 
