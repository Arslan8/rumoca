# FINDING-04396: Zero inertia is a massless algebraic component, not an intrinsic division
...
| Original report | [FINDING-firstgrounded-inertia2-j-zerolimit.md](../../v2/bugs/FINDING-firstgrounded-inertia2-j-zerolimit.md) — reviewed as `FINDING-04396-firstgrounded-inertia2-j.md`, which a later run renamed |
| Original SHA-256 | b34bba0dad354213a284027b4356e9208819b05fdf0b5e75a6d21e348c61a3bc |
...
Compiler/source-resolved declaration: `Mechanics/Rotational/Components/Inertia.mo:4`. Role: `parameter`; binding: `2`; effective min: `0`; effective max: `None`. 
