# FINDING-03759: A zero-duration ramp is a supported step
...
| Original report | [FINDING-toroidalcorequadraticcrosssection-rampcurrent-signalsource-duration-di.md](../../v2/bugs/FINDING-toroidalcorequadraticcrosssection-rampcurrent-signalsource-duration-di.md) — reviewed as `FINDING-03759-toroidalcorequadraticcrosssection-rampcurrent-signalsource-duration.md`, which a later run renamed |
| Original SHA-256 | dcaddf5a4a3c4845d3759a136ad0a7ee14d84fe016c6e91b2b7a3474f0faa3c4 |
...
Compiler/source-resolved declaration: `Blocks/Sources.mo:247`. Role: `parameter`; binding: `0.015`; effective min: `0.0`; effective max: `None`. 
