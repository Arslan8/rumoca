# FINDING-02091: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | switchedRheostat.idealCommutingSwitch.idealCommutingSwitch[3].Ron |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-ims-start-switchedrheostat-idealcommutingswitch-idealcommutingswitch-3.md](../../v2/bugs/FINDING-ims-start-switchedrheostat-idealcommutingswitch-idealcommutingswitch-3.md) — reviewed as `FINDING-02091-ims-start-switchedrheostat-idealcommutingswitch-idealcommutingswitch-3.md`, which a later run renamed |
| Original SHA-256 | 6ffd9f1e15cf236245df6fab45a1c7c9217ec2ccc8de565d2a20ee3a29fd7234 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Ideal/IdealTwoWaySwitch.mo:3`. Role: `parameter`; binding: `switchedRheostat.idealCommutingSwitch.Ron[3]`; effective min: `0`; effective max: `None`. 

[Electrical/Analog/Ideal/IdealTwoWaySwitch.mo — source snapshot](../evidence/sources/1894f031598e0a71-IdealTwoWaySwitch.mo)

```modelica
1: within Modelica.Electrical.Analog.Ideal;
2: model IdealTwoWaySwitch "Ideal two-way switch"
3:   parameter SI.Resistance Ron(final min=0) = 1e-5 "Closed switch resistance";
4:   parameter SI.Conductance Goff(final min=0) = 1e-5
5:     "Opened switch conductance";
