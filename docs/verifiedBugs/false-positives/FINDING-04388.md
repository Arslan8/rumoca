# FINDING-04388: Zero inertia is a massless algebraic component, not an intrinsic division
...
| Original report | [FINDING-elasticbearing-load-j-zerolimit.md](../../v2/bugs/FINDING-elasticbearing-load-j-zerolimit.md) — reviewed as `FINDING-04388-elasticbearing-load-j.md`, which a later run renamed |
| Original SHA-256 | d5eccaa5a5a4eab1dfc357f65bb49e984bceef0895c9742224fdab3dc6d78f34 |
...
Compiler/source-resolved declaration: `Mechanics/Rotational/Components/Inertia.mo:4`. Role: `parameter`; binding: `50`; effective min: `0`; effective max: `None`. 
...
Diagnostic: solve-IR evaluation failed: algebraic projection did not converge at event boundary: worst scaled residual row=13 target=load.a value=1.000000e0 ratio=1.000000e6 norm=1.000000e0 row_scale=1.000000e0 scaled_tolerance=1.000000e-6
