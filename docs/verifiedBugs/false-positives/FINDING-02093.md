# FINDING-02093: Polyphase resistance/conductance delegates to signed scalar elements
...
| Target | switchedRheostat.rheostat.R |
| Student classification | physical-domain-unenforced |
| Original report | `FINDING-02093-ims-start-switchedrheostat-rheostat-r.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 45480e1e6c3a2430387c02653a04a41757e407432ec16eff79014c825b00d563 |
...
Compiler/source-resolved declaration: `Electrical/Polyphase/Basic/Resistor.mo:4`. Role: `parameter`; binding: `fill(switchedRheostat.RStart, switchedRheostat.m)`; effective min: `None`; effective max: `None`. 
