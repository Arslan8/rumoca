# FINDING-02055: Zero stator resistance is a supported ideal-loss limit
...
| Original report | [FINDING-ims-start-aims-rs-unbounded.md](../../v2/bugs/FINDING-ims-start-aims-rs-unbounded.md) — reviewed as `FINDING-02055-ims-start-aims-rs.md`, which a later run renamed |
| Original SHA-256 | cae95804c5becd4b1214553d2139fa5bbf96dddc34e15ea66c53688af1922e74 |
...
Compiler/source-resolved declaration: `Electrical/Machines/Interfaces/PartialBasicInductionMachine.mo:11`. Role: `parameter`; binding: `aimsData.Rs`; effective min: `None`; effective max: `None`. 
