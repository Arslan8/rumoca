# FINDING-02303: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | diodeBridge2mPulse.diode_n.idealDiode[1].Goff |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-smpm-braking-diodebridge2mpulse-diode-n-idealdiode-1-goff-zerolimit.md](../../v2/bugs/FINDING-smpm-braking-diodebridge2mpulse-diode-n-idealdiode-1-goff-zerolimit.md) — reviewed as `FINDING-02303-smpm-braking-diodebridge2mpulse-diode-n-idealdiode-1-goff.md`, which a later run renamed |
| Original SHA-256 | 07901023e661bdc084a97e4938b9bceb17bd43092b275de592c777ecf4671eb3 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:6`. Role: `parameter`; binding: `diodeBridge2mPulse.diode_n.Goff[1]`; effective min: `0`; effective max: `None`. 
