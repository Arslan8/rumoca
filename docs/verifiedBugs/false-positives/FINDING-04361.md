# FINDING-04361: MultiBody Newton/Euler equations use mass and inertia multiplicatively
...
| Original report | [FINDING-mechanicalstructure-load-body-m-zerolimit.md](../../v2/bugs/FINDING-mechanicalstructure-load-body-m-zerolimit.md) — reviewed as `FINDING-04361-mechanicalstructure-load-body-m.md`, which a later run renamed |
| Original SHA-256 | 49d92d53d677cec2732c578c458693c00108bc50d4bb70ab7788e128aa11f165 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:16`. Role: `parameter`; binding: `mLoad`; effective min: `0`; effective max: `None`. 
