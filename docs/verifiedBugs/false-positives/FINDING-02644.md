# FINDING-02644: Zero leakage inductance is a supported ideal limit
...
| Target | smrData.Lssigma |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-smr-inverter-smrdata-lssigma-intent.md](../../v2/bugs/FINDING-smr-inverter-smrdata-lssigma-intent.md) — reviewed as `FINDING-02644-smr-inverter-smrdata-lssigma.md`, which a later run renamed |
| Original SHA-256 | ec25b44996cb20788c8d9ead618ccd8e15d7a91ea8c30ec9d317232cede88299 |
...
Compiler/source-resolved declaration: `Electrical/Machines/Utilities/ParameterRecords/InductionMachineData.mo:23`. Role: `parameter`; binding: `(0.1 / ((2 * (2 * asin(1.0))) * smrData.fsNominal))`; effective min: `None`; effective max: `None`. 
