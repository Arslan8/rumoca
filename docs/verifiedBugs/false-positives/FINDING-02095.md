# FINDING-02095: Machine-data inertia is not intrinsically a positive divisor
...
| Original report | [FINDING-ims-start-aimsdata-js-intent.md](../../v2/bugs/FINDING-ims-start-aimsdata-js-intent.md) — reviewed as `FINDING-02095-ims-start-aimsdata-js.md`, which a later run renamed |
| Original SHA-256 | c32d2df9869402d380981788e4426957fdd7e6c1967772286e9b565f4d8cadec |
...
Compiler/source-resolved declaration: `Electrical/Machines/Utilities/ParameterRecords/InductionMachineData.mo:7`. Role: `parameter`; binding: `aimsData.Jr`; effective min: `None`; effective max: `None`. 
