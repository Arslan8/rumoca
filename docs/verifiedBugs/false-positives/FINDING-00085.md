# FINDING-00085: Zero capacitance is an explicitly supported algebraic limit
...
| Target | R5.Capacitor.C |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-cauerlowpasssc-r5-capacitor-c-zerolimit.md](../../v2/bugs/FINDING-cauerlowpasssc-r5-capacitor-c-zerolimit.md) — reviewed as `FINDING-00085-cauerlowpasssc-r5-capacitor-c.md`, which a later run renamed |
| Original SHA-256 | 6793c93213aefc40c893062f8ddb95555166489a2b8f2ca9f0c09a40bafade72 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Capacitor.mo:4`. Role: `parameter`; binding: `(R5.clock / max((2.220446049250313e-16 * R5.oneOhm), abs(R5.R)))`; effective min: `0`; effective max: `None`. 
