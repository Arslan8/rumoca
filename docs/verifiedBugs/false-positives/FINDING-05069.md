# FINDING-05069: Vehicle parameter has a multiplicative zero limit
...
| Target | vehicleRoll.J |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-vehicles-vehicleroll-j-intent.md](../../v2/bugs/FINDING-vehicles-vehicleroll-j-intent.md) — reviewed as `FINDING-05069-vehicles-vehicleroll-j.md`, which a later run renamed |
| Original SHA-256 | 5eefbd836fc2af3d3a42362d6d4733ff8528fc7e232d3993dd51caaafc350ffc |
