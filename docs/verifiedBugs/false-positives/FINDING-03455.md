# FINDING-03455: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | rectifier.diode.Ron |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-diodecentertapmpulse-rectifier-diode-ron-ruleoff.md](../../v2/bugs/FINDING-diodecentertapmpulse-rectifier-diode-ron-ruleoff.md) — reviewed as `FINDING-03455-diodecentertapmpulse-rectifier-diode-ron.md`, which a later run renamed |
| Original SHA-256 | a85573fb286a0061d3713cca6b19a022fd51a3279d2c48be7c4e0c52d7b92dcb |
