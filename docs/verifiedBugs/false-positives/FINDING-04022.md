# FINDING-04022: Tensor entries are not all strictly positive scalars
...
| Target | body.body.I_31 |
| Student classification | physical-domain-unenforced |
| Original report | `FINDING-04022-initspringconstant-body-body-i-31.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | aaaccde1c1d9657b7dada62d9dd5e401794db9d6035f9f3f4ab93cf43f783b1e |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:25`. Role: `parameter`; binding: `body.I_31`; effective min: `-1.7976931348623157e+308`; effective max: `None`. 
