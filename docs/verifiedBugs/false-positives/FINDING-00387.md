# FINDING-00387: Zero inductance is an explicitly supported algebraic limit
...
| Original report | [FINDING-comparelinetrunks-oline2-l-5-l-zerolimit.md](../../v2/bugs/FINDING-comparelinetrunks-oline2-l-5-l-zerolimit.md) — reviewed as `FINDING-00387-comparelinetrunks-oline2-l-5-l.md`, which a later run renamed |
| Original SHA-256 | 70f74f67f639d9652ca23a5ade5f87d0bb0ba14e4f62f5ecbfd1410ffc8ccc43 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `oLine2.lm[5]`; effective min: `None`; effective max: `None`. 
