# FINDING-02779: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | diode2.idealDiode[3].Ron |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-rectifier12pulse-diode2-idealdiode-3-ron-ruleoff.md](../../v2/bugs/FINDING-rectifier12pulse-diode2-idealdiode-3-ron-ruleoff.md) — reviewed as `FINDING-02779-rectifier12pulse-diode2-idealdiode-3-ron.md`, which a later run renamed |
| Original SHA-256 | 0b0e460f21e4c98d626a1d284d75d14ede789288c966a656f5eab00b78add0ed |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:4`. Role: `parameter`; binding: `diode2.Ron[3]`; effective min: `0`; effective max: `None`. 
