# FINDING-02098: Zero leakage inductance is a supported ideal limit
...
| Original report | [FINDING-ims-start-aimsdata-lssigma-unbounded.md](../../v2/bugs/FINDING-ims-start-aimsdata-lssigma-unbounded.md) — reviewed as `FINDING-02098-ims-start-aimsdata-lssigma.md`, which a later run renamed |
| Original SHA-256 | 5f8a10b9f6688333ee365997152460489f83ff8617f9d75b20c5fbbae3289538 |
...
Compiler/source-resolved declaration: `Electrical/Machines/Utilities/ParameterRecords/InductionMachineData.mo:23`. Role: `parameter`; binding: `((3 * (1 - sqrt((1 - 0.0667)))) / ((2 * (2 * asin(1.0))) * aimsData.fsNominal))`; effective min: `None`; effective max: `None`. 
