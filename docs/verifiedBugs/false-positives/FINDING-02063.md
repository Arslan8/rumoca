# FINDING-02063: Machine inertia delegates to the zero-capable algebraic inertia component
...
| Original report | [FINDING-ims-start-aims-js-zerolimit.md](../../v2/bugs/FINDING-ims-start-aims-js-zerolimit.md) — reviewed as `FINDING-02063-ims-start-aims-js.md`, which a later run renamed |
| Original SHA-256 | 0abb8484596380440fae7df30e4f72c9688ccf7caaa1d972712d4b67ad6405c3 |
...
Compiler/source-resolved declaration: `Electrical/Machines/Interfaces/PartialBasicMachine.mo:8`. Role: `parameter`; binding: `aimsData.Js`; effective min: `None`; effective max: `None`. 
