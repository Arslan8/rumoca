# FINDING-03769: Zero mass is a massless algebraic component, not an intrinsic division
...
| Target | pmActuator.armature.mass.m |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-armaturestroke-pmactuator-armature-mass-m-zerolimit.md](../../v2/bugs/FINDING-armaturestroke-pmactuator-armature-mass-m-zerolimit.md) — reviewed as `FINDING-03769-armaturestroke-pmactuator-armature-mass-m.md`, which a later run renamed |
| Original SHA-256 | aad4d11517c94f9fb5cd1bd40d8ee0129ee011365c9d65df099ba8f2051f791d |
...
Compiler/source-resolved declaration: `Mechanics/Translational/Components/Mass.mo:3`. Role: `parameter`; binding: `pmActuator.m_a`; effective min: `0`; effective max: `None`. 
