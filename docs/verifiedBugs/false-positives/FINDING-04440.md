# FINDING-04440: Zero mass is a massless algebraic component, not an intrinsic division
...
| Original report | [FINDING-elastogap-mass2-m-zerolimit.md](../../v2/bugs/FINDING-elastogap-mass2-m-zerolimit.md) — reviewed as `FINDING-04440-elastogap-mass2-m.md`, which a later run renamed |
| Original SHA-256 | 3686b3476a9a9d615b40ad967dec721a4d27d4633136e75f6d232053bd3f3e82 |
...
Diagnostic: solve-IR evaluation failed: algebraic projection did not establish coordinate convergence: worst scaled residual row=53 target=fixed.flange.f value=0.000000e0 ratio=0.000000e0 norm=0.000000e0 row_scale=4.000000e1 scaled_tolerance=4.000000e-9
