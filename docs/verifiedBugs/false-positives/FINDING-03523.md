# FINDING-03523: Zero on-resistance/off-conductance is an intended ideal limit
...
| Original report | [FINDING-singlephasetwolevel-rl-inverter-transistor-n-goff-zerolimit.md](../../v2/bugs/FINDING-singlephasetwolevel-rl-inverter-transistor-n-goff-zerolimit.md) — reviewed as `FINDING-03523-singlephasetwolevel-rl-inverter-transistor-n-goff.md`, which a later run renamed |
| Original SHA-256 | 0a6d14713eb919ebfba2cb6dce62381c01fb0ec3eaeb171222107595a74bdb39 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:6`. Role: `parameter`; binding: `inverter.GoffTransistor`; effective min: `0`; effective max: `None`. 
