# FINDING-04309: MultiBody Newton/Euler equations use mass and inertia multiplicatively
...
| Original report | [FINDING-mechanicalstructure-b4-m-intent.md](../../v2/bugs/FINDING-mechanicalstructure-b4-m-intent.md) — reviewed as `FINDING-04309-mechanicalstructure-b4-m.md`, which a later run renamed |
| Original SHA-256 | fb96b10cd75513a6b73c56a9a1140ea6465bbda1df6c144e7a323c3e44fdb052 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/BodyShape.mo:23`. Role: `parameter`; binding: `28.7`; effective min: `0`; effective max: `None`. 
