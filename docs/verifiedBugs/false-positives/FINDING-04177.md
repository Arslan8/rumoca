# FINDING-04177: MultiBody Newton/Euler equations use mass and inertia multiplicatively
...
| Target | body1.body.I_11 |
| Student classification | physical-bound-permits-zero |
| Original report | `FINDING-04177-planarfourbar-body1-body-i-11.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | bf3e3aa7f61fb34e51d5545c0811280f1f45d4a26b16d33d017c5346bc151a0a |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:17`. Role: `parameter`; binding: `body1.I[1, 1]`; effective min: `0`; effective max: `None`. 
