# FINDING-00359: Zero capacitance is an explicitly supported algebraic limit
...
| Original report | [FINDING-idealtriaccircuit-idealtriac-capacitor-c-zerolimit.md](../../v2/bugs/FINDING-idealtriaccircuit-idealtriac-capacitor-c-zerolimit.md) — reviewed as `FINDING-00359-idealtriaccircuit-idealtriac-capacitor-c.md`, which a later run renamed |
| Original SHA-256 | dc78cc4718b0b17c9aa83993eb53e2a8fbea2c4fb23a502ca2fd178337bcbcf5 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Capacitor.mo:4`. Role: `parameter`; binding: `idealTriac.Cdis`; effective min: `0`; effective max: `None`. 
