# FINDING-01720: Polyphase resistance/conductance delegates to signed scalar elements
...
| Original report | `FINDING-01720-imc-inverterdrive-aimc-rs-r.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | f4c02f0f1f870438c00ce8b0b8db5a212205df19e9189461a9c9b18b55875ce5 |
...
Compiler/source-resolved declaration: `Electrical/Polyphase/Basic/Resistor.mo:4`. Role: `parameter`; binding: `fill(aimc.Rs, aimc.m)`; effective min: `None`; effective max: `None`. 
