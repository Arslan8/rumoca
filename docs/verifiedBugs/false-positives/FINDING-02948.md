# FINDING-02948: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | idealDiode2.idealDiode[2].Goff |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-rectifier-idealdiode2-idealdiode-2-goff-zerolimit.md](../../v2/bugs/FINDING-rectifier-idealdiode2-idealdiode-2-goff-zerolimit.md) — reviewed as `FINDING-02948-rectifier-idealdiode2-idealdiode-2-goff.md`, which a later run renamed |
| Original SHA-256 | 1708027786d54f0657da60f8e95cf25fc029cb70982cd2381ea361577f913dd3 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:6`. Role: `parameter`; binding: `idealDiode2.Goff[2]`; effective min: `0`; effective max: `None`. 
