# FINDING-04119: MultiBody spring mass/stiffness has an intentional zero limit
...
| Original report | [FINDING-pointgravitywithpointmasses-spring-c-intent.md](../../v2/bugs/FINDING-pointgravitywithpointmasses-spring-c-intent.md) — reviewed as `FINDING-04119-pointgravitywithpointmasses-spring-c.md`, which a later run renamed |
| Original SHA-256 | a32a9a6eeef9dd14427dba2208dd289fbee9c807688c5fd926adb461d82f4f43 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Forces/Spring.mo:9`. Role: `parameter`; binding: `10`; effective min: `0`; effective max: `None`. 
