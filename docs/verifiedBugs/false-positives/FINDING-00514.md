# FINDING-00514: Zero inductance is an explicitly supported algebraic limit
...
| Original report | [FINDING-smoothstep-oline5-l-1-l-zerolimit.md](../../v2/bugs/FINDING-smoothstep-oline5-l-1-l-zerolimit.md) — reviewed as `FINDING-00514-smoothstep-oline5-l-1-l.md`, which a later run renamed |
| Original SHA-256 | 4c16b493f95b4db65dca9dbcd535caf0236a56fbd8461b1998aa69e7d8bf7b5f |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `oLine5.lm[1]`; effective min: `None`; effective max: `None`. 
