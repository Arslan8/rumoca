# FINDING-02293: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | diodeBridge2mPulse.diode_p.Goff |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-smpm-braking-diodebridge2mpulse-diode-p-goff-ruleoff.md](../../v2/bugs/FINDING-smpm-braking-diodebridge2mpulse-diode-p-goff-ruleoff.md) — reviewed as `FINDING-02293-smpm-braking-diodebridge2mpulse-diode-p-goff.md`, which a later run renamed |
| Original SHA-256 | e3088e66a262509ba17d6f07b9c76bd8a58f5cd6f76a8ca40dcbc97ce95b80b4 |
...
Compiler/source-resolved declaration: `Electrical/Polyphase/Ideal/IdealDiode.mo:6`. Role: `parameter`; binding: `fill(diodeBridge2mPulse.GoffDiode, diodeBridge2mPulse.m)`; effective min: `zeros(3)`; effective max: `None`. 
