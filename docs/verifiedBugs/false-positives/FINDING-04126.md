# FINDING-04126: MultiBody spring mass/stiffness has an intentional zero limit
...
| Original report | [FINDING-springwithmass-spring-m-intent.md](../../v2/bugs/FINDING-springwithmass-spring-m-intent.md) — reviewed as `FINDING-04126-springwithmass-spring-m.md`, which a later run renamed |
| Original SHA-256 | ffd3893fa420ea2d06ff3a65d2b603605daaee93cb265d183fc8037b755ed3e3 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Forces/Spring.mo:11`. Role: `parameter`; binding: `0.5`; effective min: `0`; effective max: `None`. 
