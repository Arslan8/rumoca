# FINDING-00004: A zero-duration ramp is a supported step
...
| Original report | [FINDING-clockedwithdiscretetextbookcontroller-ramp-duration-divunreach.md](../../v2/bugs/FINDING-clockedwithdiscretetextbookcontroller-ramp-duration-divunreach.md) — reviewed as `FINDING-00004-clockedwithdiscretetextbookcontroller-ramp-duration.md`, which a later run renamed |
| Original SHA-256 | 550642289aba27e74ffd1438f5817f907b08d585403542b93942ddc281a14da1 |
...
[Rumoca commands, return codes, integrity hashes, bounded output and metadata](../evidence/37b649e037badc13.json). Baseline: **tool-error**.
