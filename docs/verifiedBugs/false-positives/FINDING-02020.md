# FINDING-02020: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | switchYD.idealCloser.idealClosingSwitch[2].Ron |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-imc-yd-switchyd-idealcloser-idealclosingswitch-2-ron-ruleoff.md](../../v2/bugs/FINDING-imc-yd-switchyd-idealcloser-idealclosingswitch-2-ron-ruleoff.md) — reviewed as `FINDING-02020-imc-yd-switchyd-idealcloser-idealclosingswitch-2-ron.md`, which a later run renamed |
| Original SHA-256 | 909962a9c3397a9a8887acae2d5d80d1c190baf57272e5d8b645fe301c854781 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSwitch.mo:4`. Role: `parameter`; binding: `switchYD.idealCloser.Ron[2]`; effective min: `0`; effective max: `None`. 
