# FINDING-02803: Zero on-resistance/off-conductance is an intended ideal limit
...
| Original report | [FINDING-rectifier12pulse-diode3-ron-ruleoff.md](../../v2/bugs/FINDING-rectifier12pulse-diode3-ron-ruleoff.md) — reviewed as `FINDING-02803-rectifier12pulse-diode3-ron.md`, which a later run renamed |
| Original SHA-256 | 7a3459947aee3b6fbf0a54ed3949cad3306174d5d5c0f9194292e997b498acf5 |
...
Compiler/source-resolved declaration: `Electrical/Polyphase/Ideal/IdealDiode.mo:4`. Role: `parameter`; binding: `fill(1e-05, m)`; effective min: `zeros(3)`; effective max: `None`. 
