# FINDING-03522: Zero on-resistance/off-conductance is an intended ideal limit
...
| Original report | [FINDING-singlephasetwolevel-rl-inverter-transistor-n-ron-ruleoff.md](../../v2/bugs/FINDING-singlephasetwolevel-rl-inverter-transistor-n-ron-ruleoff.md) — reviewed as `FINDING-03522-singlephasetwolevel-rl-inverter-transistor-n-ron.md`, which a later run renamed |
| Original SHA-256 | 37b4d8241c9c834098fb9f0ce9fa8fb140a6eb3ee7eccffbd7dbd1472092055a |
