# FINDING-01725: Machine inertia delegates to the zero-capable algebraic inertia component
...
| Original report | [FINDING-imc-inverterdrive-aimc-js-zerolimit.md](../../v2/bugs/FINDING-imc-inverterdrive-aimc-js-zerolimit.md) — reviewed as `FINDING-01725-imc-inverterdrive-aimc-js.md`, which a later run renamed |
| Original SHA-256 | 0033dd1d0750cce1c75b128b7ae209af7be25687d2c44572d11e39e8ad883d28 |
...
Compiler/source-resolved declaration: `Electrical/Machines/Interfaces/PartialBasicMachine.mo:8`. Role: `parameter`; binding: `aimcData.Js`; effective min: `None`; effective max: `None`. 
