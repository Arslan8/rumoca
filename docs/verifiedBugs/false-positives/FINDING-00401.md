# FINDING-00401: Zero inductance is an explicitly supported algebraic limit
...
| Original report | [FINDING-comparelinetrunks-oline3-l-2-l-zerolimit.md](../../v2/bugs/FINDING-comparelinetrunks-oline3-l-2-l-zerolimit.md) — reviewed as `FINDING-00401-comparelinetrunks-oline3-l-2-l.md`, which a later run renamed |
| Original SHA-256 | 9055ea3e516ba003ea61f01bf10fd351fbcf24bc60fc08d5cfabe5fbdc8286a7 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `oLine3.lm[2]`; effective min: `None`; effective max: `None`. 
