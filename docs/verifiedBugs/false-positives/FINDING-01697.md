# FINDING-01697: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | inverter.diode_p.idealDiode[2].Ron |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-imc-inverterdrive-inverter-diode-p-idealdiode-2-ron-ruleoff.md](../../v2/bugs/FINDING-imc-inverterdrive-inverter-diode-p-idealdiode-2-ron-ruleoff.md) — reviewed as `FINDING-01697-imc-inverterdrive-inverter-diode-p-idealdiode-2-ron.md`, which a later run renamed |
| Original SHA-256 | 307eaf39f59e22494bf4a08fb2dc7f84d8d848f51a463e83b182973abd533f9e |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:4`. Role: `parameter`; binding: `inverter.diode_p.Ron[2]`; effective min: `0`; effective max: `None`. 
