# FINDING-03405: Zero on-resistance/off-conductance is an intended ideal limit
...
| Original report | [FINDING-thyristorcentertap2mpulse-r-rectifier-thyristor-n-idealthyristor-2-ron.md](../../v2/bugs/FINDING-thyristorcentertap2mpulse-r-rectifier-thyristor-n-idealthyristor-2-ron.md) — reviewed as `FINDING-03405-thyristorcentertap2mpulse-r-rectifier-thyristor-n-idealthyristor-2-ron.md`, which a later run renamed |
| Original SHA-256 | 8fbe643ce69785bf884d733da89eb9ba1adcc8edbb3b50a4562bfb6650528b32 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:4`. Role: `parameter`; binding: `rectifier.thyristor_n.Ron[2]`; effective min: `0`; effective max: `None`. 
