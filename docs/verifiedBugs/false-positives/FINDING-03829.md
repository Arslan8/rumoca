# FINDING-03829: Armature example delegates to zero-capable mechanical terms
...
| Original report | [FINDING-advancedsolenoid-armature-m-intent.md](../../v2/bugs/FINDING-advancedsolenoid-armature-m-intent.md) — reviewed as `FINDING-03829-advancedsolenoid-armature-m.md`, which a later run renamed |
| Original SHA-256 | c8522ca360aa0e627ac525fade2be400d401297848c723b35640ee527d51fa61 |
...
Compiler/source-resolved declaration: `Magnetic/FluxTubes/Examples/Utilities/TranslatoryArmatureAndStopper.mo:7`. Role: `parameter`; binding: `(((rho_steel * l_arm) * (2 * asin(1.0))) * (r_arm ^ 2))`; effective min: `0`; effective max: `None`. 
