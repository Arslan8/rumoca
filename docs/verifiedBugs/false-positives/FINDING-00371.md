# FINDING-00371: Zero inductance is an explicitly supported algebraic limit
...
| Original report | [FINDING-comparelinetrunks-oline1-l-6-l-zerolimit.md](../../v2/bugs/FINDING-comparelinetrunks-oline1-l-6-l-zerolimit.md) — reviewed as `FINDING-00371-comparelinetrunks-oline1-l-6-l.md`, which a later run renamed |
| Original SHA-256 | 9be2e9b42e440707636e42ad596fc520f8058212cacd1c253dd83288fb5fd66f |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `oLine1.lm[6]`; effective min: `None`; effective max: `None`. 
