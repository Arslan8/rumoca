# FINDING-02294: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | diodeBridge2mPulse.diode_p.idealDiode[1].Ron |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-smpm-braking-diodebridge2mpulse-diode-p-idealdiode-1-ron-ruleoff.md](../../v2/bugs/FINDING-smpm-braking-diodebridge2mpulse-diode-p-idealdiode-1-ron-ruleoff.md) — reviewed as `FINDING-02294-smpm-braking-diodebridge2mpulse-diode-p-idealdiode-1-ron.md`, which a later run renamed |
| Original SHA-256 | 04b5705f0e67ff76203b824d82af7cf81455bb945c9da2f84015be29764abd2c |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:4`. Role: `parameter`; binding: `diodeBridge2mPulse.diode_p.Ron[1]`; effective min: `0`; effective max: `None`. 
