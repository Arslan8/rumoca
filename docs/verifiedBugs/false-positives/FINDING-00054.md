# FINDING-00054: Zero capacitance is an explicitly supported algebraic limit
...
| Original report | [FINDING-cauerlowpassopv-c7-c-zerolimit.md](../../v2/bugs/FINDING-cauerlowpassopv-c7-c-zerolimit.md) — reviewed as `FINDING-00054-cauerlowpassopv-c7-c.md`, which a later run renamed |
| Original SHA-256 | ef1cf0cec8877c344c92f2ab28d55258675ec7a72cdfd5c947826fdab14f68bf |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Capacitor.mo:4`. Role: `parameter`; binding: `l2`; effective min: `0`; effective max: `None`. 
