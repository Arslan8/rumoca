# FINDING-02027: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | switchYD.idealOpener.idealOpeningSwitch[1].Goff |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-imc-yd-switchyd-idealopener-idealopeningswitch-1-goff-ruleoff.md](../../v2/bugs/FINDING-imc-yd-switchyd-idealopener-idealopeningswitch-1-goff-ruleoff.md) — reviewed as `FINDING-02027-imc-yd-switchyd-idealopener-idealopeningswitch-1-goff.md`, which a later run renamed |
| Original SHA-256 | c33140e1e370d1bb839e872c2b22f1a57fe09aee91684a9dfcd8cc08e01a909f |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSwitch.mo:6`. Role: `parameter`; binding: `switchYD.idealOpener.Goff[1]`; effective min: `0`; effective max: `None`. 
