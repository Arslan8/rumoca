# FINDING-00527: Zero inductance is an explicitly supported algebraic limit
...
| Target | oLine50.L[1].L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-smoothstep-oline50-l-1-l-zerolimit.md](../../v2/bugs/FINDING-smoothstep-oline50-l-1-l-zerolimit.md) — reviewed as `FINDING-00527-smoothstep-oline50-l-1-l.md`, which a later run renamed |
| Original SHA-256 | bb8d36ca86d988f79e40124876b1374fee8a6ad35cd5e14dd0901c81645b2600 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `oLine50.lm[1]`; effective min: `None`; effective max: `None`. 
