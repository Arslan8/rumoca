# FINDING-03400: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | rectifier.thyristor_p.idealThyristor[3].Goff |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-thyristorcentertap2mpulse-r-rectifier-thyristor-p-idealthyristor-3-gof.md](../../v2/bugs/FINDING-thyristorcentertap2mpulse-r-rectifier-thyristor-p-idealthyristor-3-gof.md) — reviewed as `FINDING-03400-thyristorcentertap2mpulse-r-rectifier-thyristor-p-idealthyristor-3-gof.md`, which a later run renamed |
| Original SHA-256 | 2d0936126f7f971c49ffea14f0e1348374bcd810ed736cadf5fccbe5bd981744 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:6`. Role: `parameter`; binding: `rectifier.thyristor_p.Goff[3]`; effective min: `0`; effective max: `None`. 
