# FINDING-04314: Tensor entries are not all strictly positive scalars
...
| Original report | `FINDING-04314-mechanicalstructure-b4-i-31.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | b21900acd1be0dde8a598e6a952a8d8a74f7df8e5f91779d16774ea0935e1e32 |
