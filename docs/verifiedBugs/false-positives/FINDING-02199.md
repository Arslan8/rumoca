# FINDING-02199: Machine inertia delegates to the zero-capable algebraic inertia component
...
| Original report | [FINDING-smee-generator-smee-js-zerolimit.md](../../v2/bugs/FINDING-smee-generator-smee-js-zerolimit.md) — reviewed as `FINDING-02199-smee-generator-smee-js.md`, which a later run renamed |
| Original SHA-256 | 588dc5826619caaa2439ebe61804419467b0910847987ebdd9c94065af263341 |
...
Compiler/source-resolved declaration: `Electrical/Machines/Interfaces/PartialBasicMachine.mo:8`. Role: `parameter`; binding: `0.29`; effective min: `None`; effective max: `None`. 
