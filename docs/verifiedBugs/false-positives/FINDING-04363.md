# FINDING-04363: MultiBody Newton/Euler equations use mass and inertia multiplicatively
...
| Target | load.body.I_22 |
| Student classification | physical-bound-permits-zero |
| Original report | `FINDING-04363-mechanicalstructure-load-body-i-22.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 48ab88f5fd44620929ce82b6a450886c67082c377eda49e060b20d9c5afb4af6 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:19`. Role: `parameter`; binding: `load.I_22`; effective min: `0`; effective max: `None`. 
