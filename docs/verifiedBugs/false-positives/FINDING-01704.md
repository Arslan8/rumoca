# FINDING-01704: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | inverter.transistor_n.idealGTOThyristor[1].Goff |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-imc-inverterdrive-inverter-transistor-n-idealgtothyristor-1-goff-zerol.md](../../v2/bugs/FINDING-imc-inverterdrive-inverter-transistor-n-idealgtothyristor-1-goff-zerol.md) — reviewed as `FINDING-01704-imc-inverterdrive-inverter-transistor-n-idealgtothyristor-1-goff.md`, which a later run renamed |
| Original SHA-256 | b7dbc184f8d5d4af69b4b61a51dbe6fd2cc68f1d376a7624566d06b858ed6306 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:6`. Role: `parameter`; binding: `inverter.transistor_n.Goff[1]`; effective min: `0`; effective max: `None`. 
