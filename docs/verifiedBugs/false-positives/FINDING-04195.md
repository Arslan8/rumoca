# FINDING-04195: Tensor entries are not all strictly positive scalars
...
| Target | body2.body.I_32 |
| Student classification | physical-domain-unenforced |
| Original report | `FINDING-04195-planarfourbar-body2-body-i-32.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 480535aafa1a2123455f52d8a885bca751c90047dcb24b6579ccb72351fb211f |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:27`. Role: `parameter`; binding: `body2.I[3, 2]`; effective min: `-1.7976931348623157e+308`; effective max: `None`. 
