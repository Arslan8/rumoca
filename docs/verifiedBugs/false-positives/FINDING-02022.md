# FINDING-02022: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | switchYD.idealCloser.idealClosingSwitch[3].Ron |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-imc-yd-switchyd-idealcloser-idealclosingswitch-3-ron-ruleoff.md](../../v2/bugs/FINDING-imc-yd-switchyd-idealcloser-idealclosingswitch-3-ron-ruleoff.md) — reviewed as `FINDING-02022-imc-yd-switchyd-idealcloser-idealclosingswitch-3-ron.md`, which a later run renamed |
| Original SHA-256 | 77a51fc5bcdeb33c19dce3a239b78cf8a018b77b14da24b65ede3a9a3de2e666 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSwitch.mo:4`. Role: `parameter`; binding: `switchYD.idealCloser.Ron[3]`; effective min: `0`; effective max: `None`. 
