# FINDING-02058: Polyphase resistance/conductance delegates to signed scalar elements
...
| Original report | `FINDING-02058-ims-start-aims-rs-r.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 5016210b7c955debe646f8bb61e825c4d58bdc3c100955b13864bc374a946e91 |
...
Compiler/source-resolved declaration: `Electrical/Polyphase/Basic/Resistor.mo:4`. Role: `parameter`; binding: `fill(aims.Rs, aims.m)`; effective min: `None`; effective max: `None`. 
