# FINDING-02019: Zero on-resistance/off-conductance is an intended ideal limit
...
| Original report | [FINDING-imc-yd-switchyd-idealcloser-idealclosingswitch-1-goff-ruleoff.md](../../v2/bugs/FINDING-imc-yd-switchyd-idealcloser-idealclosingswitch-1-goff-ruleoff.md) — reviewed as `FINDING-02019-imc-yd-switchyd-idealcloser-idealclosingswitch-1-goff.md`, which a later run renamed |
| Original SHA-256 | 8caeca3860e19740475889db78901aba710e3ab9719adeecd2690fb9469ace70 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSwitch.mo:6`. Role: `parameter`; binding: `switchYD.idealCloser.Goff[1]`; effective min: `0`; effective max: `None`. 
