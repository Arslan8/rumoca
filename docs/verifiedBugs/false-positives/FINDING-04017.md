# FINDING-04017: MultiBody Newton/Euler equations use mass and inertia multiplicatively
...
| Original report | [FINDING-initspringconstant-body-body-m-zerolimit.md](../../v2/bugs/FINDING-initspringconstant-body-body-m-zerolimit.md) — reviewed as `FINDING-04017-initspringconstant-body-body-m.md`, which a later run renamed |
| Original SHA-256 | 7a34ed32aa2853b4fcc14d7c1a7e79257303f7e07c2445455fe889a1da236cc4 |
