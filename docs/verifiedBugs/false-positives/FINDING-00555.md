# FINDING-00555: Zero inductance is an explicitly supported algebraic limit
...
| Target | oLine50.L[29].L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-smoothstep-oline50-l-29-l-zerolimit.md](../../v2/bugs/FINDING-smoothstep-oline50-l-29-l-zerolimit.md) — reviewed as `FINDING-00555-smoothstep-oline50-l-29-l.md`, which a later run renamed |
| Original SHA-256 | 615e441e1d02798e36b8e657cd0fd8b2c85c6c13ca6c20cbb9819930fde86977 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `oLine50.lm[29]`; effective min: `None`; effective max: `None`. 
