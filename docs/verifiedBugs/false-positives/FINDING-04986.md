# FINDING-04986: Zeroing this operand does not zero the complete denominator
...
| Target | genericFluxTube3.material.c_b |
| Student classification | divisor-reachable-zero |
| Original report | `FINDING-04986-sources-genericfluxtube3-material-c-b.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 7200401fbb21b773c5e0751451f2ea219f812134173cfdb21f2e28567686a5e1 |
...
| Probe | Outcome |
|---|---|
| `genericFluxTube3.material.c_b=0` | clean |
