# FINDING-02618: Polyphase resistance/conductance delegates to signed scalar elements
...
| Original report | `FINDING-02618-smr-inverter-smr-rs-r.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 08d20d49098aab28310f87825edccc14f99f7290e5e3b0e928b1e5dac10c28d1 |
...
Compiler/source-resolved declaration: `Electrical/Polyphase/Basic/Resistor.mo:4`. Role: `parameter`; binding: `fill(smr.Rs, smr.m)`; effective min: `None`; effective max: `None`. 
