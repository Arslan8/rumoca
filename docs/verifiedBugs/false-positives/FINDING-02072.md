# FINDING-02072: Polyphase resistance/conductance delegates to signed scalar elements
...
| Original report | `FINDING-02072-ims-start-aims-rr-r.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 3f368b2ab5e8d4f9f0247febf2b39dcee19a9c59ad8adc4c1b1e88ee3c51eef3 |
...
Compiler/source-resolved declaration: `Electrical/Polyphase/Basic/Resistor.mo:4`. Role: `parameter`; binding: `fill(aims.Rr, aims.m)`; effective min: `None`; effective max: `None`. 
