# FINDING-04835: A zero-duration ramp is a supported step
...
| Target | ramp6.duration |
| Student classification | divisor-reachable-zero |
| Original report | [FINDING-limitershomotopy-ramp6-duration-divunreach.md](../../v2/bugs/FINDING-limitershomotopy-ramp6-duration-divunreach.md) — reviewed as `FINDING-04835-limitershomotopy-ramp6-duration.md`, which a later run renamed |
| Original SHA-256 | ff0e7000c12c7a499a24f70afc82bf1f8dcceda217c441d98ba163df21982638 |
