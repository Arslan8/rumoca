# FINDING-02089: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | switchedRheostat.idealCommutingSwitch.idealCommutingSwitch[2].Ron |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-ims-start-switchedrheostat-idealcommutingswitch-idealcommutingswitch-2.md](../../v2/bugs/FINDING-ims-start-switchedrheostat-idealcommutingswitch-idealcommutingswitch-2.md) — reviewed as `FINDING-02089-ims-start-switchedrheostat-idealcommutingswitch-idealcommutingswitch-2.md`, which a later run renamed |
| Original SHA-256 | 94bfd48f677efc77b0cadb9018ebc3c4ec30e50038837a5461849dd0fca9971b |
...
Compiler/source-resolved declaration: `Electrical/Analog/Ideal/IdealTwoWaySwitch.mo:3`. Role: `parameter`; binding: `switchedRheostat.idealCommutingSwitch.Ron[2]`; effective min: `0`; effective max: `None`. 
