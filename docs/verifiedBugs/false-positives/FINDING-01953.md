# FINDING-01953: Arc-switch resistance/conductance are multiplicative ideal limits
...
| Target | switchYDwithArc.idealCloser.closerWithArc[3].Ron |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-imc-ydarc-switchydwitharc-idealcloser-closerwitharc-3-ron-zerolimit.md](../../v2/bugs/FINDING-imc-ydarc-switchydwitharc-idealcloser-closerwitharc-3-ron-zerolimit.md) — reviewed as `FINDING-01953-imc-ydarc-switchydwitharc-idealcloser-closerwitharc-3-ron.md`, which a later run renamed |
| Original SHA-256 | 366745b9c0fec5566f2c23bf70cee2578d9b3b118889d0a0f7eae52b997c1dd0 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSwitchWithArc.mo:4`. Role: `parameter`; binding: `switchYDwithArc.idealCloser.Ron[3]`; effective min: `None`; effective max: `None`. 
