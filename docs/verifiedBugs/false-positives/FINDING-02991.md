# FINDING-02991: Zero inductance is an explicitly supported algebraic limit
...
| Original report | [FINDING-transformeryy-transformerl-inductor-1-l-zerolimit.md](../../v2/bugs/FINDING-transformeryy-transformerl-inductor-1-l-zerolimit.md) — reviewed as `FINDING-02991-transformeryy-transformerl-inductor-1-l.md`, which a later run renamed |
| Original SHA-256 | 24ed852b86e74ecdaa1760ad9f1ddfb73d2f6953dc1bf54a3b5ad32434bc9755 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `transformerL.L[1]`; effective min: `None`; effective max: `None`. 
