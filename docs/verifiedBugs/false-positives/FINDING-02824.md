# FINDING-02824: Polyphase inductance delegates to zero-capable scalar inductors
...
| Target | transformer2.l1sigma.L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-rectifier12pulse-transformer2-l1sigma-l-zerolimit.md](../../v2/bugs/FINDING-rectifier12pulse-transformer2-l1sigma-l-zerolimit.md) — reviewed as `FINDING-02824-rectifier12pulse-transformer2-l1sigma-l.md`, which a later run renamed |
| Original SHA-256 | 69059017be483132fdc2253d8fec7a5f49939f16890ebd94168cc6c9753a440e |
...
Compiler/source-resolved declaration: `Electrical/Polyphase/Basic/Inductor.mo:4`. Role: `parameter`; binding: `fill(transformer2.L1sigma, transformer2.m)`; effective min: `None`; effective max: `None`. 
