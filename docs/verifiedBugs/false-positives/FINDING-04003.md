# FINDING-04003: Tensor entries are not all strictly positive scalars
...
| Original report | `FINDING-04003-heatlosses-body3-i.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 0b3333f070b84ea0607cdbd6959c4a6f5527ad347a3bf43aa9700c70d3a71c92 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:114`. Role: `parameter`; binding: `cat1(cat2(body3.I_11, body3.I_21, body3.I_31), cat2(body3.I_21, body3.I_22, body3.I_32), cat2(body3.I_31, body3.I_32, body3.I_33))`; effective min: `None`; effective max: `None`. 
