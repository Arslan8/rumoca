# FINDING-00373: Zero inductance is an explicitly supported algebraic limit
...
| Original report | [FINDING-comparelinetrunks-oline1-l-8-l-zerolimit.md](../../v2/bugs/FINDING-comparelinetrunks-oline1-l-8-l-zerolimit.md) — reviewed as `FINDING-00373-comparelinetrunks-oline1-l-8-l.md`, which a later run renamed |
| Original SHA-256 | 4fc65fa31547e2b7683c8ac84d62fd822788e68c95ad18f648b0b446600dcb9e |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `oLine1.lm[8]`; effective min: `None`; effective max: `None`. 
