# FINDING-01338: A zero-duration ramp is a supported step
...
| Target | ramp2.duration |
| Student classification | divisor-reachable-zero |
| Original report | [FINDING-dcpm-drive-ramp2-duration-divunreach.md](../../v2/bugs/FINDING-dcpm-drive-ramp2-duration-divunreach.md) — reviewed as `FINDING-01338-dcpm-drive-ramp2-duration.md`, which a later run renamed |
| Original SHA-256 | 24d513300229ad3b806a9ea6b0124cbd37d74b68f3bb80ff81ca173b64c26800 |
...
Compiler/source-resolved declaration: `Blocks/Sources.mo:247`. Role: `parameter`; binding: `0.5`; effective min: `0.0`; effective max: `None`. 
