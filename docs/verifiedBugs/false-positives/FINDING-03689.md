# FINDING-03689: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | hbridge.inverter_p.transistor_p.Goff |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-hbridge-trianglepwm-rl-hbridge-inverter-p-transistor-p-goff-zerolimit.md](../../v2/bugs/FINDING-hbridge-trianglepwm-rl-hbridge-inverter-p-transistor-p-goff-zerolimit.md) — reviewed as `FINDING-03689-hbridge-trianglepwm-rl-hbridge-inverter-p-transistor-p-goff.md`, which a later run renamed |
| Original SHA-256 | a5908f9597a619626a5b1ae034fc35516cb536900bb1f36bed3a6de9397e91be |
