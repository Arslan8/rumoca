# FINDING-03538: Zero on-resistance/off-conductance is an intended ideal limit
...
| Original report | [FINDING-singlephasetwolevel-r-inverter-transistor-n-ron-ruleoff.md](../../v2/bugs/FINDING-singlephasetwolevel-r-inverter-transistor-n-ron-ruleoff.md) — reviewed as `FINDING-03538-singlephasetwolevel-r-inverter-transistor-n-ron.md`, which a later run renamed |
| Original SHA-256 | 67993a1199a55816beb10f59383e255839f1e06c870048b8670cb076aee32547 |
