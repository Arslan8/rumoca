# FINDING-01104: The complete conductor denominator is already asserted positive
...
| Target | superCap.conductor.T_ref |
| Student classification | divisor-reachable-zero |
| Original report | `FINDING-01104-supercapdischargecharge-supercap-conductor-t-ref.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 8a700e79a08165ba46850ccfc749c60fcee03737de27eec35a44fe6b92abd173 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Conductor.mo:5`. Role: `parameter`; binding: `293.15`; effective min: `0.0`; effective max: `None`. 
