# FINDING-03638: Zero on-resistance/off-conductance is an intended ideal limit
...
| Original report | [FINDING-hbridge-rl-hbridge-inverter-n-transistor-p-ron-ruleoff.md](../../v2/bugs/FINDING-hbridge-rl-hbridge-inverter-n-transistor-p-ron-ruleoff.md) — reviewed as `FINDING-03638-hbridge-rl-hbridge-inverter-n-transistor-p-ron.md`, which a later run renamed |
| Original SHA-256 | 45ffe66a75742fd0c77411ffee27797a48b54fc20c17462c2f1e2248f97e3b76 |
