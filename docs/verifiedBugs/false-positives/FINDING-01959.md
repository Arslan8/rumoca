# FINDING-01959: Arc-switch resistance/conductance are multiplicative ideal limits
...
| Target | switchYDwithArc.idealOpener.openerWithArc[2].Ron |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-imc-ydarc-switchydwitharc-idealopener-openerwitharc-2-ron-zerolimit.md](../../v2/bugs/FINDING-imc-ydarc-switchydwitharc-idealopener-openerwitharc-2-ron-zerolimit.md) — reviewed as `FINDING-01959-imc-ydarc-switchydwitharc-idealopener-openerwitharc-2-ron.md`, which a later run renamed |
| Original SHA-256 | 73b5fef2ee52475336a79dbbdfbaeb5ed76b5ae62442693598216545714b948a |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSwitchWithArc.mo:4`. Role: `parameter`; binding: `switchYDwithArc.idealOpener.Ron[2]`; effective min: `None`; effective max: `None`. 
