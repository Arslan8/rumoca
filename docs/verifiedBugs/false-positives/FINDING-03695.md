# FINDING-03695: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | hbridge.inverter_p.diode_n.Goff |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-hbridge-trianglepwm-rl-hbridge-inverter-p-diode-n-goff-zerolimit.md](../../v2/bugs/FINDING-hbridge-trianglepwm-rl-hbridge-inverter-p-diode-n-goff-zerolimit.md) — reviewed as `FINDING-03695-hbridge-trianglepwm-rl-hbridge-inverter-p-diode-n-goff.md`, which a later run renamed |
| Original SHA-256 | 287d9a578c40da6987aceef6ee47b5795339e1a195b703cefeb0a1ac15635fbc |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:6`. Role: `parameter`; binding: `hbridge.inverter_p.GoffDiode`; effective min: `0`; effective max: `None`. 
