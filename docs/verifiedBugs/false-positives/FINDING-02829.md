# FINDING-02829: Polyphase inductance delegates to zero-capable scalar inductors
...
| Target | transformer2.l2sigma.L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-rectifier12pulse-transformer2-l2sigma-l-zerolimit.md](../../v2/bugs/FINDING-rectifier12pulse-transformer2-l2sigma-l-zerolimit.md) — reviewed as `FINDING-02829-rectifier12pulse-transformer2-l2sigma-l.md`, which a later run renamed |
| Original SHA-256 | 6cc06c54bdc27418a18b78fcdb05c8256f10179b822d6d99fa51a8b052d1afbe |
...
Compiler/source-resolved declaration: `Electrical/Polyphase/Basic/Inductor.mo:4`. Role: `parameter`; binding: `fill(transformer2.L2sigma, transformer2.m)`; effective min: `None`; effective max: `None`. 
