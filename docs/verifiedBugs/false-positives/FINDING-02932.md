# FINDING-02932: Zero inductance is an explicitly supported algebraic limit
...
| Target | supplyL.inductor[1].L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-rectifier-supplyl-inductor-1-l-zerolimit.md](../../v2/bugs/FINDING-rectifier-supplyl-inductor-1-l-zerolimit.md) — reviewed as `FINDING-02932-rectifier-supplyl-inductor-1-l.md`, which a later run renamed |
| Original SHA-256 | cbd15e48c876712162c0e1ca6fddac0148f1ccb486098dd66cefc5d330e6f93b |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `supplyL.L[1]`; effective min: `None`; effective max: `None`. 
