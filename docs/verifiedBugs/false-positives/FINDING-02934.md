# FINDING-02934: Zero inductance is an explicitly supported algebraic limit
...
| Target | supplyL.inductor[3].L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-rectifier-supplyl-inductor-3-l-zerolimit.md](../../v2/bugs/FINDING-rectifier-supplyl-inductor-3-l-zerolimit.md) — reviewed as `FINDING-02934-rectifier-supplyl-inductor-3-l.md`, which a later run renamed |
| Original SHA-256 | 72afc97e11bd889049a8fa28efbe5d39fb76c2930b563e7751ad012b7bd4f30d |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `supplyL.L[3]`; effective min: `None`; effective max: `None`. 
