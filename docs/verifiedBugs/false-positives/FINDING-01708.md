# FINDING-01708: Zero on-resistance/off-conductance is an intended ideal limit
...
| Original report | [FINDING-imc-inverterdrive-inverter-transistor-n-idealgtothyristor-3-goff-zerol.md](../../v2/bugs/FINDING-imc-inverterdrive-inverter-transistor-n-idealgtothyristor-3-goff-zerol.md) — reviewed as `FINDING-01708-imc-inverterdrive-inverter-transistor-n-idealgtothyristor-3-goff.md`, which a later run renamed |
| Original SHA-256 | dfeefdca400d43e0f9c853a8769f2eaa34119d482b389cc99091b6ddd332bf40 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:6`. Role: `parameter`; binding: `inverter.transistor_n.Goff[3]`; effective min: `0`; effective max: `None`. 
