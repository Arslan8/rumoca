# FINDING-04216: MultiBody Newton/Euler equations use mass and inertia multiplicatively
...
| Target | body4.body.I_11 |
| Student classification | physical-bound-permits-zero |
| Original report | `FINDING-04216-planarfourbar-body4-body-i-11.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 9925c0b1ae6ab905edac06970e0e354c6d55020031e7d9db5c4e433896e84c80 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:17`. Role: `parameter`; binding: `body4.I[1, 1]`; effective min: `0`; effective max: `None`. 
