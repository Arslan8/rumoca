# FINDING-04010: MultiBody Newton/Euler equations use mass and inertia multiplicatively
...
| Original report | [FINDING-initspringconstant-body-m-intent.md](../../v2/bugs/FINDING-initspringconstant-body-m-intent.md) — reviewed as `FINDING-04010-initspringconstant-body-m.md`, which a later run renamed |
| Original SHA-256 | 900adf9ff36a87f1b4544764753b317edb234ad8aba8a77ff4c99d3a604fc816 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/BodyShape.mo:23`. Role: `parameter`; binding: `1`; effective min: `0`; effective max: `None`. 
