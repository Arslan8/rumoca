# FINDING-02910: Polyphase inductance delegates to zero-capable scalar inductors
...
| Target | transformer.l1sigma.L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-transformertestbench-transformer-l1sigma-l-zerolimit.md](../../v2/bugs/FINDING-transformertestbench-transformer-l1sigma-l-zerolimit.md) — reviewed as `FINDING-02910-transformertestbench-transformer-l1sigma-l.md`, which a later run renamed |
| Original SHA-256 | 889c47c53e5d737a9d6336d4bbae9c66044c45404dba90f2a10fa00bf04dd334 |
...
Compiler/source-resolved declaration: `Electrical/Polyphase/Basic/Inductor.mo:4`. Role: `parameter`; binding: `fill(transformer.L1sigma, transformer.m)`; effective min: `None`; effective max: `None`. 
