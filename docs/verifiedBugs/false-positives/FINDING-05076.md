# FINDING-05076: Zero inertia is a massless algebraic component, not an intrinsic division
...
| Target | vehicleRollInConst.inertia.J |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-vehicles-vehiclerollinconst-inertia-j-zerolimit.md](../../v2/bugs/FINDING-vehicles-vehiclerollinconst-inertia-j-zerolimit.md) — reviewed as `FINDING-05076-vehicles-vehiclerollinconst-inertia-j.md`, which a later run renamed |
| Original SHA-256 | 50f91ea9e7def53413943323071071b5cdcebfd77c40e0489b3f4227b60e7758 |
