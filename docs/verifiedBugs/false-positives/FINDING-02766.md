# FINDING-02766: Zero on-resistance/off-conductance is an intended ideal limit
...
| Original report | [FINDING-rectifier12pulse-diode1-goff-ruleoff.md](../../v2/bugs/FINDING-rectifier12pulse-diode1-goff-ruleoff.md) — reviewed as `FINDING-02766-rectifier12pulse-diode1-goff.md`, which a later run renamed |
| Original SHA-256 | b417a890c19cd7c6018098769d16f0da986870cd8f156dfb8bc0091c6729af55 |
...
Compiler/source-resolved declaration: `Electrical/Polyphase/Ideal/IdealDiode.mo:6`. Role: `parameter`; binding: `fill(1e-05, m)`; effective min: `zeros(3)`; effective max: `None`. 
