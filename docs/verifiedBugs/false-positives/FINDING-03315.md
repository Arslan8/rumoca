# FINDING-03315: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | rectifier.diode_p.idealDiode[2].Ron |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-diodecentertap2mpulse-rectifier-diode-p-idealdiode-2-ron-ruleoff.md](../../v2/bugs/FINDING-diodecentertap2mpulse-rectifier-diode-p-idealdiode-2-ron-ruleoff.md) — reviewed as `FINDING-03315-diodecentertap2mpulse-rectifier-diode-p-idealdiode-2-ron.md`, which a later run renamed |
| Original SHA-256 | e2408ca20d8beaf5b5bd2d4167ef421d9557c8c8ca695826448ca67bd4279aeb |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:4`. Role: `parameter`; binding: `rectifier.diode_p.Ron[2]`; effective min: `0`; effective max: `None`. 
