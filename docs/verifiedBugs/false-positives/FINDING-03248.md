# FINDING-03248: Zero inductance is an explicitly supported algebraic limit
...
| Original report | [FINDING-thyristorbridge2pulse-dc-drive-lmains-l-zerolimit.md](../../v2/bugs/FINDING-thyristorbridge2pulse-dc-drive-lmains-l-zerolimit.md) — reviewed as `FINDING-03248-thyristorbridge2pulse-dc-drive-lmains-l.md`, which a later run renamed |
| Original SHA-256 | 0041d6ef89fb0b6b17808607ebdb08b08999f1ae86cbd3adab0590db86195472 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `LMains`; effective min: `None`; effective max: `None`. 
