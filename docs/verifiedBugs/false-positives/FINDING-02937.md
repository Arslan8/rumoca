# FINDING-02937: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | idealDiode1.idealDiode[1].Ron |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-rectifier-idealdiode1-idealdiode-1-ron-ruleoff.md](../../v2/bugs/FINDING-rectifier-idealdiode1-idealdiode-1-ron-ruleoff.md) — reviewed as `FINDING-02937-rectifier-idealdiode1-idealdiode-1-ron.md`, which a later run renamed |
| Original SHA-256 | 37dd49d6208da113b754a8bc47e3f042eac280bb093d1d6113afeaf2e3b8b9de |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:4`. Role: `parameter`; binding: `idealDiode1.Ron[1]`; effective min: `0`; effective max: `None`. 
