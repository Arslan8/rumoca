# FINDING-02990: Polyphase inductance delegates to zero-capable scalar inductors
...
| Original report | [FINDING-transformeryy-transformerl-l-zerolimit.md](../../v2/bugs/FINDING-transformeryy-transformerl-l-zerolimit.md) — reviewed as `FINDING-02990-transformeryy-transformerl-l.md`, which a later run renamed |
| Original SHA-256 | 4af8f002bf78fcc8e409dbb59cc36b9f40e88bc9bbd5ca9d794eda36c36c46b5 |
...
Compiler/source-resolved declaration: `Electrical/Polyphase/Basic/Inductor.mo:4`. Role: `parameter`; binding: `fill(LT, m)`; effective min: `None`; effective max: `None`. 
