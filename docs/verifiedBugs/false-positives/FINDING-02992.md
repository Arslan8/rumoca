# FINDING-02992: Zero inductance is an explicitly supported algebraic limit
...
| Target | transformerL.inductor[2].L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-transformeryy-transformerl-inductor-2-l-zerolimit.md](../../v2/bugs/FINDING-transformeryy-transformerl-inductor-2-l-zerolimit.md) — reviewed as `FINDING-02992-transformeryy-transformerl-inductor-2-l.md`, which a later run renamed |
| Original SHA-256 | 247ef571f98bbad7b0417b9d22d04200a38281603fa04a5dc6627aeff8253c78 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `transformerL.L[2]`; effective min: `None`; effective max: `None`. 
