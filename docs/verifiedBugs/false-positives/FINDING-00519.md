# FINDING-00519: Zero inductance is an explicitly supported algebraic limit
...
| Original report | [FINDING-smoothstep-oline5-l-6-l-zerolimit.md](../../v2/bugs/FINDING-smoothstep-oline5-l-6-l-zerolimit.md) — reviewed as `FINDING-00519-smoothstep-oline5-l-6-l.md`, which a later run renamed |
| Original SHA-256 | 8cafc37805d34c8048c9e37828e2713b95fd1df8429c93077cd795d277d44193 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `oLine5.lm[6]`; effective min: `None`; effective max: `None`. 
