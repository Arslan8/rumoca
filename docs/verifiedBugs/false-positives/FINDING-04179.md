# FINDING-04179: MultiBody Newton/Euler equations use mass and inertia multiplicatively
...
| Target | body1.body.I_33 |
| Student classification | physical-bound-permits-zero |
| Original report | `FINDING-04179-planarfourbar-body1-body-i-33.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 319b676ebf88380ada5c7b5e5cc18d06c1d66dbb5c64bc831365a5d9ff6cf806 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:21`. Role: `parameter`; binding: `body1.I[3, 3]`; effective min: `0`; effective max: `None`. 
