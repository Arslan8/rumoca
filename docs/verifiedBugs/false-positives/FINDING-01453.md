# FINDING-01453: DC machine-data field has a supported ideal limit
...
| Original report | [FINDING-dcpm-withlosses-dcpmdata2-js-intent.md](../../v2/bugs/FINDING-dcpm-withlosses-dcpmdata2-js-intent.md) — reviewed as `FINDING-01453-dcpm-withlosses-dcpmdata2-js.md`, which a later run renamed |
| Original SHA-256 | 97218757e633c08f09973321d82646eaa78f84fed0ef75394b7ce0d3e3ebf4a1 |
...
Compiler/source-resolved declaration: `Electrical/Machines/Utilities/ParameterRecords/DcPermanentMagnetData.mo:6`. Role: `parameter`; binding: `dcpmData2.Jr`; effective min: `None`; effective max: `None`. 
