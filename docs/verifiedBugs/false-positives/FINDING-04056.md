# FINDING-04056: Tensor entries are not all strictly positive scalars
...
| Original report | `FINDING-04056-pointgravity-body2-i.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | fe90864492bf784a86328353b4b9049e5272283cff036ac331380fdad4955703 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:114`. Role: `parameter`; binding: `cat1(cat2(body2.I_11, body2.I_21, body2.I_31), cat2(body2.I_21, body2.I_22, body2.I_32), cat2(body2.I_31, body2.I_32, body2.I_33))`; effective min: `None`; effective max: `None`. 
