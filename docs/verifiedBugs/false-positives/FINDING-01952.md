# FINDING-01952: Arc-switch resistance/conductance are multiplicative ideal limits
...
| Target | switchYDwithArc.idealCloser.closerWithArc[2].Goff |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-imc-ydarc-switchydwitharc-idealcloser-closerwitharc-2-goff-zerolimit.md](../../v2/bugs/FINDING-imc-ydarc-switchydwitharc-idealcloser-closerwitharc-2-goff-zerolimit.md) — reviewed as `FINDING-01952-imc-ydarc-switchydwitharc-idealcloser-closerwitharc-2-goff.md`, which a later run renamed |
| Original SHA-256 | fd0eb6d2a759faaf468521262b0724a0cc3a1516d1f25ec9785465e51e44e9df |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSwitchWithArc.mo:5`. Role: `parameter`; binding: `switchYDwithArc.idealCloser.Goff[2]`; effective min: `None`; effective max: `None`. 
