# FINDING-04161: MultiBody Newton/Euler equations use mass and inertia multiplicatively
...
| Original report | [FINDING-userdefinedgravityfield-body-m-zerolimit.md](../../v2/bugs/FINDING-userdefinedgravityfield-body-m-zerolimit.md) — reviewed as `FINDING-04161-userdefinedgravityfield-body-m.md`, which a later run renamed |
| Original SHA-256 | c67b56d41ec11258069521c8f7f7d7f2c68718ddd00947acba2a7fe276c25d47 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:16`. Role: `parameter`; binding: `1000.0`; effective min: `0`; effective max: `None`. 
