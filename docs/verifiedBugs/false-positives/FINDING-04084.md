# FINDING-04084: MultiBody Newton/Euler equations use mass and inertia multiplicatively
...
| Target | referenceSystem.pointMass3.I_33 |
| Student classification | physical-bound-permits-zero |
| Original report | `FINDING-04084-pointgravitywithpointmasses2-referencesystem-pointmass3-i-33.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 196243476b7600cfa278cb0dd794cefb1789cfd484ac574191a4aa704f9a6cef |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:21`. Role: `parameter`; binding: `0`; effective min: `0`; effective max: `None`. 
