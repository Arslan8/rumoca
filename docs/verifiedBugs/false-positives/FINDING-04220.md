# FINDING-04220: Tensor entries are not all strictly positive scalars
...
| Target | body4.body.I_31 |
| Student classification | physical-domain-unenforced |
| Original report | `FINDING-04220-planarfourbar-body4-body-i-31.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 7e1629422792ab83352db0830cea2855217bd86ffb21c479fb8faa86acdcb5bf |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:25`. Role: `parameter`; binding: `body4.I[3, 1]`; effective min: `-1.7976931348623157e+308`; effective max: `None`. 
