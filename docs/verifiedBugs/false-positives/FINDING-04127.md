# FINDING-04127: The line-force point mass is explicitly optional
...
| Original report | [FINDING-springwithmass-spring-lineforce-m-zerolimit.md](../../v2/bugs/FINDING-springwithmass-spring-lineforce-m-zerolimit.md) — reviewed as `FINDING-04127-springwithmass-spring-lineforce-m.md`, which a later run renamed |
| Original SHA-256 | 8ca0cc42e8c9e6f10e6eef0ba98d9fc1f6ff1e849128cd8602f5a6c0cfa1157f |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Forces/LineForceWithMass.mo:23`. Role: `parameter`; binding: `0.5`; effective min: `0`; effective max: `None`. 
