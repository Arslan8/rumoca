# FINDING-01954: Arc-switch resistance/conductance are multiplicative ideal limits
...
| Target | switchYDwithArc.idealCloser.closerWithArc[3].Goff |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-imc-ydarc-switchydwitharc-idealcloser-closerwitharc-3-goff-zerolimit.md](../../v2/bugs/FINDING-imc-ydarc-switchydwitharc-idealcloser-closerwitharc-3-goff-zerolimit.md) — reviewed as `FINDING-01954-imc-ydarc-switchydwitharc-idealcloser-closerwitharc-3-goff.md`, which a later run renamed |
| Original SHA-256 | 8714e9f55e353f446b7d9428e3c8117e4bded4cc0fa33c2be900605e4e9680ba |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSwitchWithArc.mo:5`. Role: `parameter`; binding: `switchYDwithArc.idealCloser.Goff[3]`; effective min: `None`; effective max: `None`. 
