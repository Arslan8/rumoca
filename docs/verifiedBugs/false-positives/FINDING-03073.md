# FINDING-03073: Zero inductance is an explicitly supported algebraic limit
...
| Original report | [FINDING-thyristorbridge2mpulse-dc-drive-inductor-l-zerolimit.md](../../v2/bugs/FINDING-thyristorbridge2mpulse-dc-drive-inductor-l-zerolimit.md) — reviewed as `FINDING-03073-thyristorbridge2mpulse-dc-drive-inductor-l.md`, which a later run renamed |
| Original SHA-256 | e391b523788744719760637a16e9f63664de77a04f21befff19baaf2df89fd4c |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `Ld`; effective min: `None`; effective max: `None`. 
