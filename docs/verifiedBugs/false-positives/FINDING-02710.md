# FINDING-02710: Zero on-resistance/off-conductance is an intended ideal limit
...
| Original report | [FINDING-imc-transformer-idealcloser-idealclosingswitch-1-ron-ruleoff-2.md](../../v2/bugs/FINDING-imc-transformer-idealcloser-idealclosingswitch-1-ron-ruleoff-2.md) — reviewed as `FINDING-02710-imc-transformer-idealcloser-idealclosingswitch-1-ron.md`, which a later run renamed |
| Original SHA-256 | 6c05c4360612feb8a7cfe50f75895084d765163b62b21b44e370f55e826cf26b |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSwitch.mo:4`. Role: `parameter`; binding: `idealCloser.Ron[1]`; effective min: `0`; effective max: `None`. 
