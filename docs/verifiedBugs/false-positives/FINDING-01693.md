# FINDING-01693: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | inverter.diode_p.Ron |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-imc-inverterdrive-inverter-diode-p-ron-ruleoff.md](../../v2/bugs/FINDING-imc-inverterdrive-inverter-diode-p-ron-ruleoff.md) — reviewed as `FINDING-01693-imc-inverterdrive-inverter-diode-p-ron.md`, which a later run renamed |
| Original SHA-256 | 9cc3f6f35a0e3f6f91401683a9727fac33ce4eed844f274bd2774fb203b6c0a2 |
...
Compiler/source-resolved declaration: `Electrical/Polyphase/Ideal/IdealDiode.mo:4`. Role: `parameter`; binding: `fill(inverter.RonDiode, inverter.m)`; effective min: `zeros(3)`; effective max: `None`. 
