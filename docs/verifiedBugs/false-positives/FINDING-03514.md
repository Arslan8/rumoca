# FINDING-03514: Converter switch parameters delegate to ideal semiconductor limits
...
| Original report | [FINDING-singlephasetwolevel-rl-inverter-rontransistor-ruleoff.md](../../v2/bugs/FINDING-singlephasetwolevel-rl-inverter-rontransistor-ruleoff.md) — reviewed as `FINDING-03514-singlephasetwolevel-rl-inverter-rontransistor.md`, which a later run renamed |
| Original SHA-256 | e2d3c817c6bdebd72695fc783f44fce7dfcff1aa7fe079e40e164dd471854231 |
...
Compiler/source-resolved declaration: `Electrical/PowerConverters/DCAC/SinglePhase2Level.mo:4`. Role: `parameter`; binding: `1e-05`; effective min: `None`; effective max: `None`. 
