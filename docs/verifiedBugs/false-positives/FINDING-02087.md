# FINDING-02087: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | switchedRheostat.idealCommutingSwitch.idealCommutingSwitch[1].Ron |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-ims-start-switchedrheostat-idealcommutingswitch-idealcommutingswitch-1.md](../../v2/bugs/FINDING-ims-start-switchedrheostat-idealcommutingswitch-idealcommutingswitch-1.md) — reviewed as `FINDING-02087-ims-start-switchedrheostat-idealcommutingswitch-idealcommutingswitch-1.md`, which a later run renamed |
| Original SHA-256 | bbaa3b6d59020d51de379b5551af857819abfb4f5dcbeaaf520c4aa92cc1bd55 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Ideal/IdealTwoWaySwitch.mo:3`. Role: `parameter`; binding: `switchedRheostat.idealCommutingSwitch.Ron[1]`; effective min: `0`; effective max: `None`. 
