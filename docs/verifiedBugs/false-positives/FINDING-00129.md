# FINDING-00129: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | Rp1.IdealCommutingSwitch2.Goff |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-cauerlowpasssc-rp1-idealcommutingswitch2-goff-ruleoff.md](../../v2/bugs/FINDING-cauerlowpasssc-rp1-idealcommutingswitch2-goff-ruleoff.md) — reviewed as `FINDING-00129-cauerlowpasssc-rp1-idealcommutingswitch2-goff.md`, which a later run renamed |
| Original SHA-256 | bc0c358cf410270235cf6a9a105272099be203225bb029a106416254faa2f9db |
...
Compiler/source-resolved declaration: `Electrical/Analog/Ideal/IdealTwoWaySwitch.mo:4`. Role: `parameter`; binding: `1e-05`; effective min: `0`; effective max: `None`. 
