# FINDING-03706: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | hbridge.inverter_n.diode_n.Ron |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-hbridge-trianglepwm-rl-hbridge-inverter-n-diode-n-ron-ruleoff.md](../../v2/bugs/FINDING-hbridge-trianglepwm-rl-hbridge-inverter-n-diode-n-ron-ruleoff.md) — reviewed as `FINDING-03706-hbridge-trianglepwm-rl-hbridge-inverter-n-diode-n-ron.md`, which a later run renamed |
| Original SHA-256 | 0494d4dbb399c1d45178165de5a807d446add740c53d7ec77da6220fac2c8bb4 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:4`. Role: `parameter`; binding: `hbridge.inverter_n.RonDiode`; effective min: `0`; effective max: `None`. 
