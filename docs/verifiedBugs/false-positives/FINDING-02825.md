# FINDING-02825: Zero inductance is an explicitly supported algebraic limit
...
| Target | transformer2.l1sigma.inductor[1].L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-rectifier12pulse-transformer2-l1sigma-inductor-1-l-zerolimit.md](../../v2/bugs/FINDING-rectifier12pulse-transformer2-l1sigma-inductor-1-l-zerolimit.md) — reviewed as `FINDING-02825-rectifier12pulse-transformer2-l1sigma-inductor-1-l.md`, which a later run renamed |
| Original SHA-256 | 4b5022dcb0b800d814cf598ed01cf9476e86d9619237e202fc2234a4e3885ab7 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `transformer2.l1sigma.L[1]`; effective min: `None`; effective max: `None`. 
