# FINDING-00419: Zero inductance is an explicitly supported algebraic limit
...
| Original report | [FINDING-comparelinetrunks-oline4-l-3-l-zerolimit.md](../../v2/bugs/FINDING-comparelinetrunks-oline4-l-3-l-zerolimit.md) — reviewed as `FINDING-00419-comparelinetrunks-oline4-l-3-l.md`, which a later run renamed |
| Original SHA-256 | a627c994f7d597c95f15e95f9aeb3a3acdc03e6416dacc7c9c90766e9475ffbd |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `oLine4.lm[3]`; effective min: `None`; effective max: `None`. 
