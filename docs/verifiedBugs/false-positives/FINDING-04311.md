# FINDING-04311: MultiBody Newton/Euler equations use mass and inertia multiplicatively
...
| Original report | `FINDING-04311-mechanicalstructure-b4-i-22.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 9d69a2f7d7a4521c72374ef9b8fcfbccd29df91e1e87299ca5872c3bbe3dcf9d |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/BodyShape.mo:26`. Role: `parameter`; binding: `0.081`; effective min: `0`; effective max: `None`. 
