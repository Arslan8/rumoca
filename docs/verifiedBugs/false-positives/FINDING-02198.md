# FINDING-02198: Machine inertia delegates to the zero-capable algebraic inertia component
...
| Original report | [FINDING-smee-generator-smee-jr-zerolimit.md](../../v2/bugs/FINDING-smee-generator-smee-jr-zerolimit.md) — reviewed as `FINDING-02198-smee-generator-smee-jr.md`, which a later run renamed |
| Original SHA-256 | 4e53a2064c00bc32c79bcdcaa288c7200ddb02595cb02386ca1c0a16afab6387 |
...
Compiler/source-resolved declaration: `Electrical/Machines/Interfaces/PartialBasicMachine.mo:5`. Role: `parameter`; binding: `0.29`; effective min: `None`; effective max: `None`. 
