# FINDING-03915: Tensor entries are not all strictly positive scalars
...
| Target | boxBody2.body.I_21 |
| Student classification | physical-domain-unenforced |
| Original report | `FINDING-03915-doublependuluminittip-boxbody2-body-i-21.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 6031eda95af591e553c267e4bc699b9c3ec35bbcab53e3c6140861b099d3ce98 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:23`. Role: `parameter`; binding: `boxBody2.I[2, 1]`; effective min: `-1.7976931348623157e+308`; effective max: `None`. 
