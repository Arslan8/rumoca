# FINDING-00535: Zero inductance is an explicitly supported algebraic limit
...
| Target | oLine50.L[9].L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-smoothstep-oline50-l-9-l-zerolimit.md](../../v2/bugs/FINDING-smoothstep-oline50-l-9-l-zerolimit.md) — reviewed as `FINDING-00535-smoothstep-oline50-l-9-l.md`, which a later run renamed |
| Original SHA-256 | 7c2b490132a9ecad013e7212feb7b5e797f9d6e382c62dec1fc91a5eda4a7c40 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `oLine50.lm[9]`; effective min: `None`; effective max: `None`. 
