# FINDING-04279: MultiBody Newton/Euler equations use mass and inertia multiplicatively
...
| Original report | [FINDING-mechanicalstructure-b2-m-intent.md](../../v2/bugs/FINDING-mechanicalstructure-b2-m-intent.md) — reviewed as `FINDING-04279-mechanicalstructure-b2-m.md`, which a later run renamed |
| Original SHA-256 | a4886da525f9edc9167653f29033ebbb68c061c2360fbd06b9e09ad74c2cb195 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/BodyShape.mo:23`. Role: `parameter`; binding: `56.5`; effective min: `0`; effective max: `None`. 
