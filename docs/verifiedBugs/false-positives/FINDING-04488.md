# FINDING-04488: Zero stiffness is a force-free spring limit
...
| Original report | [FINDING-spring-spring-c-zerolimit-2.md](../../v2/bugs/FINDING-spring-spring-c-zerolimit-2.md) — reviewed as `FINDING-04488-spring-spring-c.md`, which a later run renamed |
| Original SHA-256 | 6b87a18238153a4e85dc2613b1263179e22840294fdb1a15e54da2548d0a9087 |
...
Compiler/source-resolved declaration: `Mechanics/Translational/Components/Spring.mo:4`. Role: `parameter`; binding: `c`; effective min: `0`; effective max: `None`. 
