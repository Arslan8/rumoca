# FINDING-02300: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | diodeBridge2mPulse.diode_n.Ron |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-smpm-braking-diodebridge2mpulse-diode-n-ron-ruleoff.md](../../v2/bugs/FINDING-smpm-braking-diodebridge2mpulse-diode-n-ron-ruleoff.md) — reviewed as `FINDING-02300-smpm-braking-diodebridge2mpulse-diode-n-ron.md`, which a later run renamed |
| Original SHA-256 | 5a7b268592e94897f0054ce52abfc491eed529dc0cfac6047e279971553dafc7 |
...
Compiler/source-resolved declaration: `Electrical/Polyphase/Ideal/IdealDiode.mo:4`. Role: `parameter`; binding: `fill(diodeBridge2mPulse.RonDiode, diodeBridge2mPulse.m)`; effective min: `zeros(3)`; effective max: `None`. 

[Electrical/Polyphase/Ideal/IdealDiode.mo — source snapshot](../evidence/sources/dd56580e34ddc2a1-IdealDiode.mo)

```modelica
2: model IdealDiode "Polyphase ideal diode"
3:   extends Interfaces.TwoPlug;
4:   parameter SI.Resistance Ron[m](final min=zeros(m), start=
5:         fill(1e-5, m)) "Closed diode resistance";
6:   parameter SI.Conductance Goff[m](final min=zeros(m), start=
7:         fill(1e-5, m)) "Opened diode conductance";
```
