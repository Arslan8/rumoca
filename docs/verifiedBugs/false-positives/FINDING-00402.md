# FINDING-00402: Zero inductance is an explicitly supported algebraic limit
...
| Original report | [FINDING-comparelinetrunks-oline3-l-3-l-zerolimit.md](../../v2/bugs/FINDING-comparelinetrunks-oline3-l-3-l-zerolimit.md) — reviewed as `FINDING-00402-comparelinetrunks-oline3-l-3-l.md`, which a later run renamed |
| Original SHA-256 | 7a8049b612e02d770859af71e12fbf31528f7db5e226345991730e298be28e28 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `oLine3.lm[3]`; effective min: `None`; effective max: `None`. 
