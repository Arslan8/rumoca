# FINDING-04357: MultiBody Newton/Euler equations use mass and inertia multiplicatively
...
| Original report | `FINDING-04357-mechanicalstructure-load-i-33.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 8b33a2548eb27ac5c9824c51bbef1fc4ed5d0eec2960f886e0f018c1abb2ee6f |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/BodyShape.mo:28`. Role: `parameter`; binding: `0.001`; effective min: `0`; effective max: `None`. 
