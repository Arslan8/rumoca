# FINDING-01677: Zero on-resistance/off-conductance is an intended ideal limit
...
| Original report | [FINDING-imc-inverterdrive-rectifier-diode-n-idealdiode-2-goff-zerolimit.md](../../v2/bugs/FINDING-imc-inverterdrive-rectifier-diode-n-idealdiode-2-goff-zerolimit.md) — reviewed as `FINDING-01677-imc-inverterdrive-rectifier-diode-n-idealdiode-2-goff.md`, which a later run renamed |
| Original SHA-256 | cfdaf0b3061366a93b42f7627c66888c64fe11dde572699d83a23c0a724f23d8 |
