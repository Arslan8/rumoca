# FINDING-00393: Zero capacitance is an explicitly supported algebraic limit
...
| Original report | [FINDING-comparelinetrunks-oline2-c-3-c-zerolimit.md](../../v2/bugs/FINDING-comparelinetrunks-oline2-c-3-c-zerolimit.md) — reviewed as `FINDING-00393-comparelinetrunks-oline2-c-3-c.md`, which a later run renamed |
| Original SHA-256 | 71c9e740db69fa0943216f70008d511472426c18b586662e52e61804832f5c38 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Capacitor.mo:4`. Role: `parameter`; binding: `((oLine2.c * oLine2.length) / oLine2.N)`; effective min: `0`; effective max: `None`. 
