# FINDING-00536: Zero inductance is an explicitly supported algebraic limit
...
| Target | oLine50.L[10].L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-smoothstep-oline50-l-10-l-zerolimit.md](../../v2/bugs/FINDING-smoothstep-oline50-l-10-l-zerolimit.md) — reviewed as `FINDING-00536-smoothstep-oline50-l-10-l.md`, which a later run renamed |
| Original SHA-256 | 9cd60c50d0c378b0a26fbded92842cbc351ef7c407dfc9c30201c8b69d22ff14 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `oLine50.lm[10]`; effective min: `None`; effective max: `None`. 
