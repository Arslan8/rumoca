# FINDING-02767: Zero on-resistance/off-conductance is an intended ideal limit
...
| Original report | [FINDING-rectifier12pulse-diode1-idealdiode-1-ron-ruleoff.md](../../v2/bugs/FINDING-rectifier12pulse-diode1-idealdiode-1-ron-ruleoff.md) — reviewed as `FINDING-02767-rectifier12pulse-diode1-idealdiode-1-ron.md`, which a later run renamed |
| Original SHA-256 | c01ba92486ab76440e5e4c2192f00d0220fb1e2ccbf0ca3fc5078e44c6c4493b |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:4`. Role: `parameter`; binding: `diode1.Ron[1]`; effective min: `0`; effective max: `None`. 
