# FINDING-04889: Machine-data inertia is not intrinsically a positive divisor
...
| Original report | [FINDING-smpm-voltagesourcewithlosses-smpmdata-js-intent.md](../../v2/bugs/FINDING-smpm-voltagesourcewithlosses-smpmdata-js-intent.md) — reviewed as `FINDING-04889-smpm-voltagesourcewithlosses-smpmdata-js.md`, which a later run renamed |
| Original SHA-256 | b0b3bfb9647b38de2edff9b5cc20b052de017ec8d8949022c4f8c1d2b74df1ee |
...
Compiler/source-resolved declaration: `Electrical/Machines/Utilities/ParameterRecords/InductionMachineData.mo:7`. Role: `parameter`; binding: `smpmData.Jr`; effective min: `None`; effective max: `None`. 
