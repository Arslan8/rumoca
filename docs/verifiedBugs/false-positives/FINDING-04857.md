# FINDING-04857: Zero stator leakage inductance is supported
...
| Original report | [FINDING-smpm-voltagesourcewithlosses-smpm-lssigma-intent.md](../../v2/bugs/FINDING-smpm-voltagesourcewithlosses-smpm-lssigma-intent.md) — reviewed as `FINDING-04857-smpm-voltagesourcewithlosses-smpm-lssigma.md`, which a later run renamed |
| Original SHA-256 | d558e7211ceda5852cc7854ced7cb3daaafe6873b58e3e90cb579d2ed4140e83 |
...
Compiler/source-resolved declaration: `Electrical/Machines/Interfaces/PartialBasicInductionMachine.mo:23`. Role: `parameter`; binding: `smpmData.Lssigma`; effective min: `None`; effective max: `None`. 
