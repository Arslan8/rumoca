# FINDING-05094: Vehicle parameter has a multiplicative zero limit
...
| Target | vehicleInclinationInVar.J |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-vehicles-vehicleinclinationinvar-j-intent.md](../../v2/bugs/FINDING-vehicles-vehicleinclinationinvar-j-intent.md) — reviewed as `FINDING-05094-vehicles-vehicleinclinationinvar-j.md`, which a later run renamed |
| Original SHA-256 | fb67652d749f9f254a2b28a98492dce3e2bfcb2255b3076873eb5f386bdb911d |
