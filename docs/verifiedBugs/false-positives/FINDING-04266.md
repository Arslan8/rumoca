# FINDING-04266: MultiBody Newton/Euler equations use mass and inertia multiplicatively
...
| Original report | `FINDING-04266-mechanicalstructure-b1-i-22.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 616085f22768570e6f702c907b698efff4b6ea3a574abad8869c70dc99d3e85a |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/BodyShape.mo:26`. Role: `parameter`; binding: `1.16`; effective min: `0`; effective max: `None`. 
