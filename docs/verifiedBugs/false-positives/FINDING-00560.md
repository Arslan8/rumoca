# FINDING-00560: Zero inductance is an explicitly supported algebraic limit
...
| Target | oLine50.L[34].L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-smoothstep-oline50-l-34-l-zerolimit.md](../../v2/bugs/FINDING-smoothstep-oline50-l-34-l-zerolimit.md) — reviewed as `FINDING-00560-smoothstep-oline50-l-34-l.md`, which a later run renamed |
| Original SHA-256 | b7be35417e6bb0b331c78505ba65fe8bae3ae52c47f96833ff2f453fd6e2f73b |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `oLine50.lm[34]`; effective min: `None`; effective max: `None`. 
