# FINDING-02016: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | switchYD.idealCloser.Ron |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-imc-yd-switchyd-idealcloser-ron-ruleoff.md](../../v2/bugs/FINDING-imc-yd-switchyd-idealcloser-ron-ruleoff.md) — reviewed as `FINDING-02016-imc-yd-switchyd-idealcloser-ron.md`, which a later run renamed |
| Original SHA-256 | 3a0e92ce8b8545009b27bdf7e513650da56751bec4caff52dd3e6b1bff652573 |
...
Compiler/source-resolved declaration: `Electrical/Polyphase/Ideal/IdealClosingSwitch.mo:4`. Role: `parameter`; binding: `fill(switchYD.Ron, switchYD.m)`; effective min: `zeros(3)`; effective max: `None`. 

[Electrical/Polyphase/Ideal/IdealClosingSwitch.mo — source snapshot](../evidence/sources/d530ea6808cfa74c-IdealClosingSwitch.mo)

```modelica
2: model IdealClosingSwitch "Polyphase ideal closer"
