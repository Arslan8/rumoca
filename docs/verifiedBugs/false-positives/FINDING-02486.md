# FINDING-02486: Zero on-resistance/off-conductance is an intended ideal limit
...
| Original report | [FINDING-smpm-resistivebraking-switch2-goff-ruleoff.md](../../v2/bugs/FINDING-smpm-resistivebraking-switch2-goff-ruleoff.md) — reviewed as `FINDING-02486-smpm-resistivebraking-switch2-goff.md`, which a later run renamed |
| Original SHA-256 | 1bc091fa50871a7c486be9439b5dfad3e2ec738d0588712eb8762e84718e26f9 |
...
Compiler/source-resolved declaration: `Electrical/Polyphase/Ideal/IdealClosingSwitch.mo:6`. Role: `parameter`; binding: `fill(1e-09, m)`; effective min: `zeros(3)`; effective max: `None`. 
