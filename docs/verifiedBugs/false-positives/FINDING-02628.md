# FINDING-02628: Air-gap inductance is used as a flux multiplier
...
| Original report | [FINDING-smr-inverter-smr-airgap-l-zerolimit.md](../../v2/bugs/FINDING-smr-inverter-smr-airgap-l-zerolimit.md) — reviewed as `FINDING-02628-smr-inverter-smr-airgap-l.md`, which a later run renamed |
| Original SHA-256 | 72ce18a704fedd113ef148b7ed6d187260d2594fe1f840779f8f9979cd5f744a |
...
Compiler/source-resolved declaration: `Electrical/Machines/BasicMachines/Components/AirGapR.mo:11`. Role: `parameter`; binding: `{{smr.airGap.Lmd, 0}, {0, smr.airGap.Lmq}}`; effective min: `None`; effective max: `None`. 
