# FINDING-00861: Zero capacitance is an explicitly supported algebraic limit
...
| Target | firstOrder.c.C |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-lowpass-firstorder-c-c-zerolimit.md](../../v2/bugs/FINDING-lowpass-firstorder-c-c-zerolimit.md) — reviewed as `FINDING-00861-lowpass-firstorder-c-c.md`, which a later run renamed |
| Original SHA-256 | 24d26ac4ef0e1a653157c4f91baa3328565edfdc8c894518c12b4ca65baf07ba |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Capacitor.mo:4`. Role: `parameter`; binding: `firstOrder.C`; effective min: `0`; effective max: `None`. 
...
| Probe | Outcome |
|---|---|
| `firstOrder.c.C=0` | reported-failure |
