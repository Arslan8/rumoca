# FINDING-00159: Signed resistance is intentional and the divisor is bounded away from zero
...
| Original report | [FINDING-cauerlowpasssc-r8-r-ruleoff.md](../../v2/bugs/FINDING-cauerlowpasssc-r8-r-ruleoff.md) — reviewed as `FINDING-00159-cauerlowpasssc-r8-r.md`, which a later run renamed |
| Original SHA-256 | 8dbcc73e2e402dbb5e278a4142adbf169ef7acaf6cf15a2c378fef4a57be04eb |
