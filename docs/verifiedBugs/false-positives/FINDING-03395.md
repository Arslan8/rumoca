# FINDING-03395: Zero on-resistance/off-conductance is an intended ideal limit
...
| Original report | [FINDING-thyristorcentertap2mpulse-r-rectifier-thyristor-p-idealthyristor-1-ron.md](../../v2/bugs/FINDING-thyristorcentertap2mpulse-r-rectifier-thyristor-p-idealthyristor-1-ron.md) — reviewed as `FINDING-03395-thyristorcentertap2mpulse-r-rectifier-thyristor-p-idealthyristor-1-ron.md`, which a later run renamed |
| Original SHA-256 | 317b7a57b454410e6cab680a312bf89cc44c85ddbebe52afe697a5a04e7d3b15 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:4`. Role: `parameter`; binding: `rectifier.thyristor_p.Ron[1]`; effective min: `0`; effective max: `None`. 
