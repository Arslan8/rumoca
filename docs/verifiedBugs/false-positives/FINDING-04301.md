# FINDING-04301: MultiBody Newton/Euler equations use mass and inertia multiplicatively
...
| Original report | [FINDING-mechanicalstructure-b3-body-m-zerolimit.md](../../v2/bugs/FINDING-mechanicalstructure-b3-body-m-zerolimit.md) — reviewed as `FINDING-04301-mechanicalstructure-b3-body-m.md`, which a later run renamed |
| Original SHA-256 | f2e35d2c0f657a9885df51732e6c71b5fe74d65f7896151f886d19d212162397 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:16`. Role: `parameter`; binding: `26.4`; effective min: `0`; effective max: `None`. 
