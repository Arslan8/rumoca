# FINDING-02939: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | idealDiode1.idealDiode[2].Ron |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-rectifier-idealdiode1-idealdiode-2-ron-ruleoff.md](../../v2/bugs/FINDING-rectifier-idealdiode1-idealdiode-2-ron-ruleoff.md) — reviewed as `FINDING-02939-rectifier-idealdiode1-idealdiode-2-ron.md`, which a later run renamed |
| Original SHA-256 | 892b053c5df5828eae5d93a2215150e70780a700e40d6c8187c599ae6b6620c2 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:4`. Role: `parameter`; binding: `idealDiode1.Ron[2]`; effective min: `0`; effective max: `None`. 
