# FINDING-00248: Zero capacitance is an explicitly supported algebraic limit
...
| Original report | [FINDING-generationoffmus-directcapacitor1-capacitor-c-zerolimit.md](../../v2/bugs/FINDING-generationoffmus-directcapacitor1-capacitor-c-zerolimit.md) — reviewed as `FINDING-00248-generationoffmus-directcapacitor1-capacitor-c.md`, which a later run renamed |
| Original SHA-256 | ee77f95929c84ebd108f4ced16f3018a25e3fce685d0711debf5429d3d51d99e |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Capacitor.mo:4`. Role: `parameter`; binding: `0.001`; effective min: `0`; effective max: `None`. 
