# FINDING-03889: Zero ElastoGap stiffness is handled without division
...
| Target | stopper_xMax.c |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-translatoryarmatureandstopper-stopper-xmax-c-zerolimit.md](../../v2/bugs/FINDING-translatoryarmatureandstopper-stopper-xmax-c-zerolimit.md) — reviewed as `FINDING-03889-translatoryarmatureandstopper-stopper-xmax-c.md`, which a later run renamed |
| Original SHA-256 | 273ce8fc65a1ad4a5d1f49e152f8a49517864589f2291b118ef67dfe6a605c16 |
