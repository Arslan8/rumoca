# FINDING-04201: Tensor entries are not all strictly positive scalars
...
| Original report | [FINDING-planarfourbar-body3-i-tensorunknown.md](../../v2/bugs/FINDING-planarfourbar-body3-i-tensorunknown.md) — reviewed as `FINDING-04201-planarfourbar-body3-i.md`, which a later run renamed |
| Original SHA-256 | c3d3796e46136111cf2b97314efad936187056a714a5d53adffa06a8567ffc2a |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/BodyBox.mo:111`. Role: `parameter`; binding: `Modelica.Mechanics.MultiBody.Frames.resolveDyade1(body3.R.T, body3.R.w, diagonal(({((body3.mo * ((body3.width * body3.width) + (body3.height * body3.height))) - (body3.mi * ((body3.innerWidth * body3.innerWidth) + (body3.innerHeight * body3.innerHeight)))), ((body3.mo * ((body3.length * body3.length) + (body3.height * body3.height))) - (body3.mi * ((body3.length * body3.length) + (body3.innerHeight * body3.innerHeight)))), ((body3.mo * ((body3.length * body3.length) + (body3.width * body3.width))) - (body3.mi * ((body3.length * body3.length) + (body3.innerWidth * body3.innerWidth))))} / 12)))`; effective min: `None`; effective max: `None`. 
