# FINDING-03518: Zero on-resistance/off-conductance is an intended ideal limit
...
| Original report | [FINDING-singlephasetwolevel-rl-inverter-transistor-p-ron-ruleoff.md](../../v2/bugs/FINDING-singlephasetwolevel-rl-inverter-transistor-p-ron-ruleoff.md) — reviewed as `FINDING-03518-singlephasetwolevel-rl-inverter-transistor-p-ron.md`, which a later run renamed |
| Original SHA-256 | 16e3cf758e31686973b792f972c063d2e1c5a3a3826115a4700e97bdda9f69ad |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:4`. Role: `parameter`; binding: `inverter.RonTransistor`; effective min: `0`; effective max: `None`. 
