# FINDING-02827: Zero inductance is an explicitly supported algebraic limit
...
| Target | transformer2.l1sigma.inductor[3].L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-rectifier12pulse-transformer2-l1sigma-inductor-3-l-zerolimit.md](../../v2/bugs/FINDING-rectifier12pulse-transformer2-l1sigma-inductor-3-l-zerolimit.md) — reviewed as `FINDING-02827-rectifier12pulse-transformer2-l1sigma-inductor-3-l.md`, which a later run renamed |
| Original SHA-256 | 553e5c75dff5430bcfad15fa95621af23ea7d1f0fcd59477563594efaa5ec451 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `transformer2.l1sigma.L[3]`; effective min: `None`; effective max: `None`. 
