# FINDING-02741: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | idealCommutingSwitch.idealCommutingSwitch[2].Goff |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-imc-transformer-idealcommutingswitch-idealcommutingswitch-2-goff-ruleo-2.md](../../v2/bugs/FINDING-imc-transformer-idealcommutingswitch-idealcommutingswitch-2-goff-ruleo-2.md) — reviewed as `FINDING-02741-imc-transformer-idealcommutingswitch-idealcommutingswitch-2-goff.md`, which a later run renamed |
| Original SHA-256 | 26a005820fd40f1bd505161872d7c79c4fa5442338f35b6c990941081fd7ab2b |
...
Compiler/source-resolved declaration: `Electrical/Analog/Ideal/IdealTwoWaySwitch.mo:4`. Role: `parameter`; binding: `idealCommutingSwitch.Goff[2]`; effective min: `0`; effective max: `None`. 
