# FINDING-03456: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | rectifier.diode.Goff |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-diodecentertapmpulse-rectifier-diode-goff-ruleoff.md](../../v2/bugs/FINDING-diodecentertapmpulse-rectifier-diode-goff-ruleoff.md) — reviewed as `FINDING-03456-diodecentertapmpulse-rectifier-diode-goff.md`, which a later run renamed |
| Original SHA-256 | d39079d808dd479d0bc62d64ed12f31633154f091bfb9a1c98633a3190a7293f |
