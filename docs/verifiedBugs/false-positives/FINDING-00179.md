# FINDING-00179: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | With_Ron_Goff.Goff |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-characteristicidealdiodes-with-ron-goff-goff-zerolimit.md](../../v2/bugs/FINDING-characteristicidealdiodes-with-ron-goff-goff-zerolimit.md) — reviewed as `FINDING-00179-characteristicidealdiodes-with-ron-goff-goff.md`, which a later run renamed |
| Original SHA-256 | edee049aba811096f785212a0256088f2cf1ea9db8ab9a752dce4222c8c01033 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:6`. Role: `parameter`; binding: `0.1`; effective min: `0`; effective max: `None`. 
