# FINDING-00097: Zero capacitance is an explicitly supported algebraic limit
...
| Target | R9.Capacitor.C |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-cauerlowpasssc-r9-capacitor-c-zerolimit.md](../../v2/bugs/FINDING-cauerlowpasssc-r9-capacitor-c-zerolimit.md) — reviewed as `FINDING-00097-cauerlowpasssc-r9-capacitor-c.md`, which a later run renamed |
| Original SHA-256 | 819b6b3d3acf6d83209afe5cf154fb55ca5096f9a0d0c8a573a226f107701cc0 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Capacitor.mo:4`. Role: `parameter`; binding: `(R9.clock / max((2.220446049250313e-16 * R9.oneOhm), abs(R9.R)))`; effective min: `0`; effective max: `None`. 
