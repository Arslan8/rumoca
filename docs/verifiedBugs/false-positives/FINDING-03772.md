# FINDING-03772: Zero mass is a massless algebraic component, not an intrinsic division
...
| Original report | [FINDING-armaturestroke-pmload-m-zerolimit.md](../../v2/bugs/FINDING-armaturestroke-pmload-m-zerolimit.md) — reviewed as `FINDING-03772-armaturestroke-pmload-m.md`, which a later run renamed |
| Original SHA-256 | 4d13fcdb8c67be7dd773ef2bf9f13cafd21d99f129c3ff452b90b3a09bbbb5cd |
...
Compiler/source-resolved declaration: `Mechanics/Translational/Components/Mass.mo:3`. Role: `parameter`; binding: `0.05`; effective min: `0`; effective max: `None`. 
