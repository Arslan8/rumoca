# FINDING-03576: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | chopperStepDown.diode.Ron |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-chopperstepdown-rl-chopperstepdown-diode-ron-ruleoff.md](../../v2/bugs/FINDING-chopperstepdown-rl-chopperstepdown-diode-ron-ruleoff.md) — reviewed as `FINDING-03576-chopperstepdown-rl-chopperstepdown-diode-ron.md`, which a later run renamed |
| Original SHA-256 | 1fb3bbc25d7a640a0d52887cca195ecf3b59f92323b4dd77d6e26d88596a872f |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:4`. Role: `parameter`; binding: `chopperStepDown.RonDiode`; effective min: `0`; effective max: `None`. 
