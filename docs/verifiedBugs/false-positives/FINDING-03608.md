# FINDING-03608: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | chopperStepUp.transistor.Ron |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-chopperstepup-r-chopperstepup-transistor-ron-ruleoff.md](../../v2/bugs/FINDING-chopperstepup-r-chopperstepup-transistor-ron-ruleoff.md) — reviewed as `FINDING-03608-chopperstepup-r-chopperstepup-transistor-ron.md`, which a later run renamed |
| Original SHA-256 | 8963f8ebe27a520f19d3c6bd26285feec644ad984bde228beb176258dd39f79f |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:4`. Role: `parameter`; binding: `chopperStepUp.RonTransistor`; effective min: `0`; effective max: `None`. 
