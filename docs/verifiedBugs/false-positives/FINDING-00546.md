# FINDING-00546: Zero inductance is an explicitly supported algebraic limit
...
| Target | oLine50.L[20].L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-smoothstep-oline50-l-20-l-zerolimit.md](../../v2/bugs/FINDING-smoothstep-oline50-l-20-l-zerolimit.md) — reviewed as `FINDING-00546-smoothstep-oline50-l-20-l.md`, which a later run renamed |
| Original SHA-256 | 604b5a11a43291d754ed1e81c204124ffaac9b250245c6b16f61d3e876efaa0f |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `oLine50.lm[20]`; effective min: `None`; effective max: `None`. 
