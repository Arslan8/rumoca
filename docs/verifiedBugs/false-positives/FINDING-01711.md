# FINDING-01711: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | inverter.diode_n.idealDiode[1].Ron |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-imc-inverterdrive-inverter-diode-n-idealdiode-1-ron-ruleoff.md](../../v2/bugs/FINDING-imc-inverterdrive-inverter-diode-n-idealdiode-1-ron-ruleoff.md) — reviewed as `FINDING-01711-imc-inverterdrive-inverter-diode-n-idealdiode-1-ron.md`, which a later run renamed |
| Original SHA-256 | 52444c8b061d09ce8d191a8a02644adb97e939f7bafa3d660aa5c37f136cc2c3 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:4`. Role: `parameter`; binding: `inverter.diode_n.Ron[1]`; effective min: `0`; effective max: `None`. 
