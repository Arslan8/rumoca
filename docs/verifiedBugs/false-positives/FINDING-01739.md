# FINDING-01739: Zero leakage inductance is a supported ideal limit
...
| Target | aimcData.Lssigma |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-imc-inverterdrive-aimcdata-lssigma-intent.md](../../v2/bugs/FINDING-imc-inverterdrive-aimcdata-lssigma-intent.md) — reviewed as `FINDING-01739-imc-inverterdrive-aimcdata-lssigma.md`, which a later run renamed |
| Original SHA-256 | 069a7eeb3596053608673941943c38a604972a251fe689adffc8275f539bab8a |
...
Compiler/source-resolved declaration: `Electrical/Machines/Utilities/ParameterRecords/InductionMachineData.mo:23`. Role: `parameter`; binding: `(((3 * (1 - sqrt((1 - 0.0667)))) / ((2 * (2 * asin(1.0))) * aimcData.fsNominal)) * 16)`; effective min: `None`; effective max: `None`. 
