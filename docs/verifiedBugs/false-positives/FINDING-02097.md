# FINDING-02097: Zero leakage inductance is a supported ideal limit
...
| Target | aimsData.Lszero |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-ims-start-aimsdata-lszero-intent.md](../../v2/bugs/FINDING-ims-start-aimsdata-lszero-intent.md) — reviewed as `FINDING-02097-ims-start-aimsdata-lszero.md`, which a later run renamed |
| Original SHA-256 | 060d0142ec45a19cd921a82f799111443005718d02e005193f1f089419122808 |
...
Compiler/source-resolved declaration: `Electrical/Machines/Utilities/ParameterRecords/InductionMachineData.mo:20`. Role: `parameter`; binding: `aimsData.Lssigma`; effective min: `None`; effective max: `None`. 
