# FINDING-02073: Zero space-phasor inductance is an algebraic ideal limit
...
| Target | aims.lrsigma.L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-ims-start-aims-lrsigma-l-intent.md](../../v2/bugs/FINDING-ims-start-aims-lrsigma-l-intent.md) — reviewed as `FINDING-02073-ims-start-aims-lrsigma-l.md`, which a later run renamed |
| Original SHA-256 | 78ea3a2178eee1356c7a99a95c204796103a025e2a7f99b063a538567c38bfb5 |
...
Compiler/source-resolved declaration: `Electrical/Machines/BasicMachines/Components/Inductor.mo:3`. Role: `parameter`; binding: `fill(((aims.internalTurnsRatio ^ 2) * aims.Lrsigma), 2)`; effective min: `None`; effective max: `None`. 
