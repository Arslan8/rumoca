# FINDING-00987: Zero capacitance is an explicitly supported algebraic limit
...
| Original report | [FINDING-seriesresonance-capacitor1-c-zerolimit.md](../../v2/bugs/FINDING-seriesresonance-capacitor1-c-zerolimit.md) — reviewed as `FINDING-00987-seriesresonance-capacitor1-c.md`, which a later run renamed |
| Original SHA-256 | b75c06e271ce3f46dd097f54c1a720e574eba68af8f924a293a80913dcf80345 |
...
Diagnostic: solve-IR evaluation failed: non-finite derivative evaluation for state 'sineVoltage.p.v'
