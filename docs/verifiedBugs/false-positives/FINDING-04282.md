# FINDING-04282: MultiBody Newton/Euler equations use mass and inertia multiplicatively
...
| Original report | `FINDING-04282-mechanicalstructure-b2-i-33.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 9b20c7140f36ff84ca22086e767ff415a5b46ab51b98ca02d7cd48b5ccf8a916 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/BodyShape.mo:28`. Role: `parameter`; binding: `2.73`; effective min: `0`; effective max: `None`. 
