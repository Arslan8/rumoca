# FINDING-03961: MultiBody Newton/Euler equations use mass and inertia multiplicatively
...
| Original report | `FINDING-03961-freebody-body-body-i-11.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 41b1a76589b7c25782ced7458215019335ef06de5f42d8a5ff2a3cde3ca03768 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:17`. Role: `parameter`; binding: `1`; effective min: `0`; effective max: `None`. 
