# FINDING-03393: Zero on-resistance/off-conductance is an intended ideal limit
...
| Original report | [FINDING-thyristorcentertap2mpulse-r-rectifier-thyristor-p-ron-ruleoff.md](../../v2/bugs/FINDING-thyristorcentertap2mpulse-r-rectifier-thyristor-p-ron-ruleoff.md) — reviewed as `FINDING-03393-thyristorcentertap2mpulse-r-rectifier-thyristor-p-ron.md`, which a later run renamed |
| Original SHA-256 | 5d01fd8fa4131cee910a42207f2054863f309de5ac085e828630b04069f3d41c |
...
Compiler/source-resolved declaration: `Electrical/Polyphase/Ideal/IdealThyristor.mo:4`. Role: `parameter`; binding: `fill(rectifier.RonThyristor, rectifier.m)`; effective min: `zeros(3)`; effective max: `None`. 

[Electrical/Polyphase/Ideal/IdealThyristor.mo — source snapshot](../evidence/sources/d251257ff1c2a526-IdealThyristor.mo)

```modelica
2: model IdealThyristor "Polyphase ideal thyristor"
...
[Rumoca commands, return codes, integrity hashes, bounded output and metadata](../evidence/02b5f3b22d4dc006.json). Baseline: **tool-error**.
