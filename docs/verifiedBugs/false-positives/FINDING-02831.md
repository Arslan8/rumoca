# FINDING-02831: Zero inductance is an explicitly supported algebraic limit
...
| Target | transformer2.l2sigma.inductor[2].L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-rectifier12pulse-transformer2-l2sigma-inductor-2-l-zerolimit.md](../../v2/bugs/FINDING-rectifier12pulse-transformer2-l2sigma-inductor-2-l-zerolimit.md) — reviewed as `FINDING-02831-rectifier12pulse-transformer2-l2sigma-inductor-2-l.md`, which a later run renamed |
| Original SHA-256 | b5191ca757f5294371e27b5ad369d54f3f1fed6a82717f43802064e104e9e7f8 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `transformer2.l2sigma.L[2]`; effective min: `None`; effective max: `None`. 
