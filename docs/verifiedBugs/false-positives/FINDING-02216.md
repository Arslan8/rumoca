# FINDING-02216: Zero inductance is an explicitly supported algebraic limit
...
| Target | smee.lesigma.L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-smee-generator-smee-lesigma-l-zerolimit.md](../../v2/bugs/FINDING-smee-generator-smee-lesigma-l-zerolimit.md) — reviewed as `FINDING-02216-smee-generator-smee-lesigma-l.md`, which a later run renamed |
| Original SHA-256 | f3093d1f5fcd09b6780d4410dbbd27697cc0728a513a8a996684666c0a411c7a |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `smee.Lesigma`; effective min: `None`; effective max: `None`. 
