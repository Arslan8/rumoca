# FINDING-00422: Zero inductance is an explicitly supported algebraic limit
...
| Original report | [FINDING-comparelinetrunks-oline4-l-6-l-zerolimit.md](../../v2/bugs/FINDING-comparelinetrunks-oline4-l-6-l-zerolimit.md) — reviewed as `FINDING-00422-comparelinetrunks-oline4-l-6-l.md`, which a later run renamed |
| Original SHA-256 | 9c00cf7ee4af6d372ef66ed3ac95a4694924d95a1da8f90a61d1126ec9719213 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `oLine4.lm[6]`; effective min: `None`; effective max: `None`. 
