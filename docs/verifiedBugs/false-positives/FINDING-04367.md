# FINDING-04367: Tensor entries are not all strictly positive scalars
...
| Target | load.body.I_32 |
| Student classification | physical-domain-unenforced |
| Original report | `FINDING-04367-mechanicalstructure-load-body-i-32.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 1c4d82d008e0201679433b345e40982641c735155cecbe71f8e72607d6433a4c |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:27`. Role: `parameter`; binding: `load.I_32`; effective min: `-1.7976931348623157e+308`; effective max: `None`. 
