# FINDING-03693: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | hbridge.inverter_p.transistor_n.Goff |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-hbridge-trianglepwm-rl-hbridge-inverter-p-transistor-n-goff-zerolimit.md](../../v2/bugs/FINDING-hbridge-trianglepwm-rl-hbridge-inverter-p-transistor-n-goff-zerolimit.md) — reviewed as `FINDING-03693-hbridge-trianglepwm-rl-hbridge-inverter-p-transistor-n-goff.md`, which a later run renamed |
| Original SHA-256 | 602555b7c36ce1bce60a10bb1be6659bdb36e3569298766adaf7220a100fd893 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:6`. Role: `parameter`; binding: `hbridge.inverter_p.GoffTransistor`; effective min: `0`; effective max: `None`. 
