# FINDING-03757: Zeroing this operand does not zero the complete denominator
...
| Target | airGap.material.c_b |
| Student classification | divisor-reachable-zero |
| Original report | `FINDING-03757-toroidalcorequadraticcrosssection-airgap-material-c-b.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 8464ca0fadb4a585948c405f2612c0124f0bd7eb7cf1bb2929bfffacbae7a328 |
