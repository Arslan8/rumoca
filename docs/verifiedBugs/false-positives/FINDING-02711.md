# FINDING-02711: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | idealCloser.idealClosingSwitch[1].Goff |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-imc-transformer-idealcloser-idealclosingswitch-1-goff-ruleoff-2.md](../../v2/bugs/FINDING-imc-transformer-idealcloser-idealclosingswitch-1-goff-ruleoff-2.md) — reviewed as `FINDING-02711-imc-transformer-idealcloser-idealclosingswitch-1-goff.md`, which a later run renamed |
| Original SHA-256 | a96784b0a90355eb970e295674cb576b272f3b51af4fc021b8298ddbc32f576e |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSwitch.mo:6`. Role: `parameter`; binding: `idealCloser.Goff[1]`; effective min: `0`; effective max: `None`. 
