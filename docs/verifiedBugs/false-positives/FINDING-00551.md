# FINDING-00551: Zero inductance is an explicitly supported algebraic limit
...
| Target | oLine50.L[25].L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-smoothstep-oline50-l-25-l-zerolimit.md](../../v2/bugs/FINDING-smoothstep-oline50-l-25-l-zerolimit.md) — reviewed as `FINDING-00551-smoothstep-oline50-l-25-l.md`, which a later run renamed |
| Original SHA-256 | 937fc06542388fa3c66eb121a6979a934f32f56d2f9f3d911eaf42e353126af2 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `oLine50.lm[25]`; effective min: `None`; effective max: `None`. 
