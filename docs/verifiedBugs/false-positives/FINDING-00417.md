# FINDING-00417: Zero inductance is an explicitly supported algebraic limit
...
| Original report | [FINDING-comparelinetrunks-oline4-l-1-l-zerolimit.md](../../v2/bugs/FINDING-comparelinetrunks-oline4-l-1-l-zerolimit.md) — reviewed as `FINDING-00417-comparelinetrunks-oline4-l-1-l.md`, which a later run renamed |
| Original SHA-256 | cac9cd1f654461c021a5f5cff546e1f537fcd3713370e1d42f69ff414a1bb63a |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `oLine4.lm[1]`; effective min: `None`; effective max: `None`. 
