# FINDING-00549: Zero inductance is an explicitly supported algebraic limit
...
| Target | oLine50.L[23].L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-smoothstep-oline50-l-23-l-zerolimit.md](../../v2/bugs/FINDING-smoothstep-oline50-l-23-l-zerolimit.md) — reviewed as `FINDING-00549-smoothstep-oline50-l-23-l.md`, which a later run renamed |
| Original SHA-256 | bcbb7892dc41d873d7f9e02a19433e9189a103a8f23719e4eb79d9611ce876f6 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `oLine50.lm[23]`; effective min: `None`; effective max: `None`. 
