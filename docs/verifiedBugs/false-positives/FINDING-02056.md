# FINDING-02056: Zero stator leakage inductance is supported
...
| Original report | [FINDING-ims-start-aims-lszero-zerolimit.md](../../v2/bugs/FINDING-ims-start-aims-lszero-zerolimit.md) — reviewed as `FINDING-02056-ims-start-aims-lszero.md`, which a later run renamed |
| Original SHA-256 | 717e0702dd5d6527fc87bcbc7c604ff14afdeb2ee274ea60b1c3a4cedfabdd58 |
...
Compiler/source-resolved declaration: `Electrical/Machines/Interfaces/PartialBasicInductionMachine.mo:20`. Role: `parameter`; binding: `aimsData.Lszero`; effective min: `None`; effective max: `None`. 
