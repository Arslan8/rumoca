# FINDING-03196: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | rectifier.diode_p1.Ron |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-diodebridge2pulse-rectifier-diode-p1-ron-ruleoff.md](../../v2/bugs/FINDING-diodebridge2pulse-rectifier-diode-p1-ron-ruleoff.md) — reviewed as `FINDING-03196-diodebridge2pulse-rectifier-diode-p1-ron.md`, which a later run renamed |
| Original SHA-256 | b02bc38cfa7a705441ef7bf7e911862e8d248a32751f2166f7d4bf535768e9f3 |
