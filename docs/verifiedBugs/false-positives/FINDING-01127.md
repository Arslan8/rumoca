# FINDING-01127: Zero DC-machine inductance is an algebraic ideal limit
...
| Original report | [FINDING-dc-comparecharacteristics-dcse-lesigma-l-zerolimit.md](../../v2/bugs/FINDING-dc-comparecharacteristics-dcse-lesigma-l-zerolimit.md) — reviewed as `FINDING-01127-dc-comparecharacteristics-dcse-lesigma-l.md`, which a later run renamed |
| Original SHA-256 | 429055ec2244459389f502003ed7bf0403770398c1ec64f30ef8668186007468 |
...
Compiler/source-resolved declaration: `Electrical/Machines/BasicMachines/Components/InductorDC.mo:5`. Role: `parameter`; binding: `dcse.Lesigma`; effective min: `None`; effective max: `None`. 
