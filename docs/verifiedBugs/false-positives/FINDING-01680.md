# FINDING-01680: Zero capacitance is an explicitly supported algebraic limit
...
| Original report | [FINDING-imc-inverterdrive-capacitor-c-zerolimit.md](../../v2/bugs/FINDING-imc-inverterdrive-capacitor-c-zerolimit.md) — reviewed as `FINDING-01680-imc-inverterdrive-capacitor-c.md`, which a later run renamed |
| Original SHA-256 | ca3d1a4a6a1592722ef1894a84616213d4c506c199b7c6aadb73c4755b88a25a |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Capacitor.mo:4`. Role: `parameter`; binding: `CDC`; effective min: `0`; effective max: `None`. 
