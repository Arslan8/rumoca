# FINDING-00388: Zero inductance is an explicitly supported algebraic limit
...
| Original report | [FINDING-comparelinetrunks-oline2-l-6-l-zerolimit.md](../../v2/bugs/FINDING-comparelinetrunks-oline2-l-6-l-zerolimit.md) — reviewed as `FINDING-00388-comparelinetrunks-oline2-l-6-l.md`, which a later run renamed |
| Original SHA-256 | ecf26961902eb553f775728ed450bf2ae07a4a8f9691826eae5fce0b3b933cd6 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `oLine2.lm[6]`; effective min: `None`; effective max: `None`. 
