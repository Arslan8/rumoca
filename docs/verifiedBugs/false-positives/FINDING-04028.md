# FINDING-04028: Zero stiffness is a force-free spring limit
...
| Original report | [FINDING-initspringconstant-spring-spring-c-zerolimit.md](../../v2/bugs/FINDING-initspringconstant-spring-spring-c-zerolimit.md) — reviewed as `FINDING-04028-initspringconstant-spring-spring-c.md`, which a later run renamed |
| Original SHA-256 | 29b328405bb3b28c0051c36381c397e6f402c60989de211236558687c286bbc4 |
...
Compiler/source-resolved declaration: `Mechanics/Translational/Components/Spring.mo:4`. Role: `parameter`; binding: `spring.c`; effective min: `0`; effective max: `None`. 
