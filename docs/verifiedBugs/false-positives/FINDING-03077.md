# FINDING-03077: Machine inertia delegates to the zero-capable algebraic inertia component
...
| Original report | [FINDING-thyristorbridge2mpulse-dc-drive-dcpm-jr-zerolimit.md](../../v2/bugs/FINDING-thyristorbridge2mpulse-dc-drive-dcpm-jr-zerolimit.md) — reviewed as `FINDING-03077-thyristorbridge2mpulse-dc-drive-dcpm-jr.md`, which a later run renamed |
| Original SHA-256 | 9a664e09376d3e9915ba70898694c0b797cce1eac4dd500633f817341070f579 |
...
Compiler/source-resolved declaration: `Electrical/Machines/Interfaces/PartialBasicMachine.mo:5`. Role: `parameter`; binding: `dcpmData.Jr`; effective min: `None`; effective max: `None`. 
