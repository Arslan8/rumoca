# FINDING-03700: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | hbridge.inverter_n.transistor_p.Ron |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-hbridge-trianglepwm-rl-hbridge-inverter-n-transistor-p-ron-ruleoff.md](../../v2/bugs/FINDING-hbridge-trianglepwm-rl-hbridge-inverter-n-transistor-p-ron-ruleoff.md) — reviewed as `FINDING-03700-hbridge-trianglepwm-rl-hbridge-inverter-n-transistor-p-ron.md`, which a later run renamed |
| Original SHA-256 | 96463453f5a32b08a635cd486a6e5d7f595010b41854914e3c1d81f633ae5f66 |
