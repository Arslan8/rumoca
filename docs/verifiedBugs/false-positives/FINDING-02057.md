# FINDING-02057: Zero stator leakage inductance is supported
...
| Original report | [FINDING-ims-start-aims-lssigma-unbounded.md](../../v2/bugs/FINDING-ims-start-aims-lssigma-unbounded.md) — reviewed as `FINDING-02057-ims-start-aims-lssigma.md`, which a later run renamed |
| Original SHA-256 | 965d4171bc324a9d5ddced7a4c5aa629d762101230ccb60dcdde89a0269728cf |
...
Compiler/source-resolved declaration: `Electrical/Machines/Interfaces/PartialBasicInductionMachine.mo:23`. Role: `parameter`; binding: `aimsData.Lssigma`; effective min: `None`; effective max: `None`. 
