# FINDING-00370: Zero inductance is an explicitly supported algebraic limit
...
| Original report | [FINDING-comparelinetrunks-oline1-l-5-l-zerolimit.md](../../v2/bugs/FINDING-comparelinetrunks-oline1-l-5-l-zerolimit.md) — reviewed as `FINDING-00370-comparelinetrunks-oline1-l-5-l.md`, which a later run renamed |
| Original SHA-256 | eba0e65b968ddc1d871b5cd29a1bbbd719ada5fed196153766bf3adb797829b0 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `oLine1.lm[5]`; effective min: `None`; effective max: `None`. 
