# FINDING-04151: MultiBody spring mass/stiffness has an intentional zero limit
...
| Original report | [FINDING-threesprings-spring2-c-intent.md](../../v2/bugs/FINDING-threesprings-spring2-c-intent.md) — reviewed as `FINDING-04151-threesprings-spring2-c.md`, which a later run renamed |
| Original SHA-256 | 8c8ac9a9797d3aa049aa220917065947e9c201c87f7cec00c2eca83a5026bb7b |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Forces/Spring.mo:9`. Role: `parameter`; binding: `40`; effective min: `0`; effective max: `None`. 
