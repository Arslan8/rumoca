# FINDING-01449: DC machine-data field has a supported ideal limit
...
| Original report | [FINDING-dcpm-withlosses-dcpmdata1-js-intent.md](../../v2/bugs/FINDING-dcpm-withlosses-dcpmdata1-js-intent.md) — reviewed as `FINDING-01449-dcpm-withlosses-dcpmdata1-js.md`, which a later run renamed |
| Original SHA-256 | a0ce1d6284032c512a3a867df6849440c4329ba641f717ecd41a3e2fc4cd90f8 |
...
Compiler/source-resolved declaration: `Electrical/Machines/Utilities/ParameterRecords/DcPermanentMagnetData.mo:6`. Role: `parameter`; binding: `dcpmData1.Jr`; effective min: `None`; effective max: `None`. 
