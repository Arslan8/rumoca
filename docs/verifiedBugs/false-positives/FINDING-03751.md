# FINDING-03751: Zeroing this operand does not zero the complete denominator
...
| Target | core.material.c_b |
| Student classification | divisor-reachable-zero |
| Original report | `FINDING-03751-toroidalcorequadraticcrosssection-core-material-c-b.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 8df85e0b4dc6e2fc7784263be06251f4eae62c9f5c9d0380d381873550659929 |
