# FINDING-02713: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | idealCloser.idealClosingSwitch[2].Goff |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-imc-transformer-idealcloser-idealclosingswitch-2-goff-ruleoff-2.md](../../v2/bugs/FINDING-imc-transformer-idealcloser-idealclosingswitch-2-goff-ruleoff-2.md) — reviewed as `FINDING-02713-imc-transformer-idealcloser-idealclosingswitch-2-goff.md`, which a later run renamed |
| Original SHA-256 | 90d6a575e2091d8712b313f64b9640076500cdefc02d7f71a6e8c571e9257480 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSwitch.mo:6`. Role: `parameter`; binding: `idealCloser.Goff[2]`; effective min: `0`; effective max: `None`. 
