# FINDING-02712: Zero on-resistance/off-conductance is an intended ideal limit
...
| Original report | [FINDING-imc-transformer-idealcloser-idealclosingswitch-2-ron-ruleoff-2.md](../../v2/bugs/FINDING-imc-transformer-idealcloser-idealclosingswitch-2-ron-ruleoff-2.md) — reviewed as `FINDING-02712-imc-transformer-idealcloser-idealclosingswitch-2-ron.md`, which a later run renamed |
| Original SHA-256 | 58aa51ef7b6d529352b9aa449d2da7b5a13d17566af964dd450e90dcce46bb31 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSwitch.mo:4`. Role: `parameter`; binding: `idealCloser.Ron[2]`; effective min: `0`; effective max: `None`. 
