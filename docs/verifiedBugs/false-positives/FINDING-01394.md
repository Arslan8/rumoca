# FINDING-01394: Zero inertia is a massless algebraic component, not an intrinsic division
...
| Original report | [FINDING-dcpm-start-loadinertia-j-zerolimit.md](../../v2/bugs/FINDING-dcpm-start-loadinertia-j-zerolimit.md) — reviewed as `FINDING-01394-dcpm-start-loadinertia-j.md`, which a later run renamed |
| Original SHA-256 | 32c4cf57a0976c5178fb528d389646dbacf88f0435a41acac2c882c82a067c43 |
