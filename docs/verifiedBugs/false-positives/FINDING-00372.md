# FINDING-00372: Zero inductance is an explicitly supported algebraic limit
...
| Original report | [FINDING-comparelinetrunks-oline1-l-7-l-zerolimit.md](../../v2/bugs/FINDING-comparelinetrunks-oline1-l-7-l-zerolimit.md) — reviewed as `FINDING-00372-comparelinetrunks-oline1-l-7-l.md`, which a later run renamed |
| Original SHA-256 | dbf9217ac876208e24d30a5aa035e6f433e41f42de1835482efb5530397cb02f |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `oLine1.lm[7]`; effective min: `None`; effective max: `None`. 
