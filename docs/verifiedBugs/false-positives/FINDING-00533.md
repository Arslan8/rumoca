# FINDING-00533: Zero inductance is an explicitly supported algebraic limit
...
| Target | oLine50.L[7].L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-smoothstep-oline50-l-7-l-zerolimit.md](../../v2/bugs/FINDING-smoothstep-oline50-l-7-l-zerolimit.md) — reviewed as `FINDING-00533-smoothstep-oline50-l-7-l.md`, which a later run renamed |
| Original SHA-256 | 9f6624ae36a744eefa8d0e76127d5666a83f44d289e6164618d07885b3294fc1 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `oLine50.lm[7]`; effective min: `None`; effective max: `None`. 
