# FINDING-04024: Tensor entries are not all strictly positive scalars
...
| Original report | `FINDING-04024-initspringconstant-body-body-i.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 5c6a9e6fc9bdb850a91cd399826fd6549c85b1ccdd1ba5134eeddbcbc15784ac |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:114`. Role: `parameter`; binding: `cat1(cat2(body.body.I_11, body.body.I_21, body.body.I_31), cat2(body.body.I_21, body.body.I_22, body.body.I_32), cat2(body.body.I_31, body.body.I_32, body.body.I_33))`; effective min: `None`; effective max: `None`. 
