# FINDING-02823: Polyphase resistance/conductance delegates to signed scalar elements
...
| Target | transformer2.r1.R |
| Student classification | physical-domain-unenforced |
| Original report | `FINDING-02823-rectifier12pulse-transformer2-r1-r.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 0612aba4e121c92c776be2560f727d61efdaa75c6f63aae2cb4917b4704c6abf |
...
Compiler/source-resolved declaration: `Electrical/Polyphase/Basic/Resistor.mo:4`. Role: `parameter`; binding: `fill(transformer2.R1, transformer2.m)`; effective min: `None`; effective max: `None`. 
