# FINDING-03368: Zero inductance is an explicitly supported algebraic limit
...
| Original report | [FINDING-thyristorcentertap2mpulse-rlv-characteristic-inductor-l-zerolimit.md](../../v2/bugs/FINDING-thyristorcentertap2mpulse-rlv-characteristic-inductor-l-zerolimit.md) — reviewed as `FINDING-03368-thyristorcentertap2mpulse-rlv-characteristic-inductor-l.md`, which a later run renamed |
| Original SHA-256 | 4f9d613fffaefd36394c43ff37314665a044448b6b8e959f476bdde5d1ac3547 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `L`; effective min: `None`; effective max: `None`. 
