# FINDING-00799: Zero capacitance is an explicitly supported algebraic limit
...
| Original report | [FINDING-controlcircuit-firstorder2a-c-c-zerolimit.md](../../v2/bugs/FINDING-controlcircuit-firstorder2a-c-c-zerolimit.md) — reviewed as `FINDING-00799-controlcircuit-firstorder2a-c-c.md`, which a later run renamed |
| Original SHA-256 | 81abbff811ab56ab07df7bce29aa3e65c7fb8542c0129cce31786a98088567a2 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Capacitor.mo:4`. Role: `parameter`; binding: `firstOrder2A.C`; effective min: `0`; effective max: `None`. 
...
| Probe | Outcome |
|---|---|
| `firstOrder2A.c.C=0` | reported-failure |
