# FINDING-03317: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | rectifier.diode_p.idealDiode[3].Ron |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-diodecentertap2mpulse-rectifier-diode-p-idealdiode-3-ron-ruleoff.md](../../v2/bugs/FINDING-diodecentertap2mpulse-rectifier-diode-p-idealdiode-3-ron-ruleoff.md) — reviewed as `FINDING-03317-diodecentertap2mpulse-rectifier-diode-p-idealdiode-3-ron.md`, which a later run renamed |
| Original SHA-256 | c564fc5556872aab3bbd51412409f333a7d5f7467f4254f6b84675c84eedafa6 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:4`. Role: `parameter`; binding: `rectifier.diode_p.Ron[3]`; effective min: `0`; effective max: `None`. 
