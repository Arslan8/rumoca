# FINDING-03699: Converter switch parameters delegate to ideal semiconductor limits
...
| Target | hbridge.inverter_n.GoffDiode |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-hbridge-trianglepwm-rl-hbridge-inverter-n-goffdiode-zerolimit.md](../../v2/bugs/FINDING-hbridge-trianglepwm-rl-hbridge-inverter-n-goffdiode-zerolimit.md) — reviewed as `FINDING-03699-hbridge-trianglepwm-rl-hbridge-inverter-n-goffdiode.md`, which a later run renamed |
| Original SHA-256 | 44fec257854522f5c590b46af6a7838161d8b0c61da7787d3fe77d50bc687730 |
...
Compiler/source-resolved declaration: `Electrical/PowerConverters/DCAC/SinglePhase2Level.mo:12`. Role: `parameter`; binding: `hbridge.GoffDiode`; effective min: `None`; effective max: `None`. 
