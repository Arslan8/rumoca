# FINDING-02772: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | diode1.idealDiode[3].Goff |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-rectifier12pulse-diode1-idealdiode-3-goff-zerolimit.md](../../v2/bugs/FINDING-rectifier12pulse-diode1-idealdiode-3-goff-zerolimit.md) — reviewed as `FINDING-02772-rectifier12pulse-diode1-idealdiode-3-goff.md`, which a later run renamed |
| Original SHA-256 | 0d779e5fbef07d0237426dbee907c94de37c236dd89a9ed09d3122decedacfe3 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:6`. Role: `parameter`; binding: `diode1.Goff[3]`; effective min: `0`; effective max: `None`. 
