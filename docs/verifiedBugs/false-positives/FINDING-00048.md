# FINDING-00048: Zero capacitance is an explicitly supported algebraic limit
...
| Original report | [FINDING-cauerlowpassopv-c1-c-zerolimit.md](../../v2/bugs/FINDING-cauerlowpassopv-c1-c-zerolimit.md) — reviewed as `FINDING-00048-cauerlowpassopv-c1-c.md`, which a later run renamed |
| Original SHA-256 | e427ec9d3b60daf267c0c2de2c1a22c62885bba8dab0d36f0d64a2026a5d89fc |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Capacitor.mo:4`. Role: `parameter`; binding: `(c1 + c2)`; effective min: `0`; effective max: `None`. 
