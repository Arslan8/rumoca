# FINDING-02491: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | switch2.idealClosingSwitch[3].Ron |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-smpm-resistivebraking-switch2-idealclosingswitch-3-ron-ruleoff.md](../../v2/bugs/FINDING-smpm-resistivebraking-switch2-idealclosingswitch-3-ron-ruleoff.md) — reviewed as `FINDING-02491-smpm-resistivebraking-switch2-idealclosingswitch-3-ron.md`, which a later run renamed |
| Original SHA-256 | ce44e6993574e8198b6003c0df6488d40e3069e2965b43c055102aa8d5400479 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSwitch.mo:4`. Role: `parameter`; binding: `switch2.Ron[3]`; effective min: `0`; effective max: `None`. 
