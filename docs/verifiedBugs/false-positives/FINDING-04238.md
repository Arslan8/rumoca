# FINDING-04238: MultiBody Newton/Euler equations use mass and inertia multiplicatively
...
| Target | bodyBox.body.m |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-bevelgear1d-bodybox-body-m-zerolimit.md](../../v2/bugs/FINDING-bevelgear1d-bodybox-body-m-zerolimit.md) — reviewed as `FINDING-04238-bevelgear1d-bodybox-body-m.md`, which a later run renamed |
| Original SHA-256 | ea7634e0381a250250896c5cc05eceb89e19a60d0b0add954a4682929d561e44 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:16`. Role: `parameter`; binding: `bodyBox.m`; effective min: `0`; effective max: `None`. 
