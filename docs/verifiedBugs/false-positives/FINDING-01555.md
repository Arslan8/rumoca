# FINDING-01555: Zero inertia is a massless algebraic component, not an intrinsic division
...
| Target | imc.inertiaStator.J |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-imc-dcbraking-imc-inertiastator-j-zerolimit.md](../../v2/bugs/FINDING-imc-dcbraking-imc-inertiastator-j-zerolimit.md) — reviewed as `FINDING-01555-imc-dcbraking-imc-inertiastator-j.md`, which a later run renamed |
| Original SHA-256 | cfe255f2217fffb4eec5675aff41e9303ef9a84b95f03bef407baf878b4702fb |
...
Compiler/source-resolved declaration: `Mechanics/Rotational/Components/Inertia.mo:4`. Role: `parameter`; binding: `imc.Js`; effective min: `0`; effective max: `None`. 
