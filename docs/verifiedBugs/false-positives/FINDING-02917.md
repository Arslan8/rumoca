# FINDING-02917: Zero inductance is an explicitly supported algebraic limit
...
| Target | transformer.l2sigma.inductor[2].L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-transformertestbench-transformer-l2sigma-inductor-2-l-zerolimit.md](../../v2/bugs/FINDING-transformertestbench-transformer-l2sigma-inductor-2-l-zerolimit.md) — reviewed as `FINDING-02917-transformertestbench-transformer-l2sigma-inductor-2-l.md`, which a later run renamed |
| Original SHA-256 | 2c49cbb9a15210d9799733563cbdb857b22ddd0a5b0b5ff71e0f2667c8933270 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `transformer.l2sigma.L[2]`; effective min: `None`; effective max: `None`. 
