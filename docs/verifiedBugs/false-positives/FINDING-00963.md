# FINDING-00963: Zero on-resistance/off-conductance is an intended ideal limit
...
| Original report | [FINDING-rectifier-idealdiode2-ron-ruleoff.md](../../v2/bugs/FINDING-rectifier-idealdiode2-ron-ruleoff.md) — reviewed as `FINDING-00963-rectifier-idealdiode2-ron.md`, which a later run renamed |
| Original SHA-256 | 7fff37be5b06f42adca914fabc5a889c48f27f2d9deea3c83cc88cfca6100abd |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:4`. Role: `parameter`; binding: `Ron`; effective min: `0`; effective max: `None`. 
