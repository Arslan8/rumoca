# FINDING-03669: Converter switch parameters delegate to ideal semiconductor limits
...
| Original report | [FINDING-hbridge-r-hbridge-inverter-n-goffdiode-zerolimit.md](../../v2/bugs/FINDING-hbridge-r-hbridge-inverter-n-goffdiode-zerolimit.md) — reviewed as `FINDING-03669-hbridge-r-hbridge-inverter-n-goffdiode.md`, which a later run renamed |
| Original SHA-256 | a3273eaf25458d27664c27f7269cf1723d06eda836472d4e3c527f3a7bacefff |
