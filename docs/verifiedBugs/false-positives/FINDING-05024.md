# FINDING-05024: Zero stiffness is a force-free spring limit
...
| Original report | [FINDING-allcomponents-spring-c-zerolimit.md](../../v2/bugs/FINDING-allcomponents-spring-c-zerolimit.md) — reviewed as `FINDING-05024-allcomponents-spring-c.md`, which a later run renamed |
| Original SHA-256 | b774b8fb08b6d28ebf12d889eb617bc45170bd24cb3cb7aab5bc45b88609f3f2 |
...
Compiler/source-resolved declaration: `Mechanics/Translational/Components/Spring.mo:4`. Role: `parameter`; binding: `1`; effective min: `0`; effective max: `None`. 
