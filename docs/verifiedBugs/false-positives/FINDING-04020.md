# FINDING-04020: MultiBody Newton/Euler equations use mass and inertia multiplicatively
...
| Target | body.body.I_33 |
| Student classification | physical-bound-permits-zero |
| Original report | `FINDING-04020-initspringconstant-body-body-i-33.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 6323cde5f76b4412b25cc22a4dbc85fc212056f28917ab387a4fbded353a9ce0 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:21`. Role: `parameter`; binding: `body.I_33`; effective min: `0`; effective max: `None`. 
