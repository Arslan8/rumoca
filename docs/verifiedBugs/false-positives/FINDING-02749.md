# FINDING-02749: Zero leakage inductance is a supported ideal limit
...
| Original report | [FINDING-imc-transformer-aimcdata-lssigma-intent-2.md](../../v2/bugs/FINDING-imc-transformer-aimcdata-lssigma-intent-2.md) — reviewed as `FINDING-02749-imc-transformer-aimcdata-lssigma.md`, which a later run renamed |
| Original SHA-256 | dbf92cb7ce5fa37217807829a39a37d32a1636407857b8facacf975aad07490f |
...
Compiler/source-resolved declaration: `Electrical/Machines/Utilities/ParameterRecords/InductionMachineData.mo:23`. Role: `parameter`; binding: `((3 * (1 - sqrt((1 - 0.0667)))) / ((2 * (2 * asin(1.0))) * aimcData.fsNominal))`; effective min: `None`; effective max: `None`. 
