# FINDING-04219: Tensor entries are not all strictly positive scalars
...
| Target | body4.body.I_21 |
| Student classification | physical-domain-unenforced |
| Original report | `FINDING-04219-planarfourbar-body4-body-i-21.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 7a8aeec5ce827673ca46cc1474fd64606bb47fe21ec1d244ee6949151b864469 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:23`. Role: `parameter`; binding: `body4.I[2, 1]`; effective min: `-1.7976931348623157e+308`; effective max: `None`. 
