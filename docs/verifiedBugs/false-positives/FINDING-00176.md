# FINDING-00176: Zero on-resistance/off-conductance is an intended ideal limit
...
| Original report | [FINDING-characteristicidealdiodes-ideal-ron-zerolimit.md](../../v2/bugs/FINDING-characteristicidealdiodes-ideal-ron-zerolimit.md) — reviewed as `FINDING-00176-characteristicidealdiodes-ideal-ron.md`, which a later run renamed |
| Original SHA-256 | 2298fc6dcb524cf685ac08040a2d0abae6f589a951f114fb2e496dd4310beedb |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:4`. Role: `parameter`; binding: `0`; effective min: `0`; effective max: `None`. 
