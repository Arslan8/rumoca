# FINDING-04215: MultiBody Newton/Euler equations use mass and inertia multiplicatively
...
| Original report | [FINDING-planarfourbar-body4-body-m-zerolimit.md](../../v2/bugs/FINDING-planarfourbar-body4-body-m-zerolimit.md) — reviewed as `FINDING-04215-planarfourbar-body4-body-m.md`, which a later run renamed |
| Original SHA-256 | 180607cedb8a243db1ecde8245b13d10f8b883dcef9f537df489a8ce38323221 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:16`. Role: `parameter`; binding: `body4.m`; effective min: `0`; effective max: `None`. 
