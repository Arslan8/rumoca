# FINDING-03674: Zero on-resistance/off-conductance is an intended ideal limit
...
| Original report | [FINDING-hbridge-r-hbridge-inverter-n-transistor-n-ron-ruleoff.md](../../v2/bugs/FINDING-hbridge-r-hbridge-inverter-n-transistor-n-ron-ruleoff.md) — reviewed as `FINDING-03674-hbridge-r-hbridge-inverter-n-transistor-n-ron.md`, which a later run renamed |
| Original SHA-256 | 3a28297602a38167201dce609c92dab1aec850c309815ab8a54b50f103c04290 |
