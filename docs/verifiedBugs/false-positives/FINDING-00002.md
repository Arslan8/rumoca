# FINDING-00002: A zero-duration ramp is a supported step
...
| Original report | [FINDING-clockedwithdiscretecontroller-ramp-duration-divunreach.md](../../v2/bugs/FINDING-clockedwithdiscretecontroller-ramp-duration-divunreach.md) — reviewed as `FINDING-00002-clockedwithdiscretecontroller-ramp-duration.md`, which a later run renamed |
| Original SHA-256 | b5f6c23884890aecd4af6fbfbf5ca482bcc512bf31b58a74db52ab5d8e2747bd |
...
[Rumoca commands, return codes, integrity hashes, bounded output and metadata](../evidence/3c5eed299ed9fe44.json). Baseline: **tool-error**.
