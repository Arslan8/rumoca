# FINDING-01962: Arc-switch resistance/conductance are multiplicative ideal limits
...
| Target | switchYDwithArc.idealOpener.openerWithArc[3].Goff |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-imc-ydarc-switchydwitharc-idealopener-openerwitharc-3-goff-zerolimit.md](../../v2/bugs/FINDING-imc-ydarc-switchydwitharc-idealopener-openerwitharc-3-goff-zerolimit.md) — reviewed as `FINDING-01962-imc-ydarc-switchydwitharc-idealopener-openerwitharc-3-goff.md`, which a later run renamed |
| Original SHA-256 | aa5b51393bd3cbf8fad26fee736ba6f40f053dda5bea3da528695af939496c4f |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSwitchWithArc.mo:5`. Role: `parameter`; binding: `switchYDwithArc.idealOpener.Goff[3]`; effective min: `None`; effective max: `None`. 
