# FINDING-04294: MultiBody Newton/Euler equations use mass and inertia multiplicatively
...
| Original report | [FINDING-mechanicalstructure-b3-m-intent.md](../../v2/bugs/FINDING-mechanicalstructure-b3-m-intent.md) — reviewed as `FINDING-04294-mechanicalstructure-b3-m.md`, which a later run renamed |
| Original SHA-256 | 4c88f59fc80cb0269b8a6cb1c9a10262bbb53e81e2bd3a631c755298a4386698 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/BodyShape.mo:23`. Role: `parameter`; binding: `26.4`; effective min: `0`; effective max: `None`. 
