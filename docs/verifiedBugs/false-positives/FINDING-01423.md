# FINDING-01423: Zero core-loss conductance deliberately disables losses
...
| Original report | [FINDING-dcpm-withlosses-dcpm1-core-coreparameters-gcref-zerolimit.md](../../v2/bugs/FINDING-dcpm-withlosses-dcpm1-core-coreparameters-gcref-zerolimit.md) — reviewed as `FINDING-01423-dcpm-withlosses-dcpm1-core-coreparameters-gcref.md`, which a later run renamed |
| Original SHA-256 | 00d9af3e6b0a4c33dfd54a2f702902e6df4de7de11285d7a2e168de2fe2fd912 |
...
Compiler/source-resolved declaration: `Electrical/Machines/Losses/CoreParameters.mo:18`. Role: `parameter`; binding: `dcpmData1.coreParameters.GcRef`; effective min: `None`; effective max: `None`. 
