# FINDING-00377: Zero capacitance is an explicitly supported algebraic limit
...
| Original report | [FINDING-comparelinetrunks-oline1-c-4-c-zerolimit.md](../../v2/bugs/FINDING-comparelinetrunks-oline1-c-4-c-zerolimit.md) — reviewed as `FINDING-00377-comparelinetrunks-oline1-c-4-c.md`, which a later run renamed |
| Original SHA-256 | 31b91a88eb23b44c115371fb07f43e496c53ff584d3625b02a40a42abfd8454b |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Capacitor.mo:4`. Role: `parameter`; binding: `((oLine1.c * oLine1.length) / oLine1.N)`; effective min: `0`; effective max: `None`. 
