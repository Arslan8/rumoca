# FINDING-01154: AirGapDC uses excitation inductance only as a multiplier
...
| Target | dcee.airGapDC.Le |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-dc-comparecharacteristics-dcee-airgapdc-le-zerolimit.md](../../v2/bugs/FINDING-dc-comparecharacteristics-dcee-airgapdc-le-zerolimit.md) — reviewed as `FINDING-01154-dc-comparecharacteristics-dcee-airgapdc-le.md`, which a later run renamed |
| Original SHA-256 | b949f28ea30710853049ea9d9838a9aa47217db1a783eb6c425c26e26abdb1c5 |
...
Compiler/source-resolved declaration: `Electrical/Machines/BasicMachines/Components/AirGapDC.mo:4`. Role: `parameter`; binding: `dcee.Lme`; effective min: `None`; effective max: `None`. 
