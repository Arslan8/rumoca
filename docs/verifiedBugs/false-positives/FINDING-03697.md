# FINDING-03697: Converter switch parameters delegate to ideal semiconductor limits
...
| Target | hbridge.inverter_n.GoffTransistor |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-hbridge-trianglepwm-rl-hbridge-inverter-n-gofftransistor-zerolimit.md](../../v2/bugs/FINDING-hbridge-trianglepwm-rl-hbridge-inverter-n-gofftransistor-zerolimit.md) — reviewed as `FINDING-03697-hbridge-trianglepwm-rl-hbridge-inverter-n-gofftransistor.md`, which a later run renamed |
| Original SHA-256 | 7d1f7be00361c87541bf3f18953225800f382ae7cc4e16127d0fe83f7f3797bc |
...
Compiler/source-resolved declaration: `Electrical/PowerConverters/DCAC/SinglePhase2Level.mo:6`. Role: `parameter`; binding: `hbridge.GoffTransistor`; effective min: `None`; effective max: `None`. 
