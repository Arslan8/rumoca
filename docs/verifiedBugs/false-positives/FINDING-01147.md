# FINDING-01147: DC machine-data field has a supported ideal limit
...
| Original report | [FINDING-dc-comparecharacteristics-dceedata-js-intent.md](../../v2/bugs/FINDING-dc-comparecharacteristics-dceedata-js-intent.md) — reviewed as `FINDING-01147-dc-comparecharacteristics-dceedata-js.md`, which a later run renamed |
| Original SHA-256 | a92e39bc3dda9fb2dda53893b78a90ed47f642523997f9ecc753962807659bbb |
...
Compiler/source-resolved declaration: `Electrical/Machines/Utilities/ParameterRecords/DcPermanentMagnetData.mo:6`. Role: `parameter`; binding: `dceeData.Jr`; effective min: `None`; effective max: `None`. 
