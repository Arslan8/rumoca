# FINDING-02739: Zero on-resistance/off-conductance is an intended ideal limit
...
| Original report | [FINDING-imc-transformer-idealcommutingswitch-idealcommutingswitch-1-goff-ruleo-2.md](../../v2/bugs/FINDING-imc-transformer-idealcommutingswitch-idealcommutingswitch-1-goff-ruleo-2.md) — reviewed as `FINDING-02739-imc-transformer-idealcommutingswitch-idealcommutingswitch-1-goff.md`, which a later run renamed |
| Original SHA-256 | 02734c5c4dae30551271bd03c7dbdec8c61776887307c623405582c61919469b |
...
Compiler/source-resolved declaration: `Electrical/Analog/Ideal/IdealTwoWaySwitch.mo:4`. Role: `parameter`; binding: `idealCommutingSwitch.Goff[1]`; effective min: `0`; effective max: `None`. 
