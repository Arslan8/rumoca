# FINDING-03630: Zero on-resistance/off-conductance is an intended ideal limit
...
| Original report | [FINDING-hbridge-rl-hbridge-inverter-p-transistor-n-ron-ruleoff.md](../../v2/bugs/FINDING-hbridge-rl-hbridge-inverter-p-transistor-n-ron-ruleoff.md) — reviewed as `FINDING-03630-hbridge-rl-hbridge-inverter-p-transistor-n-ron.md`, which a later run renamed |
| Original SHA-256 | 98f0a3ab2a9ddbe99e8ae2314c5bfe9508d892693b997630491b23a67a69bda3 |
