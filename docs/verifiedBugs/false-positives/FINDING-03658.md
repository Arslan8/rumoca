# FINDING-03658: Zero on-resistance/off-conductance is an intended ideal limit
...
| Original report | [FINDING-hbridge-r-hbridge-inverter-p-transistor-p-ron-ruleoff.md](../../v2/bugs/FINDING-hbridge-r-hbridge-inverter-p-transistor-p-ron-ruleoff.md) — reviewed as `FINDING-03658-hbridge-r-hbridge-inverter-p-transistor-p-ron.md`, which a later run renamed |
| Original SHA-256 | 7a61a296debba3ba2e79390e2afcaff38a94e47180f9fb0ebb2d119643ef4f4d |
