# FINDING-04921: Zero on-resistance/off-conductance is an intended ideal limit
...
| Original report | [FINDING-halfcontrolledbridge2mpulse-rectifier-diode-n-goff-ruleoff-2.md](../../v2/bugs/FINDING-halfcontrolledbridge2mpulse-rectifier-diode-n-goff-ruleoff-2.md) — reviewed as `FINDING-04921-halfcontrolledbridge2mpulse-rectifier-diode-n-goff.md`, which a later run renamed |
| Original SHA-256 | 62ab37fff2f222a2c37f04e5fe0b05876a14977a9b7895fff0e66dc49e64a2c3 |
...
Compiler/source-resolved declaration: `Electrical/Polyphase/Ideal/IdealDiode.mo:6`. Role: `parameter`; binding: `fill(rectifier.GoffDiode, rectifier.m)`; effective min: `zeros(3)`; effective max: `None`. 
