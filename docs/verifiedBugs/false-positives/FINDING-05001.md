# FINDING-05001: Zero mass is a massless algebraic component, not an intrinsic division
...
| Original report | [FINDING-testspeed-mass1-m-zerolimit.md](../../v2/bugs/FINDING-testspeed-mass1-m-zerolimit.md) — reviewed as `FINDING-05001-testspeed-mass1-m.md`, which a later run renamed |
| Original SHA-256 | 7f5d5ecbf9cab0d779bd952d453d3bd491c7e1252f9462ecbf179018806f3ff4 |
...
[Rumoca commands, return codes, integrity hashes, bounded output and metadata](../evidence/666456ba5edf17cf.json). Baseline: **tool-error**.
