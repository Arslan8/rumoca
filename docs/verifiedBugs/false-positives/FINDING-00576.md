# FINDING-00576: Zero inductance is an explicitly supported algebraic limit
...
| Target | oLine50.L[50].L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-smoothstep-oline50-l-50-l-zerolimit.md](../../v2/bugs/FINDING-smoothstep-oline50-l-50-l-zerolimit.md) — reviewed as `FINDING-00576-smoothstep-oline50-l-50-l.md`, which a later run renamed |
| Original SHA-256 | 209d64db241fc64a293ceb768fac4c1305e46a5b555e00562d3342e6a2437552 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `oLine50.lm[50]`; effective min: `None`; effective max: `None`. 
