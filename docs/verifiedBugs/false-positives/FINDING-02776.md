# FINDING-02776: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | diode2.idealDiode[1].Goff |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-rectifier12pulse-diode2-idealdiode-1-goff-zerolimit.md](../../v2/bugs/FINDING-rectifier12pulse-diode2-idealdiode-1-goff-zerolimit.md) — reviewed as `FINDING-02776-rectifier12pulse-diode2-idealdiode-1-goff.md`, which a later run renamed |
| Original SHA-256 | 360ce0e19e10068c82677a53a274159ee428aa06c0aab1a853c1049ea257894a |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:6`. Role: `parameter`; binding: `diode2.Goff[1]`; effective min: `0`; effective max: `None`. 
