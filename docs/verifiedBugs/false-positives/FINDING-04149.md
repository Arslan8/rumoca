# FINDING-04149: The line-force point mass is explicitly optional
...
| Original report | [FINDING-threesprings-spring1-lineforce-m-zerolimit.md](../../v2/bugs/FINDING-threesprings-spring1-lineforce-m-zerolimit.md) — reviewed as `FINDING-04149-threesprings-spring1-lineforce-m.md`, which a later run renamed |
| Original SHA-256 | 6e29288514d3b6b486fe97da9321ea37ce6f1ecc3b847ec423882c8373c1fdbe |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Forces/LineForceWithMass.mo:23`. Role: `parameter`; binding: `spring1.m`; effective min: `0`; effective max: `None`. 
