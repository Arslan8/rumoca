# FINDING-00542: Zero inductance is an explicitly supported algebraic limit
...
| Target | oLine50.L[16].L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-smoothstep-oline50-l-16-l-zerolimit.md](../../v2/bugs/FINDING-smoothstep-oline50-l-16-l-zerolimit.md) — reviewed as `FINDING-00542-smoothstep-oline50-l-16-l.md`, which a later run renamed |
| Original SHA-256 | bce78c97841f843cd816aa61634e563d68d4c4f0b7318a7ee20791ab1d15d5a8 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `oLine50.lm[16]`; effective min: `None`; effective max: `None`. 
