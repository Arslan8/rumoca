# FINDING-04018: MultiBody Newton/Euler equations use mass and inertia multiplicatively
...
| Target | body.body.I_11 |
| Student classification | physical-bound-permits-zero |
| Original report | `FINDING-04018-initspringconstant-body-body-i-11.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | fcc8765752481cdc2d9dc5bba82d8d0d81bb66528b01687c73d3b36fe8e29c8a |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:17`. Role: `parameter`; binding: `body.I_11`; effective min: `0`; effective max: `None`. 
