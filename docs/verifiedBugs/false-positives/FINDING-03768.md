# FINDING-03768: Armature example delegates to zero-capable mechanical terms
...
| Target | pmActuator.armature.d |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-armaturestroke-pmactuator-armature-d-intent.md](../../v2/bugs/FINDING-armaturestroke-pmactuator-armature-d-intent.md) — reviewed as `FINDING-03768-armaturestroke-pmactuator-armature-d.md`, which a later run renamed |
| Original SHA-256 | 31cf015084eb33b786aaf0f6ecaa8b28e22844654096222bcafce0d99fded90c |
...
Compiler/source-resolved declaration: `Magnetic/FluxTubes/Examples/Utilities/TranslatoryArmatureAndStopper.mo:11`. Role: `parameter`; binding: `pmActuator.d`; effective min: `None`; effective max: `None`. 
