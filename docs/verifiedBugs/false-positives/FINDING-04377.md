# FINDING-04377: Zero inertia is a massless algebraic component, not an intrinsic division
...
| Original report | [FINDING-comparebrakingtorque-inertia2-j-zerolimit.md](../../v2/bugs/FINDING-comparebrakingtorque-inertia2-j-zerolimit.md) — reviewed as `FINDING-04377-comparebrakingtorque-inertia2-j.md`, which a later run renamed |
| Original SHA-256 | 1add958e8c17844e1110649291ced1cdcd6f66c9a12dd538ff545a6239eb203e |
...
| Probe | Outcome |
|---|---|
| `inertia2.J=0` | reported-failure |

Diagnostic: solve-IR evaluation failed: algebraic projection did not converge at event boundary: worst scaled residual row=14 target=inertia2.a value=1.000000e2 ratio=1.000000e12 norm=1.000000e2 row_scale=1.000000e0 scaled_tolerance=1.000000e-10
