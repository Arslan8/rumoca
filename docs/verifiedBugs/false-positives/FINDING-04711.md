# FINDING-04711: The friction denominator is protected by an ordering assertion
...
| Original report | [FINDING-twotanks-pipe-v-flownominal-divzero.md](../../v2/bugs/FINDING-twotanks-pipe-v-flownominal-divzero.md) — reviewed as `FINDING-04711-twotanks-pipe-v-flownominal.md`, which a later run renamed |
| Original SHA-256 | de2665b2c419b3ecb2f046d06ee086fc1c42a4f333b42c957cbe7a1ab8e8b795 |
...
Compiler/source-resolved declaration: `Thermal/FluidHeatFlow/BaseClasses/SimpleFriction.mo:9`. Role: `parameter`; binding: `4`; effective min: `None`; effective max: `None`. 
