# FINDING-04352: Tensor entries are not all strictly positive scalars
...
| Original report | `FINDING-04352-mechanicalstructure-b6-body-i-32.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 2353bcddd85a8caed74875f323b7c594c05c513dd4b957b5e2faa2b3df59bc04 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:27`. Role: `parameter`; binding: `b6.I_32`; effective min: `-1.7976931348623157e+308`; effective max: `None`. 
