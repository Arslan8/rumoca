# FINDING-01661: Zero inductance is an explicitly supported algebraic limit
...
| Target | inductor.inductor[3].L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-imc-inverterdrive-inductor-inductor-3-l-zerolimit.md](../../v2/bugs/FINDING-imc-inverterdrive-inductor-inductor-3-l-zerolimit.md) — reviewed as `FINDING-01661-imc-inverterdrive-inductor-inductor-3-l.md`, which a later run renamed |
| Original SHA-256 | fa590c6177235924bd27db85a70789b5dacc80e43f6f48e6e31b187ef004b309 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `inductor.L[3]`; effective min: `None`; effective max: `None`. 
