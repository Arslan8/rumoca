# FINDING-01688: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | inverter.transistor_p.idealGTOThyristor[1].Goff |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-imc-inverterdrive-inverter-transistor-p-idealgtothyristor-1-goff-zerol.md](../../v2/bugs/FINDING-imc-inverterdrive-inverter-transistor-p-idealgtothyristor-1-goff-zerol.md) — reviewed as `FINDING-01688-imc-inverterdrive-inverter-transistor-p-idealgtothyristor-1-goff.md`, which a later run renamed |
| Original SHA-256 | e14982ca682aeb8515f913e26ac17d10d3ea5dceba715dca3919a16ebb9d8fd5 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:6`. Role: `parameter`; binding: `inverter.transistor_p.Goff[1]`; effective min: `0`; effective max: `None`. 
