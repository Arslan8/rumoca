# FINDING-00383: Zero inductance is an explicitly supported algebraic limit
...
| Original report | [FINDING-comparelinetrunks-oline2-l-1-l-zerolimit.md](../../v2/bugs/FINDING-comparelinetrunks-oline2-l-1-l-zerolimit.md) — reviewed as `FINDING-00383-comparelinetrunks-oline2-l-1-l.md`, which a later run renamed |
| Original SHA-256 | 814b6c8e9a1ab5b3127a45d12e45d194f8462c21d276065501d1a5c7173a1273 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `oLine2.lm[1]`; effective min: `None`; effective max: `None`. 
