# FINDING-02307: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | diodeBridge2mPulse.diode_n.idealDiode[3].Goff |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-smpm-braking-diodebridge2mpulse-diode-n-idealdiode-3-goff-zerolimit.md](../../v2/bugs/FINDING-smpm-braking-diodebridge2mpulse-diode-n-idealdiode-3-goff-zerolimit.md) — reviewed as `FINDING-02307-smpm-braking-diodebridge2mpulse-diode-n-idealdiode-3-goff.md`, which a later run renamed |
| Original SHA-256 | c9b0a2b6eb7bc761072f9df7c3f377b4f47bdaf3e9b115040c123df400ee7009 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:6`. Role: `parameter`; binding: `diodeBridge2mPulse.diode_n.Goff[3]`; effective min: `0`; effective max: `None`. 
