# FINDING-01705: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | inverter.transistor_n.idealGTOThyristor[2].Ron |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-imc-inverterdrive-inverter-transistor-n-idealgtothyristor-2-ron-ruleof.md](../../v2/bugs/FINDING-imc-inverterdrive-inverter-transistor-n-idealgtothyristor-2-ron-ruleof.md) — reviewed as `FINDING-01705-imc-inverterdrive-inverter-transistor-n-idealgtothyristor-2-ron.md`, which a later run renamed |
| Original SHA-256 | 7666752569884b8511d90b111ba3bce507db7543cae4b1ec2e2dfeb90f1e9e60 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:4`. Role: `parameter`; binding: `inverter.transistor_n.Ron[2]`; effective min: `0`; effective max: `None`. 
