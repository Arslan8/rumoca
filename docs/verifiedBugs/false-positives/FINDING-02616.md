# FINDING-02616: Zero stator leakage inductance is supported
...
| Original report | [FINDING-smr-inverter-smr-lszero-zerolimit.md](../../v2/bugs/FINDING-smr-inverter-smr-lszero-zerolimit.md) — reviewed as `FINDING-02616-smr-inverter-smr-lszero.md`, which a later run renamed |
| Original SHA-256 | 4100d484302b6a494dab7a7bc69034dc671816465eaa6975d00b609828187a21 |
...
Compiler/source-resolved declaration: `Electrical/Machines/Interfaces/PartialBasicInductionMachine.mo:20`. Role: `parameter`; binding: `smrData.Lszero`; effective min: `None`; effective max: `None`. 
