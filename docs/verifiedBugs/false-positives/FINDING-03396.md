# FINDING-03396: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | rectifier.thyristor_p.idealThyristor[1].Goff |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-thyristorcentertap2mpulse-r-rectifier-thyristor-p-idealthyristor-1-gof.md](../../v2/bugs/FINDING-thyristorcentertap2mpulse-r-rectifier-thyristor-p-idealthyristor-1-gof.md) — reviewed as `FINDING-03396-thyristorcentertap2mpulse-r-rectifier-thyristor-p-idealthyristor-1-gof.md`, which a later run renamed |
| Original SHA-256 | 280d96a49cd5cb74e981dd99427943941a5b4b971b57b83c07f616421b6d0299 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:6`. Role: `parameter`; binding: `rectifier.thyristor_p.Goff[1]`; effective min: `0`; effective max: `None`. 
