# FINDING-05060: Zero inertia is a massless algebraic component, not an intrinsic division
...
| Target | vehicleDragInConst.inertia.J |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-vehicles-vehicledraginconst-inertia-j-zerolimit.md](../../v2/bugs/FINDING-vehicles-vehicledraginconst-inertia-j-zerolimit.md) — reviewed as `FINDING-05060-vehicles-vehicledraginconst-inertia-j.md`, which a later run renamed |
| Original SHA-256 | 914dd53b729f4fea81233eedb816080e379b64e3c8a0a736b32d139b4aee695e |
