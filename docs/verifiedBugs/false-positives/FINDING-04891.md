# FINDING-04891: Zero leakage inductance is a supported ideal limit
...
| Target | smpmData.Lszero |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-smpm-voltagesourcewithlosses-smpmdata-lszero-intent.md](../../v2/bugs/FINDING-smpm-voltagesourcewithlosses-smpmdata-lszero-intent.md) — reviewed as `FINDING-04891-smpm-voltagesourcewithlosses-smpmdata-lszero.md`, which a later run renamed |
| Original SHA-256 | 2ba40eb4475fbe658a39e554f72592d112ccc51016b6069415de7efcaff5bc51 |
...
Compiler/source-resolved declaration: `Electrical/Machines/Utilities/ParameterRecords/InductionMachineData.mo:20`. Role: `parameter`; binding: `smpmData.Lssigma`; effective min: `None`; effective max: `None`. 
