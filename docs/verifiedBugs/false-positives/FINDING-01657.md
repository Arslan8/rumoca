# FINDING-01657: Polyphase resistance/conductance delegates to signed scalar elements
...
| Original report | `FINDING-01657-imc-inverterdrive-resistor-r.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | f1ae8803ffb6ed08e2f7284243e2dbfba3f49416685ba2189310ce9b759b0baa |
...
Compiler/source-resolved declaration: `Electrical/Polyphase/Basic/Resistor.mo:4`. Role: `parameter`; binding: `fill(RGrid, m)`; effective min: `None`; effective max: `None`. 
