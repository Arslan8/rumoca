# FINDING-02305: Zero on-resistance/off-conductance is an intended ideal limit
...
| Original report | [FINDING-smpm-braking-diodebridge2mpulse-diode-n-idealdiode-2-goff-zerolimit.md](../../v2/bugs/FINDING-smpm-braking-diodebridge2mpulse-diode-n-idealdiode-2-goff-zerolimit.md) — reviewed as `FINDING-02305-smpm-braking-diodebridge2mpulse-diode-n-idealdiode-2-goff.md`, which a later run renamed |
| Original SHA-256 | fb45dd10017ab6adb27d53c75c75530adbd64147586f842418cb01fe53ea3e33 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:6`. Role: `parameter`; binding: `diodeBridge2mPulse.diode_n.Goff[2]`; effective min: `0`; effective max: `None`. 
