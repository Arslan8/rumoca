# FINDING-00543: Zero inductance is an explicitly supported algebraic limit
...
| Target | oLine50.L[17].L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-smoothstep-oline50-l-17-l-zerolimit.md](../../v2/bugs/FINDING-smoothstep-oline50-l-17-l-zerolimit.md) — reviewed as `FINDING-00543-smoothstep-oline50-l-17-l.md`, which a later run renamed |
| Original SHA-256 | 6a2cedbeec606a8a1b95d299d79bf39458b2def5b30e3362b5b758d65fdafcde |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `oLine50.lm[17]`; effective min: `None`; effective max: `None`. 
