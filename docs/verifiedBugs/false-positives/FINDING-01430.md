# FINDING-01430: Machine inertia delegates to the zero-capable algebraic inertia component
...
| Original report | [FINDING-dcpm-withlosses-dcpm1-js-zerolimit.md](../../v2/bugs/FINDING-dcpm-withlosses-dcpm1-js-zerolimit.md) — reviewed as `FINDING-01430-dcpm-withlosses-dcpm1-js.md`, which a later run renamed |
| Original SHA-256 | 5e75478726e6067e32992cf829fde2674f54a5144bf441cd30c7b09348deb9f8 |
...
Compiler/source-resolved declaration: `Electrical/Machines/Interfaces/PartialBasicMachine.mo:8`. Role: `parameter`; binding: `dcpmData1.Js`; effective min: `None`; effective max: `None`. 
