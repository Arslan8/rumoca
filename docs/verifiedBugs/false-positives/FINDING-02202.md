# FINDING-02202: Air-gap inductance is used as a flux multiplier
...
| Target | smee.airGap.Lmd |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-smee-generator-smee-airgap-lmd-zerolimit.md](../../v2/bugs/FINDING-smee-generator-smee-airgap-lmd-zerolimit.md) — reviewed as `FINDING-02202-smee-generator-smee-airgap-lmd.md`, which a later run renamed |
| Original SHA-256 | c29650479bc01fb6491577ede015aab53f8627780ac00f4181ab2a1bef340a71 |
...
Compiler/source-resolved declaration: `Electrical/Machines/BasicMachines/Components/AirGapR.mo:3`. Role: `parameter`; binding: `smeeData.Lmd`; effective min: `None`; effective max: `None`. 
