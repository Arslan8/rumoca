# FINDING-04603: The friction denominator is protected by an ordering assertion
...
| Target | pipe3.V_flowNominal |
| Student classification | divisor-reachable-zero |
| Original report | [FINDING-parallelpumpdropout-pipe3-v-flownominal-divzero.md](../../v2/bugs/FINDING-parallelpumpdropout-pipe3-v-flownominal-divzero.md) — reviewed as `FINDING-04603-parallelpumpdropout-pipe3-v-flownominal.md`, which a later run renamed |
| Original SHA-256 | 5f4f9231cb68180c123e375fc8bb99748408963ddf15587a28087e24836fdd7e |
...
| Probe | Outcome |
|---|---|
| `pipe3.V_flowNominal=0` | reported-failure |
