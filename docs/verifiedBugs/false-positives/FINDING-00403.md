# FINDING-00403: Zero inductance is an explicitly supported algebraic limit
...
| Original report | [FINDING-comparelinetrunks-oline3-l-4-l-zerolimit.md](../../v2/bugs/FINDING-comparelinetrunks-oline3-l-4-l-zerolimit.md) — reviewed as `FINDING-00403-comparelinetrunks-oline3-l-4-l.md`, which a later run renamed |
| Original SHA-256 | 361e15d0f4a47d55fef443835966fed1ee6c3193e807943e644c7c7db18edf93 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `oLine3.lm[4]`; effective min: `None`; effective max: `None`. 
