# FINDING-03560: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | dcdc.diodeHS.Ron |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-chopperbuckboost-dutycycle-dcdc-diodehs-ron-ruleoff.md](../../v2/bugs/FINDING-chopperbuckboost-dutycycle-dcdc-diodehs-ron-ruleoff.md) — reviewed as `FINDING-03560-chopperbuckboost-dutycycle-dcdc-diodehs-ron.md`, which a later run renamed |
| Original SHA-256 | 95cf6efa95ff664b7f7999550ee1c69ea2d72b7bdfb92e7b569c79e141ea7a58 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:4`. Role: `parameter`; binding: `dcdc.RonDiode`; effective min: `0`; effective max: `None`. 
