# FINDING-04178: MultiBody Newton/Euler equations use mass and inertia multiplicatively
...
| Target | body1.body.I_22 |
| Student classification | physical-bound-permits-zero |
| Original report | `FINDING-04178-planarfourbar-body1-body-i-22.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | f81ec0a4fcfc5bf909fe5d4b23ca50fe2eb14fc0d62924aa92fbbb57cb2aa432 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:19`. Role: `parameter`; binding: `body1.I[2, 2]`; effective min: `0`; effective max: `None`. 
