# FINDING-03555: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | dcdc.transistorLS.Goff |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-chopperbuckboost-dutycycle-dcdc-transistorls-goff-zerolimit.md](../../v2/bugs/FINDING-chopperbuckboost-dutycycle-dcdc-transistorls-goff-zerolimit.md) — reviewed as `FINDING-03555-chopperbuckboost-dutycycle-dcdc-transistorls-goff.md`, which a later run renamed |
| Original SHA-256 | 99c01a8f810aef443b0fd3776bede30bec37d84b68b6fbdb727f06a83753c85a |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:6`. Role: `parameter`; binding: `dcdc.GoffTransistor`; effective min: `0`; effective max: `None`. 
