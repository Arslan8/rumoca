# FINDING-00389: Zero inductance is an explicitly supported algebraic limit
...
| Original report | [FINDING-comparelinetrunks-oline2-l-7-l-zerolimit.md](../../v2/bugs/FINDING-comparelinetrunks-oline2-l-7-l-zerolimit.md) — reviewed as `FINDING-00389-comparelinetrunks-oline2-l-7-l.md`, which a later run renamed |
| Original SHA-256 | 552a4fca806e41093072d262c8ed6ad7cc4b397c74bccdacd5529b8349f37ead |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `oLine2.lm[7]`; effective min: `None`; effective max: `None`. 
