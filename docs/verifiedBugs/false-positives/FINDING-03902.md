# FINDING-03902: Tensor entries are not all strictly positive scalars
...
| Target | boxBody1.body.I_21 |
| Student classification | physical-domain-unenforced |
| Original report | `FINDING-03902-doublependuluminittip-boxbody1-body-i-21.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | d2cbc75f34985443c7690d62cf21ae11fc90bcbeacc25553a0766cbc3c9b75cc |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:23`. Role: `parameter`; binding: `boxBody1.I[2, 1]`; effective min: `-1.7976931348623157e+308`; effective max: `None`. 
