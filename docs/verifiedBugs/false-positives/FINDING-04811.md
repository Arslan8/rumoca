# FINDING-04811: normalized=false selects a safe explicit branch
...
| Target | criticalDamping.normalized |
| Student classification | divisor-reachable-zero |
| Original report | `FINDING-04811-continuous-initialstate-criticaldamping-normalized.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | a417cea8e26a7a5c9d6584746519603ef5befd8ce8d62245007e5dceb1506a44 |
