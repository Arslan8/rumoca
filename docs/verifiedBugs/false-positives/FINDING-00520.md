# FINDING-00520: Zero capacitance is an explicitly supported algebraic limit
...
| Original report | [FINDING-smoothstep-oline5-c-1-c-zerolimit.md](../../v2/bugs/FINDING-smoothstep-oline5-c-1-c-zerolimit.md) — reviewed as `FINDING-00520-smoothstep-oline5-c-1-c.md`, which a later run renamed |
| Original SHA-256 | 69caa21df55ab0e431ebfc43765a738c9ad5727389866b25b8902975b8cc139e |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Capacitor.mo:4`. Role: `parameter`; binding: `((oLine5.c * oLine5.length) / oLine5.N)`; effective min: `0`; effective max: `None`. 
