# FINDING-04280: MultiBody Newton/Euler equations use mass and inertia multiplicatively
...
| Original report | `FINDING-04280-mechanicalstructure-b2-i-11.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 311c960b9c9caedbab378c5672b8a21ecdf540c3ca0066e573534c9cfc3b6250 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/BodyShape.mo:24`. Role: `parameter`; binding: `2.58`; effective min: `0`; effective max: `None`. 
