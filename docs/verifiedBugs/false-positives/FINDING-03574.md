# FINDING-03574: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | chopperStepDown.transistor.Ron |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-chopperstepdown-rl-chopperstepdown-transistor-ron-ruleoff.md](../../v2/bugs/FINDING-chopperstepdown-rl-chopperstepdown-transistor-ron-ruleoff.md) — reviewed as `FINDING-03574-chopperstepdown-rl-chopperstepdown-transistor-ron.md`, which a later run renamed |
| Original SHA-256 | 43a1228f20d01d1438fc738ba1c97b63d1005e4b1d3592f8a52d856d6bed9f26 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:4`. Role: `parameter`; binding: `chopperStepDown.RonTransistor`; effective min: `0`; effective max: `None`. 
