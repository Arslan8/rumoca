# FINDING-01721: Zero space-phasor inductance is an algebraic ideal limit
...
| Target | aimc.lssigma.L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-imc-inverterdrive-aimc-lssigma-l-intent.md](../../v2/bugs/FINDING-imc-inverterdrive-aimc-lssigma-l-intent.md) — reviewed as `FINDING-01721-imc-inverterdrive-aimc-lssigma-l.md`, which a later run renamed |
| Original SHA-256 | d5fe8c0d29fab892470798f9cf29d0c944835ae6aeed97574f5c511df84f87b3 |
...
Compiler/source-resolved declaration: `Electrical/Machines/BasicMachines/Components/Inductor.mo:3`. Role: `parameter`; binding: `fill(aimc.Lssigma, 2)`; effective min: `None`; effective max: `None`. 
