# FINDING-01818: Zero capacitance is an explicitly supported algebraic limit
...
| Original report | [FINDING-imc-steinmetz-crun-c-zerolimit.md](../../v2/bugs/FINDING-imc-steinmetz-crun-c-zerolimit.md) — reviewed as `FINDING-01818-imc-steinmetz-crun-c.md`, which a later run renamed |
| Original SHA-256 | b9995c7df095ef93ef37fd549b24c0cf0290dc560291d910458559312f8930bc |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Capacitor.mo:4`. Role: `parameter`; binding: `Cr`; effective min: `0`; effective max: `None`. 
