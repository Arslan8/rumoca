# FINDING-03782: Zero ElastoGap stiffness is handled without division
...
| Target | cActuator.armature.stopper_xMax.c |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-armaturestroke-cactuator-armature-stopper-xmax-c-zerolimit.md](../../v2/bugs/FINDING-armaturestroke-cactuator-armature-stopper-xmax-c-zerolimit.md) — reviewed as `FINDING-03782-armaturestroke-cactuator-armature-stopper-xmax-c.md`, which a later run renamed |
| Original SHA-256 | abd0ef5f282829f686734a5c4d5f5aa784b91c9b7ddb3abe2f0a463316eee741 |
