# FINDING-03611: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | chopperStepUp.diode.Goff |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-chopperstepup-r-chopperstepup-diode-goff-zerolimit.md](../../v2/bugs/FINDING-chopperstepup-r-chopperstepup-diode-goff-zerolimit.md) — reviewed as `FINDING-03611-chopperstepup-r-chopperstepup-diode-goff.md`, which a later run renamed |
| Original SHA-256 | 07cbe5d7990333da6888f7ec84202fc479a649968bf43e7609000d0efcecdb93 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:6`. Role: `parameter`; binding: `chopperStepUp.GoffDiode`; effective min: `0`; effective max: `None`. 
