# FINDING-03688: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | hbridge.inverter_p.transistor_p.Ron |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-hbridge-trianglepwm-rl-hbridge-inverter-p-transistor-p-ron-ruleoff.md](../../v2/bugs/FINDING-hbridge-trianglepwm-rl-hbridge-inverter-p-transistor-p-ron-ruleoff.md) — reviewed as `FINDING-03688-hbridge-trianglepwm-rl-hbridge-inverter-p-transistor-p-ron.md`, which a later run renamed |
| Original SHA-256 | 87c695aae6daa64e82f1ea1bf5e7b02b16ea8ef9990712312b7351080173da46 |
