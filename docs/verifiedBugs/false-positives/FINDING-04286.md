# FINDING-04286: MultiBody Newton/Euler equations use mass and inertia multiplicatively
...
| Original report | [FINDING-mechanicalstructure-b2-body-m-zerolimit.md](../../v2/bugs/FINDING-mechanicalstructure-b2-body-m-zerolimit.md) — reviewed as `FINDING-04286-mechanicalstructure-b2-body-m.md`, which a later run renamed |
| Original SHA-256 | 361d0a65d815dbef92da19f16f76f7cc1a7050c3b0e1920b20fc4e6d5a5c1c4e |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:16`. Role: `parameter`; binding: `56.5`; effective min: `0`; effective max: `None`. 
