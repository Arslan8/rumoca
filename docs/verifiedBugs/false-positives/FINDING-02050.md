# FINDING-02050: Zero core-loss conductance deliberately disables losses
...
| Target | aims.rotorCore.coreParameters.GcRef |
| Student classification | physical-invariant-violated |
| Original report | [FINDING-ims-start-aims-rotorcore-coreparameters-gcref-zerolimit.md](../../v2/bugs/FINDING-ims-start-aims-rotorcore-coreparameters-gcref-zerolimit.md) — reviewed as `FINDING-02050-ims-start-aims-rotorcore-coreparameters-gcref.md`, which a later run renamed |
| Original SHA-256 | f96593c75afd8d0e7627dcbe1a6a29acde8a3c4165fe78914a808e949f378c64 |
...
Compiler/source-resolved declaration: `Electrical/Machines/Losses/CoreParameters.mo:18`. Role: `parameter`; binding: `aims.rotorCoreParameters.GcRef`; effective min: `None`; effective max: `None`. 
