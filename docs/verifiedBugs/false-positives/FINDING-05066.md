# FINDING-05066: Zero inertia is a massless algebraic component, not an intrinsic division
...
| Target | vehicleDragInVar.inertia.J |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-vehicles-vehicledraginvar-inertia-j-zerolimit.md](../../v2/bugs/FINDING-vehicles-vehicledraginvar-inertia-j-zerolimit.md) — reviewed as `FINDING-05066-vehicles-vehicledraginvar-inertia-j.md`, which a later run renamed |
| Original SHA-256 | 957ab748eca86d19d5baa8a99792089a29decb2a1ea81d07dfa988478edf02e9 |
