# FINDING-01540: Zero leakage inductance is a supported ideal limit
...
| Target | imcData.Lszero |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-imc-dcbraking-imcdata-lszero-intent.md](../../v2/bugs/FINDING-imc-dcbraking-imcdata-lszero-intent.md) — reviewed as `FINDING-01540-imc-dcbraking-imcdata-lszero.md`, which a later run renamed |
| Original SHA-256 | d5b7fd827be0a9a6c5844692d62bb9770673a15a086f950d0838bfe076240e5f |
...
Compiler/source-resolved declaration: `Electrical/Machines/Utilities/ParameterRecords/InductionMachineData.mo:20`. Role: `parameter`; binding: `imcData.Lssigma`; effective min: `None`; effective max: `None`. 
