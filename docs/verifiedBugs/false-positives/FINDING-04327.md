# FINDING-04327: MultiBody Newton/Euler equations use mass and inertia multiplicatively
...
| Original report | `FINDING-04327-mechanicalstructure-b5-i-33.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | b650dada24f44a7620ea0f8a30838c96969cae4fb3231302f8b2eb95f76d40e1 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/BodyShape.mo:28`. Role: `parameter`; binding: `1.53`; effective min: `0`; effective max: `None`. 
