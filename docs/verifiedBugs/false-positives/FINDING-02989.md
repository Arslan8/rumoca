# FINDING-02989: Polyphase resistance/conductance delegates to signed scalar elements
...
| Original report | `FINDING-02989-transformeryy-transformerr-r.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 3634aa6a7426281896bfeac0dca266439c8fd72c1c8778eb69edeb17495c3a87 |
...
Compiler/source-resolved declaration: `Electrical/Polyphase/Basic/Resistor.mo:4`. Role: `parameter`; binding: `fill(RT, m)`; effective min: `None`; effective max: `None`. 
