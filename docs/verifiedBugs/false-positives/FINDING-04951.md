# FINDING-04951: Polyphase resistance/conductance delegates to signed scalar elements
...
| Target | innerResistor.R |
| Student classification | physical-domain-unenforced |
| Original report | `FINDING-04951-thyristorbridge2mpulse-r-innerresistor-r.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 35f585c8526336dc8942b6a8d56935bed8f32894b12052d9f2cbd5714a4fc3ca |
...
Compiler/source-resolved declaration: `Electrical/Polyphase/Basic/Resistor.mo:4`. Role: `parameter`; binding: `fill(1, m)`; effective min: `None`; effective max: `None`. 
