# FINDING-01695: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | inverter.diode_p.idealDiode[1].Ron |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-imc-inverterdrive-inverter-diode-p-idealdiode-1-ron-ruleoff.md](../../v2/bugs/FINDING-imc-inverterdrive-inverter-diode-p-idealdiode-1-ron-ruleoff.md) — reviewed as `FINDING-01695-imc-inverterdrive-inverter-diode-p-idealdiode-1-ron.md`, which a later run renamed |
| Original SHA-256 | eadc9ae5f17c4dcb5f9500855cfa46ce09a6745d2db715ae227bbed741e88568 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:4`. Role: `parameter`; binding: `inverter.diode_p.Ron[1]`; effective min: `0`; effective max: `None`. 
