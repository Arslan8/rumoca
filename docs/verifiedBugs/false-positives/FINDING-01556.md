# FINDING-01556: Air-gap inductance is used as a flux multiplier
...
| Target | imc.airGap.Lm |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-imc-dcbraking-imc-airgap-lm-zerolimit.md](../../v2/bugs/FINDING-imc-dcbraking-imc-airgap-lm-zerolimit.md) — reviewed as `FINDING-01556-imc-dcbraking-imc-airgap-lm.md`, which a later run renamed |
| Original SHA-256 | 6247fdad9407130075f9ad03d9ed5fefa3e47bceedd71cd75c0ee85e09f0fbf3 |
...
Compiler/source-resolved declaration: `Electrical/Machines/BasicMachines/Components/AirGapS.mo:3`. Role: `parameter`; binding: `imcData.Lm`; effective min: `None`; effective max: `None`. 
