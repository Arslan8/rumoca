# FINDING-00518: Zero inductance is an explicitly supported algebraic limit
...
| Original report | [FINDING-smoothstep-oline5-l-5-l-zerolimit.md](../../v2/bugs/FINDING-smoothstep-oline5-l-5-l-zerolimit.md) — reviewed as `FINDING-00518-smoothstep-oline5-l-5-l.md`, which a later run renamed |
| Original SHA-256 | 4ddb211456b8fe89d73e045a40506a9e4372b1243f9d5051e100541b629a2737 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `oLine5.lm[5]`; effective min: `None`; effective max: `None`. 
