# FINDING-02914: Polyphase resistance/conductance delegates to signed scalar elements
...
| Target | transformer.r2.R |
| Student classification | physical-domain-unenforced |
| Original report | `FINDING-02914-transformertestbench-transformer-r2-r.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 55fb8e44349b7f82b73bdfce9fd081ba05e27ed5dbede91376a6e841c4b970c7 |
...
Compiler/source-resolved declaration: `Electrical/Polyphase/Basic/Resistor.mo:4`. Role: `parameter`; binding: `fill(transformer.R2, transformer.m)`; effective min: `None`; effective max: `None`. 
