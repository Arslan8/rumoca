# FINDING-03314: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | rectifier.diode_p.idealDiode[1].Goff |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-diodecentertap2mpulse-rectifier-diode-p-idealdiode-1-goff-zerolimit.md](../../v2/bugs/FINDING-diodecentertap2mpulse-rectifier-diode-p-idealdiode-1-goff-zerolimit.md) — reviewed as `FINDING-03314-diodecentertap2mpulse-rectifier-diode-p-idealdiode-1-goff.md`, which a later run renamed |
| Original SHA-256 | 5dacb8087b3e819af58c39af9077dfe7e5a6bb995bff30bde6c76e5cd8e0115c |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:6`. Role: `parameter`; binding: `rectifier.diode_p.Goff[1]`; effective min: `0`; effective max: `None`. 
