# FINDING-01547: Zero stator leakage inductance is supported
...
| Original report | [FINDING-imc-dcbraking-imc-lssigma-intent.md](../../v2/bugs/FINDING-imc-dcbraking-imc-lssigma-intent.md) — reviewed as `FINDING-01547-imc-dcbraking-imc-lssigma.md`, which a later run renamed |
| Original SHA-256 | 88a5899dbdd20784bb9e63089ad1796cbcfd1c8a6e9bdeaeadcf575b1934fdd1 |
...
Compiler/source-resolved declaration: `Electrical/Machines/Interfaces/PartialBasicInductionMachine.mo:23`. Role: `parameter`; binding: `imcData.Lssigma`; effective min: `None`; effective max: `None`. 
