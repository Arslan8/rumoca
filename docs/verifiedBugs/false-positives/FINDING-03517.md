# FINDING-03517: Converter switch parameters delegate to ideal semiconductor limits
...
| Original report | [FINDING-singlephasetwolevel-rl-inverter-goffdiode-zerolimit.md](../../v2/bugs/FINDING-singlephasetwolevel-rl-inverter-goffdiode-zerolimit.md) — reviewed as `FINDING-03517-singlephasetwolevel-rl-inverter-goffdiode.md`, which a later run renamed |
| Original SHA-256 | 825a864bbab1d1c49b88ad73d5e0c666cf5b865c7868c08abb205ee984f83a2e |
...
Compiler/source-resolved declaration: `Electrical/PowerConverters/DCAC/SinglePhase2Level.mo:12`. Role: `parameter`; binding: `1e-05`; effective min: `None`; effective max: `None`. 
