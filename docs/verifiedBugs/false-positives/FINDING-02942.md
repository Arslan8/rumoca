# FINDING-02942: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | idealDiode1.idealDiode[3].Goff |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-rectifier-idealdiode1-idealdiode-3-goff-zerolimit.md](../../v2/bugs/FINDING-rectifier-idealdiode1-idealdiode-3-goff-zerolimit.md) — reviewed as `FINDING-02942-rectifier-idealdiode1-idealdiode-3-goff.md`, which a later run renamed |
| Original SHA-256 | 7abc64f49c10c2e73f43a9fb98c171d65a715f948387d90b228bff304994f388 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:6`. Role: `parameter`; binding: `idealDiode1.Goff[3]`; effective min: `0`; effective max: `None`. 
