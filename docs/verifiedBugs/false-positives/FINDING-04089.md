# FINDING-04089: MultiBody Newton/Euler equations use mass and inertia multiplicatively
...
| Target | referenceSystem.pointMass4.m |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-pointgravitywithpointmasses2-referencesystem-pointmass4-m-zerolimit.md](../../v2/bugs/FINDING-pointgravitywithpointmasses2-referencesystem-pointmass4-m-zerolimit.md) — reviewed as `FINDING-04089-pointgravitywithpointmasses2-referencesystem-pointmass4-m.md`, which a later run renamed |
| Original SHA-256 | dd22380f31d533dbb53676907bb55f189342c9d379db89da573c409666ca239b |
