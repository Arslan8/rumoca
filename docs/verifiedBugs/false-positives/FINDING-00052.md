# FINDING-00052: Zero capacitance is an explicitly supported algebraic limit
...
| Original report | [FINDING-cauerlowpassopv-c5-c-zerolimit.md](../../v2/bugs/FINDING-cauerlowpassopv-c5-c-zerolimit.md) — reviewed as `FINDING-00052-cauerlowpassopv-c5-c.md`, which a later run renamed |
| Original SHA-256 | 654013d210721d7938b08fcc41eeebe6d7f4cb30370cea3a0b965faba03af85f |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Capacitor.mo:4`. Role: `parameter`; binding: `c2`; effective min: `0`; effective max: `None`. 
