# FINDING-03635: Converter switch parameters delegate to ideal semiconductor limits
...
| Original report | [FINDING-hbridge-rl-hbridge-inverter-n-gofftransistor-zerolimit.md](../../v2/bugs/FINDING-hbridge-rl-hbridge-inverter-n-gofftransistor-zerolimit.md) — reviewed as `FINDING-03635-hbridge-rl-hbridge-inverter-n-gofftransistor.md`, which a later run renamed |
| Original SHA-256 | 4ed9d8b0f39102532ac3473427fb8f292f774c6dc8d2f66b8212f3694ca8f6e1 |
