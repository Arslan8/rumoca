# FINDING-04333: MultiBody Newton/Euler equations use mass and inertia multiplicatively
...
| Original report | `FINDING-04333-mechanicalstructure-b5-body-i-22.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 62798786a17bd86be2e979f5a58430093e35928019f5f1e2418cf9b69777a9d4 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:19`. Role: `parameter`; binding: `0.81`; effective min: `0`; effective max: `None`. 
