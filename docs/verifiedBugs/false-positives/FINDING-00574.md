# FINDING-00574: Zero inductance is an explicitly supported algebraic limit
...
| Target | oLine50.L[48].L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-smoothstep-oline50-l-48-l-zerolimit.md](../../v2/bugs/FINDING-smoothstep-oline50-l-48-l-zerolimit.md) — reviewed as `FINDING-00574-smoothstep-oline50-l-48-l.md`, which a later run renamed |
| Original SHA-256 | 77513a97977b81f331aa74eb6be4474a91ffb590df48ba3c47594a09089b5882 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `oLine50.lm[48]`; effective min: `None`; effective max: `None`. 
