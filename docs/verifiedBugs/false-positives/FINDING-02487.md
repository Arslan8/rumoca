# FINDING-02487: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | switch2.idealClosingSwitch[1].Ron |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-smpm-resistivebraking-switch2-idealclosingswitch-1-ron-ruleoff.md](../../v2/bugs/FINDING-smpm-resistivebraking-switch2-idealclosingswitch-1-ron-ruleoff.md) — reviewed as `FINDING-02487-smpm-resistivebraking-switch2-idealclosingswitch-1-ron.md`, which a later run renamed |
| Original SHA-256 | a0486d7a1d111845f7769e40e195b61d2ea3b798ab22328b48a75f940b8557ae |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSwitch.mo:4`. Role: `parameter`; binding: `switch2.Ron[1]`; effective min: `0`; effective max: `None`. 
