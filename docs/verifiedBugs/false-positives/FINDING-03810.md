# FINDING-03810: Armature example delegates to zero-capable mechanical terms
...
| Original report | [FINDING-permeanceactuator-armature-c-intent.md](../../v2/bugs/FINDING-permeanceactuator-armature-c-intent.md) — reviewed as `FINDING-03810-permeanceactuator-armature-c.md`, which a later run renamed |
| Original SHA-256 | 7d8219182ef297aacada2edd1e8fc647cacf8be5e570233d4b01bb39b29fd694 |
...
Compiler/source-resolved declaration: `Magnetic/FluxTubes/Examples/Utilities/TranslatoryArmatureAndStopper.mo:9`. Role: `parameter`; binding: `c`; effective min: `None`; effective max: `None`. 
