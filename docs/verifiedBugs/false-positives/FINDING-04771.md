# FINDING-04771: Zero heat capacity is a no-storage algebraic limit
...
| Original report | [FINDING-directcapacity-heatcapacitor-c-zerolimit.md](../../v2/bugs/FINDING-directcapacity-heatcapacitor-c-zerolimit.md) — reviewed as `FINDING-04771-directcapacity-heatcapacitor-c.md`, which a later run renamed |
| Original SHA-256 | ebe79cdab3df60c418ff893700c865a55b609d60296665e2ae6514cb8cd700c6 |
...
Compiler/source-resolved declaration: `Thermal/HeatTransfer/Components/HeatCapacitor.mo:3`. Role: `parameter`; binding: `C`; effective min: `None`; effective max: `None`. 
