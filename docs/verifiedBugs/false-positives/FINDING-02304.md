# FINDING-02304: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | diodeBridge2mPulse.diode_n.idealDiode[2].Ron |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-smpm-braking-diodebridge2mpulse-diode-n-idealdiode-2-ron-ruleoff.md](../../v2/bugs/FINDING-smpm-braking-diodebridge2mpulse-diode-n-idealdiode-2-ron-ruleoff.md) — reviewed as `FINDING-02304-smpm-braking-diodebridge2mpulse-diode-n-idealdiode-2-ron.md`, which a later run renamed |
| Original SHA-256 | 35a9f348a9a66674f5be8d97715cfc694831895a1a4b551c96fd928946e7e472 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:4`. Role: `parameter`; binding: `diodeBridge2mPulse.diode_n.Ron[2]`; effective min: `0`; effective max: `None`. 
