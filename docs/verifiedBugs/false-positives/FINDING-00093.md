# FINDING-00093: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | R8.IdealCommutingSwitch1.Goff |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-cauerlowpasssc-r8-idealcommutingswitch1-goff-ruleoff.md](../../v2/bugs/FINDING-cauerlowpasssc-r8-idealcommutingswitch1-goff-ruleoff.md) — reviewed as `FINDING-00093-cauerlowpasssc-r8-idealcommutingswitch1-goff.md`, which a later run renamed |
| Original SHA-256 | 40e04b85b3838318911039fcfec85fd074456f6160c4d4ef3924a3dc795001bb |
