# FINDING-01651: Zero core-loss conductance deliberately disables losses
...
| Original report | [FINDING-imc-inverterdrive-aimc-statorcore-coreparameters-gcref-zerolimit.md](../../v2/bugs/FINDING-imc-inverterdrive-aimc-statorcore-coreparameters-gcref-zerolimit.md) — reviewed as `FINDING-01651-imc-inverterdrive-aimc-statorcore-coreparameters-gcref.md`, which a later run renamed |
| Original SHA-256 | ff3a8bca3208dfb3e6e7d9f9003ac91c87fb97a851f6701880d8fbaa525b5ff7 |
...
Compiler/source-resolved declaration: `Electrical/Machines/Losses/CoreParameters.mo:18`. Role: `parameter`; binding: `aimc.statorCoreParameters.GcRef`; effective min: `None`; effective max: `None`. 
