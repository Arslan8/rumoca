# FINDING-01161: Zero inertia is a massless algebraic component, not an intrinsic division
...
| Target | dcee.inertiaRotor.J |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-dc-comparecharacteristics-dcee-inertiarotor-j-zerolimit.md](../../v2/bugs/FINDING-dc-comparecharacteristics-dcee-inertiarotor-j-zerolimit.md) — reviewed as `FINDING-01161-dc-comparecharacteristics-dcee-inertiarotor-j.md`, which a later run renamed |
| Original SHA-256 | 9d2a2a82c49e11def91956fd85b631b485e0de1ea977cf9603abd6d82932593c |
...
Compiler/source-resolved declaration: `Mechanics/Rotational/Components/Inertia.mo:4`. Role: `parameter`; binding: `dcee.Jr`; effective min: `0`; effective max: `None`. 
