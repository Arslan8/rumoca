# FINDING-04240: MultiBody Newton/Euler equations use mass and inertia multiplicatively
...
| Target | bodyBox.body.I_22 |
| Student classification | physical-bound-permits-zero |
| Original report | `FINDING-04240-bevelgear1d-bodybox-body-i-22.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | c9d7f3d06385af22942c8675b4f993a50d0b3864b2ae5d5318d5bdb6220e9e59 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:19`. Role: `parameter`; binding: `bodyBox.I[2, 2]`; effective min: `0`; effective max: `None`. 
