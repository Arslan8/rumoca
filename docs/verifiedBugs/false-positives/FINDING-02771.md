# FINDING-02771: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | diode1.idealDiode[3].Ron |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-rectifier12pulse-diode1-idealdiode-3-ron-ruleoff.md](../../v2/bugs/FINDING-rectifier12pulse-diode1-idealdiode-3-ron-ruleoff.md) — reviewed as `FINDING-02771-rectifier12pulse-diode1-idealdiode-3-ron.md`, which a later run renamed |
| Original SHA-256 | 25f6ec4c17c5a678ee0052f7b5e4e4a106473bc75902078504cfe09f5c22c653 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:4`. Role: `parameter`; binding: `diode1.Ron[3]`; effective min: `0`; effective max: `None`. 
