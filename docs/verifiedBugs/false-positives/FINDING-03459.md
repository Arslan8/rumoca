# FINDING-03459: Zero on-resistance/off-conductance is an intended ideal limit
...
| Original report | [FINDING-diodecentertapmpulse-rectifier-diode-idealdiode-2-ron-ruleoff.md](../../v2/bugs/FINDING-diodecentertapmpulse-rectifier-diode-idealdiode-2-ron-ruleoff.md) — reviewed as `FINDING-03459-diodecentertapmpulse-rectifier-diode-idealdiode-2-ron.md`, which a later run renamed |
| Original SHA-256 | 4a45e340134221455c0c3e8bfbaccc9d0e5560e1a1f9500fcb53fa256b52919b |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:4`. Role: `parameter`; binding: `rectifier.diode.Ron[2]`; effective min: `0`; effective max: `None`. 
