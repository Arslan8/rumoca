# FINDING-05104: vRef is a protected nonzero constant
...
| Target | vehicleRoll.vRef |
| Student classification | divisor-reachable-zero |
| Original report | `FINDING-05104-vehicles-vehicleroll-vref.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 4d4503315a73b4adc5b42ce3492c93b5401f7df08cc5b2a004fe627148946516 |
