# FINDING-00406: Zero inductance is an explicitly supported algebraic limit
...
| Original report | [FINDING-comparelinetrunks-oline3-l-7-l-zerolimit.md](../../v2/bugs/FINDING-comparelinetrunks-oline3-l-7-l-zerolimit.md) — reviewed as `FINDING-00406-comparelinetrunks-oline3-l-7-l.md`, which a later run renamed |
| Original SHA-256 | fe62d180f1a0ed720db5ba5f71cd9d1bda5ed0c8cf0e938de5d5994a36ee2575 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `oLine3.lm[7]`; effective min: `None`; effective max: `None`. 
