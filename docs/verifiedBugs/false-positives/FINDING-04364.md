# FINDING-04364: MultiBody Newton/Euler equations use mass and inertia multiplicatively
...
| Target | load.body.I_33 |
| Student classification | physical-bound-permits-zero |
| Original report | `FINDING-04364-mechanicalstructure-load-body-i-33.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 48f7d7124bf893331d44ca6a2071386454ee6a040fb143c0288e98eeb023ada4 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:21`. Role: `parameter`; binding: `load.I_33`; effective min: `0`; effective max: `None`. 
