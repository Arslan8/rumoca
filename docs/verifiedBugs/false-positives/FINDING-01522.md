# FINDING-01522: DC machine-data field has a supported ideal limit
...
| Original report | [FINDING-dcse-start-dcsedata-js-intent.md](../../v2/bugs/FINDING-dcse-start-dcsedata-js-intent.md) — reviewed as `FINDING-01522-dcse-start-dcsedata-js.md`, which a later run renamed |
| Original SHA-256 | cf33ae3d81ff0286ef736c5dcdde5b7327823496fce0e5acaff7d6aa59555338 |
