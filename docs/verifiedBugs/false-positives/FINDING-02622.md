# FINDING-02622: Machine inertia delegates to the zero-capable algebraic inertia component
...
| Original report | [FINDING-smr-inverter-smr-jr-zerolimit.md](../../v2/bugs/FINDING-smr-inverter-smr-jr-zerolimit.md) — reviewed as `FINDING-02622-smr-inverter-smr-jr.md`, which a later run renamed |
| Original SHA-256 | a4a0b190db93636b00bb7ecb574df15e0c988f8a0641cbe6ac58556f4dbdf514 |
...
Compiler/source-resolved declaration: `Electrical/Machines/Interfaces/PartialBasicMachine.mo:5`. Role: `parameter`; binding: `smrData.Jr`; effective min: `None`; effective max: `None`. 
