# FINDING-03219: Zero core-loss conductance deliberately disables losses
...
| Target | dcpmData.coreParameters.GcRef |
| Student classification | physical-invariant-violated |
| Original report | [FINDING-thyristorbridge2pulse-dc-drive-dcpmdata-coreparameters-gcref-zerolimit.md](../../v2/bugs/FINDING-thyristorbridge2pulse-dc-drive-dcpmdata-coreparameters-gcref-zerolimit.md) — reviewed as `FINDING-03219-thyristorbridge2pulse-dc-drive-dcpmdata-coreparameters-gcref.md`, which a later run renamed |
| Original SHA-256 | 7c9a55ab2e25d15014716dd3150da358ddd1501256f6b73cd8bcd4c4e7626c8e |
...
Compiler/source-resolved declaration: `Electrical/Machines/Losses/CoreParameters.mo:18`. Role: `parameter`; binding: `0`; effective min: `None`; effective max: `None`. 
