# FINDING-00752: Zero capacitance is an explicitly supported algebraic limit
...
| Original report | [FINDING-nandgate-nand-c4-c-zerolimit.md](../../v2/bugs/FINDING-nandgate-nand-c4-c-zerolimit.md) — reviewed as `FINDING-00752-nandgate-nand-c4-c.md`, which a later run renamed |
| Original SHA-256 | 98da25692acf05501586acfe25bb3cf0819d816ba185c3692c082bbc1a4e63b5 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Capacitor.mo:4`. Role: `parameter`; binding: `4e-14`; effective min: `0`; effective max: `None`. 
