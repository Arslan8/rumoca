# FINDING-02500: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | switch3.idealClosingSwitch[3].Goff |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-smpm-resistivebraking-switch3-idealclosingswitch-3-goff-ruleoff.md](../../v2/bugs/FINDING-smpm-resistivebraking-switch3-idealclosingswitch-3-goff-ruleoff.md) — reviewed as `FINDING-02500-smpm-resistivebraking-switch3-idealclosingswitch-3-goff.md`, which a later run renamed |
| Original SHA-256 | 559802b0adbefe7289802681d3cfecb9ff08b0c470fff0aae09de31ebc6cea1c |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSwitch.mo:6`. Role: `parameter`; binding: `switch3.Goff[3]`; effective min: `0`; effective max: `None`. 
