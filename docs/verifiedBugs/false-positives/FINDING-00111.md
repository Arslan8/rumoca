# FINDING-00111: Zero capacitance is an explicitly supported algebraic limit
...
| Target | R2.Capacitor.C |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-cauerlowpasssc-r2-capacitor-c-zerolimit.md](../../v2/bugs/FINDING-cauerlowpasssc-r2-capacitor-c-zerolimit.md) — reviewed as `FINDING-00111-cauerlowpasssc-r2-capacitor-c.md`, which a later run renamed |
| Original SHA-256 | 9b72a6eed6129eb3e38f45de93d779e21c17a41919fd4826c6ac2659069dbb28 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Capacitor.mo:4`. Role: `parameter`; binding: `(R2.clock / max((2.220446049250313e-16 * R2.oneOhm), abs(R2.R)))`; effective min: `0`; effective max: `None`. 
