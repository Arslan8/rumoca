# FINDING-03960: MultiBody Newton/Euler equations use mass and inertia multiplicatively
...
| Original report | [FINDING-freebody-body-body-m-zerolimit.md](../../v2/bugs/FINDING-freebody-body-body-m-zerolimit.md) — reviewed as `FINDING-03960-freebody-body-body-m.md`, which a later run renamed |
| Original SHA-256 | 4afb96b943764a438c0e7a4056002dfe73be98b7a4cdade66b6f728d43265985 |
