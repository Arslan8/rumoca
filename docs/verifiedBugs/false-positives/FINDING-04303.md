# FINDING-04303: MultiBody Newton/Euler equations use mass and inertia multiplicatively
...
| Original report | `FINDING-04303-mechanicalstructure-b3-body-i-22.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 3a6bad538ac8b0fd0bbb135d6a7c52baa58a2e3d7b017318231e5d7c3f27b3a0 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:19`. Role: `parameter`; binding: `0.245`; effective min: `0`; effective max: `None`. 
