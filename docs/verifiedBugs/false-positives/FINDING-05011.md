# FINDING-05011: Zero mass is a massless algebraic component, not an intrinsic division
...
| Target | slidingMass.m |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-testmove-slidingmass-m-zerolimit.md](../../v2/bugs/FINDING-testmove-slidingmass-m-zerolimit.md) — reviewed as `FINDING-05011-testmove-slidingmass-m.md`, which a later run renamed |
| Original SHA-256 | 892c01872d6699e5c573f7ccd799d95174c03c80c3ec47790227e4472bf92296 |
...
Compiler/source-resolved declaration: `Mechanics/Translational/Components/Mass.mo:3`. Role: `parameter`; binding: `2`; effective min: `0`; effective max: `None`. 
