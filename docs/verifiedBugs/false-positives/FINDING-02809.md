# FINDING-02809: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | diode3.idealDiode[3].Ron |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-rectifier12pulse-diode3-idealdiode-3-ron-ruleoff.md](../../v2/bugs/FINDING-rectifier12pulse-diode3-idealdiode-3-ron-ruleoff.md) — reviewed as `FINDING-02809-rectifier12pulse-diode3-idealdiode-3-ron.md`, which a later run renamed |
| Original SHA-256 | 406c8bd0da000a14e4bac2e7ea0a66189c0a088e65acfc111bbf46485b759703 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:4`. Role: `parameter`; binding: `diode3.Ron[3]`; effective min: `0`; effective max: `None`. 
