# FINDING-03696: Converter switch parameters delegate to ideal semiconductor limits
...
| Original report | [FINDING-hbridge-trianglepwm-rl-hbridge-inverter-n-rontransistor-ruleoff.md](../../v2/bugs/FINDING-hbridge-trianglepwm-rl-hbridge-inverter-n-rontransistor-ruleoff.md) — reviewed as `FINDING-03696-hbridge-trianglepwm-rl-hbridge-inverter-n-rontransistor.md`, which a later run renamed |
| Original SHA-256 | 4324b83271ea0a1d8e2028c04b5825b8503ff8c256d1a5a9caa500fa19cd6f60 |
