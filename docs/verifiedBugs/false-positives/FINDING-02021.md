# FINDING-02021: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | switchYD.idealCloser.idealClosingSwitch[2].Goff |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-imc-yd-switchyd-idealcloser-idealclosingswitch-2-goff-ruleoff.md](../../v2/bugs/FINDING-imc-yd-switchyd-idealcloser-idealclosingswitch-2-goff-ruleoff.md) — reviewed as `FINDING-02021-imc-yd-switchyd-idealcloser-idealclosingswitch-2-goff.md`, which a later run renamed |
| Original SHA-256 | 9cd98d5096e6662ee3a6990911fae6633a0c60baec96ae49d9a621a7e4b864b9 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSwitch.mo:6`. Role: `parameter`; binding: `switchYD.idealCloser.Goff[2]`; effective min: `0`; effective max: `None`. 
