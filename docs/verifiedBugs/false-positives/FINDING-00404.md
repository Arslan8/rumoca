# FINDING-00404: Zero inductance is an explicitly supported algebraic limit
...
| Original report | [FINDING-comparelinetrunks-oline3-l-5-l-zerolimit.md](../../v2/bugs/FINDING-comparelinetrunks-oline3-l-5-l-zerolimit.md) — reviewed as `FINDING-00404-comparelinetrunks-oline3-l-5-l.md`, which a later run renamed |
| Original SHA-256 | daa6930fc0f8e8004ee6bee1299efcee96032c980a796bc79b92417a83f769b2 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `oLine3.lm[5]`; effective min: `None`; effective max: `None`. 
