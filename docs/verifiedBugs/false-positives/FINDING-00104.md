# FINDING-00104: Zero capacitance is an explicitly supported algebraic limit
...
| Original report | [FINDING-cauerlowpasssc-r1-capacitor-c-zerolimit.md](../../v2/bugs/FINDING-cauerlowpasssc-r1-capacitor-c-zerolimit.md) — reviewed as `FINDING-00104-cauerlowpasssc-r1-capacitor-c.md`, which a later run renamed |
| Original SHA-256 | 25ad38bbeffca02176ec6042faee32387286201e1cbb05faae6491479ef00587 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Capacitor.mo:4`. Role: `parameter`; binding: `(R1.clock / max((2.220446049250313e-16 * R1.oneOhm), abs(R1.R)))`; effective min: `0`; effective max: `None`. 
