# FINDING-02911: Zero inductance is an explicitly supported algebraic limit
...
| Original report | [FINDING-transformertestbench-transformer-l1sigma-inductor-1-l-zerolimit.md](../../v2/bugs/FINDING-transformertestbench-transformer-l1sigma-inductor-1-l-zerolimit.md) — reviewed as `FINDING-02911-transformertestbench-transformer-l1sigma-inductor-1-l.md`, which a later run renamed |
| Original SHA-256 | 12adf5644c1999daf4b91fdb05f29e194b1cd1a7f1914e2dea5921b3e7c03c00 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `transformer.l1sigma.L[1]`; effective min: `None`; effective max: `None`. 
