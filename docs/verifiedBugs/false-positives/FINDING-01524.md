# FINDING-01524: DC machine-data field has a supported ideal limit
...
| Original report | [FINDING-dcse-start-dcsedata-la-intent.md](../../v2/bugs/FINDING-dcse-start-dcsedata-la-intent.md) — reviewed as `FINDING-01524-dcse-start-dcsedata-la.md`, which a later run renamed |
| Original SHA-256 | 8cb046d263e217957553a037d5f40bbcf168b282748681dd1d48d20759063217 |
