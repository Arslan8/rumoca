# FINDING-02426: Machine inertia delegates to the zero-capable algebraic inertia component
...
| Original report | [FINDING-smpm-noload-smpm-js-zerolimit.md](../../v2/bugs/FINDING-smpm-noload-smpm-js-zerolimit.md) — reviewed as `FINDING-02426-smpm-noload-smpm-js.md`, which a later run renamed |
| Original SHA-256 | e4079409b43db604f94e9a5767c968249839886558f33d250ae7ec342759b5ba |
...
Compiler/source-resolved declaration: `Electrical/Machines/Interfaces/PartialBasicMachine.mo:8`. Role: `parameter`; binding: `smpm.Jr`; effective min: `None`; effective max: `None`. 
