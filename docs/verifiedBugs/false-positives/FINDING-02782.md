# FINDING-02782: Zero capacitance is an explicitly supported algebraic limit
...
| Original report | [FINDING-rectifier12pulse-cdc2-c-zerolimit.md](../../v2/bugs/FINDING-rectifier12pulse-cdc2-c-zerolimit.md) — reviewed as `FINDING-02782-rectifier12pulse-cdc2-c.md`, which a later run renamed |
| Original SHA-256 | 31120db154278c5a2247e9a4191f3e7ed92d58b116accf067bba76d1f0e514d8 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Capacitor.mo:4`. Role: `parameter`; binding: `(2 * C)`; effective min: `0`; effective max: `None`. 
