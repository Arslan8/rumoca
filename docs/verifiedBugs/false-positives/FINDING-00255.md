# FINDING-00255: Zero inductance is an explicitly supported algebraic limit
...
| Target | directInductor3.inductor.L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-generationoffmus-directinductor3-inductor-l-zerolimit.md](../../v2/bugs/FINDING-generationoffmus-directinductor3-inductor-l-zerolimit.md) — reviewed as `FINDING-00255-generationoffmus-directinductor3-inductor-l.md`, which a later run renamed |
| Original SHA-256 | 4de6933a0813c95d2e885628206836e8c2e29d5358a855e65f4e6a0cf7a48bc7 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `0.001`; effective min: `None`; effective max: `None`. 
