# FINDING-04866: Zero inertia is a massless algebraic component, not an intrinsic division
...
| Target | smpm.inertiaRotor.J |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-smpm-voltagesourcewithlosses-smpm-inertiarotor-j-zerolimit.md](../../v2/bugs/FINDING-smpm-voltagesourcewithlosses-smpm-inertiarotor-j-zerolimit.md) — reviewed as `FINDING-04866-smpm-voltagesourcewithlosses-smpm-inertiarotor-j.md`, which a later run renamed |
| Original SHA-256 | cae2244bd8d924edd3c77b508300c56c355f9d3074ba3b706dbe22b34d247272 |
...
Compiler/source-resolved declaration: `Mechanics/Rotational/Components/Inertia.mo:4`. Role: `parameter`; binding: `smpm.Jr`; effective min: `0`; effective max: `None`. 
