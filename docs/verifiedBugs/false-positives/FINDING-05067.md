# FINDING-05067: Zero mass is a massless algebraic component, not an intrinsic division
...
| Target | vehicleDragInVar.mass.m |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-vehicles-vehicledraginvar-mass-m-zerolimit.md](../../v2/bugs/FINDING-vehicles-vehicledraginvar-mass-m-zerolimit.md) — reviewed as `FINDING-05067-vehicles-vehicledraginvar-mass-m.md`, which a later run renamed |
| Original SHA-256 | e776a1ba107c9edd7475e9f55b482eebf7e38af4ba228105c0ae9068af0c1238 |
