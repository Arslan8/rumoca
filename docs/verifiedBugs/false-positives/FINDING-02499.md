# FINDING-02499: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | switch3.idealClosingSwitch[3].Ron |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-smpm-resistivebraking-switch3-idealclosingswitch-3-ron-ruleoff.md](../../v2/bugs/FINDING-smpm-resistivebraking-switch3-idealclosingswitch-3-ron-ruleoff.md) — reviewed as `FINDING-02499-smpm-resistivebraking-switch3-idealclosingswitch-3-ron.md`, which a later run renamed |
| Original SHA-256 | e7e268dba986ecbd28f4cc475dc6943053c8ed4ef88454729dc2fb8dbd22021a |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSwitch.mo:4`. Role: `parameter`; binding: `switch3.Ron[3]`; effective min: `0`; effective max: `None`. 
