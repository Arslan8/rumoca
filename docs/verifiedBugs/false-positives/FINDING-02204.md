# FINDING-02204: Air-gap inductance is used as a flux multiplier
...
| Target | smee.airGap.L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-smee-generator-smee-airgap-l-zerolimit.md](../../v2/bugs/FINDING-smee-generator-smee-airgap-l-zerolimit.md) — reviewed as `FINDING-02204-smee-generator-smee-airgap-l.md`, which a later run renamed |
| Original SHA-256 | 277d45b95d411257f28b8517da6a3c4d308a1241a3be39d0edb0edbbad4f308b |
...
Compiler/source-resolved declaration: `Electrical/Machines/BasicMachines/Components/AirGapR.mo:11`. Role: `parameter`; binding: `{{smee.airGap.Lmd, 0}, {0, smee.airGap.Lmq}}`; effective min: `None`; effective max: `None`. 
