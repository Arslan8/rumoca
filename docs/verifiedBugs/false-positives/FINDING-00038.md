# FINDING-00038: Zero inductance is an explicitly supported algebraic limit
...
| Original report | [FINDING-cauerlowpassanalog-l2-l-zerolimit.md](../../v2/bugs/FINDING-cauerlowpassanalog-l2-l-zerolimit.md) — reviewed as `FINDING-00038-cauerlowpassanalog-l2-l.md`, which a later run renamed |
| Original SHA-256 | e03ea1937da2c1129480d65034266f4ec85eed985b37328ccd9c0b6979d18732 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `l2`; effective min: `None`; effective max: `None`. 
