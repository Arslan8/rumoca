# FINDING-03087: Polyphase resistance/conductance delegates to signed scalar elements
...
| Original report | `FINDING-03087-thyristorbridge2mpulse-dc-drive-rmains-r.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | a9b9ec935592c6b5db5e4c2d9013a63d7923dcda3317ad9cd929952751638cfc |
...
Compiler/source-resolved declaration: `Electrical/Polyphase/Basic/Resistor.mo:4`. Role: `parameter`; binding: `fill(RMains, m)`; effective min: `None`; effective max: `None`. 
