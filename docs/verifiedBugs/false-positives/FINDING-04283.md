# FINDING-04283: Tensor entries are not all strictly positive scalars
...
| Original report | `FINDING-04283-mechanicalstructure-b2-i-21.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 2abc580b3c9082225015897ba853e4046442a6918be01dca4bf58cda1d1d27d6 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/BodyShape.mo:30`. Role: `parameter`; binding: `-0.46`; effective min: `-1.7976931348623157e+308`; effective max: `None`. 
