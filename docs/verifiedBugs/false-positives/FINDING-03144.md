# FINDING-03144: Polyphase resistance/conductance delegates to signed scalar elements
...
| Target | multiStarResistance.resistor.R |
| Student classification | physical-domain-unenforced |
| Original report | `FINDING-03144-thyristorbridge2mpulse-rlv-characteristic-multistarresistance-resistor.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | f0e87d83edebde29abefa1ba78f61f751e72fa73968bc999f6e178fc8a868176 |
...
Compiler/source-resolved declaration: `Electrical/Polyphase/Basic/Resistor.mo:4`. Role: `parameter`; binding: `fill(multiStarResistance.R, multiStarResistance.mBasic)`; effective min: `None`; effective max: `None`. 
