# FINDING-04439: Zero ElastoGap stiffness is handled without division
...
| Original report | [FINDING-elastogap-elastogap2-c-intent.md](../../v2/bugs/FINDING-elastogap-elastogap2-c-intent.md) — reviewed as `FINDING-04439-elastogap-elastogap2-c.md`, which a later run renamed |
| Original SHA-256 | 449e8fb884ae7a7ddae6b7527eb3244b2b85e852cc7b74b33313cd3534243416 |
...
Compiler/source-resolved declaration: `Mechanics/Translational/Components/ElastoGap.mo:4`. Role: `parameter`; binding: `10`; effective min: `0`; effective max: `None`. 
