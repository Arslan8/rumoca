# FINDING-00537: Zero inductance is an explicitly supported algebraic limit
...
| Target | oLine50.L[11].L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-smoothstep-oline50-l-11-l-zerolimit.md](../../v2/bugs/FINDING-smoothstep-oline50-l-11-l-zerolimit.md) — reviewed as `FINDING-00537-smoothstep-oline50-l-11-l.md`, which a later run renamed |
| Original SHA-256 | b5d5161de62495e3826bf270fa17460322a9b521e206518b0edb39e723f9da2e |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `oLine50.lm[11]`; effective min: `None`; effective max: `None`. 
