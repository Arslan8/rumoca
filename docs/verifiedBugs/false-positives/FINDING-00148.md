# FINDING-00148: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | R11.IdealCommutingSwitch1.Goff |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-cauerlowpasssc-r11-idealcommutingswitch1-goff-ruleoff.md](../../v2/bugs/FINDING-cauerlowpasssc-r11-idealcommutingswitch1-goff-ruleoff.md) — reviewed as `FINDING-00148-cauerlowpasssc-r11-idealcommutingswitch1-goff.md`, which a later run renamed |
| Original SHA-256 | b675903ffac1f080fb456eddf0c9ea05ad16f649117a5efe835cf5cb4f58e7f6 |
