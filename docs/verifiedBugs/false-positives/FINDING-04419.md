# FINDING-04419: Zero mass is a massless algebraic component, not an intrinsic division
...
| Original report | [FINDING-comparebrakingforce-mass1-m-zerolimit.md](../../v2/bugs/FINDING-comparebrakingforce-mass1-m-zerolimit.md) — reviewed as `FINDING-04419-comparebrakingforce-mass1-m.md`, which a later run renamed |
| Original SHA-256 | a8209f7c6ab3db7e4e6c684ae17c6cbcf2f683da0a050482564dfcb66f760d38 |
...
Diagnostic: solve-IR evaluation failed: algebraic projection did not converge at event boundary: worst scaled residual row=4 target=mass1.a value=1.000000e2 ratio=1.000000e12 norm=1.000000e2 row_scale=1.000000e0 scaled_tolerance=1.000000e-10
