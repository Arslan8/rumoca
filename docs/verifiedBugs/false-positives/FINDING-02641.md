# FINDING-02641: Machine-data inertia is not intrinsically a positive divisor
...
| Original report | [FINDING-smr-inverter-smrdata-js-intent.md](../../v2/bugs/FINDING-smr-inverter-smrdata-js-intent.md) — reviewed as `FINDING-02641-smr-inverter-smrdata-js.md`, which a later run renamed |
| Original SHA-256 | dbaadd42f358230496b0650f0fedb1d701ec4152579a869477698f3a770808cf |
...
Compiler/source-resolved declaration: `Electrical/Machines/Utilities/ParameterRecords/InductionMachineData.mo:7`. Role: `parameter`; binding: `smrData.Jr`; effective min: `None`; effective max: `None`. 
