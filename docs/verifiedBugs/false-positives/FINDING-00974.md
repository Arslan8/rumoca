# FINDING-00974: Zero capacitance is an explicitly supported algebraic limit
...
| Original report | [FINDING-rectifier-capacitor2-c-zerolimit.md](../../v2/bugs/FINDING-rectifier-capacitor2-c-zerolimit.md) — reviewed as `FINDING-00974-rectifier-capacitor2-c.md`, which a later run renamed |
| Original SHA-256 | 5bb9623e49db3eab4f19de6e356519048e77e0dcc75198bb373393a5e1b5f39a |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Capacitor.mo:4`. Role: `parameter`; binding: `(2 * CDC)`; effective min: `0`; effective max: `None`. 
