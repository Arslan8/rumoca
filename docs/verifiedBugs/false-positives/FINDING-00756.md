# FINDING-00756: Zero trapezoid edge duration is handled by branch reachability
...
| Target | VIN2.signalSource.rising |
| Student classification | divisor-reachable-zero |
| Original report | [FINDING-nandgate-vin2-signalsource-rising-divunresolved.md](../../v2/bugs/FINDING-nandgate-vin2-signalsource-rising-divunresolved.md) — reviewed as `FINDING-00756-nandgate-vin2-signalsource-rising.md`, which a later run renamed |
| Original SHA-256 | eeb78722ba3f28a79e6a6eff30ea3f347978c5996319b1431620c2f1c62abbc8 |
