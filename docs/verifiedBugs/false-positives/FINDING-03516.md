# FINDING-03516: Converter switch parameters delegate to ideal semiconductor limits
...
| Original report | [FINDING-singlephasetwolevel-rl-inverter-rondiode-ruleoff.md](../../v2/bugs/FINDING-singlephasetwolevel-rl-inverter-rondiode-ruleoff.md) — reviewed as `FINDING-03516-singlephasetwolevel-rl-inverter-rondiode.md`, which a later run renamed |
| Original SHA-256 | cd998886ac0c7e8a1e54b4e61a30a2331da811c808905aab5d196fcc9041c868 |
...
Compiler/source-resolved declaration: `Electrical/PowerConverters/DCAC/SinglePhase2Level.mo:10`. Role: `parameter`; binding: `1e-05`; effective min: `None`; effective max: `None`. 
