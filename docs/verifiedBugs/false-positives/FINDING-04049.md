# FINDING-04049: MultiBody Newton/Euler equations use mass and inertia multiplicatively
...
| Original report | [FINDING-pointgravity-body2-m-zerolimit.md](../../v2/bugs/FINDING-pointgravity-body2-m-zerolimit.md) — reviewed as `FINDING-04049-pointgravity-body2-m.md`, which a later run renamed |
| Original SHA-256 | b288b2986c911158945a420ccab1fe540e57f9eed7fbe08b41e8ea3e8c090726 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:16`. Role: `parameter`; binding: `1`; effective min: `0`; effective max: `None`. 
