# FINDING-00132: Zero capacitance is an explicitly supported algebraic limit
...
| Target | R7.Capacitor.C |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-cauerlowpasssc-r7-capacitor-c-zerolimit.md](../../v2/bugs/FINDING-cauerlowpasssc-r7-capacitor-c-zerolimit.md) — reviewed as `FINDING-00132-cauerlowpasssc-r7-capacitor-c.md`, which a later run renamed |
| Original SHA-256 | 96577c6feeffc2a1f26c42ccf5899dcb0615c66664107f769563ba56e969a9c1 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Capacitor.mo:4`. Role: `parameter`; binding: `(R7.clock / max((2.220446049250313e-16 * R7.oneOhm), abs(R7.R)))`; effective min: `0`; effective max: `None`. 
