# FINDING-02191: Zero stator resistance is a supported ideal-loss limit
...
| Original report | [FINDING-smee-generator-smee-rs-ruleoff.md](../../v2/bugs/FINDING-smee-generator-smee-rs-ruleoff.md) — reviewed as `FINDING-02191-smee-generator-smee-rs.md`, which a later run renamed |
| Original SHA-256 | b2022463fec19f550a27adb9fec8bd8fe7597942bedf82a9ada17e55b76300d1 |
...
Compiler/source-resolved declaration: `Electrical/Machines/Interfaces/PartialBasicInductionMachine.mo:11`. Role: `parameter`; binding: `smeeData.Rs`; effective min: `None`; effective max: `None`. 
