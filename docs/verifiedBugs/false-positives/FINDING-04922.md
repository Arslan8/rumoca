# FINDING-04922: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | rectifier.diode_n.idealDiode[1].Ron |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-halfcontrolledbridge2mpulse-rectifier-diode-n-idealdiode-1-ron-ruleoff-2.md](../../v2/bugs/FINDING-halfcontrolledbridge2mpulse-rectifier-diode-n-idealdiode-1-ron-ruleoff-2.md) — reviewed as `FINDING-04922-halfcontrolledbridge2mpulse-rectifier-diode-n-idealdiode-1-ron.md`, which a later run renamed |
| Original SHA-256 | 6ec4e65459dc565842c9208fc8311dc4b20f8c04f9f52257bcce460c383a9627 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:4`. Role: `parameter`; binding: `rectifier.diode_n.Ron[1]`; effective min: `0`; effective max: `None`. 
