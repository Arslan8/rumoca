# FINDING-02065: Zero inertia is a massless algebraic component, not an intrinsic division
...
| Target | aims.inertiaStator.J |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-ims-start-aims-inertiastator-j-zerolimit.md](../../v2/bugs/FINDING-ims-start-aims-inertiastator-j-zerolimit.md) — reviewed as `FINDING-02065-ims-start-aims-inertiastator-j.md`, which a later run renamed |
| Original SHA-256 | 54b137f2de5205b01b65b1a53bcb7db71c32a10b47b29d1b1e5761a07b16551c |
...
Compiler/source-resolved declaration: `Mechanics/Rotational/Components/Inertia.mo:4`. Role: `parameter`; binding: `aims.Js`; effective min: `0`; effective max: `None`. 
