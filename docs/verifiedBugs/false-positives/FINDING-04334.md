# FINDING-04334: MultiBody Newton/Euler equations use mass and inertia multiplicatively
...
| Original report | `FINDING-04334-mechanicalstructure-b5-body-i-33.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 3ad1bcf8ea2c4333b8bde6292afd1a0bf7856e0392534f418109518cd023a1ec |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:21`. Role: `parameter`; binding: `1.53`; effective min: `0`; effective max: `None`. 
