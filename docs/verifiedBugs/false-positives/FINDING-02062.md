# FINDING-02062: Machine inertia delegates to the zero-capable algebraic inertia component
...
| Original report | [FINDING-ims-start-aims-jr-zerolimit.md](../../v2/bugs/FINDING-ims-start-aims-jr-zerolimit.md) — reviewed as `FINDING-02062-ims-start-aims-jr.md`, which a later run renamed |
| Original SHA-256 | 5bfc8a0366046919db7a13eafd20b5177d31c73d3116ae2d785e7b5ca994c7eb |
...
Compiler/source-resolved declaration: `Electrical/Machines/Interfaces/PartialBasicMachine.mo:5`. Role: `parameter`; binding: `aimsData.Jr`; effective min: `None`; effective max: `None`. 
