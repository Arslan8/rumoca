# FINDING-03766: Armature example delegates to zero-capable mechanical terms
...
| Target | pmActuator.armature.m |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-armaturestroke-pmactuator-armature-m-intent.md](../../v2/bugs/FINDING-armaturestroke-pmactuator-armature-m-intent.md) — reviewed as `FINDING-03766-armaturestroke-pmactuator-armature-m.md`, which a later run renamed |
| Original SHA-256 | 440e5f79365fb24730adc23f27d29ef52df33932fd694ffde32b1ffcbecb452c |
...
Compiler/source-resolved declaration: `Magnetic/FluxTubes/Examples/Utilities/TranslatoryArmatureAndStopper.mo:7`. Role: `parameter`; binding: `pmActuator.m_a`; effective min: `0`; effective max: `None`. 
