# FINDING-02060: Zero inductance is an explicitly supported algebraic limit
...
| Target | aims.lszero.L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-ims-start-aims-lszero-l-zerolimit.md](../../v2/bugs/FINDING-ims-start-aims-lszero-l-zerolimit.md) — reviewed as `FINDING-02060-ims-start-aims-lszero-l.md`, which a later run renamed |
| Original SHA-256 | 0836e9c0c461d7fdd2f81c342f5a729b18d1d3ce30d74dfebce0602dce8c56cd |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `aims.Lszero`; effective min: `None`; effective max: `None`. 
