# FINDING-02067: Air-gap inductance is used as a flux multiplier
...
| Target | aims.airGap.L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-ims-start-aims-airgap-l-zerolimit.md](../../v2/bugs/FINDING-ims-start-aims-airgap-l-zerolimit.md) — reviewed as `FINDING-02067-ims-start-aims-airgap-l.md`, which a later run renamed |
| Original SHA-256 | dd46ac1f9edbc9aa6a80c61783f1dc14a1cd41f0c1aceabd7d59a30347f4d213 |
...
Compiler/source-resolved declaration: `Electrical/Machines/BasicMachines/Components/AirGapS.mo:8`. Role: `parameter`; binding: `{{aims.airGap.Lm, 0}, {0, aims.airGap.Lm}}`; effective min: `None`; effective max: `None`. 
