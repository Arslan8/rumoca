# FINDING-01535: Zero core-loss conductance deliberately disables losses
...
| Target | imc.statorCore.coreParameters.GcRef |
| Student classification | physical-invariant-violated |
| Original report | [FINDING-imc-dcbraking-imc-statorcore-coreparameters-gcref-zerolimit.md](../../v2/bugs/FINDING-imc-dcbraking-imc-statorcore-coreparameters-gcref-zerolimit.md) — reviewed as `FINDING-01535-imc-dcbraking-imc-statorcore-coreparameters-gcref.md`, which a later run renamed |
| Original SHA-256 | 71e78d9c2704df5111a06b5f14f05bb9037e68e6984c0505ec9450c4daab9843 |
...
Compiler/source-resolved declaration: `Electrical/Machines/Losses/CoreParameters.mo:18`. Role: `parameter`; binding: `imc.statorCoreParameters.GcRef`; effective min: `None`; effective max: `None`. 
