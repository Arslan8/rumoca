# FINDING-02709: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | idealCloser.Goff |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-imc-transformer-idealcloser-goff-ruleoff-2.md](../../v2/bugs/FINDING-imc-transformer-idealcloser-goff-ruleoff-2.md) — reviewed as `FINDING-02709-imc-transformer-idealcloser-goff.md`, which a later run renamed |
| Original SHA-256 | 214e48bb2dc7e05b23d9cfd56f8b80d8b6cf69ccdcf910798abb24770bfe3f95 |
...
Compiler/source-resolved declaration: `Electrical/Polyphase/Ideal/IdealClosingSwitch.mo:6`. Role: `parameter`; binding: `fill(1e-05, m)`; effective min: `zeros(3)`; effective max: `None`. 
