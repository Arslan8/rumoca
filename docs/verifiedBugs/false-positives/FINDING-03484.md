# FINDING-03484: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | rectifier.thyristor.idealThyristor[3].Ron |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-thyristorcentertapmpulse-rlv-characteristic-rectifier-thyristor-idealt-5.md](../../v2/bugs/FINDING-thyristorcentertapmpulse-rlv-characteristic-rectifier-thyristor-idealt-5.md) — reviewed as `FINDING-03484-thyristorcentertapmpulse-rlv-characteristic-rectifier-thyristor-idealt.md`, which a later run renamed |
| Original SHA-256 | 5da9b7d6a8e8f2aa5e89c14ee3c1648a33271e7ca50cb6bbbedf7efaf09bf93a |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:4`. Role: `parameter`; binding: `rectifier.thyristor.Ron[3]`; effective min: `0`; effective max: `None`. 
