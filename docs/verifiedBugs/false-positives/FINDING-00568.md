# FINDING-00568: Zero inductance is an explicitly supported algebraic limit
...
| Target | oLine50.L[42].L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-smoothstep-oline50-l-42-l-zerolimit.md](../../v2/bugs/FINDING-smoothstep-oline50-l-42-l-zerolimit.md) — reviewed as `FINDING-00568-smoothstep-oline50-l-42-l.md`, which a later run renamed |
| Original SHA-256 | dc33ed2217734cf46051e7363db7ba8595cf5c88274aca1d7d3cb1e4f5688fff |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `oLine50.lm[42]`; effective min: `None`; effective max: `None`. 
