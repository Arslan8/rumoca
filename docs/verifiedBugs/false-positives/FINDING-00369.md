# FINDING-00369: Zero inductance is an explicitly supported algebraic limit
...
| Original report | [FINDING-comparelinetrunks-oline1-l-4-l-zerolimit.md](../../v2/bugs/FINDING-comparelinetrunks-oline1-l-4-l-zerolimit.md) — reviewed as `FINDING-00369-comparelinetrunks-oline1-l-4-l.md`, which a later run renamed |
| Original SHA-256 | 326e33f60ce7eab78db2d6b4f4f9ddf19b52e244868c3ff6936620c2df2152db |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `oLine1.lm[4]`; effective min: `None`; effective max: `None`. 
