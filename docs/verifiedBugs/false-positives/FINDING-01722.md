# FINDING-01722: Zero inductance is an explicitly supported algebraic limit
...
| Original report | [FINDING-imc-inverterdrive-aimc-lszero-l-zerolimit.md](../../v2/bugs/FINDING-imc-inverterdrive-aimc-lszero-l-zerolimit.md) — reviewed as `FINDING-01722-imc-inverterdrive-aimc-lszero-l.md`, which a later run renamed |
| Original SHA-256 | 45ba34693d22412eb40e7fd88480af35d2e8eca1c4c139fd00cc9e24675418a5 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `aimc.Lszero`; effective min: `None`; effective max: `None`. 
