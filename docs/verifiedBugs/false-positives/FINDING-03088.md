# FINDING-03088: Polyphase inductance delegates to zero-capable scalar inductors
...
| Original report | [FINDING-thyristorbridge2mpulse-dc-drive-lmains-l-zerolimit.md](../../v2/bugs/FINDING-thyristorbridge2mpulse-dc-drive-lmains-l-zerolimit.md) — reviewed as `FINDING-03088-thyristorbridge2mpulse-dc-drive-lmains-l.md`, which a later run renamed |
| Original SHA-256 | 6e4bd444726ac92e5a14aa3184b0d521228547c7c45c7784ee35f2c16c95638a |
...
Compiler/source-resolved declaration: `Electrical/Polyphase/Basic/Inductor.mo:4`. Role: `parameter`; binding: `fill(LMains, m)`; effective min: `None`; effective max: `None`. 
