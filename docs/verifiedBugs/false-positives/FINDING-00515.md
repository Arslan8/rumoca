# FINDING-00515: Zero inductance is an explicitly supported algebraic limit
...
| Original report | [FINDING-smoothstep-oline5-l-2-l-zerolimit.md](../../v2/bugs/FINDING-smoothstep-oline5-l-2-l-zerolimit.md) — reviewed as `FINDING-00515-smoothstep-oline5-l-2-l.md`, which a later run renamed |
| Original SHA-256 | 78981fc16613a9469a93ab836dcd0a9ecca7ba0dfe269cf57d1fe06854c3231d |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `oLine5.lm[2]`; effective min: `None`; effective max: `None`. 
