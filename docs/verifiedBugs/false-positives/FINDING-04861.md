# FINDING-04861: Zero inductance is an explicitly supported algebraic limit
...
| Target | smpm.lszero.L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-smpm-voltagesourcewithlosses-smpm-lszero-l-zerolimit.md](../../v2/bugs/FINDING-smpm-voltagesourcewithlosses-smpm-lszero-l-zerolimit.md) — reviewed as `FINDING-04861-smpm-voltagesourcewithlosses-smpm-lszero-l.md`, which a later run renamed |
| Original SHA-256 | b97ea28b5983369b3c17a558859943ba58205be3ba87fe37e2aef781785a07c8 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `smpm.Lszero`; effective min: `None`; effective max: `None`. 
