# FINDING-04390: Zero rotational stiffness/damping disables one torque term
...
| Original report | [FINDING-elasticbearing-springdamper-c-zerolimit.md](../../v2/bugs/FINDING-elasticbearing-springdamper-c-zerolimit.md) — reviewed as `FINDING-04390-elasticbearing-springdamper-c.md`, which a later run renamed |
| Original SHA-256 | 3fb51fd2da8d5041adc00cc0c7bd05df6a475b3657901f5b10393a6fc232f61b |
...
Compiler/source-resolved declaration: `Mechanics/Rotational/Components/SpringDamper.mo:3`. Role: `parameter`; binding: `100000.0`; effective min: `0`; effective max: `None`. 
