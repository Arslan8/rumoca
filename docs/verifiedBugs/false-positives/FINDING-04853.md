# FINDING-04853: A zero-duration ramp is a supported step

| Field | Value |
|---|---|
| Verdict | false-positives |
| Scope / group | zero-duration-ramp |
| Model | ModelicaTest.Blocks.ZeroThresholds |
| Target | ramp.duration |
| Student classification | divisor-reachable-zero |
| Original report | [FINDING-zerothresholds-ramp-duration-divunreach.md](../../v2/bugs/FINDING-zerothresholds-ramp-duration-divunreach.md) — reviewed as `FINDING-04853-zerothresholds-ramp-duration.md`, which a later run renamed |
| Original SHA-256 | 69bc5cfab565ca70ed0aa19f8d357fec3a5b1f27f907ecb144b1107f20bd910b |
...
Compiler/source-resolved declaration: `Blocks/Sources.mo:247`. Role: `parameter`; binding: `0.2`; effective min: `0.0`; effective max: `None`. 
...
[Rumoca commands, return codes, integrity hashes, bounded output and metadata](../evidence/a94991ae69c4d554.json). Baseline: **tool-error**.
