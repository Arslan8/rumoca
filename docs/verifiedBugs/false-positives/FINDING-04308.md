# FINDING-04308: Tensor entries are not all strictly positive scalars
...
| Original report | `FINDING-04308-mechanicalstructure-b3-body-i.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | db90a3ad3b38b2fe53dc71a32f4963258a934696d403678bba18f02ce0577a60 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:114`. Role: `parameter`; binding: `cat1(cat2(b3.body.I_11, b3.body.I_21, b3.body.I_31), cat2(b3.body.I_21, b3.body.I_22, b3.body.I_32), cat2(b3.body.I_31, b3.body.I_32, b3.body.I_33))`; effective min: `None`; effective max: `None`. 
