# FINDING-01426: Zero armature resistance is an ideal algebraic limit
...
| Original report | [FINDING-dcpm-withlosses-dcpm1-ra-unbounded.md](../../v2/bugs/FINDING-dcpm-withlosses-dcpm1-ra-unbounded.md) — reviewed as `FINDING-01426-dcpm-withlosses-dcpm1-ra.md`, which a later run renamed |
| Original SHA-256 | 85e24c846cd789719179f77a7d8d2e933cbd904f803ff7d930395f837633dd21 |
...
Compiler/source-resolved declaration: `Electrical/Machines/Interfaces/PartialBasicDCMachine.mo:17`. Role: `parameter`; binding: `dcpmData1.Ra`; effective min: `None`; effective max: `None`. 
