# FINDING-00178: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | With_Ron_Goff.Ron |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-characteristicidealdiodes-with-ron-goff-ron-ruleoff.md](../../v2/bugs/FINDING-characteristicidealdiodes-with-ron-goff-ron-ruleoff.md) — reviewed as `FINDING-00178-characteristicidealdiodes-with-ron-goff-ron.md`, which a later run renamed |
| Original SHA-256 | ec27dfccd4eddf77c34ff55eee950cbf72de24e6482aa16b4ca747e9a56af497 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:4`. Role: `parameter`; binding: `0.1`; effective min: `0`; effective max: `None`. 
