# FINDING-04065: MultiBody Newton/Euler equations use mass and inertia multiplicatively
...
| Target | referenceSystem.pointMass1.m |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-pointgravitywithpointmasses2-referencesystem-pointmass1-m-zerolimit.md](../../v2/bugs/FINDING-pointgravitywithpointmasses2-referencesystem-pointmass1-m-zerolimit.md) — reviewed as `FINDING-04065-pointgravitywithpointmasses2-referencesystem-pointmass1-m.md`, which a later run renamed |
| Original SHA-256 | 4fef47fc7f082c691aadc504c657acdc61360873eff2193adb777228868b1f55 |
