# FINDING-04180: Tensor entries are not all strictly positive scalars
...
| Target | body1.body.I_21 |
| Student classification | physical-domain-unenforced |
| Original report | `FINDING-04180-planarfourbar-body1-body-i-21.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | d6c19c80cebfe536097479b5478b707056bd5cc5a12ed021111d8b8197d1d3a5 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:23`. Role: `parameter`; binding: `body1.I[2, 1]`; effective min: `-1.7976931348623157e+308`; effective max: `None`. 
