# FINDING-03562: Zero capacitance is an explicitly supported algebraic limit
...
| Target | capacitorLV.C |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-chopperbuckboost-dutycycle-capacitorlv-c-zerolimit.md](../../v2/bugs/FINDING-chopperbuckboost-dutycycle-capacitorlv-c-zerolimit.md) — reviewed as `FINDING-03562-chopperbuckboost-dutycycle-capacitorlv-c.md`, which a later run renamed |
| Original SHA-256 | 9c31dea25c452c1bb0156f91bb2786c8675d57f251985f8562af50a1c43ee5c9 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Capacitor.mo:4`. Role: `parameter`; binding: `CLV`; effective min: `0`; effective max: `None`. 
