# FINDING-04331: MultiBody Newton/Euler equations use mass and inertia multiplicatively
...
| Original report | [FINDING-mechanicalstructure-b5-body-m-zerolimit.md](../../v2/bugs/FINDING-mechanicalstructure-b5-body-m-zerolimit.md) — reviewed as `FINDING-04331-mechanicalstructure-b5-body-m.md`, which a later run renamed |
| Original SHA-256 | 247524ec50fa5484abb6a592f04df718a87d5f1d4eaf01012fe93ccecf1ee568 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:16`. Role: `parameter`; binding: `5.2`; effective min: `0`; effective max: `None`. 
