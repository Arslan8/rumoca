# FINDING-00032: Zero capacitance is an explicitly supported algebraic limit
...
| Original report | [FINDING-cauerlowpassanalog-c1-c-zerolimit.md](../../v2/bugs/FINDING-cauerlowpassanalog-c1-c-zerolimit.md) — reviewed as `FINDING-00032-cauerlowpassanalog-c1-c.md`, which a later run renamed |
| Original SHA-256 | a9922deffd1eb86e087c8269af9e12020a5f83d5c2c6d6458d5d8e11e06cf0fe |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Capacitor.mo:4`. Role: `parameter`; binding: `c1`; effective min: `0`; effective max: `None`. 
