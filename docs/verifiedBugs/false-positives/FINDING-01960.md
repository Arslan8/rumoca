# FINDING-01960: Arc-switch resistance/conductance are multiplicative ideal limits
...
| Original report | [FINDING-imc-ydarc-switchydwitharc-idealopener-openerwitharc-2-goff-zerolimit.md](../../v2/bugs/FINDING-imc-ydarc-switchydwitharc-idealopener-openerwitharc-2-goff-zerolimit.md) — reviewed as `FINDING-01960-imc-ydarc-switchydwitharc-idealopener-openerwitharc-2-goff.md`, which a later run renamed |
| Original SHA-256 | 6a90f90ed29e232b89a1328034b5dce31ab5c7831dce8d4abd776a8df8552fd6 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSwitchWithArc.mo:5`. Role: `parameter`; binding: `switchYDwithArc.idealOpener.Goff[2]`; effective min: `None`; effective max: `None`. 
