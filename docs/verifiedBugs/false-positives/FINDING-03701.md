# FINDING-03701: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | hbridge.inverter_n.transistor_p.Goff |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-hbridge-trianglepwm-rl-hbridge-inverter-n-transistor-p-goff-zerolimit.md](../../v2/bugs/FINDING-hbridge-trianglepwm-rl-hbridge-inverter-n-transistor-p-goff-zerolimit.md) — reviewed as `FINDING-03701-hbridge-trianglepwm-rl-hbridge-inverter-n-transistor-p-goff.md`, which a later run renamed |
| Original SHA-256 | fec2aafb54618768594a75d59c1f9b1413aec0eafaea4fc5c2036bab3df78245 |
