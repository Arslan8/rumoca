# FINDING-02708: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | idealCloser.Ron |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-imc-transformer-idealcloser-ron-ruleoff-2.md](../../v2/bugs/FINDING-imc-transformer-idealcloser-ron-ruleoff-2.md) — reviewed as `FINDING-02708-imc-transformer-idealcloser-ron.md`, which a later run renamed |
| Original SHA-256 | 0dd7545d1802f56077ee1ae9b8593151384d358e1d99dfe170464a816121650f |
...
Compiler/source-resolved declaration: `Electrical/Polyphase/Ideal/IdealClosingSwitch.mo:4`. Role: `parameter`; binding: `fill(1e-05, m)`; effective min: `zeros(3)`; effective max: `None`. 
