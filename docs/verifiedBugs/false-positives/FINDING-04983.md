# FINDING-04983: Zeroing this operand does not zero the complete denominator
...
| Target | genericFluxTube2.material.n |
| Student classification | divisor-reachable-zero |
| Original report | `FINDING-04983-sources-genericfluxtube2-material-n.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 6f3361c11102254e6578b600b52554a59d2086c117e055351efa3e3cf8001fc9 |
...
| Probe | Outcome |
|---|---|
| `genericFluxTube2.material.n=0` | clean |
