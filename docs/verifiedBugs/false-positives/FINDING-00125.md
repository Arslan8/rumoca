# FINDING-00125: Zero capacitance is an explicitly supported algebraic limit
...
| Target | Rp1.Capacitor.C |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-cauerlowpasssc-rp1-capacitor-c-zerolimit.md](../../v2/bugs/FINDING-cauerlowpasssc-rp1-capacitor-c-zerolimit.md) — reviewed as `FINDING-00125-cauerlowpasssc-rp1-capacitor-c.md`, which a later run renamed |
| Original SHA-256 | d8d050925288b2a71345a92642445b9a9c832d13cbb5fd59c6c2f7a5c070ef3c |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Capacitor.mo:4`. Role: `parameter`; binding: `(Rp1.clock / max((2.220446049250313e-16 * Rp1.oneOhm), abs(Rp1.R)))`; effective min: `0`; effective max: `None`. 
