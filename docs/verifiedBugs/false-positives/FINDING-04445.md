# FINDING-04445: Zero mass is a massless algebraic component, not an intrinsic division
...
| Target | inverseMass.mass.m |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-generationoffmus-inversemass-mass-m-zerolimit.md](../../v2/bugs/FINDING-generationoffmus-inversemass-mass-m-zerolimit.md) — reviewed as `FINDING-04445-generationoffmus-inversemass-mass-m.md`, which a later run renamed |
| Original SHA-256 | 1c1e38a7a0283ff0b77da44699d19102fef4f2edc49065954ffcc147c15fa88b |
...
Compiler/source-resolved declaration: `Mechanics/Translational/Components/Mass.mo:3`. Role: `parameter`; binding: `2.2`; effective min: `0`; effective max: `None`. 
