# FINDING-00989: Zero capacitance is an explicitly supported algebraic limit
...
| Original report | [FINDING-seriesresonance-capacitor2-c-zerolimit.md](../../v2/bugs/FINDING-seriesresonance-capacitor2-c-zerolimit.md) — reviewed as `FINDING-00989-seriesresonance-capacitor2-c.md`, which a later run renamed |
| Original SHA-256 | 5fd6b7d987441154fa05e667a51a33e5ac83114f617df14c6b5510053921c9e0 |
...
[Rumoca commands, return codes, integrity hashes, bounded output and metadata](../evidence/94817525f7fcfd91.json). Baseline: **clean**.

| Probe | Outcome |
|---|---|
| `capacitor2.C=0` | reported-failure |

Diagnostic: solve-IR evaluation failed: non-finite derivative evaluation for state 'sineVoltage.n.i'
