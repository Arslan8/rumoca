# FINDING-04189: MultiBody Newton/Euler equations use mass and inertia multiplicatively
...
| Original report | [FINDING-planarfourbar-body2-body-m-zerolimit.md](../../v2/bugs/FINDING-planarfourbar-body2-body-m-zerolimit.md) — reviewed as `FINDING-04189-planarfourbar-body2-body-m.md`, which a later run renamed |
| Original SHA-256 | c1a3f261dffa5e234b777e5a7d94a50ee06026e63f83a5736375bf81381f3cde |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:16`. Role: `parameter`; binding: `body2.m`; effective min: `0`; effective max: `None`. 
