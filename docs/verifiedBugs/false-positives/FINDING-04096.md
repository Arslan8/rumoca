# FINDING-04096: Tensor entries are not all strictly positive scalars
...
| Target | referenceSystem.pointMass4.I |
| Student classification | physical-domain-unenforced |
| Original report | `FINDING-04096-pointgravitywithpointmasses2-referencesystem-pointmass4-i.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | c26683b39b16ebd2bd09b4e7544263b86de60eaedfffde8f1babb08aba9d089b |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:114`. Role: `parameter`; binding: `cat1(cat2(referenceSystem.pointMass4.I_11, referenceSystem.pointMass4.I_21, referenceSystem.pointMass4.I_31), cat2(referenceSystem.pointMass4.I_21, referenceSystem.pointMass4.I_22, referenceSystem.pointMass4.I_32), cat2(referenceSystem.pointMass4.I_31, referenceSystem.pointMass4.I_32, referenceSystem.pointMass4.I_33))`; effective min: `None`; effective max: `None`. 
