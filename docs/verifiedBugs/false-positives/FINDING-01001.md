# FINDING-01001: A zero-duration ramp is a supported step
...
| Original report | [FINDING-showvariableresistor-ramp1-duration-divunreach.md](../../v2/bugs/FINDING-showvariableresistor-ramp1-duration-divunreach.md) — reviewed as `FINDING-01001-showvariableresistor-ramp1-duration.md`, which a later run renamed |
| Original SHA-256 | 2a32850d5539eecf7a4188f5e8450c065fab510494bfc40a09d860a757c36655 |
...
[Rumoca commands, return codes, integrity hashes, bounded output and metadata](../evidence/f9ffa7cb1021f97a.json). Baseline: **tool-error**.
