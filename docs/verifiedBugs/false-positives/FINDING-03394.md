# FINDING-03394: Zero on-resistance/off-conductance is an intended ideal limit
...
| Original report | [FINDING-thyristorcentertap2mpulse-r-rectifier-thyristor-p-goff-ruleoff.md](../../v2/bugs/FINDING-thyristorcentertap2mpulse-r-rectifier-thyristor-p-goff-ruleoff.md) — reviewed as `FINDING-03394-thyristorcentertap2mpulse-r-rectifier-thyristor-p-goff.md`, which a later run renamed |
| Original SHA-256 | f767b368180b3fee0736d810fcf74edb2ffa047f2227fd2682e7c63ea29e5552 |
...
Compiler/source-resolved declaration: `Electrical/Polyphase/Ideal/IdealThyristor.mo:6`. Role: `parameter`; binding: `fill(rectifier.GoffThyristor, rectifier.m)`; effective min: `zeros(3)`; effective max: `None`. 
