# FINDING-02940: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | idealDiode1.idealDiode[2].Goff |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-rectifier-idealdiode1-idealdiode-2-goff-zerolimit.md](../../v2/bugs/FINDING-rectifier-idealdiode1-idealdiode-2-goff-zerolimit.md) — reviewed as `FINDING-02940-rectifier-idealdiode1-idealdiode-2-goff.md`, which a later run renamed |
| Original SHA-256 | c0605410b482f7c754d3f7d65812c86581a05276958a524885f27fd96063c331 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:6`. Role: `parameter`; binding: `idealDiode1.Goff[2]`; effective min: `0`; effective max: `None`. 
