# FINDING-02064: Zero inertia is a massless algebraic component, not an intrinsic division
...
| Target | aims.inertiaRotor.J |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-ims-start-aims-inertiarotor-j-zerolimit.md](../../v2/bugs/FINDING-ims-start-aims-inertiarotor-j-zerolimit.md) — reviewed as `FINDING-02064-ims-start-aims-inertiarotor-j.md`, which a later run renamed |
| Original SHA-256 | 88c43bf5545f538555418aa6dc20a190503c8cdb2ebbd510eceef9215e224cab |
...
Compiler/source-resolved declaration: `Mechanics/Rotational/Components/Inertia.mo:4`. Role: `parameter`; binding: `aims.Jr`; effective min: `0`; effective max: `None`. 
