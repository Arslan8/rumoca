# FINDING-00548: Zero inductance is an explicitly supported algebraic limit
...
| Target | oLine50.L[22].L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-smoothstep-oline50-l-22-l-zerolimit.md](../../v2/bugs/FINDING-smoothstep-oline50-l-22-l-zerolimit.md) — reviewed as `FINDING-00548-smoothstep-oline50-l-22-l.md`, which a later run renamed |
| Original SHA-256 | 9c9c139e95f897389b3ab0fe4007c7eafd80b80359063fefc5e3400d7ef8007c |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `oLine50.lm[22]`; effective min: `None`; effective max: `None`. 
