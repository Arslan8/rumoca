# FINDING-03408: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | rectifier.thyristor_n.idealThyristor[3].Goff |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-thyristorcentertap2mpulse-r-rectifier-thyristor-n-idealthyristor-3-gof.md](../../v2/bugs/FINDING-thyristorcentertap2mpulse-r-rectifier-thyristor-n-idealthyristor-3-gof.md) — reviewed as `FINDING-03408-thyristorcentertap2mpulse-r-rectifier-thyristor-n-idealthyristor-3-gof.md`, which a later run renamed |
| Original SHA-256 | 993edf75f88bda1d2a136d4f7ea37ed80dbb08efa6d471cdce9f0bf0ffd86034 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:6`. Role: `parameter`; binding: `rectifier.thyristor_n.Goff[3]`; effective min: `0`; effective max: `None`. 
