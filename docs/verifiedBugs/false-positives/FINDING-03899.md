# FINDING-03899: MultiBody Newton/Euler equations use mass and inertia multiplicatively
...
| Target | boxBody1.body.I_11 |
| Student classification | physical-bound-permits-zero |
| Original report | `FINDING-03899-doublependuluminittip-boxbody1-body-i-11.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 79e3a26fbf72445454e23fae4f7245b6b1874672f9d6313fcb1ca5a5ef794810 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:17`. Role: `parameter`; binding: `boxBody1.I[1, 1]`; effective min: `0`; effective max: `None`. 
