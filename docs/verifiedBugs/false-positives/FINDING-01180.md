# FINDING-01180: Zero inertia is a massless algebraic component, not an intrinsic division
...
| Target | dcse.inertiaStator.J |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-dc-comparecharacteristics-dcse-inertiastator-j-zerolimit.md](../../v2/bugs/FINDING-dc-comparecharacteristics-dcse-inertiastator-j-zerolimit.md) — reviewed as `FINDING-01180-dc-comparecharacteristics-dcse-inertiastator-j.md`, which a later run renamed |
| Original SHA-256 | 611e89a7cf3783f3ddd55ef66019e60f357ce2ad4b13a2d069c7a2e1fe06f6ec |
...
Compiler/source-resolved declaration: `Mechanics/Rotational/Components/Inertia.mo:4`. Role: `parameter`; binding: `dcse.Js`; effective min: `0`; effective max: `None`. 
