# FINDING-00572: Zero inductance is an explicitly supported algebraic limit
...
| Target | oLine50.L[46].L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-smoothstep-oline50-l-46-l-zerolimit.md](../../v2/bugs/FINDING-smoothstep-oline50-l-46-l-zerolimit.md) — reviewed as `FINDING-00572-smoothstep-oline50-l-46-l.md`, which a later run renamed |
| Original SHA-256 | 10a54c6a388ab75b0aae47a24b6292997575adcbb37f9078c21534de59e56f71 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `oLine50.lm[46]`; effective min: `None`; effective max: `None`. 
