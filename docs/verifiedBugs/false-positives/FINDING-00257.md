# FINDING-00257: Zero inductance is an explicitly supported algebraic limit
...
| Target | inverseInductor3.inductor.L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-generationoffmus-inverseinductor3-inductor-l-zerolimit.md](../../v2/bugs/FINDING-generationoffmus-inverseinductor3-inductor-l-zerolimit.md) — reviewed as `FINDING-00257-generationoffmus-inverseinductor3-inductor-l.md`, which a later run renamed |
| Original SHA-256 | 94d408e6ceb192207f83c9e54efc1ae07ed8fa0b7bcf5508d6c40cd71af47367 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `0.002`; effective min: `None`; effective max: `None`. 
