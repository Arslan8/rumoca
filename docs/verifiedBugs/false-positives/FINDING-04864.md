# FINDING-04864: Machine inertia delegates to the zero-capable algebraic inertia component
...
| Original report | [FINDING-smpm-voltagesourcewithlosses-smpm-jr-zerolimit.md](../../v2/bugs/FINDING-smpm-voltagesourcewithlosses-smpm-jr-zerolimit.md) — reviewed as `FINDING-04864-smpm-voltagesourcewithlosses-smpm-jr.md`, which a later run renamed |
| Original SHA-256 | 68555b08b9bb566c55c45baab8f475fdcb562a4e2a105502cc110fdbf36b7d5c |
...
Compiler/source-resolved declaration: `Electrical/Machines/Interfaces/PartialBasicMachine.mo:5`. Role: `parameter`; binding: `smpmData.Jr`; effective min: `None`; effective max: `None`. 
