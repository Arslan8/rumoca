# FINDING-01689: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | inverter.transistor_p.idealGTOThyristor[2].Ron |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-imc-inverterdrive-inverter-transistor-p-idealgtothyristor-2-ron-ruleof.md](../../v2/bugs/FINDING-imc-inverterdrive-inverter-transistor-p-idealgtothyristor-2-ron-ruleof.md) — reviewed as `FINDING-01689-imc-inverterdrive-inverter-transistor-p-idealgtothyristor-2-ron.md`, which a later run renamed |
| Original SHA-256 | 8a88473a66296a6576f28b473d032f2a6cc01f35fc2990b05edf7d696c47a9f7 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:4`. Role: `parameter`; binding: `inverter.transistor_p.Ron[2]`; effective min: `0`; effective max: `None`. 
