# FINDING-00235: A zero-duration ramp is a supported step
...
| Target | V2.signalSource.duration |
| Student classification | divisor-reachable-zero |
| Original report | [FINDING-differenceamplifier-v2-signalsource-duration-divunreach.md](../../v2/bugs/FINDING-differenceamplifier-v2-signalsource-duration-divunreach.md) — reviewed as `FINDING-00235-differenceamplifier-v2-signalsource-duration.md`, which a later run renamed |
| Original SHA-256 | 43da1ecd57f1067acf095171467100e8dd553491ec97b44b6020c493e590a461 |
