# FINDING-04362: MultiBody Newton/Euler equations use mass and inertia multiplicatively
...
| Target | load.body.I_11 |
| Student classification | physical-bound-permits-zero |
| Original report | `FINDING-04362-mechanicalstructure-load-body-i-11.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 182cccecf7f6f53db1826821e24487aa291e63fe2a99274301495e5bb54ad2a5 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:17`. Role: `parameter`; binding: `load.I_11`; effective min: `0`; effective max: `None`. 
