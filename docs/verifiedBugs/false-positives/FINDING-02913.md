# FINDING-02913: Zero inductance is an explicitly supported algebraic limit
...
| Target | transformer.l1sigma.inductor[3].L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-transformertestbench-transformer-l1sigma-inductor-3-l-zerolimit.md](../../v2/bugs/FINDING-transformertestbench-transformer-l1sigma-inductor-3-l-zerolimit.md) — reviewed as `FINDING-02913-transformertestbench-transformer-l1sigma-inductor-3-l.md`, which a later run renamed |
| Original SHA-256 | 490cf2b108eb09fb0ff2b86e0bf6c9e04e043a3549d2d1bdc5f081ebee541df6 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `transformer.l1sigma.L[3]`; effective min: `None`; effective max: `None`. 
