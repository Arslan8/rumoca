# FINDING-03812: Zero mass is a massless algebraic component, not an intrinsic division
...
| Original report | [FINDING-permeanceactuator-armature-mass-m-zerolimit.md](../../v2/bugs/FINDING-permeanceactuator-armature-mass-m-zerolimit.md) — reviewed as `FINDING-03812-permeanceactuator-armature-mass-m.md`, which a later run renamed |
| Original SHA-256 | b9e901bef6ab7ac0373b5e31c48008430de347a6c5ad53ebec5b212aeebada60 |
...
Compiler/source-resolved declaration: `Mechanics/Translational/Components/Mass.mo:3`. Role: `parameter`; binding: `m_a`; effective min: `0`; effective max: `None`. 
