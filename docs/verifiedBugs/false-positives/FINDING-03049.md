# FINDING-03049: Zero core-loss conductance deliberately disables losses
...
| Target | dcpm.core.coreParameters.GcRef |
| Student classification | physical-invariant-violated |
| Original report | [FINDING-thyristorbridge2mpulse-dc-drive-dcpm-core-coreparameters-gcref-zerolim.md](../../v2/bugs/FINDING-thyristorbridge2mpulse-dc-drive-dcpm-core-coreparameters-gcref-zerolim.md) — reviewed as `FINDING-03049-thyristorbridge2mpulse-dc-drive-dcpm-core-coreparameters-gcref.md`, which a later run renamed |
| Original SHA-256 | 07bdb84bfd60218742a02d42ff5b1297c5721825b9c198228c732bf658995ccf |
...
Compiler/source-resolved declaration: `Electrical/Machines/Losses/CoreParameters.mo:18`. Role: `parameter`; binding: `dcpmData.coreParameters.GcRef`; effective min: `None`; effective max: `None`. 
