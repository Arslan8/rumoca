# FINDING-02076: Zero on-resistance/off-conductance is an intended ideal limit
...
| Original report | [FINDING-ims-start-idealcloser-goff-ruleoff.md](../../v2/bugs/FINDING-ims-start-idealcloser-goff-ruleoff.md) — reviewed as `FINDING-02076-ims-start-idealcloser-goff.md`, which a later run renamed |
| Original SHA-256 | 51a9bda1f92dcd114c5878fb5a0792fce612eb578436a99a969387ec52cfa2a1 |
