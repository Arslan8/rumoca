# FINDING-00113: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | R2.IdealCommutingSwitch1.Goff |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-cauerlowpasssc-r2-idealcommutingswitch1-goff-ruleoff.md](../../v2/bugs/FINDING-cauerlowpasssc-r2-idealcommutingswitch1-goff-ruleoff.md) — reviewed as `FINDING-00113-cauerlowpasssc-r2-idealcommutingswitch1-goff.md`, which a later run renamed |
| Original SHA-256 | 231a1fa55056d24151db0e0d52537cd58cbddb062069a3c11aa1306f6fcde731 |
