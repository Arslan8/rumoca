# FINDING-03078: Machine inertia delegates to the zero-capable algebraic inertia component
...
| Original report | [FINDING-thyristorbridge2mpulse-dc-drive-dcpm-js-zerolimit.md](../../v2/bugs/FINDING-thyristorbridge2mpulse-dc-drive-dcpm-js-zerolimit.md) — reviewed as `FINDING-03078-thyristorbridge2mpulse-dc-drive-dcpm-js.md`, which a later run renamed |
| Original SHA-256 | 79806fcb9fc7467e965e80dc66680b79ddc69a97d140ac82cf7e06878ce7896b |
...
Compiler/source-resolved declaration: `Electrical/Machines/Interfaces/PartialBasicMachine.mo:8`. Role: `parameter`; binding: `dcpmData.Js`; effective min: `None`; effective max: `None`. 
