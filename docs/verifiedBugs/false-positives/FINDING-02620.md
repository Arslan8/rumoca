# FINDING-02620: Zero inductance is an explicitly supported algebraic limit
...
| Original report | [FINDING-smr-inverter-smr-lszero-l-zerolimit.md](../../v2/bugs/FINDING-smr-inverter-smr-lszero-l-zerolimit.md) — reviewed as `FINDING-02620-smr-inverter-smr-lszero-l.md`, which a later run renamed |
| Original SHA-256 | 36e92a31ebcb62cd7c28a62a6539b6ad9d02984477d93c5a32b1812523e4b0c6 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `smr.Lszero`; effective min: `None`; effective max: `None`. 
