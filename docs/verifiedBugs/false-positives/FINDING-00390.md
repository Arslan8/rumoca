# FINDING-00390: Zero inductance is an explicitly supported algebraic limit
...
| Original report | [FINDING-comparelinetrunks-oline2-l-8-l-zerolimit.md](../../v2/bugs/FINDING-comparelinetrunks-oline2-l-8-l-zerolimit.md) — reviewed as `FINDING-00390-comparelinetrunks-oline2-l-8-l.md`, which a later run renamed |
| Original SHA-256 | 89051cd46b6676672dd59db58cd5eba2e9387f8b6407ac3df7508087a4d1f791 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `oLine2.lm[8]`; effective min: `None`; effective max: `None`. 
