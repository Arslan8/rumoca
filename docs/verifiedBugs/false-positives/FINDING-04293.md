# FINDING-04293: Tensor entries are not all strictly positive scalars
...
| Original report | `FINDING-04293-mechanicalstructure-b2-body-i.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | f15db4dbcab63f68ceb40f32abfa758d21f4a89826dc44c55431bb572f18328a |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:114`. Role: `parameter`; binding: `cat1(cat2(b2.body.I_11, b2.body.I_21, b2.body.I_31), cat2(b2.body.I_21, b2.body.I_22, b2.body.I_32), cat2(b2.body.I_31, b2.body.I_32, b2.body.I_33))`; effective min: `None`; effective max: `None`. 
