# FINDING-00516: Zero inductance is an explicitly supported algebraic limit
...
| Original report | [FINDING-smoothstep-oline5-l-3-l-zerolimit.md](../../v2/bugs/FINDING-smoothstep-oline5-l-3-l-zerolimit.md) — reviewed as `FINDING-00516-smoothstep-oline5-l-3-l.md`, which a later run renamed |
| Original SHA-256 | f54d55258518d95ac5906656b6a707107cff372005dbac3af2c77c46f1df36f4 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `oLine5.lm[3]`; effective min: `None`; effective max: `None`. 
