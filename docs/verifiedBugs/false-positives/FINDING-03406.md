# FINDING-03406: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | rectifier.thyristor_n.idealThyristor[2].Goff |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-thyristorcentertap2mpulse-r-rectifier-thyristor-n-idealthyristor-2-gof.md](../../v2/bugs/FINDING-thyristorcentertap2mpulse-r-rectifier-thyristor-n-idealthyristor-2-gof.md) — reviewed as `FINDING-03406-thyristorcentertap2mpulse-r-rectifier-thyristor-n-idealthyristor-2-gof.md`, which a later run renamed |
| Original SHA-256 | fe4e38da10fecd5d98aad9d29cba64ce9a3876db131c7d8f6a64a6292974b3c0 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:6`. Role: `parameter`; binding: `rectifier.thyristor_n.Goff[2]`; effective min: `0`; effective max: `None`. 
