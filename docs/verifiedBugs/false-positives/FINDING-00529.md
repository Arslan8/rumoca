# FINDING-00529: Zero inductance is an explicitly supported algebraic limit
...
| Target | oLine50.L[3].L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-smoothstep-oline50-l-3-l-zerolimit.md](../../v2/bugs/FINDING-smoothstep-oline50-l-3-l-zerolimit.md) — reviewed as `FINDING-00529-smoothstep-oline50-l-3-l.md`, which a later run renamed |
| Original SHA-256 | 01856132e218c3c03de007e8c7e05fef96272f9dc64d83e9a8585d3b50d81c6d |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `oLine50.lm[3]`; effective min: `None`; effective max: `None`. 
