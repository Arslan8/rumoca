# FINDING-04472: Zero stiffness is a force-free spring limit
...
| Original report | [FINDING-preload-spring-c-zerolimit.md](../../v2/bugs/FINDING-preload-spring-c-zerolimit.md) — reviewed as `FINDING-04472-preload-spring-c.md`, which a later run renamed |
| Original SHA-256 | fe595bbe010a15e8c7712bc6ccbcb7dca13a972422033bc0149c3787b866122e |
...
Compiler/source-resolved declaration: `Mechanics/Translational/Components/Spring.mo:4`. Role: `parameter`; binding: `20000.0`; effective min: `0`; effective max: `None`. 
