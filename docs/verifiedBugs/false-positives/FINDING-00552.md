# FINDING-00552: Zero inductance is an explicitly supported algebraic limit
...
| Target | oLine50.L[26].L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-smoothstep-oline50-l-26-l-zerolimit.md](../../v2/bugs/FINDING-smoothstep-oline50-l-26-l-zerolimit.md) — reviewed as `FINDING-00552-smoothstep-oline50-l-26-l.md`, which a later run renamed |
| Original SHA-256 | efe7d16b6100770ddb938329c2be415d4c82b233c5f3648f8d254fe6d862cf65 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `oLine50.lm[26]`; effective min: `None`; effective max: `None`. 
