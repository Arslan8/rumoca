# FINDING-02818: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | diode4.idealDiode[3].Goff |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-rectifier12pulse-diode4-idealdiode-3-goff-zerolimit.md](../../v2/bugs/FINDING-rectifier12pulse-diode4-idealdiode-3-goff-zerolimit.md) — reviewed as `FINDING-02818-rectifier12pulse-diode4-idealdiode-3-goff.md`, which a later run renamed |
| Original SHA-256 | c5c480120c97736af12060e4208295f11d5acb1a5f9f858e4db7f595929b00cd |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:6`. Role: `parameter`; binding: `diode4.Goff[3]`; effective min: `0`; effective max: `None`. 
