# FINDING-00205: Zero inductance is an explicitly supported algebraic limit
...
| Original report | [FINDING-controlledswitchwitharc-inductor1-l-zerolimit.md](../../v2/bugs/FINDING-controlledswitchwitharc-inductor1-l-zerolimit.md) — reviewed as `FINDING-00205-controlledswitchwitharc-inductor1-l.md`, which a later run renamed |
| Original SHA-256 | 64990ede2c87991209df95602fc405fa9590c6c2a2286e97f9def6624da725c3 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `0.1`; effective min: `None`; effective max: `None`. 
