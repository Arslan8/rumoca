# FINDING-02936: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | idealDiode1.Goff |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-rectifier-idealdiode1-goff-ruleoff.md](../../v2/bugs/FINDING-rectifier-idealdiode1-goff-ruleoff.md) — reviewed as `FINDING-02936-rectifier-idealdiode1-goff.md`, which a later run renamed |
| Original SHA-256 | d29cfcb9d63c9d804f16fd7e7eb9d8294ecc1b96d5e3550a34f708b35f0d7bfc |
...
Compiler/source-resolved declaration: `Electrical/Polyphase/Ideal/IdealDiode.mo:6`. Role: `parameter`; binding: `fill(Goff, m)`; effective min: `zeros(3)`; effective max: `None`. 
