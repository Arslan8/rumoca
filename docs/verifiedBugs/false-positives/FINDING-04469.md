# FINDING-04469: Zero mass is a massless algebraic component, not an intrinsic division
...
| Original report | [FINDING-preload-spool-m-zerolimit.md](../../v2/bugs/FINDING-preload-spool-m-zerolimit.md) — reviewed as `FINDING-04469-preload-spool-m.md`, which a later run renamed |
| Original SHA-256 | 0414a3c3855c4f2bfc1883117f77227d694bfee8783a6bd0c348e6cc55ec1693 |
...
Compiler/source-resolved declaration: `Mechanics/Translational/Components/Mass.mo:3`. Role: `parameter`; binding: `0.15`; effective min: `0`; effective max: `None`. 
