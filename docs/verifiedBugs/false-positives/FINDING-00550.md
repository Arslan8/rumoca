# FINDING-00550: Zero inductance is an explicitly supported algebraic limit
...
| Target | oLine50.L[24].L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-smoothstep-oline50-l-24-l-zerolimit.md](../../v2/bugs/FINDING-smoothstep-oline50-l-24-l-zerolimit.md) — reviewed as `FINDING-00550-smoothstep-oline50-l-24-l.md`, which a later run renamed |
| Original SHA-256 | b3771647e646797c3cdfc411687b5b468c9ca13011106c4355fc1fd35272f664 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `oLine50.lm[24]`; effective min: `None`; effective max: `None`. 
