# FINDING-04339: MultiBody Newton/Euler equations use mass and inertia multiplicatively
...
| Original report | [FINDING-mechanicalstructure-b6-m-intent.md](../../v2/bugs/FINDING-mechanicalstructure-b6-m-intent.md) — reviewed as `FINDING-04339-mechanicalstructure-b6-m.md`, which a later run renamed |
| Original SHA-256 | 0acde9cea2ef4228b3cd846850f6317cbe5910912b1db8356d3bb0a0cdd2bc3d |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/BodyShape.mo:23`. Role: `parameter`; binding: `0.5`; effective min: `0`; effective max: `None`. 
