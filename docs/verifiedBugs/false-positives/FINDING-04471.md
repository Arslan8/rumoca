# FINDING-04471: Zero mass is a massless algebraic component, not an intrinsic division
...
| Target | springPlateB.m |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-preload-springplateb-m-zerolimit.md](../../v2/bugs/FINDING-preload-springplateb-m-zerolimit.md) — reviewed as `FINDING-04471-preload-springplateb-m.md`, which a later run renamed |
| Original SHA-256 | e22a6ee165e93f8c7955de0fa76163c07c37e9812bd8001bb2c866a794952a89 |
...
Compiler/source-resolved declaration: `Mechanics/Translational/Components/Mass.mo:3`. Role: `parameter`; binding: `0.01`; effective min: `0`; effective max: `None`. 
...
[Rumoca commands, return codes, integrity hashes, bounded output and metadata](../evidence/6b9c22950194f259.json). Baseline: **tool-error**.
