# FINDING-01206: AirGapDC uses excitation inductance only as a multiplier
...
| Original report | [FINDING-dcee-start-dcee-airgapdc-le-zerolimit.md](../../v2/bugs/FINDING-dcee-start-dcee-airgapdc-le-zerolimit.md) — reviewed as `FINDING-01206-dcee-start-dcee-airgapdc-le.md`, which a later run renamed |
| Original SHA-256 | 094644afa3475db13608fcf28de99a514c609a5343aef8dd5df4a7be6fac52ed |
