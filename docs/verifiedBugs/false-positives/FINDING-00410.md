# FINDING-00410: Zero capacitance is an explicitly supported algebraic limit
...
| Original report | [FINDING-comparelinetrunks-oline3-c-3-c-zerolimit.md](../../v2/bugs/FINDING-comparelinetrunks-oline3-c-3-c-zerolimit.md) — reviewed as `FINDING-00410-comparelinetrunks-oline3-c-3-c.md`, which a later run renamed |
| Original SHA-256 | b51f25af63daa4ab9b1f2d8b904f6912836399c40f88948f4d7e68ff0ade1f2b |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Capacitor.mo:4`. Role: `parameter`; binding: `((oLine3.c * oLine3.length) / oLine3.N)`; effective min: `0`; effective max: `None`. 
