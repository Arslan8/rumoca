# FINDING-04295: MultiBody Newton/Euler equations use mass and inertia multiplicatively
...
| Original report | `FINDING-04295-mechanicalstructure-b3-i-11.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | f03a01e91c4606db86a146905874bcdc50690eed5caed690329041528a055466 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/BodyShape.mo:24`. Role: `parameter`; binding: `0.279`; effective min: `0`; effective max: `None`. 
