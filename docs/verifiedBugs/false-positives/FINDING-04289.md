# FINDING-04289: MultiBody Newton/Euler equations use mass and inertia multiplicatively
...
| Original report | `FINDING-04289-mechanicalstructure-b2-body-i-33.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 5a98ccf1802a06902e4c1e16db259312ef7361109f32e20a5676ccbdecf7ea49 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:21`. Role: `parameter`; binding: `2.73`; effective min: `0`; effective max: `None`. 
