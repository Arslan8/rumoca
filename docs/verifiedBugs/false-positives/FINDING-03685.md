# FINDING-03685: Converter switch parameters delegate to ideal semiconductor limits
...
| Target | hbridge.inverter_p.GoffTransistor |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-hbridge-trianglepwm-rl-hbridge-inverter-p-gofftransistor-zerolimit.md](../../v2/bugs/FINDING-hbridge-trianglepwm-rl-hbridge-inverter-p-gofftransistor-zerolimit.md) — reviewed as `FINDING-03685-hbridge-trianglepwm-rl-hbridge-inverter-p-gofftransistor.md`, which a later run renamed |
| Original SHA-256 | d1414147b771d4dc3830d4a0d0438e03a0d07cd373e627056a9aebfa6d7c255b |
