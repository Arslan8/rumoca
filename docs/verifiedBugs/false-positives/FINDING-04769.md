# FINDING-04769: Zero thermal conductance is an insulating limit
...
| Original report | [FINDING-conduction-thermalconductor-g-zerolimit.md](../../v2/bugs/FINDING-conduction-thermalconductor-g-zerolimit.md) — reviewed as `FINDING-04769-conduction-thermalconductor-g.md`, which a later run renamed |
| Original SHA-256 | ef22f60734e21839d2164d5707699dcfd811831e039c94e8db3be4aa8a972407 |
...
Compiler/source-resolved declaration: `Thermal/HeatTransfer/Components/ThermalConductor.mo:5`. Role: `parameter`; binding: `G`; effective min: `None`; effective max: `None`. 
