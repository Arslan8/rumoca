# FINDING-02778: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | diode2.idealDiode[2].Goff |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-rectifier12pulse-diode2-idealdiode-2-goff-zerolimit.md](../../v2/bugs/FINDING-rectifier12pulse-diode2-idealdiode-2-goff-zerolimit.md) — reviewed as `FINDING-02778-rectifier12pulse-diode2-idealdiode-2-goff.md`, which a later run renamed |
| Original SHA-256 | f4a852f0dda62d304ed08068f8835a4851d69a37af94640949e973039c35e07b |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:6`. Role: `parameter`; binding: `diode2.Goff[2]`; effective min: `0`; effective max: `None`. 
