# FINDING-04753: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | idealSwitch.Goff |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-controlledtemperature-idealswitch-goff-ruleoff.md](../../v2/bugs/FINDING-controlledtemperature-idealswitch-goff-ruleoff.md) — reviewed as `FINDING-04753-controlledtemperature-idealswitch-goff.md`, which a later run renamed |
| Original SHA-256 | 9dea50e9c547139bac7e4e460890b0ce071b20781ffc0d122bc5d457ef9230cf |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSwitch.mo:6`. Role: `parameter`; binding: `1e-05`; effective min: `0`; effective max: `None`. 
...
5:     "Closed switch resistance";
6:   parameter SI.Conductance Goff(final min=0) = 1e-5
7:     "Opened switch conductance";
8:   extends Modelica.Electrical.Analog.Interfaces.ConditionalHeatPort(final T=293.15);
9: protected
```
...
[Rumoca commands, return codes, integrity hashes, bounded output and metadata](../evidence/8c862644ff3c5068.json). Baseline: **tool-error**.
