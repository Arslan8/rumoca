# FINDING-02946: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | idealDiode2.idealDiode[1].Goff |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-rectifier-idealdiode2-idealdiode-1-goff-zerolimit.md](../../v2/bugs/FINDING-rectifier-idealdiode2-idealdiode-1-goff-zerolimit.md) — reviewed as `FINDING-02946-rectifier-idealdiode2-idealdiode-1-goff.md`, which a later run renamed |
| Original SHA-256 | 37a8f7b6f21ecfc4358fe56fc6853c4ab6d2bc7b5cd63f57a5fdd29226fc202a |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:6`. Role: `parameter`; binding: `idealDiode2.Goff[1]`; effective min: `0`; effective max: `None`. 
