# FINDING-03581: Zero inductance is an explicitly supported algebraic limit
...
| Target | loadInductor.L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-chopperstepdown-rl-loadinductor-l-zerolimit.md](../../v2/bugs/FINDING-chopperstepdown-rl-loadinductor-l-zerolimit.md) — reviewed as `FINDING-03581-chopperstepdown-rl-loadinductor-l.md`, which a later run renamed |
| Original SHA-256 | 586a177465fe7c1b3e86f735fdacef630cf0fc984547e0fa25c1a01cf6425de5 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `LLoad`; effective min: `None`; effective max: `None`. 
