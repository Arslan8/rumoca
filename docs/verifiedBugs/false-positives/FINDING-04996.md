# FINDING-04996: A zero-duration ramp is a supported step
...
| Target | rampReluctance.duration |
| Student classification | divisor-reachable-zero |
| Original report | [FINDING-variablecomponents-rampreluctance-duration-divunreach.md](../../v2/bugs/FINDING-variablecomponents-rampreluctance-duration-divunreach.md) — reviewed as `FINDING-04996-variablecomponents-rampreluctance-duration.md`, which a later run renamed |
| Original SHA-256 | 1ed37e583a345f173e129eea3975f7e31ce4bd557b1098bd355ed8792315a20f |
...
Compiler/source-resolved declaration: `Blocks/Sources.mo:247`. Role: `parameter`; binding: `0.3`; effective min: `0.0`; effective max: `None`. 
...
[Rumoca commands, return codes, integrity hashes, bounded output and metadata](../evidence/768a4bac5224078f.json). Baseline: **clean**.

| Probe | Outcome |
|---|---|
| `rampReluctance.duration=0` | clean |
