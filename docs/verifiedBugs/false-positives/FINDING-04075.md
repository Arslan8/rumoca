# FINDING-04075: MultiBody Newton/Euler equations use mass and inertia multiplicatively
...
| Target | referenceSystem.pointMass2.I_22 |
| Student classification | physical-bound-permits-zero |
| Original report | `FINDING-04075-pointgravitywithpointmasses2-referencesystem-pointmass2-i-22.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 554911a7885d77282b544b8ab003c75c3d5c5e02b776f229ac34c4870a14b1e1 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:19`. Role: `parameter`; binding: `0`; effective min: `0`; effective max: `None`. 
