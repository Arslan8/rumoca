# FINDING-02498: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | switch3.idealClosingSwitch[2].Goff |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-smpm-resistivebraking-switch3-idealclosingswitch-2-goff-ruleoff.md](../../v2/bugs/FINDING-smpm-resistivebraking-switch3-idealclosingswitch-2-goff-ruleoff.md) — reviewed as `FINDING-02498-smpm-resistivebraking-switch3-idealclosingswitch-2-goff.md`, which a later run renamed |
| Original SHA-256 | e273cc98b55eefaa70fa66aec1399b61ded3da3db6f153756337e5cfc2cf2975 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSwitch.mo:6`. Role: `parameter`; binding: `switch3.Goff[2]`; effective min: `0`; effective max: `None`. 
