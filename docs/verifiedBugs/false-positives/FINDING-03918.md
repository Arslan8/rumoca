# FINDING-03918: Tensor entries are not all strictly positive scalars
...
| Original report | [FINDING-doublependuluminittip-boxbody2-body-i-tensorunknown.md](../../v2/bugs/FINDING-doublependuluminittip-boxbody2-body-i-tensorunknown.md) — reviewed as `FINDING-03918-doublependuluminittip-boxbody2-body-i.md`, which a later run renamed |
| Original SHA-256 | 972ba93fe9dd1f568366d9f65dee0faa79374ee019a01ea082566d969691a694 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:114`. Role: `parameter`; binding: `cat1(cat2(boxBody2.body.I_11, boxBody2.body.I_21, boxBody2.body.I_31), cat2(boxBody2.body.I_21, boxBody2.body.I_22, boxBody2.body.I_32), cat2(boxBody2.body.I_31, boxBody2.body.I_32, boxBody2.body.I_33))`; effective min: `None`; effective max: `None`. 
