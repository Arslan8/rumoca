# FINDING-02898: Polyphase resistance/conductance delegates to signed scalar elements
...
| Original report | `FINDING-02898-transformertestbench-load-r.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 4c85f9ef19034707b5eda4bcb59dd6184b94434669c58d48ce65c7f23b229e65 |
...
Compiler/source-resolved declaration: `Electrical/Polyphase/Basic/Resistor.mo:4`. Role: `parameter`; binding: `RL`; effective min: `None`; effective max: `None`. 
