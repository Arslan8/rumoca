# FINDING-01707: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | inverter.transistor_n.idealGTOThyristor[3].Ron |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-imc-inverterdrive-inverter-transistor-n-idealgtothyristor-3-ron-ruleof.md](../../v2/bugs/FINDING-imc-inverterdrive-inverter-transistor-n-idealgtothyristor-3-ron-ruleof.md) — reviewed as `FINDING-01707-imc-inverterdrive-inverter-transistor-n-idealgtothyristor-3-ron.md`, which a later run renamed |
| Original SHA-256 | 58fe790265e49a1136b0156333ab8ac8cd6400f28b5cd94b44b47a89db0d0b0e |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:4`. Role: `parameter`; binding: `inverter.transistor_n.Ron[3]`; effective min: `0`; effective max: `None`. 
