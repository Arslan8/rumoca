# FINDING-00405: Zero inductance is an explicitly supported algebraic limit
...
| Original report | [FINDING-comparelinetrunks-oline3-l-6-l-zerolimit.md](../../v2/bugs/FINDING-comparelinetrunks-oline3-l-6-l-zerolimit.md) — reviewed as `FINDING-00405-comparelinetrunks-oline3-l-6-l.md`, which a later run renamed |
| Original SHA-256 | dfe370663509887b849bd9f602db49f44ac9f2d40971e53fe6a76dd26291e36f |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `oLine3.lm[6]`; effective min: `None`; effective max: `None`. 
