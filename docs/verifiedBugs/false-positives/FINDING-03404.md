# FINDING-03404: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | rectifier.thyristor_n.idealThyristor[1].Goff |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-thyristorcentertap2mpulse-r-rectifier-thyristor-n-idealthyristor-1-gof.md](../../v2/bugs/FINDING-thyristorcentertap2mpulse-r-rectifier-thyristor-n-idealthyristor-1-gof.md) — reviewed as `FINDING-03404-thyristorcentertap2mpulse-r-rectifier-thyristor-n-idealthyristor-1-gof.md`, which a later run renamed |
| Original SHA-256 | 925dad8754705e096732703e73452a36be28e6a35520c3d3269476ad1fd064b9 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:6`. Role: `parameter`; binding: `rectifier.thyristor_n.Goff[1]`; effective min: `0`; effective max: `None`. 
