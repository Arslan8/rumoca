# FINDING-03887: Armature example delegates to zero-capable mechanical terms
...
| Original report | [FINDING-translatoryarmatureandstopper-d-zerolimit.md](../../v2/bugs/FINDING-translatoryarmatureandstopper-d-zerolimit.md) — reviewed as `FINDING-03887-translatoryarmatureandstopper-d.md`, which a later run renamed |
| Original SHA-256 | f368562fcf4be419ff479d041439851310844bfcaaa6ce4c409021c39a31c483 |
...
Compiler/source-resolved declaration: `Magnetic/FluxTubes/Examples/Utilities/TranslatoryArmatureAndStopper.mo:11`. Role: `parameter`; binding: `None`; effective min: `None`; effective max: `None`. 
