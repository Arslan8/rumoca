# FINDING-02049: Zero core-loss conductance deliberately disables losses
...
| Target | aims.rotorCoreParameters.GcRef |
| Student classification | physical-invariant-violated |
| Original report | [FINDING-ims-start-aims-rotorcoreparameters-gcref-zerolimit.md](../../v2/bugs/FINDING-ims-start-aims-rotorcoreparameters-gcref-zerolimit.md) — reviewed as `FINDING-02049-ims-start-aims-rotorcoreparameters-gcref.md`, which a later run renamed |
| Original SHA-256 | 183f5e485c14fc747afb1c5ff4e038fb8b45c46357b65a8cf9e8a4d64cc1ed63 |
...
Compiler/source-resolved declaration: `Electrical/Machines/Losses/CoreParameters.mo:18`. Role: `parameter`; binding: `aimsData.rotorCoreParameters.GcRef`; effective min: `None`; effective max: `None`. 
