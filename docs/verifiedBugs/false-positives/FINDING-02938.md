# FINDING-02938: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | idealDiode1.idealDiode[1].Goff |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-rectifier-idealdiode1-idealdiode-1-goff-zerolimit.md](../../v2/bugs/FINDING-rectifier-idealdiode1-idealdiode-1-goff-zerolimit.md) — reviewed as `FINDING-02938-rectifier-idealdiode1-idealdiode-1-goff.md`, which a later run renamed |
| Original SHA-256 | 18f2364537e8c7d79894d960f1e499065ffb6925929bdbe3147f035484e3fd19 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:6`. Role: `parameter`; binding: `idealDiode1.Goff[1]`; effective min: `0`; effective max: `None`. 
