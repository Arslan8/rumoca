# FINDING-04477: Zero mass is a massless algebraic component, not an intrinsic division
...
| Original report | [FINDING-signconvention-mass2-m-zerolimit.md](../../v2/bugs/FINDING-signconvention-mass2-m-zerolimit.md) — reviewed as `FINDING-04477-signconvention-mass2-m.md`, which a later run renamed |
| Original SHA-256 | 54a1918279cba0b1bee1415595f007bc76d83c6254298186e4e2154151dcc55a |
...
[Rumoca commands, return codes, integrity hashes, bounded output and metadata](../evidence/e2c565b83f9499b2.json). Baseline: **clean**.

| Probe | Outcome |
|---|---|
| `mass2.m=0` | reported-failure |

Diagnostic: solve-IR evaluation failed: algebraic projection did not converge at event boundary: worst scaled residual row=13 target=mass2.a value=-1.000000e0 ratio=1.000000e10 norm=1.000000e0 row_scale=1.000000e0 scaled_tolerance=1.000000e-10
