# FINDING-04098: MultiBody Newton/Euler equations use mass and inertia multiplicatively
...
| Target | referenceSystem.pointMass5.I_11 |
| Student classification | physical-bound-permits-zero |
| Original report | `FINDING-04098-pointgravitywithpointmasses2-referencesystem-pointmass5-i-11.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 6b538fa0b7b07c424d62728e12b18c36c8e94cdaee68733f776c7263be38ff09 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:17`. Role: `parameter`; binding: `0`; effective min: `0`; effective max: `None`. 
