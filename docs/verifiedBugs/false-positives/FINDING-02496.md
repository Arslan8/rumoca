# FINDING-02496: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | switch3.idealClosingSwitch[1].Goff |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-smpm-resistivebraking-switch3-idealclosingswitch-1-goff-ruleoff.md](../../v2/bugs/FINDING-smpm-resistivebraking-switch3-idealclosingswitch-1-goff-ruleoff.md) — reviewed as `FINDING-02496-smpm-resistivebraking-switch3-idealclosingswitch-1-goff.md`, which a later run renamed |
| Original SHA-256 | 00e10abc163e501a5e94a9aa19347c98394f5568549216152ac096592827856b |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSwitch.mo:6`. Role: `parameter`; binding: `switch3.Goff[1]`; effective min: `0`; effective max: `None`. 
