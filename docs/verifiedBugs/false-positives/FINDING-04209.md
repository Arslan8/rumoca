# FINDING-04209: Tensor entries are not all strictly positive scalars
...
| Original report | [FINDING-planarfourbar-body3-body-i-tensorunknown.md](../../v2/bugs/FINDING-planarfourbar-body3-body-i-tensorunknown.md) — reviewed as `FINDING-04209-planarfourbar-body3-body-i.md`, which a later run renamed |
| Original SHA-256 | 0d7e41d6b5c1ea390cdf4cdd684463dac8d7da93acee547ee373c7b85f374681 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:114`. Role: `parameter`; binding: `cat1(cat2(body3.body.I_11, body3.body.I_21, body3.body.I_31), cat2(body3.body.I_21, body3.body.I_22, body3.body.I_32), cat2(body3.body.I_31, body3.body.I_32, body3.body.I_33))`; effective min: `None`; effective max: `None`. 
