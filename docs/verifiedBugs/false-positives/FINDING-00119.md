# FINDING-00119: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | R3.IdealCommutingSwitch1.Ron |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-cauerlowpasssc-r3-idealcommutingswitch1-ron-ruleoff.md](../../v2/bugs/FINDING-cauerlowpasssc-r3-idealcommutingswitch1-ron-ruleoff.md) — reviewed as `FINDING-00119-cauerlowpasssc-r3-idealcommutingswitch1-ron.md`, which a later run renamed |
| Original SHA-256 | 626a0cfa39572d168bc5079728d1c43c282f88139443ce78a451b2fb075ec7ba |
