# FINDING-03524: Zero on-resistance/off-conductance is an intended ideal limit
...
| Original report | [FINDING-singlephasetwolevel-rl-inverter-diode-n-ron-ruleoff.md](../../v2/bugs/FINDING-singlephasetwolevel-rl-inverter-diode-n-ron-ruleoff.md) — reviewed as `FINDING-03524-singlephasetwolevel-rl-inverter-diode-n-ron.md`, which a later run renamed |
| Original SHA-256 | cdb3a9f8b92eb68499bcef16d7b9a197a3182fb228ba938c3e8b47c1ee84b245 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:4`. Role: `parameter`; binding: `inverter.RonDiode`; effective min: `0`; effective max: `None`. 
