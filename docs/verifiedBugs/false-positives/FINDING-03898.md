# FINDING-03898: MultiBody Newton/Euler equations use mass and inertia multiplicatively
...
| Original report | [FINDING-doublependuluminittip-boxbody1-body-m-zerolimit.md](../../v2/bugs/FINDING-doublependuluminittip-boxbody1-body-m-zerolimit.md) — reviewed as `FINDING-03898-doublependuluminittip-boxbody1-body-m.md`, which a later run renamed |
| Original SHA-256 | 5dfe4abcee3367cda0e986913261e68228a2487b7113da0437f9849b64ae3428 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:16`. Role: `parameter`; binding: `boxBody1.m`; effective min: `0`; effective max: `None`. 
