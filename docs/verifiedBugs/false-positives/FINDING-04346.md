# FINDING-04346: MultiBody Newton/Euler equations use mass and inertia multiplicatively
...
| Original report | [FINDING-mechanicalstructure-b6-body-m-zerolimit.md](../../v2/bugs/FINDING-mechanicalstructure-b6-body-m-zerolimit.md) — reviewed as `FINDING-04346-mechanicalstructure-b6-body-m.md`, which a later run renamed |
| Original SHA-256 | 0ecbd2a04ba045520cfe0a63d98f60e0d20d3d2daba00065c107bd770f87ec37 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:16`. Role: `parameter`; binding: `0.5`; effective min: `0`; effective max: `None`. 
