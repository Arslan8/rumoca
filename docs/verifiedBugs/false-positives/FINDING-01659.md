# FINDING-01659: Zero inductance is an explicitly supported algebraic limit
...
| Target | inductor.inductor[1].L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-imc-inverterdrive-inductor-inductor-1-l-zerolimit.md](../../v2/bugs/FINDING-imc-inverterdrive-inductor-inductor-1-l-zerolimit.md) — reviewed as `FINDING-01659-imc-inverterdrive-inductor-inductor-1-l.md`, which a later run renamed |
| Original SHA-256 | 219e1b6dbd1e6aa5a679ca787f0ed2417c475f398f0ff5ca5c9a6c325f5a80cd |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `inductor.L[1]`; effective min: `None`; effective max: `None`. 
