# FINDING-04244: Tensor entries are not all strictly positive scalars
...
| Target | bodyBox.body.I_32 |
| Student classification | physical-domain-unenforced |
| Original report | `FINDING-04244-bevelgear1d-bodybox-body-i-32.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 6eb06d6cc037e05d8a5e1dc08c12776b68f1ce3945f3d3edae1083a3c738343b |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:27`. Role: `parameter`; binding: `bodyBox.I[3, 2]`; effective min: `-1.7976931348623157e+308`; effective max: `None`. 
