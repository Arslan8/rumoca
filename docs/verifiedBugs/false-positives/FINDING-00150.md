# FINDING-00150: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | R11.IdealCommutingSwitch2.Goff |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-cauerlowpasssc-r11-idealcommutingswitch2-goff-ruleoff.md](../../v2/bugs/FINDING-cauerlowpasssc-r11-idealcommutingswitch2-goff-ruleoff.md) — reviewed as `FINDING-00150-cauerlowpasssc-r11-idealcommutingswitch2-goff.md`, which a later run renamed |
| Original SHA-256 | f90a3594230ca5875b8b92d4bf847533e90124c788d733ff56b19c45a1dbfd62 |
