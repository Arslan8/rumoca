# FINDING-01238: Zero heat capacity is a no-storage algebraic limit
...
| Original report | [FINDING-dcpm-cooling-core-c-zerolimit.md](../../v2/bugs/FINDING-dcpm-cooling-core-c-zerolimit.md) — reviewed as `FINDING-01238-dcpm-cooling-core-c.md`, which a later run renamed |
| Original SHA-256 | 5b52dd049b370249a0225798238f1953f15462f5db6dfdc12b7310d1fb8f0e18 |
...
Compiler/source-resolved declaration: `Thermal/HeatTransfer/Components/HeatCapacitor.mo:3`. Role: `parameter`; binding: `Cc`; effective min: `None`; effective max: `None`. 
