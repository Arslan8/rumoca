# FINDING-02740: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | idealCommutingSwitch.idealCommutingSwitch[2].Ron |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-imc-transformer-idealcommutingswitch-idealcommutingswitch-2-ron-ruleof-2.md](../../v2/bugs/FINDING-imc-transformer-idealcommutingswitch-idealcommutingswitch-2-ron-ruleof-2.md) — reviewed as `FINDING-02740-imc-transformer-idealcommutingswitch-idealcommutingswitch-2-ron.md`, which a later run renamed |
| Original SHA-256 | 9e93798d886aba995881671cd61dc655b099d5318821564e5f5e14cba2e67f10 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Ideal/IdealTwoWaySwitch.mo:3`. Role: `parameter`; binding: `idealCommutingSwitch.Ron[2]`; effective min: `0`; effective max: `None`. 
