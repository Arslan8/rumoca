# FINDING-00056: Zero capacitance is an explicitly supported algebraic limit
...
| Original report | [FINDING-cauerlowpassopv-c9-c-zerolimit.md](../../v2/bugs/FINDING-cauerlowpassopv-c9-c-zerolimit.md) — reviewed as `FINDING-00056-cauerlowpassopv-c9-c.md`, which a later run renamed |
| Original SHA-256 | 208dc15bf569a3209bdb9fed1eaf12040922093c1d279f5499ec09dfc02f7689 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Capacitor.mo:4`. Role: `parameter`; binding: `(c4 + c5)`; effective min: `0`; effective max: `None`. 
