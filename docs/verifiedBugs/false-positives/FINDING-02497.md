# FINDING-02497: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | switch3.idealClosingSwitch[2].Ron |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-smpm-resistivebraking-switch3-idealclosingswitch-2-ron-ruleoff.md](../../v2/bugs/FINDING-smpm-resistivebraking-switch3-idealclosingswitch-2-ron-ruleoff.md) — reviewed as `FINDING-02497-smpm-resistivebraking-switch3-idealclosingswitch-2-ron.md`, which a later run renamed |
| Original SHA-256 | f7200fb8bbd8ba4fec6522e437f9dd3298d65a6ef21499405c85f19af5490d46 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSwitch.mo:4`. Role: `parameter`; binding: `switch3.Ron[2]`; effective min: `0`; effective max: `None`. 
