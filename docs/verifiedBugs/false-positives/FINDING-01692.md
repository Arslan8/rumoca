# FINDING-01692: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | inverter.transistor_p.idealGTOThyristor[3].Goff |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-imc-inverterdrive-inverter-transistor-p-idealgtothyristor-3-goff-zerol.md](../../v2/bugs/FINDING-imc-inverterdrive-inverter-transistor-p-idealgtothyristor-3-goff-zerol.md) — reviewed as `FINDING-01692-imc-inverterdrive-inverter-transistor-p-idealgtothyristor-3-goff.md`, which a later run renamed |
| Original SHA-256 | 4661aafa56a4aa543901381430f7ab3581cbe2e2b9ae88aff52a5ecfe361dd6b |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:6`. Role: `parameter`; binding: `inverter.transistor_p.Goff[3]`; effective min: `0`; effective max: `None`. 
