# FINDING-02830: Zero inductance is an explicitly supported algebraic limit
...
| Target | transformer2.l2sigma.inductor[1].L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-rectifier12pulse-transformer2-l2sigma-inductor-1-l-zerolimit.md](../../v2/bugs/FINDING-rectifier12pulse-transformer2-l2sigma-inductor-1-l-zerolimit.md) — reviewed as `FINDING-02830-rectifier12pulse-transformer2-l2sigma-inductor-1-l.md`, which a later run renamed |
| Original SHA-256 | 0f64c57937fdaa47cd49ecfd225e85a90a6fe7d287d827730ae08f0b12082b7e |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `transformer2.l2sigma.L[1]`; effective min: `None`; effective max: `None`. 
