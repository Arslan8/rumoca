# FINDING-00754: Zero trapezoid edge duration is handled by branch reachability
...
| Target | VIN1.signalSource.rising |
| Student classification | divisor-reachable-zero |
| Original report | [FINDING-nandgate-vin1-signalsource-rising-divunresolved.md](../../v2/bugs/FINDING-nandgate-vin1-signalsource-rising-divunresolved.md) — reviewed as `FINDING-00754-nandgate-vin1-signalsource-rising.md`, which a later run renamed |
| Original SHA-256 | 5d236f6481eda2af597ab89c42e3b510e61c223e279d0c52a12b482d02a88452 |
...
Compiler/source-resolved declaration: `Blocks/Sources.mo:894`. Role: `parameter`; binding: `1e-09`; effective min: `0`; effective max: `None`. 
