# FINDING-02777: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | diode2.idealDiode[2].Ron |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-rectifier12pulse-diode2-idealdiode-2-ron-ruleoff.md](../../v2/bugs/FINDING-rectifier12pulse-diode2-idealdiode-2-ron-ruleoff.md) — reviewed as `FINDING-02777-rectifier12pulse-diode2-idealdiode-2-ron.md`, which a later run renamed |
| Original SHA-256 | d9b27fb1a2d130baa32bf7c2d448b0feab25601baeab7ca199158e56be0caba9 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:4`. Role: `parameter`; binding: `diode2.Ron[2]`; effective min: `0`; effective max: `None`. 
