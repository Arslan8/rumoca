# FINDING-03839: Zeroing this operand does not zero the complete denominator
...
| Original report | `FINDING-03839-advancedsolenoid-material-n.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | c865d54dd4253c887d65238f1dcf05e686fda51337558cbe478e2e87f7744ea6 |
...
Compiler/source-resolved declaration: `Magnetic/FluxTubes/Material/SoftMagnetic/BaseData.mo:13`. Role: `parameter`; binding: `12.5`; effective min: `None`; effective max: `None`. 
