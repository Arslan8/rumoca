# FINDING-02743: Zero on-resistance/off-conductance is an intended ideal limit
...
| Original report | [FINDING-imc-transformer-idealcommutingswitch-idealcommutingswitch-3-goff-ruleo-2.md](../../v2/bugs/FINDING-imc-transformer-idealcommutingswitch-idealcommutingswitch-3-goff-ruleo-2.md) — reviewed as `FINDING-02743-imc-transformer-idealcommutingswitch-idealcommutingswitch-3-goff.md`, which a later run renamed |
| Original SHA-256 | 24464f8be61e2393f9f2f07cf1260adf473d2de1bfddc8144d3c93abfa83aefb |
...
Compiler/source-resolved declaration: `Electrical/Analog/Ideal/IdealTwoWaySwitch.mo:4`. Role: `parameter`; binding: `idealCommutingSwitch.Goff[3]`; effective min: `0`; effective max: `None`. 
