# FINDING-04752: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | idealSwitch.Ron |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-controlledtemperature-idealswitch-ron-ruleoff.md](../../v2/bugs/FINDING-controlledtemperature-idealswitch-ron-ruleoff.md) — reviewed as `FINDING-04752-controlledtemperature-idealswitch-ron.md`, which a later run renamed |
| Original SHA-256 | f57f2e9f1c71a7953f8317b3405e67a4d322260a52d0099b86785baa0124b8de |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSwitch.mo:4`. Role: `parameter`; binding: `1e-05`; effective min: `0`; effective max: `None`. 

[Electrical/Analog/Interfaces/IdealSwitch.mo — source snapshot](../evidence/sources/ddf9c35a45d16f3d-IdealSwitch.mo)

```modelica
2: partial model IdealSwitch "Ideal electrical switch"
