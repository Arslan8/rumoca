# FINDING-00623: Zero capacitance is an explicitly supported algebraic limit
...
| Target | oLine50.C[46].C |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-smoothstep-oline50-c-46-c-zerolimit.md](../../v2/bugs/FINDING-smoothstep-oline50-c-46-c-zerolimit.md) — reviewed as `FINDING-00623-smoothstep-oline50-c-46-c.md`, which a later run renamed |
| Original SHA-256 | 3f468b44d06ad4019457adc0b3da92dc6743125e86665b7075bd6ca380d10414 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Capacitor.mo:4`. Role: `parameter`; binding: `((oLine50.c * oLine50.length) / oLine50.N)`; effective min: `0`; effective max: `None`. 
