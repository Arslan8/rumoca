# FINDING-00544: Zero inductance is an explicitly supported algebraic limit
...
| Target | oLine50.L[18].L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-smoothstep-oline50-l-18-l-zerolimit.md](../../v2/bugs/FINDING-smoothstep-oline50-l-18-l-zerolimit.md) — reviewed as `FINDING-00544-smoothstep-oline50-l-18-l.md`, which a later run renamed |
| Original SHA-256 | 096c7342ff018e62737f043fb4ca62d0afaae866290c89b7690cd68575788048 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `oLine50.lm[18]`; effective min: `None`; effective max: `None`. 
