# FINDING-02092: Zero on-resistance/off-conductance is an intended ideal limit
...
| Original report | [FINDING-ims-start-switchedrheostat-idealcommutingswitch-idealcommutingswitch-3-2.md](../../v2/bugs/FINDING-ims-start-switchedrheostat-idealcommutingswitch-idealcommutingswitch-3-2.md) — reviewed as `FINDING-02092-ims-start-switchedrheostat-idealcommutingswitch-idealcommutingswitch-3.md`, which a later run renamed |
| Original SHA-256 | 8ebef87f4efae9fb3a9a12eabf81d4022ebc15c3a54c1f6af30728b4e61198e6 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Ideal/IdealTwoWaySwitch.mo:4`. Role: `parameter`; binding: `switchedRheostat.idealCommutingSwitch.Goff[3]`; effective min: `0`; effective max: `None`. 
