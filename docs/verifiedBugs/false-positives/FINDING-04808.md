# FINDING-04808: unitTime is an immutable nonzero unit constant
...
| Target | limPID.unitTime |
| Student classification | divisor-reachable-zero |
| Original report | `FINDING-04808-continuous-initialstate-limpid-unittime.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 7764636878bb0e7a0288a18e2793b05d0fa8371221014f18f1e8585ed5d62dcd |
