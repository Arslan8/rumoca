# FINDING-05048: Zero effective drag area switches off aerodynamic drag
...
| Target | vehicleInclinationInConst.A |
| Student classification | physical-invariant-violated |
| Original report | [FINDING-vehicles-vehicleinclinationinconst-a-zerolimit.md](../../v2/bugs/FINDING-vehicles-vehicleinclinationinconst-a-zerolimit.md) — reviewed as `FINDING-05048-vehicles-vehicleinclinationinconst-a.md`, which a later run renamed |
| Original SHA-256 | 984345522115506a2307d4a23e1c4df273d079341e5a8187df9b10ce8a4588b9 |
