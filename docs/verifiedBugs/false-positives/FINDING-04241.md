# FINDING-04241: MultiBody Newton/Euler equations use mass and inertia multiplicatively
...
| Target | bodyBox.body.I_33 |
| Student classification | physical-bound-permits-zero |
| Original report | `FINDING-04241-bevelgear1d-bodybox-body-i-33.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | e2b0badb16d0cbcaf0173595a657d3b5b40dc1803304cd9415399197491e214e |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:21`. Role: `parameter`; binding: `bodyBox.I[3, 3]`; effective min: `0`; effective max: `None`. 
