# FINDING-01121: Zero core-loss conductance deliberately disables losses
...
| Target | dceeData.coreParameters.GcRef |
| Student classification | physical-invariant-violated |
| Original report | [FINDING-dc-comparecharacteristics-dceedata-coreparameters-gcref-zerolimit.md](../../v2/bugs/FINDING-dc-comparecharacteristics-dceedata-coreparameters-gcref-zerolimit.md) — reviewed as `FINDING-01121-dc-comparecharacteristics-dceedata-coreparameters-gcref.md`, which a later run renamed |
| Original SHA-256 | 21823d01cfdee21d0f21c240c78b77b29028045f2063cf3a4f9a6a42322d8c4f |
