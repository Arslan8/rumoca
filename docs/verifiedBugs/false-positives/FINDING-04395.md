# FINDING-04395: Zero inertia is a massless algebraic component, not an intrinsic division
...
| Original report | [FINDING-firstgrounded-inertia1-j-zerolimit.md](../../v2/bugs/FINDING-firstgrounded-inertia1-j-zerolimit.md) — reviewed as `FINDING-04395-firstgrounded-inertia1-j.md`, which a later run renamed |
| Original SHA-256 | c8df968b00dfd79a7e9c1b18890970c1f1e72e29d34e3424e9428587b4522b55 |
...
Compiler/source-resolved declaration: `Mechanics/Rotational/Components/Inertia.mo:4`. Role: `parameter`; binding: `Jmotor`; effective min: `0`; effective max: `None`. 
