# FINDING-00966: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | IdealDiode3.Goff |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-rectifier-idealdiode3-goff-zerolimit.md](../../v2/bugs/FINDING-rectifier-idealdiode3-goff-zerolimit.md) — reviewed as `FINDING-00966-rectifier-idealdiode3-goff.md`, which a later run renamed |
| Original SHA-256 | 3249396758f2c7e538c903dc4a2b688abca51449c1566f8afca04f59c398c849 |
