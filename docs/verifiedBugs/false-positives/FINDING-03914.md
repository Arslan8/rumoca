# FINDING-03914: MultiBody Newton/Euler equations use mass and inertia multiplicatively
...
| Target | boxBody2.body.I_33 |
| Student classification | physical-bound-permits-zero |
| Original report | `FINDING-03914-doublependuluminittip-boxbody2-body-i-33.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | c0c6159e93262dbee298aed4fdb405c7a38cf2cdf9e17cbe18d688c29388be73 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:21`. Role: `parameter`; binding: `boxBody2.I[3, 3]`; effective min: `0`; effective max: `None`. 
