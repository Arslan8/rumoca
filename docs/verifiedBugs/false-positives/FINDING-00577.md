# FINDING-00577: Zero inductance is an explicitly supported algebraic limit
...
| Target | oLine50.L[51].L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-smoothstep-oline50-l-51-l-zerolimit.md](../../v2/bugs/FINDING-smoothstep-oline50-l-51-l-zerolimit.md) — reviewed as `FINDING-00577-smoothstep-oline50-l-51-l.md`, which a later run renamed |
| Original SHA-256 | cbebf4bc689a42a35d2e37f6b241f02a3dad220b5033c8a2bb6b956d99588b2f |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `oLine50.lm[51]`; effective min: `None`; effective max: `None`. 
