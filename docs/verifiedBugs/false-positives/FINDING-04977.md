# FINDING-04977: Zeroing this operand does not zero the complete denominator
...
| Target | genericFluxTube1.material.n |
| Student classification | divisor-reachable-zero |
| Original report | `FINDING-04977-sources-genericfluxtube1-material-n.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 464e4f0a1defe91aacadbda346c54c5544807b7c98989a40182588f43479a911 |
...
| Probe | Outcome |
|---|---|
| `genericFluxTube1.material.n=0` | clean |
