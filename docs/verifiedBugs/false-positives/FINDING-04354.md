# FINDING-04354: MultiBody Newton/Euler equations use mass and inertia multiplicatively
...
| Original report | [FINDING-mechanicalstructure-load-m-intent.md](../../v2/bugs/FINDING-mechanicalstructure-load-m-intent.md) — reviewed as `FINDING-04354-mechanicalstructure-load-m.md`, which a later run renamed |
| Original SHA-256 | c902837e53a06d838b9c6f26cb539acdc3465775e35a6edd4a1b7257395df684 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/BodyShape.mo:23`. Role: `parameter`; binding: `mLoad`; effective min: `0`; effective max: `None`. 
