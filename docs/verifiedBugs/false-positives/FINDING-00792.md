# FINDING-00792: Zero capacitance is an explicitly supported algebraic limit
...
| Target | firstOrder1A.c.C |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-controlcircuit-firstorder1a-c-c-zerolimit.md](../../v2/bugs/FINDING-controlcircuit-firstorder1a-c-c-zerolimit.md) — reviewed as `FINDING-00792-controlcircuit-firstorder1a-c-c.md`, which a later run renamed |
| Original SHA-256 | fb21721de42711ce71137aafeeb682b36cb3838bd5ad2cd7501279fb08233e6a |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Capacitor.mo:4`. Role: `parameter`; binding: `firstOrder1A.C`; effective min: `0`; effective max: `None`. 
...
| Probe | Outcome |
|---|---|
| `firstOrder1A.c.C=0` | reported-failure |
