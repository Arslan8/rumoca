# FINDING-00139: Zero capacitance is an explicitly supported algebraic limit
...
| Target | R10.Capacitor.C |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-cauerlowpasssc-r10-capacitor-c-zerolimit.md](../../v2/bugs/FINDING-cauerlowpasssc-r10-capacitor-c-zerolimit.md) — reviewed as `FINDING-00139-cauerlowpasssc-r10-capacitor-c.md`, which a later run renamed |
| Original SHA-256 | 0d3923a76fffa903e7b60be88fd357c9cab9e18339a0c25f41553b76de459ba5 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Capacitor.mo:4`. Role: `parameter`; binding: `(R10.clock / max((2.220446049250313e-16 * R10.oneOhm), abs(R10.R)))`; effective min: `0`; effective max: `None`. 
