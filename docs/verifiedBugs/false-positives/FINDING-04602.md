# FINDING-04602: The friction denominator is protected by an ordering assertion
...
| Target | pipe2.V_flowNominal |
| Student classification | divisor-reachable-zero |
| Original report | [FINDING-parallelpumpdropout-pipe2-v-flownominal-divzero.md](../../v2/bugs/FINDING-parallelpumpdropout-pipe2-v-flownominal-divzero.md) — reviewed as `FINDING-04602-parallelpumpdropout-pipe2-v-flownominal.md`, which a later run renamed |
| Original SHA-256 | 9d63b33c358a08b4e52e5c63e11880a396bc938987c174f19439530c0c806cdd |
...
| Probe | Outcome |
|---|---|
| `pipe2.V_flowNominal=0` | reported-failure |
