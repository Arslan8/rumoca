# FINDING-04529: The friction denominator is protected by an ordering assertion
...
| Target | innerPipe.V_flowNominal |
| Student classification | divisor-reachable-zero |
| Original report | [FINDING-indirectcooling-innerpipe-v-flownominal-divzero.md](../../v2/bugs/FINDING-indirectcooling-innerpipe-v-flownominal-divzero.md) — reviewed as `FINDING-04529-indirectcooling-innerpipe-v-flownominal.md`, which a later run renamed |
| Original SHA-256 | 850310b717cd2e32f4211de3e4cc6c8df4b02609161e61596ecc41c5514ab9ff |
...
| Probe | Outcome |
|---|---|
| `innerPipe.V_flowNominal=0` | reported-failure |
