# FINDING-01973: Polyphase inductance delegates to zero-capable scalar inductors
...
| Original report | [FINDING-imc-ydarc-inductor-l-zerolimit.md](../../v2/bugs/FINDING-imc-ydarc-inductor-l-zerolimit.md) — reviewed as `FINDING-01973-imc-ydarc-inductor-l.md`, which a later run renamed |
| Original SHA-256 | e5816b80153f9b77fb458a2c50d219a2fea9390482dc7bb5a83b00385145eb73 |
...
Compiler/source-resolved declaration: `Electrical/Polyphase/Basic/Inductor.mo:4`. Role: `parameter`; binding: `fill(LLine, m)`; effective min: `None`; effective max: `None`. 
