# FINDING-04475: Zero mass is a massless algebraic component, not an intrinsic division
...
| Original report | [FINDING-sensors-mass-m-zerolimit.md](../../v2/bugs/FINDING-sensors-mass-m-zerolimit.md) — reviewed as `FINDING-04475-sensors-mass-m.md`, which a later run renamed |
| Original SHA-256 | e07e1feffb0be7296e8c2e1bb0723b977803327040c5f579c61e1321feb8d428 |
...
[Rumoca commands, return codes, integrity hashes, bounded output and metadata](../evidence/f401827003c55d54.json). Baseline: **tool-error**.
