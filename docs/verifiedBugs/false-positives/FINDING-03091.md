# FINDING-03091: Zero inductance is an explicitly supported algebraic limit
...
| Target | lMains.inductor[3].L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-thyristorbridge2mpulse-dc-drive-lmains-inductor-3-l-zerolimit.md](../../v2/bugs/FINDING-thyristorbridge2mpulse-dc-drive-lmains-inductor-3-l-zerolimit.md) — reviewed as `FINDING-03091-thyristorbridge2mpulse-dc-drive-lmains-inductor-3-l.md`, which a later run renamed |
| Original SHA-256 | 88d334a995cf0026d00aec15c6c56142700d58d0b6d14e2249b60673c91a039c |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `lMains.L[3]`; effective min: `None`; effective max: `None`. 
