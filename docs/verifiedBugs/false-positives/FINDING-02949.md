# FINDING-02949: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | idealDiode2.idealDiode[3].Ron |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-rectifier-idealdiode2-idealdiode-3-ron-ruleoff.md](../../v2/bugs/FINDING-rectifier-idealdiode2-idealdiode-3-ron-ruleoff.md) — reviewed as `FINDING-02949-rectifier-idealdiode2-idealdiode-3-ron.md`, which a later run renamed |
| Original SHA-256 | 55abb2012690a6352cce3d8d6258f8dea269c6b1cf761dcfa83c5ef85725301a |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:4`. Role: `parameter`; binding: `idealDiode2.Ron[3]`; effective min: `0`; effective max: `None`. 
