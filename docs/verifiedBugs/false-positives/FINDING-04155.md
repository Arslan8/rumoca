# FINDING-04155: MultiBody spring mass/stiffness has an intentional zero limit
...
| Original report | [FINDING-threesprings-spring3-c-intent.md](../../v2/bugs/FINDING-threesprings-spring3-c-intent.md) — reviewed as `FINDING-04155-threesprings-spring3-c.md`, which a later run renamed |
| Original SHA-256 | ae1cb200db71f4bc55f13510b95f2065a1a892947c4ccf29b558adb165cc0611 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Forces/Spring.mo:9`. Role: `parameter`; binding: `20`; effective min: `0`; effective max: `None`. 
