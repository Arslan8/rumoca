# FINDING-00209: Arc-switch resistance/conductance are multiplicative ideal limits
...
| Original report | [FINDING-controlledswitchwitharc-switch2-ron-zerolimit.md](../../v2/bugs/FINDING-controlledswitchwitharc-switch2-ron-zerolimit.md) — reviewed as `FINDING-00209-controlledswitchwitharc-switch2-ron.md`, which a later run renamed |
| Original SHA-256 | f725797a0fb801d11028432ded066228251e8056320c8515bada3a90aa0ffcd5 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSwitchWithArc.mo:4`. Role: `parameter`; binding: `1e-05`; effective min: `None`; effective max: `None`. 
