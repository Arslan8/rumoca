# FINDING-03668: Converter switch parameters delegate to ideal semiconductor limits
...
| Original report | [FINDING-hbridge-r-hbridge-inverter-n-rondiode-ruleoff.md](../../v2/bugs/FINDING-hbridge-r-hbridge-inverter-n-rondiode-ruleoff.md) — reviewed as `FINDING-03668-hbridge-r-hbridge-inverter-n-rondiode.md`, which a later run renamed |
| Original SHA-256 | 95f864e9315f557b49e2f7c1e171c0ff35202053d6cba35dacf5cd2eace81aba |
