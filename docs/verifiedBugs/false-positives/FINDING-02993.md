# FINDING-02993: Zero inductance is an explicitly supported algebraic limit
...
| Target | transformerL.inductor[3].L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-transformeryy-transformerl-inductor-3-l-zerolimit.md](../../v2/bugs/FINDING-transformeryy-transformerl-inductor-3-l-zerolimit.md) — reviewed as `FINDING-02993-transformeryy-transformerl-inductor-3-l.md`, which a later run renamed |
| Original SHA-256 | 895b6ae2ccf3904828c25a2913dcc76b3c503e2d4945a9777185a017a1934178 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `transformerL.L[3]`; effective min: `None`; effective max: `None`. 
