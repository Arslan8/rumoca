# FINDING-03625: Converter switch parameters delegate to ideal semiconductor limits
...
| Original report | [FINDING-hbridge-rl-hbridge-inverter-p-goffdiode-zerolimit.md](../../v2/bugs/FINDING-hbridge-rl-hbridge-inverter-p-goffdiode-zerolimit.md) — reviewed as `FINDING-03625-hbridge-rl-hbridge-inverter-p-goffdiode.md`, which a later run renamed |
| Original SHA-256 | 57069d7abdf6623f333097adddfc7686226ce205a31e2ffbddc5dbc1a1c48164 |
