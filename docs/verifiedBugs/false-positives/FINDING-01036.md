# FINDING-01036: Zero inductance is an explicitly supported algebraic limit
...
| Original report | [FINDING-thyristorbehaviourtest-inductor-l-zerolimit.md](../../v2/bugs/FINDING-thyristorbehaviourtest-inductor-l-zerolimit.md) — reviewed as `FINDING-01036-thyristorbehaviourtest-inductor-l.md`, which a later run renamed |
| Original SHA-256 | 0018c587a3fa67305e4cc584715949928579304ef42fcb7ee6fb0acc09e5a89e |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `2e-06`; effective min: `None`; effective max: `None`. 
