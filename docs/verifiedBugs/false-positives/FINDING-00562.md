# FINDING-00562: Zero inductance is an explicitly supported algebraic limit
...
| Target | oLine50.L[36].L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-smoothstep-oline50-l-36-l-zerolimit.md](../../v2/bugs/FINDING-smoothstep-oline50-l-36-l-zerolimit.md) — reviewed as `FINDING-00562-smoothstep-oline50-l-36-l.md`, which a later run renamed |
| Original SHA-256 | 65b55b1b7cfd0c1aac8a941e065549e69edf94a97503a1b5a01412ab4018b561 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `oLine50.lm[36]`; effective min: `None`; effective max: `None`. 
