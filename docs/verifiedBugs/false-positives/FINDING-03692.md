# FINDING-03692: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | hbridge.inverter_p.transistor_n.Ron |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-hbridge-trianglepwm-rl-hbridge-inverter-p-transistor-n-ron-ruleoff.md](../../v2/bugs/FINDING-hbridge-trianglepwm-rl-hbridge-inverter-p-transistor-n-ron-ruleoff.md) — reviewed as `FINDING-03692-hbridge-trianglepwm-rl-hbridge-inverter-p-transistor-n-ron.md`, which a later run renamed |
| Original SHA-256 | 84b2322a250b1681029c177d027a67228b062ed7919ec06a4ac0705e3b1ab23c |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:4`. Role: `parameter`; binding: `hbridge.inverter_p.RonTransistor`; effective min: `0`; effective max: `None`. 
