# FINDING-04245: Tensor entries are not all strictly positive scalars
...
| Target | bodyBox.body.I |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-bevelgear1d-bodybox-body-i-tensorunknown.md](../../v2/bugs/FINDING-bevelgear1d-bodybox-body-i-tensorunknown.md) — reviewed as `FINDING-04245-bevelgear1d-bodybox-body-i.md`, which a later run renamed |
| Original SHA-256 | 10e471adc3a0ad3d3db01c2ec03e39b2ae6a3ef42fab0a0f6849e0d535751dc3 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:114`. Role: `parameter`; binding: `cat1(cat2(bodyBox.body.I_11, bodyBox.body.I_21, bodyBox.body.I_31), cat2(bodyBox.body.I_21, bodyBox.body.I_22, bodyBox.body.I_32), cat2(bodyBox.body.I_31, bodyBox.body.I_32, bodyBox.body.I_33))`; effective min: `None`; effective max: `None`. 
