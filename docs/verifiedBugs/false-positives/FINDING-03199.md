# FINDING-03199: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | rectifier.diode_p2.Goff |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-diodebridge2pulse-rectifier-diode-p2-goff-zerolimit.md](../../v2/bugs/FINDING-diodebridge2pulse-rectifier-diode-p2-goff-zerolimit.md) — reviewed as `FINDING-03199-diodebridge2pulse-rectifier-diode-p2-goff.md`, which a later run renamed |
| Original SHA-256 | 18c8015727e49cac8c19689cc2a495dd2eb3ebed1aafb7e6b92a1102f9883365 |
