# FINDING-03397: Zero on-resistance/off-conductance is an intended ideal limit
...
| Original report | [FINDING-thyristorcentertap2mpulse-r-rectifier-thyristor-p-idealthyristor-2-ron.md](../../v2/bugs/FINDING-thyristorcentertap2mpulse-r-rectifier-thyristor-p-idealthyristor-2-ron.md) — reviewed as `FINDING-03397-thyristorcentertap2mpulse-r-rectifier-thyristor-p-idealthyristor-2-ron.md`, which a later run renamed |
| Original SHA-256 | d5a5ffafa2410a92e0e6783ea1ab1ba5aba9ff74b176e1045c13e79712b8bd90 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:4`. Role: `parameter`; binding: `rectifier.thyristor_p.Ron[2]`; effective min: `0`; effective max: `None`. 
