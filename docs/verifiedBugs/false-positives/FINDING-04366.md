# FINDING-04366: Tensor entries are not all strictly positive scalars
...
| Target | load.body.I_31 |
| Student classification | physical-domain-unenforced |
| Original report | `FINDING-04366-mechanicalstructure-load-body-i-31.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 15fa4ac6aa384ef839b93b472d33022f91e539cb77900ecd515de55af3e7afaa |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:25`. Role: `parameter`; binding: `load.I_31`; effective min: `-1.7976931348623157e+308`; effective max: `None`. 
