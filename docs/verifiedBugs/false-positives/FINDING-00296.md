# FINDING-00296: A zero-duration ramp is a supported step
...
| Original report | [FINDING-heatingnpn-norgate-v-signalsource-duration-divunreach.md](../../v2/bugs/FINDING-heatingnpn-norgate-v-signalsource-duration-divunreach.md) — reviewed as `FINDING-00296-heatingnpn-norgate-v-signalsource-duration.md`, which a later run renamed |
| Original SHA-256 | 65ffca08121a9ccac1012cb70758cc30ccab9654f479adc8cdd6eea8a99632f1 |
...
Compiler/source-resolved declaration: `Blocks/Sources.mo:247`. Role: `parameter`; binding: `5`; effective min: `0.0`; effective max: `None`. 
