# FINDING-00570: Zero inductance is an explicitly supported algebraic limit
...
| Target | oLine50.L[44].L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-smoothstep-oline50-l-44-l-zerolimit.md](../../v2/bugs/FINDING-smoothstep-oline50-l-44-l-zerolimit.md) — reviewed as `FINDING-00570-smoothstep-oline50-l-44-l.md`, which a later run renamed |
| Original SHA-256 | 4f58a124fbfd227475c563920c044a5715d474ec3a2b2ec816c181370a8cd071 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `oLine50.lm[44]`; effective min: `None`; effective max: `None`. 
