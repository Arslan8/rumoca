# FINDING-01660: Zero inductance is an explicitly supported algebraic limit
...
| Target | inductor.inductor[2].L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-imc-inverterdrive-inductor-inductor-2-l-zerolimit.md](../../v2/bugs/FINDING-imc-inverterdrive-inductor-inductor-2-l-zerolimit.md) — reviewed as `FINDING-01660-imc-inverterdrive-inductor-inductor-2-l.md`, which a later run renamed |
| Original SHA-256 | cd59ebe2f9efe69f37496e2023f79ab37def1c9072214aa95fb2e5bf8f7479a9 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `inductor.L[2]`; effective min: `None`; effective max: `None`. 
