# FINDING-00567: Zero inductance is an explicitly supported algebraic limit
...
| Target | oLine50.L[41].L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-smoothstep-oline50-l-41-l-zerolimit.md](../../v2/bugs/FINDING-smoothstep-oline50-l-41-l-zerolimit.md) — reviewed as `FINDING-00567-smoothstep-oline50-l-41-l.md`, which a later run renamed |
| Original SHA-256 | eb0afcac5986748d62c6834c43ddd5f7a9f06831573bd12b68f82e23fc4d17f8 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `oLine50.lm[41]`; effective min: `None`; effective max: `None`. 
