# FINDING-03811: Armature example delegates to zero-capable mechanical terms
...
| Original report | [FINDING-permeanceactuator-armature-d-intent.md](../../v2/bugs/FINDING-permeanceactuator-armature-d-intent.md) — reviewed as `FINDING-03811-permeanceactuator-armature-d.md`, which a later run renamed |
| Original SHA-256 | bdd0ffabb835a4da58cb53c6d8065c925a76ec491fd9f87718ec5cf350468e59 |
...
Compiler/source-resolved declaration: `Magnetic/FluxTubes/Examples/Utilities/TranslatoryArmatureAndStopper.mo:11`. Role: `parameter`; binding: `d`; effective min: `None`; effective max: `None`. 
