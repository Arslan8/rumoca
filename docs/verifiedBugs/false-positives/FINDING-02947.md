# FINDING-02947: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | idealDiode2.idealDiode[2].Ron |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-rectifier-idealdiode2-idealdiode-2-ron-ruleoff.md](../../v2/bugs/FINDING-rectifier-idealdiode2-idealdiode-2-ron-ruleoff.md) — reviewed as `FINDING-02947-rectifier-idealdiode2-idealdiode-2-ron.md`, which a later run renamed |
| Original SHA-256 | 67a9cdb580025bd7ef6c690341122cc5c3a7b48e8e29ebe5c6ad75647d76451d |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:4`. Role: `parameter`; binding: `idealDiode2.Ron[2]`; effective min: `0`; effective max: `None`. 
