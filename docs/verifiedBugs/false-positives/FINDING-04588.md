# FINDING-04588: Zero stored fluid mass is explicitly supported
...
| Original report | [FINDING-parallelpumpdropout-pipe2-m-zerolimit.md](../../v2/bugs/FINDING-parallelpumpdropout-pipe2-m-zerolimit.md) — reviewed as `FINDING-04588-parallelpumpdropout-pipe2-m.md`, which a later run renamed |
| Original SHA-256 | 58e8bd9a633441987cc2cf3e4598a7625d4dccefa4c6182daeb0768419889726 |
...
| Probe | Outcome |
|---|---|
| `pipe2.m=0` | reported-failure |

Diagnostic: solve-IR evaluation failed: non-finite derivative evaluation for state 'dTtoPipe1'
