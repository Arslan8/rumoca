# FINDING-02484: Polyphase resistance/conductance delegates to signed scalar elements
...
| Original report | `FINDING-02484-smpm-resistivebraking-resistor3-r.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 5bde15a342ae4f2a4e35dfc9d7d4da70595a6fd17fe069705e10e60b448129ad |
...
Compiler/source-resolved declaration: `Electrical/Polyphase/Basic/Resistor.mo:4`. Role: `parameter`; binding: `(k[3] * fill(smpmData.Rs, m))`; effective min: `None`; effective max: `None`. 
