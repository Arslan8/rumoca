# FINDING-00407: Zero inductance is an explicitly supported algebraic limit
...
| Original report | [FINDING-comparelinetrunks-oline3-l-8-l-zerolimit.md](../../v2/bugs/FINDING-comparelinetrunks-oline3-l-8-l-zerolimit.md) — reviewed as `FINDING-00407-comparelinetrunks-oline3-l-8-l.md`, which a later run renamed |
| Original SHA-256 | d8e2a64bde196b3e7d19e4b4205dae680888beddc8b39b7e2be6320e672362cd |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `oLine3.lm[8]`; effective min: `None`; effective max: `None`. 
