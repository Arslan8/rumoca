# FINDING-03809: Armature example delegates to zero-capable mechanical terms
...
| Original report | [FINDING-permeanceactuator-armature-m-intent.md](../../v2/bugs/FINDING-permeanceactuator-armature-m-intent.md) — reviewed as `FINDING-03809-permeanceactuator-armature-m.md`, which a later run renamed |
| Original SHA-256 | ba546f78bbfc8e5cee636b4d5aecd3770167adac487c084e7d26cd601e362d51 |
...
Compiler/source-resolved declaration: `Magnetic/FluxTubes/Examples/Utilities/TranslatoryArmatureAndStopper.mo:7`. Role: `parameter`; binding: `m_a`; effective min: `0`; effective max: `None`. 
