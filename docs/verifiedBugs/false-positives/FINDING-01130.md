# FINDING-01130: Zero core-loss conductance deliberately disables losses
...
| Target | dcse.core.coreParameters.GcRef |
| Student classification | physical-invariant-violated |
| Original report | [FINDING-dc-comparecharacteristics-dcse-core-coreparameters-gcref-zerolimit.md](../../v2/bugs/FINDING-dc-comparecharacteristics-dcse-core-coreparameters-gcref-zerolimit.md) — reviewed as `FINDING-01130-dc-comparecharacteristics-dcse-core-coreparameters-gcref.md`, which a later run renamed |
| Original SHA-256 | 9a846fb5812216b68d46f3f64710ef3779d425653cd96c7e327c09344a548738 |
...
Compiler/source-resolved declaration: `Electrical/Machines/Losses/CoreParameters.mo:18`. Role: `parameter`; binding: `dcseData.coreParameters.GcRef`; effective min: `None`; effective max: `None`. 
