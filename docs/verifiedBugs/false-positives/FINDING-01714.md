# FINDING-01714: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | inverter.diode_n.idealDiode[2].Goff |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-imc-inverterdrive-inverter-diode-n-idealdiode-2-goff-zerolimit.md](../../v2/bugs/FINDING-imc-inverterdrive-inverter-diode-n-idealdiode-2-goff-zerolimit.md) — reviewed as `FINDING-01714-imc-inverterdrive-inverter-diode-n-idealdiode-2-goff.md`, which a later run renamed |
| Original SHA-256 | 56db2edcdeb14c992c4887f62a5b2eb8f466e6dc672c3c160c812ef745d96e31 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:6`. Role: `parameter`; binding: `inverter.diode_n.Goff[2]`; effective min: `0`; effective max: `None`. 
