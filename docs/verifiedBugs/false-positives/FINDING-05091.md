# FINDING-05091: Zero inertia is a massless algebraic component, not an intrinsic division
...
| Target | vehicleInclinationInConst.inertia.J |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-vehicles-vehicleinclinationinconst-inertia-j-zerolimit.md](../../v2/bugs/FINDING-vehicles-vehicleinclinationinconst-inertia-j-zerolimit.md) — reviewed as `FINDING-05091-vehicles-vehicleinclinationinconst-inertia-j.md`, which a later run renamed |
| Original SHA-256 | f16106155039bafa5c95c617c7fc1dfbc8e1b7fdd1b68623abe879dc869c4dc8 |
...
Compiler/source-resolved declaration: `Mechanics/Rotational/Components/Inertia.mo:4`. Role: `parameter`; binding: `2.3`; effective min: `0`; effective max: `None`. 
