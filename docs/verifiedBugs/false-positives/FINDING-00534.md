# FINDING-00534: Zero inductance is an explicitly supported algebraic limit
...
| Target | oLine50.L[8].L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-smoothstep-oline50-l-8-l-zerolimit.md](../../v2/bugs/FINDING-smoothstep-oline50-l-8-l-zerolimit.md) — reviewed as `FINDING-00534-smoothstep-oline50-l-8-l.md`, which a later run renamed |
| Original SHA-256 | 69389f1cccd4fbeb67385907a2b56fd26ef4627017c27fc5f5a2a9abb796366a |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `oLine50.lm[8]`; effective min: `None`; effective max: `None`. 
