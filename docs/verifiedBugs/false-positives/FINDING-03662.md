# FINDING-03662: Zero on-resistance/off-conductance is an intended ideal limit
...
| Original report | [FINDING-hbridge-r-hbridge-inverter-p-transistor-n-ron-ruleoff.md](../../v2/bugs/FINDING-hbridge-r-hbridge-inverter-p-transistor-n-ron-ruleoff.md) — reviewed as `FINDING-03662-hbridge-r-hbridge-inverter-p-transistor-n-ron.md`, which a later run renamed |
| Original SHA-256 | 170ac4d09e5b289b07c7fbf9c0954ae1bdf952e33371576ded9b76dc72016118 |
