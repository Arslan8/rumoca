# FINDING-00400: Zero inductance is an explicitly supported algebraic limit
...
| Original report | [FINDING-comparelinetrunks-oline3-l-1-l-zerolimit.md](../../v2/bugs/FINDING-comparelinetrunks-oline3-l-1-l-zerolimit.md) — reviewed as `FINDING-00400-comparelinetrunks-oline3-l-1-l.md`, which a later run renamed |
| Original SHA-256 | 0489023569b4483d460228ccd0500b14fbfea168b8eb5f695c5a6656c7f5a755 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `oLine3.lm[1]`; effective min: `None`; effective max: `None`. 
