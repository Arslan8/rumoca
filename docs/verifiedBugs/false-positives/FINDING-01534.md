# FINDING-01534: Zero core-loss conductance deliberately disables losses
...
| Target | imc.statorCoreParameters.GcRef |
| Student classification | physical-invariant-violated |
| Original report | [FINDING-imc-dcbraking-imc-statorcoreparameters-gcref-zerolimit.md](../../v2/bugs/FINDING-imc-dcbraking-imc-statorcoreparameters-gcref-zerolimit.md) — reviewed as `FINDING-01534-imc-dcbraking-imc-statorcoreparameters-gcref.md`, which a later run renamed |
| Original SHA-256 | cda9bf9a8c227a7c39b311a3f76e149c16e0b159a5722e2af4fc649941a37fce |
...
Compiler/source-resolved declaration: `Electrical/Machines/Losses/CoreParameters.mo:18`. Role: `parameter`; binding: `imcData.statorCoreParameters.GcRef`; effective min: `None`; effective max: `None`. 
