# FINDING-00557: Zero inductance is an explicitly supported algebraic limit
...
| Target | oLine50.L[31].L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-smoothstep-oline50-l-31-l-zerolimit.md](../../v2/bugs/FINDING-smoothstep-oline50-l-31-l-zerolimit.md) — reviewed as `FINDING-00557-smoothstep-oline50-l-31-l.md`, which a later run renamed |
| Original SHA-256 | 18573df88fd01903d45638075841e218214462a979d798ec57b2047ac649128f |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `oLine50.lm[31]`; effective min: `None`; effective max: `None`. 
