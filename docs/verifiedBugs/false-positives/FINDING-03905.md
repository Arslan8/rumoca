# FINDING-03905: Tensor entries are not all strictly positive scalars
...
| Target | boxBody1.body.I |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-doublependuluminittip-boxbody1-body-i-tensorunknown.md](../../v2/bugs/FINDING-doublependuluminittip-boxbody1-body-i-tensorunknown.md) — reviewed as `FINDING-03905-doublependuluminittip-boxbody1-body-i.md`, which a later run renamed |
| Original SHA-256 | 5bc7ab3154e46daea0bc08479e90ae982fa11000f9ef1c43859cbcf053dd4ddb |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:114`. Role: `parameter`; binding: `cat1(cat2(boxBody1.body.I_11, boxBody1.body.I_21, boxBody1.body.I_31), cat2(boxBody1.body.I_21, boxBody1.body.I_22, boxBody1.body.I_32), cat2(boxBody1.body.I_31, boxBody1.body.I_32, boxBody1.body.I_33))`; effective min: `None`; effective max: `None`. 
