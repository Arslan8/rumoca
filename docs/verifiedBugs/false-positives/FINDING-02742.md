# FINDING-02742: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | idealCommutingSwitch.idealCommutingSwitch[3].Ron |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-imc-transformer-idealcommutingswitch-idealcommutingswitch-3-ron-ruleof-2.md](../../v2/bugs/FINDING-imc-transformer-idealcommutingswitch-idealcommutingswitch-3-ron-ruleof-2.md) — reviewed as `FINDING-02742-imc-transformer-idealcommutingswitch-idealcommutingswitch-3-ron.md`, which a later run renamed |
| Original SHA-256 | acc0fabe8ab5c442e140caca65f1c47c241d89a252db859daa6d8ac44327ec4a |
...
Compiler/source-resolved declaration: `Electrical/Analog/Ideal/IdealTwoWaySwitch.mo:3`. Role: `parameter`; binding: `idealCommutingSwitch.Ron[3]`; effective min: `0`; effective max: `None`. 
