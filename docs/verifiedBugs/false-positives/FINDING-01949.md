# FINDING-01949: Arc-switch resistance/conductance are multiplicative ideal limits
...
| Target | switchYDwithArc.idealCloser.closerWithArc[1].Ron |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-imc-ydarc-switchydwitharc-idealcloser-closerwitharc-1-ron-zerolimit.md](../../v2/bugs/FINDING-imc-ydarc-switchydwitharc-idealcloser-closerwitharc-1-ron-zerolimit.md) — reviewed as `FINDING-01949-imc-ydarc-switchydwitharc-idealcloser-closerwitharc-1-ron.md`, which a later run renamed |
| Original SHA-256 | 2a5d1e973a270516cfe4c0e0b1126ecca674219aaba86c04fe40c71a00d4781a |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSwitchWithArc.mo:4`. Role: `parameter`; binding: `switchYDwithArc.idealCloser.Ron[1]`; effective min: `None`; effective max: `None`. 
