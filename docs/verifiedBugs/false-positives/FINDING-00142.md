# FINDING-00142: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | R10.IdealCommutingSwitch2.Ron |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-cauerlowpasssc-r10-idealcommutingswitch2-ron-ruleoff.md](../../v2/bugs/FINDING-cauerlowpasssc-r10-idealcommutingswitch2-ron-ruleoff.md) — reviewed as `FINDING-00142-cauerlowpasssc-r10-idealcommutingswitch2-ron.md`, which a later run renamed |
| Original SHA-256 | 41bfa821a3639fadffdede857c1e9ec17a6fa0620e3558c1944b785abead3f91 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Ideal/IdealTwoWaySwitch.mo:3`. Role: `parameter`; binding: `1e-05`; effective min: `0`; effective max: `None`. 
