# FINDING-04347: MultiBody Newton/Euler equations use mass and inertia multiplicatively
...
| Original report | `FINDING-04347-mechanicalstructure-b6-body-i-11.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 3d0a87cfcaec8182a28d005661e38b46a51bea4ce5556946617740a34933f4d0 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:17`. Role: `parameter`; binding: `b6.I_11`; effective min: `0`; effective max: `None`. 
