# FINDING-01553: Machine inertia delegates to the zero-capable algebraic inertia component
...
| Original report | [FINDING-imc-dcbraking-imc-js-zerolimit.md](../../v2/bugs/FINDING-imc-dcbraking-imc-js-zerolimit.md) — reviewed as `FINDING-01553-imc-dcbraking-imc-js.md`, which a later run renamed |
| Original SHA-256 | 39e718540da7a1e2eba95664c81ab1b74cde41494c8696848af9406625dd5b75 |
...
Compiler/source-resolved declaration: `Electrical/Machines/Interfaces/PartialBasicMachine.mo:8`. Role: `parameter`; binding: `imcData.Js`; effective min: `None`; effective max: `None`. 
