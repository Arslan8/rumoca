# FINDING-02974: Polyphase inductance delegates to zero-capable scalar inductors
...
| Target | transformerL.L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-transformeryd-transformerl-l-zerolimit.md](../../v2/bugs/FINDING-transformeryd-transformerl-l-zerolimit.md) — reviewed as `FINDING-02974-transformeryd-transformerl-l.md`, which a later run renamed |
| Original SHA-256 | d1d18feb90167113e93a07f0222649d68944e316cb5719ee653d560a4dd36547 |
...
Compiler/source-resolved declaration: `Electrical/Polyphase/Basic/Inductor.mo:4`. Role: `parameter`; binding: `fill((LT / (nT ^ 2)), m)`; effective min: `None`; effective max: `None`. 
