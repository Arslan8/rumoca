# FINDING-02769: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | diode1.idealDiode[2].Ron |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-rectifier12pulse-diode1-idealdiode-2-ron-ruleoff.md](../../v2/bugs/FINDING-rectifier12pulse-diode1-idealdiode-2-ron-ruleoff.md) — reviewed as `FINDING-02769-rectifier12pulse-diode1-idealdiode-2-ron.md`, which a later run renamed |
| Original SHA-256 | fa34ac48090fe51ed4eb373567328eff8bbc675d437cd7dd1fe8fe6100f413bc |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:4`. Role: `parameter`; binding: `diode1.Ron[2]`; effective min: `0`; effective max: `None`. 
