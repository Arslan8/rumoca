# FINDING-03462: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | rectifier.diode.idealDiode[3].Goff |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-diodecentertapmpulse-rectifier-diode-idealdiode-3-goff-zerolimit.md](../../v2/bugs/FINDING-diodecentertapmpulse-rectifier-diode-idealdiode-3-goff-zerolimit.md) — reviewed as `FINDING-03462-diodecentertapmpulse-rectifier-diode-idealdiode-3-goff.md`, which a later run renamed |
| Original SHA-256 | ac742240bb8bf195aa88061d368376bdf980fbdda08d0f6f05f7c4092629a4b5 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:6`. Role: `parameter`; binding: `rectifier.diode.Goff[3]`; effective min: `0`; effective max: `None`. 
