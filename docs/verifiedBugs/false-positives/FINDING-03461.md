# FINDING-03461: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | rectifier.diode.idealDiode[3].Ron |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-diodecentertapmpulse-rectifier-diode-idealdiode-3-ron-ruleoff.md](../../v2/bugs/FINDING-diodecentertapmpulse-rectifier-diode-idealdiode-3-ron-ruleoff.md) — reviewed as `FINDING-03461-diodecentertapmpulse-rectifier-diode-idealdiode-3-ron.md`, which a later run renamed |
| Original SHA-256 | 86276d0535073ac27862f7483ce3ec59e1bddad0c141f70c294e8a9fbf6b4aac |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:4`. Role: `parameter`; binding: `rectifier.diode.Ron[3]`; effective min: `0`; effective max: `None`. 
