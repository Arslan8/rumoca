# FINDING-02795: Zero inductance is an explicitly supported algebraic limit
...
| Target | transformer1.l1sigma.inductor[1].L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-rectifier12pulse-transformer1-l1sigma-inductor-1-l-zerolimit.md](../../v2/bugs/FINDING-rectifier12pulse-transformer1-l1sigma-inductor-1-l-zerolimit.md) — reviewed as `FINDING-02795-rectifier12pulse-transformer1-l1sigma-inductor-1-l.md`, which a later run renamed |
| Original SHA-256 | bbc516cb33f2ce5f3a38a16dc5583062ea27060d834c481ffdb4b0a4c52bc541 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `transformer1.l1sigma.L[1]`; effective min: `None`; effective max: `None`. 
