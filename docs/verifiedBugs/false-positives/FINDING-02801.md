# FINDING-02801: Zero inductance is an explicitly supported algebraic limit
...
| Target | transformer1.l2sigma.inductor[2].L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-rectifier12pulse-transformer1-l2sigma-inductor-2-l-zerolimit.md](../../v2/bugs/FINDING-rectifier12pulse-transformer1-l2sigma-inductor-2-l-zerolimit.md) — reviewed as `FINDING-02801-rectifier12pulse-transformer1-l2sigma-inductor-2-l.md`, which a later run renamed |
| Original SHA-256 | 32e1746285e65ea1fcdb0812328c5eb1a6541442025ad0de94fb133b207c690d |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `transformer1.l2sigma.L[2]`; effective min: `None`; effective max: `None`. 
