# FINDING-01712: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | inverter.diode_n.idealDiode[1].Goff |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-imc-inverterdrive-inverter-diode-n-idealdiode-1-goff-zerolimit.md](../../v2/bugs/FINDING-imc-inverterdrive-inverter-diode-n-idealdiode-1-goff-zerolimit.md) — reviewed as `FINDING-01712-imc-inverterdrive-inverter-diode-n-idealdiode-1-goff.md`, which a later run renamed |
| Original SHA-256 | 63008949dc37fa0cd9aa84c8692a62f01b2055ffd15d429fa37248a6f0d562e1 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:6`. Role: `parameter`; binding: `inverter.diode_n.Goff[1]`; effective min: `0`; effective max: `None`. 
