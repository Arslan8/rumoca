# FINDING-00106: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | R1.IdealCommutingSwitch1.Goff |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-cauerlowpasssc-r1-idealcommutingswitch1-goff-ruleoff.md](../../v2/bugs/FINDING-cauerlowpasssc-r1-idealcommutingswitch1-goff-ruleoff.md) — reviewed as `FINDING-00106-cauerlowpasssc-r1-idealcommutingswitch1-goff.md`, which a later run renamed |
| Original SHA-256 | 2a51240c48720b736a32dc9ca18e79e167b11862210f98ab49841d7522832882 |
