# FINDING-02715: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | idealCloser.idealClosingSwitch[3].Goff |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-imc-transformer-idealcloser-idealclosingswitch-3-goff-ruleoff-2.md](../../v2/bugs/FINDING-imc-transformer-idealcloser-idealclosingswitch-3-goff-ruleoff-2.md) — reviewed as `FINDING-02715-imc-transformer-idealcloser-idealclosingswitch-3-goff.md`, which a later run renamed |
| Original SHA-256 | 5b11e0e963567f32fbd4447b479371bc4e3b61df82c3c89191171de421181150 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSwitch.mo:6`. Role: `parameter`; binding: `idealCloser.Goff[3]`; effective min: `0`; effective max: `None`. 
