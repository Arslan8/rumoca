# FINDING-02775: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | diode2.idealDiode[1].Ron |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-rectifier12pulse-diode2-idealdiode-1-ron-ruleoff.md](../../v2/bugs/FINDING-rectifier12pulse-diode2-idealdiode-1-ron-ruleoff.md) — reviewed as `FINDING-02775-rectifier12pulse-diode2-idealdiode-1-ron.md`, which a later run renamed |
| Original SHA-256 | 0101a499a4b7f795a2b25b2d79eaeb91ece92545e07dfea4199034f576f65c16 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:4`. Role: `parameter`; binding: `diode2.Ron[1]`; effective min: `0`; effective max: `None`. 
