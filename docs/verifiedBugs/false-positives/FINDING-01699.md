# FINDING-01699: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | inverter.diode_p.idealDiode[3].Ron |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-imc-inverterdrive-inverter-diode-p-idealdiode-3-ron-ruleoff.md](../../v2/bugs/FINDING-imc-inverterdrive-inverter-diode-p-idealdiode-3-ron-ruleoff.md) — reviewed as `FINDING-01699-imc-inverterdrive-inverter-diode-p-idealdiode-3-ron.md`, which a later run renamed |
| Original SHA-256 | 7991dce6159d7d5bfa8b5d6f18ed17e6b54554d0374a18f577cf6328c6855aee |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:4`. Role: `parameter`; binding: `inverter.diode_p.Ron[3]`; effective min: `0`; effective max: `None`. 
