# FINDING-02066: Air-gap inductance is used as a flux multiplier
...
| Target | aims.airGap.Lm |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-ims-start-aims-airgap-lm-zerolimit.md](../../v2/bugs/FINDING-ims-start-aims-airgap-lm-zerolimit.md) — reviewed as `FINDING-02066-ims-start-aims-airgap-lm.md`, which a later run renamed |
| Original SHA-256 | 936ae4d83c370dcc947c2072dfaab7269193bca9cf80bff505b4582db35fa56f |
...
Compiler/source-resolved declaration: `Electrical/Machines/BasicMachines/Components/AirGapS.mo:3`. Role: `parameter`; binding: `aimsData.Lm`; effective min: `None`; effective max: `None`. 
