# FINDING-02030: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | switchYD.idealOpener.idealOpeningSwitch[3].Ron |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-imc-yd-switchyd-idealopener-idealopeningswitch-3-ron-ruleoff.md](../../v2/bugs/FINDING-imc-yd-switchyd-idealopener-idealopeningswitch-3-ron-ruleoff.md) — reviewed as `FINDING-02030-imc-yd-switchyd-idealopener-idealopeningswitch-3-ron.md`, which a later run renamed |
| Original SHA-256 | d4453b89d8013c8af50b2f191d33049d7e9d157dee397fd6964c9e42d62fa45f |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSwitch.mo:4`. Role: `parameter`; binding: `switchYD.idealOpener.Ron[3]`; effective min: `0`; effective max: `None`. 
