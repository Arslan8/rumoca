# FINDING-04892: Zero leakage inductance is a supported ideal limit
...
| Target | smpmData.Lssigma |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-smpm-voltagesourcewithlosses-smpmdata-lssigma-intent.md](../../v2/bugs/FINDING-smpm-voltagesourcewithlosses-smpmdata-lssigma-intent.md) — reviewed as `FINDING-04892-smpm-voltagesourcewithlosses-smpmdata-lssigma.md`, which a later run renamed |
| Original SHA-256 | 645e56387629ae990fbed69a420fd328c4ff62d93f66996c0db13ed1f73871c3 |
...
Compiler/source-resolved declaration: `Electrical/Machines/Utilities/ParameterRecords/InductionMachineData.mo:23`. Role: `parameter`; binding: `(0.1 / ((2 * (2 * asin(1.0))) * smpmData.fsNominal))`; effective min: `None`; effective max: `None`. 
