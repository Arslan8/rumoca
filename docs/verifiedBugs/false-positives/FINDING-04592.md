# FINDING-04592: Zero stored fluid mass is explicitly supported
...
| Original report | [FINDING-parallelpumpdropout-pipe3-m-zerolimit.md](../../v2/bugs/FINDING-parallelpumpdropout-pipe3-m-zerolimit.md) — reviewed as `FINDING-04592-parallelpumpdropout-pipe3-m.md`, which a later run renamed |
| Original SHA-256 | cbf6507038359f84f2759f775f9e21dd9e69b2a201eea3e6b3301619a67372b9 |
...
| Probe | Outcome |
|---|---|
| `pipe3.m=0` | reported-failure |

Diagnostic: solve-IR evaluation failed: non-finite derivative evaluation for state 'dTCoolant1'
