# FINDING-04191: MultiBody Newton/Euler equations use mass and inertia multiplicatively
...
| Target | body2.body.I_22 |
| Student classification | physical-bound-permits-zero |
| Original report | `FINDING-04191-planarfourbar-body2-body-i-22.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | be118cda3e47db346fdd91da14f802c53ccf259b11e8fc4cd7baf98b14007df5 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:19`. Role: `parameter`; binding: `body2.I[2, 2]`; effective min: `0`; effective max: `None`. 
