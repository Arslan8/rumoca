# FINDING-03319: Zero on-resistance/off-conductance is an intended ideal limit
...
| Original report | [FINDING-diodecentertap2mpulse-rectifier-diode-n-ron-ruleoff.md](../../v2/bugs/FINDING-diodecentertap2mpulse-rectifier-diode-n-ron-ruleoff.md) — reviewed as `FINDING-03319-diodecentertap2mpulse-rectifier-diode-n-ron.md`, which a later run renamed |
| Original SHA-256 | 2d4eb92c24a8199b3961edfc8ca1736daca9342a38b6dd9ce348c8cf2e08f49e |
