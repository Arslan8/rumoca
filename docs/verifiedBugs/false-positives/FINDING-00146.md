# FINDING-00146: Zero capacitance is an explicitly supported algebraic limit
...
| Target | R11.Capacitor.C |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-cauerlowpasssc-r11-capacitor-c-zerolimit.md](../../v2/bugs/FINDING-cauerlowpasssc-r11-capacitor-c-zerolimit.md) — reviewed as `FINDING-00146-cauerlowpasssc-r11-capacitor-c.md`, which a later run renamed |
| Original SHA-256 | 98ac2edfb703ea47645fcbdd46b0eb8967f63fb55fd746a9b7bebeefd3f44db0 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Capacitor.mo:4`. Role: `parameter`; binding: `(R11.clock / max((2.220446049250313e-16 * R11.oneOhm), abs(R11.R)))`; effective min: `0`; effective max: `None`. 
