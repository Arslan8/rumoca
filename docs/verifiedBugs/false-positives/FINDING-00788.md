# FINDING-00788: Zero capacitance is an explicitly supported algebraic limit
...
| Original report | [FINDING-controlcircuit-pia-c-c-zerolimit.md](../../v2/bugs/FINDING-controlcircuit-pia-c-c-zerolimit.md) — reviewed as `FINDING-00788-controlcircuit-pia-c-c.md`, which a later run renamed |
| Original SHA-256 | ad2a1c73a18182586142cabcd3c4cc3c8a7982399ee0448f141e0ab603b8711c |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Capacitor.mo:4`. Role: `parameter`; binding: `PIA.C`; effective min: `0`; effective max: `None`. 
