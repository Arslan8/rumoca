# FINDING-04206: Tensor entries are not all strictly positive scalars
...
| Target | body3.body.I_21 |
| Student classification | physical-domain-unenforced |
| Original report | `FINDING-04206-planarfourbar-body3-body-i-21.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 7c8d7bf0f02dad39bfede56c69854ee3ae5beed0e3e4af0bd4c6671c9ca4e884 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:23`. Role: `parameter`; binding: `body3.I[2, 1]`; effective min: `-1.7976931348623157e+308`; effective max: `None`. 
