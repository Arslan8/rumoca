# FINDING-02196: Zero inductance is an explicitly supported algebraic limit
...
| Target | smee.lszero.L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-smee-generator-smee-lszero-l-zerolimit.md](../../v2/bugs/FINDING-smee-generator-smee-lszero-l-zerolimit.md) — reviewed as `FINDING-02196-smee-generator-smee-lszero-l.md`, which a later run renamed |
| Original SHA-256 | fd8dbf168b13f64e13742d41e8273188c8782bbff0aec62a44651f901ae6c08e |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `smee.Lszero`; effective min: `None`; effective max: `None`. 
