# FINDING-00196: Zero inductance is an explicitly supported algebraic limit
...
| Original report | [FINDING-comparetransformers-inductor21-l-zerolimit.md](../../v2/bugs/FINDING-comparetransformers-inductor21-l-zerolimit.md) — reviewed as `FINDING-00196-comparetransformers-inductor21-l.md`, which a later run renamed |
| Original SHA-256 | bba0f0febd4627d37844990224e55aba159cad96af80d0d6b0bcf4da51cbd2a0 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `L1sigma`; effective min: `None`; effective max: `None`. 
