# FINDING-05098: vRef is a protected nonzero constant
...
| Target | vehicleDrag.vRef |
| Student classification | divisor-reachable-zero |
| Original report | `FINDING-05098-vehicles-vehicledrag-vref.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | af46c985dccc5426f6cc0042b5014137360931558442de796ebcbb142029435f |
