# FINDING-04272: MultiBody Newton/Euler equations use mass and inertia multiplicatively
...
| Original report | `FINDING-04272-mechanicalstructure-b1-body-i-11.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 9803a5a5b9f915c20d9188d42154e3740dbbf7d3bfb18a6e71de2f4b931e4adc |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:17`. Role: `parameter`; binding: `b1.I_11`; effective min: `0`; effective max: `None`. 
