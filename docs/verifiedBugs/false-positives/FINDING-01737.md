# FINDING-01737: Zero/signed machine resistance is an ideal electrical limit
...
| Original report | [FINDING-imc-inverterdrive-aimcdata-rs-unbounded.md](../../v2/bugs/FINDING-imc-inverterdrive-aimcdata-rs-unbounded.md) — reviewed as `FINDING-01737-imc-inverterdrive-aimcdata-rs.md`, which a later run renamed |
| Original SHA-256 | aaef564b38159aef1fc121142de14c64399efb9aeee9730643c40301df7c200b |
...
Compiler/source-resolved declaration: `Electrical/Machines/Utilities/ParameterRecords/InductionMachineData.mo:10`. Role: `parameter`; binding: `(0.03 * 16)`; effective min: `None`; effective max: `None`. 
