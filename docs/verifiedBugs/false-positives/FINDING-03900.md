# FINDING-03900: MultiBody Newton/Euler equations use mass and inertia multiplicatively
...
| Target | boxBody1.body.I_22 |
| Student classification | physical-bound-permits-zero |
| Original report | `FINDING-03900-doublependuluminittip-boxbody1-body-i-22.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 11c7b66467322f1f3684d0c832efc3e6d97d15c5609d86185ca3d7cae50807b1 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:19`. Role: `parameter`; binding: `boxBody1.I[2, 2]`; effective min: `0`; effective max: `None`. 
