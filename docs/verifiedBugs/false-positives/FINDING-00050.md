# FINDING-00050: Zero capacitance is an explicitly supported algebraic limit
...
| Original report | [FINDING-cauerlowpassopv-c3-c-zerolimit.md](../../v2/bugs/FINDING-cauerlowpassopv-c3-c-zerolimit.md) — reviewed as `FINDING-00050-cauerlowpassopv-c3-c.md`, which a later run renamed |
| Original SHA-256 | ac34e6c3e97b696586f1387139203d0fdfe3a386948b67c124022c43f1477010 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Capacitor.mo:4`. Role: `parameter`; binding: `l1`; effective min: `0`; effective max: `None`. 
