# FINDING-01163: Zero inertia is a massless algebraic component, not an intrinsic division
...
| Target | loadInertia2.J |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-dc-comparecharacteristics-loadinertia2-j-zerolimit.md](../../v2/bugs/FINDING-dc-comparecharacteristics-loadinertia2-j-zerolimit.md) — reviewed as `FINDING-01163-dc-comparecharacteristics-loadinertia2-j.md`, which a later run renamed |
| Original SHA-256 | aec1e21ae0ec0fef4ec3247b7abbcdaa5a2ff9ab486894d63cae87378e2902bf |
