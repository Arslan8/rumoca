# FINDING-04104: Tensor entries are not all strictly positive scalars
...
| Target | referenceSystem.pointMass5.I |
| Student classification | physical-domain-unenforced |
| Original report | `FINDING-04104-pointgravitywithpointmasses2-referencesystem-pointmass5-i.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 0b9d7e2766eafe72e52c0d279bbe7853e4d40efd14ce198fcc5826d2877e20a4 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:114`. Role: `parameter`; binding: `cat1(cat2(referenceSystem.pointMass5.I_11, referenceSystem.pointMass5.I_21, referenceSystem.pointMass5.I_31), cat2(referenceSystem.pointMass5.I_21, referenceSystem.pointMass5.I_22, referenceSystem.pointMass5.I_32), cat2(referenceSystem.pointMass5.I_31, referenceSystem.pointMass5.I_32, referenceSystem.pointMass5.I_33))`; effective min: `None`; effective max: `None`. 
