# FINDING-00559: Zero inductance is an explicitly supported algebraic limit
...
| Target | oLine50.L[33].L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-smoothstep-oline50-l-33-l-zerolimit.md](../../v2/bugs/FINDING-smoothstep-oline50-l-33-l-zerolimit.md) — reviewed as `FINDING-00559-smoothstep-oline50-l-33-l.md`, which a later run renamed |
| Original SHA-256 | 29cf1be5f6e93c84233a50e7e29087695da6d8d3b6bab0896e189f34829c8206 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `oLine50.lm[33]`; effective min: `None`; effective max: `None`. 
