# FINDING-01541: Zero leakage inductance is a supported ideal limit
...
| Target | imcData.Lssigma |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-imc-dcbraking-imcdata-lssigma-intent.md](../../v2/bugs/FINDING-imc-dcbraking-imcdata-lssigma-intent.md) — reviewed as `FINDING-01541-imc-dcbraking-imcdata-lssigma.md`, which a later run renamed |
| Original SHA-256 | 68ebcd94c9cabdd1e83c085a45934f5ac9baf3ad06c234bfce578010b1691cf7 |
...
Compiler/source-resolved declaration: `Electrical/Machines/Utilities/ParameterRecords/InductionMachineData.mo:23`. Role: `parameter`; binding: `((3 * (1 - sqrt((1 - 0.0667)))) / ((2 * (2 * asin(1.0))) * imcData.fsNominal))`; effective min: `None`; effective max: `None`. 
