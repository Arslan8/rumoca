# FINDING-02194: Polyphase resistance/conductance delegates to signed scalar elements
...
| Original report | `FINDING-02194-smee-generator-smee-rs-r.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 8a910019333fadce24d87e39063b5f8a8e0630a72443e194e8e85511a328dcee |
...
Compiler/source-resolved declaration: `Electrical/Polyphase/Basic/Resistor.mo:4`. Role: `parameter`; binding: `fill(smee.Rs, smee.m)`; effective min: `None`; effective max: `None`. 
