# FINDING-03671: Zero on-resistance/off-conductance is an intended ideal limit
...
| Original report | [FINDING-hbridge-r-hbridge-inverter-n-transistor-p-goff-zerolimit.md](../../v2/bugs/FINDING-hbridge-r-hbridge-inverter-n-transistor-p-goff-zerolimit.md) — reviewed as `FINDING-03671-hbridge-r-hbridge-inverter-n-transistor-p-goff.md`, which a later run renamed |
| Original SHA-256 | bb62ba64294b35b96d44d52111db8c217e4507d81c53de53942bc5c345de655e |
