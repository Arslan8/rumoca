# FINDING-00008: A zero-duration ramp is a supported step
...
| Original report | [FINDING-exactlyclockedwithdiscretecontroller-ramp-duration-divunreach.md](../../v2/bugs/FINDING-exactlyclockedwithdiscretecontroller-ramp-duration-divunreach.md) — reviewed as `FINDING-00008-exactlyclockedwithdiscretecontroller-ramp-duration.md`, which a later run renamed |
| Original SHA-256 | dbf2d9882141ce41df08ac6f9e3f0f2b8d36d58354dc37eaaa5da322aaf5312b |
...
[Rumoca commands, return codes, integrity hashes, bounded output and metadata](../evidence/44b68a1b4a755462.json). Baseline: **tool-error**.
