# FINDING-04148: MultiBody spring mass/stiffness has an intentional zero limit
...
| Original report | [FINDING-threesprings-spring1-m-zerolimit.md](../../v2/bugs/FINDING-threesprings-spring1-m-zerolimit.md) — reviewed as `FINDING-04148-threesprings-spring1-m.md`, which a later run renamed |
| Original SHA-256 | dc7726429e623203aafb283cd334fcb6cd26fa3a96af0220e05e37ea185b707e |

## Why this is a false positive

m(min=0)=0 is the default optional point mass and is forwarded to LineForceWithMass. The reported blanket positive-only constraint is inconsistent with these explicit component branches/equations.

## Source evidence

Compiler/source-resolved declaration: `Mechanics/MultiBody/Forces/Spring.mo:11`. Role: `parameter`; binding: `0`; effective min: `0`; effective max: `None`. 
...
[Rumoca commands, return codes, integrity hashes, bounded output and metadata](../evidence/b85eccc940a7a626.json). Baseline: **tool-error**.
