# FINDING-04278: Tensor entries are not all strictly positive scalars
...
| Original report | `FINDING-04278-mechanicalstructure-b1-body-i.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | bfc6d78f60c02ea4c32c16f8a2ba079d9cbcc8792c2e585deaa068c21b77033b |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:114`. Role: `parameter`; binding: `cat1(cat2(b1.body.I_11, b1.body.I_21, b1.body.I_31), cat2(b1.body.I_21, b1.body.I_22, b1.body.I_32), cat2(b1.body.I_31, b1.body.I_32, b1.body.I_33))`; effective min: `None`; effective max: `None`. 
