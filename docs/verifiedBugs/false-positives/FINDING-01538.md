# FINDING-01538: Machine-data inertia is not intrinsically a positive divisor
...
| Original report | [FINDING-imc-dcbraking-imcdata-js-intent.md](../../v2/bugs/FINDING-imc-dcbraking-imcdata-js-intent.md) — reviewed as `FINDING-01538-imc-dcbraking-imcdata-js.md`, which a later run renamed |
| Original SHA-256 | 0951958787506cb41b54c56aa84a31490b640d5e09ce19f3de99c73822f77234 |
...
Compiler/source-resolved declaration: `Electrical/Machines/Utilities/ParameterRecords/InductionMachineData.mo:7`. Role: `parameter`; binding: `imcData.Jr`; effective min: `None`; effective max: `None`. 
