# FINDING-04239: MultiBody Newton/Euler equations use mass and inertia multiplicatively
...
| Target | bodyBox.body.I_11 |
| Student classification | physical-bound-permits-zero |
| Original report | `FINDING-04239-bevelgear1d-bodybox-body-i-11.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | eb9e31048f4e60a7649ccbe35689f84c1318da7bea7ed9a7aacc4a71a483c14b |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:17`. Role: `parameter`; binding: `bodyBox.I[1, 1]`; effective min: `0`; effective max: `None`. 
