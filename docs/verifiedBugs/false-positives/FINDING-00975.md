# FINDING-00975: Zero thermal conductance is an insulating limit
...
| Original report | [FINDING-resistor-thermalconductor-g-zerolimit.md](../../v2/bugs/FINDING-resistor-thermalconductor-g-zerolimit.md) — reviewed as `FINDING-00975-resistor-thermalconductor-g.md`, which a later run renamed |
| Original SHA-256 | 4cef741eb26549e8617621ad03dedd6bce9961f2c904a728a2ee6ac12fc0c7d3 |
...
Compiler/source-resolved declaration: `Thermal/HeatTransfer/Components/ThermalConductor.mo:5`. Role: `parameter`; binding: `50`; effective min: `None`; effective max: `None`. 
...
[Rumoca commands, return codes, integrity hashes, bounded output and metadata](../evidence/e9db0b0c92b7a282.json). Baseline: **tool-error**.
