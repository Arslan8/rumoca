# FINDING-02051: Zero core-loss conductance deliberately disables losses
...
| Target | aimsData.statorCoreParameters.GcRef |
| Student classification | physical-invariant-violated |
| Original report | [FINDING-ims-start-aimsdata-statorcoreparameters-gcref-zerolimit.md](../../v2/bugs/FINDING-ims-start-aimsdata-statorcoreparameters-gcref-zerolimit.md) — reviewed as `FINDING-02051-ims-start-aimsdata-statorcoreparameters-gcref.md`, which a later run renamed |
| Original SHA-256 | 507d0f503aeb0dd8b2cd8be200a3540f44d4c009f0b199649f4c7e7e675a30f8 |
