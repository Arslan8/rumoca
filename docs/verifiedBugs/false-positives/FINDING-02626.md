# FINDING-02626: Air-gap inductance is used as a flux multiplier
...
| Target | smr.airGap.Lmd |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-smr-inverter-smr-airgap-lmd-zerolimit.md](../../v2/bugs/FINDING-smr-inverter-smr-airgap-lmd-zerolimit.md) — reviewed as `FINDING-02626-smr-inverter-smr-airgap-lmd.md`, which a later run renamed |
| Original SHA-256 | ec8569d267e82bf59bb48f0556556164d9381267da15a6aea91b57290c1df762 |
...
Compiler/source-resolved declaration: `Electrical/Machines/BasicMachines/Components/AirGapR.mo:3`. Role: `parameter`; binding: `smrData.Lmd`; effective min: `None`; effective max: `None`. 
