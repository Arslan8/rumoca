# FINDING-03903: Tensor entries are not all strictly positive scalars
...
| Target | boxBody1.body.I_31 |
| Student classification | physical-domain-unenforced |
| Original report | `FINDING-03903-doublependuluminittip-boxbody1-body-i-31.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 7eab6fdae29b7b8ee083bb225beebba1ce2210e3fc32b4f4bf1b8c91e75555f9 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:25`. Role: `parameter`; binding: `boxBody1.I[3, 1]`; effective min: `-1.7976931348623157e+308`; effective max: `None`. 
