# FINDING-04193: Tensor entries are not all strictly positive scalars
...
| Target | body2.body.I_21 |
| Student classification | physical-domain-unenforced |
| Original report | `FINDING-04193-planarfourbar-body2-body-i-21.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | cc13815babb7ee1282f5eb5744281c413fc64fd436248f1b500dea4e999fa959 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:23`. Role: `parameter`; binding: `body2.I[2, 1]`; effective min: `-1.7976931348623157e+308`; effective max: `None`. 
