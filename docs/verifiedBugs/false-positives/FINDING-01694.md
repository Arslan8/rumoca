# FINDING-01694: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | inverter.diode_p.Goff |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-imc-inverterdrive-inverter-diode-p-goff-ruleoff.md](../../v2/bugs/FINDING-imc-inverterdrive-inverter-diode-p-goff-ruleoff.md) — reviewed as `FINDING-01694-imc-inverterdrive-inverter-diode-p-goff.md`, which a later run renamed |
| Original SHA-256 | e3b8e5bae00eda4930c5256fdae8ae76069dffdc3776c8b371026cfdb58a1946 |
...
Compiler/source-resolved declaration: `Electrical/Polyphase/Ideal/IdealDiode.mo:6`. Role: `parameter`; binding: `fill(inverter.GoffDiode, inverter.m)`; effective min: `zeros(3)`; effective max: `None`. 
