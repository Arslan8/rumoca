# FINDING-01156: Zero armature resistance is an ideal algebraic limit
...
| Original report | [FINDING-dc-comparecharacteristics-dcee-ra-unbounded.md](../../v2/bugs/FINDING-dc-comparecharacteristics-dcee-ra-unbounded.md) — reviewed as `FINDING-01156-dc-comparecharacteristics-dcee-ra.md`, which a later run renamed |
| Original SHA-256 | 4e15b8d933a6fc16b8434d1d48be201616fc7f479091ae70890c81f56b9f3fe2 |
...
Compiler/source-resolved declaration: `Electrical/Machines/Interfaces/PartialBasicDCMachine.mo:17`. Role: `parameter`; binding: `dceeData.Ra`; effective min: `None`; effective max: `None`. 
