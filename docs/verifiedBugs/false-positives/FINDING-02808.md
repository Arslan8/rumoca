# FINDING-02808: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | diode3.idealDiode[2].Goff |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-rectifier12pulse-diode3-idealdiode-2-goff-zerolimit.md](../../v2/bugs/FINDING-rectifier12pulse-diode3-idealdiode-2-goff-zerolimit.md) — reviewed as `FINDING-02808-rectifier12pulse-diode3-idealdiode-2-goff.md`, which a later run renamed |
| Original SHA-256 | 93acb80a95dee6a364f347b1f027d2b63fda3f7f62f7a67e72c7b73d7bfe1200 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:6`. Role: `parameter`; binding: `diode3.Goff[2]`; effective min: `0`; effective max: `None`. 
