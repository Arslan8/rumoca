# FINDING-01456: Zero core-loss conductance deliberately disables losses
...
| Target | dcpmData2.coreParameters.GcRef |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-dcpm-withlosses-dcpmdata2-coreparameters-gcref-zerolimit.md](../../v2/bugs/FINDING-dcpm-withlosses-dcpmdata2-coreparameters-gcref-zerolimit.md) — reviewed as `FINDING-01456-dcpm-withlosses-dcpmdata2-coreparameters-gcref.md`, which a later run renamed |
| Original SHA-256 | 1ea62f6b02caf44653e7270a1567956409b6eb04a8729cbcb8be12403956437e |
...
Compiler/source-resolved declaration: `Electrical/Machines/Losses/CoreParameters.mo:18`. Role: `parameter`; binding: `(if (dcpmData2.coreParameters.PRef <= 0) then 0 else ((dcpmData2.coreParameters.PRef / (dcpmData2.coreParameters.VRef ^ 2)) / dcpmData2.coreParameters.m))`; effective min: `None`; effective max: `None`. 
