# FINDING-03521: Zero on-resistance/off-conductance is an intended ideal limit
...
| Original report | [FINDING-singlephasetwolevel-rl-inverter-diode-p-goff-zerolimit.md](../../v2/bugs/FINDING-singlephasetwolevel-rl-inverter-diode-p-goff-zerolimit.md) — reviewed as `FINDING-03521-singlephasetwolevel-rl-inverter-diode-p-goff.md`, which a later run renamed |
| Original SHA-256 | 894fae16a8180d3b3d4af85895d6998b500656f57adc9972da515bdb94cb46f0 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:6`. Role: `parameter`; binding: `inverter.GoffDiode`; effective min: `0`; effective max: `None`. 
