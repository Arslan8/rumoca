# FINDING-04365: Tensor entries are not all strictly positive scalars
...
| Target | load.body.I_21 |
| Student classification | physical-domain-unenforced |
| Original report | `FINDING-04365-mechanicalstructure-load-body-i-21.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 5d0deef9f802e5414cec97248111eeabbe0ee0eb192b794c6f56aae04e462097 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:23`. Role: `parameter`; binding: `load.I_21`; effective min: `-1.7976931348623157e+308`; effective max: `None`. 
