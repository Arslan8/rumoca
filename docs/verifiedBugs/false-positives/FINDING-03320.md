# FINDING-03320: Zero on-resistance/off-conductance is an intended ideal limit
...
| Original report | [FINDING-diodecentertap2mpulse-rectifier-diode-n-goff-ruleoff.md](../../v2/bugs/FINDING-diodecentertap2mpulse-rectifier-diode-n-goff-ruleoff.md) — reviewed as `FINDING-03320-diodecentertap2mpulse-rectifier-diode-n-goff.md`, which a later run renamed |
| Original SHA-256 | 153b5332d8fdd0b2fba1a01f21ec51909e8963ccd5f562e6247f628de53c5cfe |
