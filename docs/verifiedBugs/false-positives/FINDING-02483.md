# FINDING-02483: Polyphase resistance/conductance delegates to signed scalar elements
...
| Original report | `FINDING-02483-smpm-resistivebraking-resistor2-r.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 4a56c58f00eb5bded0901c197460f5a7a8ab6943d00f253f4a87c31afefbd064 |
...
Compiler/source-resolved declaration: `Electrical/Polyphase/Basic/Resistor.mo:4`. Role: `parameter`; binding: `(k[2] * fill(smpmData.Rs, m))`; effective min: `None`; effective max: `None`. 
