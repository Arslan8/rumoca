# FINDING-02623: Machine inertia delegates to the zero-capable algebraic inertia component
...
| Original report | [FINDING-smr-inverter-smr-js-zerolimit.md](../../v2/bugs/FINDING-smr-inverter-smr-js-zerolimit.md) — reviewed as `FINDING-02623-smr-inverter-smr-js.md`, which a later run renamed |
| Original SHA-256 | 436c34bf2c31626ecaca7122338eb89de7e3b63d0a3e515fae553da185308076 |
...
Compiler/source-resolved declaration: `Electrical/Machines/Interfaces/PartialBasicMachine.mo:8`. Role: `parameter`; binding: `smrData.Js`; effective min: `None`; effective max: `None`. 
