# FINDING-04379: Zero inertia is a massless algebraic component, not an intrinsic division
...
| Original report | [FINDING-comparebrakingtorque-inertia4-j-zerolimit.md](../../v2/bugs/FINDING-comparebrakingtorque-inertia4-j-zerolimit.md) — reviewed as `FINDING-04379-comparebrakingtorque-inertia4-j.md`, which a later run renamed |
| Original SHA-256 | bb3321b239f679b598fc91b4d345a2a1972c2f4b3d9d4fda28336d21f832dbbf |
...
| Probe | Outcome |
|---|---|
| `inertia4.J=0` | reported-failure |

Diagnostic: solve-IR evaluation failed: algebraic projection did not converge at event boundary: worst scaled residual row=34 target=inertia4.a value=1.000000e2 ratio=1.000000e12 norm=1.000000e2 row_scale=1.000000e0 scaled_tolerance=1.000000e-10
