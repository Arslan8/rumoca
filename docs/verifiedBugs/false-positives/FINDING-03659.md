# FINDING-03659: Zero on-resistance/off-conductance is an intended ideal limit
...
| Original report | [FINDING-hbridge-r-hbridge-inverter-p-transistor-p-goff-zerolimit.md](../../v2/bugs/FINDING-hbridge-r-hbridge-inverter-p-transistor-p-goff-zerolimit.md) — reviewed as `FINDING-03659-hbridge-r-hbridge-inverter-p-transistor-p-goff.md`, which a later run renamed |
| Original SHA-256 | af2cb4a1054b0b2d001060c962d25e7727e57e8d81d4a4405314cc3e01545def |
