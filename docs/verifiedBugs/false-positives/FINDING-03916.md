# FINDING-03916: Tensor entries are not all strictly positive scalars
...
| Target | boxBody2.body.I_31 |
| Student classification | physical-domain-unenforced |
| Original report | `FINDING-03916-doublependuluminittip-boxbody2-body-i-31.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | b5478c7d5f646704481a420f8df7f549b80a5312d1149c692d40e81373838ee8 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:25`. Role: `parameter`; binding: `boxBody2.I[3, 1]`; effective min: `-1.7976931348623157e+308`; effective max: `None`. 
