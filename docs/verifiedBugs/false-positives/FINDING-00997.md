# FINDING-00997: Zero inductance is an explicitly supported algebraic limit
...
| Target | Inductance1.L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-showsaturatinginductor-inductance1-l-zerolimit.md](../../v2/bugs/FINDING-showsaturatinginductor-inductance1-l-zerolimit.md) — reviewed as `FINDING-00997-showsaturatinginductor-inductance1-l.md`, which a later run renamed |
| Original SHA-256 | 2426f71a436609660e2b42e88de388b6864c5eaa5395d11bc27f5825ca2c5224 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `Lnom`; effective min: `None`; effective max: `None`. 
