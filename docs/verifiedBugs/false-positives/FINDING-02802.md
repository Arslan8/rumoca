# FINDING-02802: Zero inductance is an explicitly supported algebraic limit
...
| Target | transformer1.l2sigma.inductor[3].L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-rectifier12pulse-transformer1-l2sigma-inductor-3-l-zerolimit.md](../../v2/bugs/FINDING-rectifier12pulse-transformer1-l2sigma-inductor-3-l-zerolimit.md) — reviewed as `FINDING-02802-rectifier12pulse-transformer1-l2sigma-inductor-3-l.md`, which a later run renamed |
| Original SHA-256 | 2344977900eef0d1037ceecde7ba0409e8d75c5189c33a8f0b028623e6731767 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `transformer1.l2sigma.L[3]`; effective min: `None`; effective max: `None`. 
