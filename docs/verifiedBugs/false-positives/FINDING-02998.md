# FINDING-02998: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | idealthyristor.Goff |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-thyristor1pulse-r-characteristic-idealthyristor-goff-zerolimit.md](../../v2/bugs/FINDING-thyristor1pulse-r-characteristic-idealthyristor-goff-zerolimit.md) — reviewed as `FINDING-02998-thyristor1pulse-r-characteristic-idealthyristor-goff.md`, which a later run renamed |
| Original SHA-256 | dd7e0dc008a1a57a4faf8bf9c68d2f46b01f81bdebc86bccac268f95bcf35db3 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:6`. Role: `parameter`; binding: `1e-05`; effective min: `0`; effective max: `None`. 
