# FINDING-02814: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | diode4.idealDiode[1].Goff |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-rectifier12pulse-diode4-idealdiode-1-goff-zerolimit.md](../../v2/bugs/FINDING-rectifier12pulse-diode4-idealdiode-1-goff-zerolimit.md) — reviewed as `FINDING-02814-rectifier12pulse-diode4-idealdiode-1-goff.md`, which a later run renamed |
| Original SHA-256 | db20885ab9dd8ded7c5b6bf29b2087801dd4dac410a005ccfa0a31ed806d3df7 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:6`. Role: `parameter`; binding: `diode4.Goff[1]`; effective min: `0`; effective max: `None`. 
