# FINDING-02916: Zero inductance is an explicitly supported algebraic limit
...
| Target | transformer.l2sigma.inductor[1].L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-transformertestbench-transformer-l2sigma-inductor-1-l-zerolimit.md](../../v2/bugs/FINDING-transformertestbench-transformer-l2sigma-inductor-1-l-zerolimit.md) — reviewed as `FINDING-02916-transformertestbench-transformer-l2sigma-inductor-1-l.md`, which a later run renamed |
| Original SHA-256 | dfc98a50a95928fbdf04abdba9c2aa2f843e0552097f370decfa646d29f5f159 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `transformer.l2sigma.L[1]`; effective min: `None`; effective max: `None`. 
