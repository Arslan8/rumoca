# FINDING-01958: Arc-switch resistance/conductance are multiplicative ideal limits
...
| Target | switchYDwithArc.idealOpener.openerWithArc[1].Goff |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-imc-ydarc-switchydwitharc-idealopener-openerwitharc-1-goff-zerolimit.md](../../v2/bugs/FINDING-imc-ydarc-switchydwitharc-idealopener-openerwitharc-1-goff-zerolimit.md) — reviewed as `FINDING-01958-imc-ydarc-switchydwitharc-idealopener-openerwitharc-1-goff.md`, which a later run renamed |
| Original SHA-256 | 2434169bb744d511a46b30633ee801cdf38ef31de8ea8aeb5f23ad9fed5a06c9 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSwitchWithArc.mo:5`. Role: `parameter`; binding: `switchYDwithArc.idealOpener.Goff[1]`; effective min: `None`; effective max: `None`. 
