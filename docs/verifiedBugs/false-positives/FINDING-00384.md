# FINDING-00384: Zero inductance is an explicitly supported algebraic limit
...
| Original report | [FINDING-comparelinetrunks-oline2-l-2-l-zerolimit.md](../../v2/bugs/FINDING-comparelinetrunks-oline2-l-2-l-zerolimit.md) — reviewed as `FINDING-00384-comparelinetrunks-oline2-l-2-l.md`, which a later run renamed |
| Original SHA-256 | 8e1be4aad11061121edddd2ed0de9cf59ce0fa7846654824a13120af7f290861 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `oLine2.lm[2]`; effective min: `None`; effective max: `None`. 
