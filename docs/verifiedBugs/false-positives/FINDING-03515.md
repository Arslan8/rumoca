# FINDING-03515: Converter switch parameters delegate to ideal semiconductor limits
...
| Original report | [FINDING-singlephasetwolevel-rl-inverter-gofftransistor-zerolimit.md](../../v2/bugs/FINDING-singlephasetwolevel-rl-inverter-gofftransistor-zerolimit.md) — reviewed as `FINDING-03515-singlephasetwolevel-rl-inverter-gofftransistor.md`, which a later run renamed |
| Original SHA-256 | 8178d02ae1fff49a99505351dbc6ff7e7b900bffa5af683556479e86ca8d8b17 |
...
Compiler/source-resolved declaration: `Electrical/PowerConverters/DCAC/SinglePhase2Level.mo:6`. Role: `parameter`; binding: `1e-05`; effective min: `None`; effective max: `None`. 
