# FINDING-00134: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | R7.IdealCommutingSwitch1.Goff |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-cauerlowpasssc-r7-idealcommutingswitch1-goff-ruleoff.md](../../v2/bugs/FINDING-cauerlowpasssc-r7-idealcommutingswitch1-goff-ruleoff.md) — reviewed as `FINDING-00134-cauerlowpasssc-r7-idealcommutingswitch1-goff.md`, which a later run renamed |
| Original SHA-256 | d8cf7cebd267c10d6a0563b240486862fb4c48b75661f892681e4e1d72d1a984 |
