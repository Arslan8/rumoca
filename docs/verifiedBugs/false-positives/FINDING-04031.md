# FINDING-04031: MultiBody Newton/Euler equations use mass and inertia multiplicatively
...
| Original report | [FINDING-pendulum-body-m-zerolimit.md](../../v2/bugs/FINDING-pendulum-body-m-zerolimit.md) — reviewed as `FINDING-04031-pendulum-body-m.md`, which a later run renamed |
| Original SHA-256 | 227b09732a65be59e957934d42980c1b0663c493adc69e941af5d8a99e5a3731 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:16`. Role: `parameter`; binding: `1.0`; effective min: `0`; effective max: `None`. 
