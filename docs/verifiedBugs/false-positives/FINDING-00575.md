# FINDING-00575: Zero inductance is an explicitly supported algebraic limit
...
| Target | oLine50.L[49].L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-smoothstep-oline50-l-49-l-zerolimit.md](../../v2/bugs/FINDING-smoothstep-oline50-l-49-l-zerolimit.md) — reviewed as `FINDING-00575-smoothstep-oline50-l-49-l.md`, which a later run renamed |
| Original SHA-256 | 378be85823aa1b11b99843a369a250b2fb054de6b00c742d0bb64476b6864c62 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `oLine50.lm[49]`; effective min: `None`; effective max: `None`. 
