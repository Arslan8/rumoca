# FINDING-00563: Zero inductance is an explicitly supported algebraic limit
...
| Target | oLine50.L[37].L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-smoothstep-oline50-l-37-l-zerolimit.md](../../v2/bugs/FINDING-smoothstep-oline50-l-37-l-zerolimit.md) — reviewed as `FINDING-00563-smoothstep-oline50-l-37-l.md`, which a later run renamed |
| Original SHA-256 | d73c4461e53fcc11195f2a1c3f15c91de202dec98cac7dce4e46581ab15e5d01 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `oLine50.lm[37]`; effective min: `None`; effective max: `None`. 
