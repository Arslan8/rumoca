# FINDING-00528: Zero inductance is an explicitly supported algebraic limit
...
| Target | oLine50.L[2].L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-smoothstep-oline50-l-2-l-zerolimit.md](../../v2/bugs/FINDING-smoothstep-oline50-l-2-l-zerolimit.md) — reviewed as `FINDING-00528-smoothstep-oline50-l-2-l.md`, which a later run renamed |
| Original SHA-256 | 50bbd6f6eb016e29c2b1a41aa829c6ddc8becfa811ef273235258be8fa24d868 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `oLine50.lm[2]`; effective min: `None`; effective max: `None`. 
