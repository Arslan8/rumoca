# FINDING-04527: The friction denominator is protected by an ordering assertion
...
| Target | pipe1.V_flowNominal |
| Student classification | divisor-reachable-zero |
| Original report | [FINDING-indirectcooling-pipe1-v-flownominal-divzero.md](../../v2/bugs/FINDING-indirectcooling-pipe1-v-flownominal-divzero.md) — reviewed as `FINDING-04527-indirectcooling-pipe1-v-flownominal.md`, which a later run renamed |
| Original SHA-256 | 71e7316115a58cae92b64bc53e1fc2924cf30cf2296ff82bed52c59279fcf7d2 |
...
Compiler/source-resolved declaration: `Thermal/FluidHeatFlow/BaseClasses/SimpleFriction.mo:9`. Role: `parameter`; binding: `2`; effective min: `None`; effective max: `None`. 
...
| Probe | Outcome |
|---|---|
| `pipe1.V_flowNominal=0` | reported-failure |

Diagnostic: Modelica assert failed at t=0.000000000: SimpleFriction: V_flowNominal has to be > V_flowLaminar!
