# FINDING-04870: Air-gap inductance is used as a flux multiplier
...
| Target | smpm.airGap.L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-smpm-voltagesourcewithlosses-smpm-airgap-l-zerolimit.md](../../v2/bugs/FINDING-smpm-voltagesourcewithlosses-smpm-airgap-l-zerolimit.md) — reviewed as `FINDING-04870-smpm-voltagesourcewithlosses-smpm-airgap-l.md`, which a later run renamed |
| Original SHA-256 | 37732f02fd5e9e5860e2827c439f616222279cbf5f8eba8d41fb2ef742bdb49f |
...
Compiler/source-resolved declaration: `Electrical/Machines/BasicMachines/Components/AirGapR.mo:11`. Role: `parameter`; binding: `{{smpm.airGap.Lmd, 0}, {0, smpm.airGap.Lmq}}`; effective min: `None`; effective max: `None`. 
