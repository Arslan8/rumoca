# FINDING-00538: Zero inductance is an explicitly supported algebraic limit
...
| Target | oLine50.L[12].L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-smoothstep-oline50-l-12-l-zerolimit.md](../../v2/bugs/FINDING-smoothstep-oline50-l-12-l-zerolimit.md) — reviewed as `FINDING-00538-smoothstep-oline50-l-12-l.md`, which a later run renamed |
| Original SHA-256 | ab9a0c47725d62aa5e57595f1c4e7d14bd474e7c9a571c0bddfc0379c13d614a |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `oLine50.lm[12]`; effective min: `None`; effective max: `None`. 
