# FINDING-00264: Zero heat capacity is a no-storage algebraic limit
...
| Original report | [FINDING-heatingmosinverter-heatcapacitor1-c-zerolimit.md](../../v2/bugs/FINDING-heatingmosinverter-heatcapacitor1-c-zerolimit.md) — reviewed as `FINDING-00264-heatingmosinverter-heatcapacitor1-c.md`, which a later run renamed |
| Original SHA-256 | 502fc67efdcb1e9d3bd6bd338bc7b67a5f9437b266403725a7d06d3119d530a6 |
...
Compiler/source-resolved declaration: `Thermal/HeatTransfer/Components/HeatCapacitor.mo:3`. Role: `parameter`; binding: `0.01`; effective min: `None`; effective max: `None`. 
