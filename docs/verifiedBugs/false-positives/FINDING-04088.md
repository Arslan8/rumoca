# FINDING-04088: Tensor entries are not all strictly positive scalars
...
| Target | referenceSystem.pointMass3.I |
| Student classification | physical-domain-unenforced |
| Original report | `FINDING-04088-pointgravitywithpointmasses2-referencesystem-pointmass3-i.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | f24fda666ddddff4dce67ffe4c6e1f3f072464ac38adb96a30a18ea312e92b9e |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:114`. Role: `parameter`; binding: `cat1(cat2(referenceSystem.pointMass3.I_11, referenceSystem.pointMass3.I_21, referenceSystem.pointMass3.I_31), cat2(referenceSystem.pointMass3.I_21, referenceSystem.pointMass3.I_22, referenceSystem.pointMass3.I_32), cat2(referenceSystem.pointMass3.I_31, referenceSystem.pointMass3.I_32, referenceSystem.pointMass3.I_33))`; effective min: `None`; effective max: `None`. 
