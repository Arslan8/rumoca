# FINDING-03557: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | dcdc.diodeLS.Goff |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-chopperbuckboost-dutycycle-dcdc-diodels-goff-zerolimit.md](../../v2/bugs/FINDING-chopperbuckboost-dutycycle-dcdc-diodels-goff-zerolimit.md) — reviewed as `FINDING-03557-chopperbuckboost-dutycycle-dcdc-diodels-goff.md`, which a later run renamed |
| Original SHA-256 | f1b9f8f60fe72acf561178671fea88a62c2c00a1da0cbf300fc5ed785015f5c6 |
