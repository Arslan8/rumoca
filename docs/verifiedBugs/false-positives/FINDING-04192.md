# FINDING-04192: MultiBody Newton/Euler equations use mass and inertia multiplicatively
...
| Target | body2.body.I_33 |
| Student classification | physical-bound-permits-zero |
| Original report | `FINDING-04192-planarfourbar-body2-body-i-33.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 53b252c4964ad586bcd7a1284895967365955d34a11b6de216426e4aacf09c3a |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:21`. Role: `parameter`; binding: `body2.I[3, 3]`; effective min: `0`; effective max: `None`. 
