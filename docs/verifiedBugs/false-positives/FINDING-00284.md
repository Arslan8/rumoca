# FINDING-00284: Zero capacitance is an explicitly supported algebraic limit
...
| Original report | [FINDING-heatingnpn-norgate-c2-c-zerolimit.md](../../v2/bugs/FINDING-heatingnpn-norgate-c2-c-zerolimit.md) — reviewed as `FINDING-00284-heatingnpn-norgate-c2-c.md`, which a later run renamed |
| Original SHA-256 | 0ed8db372623e9a30c512887f9bb30d3aad86cf93455356d8a1ce3faccc16dce |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Capacitor.mo:4`. Role: `parameter`; binding: `CapVal`; effective min: `0`; effective max: `None`. 
