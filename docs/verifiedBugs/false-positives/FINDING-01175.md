# FINDING-01175: Zero armature inductance is an ideal algebraic limit
...
| Original report | [FINDING-dc-comparecharacteristics-dcse-la-zerolimit.md](../../v2/bugs/FINDING-dc-comparecharacteristics-dcse-la-zerolimit.md) — reviewed as `FINDING-01175-dc-comparecharacteristics-dcse-la.md`, which a later run renamed |
| Original SHA-256 | f9dce0901ef632ac2de60e27945d93e36c42a0e7e9c7d7aa1974bac065dffdd1 |
...
Compiler/source-resolved declaration: `Electrical/Machines/Interfaces/PartialBasicDCMachine.mo:26`. Role: `parameter`; binding: `dcseData.La`; effective min: `None`; effective max: `None`. 
