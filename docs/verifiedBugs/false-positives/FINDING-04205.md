# FINDING-04205: MultiBody Newton/Euler equations use mass and inertia multiplicatively
...
| Target | body3.body.I_33 |
| Student classification | physical-bound-permits-zero |
| Original report | `FINDING-04205-planarfourbar-body3-body-i-33.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | b75805b10fa0eb58d7a7eec4f074b5ded3bfc2b6971f377ca090f6f8e7a4c7fb |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:21`. Role: `parameter`; binding: `body3.I[3, 3]`; effective min: `0`; effective max: `None`. 
