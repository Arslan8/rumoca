# FINDING-04081: MultiBody Newton/Euler equations use mass and inertia multiplicatively
...
| Target | referenceSystem.pointMass3.m |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-pointgravitywithpointmasses2-referencesystem-pointmass3-m-zerolimit.md](../../v2/bugs/FINDING-pointgravitywithpointmasses2-referencesystem-pointmass3-m-zerolimit.md) — reviewed as `FINDING-04081-pointgravitywithpointmasses2-referencesystem-pointmass3-m.md`, which a later run renamed |
| Original SHA-256 | 1491d24bef6844c4fc142af9fcf123f4c726c125e37bd8f8a13c3c09be28f772 |
