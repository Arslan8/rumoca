# FINDING-02794: Polyphase inductance delegates to zero-capable scalar inductors
...
| Target | transformer1.l1sigma.L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-rectifier12pulse-transformer1-l1sigma-l-zerolimit.md](../../v2/bugs/FINDING-rectifier12pulse-transformer1-l1sigma-l-zerolimit.md) — reviewed as `FINDING-02794-rectifier12pulse-transformer1-l1sigma-l.md`, which a later run renamed |
| Original SHA-256 | 2a926ee7ea037c4df0440d87c643eccc46e453b88dbf9e41f3a5a7002e01c7d5 |
...
Compiler/source-resolved declaration: `Electrical/Polyphase/Basic/Inductor.mo:4`. Role: `parameter`; binding: `fill(transformer1.L1sigma, transformer1.m)`; effective min: `None`; effective max: `None`. 
