# FINDING-03770: Zero ElastoGap stiffness is handled without division
...
| Target | pmActuator.armature.stopper_xMax.c |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-armaturestroke-pmactuator-armature-stopper-xmax-c-zerolimit.md](../../v2/bugs/FINDING-armaturestroke-pmactuator-armature-stopper-xmax-c-zerolimit.md) — reviewed as `FINDING-03770-armaturestroke-pmactuator-armature-stopper-xmax-c.md`, which a later run renamed |
| Original SHA-256 | 68a149570af79a96cfefbdc1fd85ce3ab1b173a67b3c54bf080016d0ff54cd35 |
...
Compiler/source-resolved declaration: `Mechanics/Translational/Components/ElastoGap.mo:4`. Role: `parameter`; binding: `pmActuator.c`; effective min: `0`; effective max: `None`. 
