# FINDING-02994: Polyphase resistance/conductance delegates to signed scalar elements
...
| Original report | `FINDING-02994-transformeryy-loadr-r.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | f686510592eb7541d75a76693737c682e725e703d63cded687b356708f4c5f74 |
...
Compiler/source-resolved declaration: `Electrical/Polyphase/Basic/Resistor.mo:4`. Role: `parameter`; binding: `fill(RL, m)`; effective min: `None`; effective max: `None`. 
