# FINDING-04288: MultiBody Newton/Euler equations use mass and inertia multiplicatively
...
| Original report | `FINDING-04288-mechanicalstructure-b2-body-i-22.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 6bf0caec32bf0349f301592210ceb32db3801606f6df479b44b6b18a3183dacd |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:19`. Role: `parameter`; binding: `0.64`; effective min: `0`; effective max: `None`. 
