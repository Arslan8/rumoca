# FINDING-04204: MultiBody Newton/Euler equations use mass and inertia multiplicatively
...
| Target | body3.body.I_22 |
| Student classification | physical-bound-permits-zero |
| Original report | `FINDING-04204-planarfourbar-body3-body-i-22.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | db69c07d66d5397fc7e3ac14f726936efa94ad6832585992e8eef421e71cd9e4 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:19`. Role: `parameter`; binding: `body3.I[2, 2]`; effective min: `0`; effective max: `None`. 
