# FINDING-00036: Zero capacitance is an explicitly supported algebraic limit
...
| Original report | [FINDING-cauerlowpassanalog-c5-c-zerolimit.md](../../v2/bugs/FINDING-cauerlowpassanalog-c5-c-zerolimit.md) — reviewed as `FINDING-00036-cauerlowpassanalog-c5-c.md`, which a later run renamed |
| Original SHA-256 | f1d88abd60ea9bce215c615a21b088e8302780b16e0999d358cacc01668f68ee |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Capacitor.mo:4`. Role: `parameter`; binding: `c5`; effective min: `0`; effective max: `None`. 
