# FINDING-03403: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | rectifier.thyristor_n.idealThyristor[1].Ron |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-thyristorcentertap2mpulse-r-rectifier-thyristor-n-idealthyristor-1-ron.md](../../v2/bugs/FINDING-thyristorcentertap2mpulse-r-rectifier-thyristor-n-idealthyristor-1-ron.md) — reviewed as `FINDING-03403-thyristorcentertap2mpulse-r-rectifier-thyristor-n-idealthyristor-1-ron.md`, which a later run renamed |
| Original SHA-256 | 63cb6aa098076a7a413742c95629ce78ea3241269727e3f2c42615d59a4474b8 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:4`. Role: `parameter`; binding: `rectifier.thyristor_n.Ron[1]`; effective min: `0`; effective max: `None`. 
