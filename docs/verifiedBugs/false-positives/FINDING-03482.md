# FINDING-03482: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | rectifier.thyristor.idealThyristor[2].Ron |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-thyristorcentertapmpulse-rlv-characteristic-rectifier-thyristor-idealt-3.md](../../v2/bugs/FINDING-thyristorcentertapmpulse-rlv-characteristic-rectifier-thyristor-idealt-3.md) — reviewed as `FINDING-03482-thyristorcentertapmpulse-rlv-characteristic-rectifier-thyristor-idealt.md`, which a later run renamed |
| Original SHA-256 | e00236085d2ae9e903aaa42097f12270dc9d4d755fa2f7f80e3805acbc9b8e8c |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:4`. Role: `parameter`; binding: `rectifier.thyristor.Ron[2]`; effective min: `0`; effective max: `None`. 
