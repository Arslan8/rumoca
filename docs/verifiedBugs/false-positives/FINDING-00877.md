# FINDING-00877: Zero feedback resistance is the unity-gain buffer
...
| Original report | [FINDING-noninvertingamplifier-buffer-r2-zerolimit.md](../../v2/bugs/FINDING-noninvertingamplifier-buffer-r2-zerolimit.md) — reviewed as `FINDING-00877-noninvertingamplifier-buffer-r2.md`, which a later run renamed |
| Original SHA-256 | b747c96bdeca2a25542ca8978fc5c6aece0d277dc27360ea3fe6381f406ea5fa |
...
Compiler/source-resolved declaration: `Electrical/Analog/Examples/OpAmps/OpAmpCircuits/Buffer.mo:6`. Role: `parameter`; binding: `1000`; effective min: `None`; effective max: `None`. 
