# FINDING-02490: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | switch2.idealClosingSwitch[2].Goff |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-smpm-resistivebraking-switch2-idealclosingswitch-2-goff-ruleoff.md](../../v2/bugs/FINDING-smpm-resistivebraking-switch2-idealclosingswitch-2-goff-ruleoff.md) — reviewed as `FINDING-02490-smpm-resistivebraking-switch2-idealclosingswitch-2-goff.md`, which a later run renamed |
| Original SHA-256 | 69670c5c7104a6ff571177eda174e46f38d3dd9637710b463d14eeb691a840ec |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSwitch.mo:6`. Role: `parameter`; binding: `switch2.Goff[2]`; effective min: `0`; effective max: `None`. 
