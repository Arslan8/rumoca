# FINDING-00565: Zero inductance is an explicitly supported algebraic limit
...
| Target | oLine50.L[39].L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-smoothstep-oline50-l-39-l-zerolimit.md](../../v2/bugs/FINDING-smoothstep-oline50-l-39-l-zerolimit.md) — reviewed as `FINDING-00565-smoothstep-oline50-l-39-l.md`, which a later run renamed |
| Original SHA-256 | 49016416944eff975b3011656b93c34df1fcc2a7fd52015315e059ae5be74391 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `oLine50.lm[39]`; effective min: `None`; effective max: `None`. 
