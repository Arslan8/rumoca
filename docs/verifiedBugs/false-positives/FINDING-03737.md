# FINDING-03737: Zeroing this operand does not zero the complete denominator
...
| Target | r_mFe.material.c_b |
| Student classification | divisor-reachable-zero |
| Original report | `FINDING-03737-saturatedinductor-r-mfe-material-c-b.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 49ff1bcd61c9c6826a66ff0aaba96780c6d8b98cb88bce1ab6d9e2dfca84a44b |
...
Compiler/source-resolved declaration: `Magnetic/FluxTubes/Material/SoftMagnetic/BaseData.mo:12`. Role: `parameter`; binding: `2.44`; effective min: `None`; effective max: `None`. 
