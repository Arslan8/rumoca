# FINDING-01546: Zero stator leakage inductance is supported
...
| Original report | [FINDING-imc-dcbraking-imc-lszero-zerolimit.md](../../v2/bugs/FINDING-imc-dcbraking-imc-lszero-zerolimit.md) — reviewed as `FINDING-01546-imc-dcbraking-imc-lszero.md`, which a later run renamed |
| Original SHA-256 | f9ee9ca3528fde48fbb7f81a7b4acfeae5c6f60ef64bc60881de2f0364976d57 |
...
Compiler/source-resolved declaration: `Electrical/Machines/Interfaces/PartialBasicInductionMachine.mo:20`. Role: `parameter`; binding: `imcData.Lszero`; effective min: `None`; effective max: `None`. 
