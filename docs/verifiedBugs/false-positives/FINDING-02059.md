# FINDING-02059: Zero space-phasor inductance is an algebraic ideal limit
...
| Target | aims.lssigma.L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-ims-start-aims-lssigma-l-intent.md](../../v2/bugs/FINDING-ims-start-aims-lssigma-l-intent.md) — reviewed as `FINDING-02059-ims-start-aims-lssigma-l.md`, which a later run renamed |
| Original SHA-256 | 8b5dac5512d1d2bf19d41f9a9bc17ce4939c717af273e37e1869686a0f0daaaf |
...
Compiler/source-resolved declaration: `Electrical/Machines/BasicMachines/Components/Inductor.mo:3`. Role: `parameter`; binding: `fill(aims.Lssigma, 2)`; effective min: `None`; effective max: `None`. 
