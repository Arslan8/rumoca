# FINDING-04673: Zero stored fluid mass is explicitly supported
...
| Original report | [FINDING-twomass-pipe1-m-zerolimit.md](../../v2/bugs/FINDING-twomass-pipe1-m-zerolimit.md) — reviewed as `FINDING-04673-twomass-pipe1-m.md`, which a later run renamed |
| Original SHA-256 | a64207081a8ee2a26cc7eabfa85fee507ae98757f0e8abd7069339b65e435f3d |
...
Diagnostic: solve-IR evaluation failed: non-finite derivative evaluation for state 'dTMass1'
