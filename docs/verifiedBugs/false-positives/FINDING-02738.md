# FINDING-02738: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | idealCommutingSwitch.idealCommutingSwitch[1].Ron |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-imc-transformer-idealcommutingswitch-idealcommutingswitch-1-ron-ruleof-2.md](../../v2/bugs/FINDING-imc-transformer-idealcommutingswitch-idealcommutingswitch-1-ron-ruleof-2.md) — reviewed as `FINDING-02738-imc-transformer-idealcommutingswitch-idealcommutingswitch-1-ron.md`, which a later run renamed |
| Original SHA-256 | dec02b7c8069d03c78068874aa1f907fcf89dec24d79aba4c0c33d45f832cd9f |
...
Compiler/source-resolved declaration: `Electrical/Analog/Ideal/IdealTwoWaySwitch.mo:3`. Role: `parameter`; binding: `idealCommutingSwitch.Ron[1]`; effective min: `0`; effective max: `None`. 
