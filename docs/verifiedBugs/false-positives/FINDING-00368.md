# FINDING-00368: Zero inductance is an explicitly supported algebraic limit
...
| Original report | [FINDING-comparelinetrunks-oline1-l-3-l-zerolimit.md](../../v2/bugs/FINDING-comparelinetrunks-oline1-l-3-l-zerolimit.md) — reviewed as `FINDING-00368-comparelinetrunks-oline1-l-3-l.md`, which a later run renamed |
| Original SHA-256 | 2bb99dfe78cc169b132cdbe3dd8d09a376239b44ec1af8dcaed973637b1591ca |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `oLine1.lm[3]`; effective min: `None`; effective max: `None`. 
