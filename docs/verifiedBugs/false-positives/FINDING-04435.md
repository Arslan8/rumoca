# FINDING-04435: Zero stiffness/damping disables one parallel force term
...
| Target | springDamper1.c |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-elastogap-springdamper1-c-zerolimit.md](../../v2/bugs/FINDING-elastogap-springdamper1-c-zerolimit.md) — reviewed as `FINDING-04435-elastogap-springdamper1-c.md`, which a later run renamed |
| Original SHA-256 | 9c65165ac6836d97f8572162d6546e6d85ec4cf6bf6300c2cf8f6ac3150121cc |
...
Compiler/source-resolved declaration: `Mechanics/Translational/Components/SpringDamper.mo:4`. Role: `parameter`; binding: `10`; effective min: `0`; effective max: `None`. 
