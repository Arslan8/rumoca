# FINDING-02485: Zero on-resistance/off-conductance is an intended ideal limit
...
| Original report | [FINDING-smpm-resistivebraking-switch2-ron-ruleoff.md](../../v2/bugs/FINDING-smpm-resistivebraking-switch2-ron-ruleoff.md) — reviewed as `FINDING-02485-smpm-resistivebraking-switch2-ron.md`, which a later run renamed |
| Original SHA-256 | df222a0968a499252ad7769daad2e3aa84faf1ad74eb20ebcbc6883f770b96e3 |
...
Compiler/source-resolved declaration: `Electrical/Polyphase/Ideal/IdealClosingSwitch.mo:4`. Role: `parameter`; binding: `fill(1e-09, m)`; effective min: `zeros(3)`; effective max: `None`. 
