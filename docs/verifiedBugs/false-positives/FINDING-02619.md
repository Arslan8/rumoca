# FINDING-02619: Zero space-phasor inductance is an algebraic ideal limit
...
| Target | smr.lssigma.L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-smr-inverter-smr-lssigma-l-intent.md](../../v2/bugs/FINDING-smr-inverter-smr-lssigma-l-intent.md) — reviewed as `FINDING-02619-smr-inverter-smr-lssigma-l.md`, which a later run renamed |
| Original SHA-256 | f54226b548132d1cead574c0ad8bc1f145c6ac2adfa63deb59b4042cca75f1af |
...
Compiler/source-resolved declaration: `Electrical/Machines/BasicMachines/Components/Inductor.mo:3`. Role: `parameter`; binding: `fill(smr.Lssigma, 2)`; effective min: `None`; effective max: `None`. 
