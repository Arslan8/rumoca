# FINDING-03624: Converter switch parameters delegate to ideal semiconductor limits
...
| Original report | [FINDING-hbridge-rl-hbridge-inverter-p-rondiode-ruleoff.md](../../v2/bugs/FINDING-hbridge-rl-hbridge-inverter-p-rondiode-ruleoff.md) — reviewed as `FINDING-03624-hbridge-rl-hbridge-inverter-p-rondiode.md`, which a later run renamed |
| Original SHA-256 | 1b9e15abad3e7d0e59396baf6e6c0e7abbac9866175027b04453917ea4e82390 |
