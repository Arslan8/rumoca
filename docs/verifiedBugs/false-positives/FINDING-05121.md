# FINDING-05121: unitTime is an immutable nonzero unit constant
...
| Original report | `FINDING-05121-pidmsl-pid-unittime.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 4e0b045d174ee5e003271f74731aeda780e40363c95ca13f8e9ec773a6fa92e9 |
...
[Rumoca commands, return codes, integrity hashes, bounded output and metadata](../evidence/330164aeb9efe3d5.json). Baseline: **clean**.

| Probe | Outcome |
|---|---|
| `pid.unitTime=0` | reported-failure |

Diagnostic: `pid.unitTime` is structural or constant; change it by recompiling
