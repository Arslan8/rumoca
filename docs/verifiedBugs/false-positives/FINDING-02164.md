# FINDING-02164: A zero-duration ramp is a supported step
...
| Target | rampVoltage.signalSource.duration |
| Student classification | divisor-reachable-zero |
| Original report | [FINDING-smee-dol-rampvoltage-signalsource-duration-divunreach.md](../../v2/bugs/FINDING-smee-dol-rampvoltage-signalsource-duration-divunreach.md) — reviewed as `FINDING-02164-smee-dol-rampvoltage-signalsource-duration.md`, which a later run renamed |
| Original SHA-256 | 7b8afa3d31887b648706f5654cf46219be77e983f1befadccd08be5e342788e3 |
...
Compiler/source-resolved declaration: `Blocks/Sources.mo:247`. Role: `parameter`; binding: `0.1`; effective min: `0.0`; effective max: `None`. 
