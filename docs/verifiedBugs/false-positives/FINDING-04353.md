# FINDING-04353: Tensor entries are not all strictly positive scalars
...
| Original report | `FINDING-04353-mechanicalstructure-b6-body-i.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 542981d8bdc7fe9a654d75d221b51e53bbbf8e8334ff80c3cbe9feffae487258 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:114`. Role: `parameter`; binding: `cat1(cat2(b6.body.I_11, b6.body.I_21, b6.body.I_31), cat2(b6.body.I_21, b6.body.I_22, b6.body.I_32), cat2(b6.body.I_31, b6.body.I_32, b6.body.I_33))`; effective min: `None`; effective max: `None`. 
