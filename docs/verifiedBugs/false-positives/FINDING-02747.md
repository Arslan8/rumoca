# FINDING-02747: Zero/signed machine resistance is an ideal electrical limit
...
| Original report | [FINDING-imc-transformer-aimcdata-rs-unbounded-2.md](../../v2/bugs/FINDING-imc-transformer-aimcdata-rs-unbounded-2.md) — reviewed as `FINDING-02747-imc-transformer-aimcdata-rs.md`, which a later run renamed |
| Original SHA-256 | de2a319421128bca94728c2ab9ffe0237a67980b9a0952438629a1697418ac7f |
