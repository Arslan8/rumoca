# FINDING-01122: Zero DC-machine inductance is an algebraic ideal limit
...
| Target | dcee.lesigma.L |
| Student classification | physical-invariant-violated |
| Original report | [FINDING-dc-comparecharacteristics-dcee-lesigma-l-zerolimit.md](../../v2/bugs/FINDING-dc-comparecharacteristics-dcee-lesigma-l-zerolimit.md) — reviewed as `FINDING-01122-dc-comparecharacteristics-dcee-lesigma-l.md`, which a later run renamed |
| Original SHA-256 | 86a9db17b620e5af075a3285d27cd8cc4d3bf0f0730536ec037c38a324ae9678 |
...
Compiler/source-resolved declaration: `Electrical/Machines/BasicMachines/Components/InductorDC.mo:5`. Role: `parameter`; binding: `dcee.Lesigma`; effective min: `None`; effective max: `None`. 
