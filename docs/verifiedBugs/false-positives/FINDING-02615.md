# FINDING-02615: Zero stator resistance is a supported ideal-loss limit
...
| Original report | [FINDING-smr-inverter-smr-rs-ruleoff.md](../../v2/bugs/FINDING-smr-inverter-smr-rs-ruleoff.md) — reviewed as `FINDING-02615-smr-inverter-smr-rs.md`, which a later run renamed |
| Original SHA-256 | 956b5dac0db86308e34b3ce5fc850f11f773bc5bfaf7f9a8e4f02cc6f87da73c |
...
Compiler/source-resolved declaration: `Electrical/Machines/Interfaces/PartialBasicInductionMachine.mo:11`. Role: `parameter`; binding: `smrData.Rs`; effective min: `None`; effective max: `None`. 
