# FINDING-01700: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | inverter.diode_p.idealDiode[3].Goff |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-imc-inverterdrive-inverter-diode-p-idealdiode-3-goff-zerolimit.md](../../v2/bugs/FINDING-imc-inverterdrive-inverter-diode-p-idealdiode-3-goff-zerolimit.md) — reviewed as `FINDING-01700-imc-inverterdrive-inverter-diode-p-idealdiode-3-goff.md`, which a later run renamed |
| Original SHA-256 | 514f497310c79aa51e37be5fe3307d0bfec0dface365834fcf6a7f602b66a7da |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:6`. Role: `parameter`; binding: `inverter.diode_p.Goff[3]`; effective min: `0`; effective max: `None`. 
