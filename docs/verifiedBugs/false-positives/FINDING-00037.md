# FINDING-00037: Zero inductance is an explicitly supported algebraic limit
...
| Original report | [FINDING-cauerlowpassanalog-l1-l-zerolimit.md](../../v2/bugs/FINDING-cauerlowpassanalog-l1-l-zerolimit.md) — reviewed as `FINDING-00037-cauerlowpassanalog-l1-l.md`, which a later run renamed |
| Original SHA-256 | e4a9bb1daece81f41376cc794a695a23d3503f6a71f55c40a2090499cf7f62b7 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `l1`; effective min: `None`; effective max: `None`. 
