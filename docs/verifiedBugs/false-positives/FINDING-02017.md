# FINDING-02017: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | switchYD.idealCloser.Goff |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-imc-yd-switchyd-idealcloser-goff-ruleoff.md](../../v2/bugs/FINDING-imc-yd-switchyd-idealcloser-goff-ruleoff.md) — reviewed as `FINDING-02017-imc-yd-switchyd-idealcloser-goff.md`, which a later run renamed |
| Original SHA-256 | a2c55f7d7bb3d89a3df90a26a02b4db72abb07c20903419f3a2aa5854f7bd148 |
...
Compiler/source-resolved declaration: `Electrical/Polyphase/Ideal/IdealClosingSwitch.mo:6`. Role: `parameter`; binding: `fill(switchYD.Goff, switchYD.m)`; effective min: `zeros(3)`; effective max: `None`. 
