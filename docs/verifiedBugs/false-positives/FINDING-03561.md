# FINDING-03561: Zero on-resistance/off-conductance is an intended ideal limit
...
| Target | dcdc.diodeHS.Goff |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-chopperbuckboost-dutycycle-dcdc-diodehs-goff-zerolimit.md](../../v2/bugs/FINDING-chopperbuckboost-dutycycle-dcdc-diodehs-goff-zerolimit.md) — reviewed as `FINDING-03561-chopperbuckboost-dutycycle-dcdc-diodehs-goff.md`, which a later run renamed |
| Original SHA-256 | 48ff836406c296cdfcb49dfa3396175dc1b955fafaa6957d76654333daf689a2 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Interfaces/IdealSemiconductor.mo:6`. Role: `parameter`; binding: `dcdc.GoffDiode`; effective min: `0`; effective max: `None`. 
