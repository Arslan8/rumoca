# FINDING-00545: Zero inductance is an explicitly supported algebraic limit
...
| Target | oLine50.L[19].L |
| Student classification | physical-domain-unenforced |
| Original report | [FINDING-smoothstep-oline50-l-19-l-zerolimit.md](../../v2/bugs/FINDING-smoothstep-oline50-l-19-l-zerolimit.md) — reviewed as `FINDING-00545-smoothstep-oline50-l-19-l.md`, which a later run renamed |
| Original SHA-256 | cc0cc87b6d027baa0609acb8719d7b08c299e0fc6e9eb9c8b00c9a00d040be13 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `oLine50.lm[19]`; effective min: `None`; effective max: `None`. 
