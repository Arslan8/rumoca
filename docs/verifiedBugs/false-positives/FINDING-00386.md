# FINDING-00386: Zero inductance is an explicitly supported algebraic limit
...
| Original report | [FINDING-comparelinetrunks-oline2-l-4-l-zerolimit.md](../../v2/bugs/FINDING-comparelinetrunks-oline2-l-4-l-zerolimit.md) — reviewed as `FINDING-00386-comparelinetrunks-oline2-l-4-l.md`, which a later run renamed |
| Original SHA-256 | a4e360dac58ef49bd7e85f1d400554c577a8036f53d4013efdf8a342b9d33869 |
...
Compiler/source-resolved declaration: `Electrical/Analog/Basic/Inductor.mo:4`. Role: `parameter`; binding: `oLine2.lm[4]`; effective min: `None`; effective max: `None`. 
