# FINDING-04378: Zero inertia is a massless algebraic component, not an intrinsic division
...
| Original report | [FINDING-comparebrakingtorque-inertia3-j-zerolimit.md](../../v2/bugs/FINDING-comparebrakingtorque-inertia3-j-zerolimit.md) — reviewed as `FINDING-04378-comparebrakingtorque-inertia3-j.md`, which a later run renamed |
| Original SHA-256 | 66a1523400a762fdbd103cbacd202e0da5eef12da7daecb093dc75d1be06c6b0 |
...
Compiler/source-resolved declaration: `Mechanics/Rotational/Components/Inertia.mo:4`. Role: `parameter`; binding: `J`; effective min: `0`; effective max: `None`. 
...
| Probe | Outcome |
|---|---|
| `inertia3.J=0` | reported-failure |

Diagnostic: solve-IR evaluation failed: algebraic projection did not converge at event boundary: worst scaled residual row=24 target=inertia3.a value=1.000000e2 ratio=1.000000e12 norm=1.000000e2 row_scale=1.000000e0 scaled_tolerance=1.000000e-10
