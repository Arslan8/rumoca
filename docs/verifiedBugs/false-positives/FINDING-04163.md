# FINDING-04163: MultiBody Newton/Euler equations use mass and inertia multiplicatively
...
| Original report | `FINDING-04163-userdefinedgravityfield-body-i-22.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | 203b750db5fd05b464a78fca5633968db10ca011fcc12715230aeaec3b7f2eb0 |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/Body.mo:19`. Role: `parameter`; binding: `0.001`; effective min: `0`; effective max: `None`. 
