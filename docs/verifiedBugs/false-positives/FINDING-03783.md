# FINDING-03783: Zero ElastoGap stiffness is handled without division
...
| Target | cActuator.armature.stopper_xMin.c |
| Student classification | physical-bound-permits-zero |
| Original report | [FINDING-armaturestroke-cactuator-armature-stopper-xmin-c-zerolimit.md](../../v2/bugs/FINDING-armaturestroke-cactuator-armature-stopper-xmin-c-zerolimit.md) — reviewed as `FINDING-03783-armaturestroke-cactuator-armature-stopper-xmin-c.md`, which a later run renamed |
| Original SHA-256 | 1e12bb08b29833d9ac517f60e033e8c6a3ac53e205f65744f12302fad6a72a3a |
...
Compiler/source-resolved declaration: `Mechanics/Translational/Components/ElastoGap.mo:4`. Role: `parameter`; binding: `cActuator.c`; effective min: `0`; effective max: `None`. 
