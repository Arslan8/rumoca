# FINDING-03686: Converter switch parameters delegate to ideal semiconductor limits
...
| Original report | [FINDING-hbridge-trianglepwm-rl-hbridge-inverter-p-rondiode-ruleoff.md](../../v2/bugs/FINDING-hbridge-trianglepwm-rl-hbridge-inverter-p-rondiode-ruleoff.md) — reviewed as `FINDING-03686-hbridge-trianglepwm-rl-hbridge-inverter-p-rondiode.md`, which a later run renamed |
| Original SHA-256 | 157aaef50c5aaf4ac0c4a1b5039d5b1d0f8c7999e94bf11c868e76a0cb6b2697 |
...
Compiler/source-resolved declaration: `Electrical/PowerConverters/DCAC/SinglePhase2Level.mo:10`. Role: `parameter`; binding: `hbridge.RonDiode`; effective min: `None`; effective max: `None`. 
