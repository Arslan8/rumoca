# FINDING-00207: Zero on-resistance/off-conductance is an intended ideal limit
...
| Original report | [FINDING-controlledswitchwitharc-switch1-goff-ruleoff.md](../../v2/bugs/FINDING-controlledswitchwitharc-switch1-goff-ruleoff.md) — reviewed as `FINDING-00207-controlledswitchwitharc-switch1-goff.md`, which a later run renamed |
| Original SHA-256 | fce7566e1aba7237aeb438de61a6297cdb45d21c4c6b7b50219978828d7b880b |
...
[Rumoca commands, return codes, integrity hashes, bounded output and metadata](../evidence/f85c84c622850bae.json). Baseline: **tool-error**.
