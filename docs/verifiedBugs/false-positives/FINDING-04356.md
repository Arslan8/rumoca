# FINDING-04356: MultiBody Newton/Euler equations use mass and inertia multiplicatively
...
| Original report | `FINDING-04356-mechanicalstructure-load-i-22.md` — [withdrawn](../../v2/bugs/withdrawn.md); a later run no longer makes this claim |
| Original SHA-256 | d7a01fdc112ab3cb5d26aca4e911f2a18ac63632e1f8062a22f9e2cf6c497eef |
...
Compiler/source-resolved declaration: `Mechanics/MultiBody/Parts/BodyShape.mo:26`. Role: `parameter`; binding: `0.001`; effective min: `0`; effective max: `None`. 
