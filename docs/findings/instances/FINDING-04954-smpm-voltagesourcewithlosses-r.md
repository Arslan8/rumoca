# FINDING-04954: `smpm.rs.R` in `SMPM_VoltageSourceWithLosses`

| | |
|---|---|
| **Model** | `ModelicaTest.Electrical.Machines.SMPM_VoltageSourceWithLosses` |
| **Reached as** | `smpm.rs.R` |
...
`smpm.rs.R`, and the analysis reached it statically — no value has been observed
