# FINDING-00088: `R1.IdealCommutingSwitch1.Ron` in `CauerLowPassSC`
...
`R1.IdealCommutingSwitch1.Ron`, and the analysis reached it statically — no value has been observed
