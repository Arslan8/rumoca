# FINDING-03450: `rectifier.diode_p.idealDiode[3].Goff` in `DiodeCenterTap2mPulse`
...
`rectifier.diode_p.idealDiode[3].Goff`, and the analysis reached it statically — no value has been observed
