# FINDING-01753: `inverter.diode_n.idealDiode[2].Ron` in `IMC_InverterDrive`
...
`inverter.diode_n.idealDiode[2].Ron`, and the analysis reached it statically — no value has been observed
