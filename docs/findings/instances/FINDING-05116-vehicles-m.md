# FINDING-05116: `vehicleInclinationInVar.mass.m` in `Vehicles`
...
`vehicleInclinationInVar.mass.m`, and the analysis reached it statically — no value has been observed
