# FINDING-03637: `CLV` in `ChopperBuckBoost_DutyCycle`
...
| **Severity** | low |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0587](../../site-reports/SITE-0587-clv-physical-bound-permits-zero.md) |
...
`CLV`, and the analysis reached it statically — no value has been observed
