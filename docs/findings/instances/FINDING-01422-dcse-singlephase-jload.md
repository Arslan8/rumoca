# FINDING-01422: `JLoad` in `DCSE_SinglePhase`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Machines.Examples.DCMachines.DCSE_SinglePhase` |
| **Reached as** | `JLoad` |
| **Declaration** | `DCSE_SinglePhase.mo:11` |
| **Parameter** | `JLoad` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0691](../../site-reports/SITE-0691-jload-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `DCSE_SinglePhase.mo:11` is reached by this model through
