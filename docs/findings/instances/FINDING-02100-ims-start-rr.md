# FINDING-02100: `aimsData.Rr` in `IMS_Start`
...
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0738](../../site-reports/SITE-0738-rr-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `IM_SlipRingData.mo:19` is reached by this model through
`aimsData.Rr`, and the analysis reached it statically — no value has been observed
