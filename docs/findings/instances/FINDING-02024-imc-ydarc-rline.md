# FINDING-02024: `RLine` in `IMC_YDarc`
...
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0730](../../site-reports/SITE-0730-rline-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `IMC_YDarc.mo:9` is reached by this model through
`RLine`, and the analysis reached it statically — no value has been observed
