# FINDING-00178: `With_Ron_Goff_Vknee.Ron` in `CharacteristicIdealDiodes`
...
`With_Ron_Goff_Vknee.Ron`, and the analysis reached it statically — no value has been observed
