# FINDING-00796: `data.R1` in `DifferentialAmplifier`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Analog.Examples.OpAmps.DifferentialAmplifier` |
| **Reached as** | `data.R1` |
| **Declaration** | `DifferentialAmplifierData.mo:18` |
| **Parameter** | `R1` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0695](../../site-reports/SITE-0695-r1-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `DifferentialAmplifierData.mo:18` is reached by this model through
`data.R1`, and the analysis reached it statically — no value has been observed
