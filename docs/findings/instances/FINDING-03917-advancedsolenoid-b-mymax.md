# FINDING-03917: `G_mLeakRad.material.B_myMax` in `AdvancedSolenoid`
...
| key | value |
|---|---|
| `parameter` | G_mLeakRad.material.B_myMax |
| `shape` | direct |
| `path` | G_mLeakRad.material.B_myMax |
| `declared_min` | None |
| `divisor_sites` | 1 |
...
`G_mLeakRad.material.B_myMax`, and the analysis reached it statically — no value has been observed
