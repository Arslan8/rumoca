# FINDING-01386: `dcpmData1.IaNominal` in `DCPM_withLosses`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Machines.Examples.DCMachines.DCPM_withLosses` |
| **Reached as** | `dcpmData1.IaNominal` |
...
| key | value |
|---|---|
| `parameter` | dcpmData1.IaNominal |
| `shape` | propagated |
| `path` | dcpmData1.IaNominal -> dcpmData1.ViNominal -> dcpmData1.coreParameters.VRef |
| `declared_min` | None |
| `divisor_sites` | 2 |
...
`dcpmData1.IaNominal`, and the analysis reached it statically — no value has been observed
