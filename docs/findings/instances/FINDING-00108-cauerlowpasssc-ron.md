# FINDING-00108: `Rp1.IdealCommutingSwitch1.Ron` in `CauerLowPassSC`
...
`Rp1.IdealCommutingSwitch1.Ron`, and the analysis reached it statically — no value has been observed
