...
One occurrence. The declaration at `IM_SquirrelCageData.mo:6` is reached by this model through
`aimcData.Lm`, and the analysis reached it statically — no value has been observed
