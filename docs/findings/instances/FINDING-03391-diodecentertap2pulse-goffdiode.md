# FINDING-03391: `rectifier.GoffDiode` in `DiodeCenterTap2Pulse`
...
| **Declaration** | `DiodeCenterTap2Pulse.mo:7` |
| **Parameter** | `GoffDiode` |
| **Claim** | the declaration explicitly permits zero (`min=0`) |
| **Kind** | `physical-bound-permits-zero` |
| **Severity** | low |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0598](../../site-reports/SITE-0598-goffdiode-physical-bound-permits-zero.md) |
...
One occurrence. The declaration at `DiodeCenterTap2Pulse.mo:7` is reached by this model through
