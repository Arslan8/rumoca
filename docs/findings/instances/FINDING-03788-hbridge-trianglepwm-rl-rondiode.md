# FINDING-03788: `hbridge.inverter_p.RonDiode` in `HBridge_TrianglePWM_RL`
...
`hbridge.inverter_p.RonDiode`, and the analysis reached it statically — no value has been observed
