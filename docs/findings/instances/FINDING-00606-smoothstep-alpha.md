# FINDING-00606: `oLine5.G[2].alpha` in `SmoothStep`
...
| key | value |
|---|---|
| `parameter` | oLine5.G[2].alpha |
| `shape` | sum |
| `path` | oLine5.G[2].alpha |
| `declared_min` | None |
| `divisor_sites` | 1 |
...
`oLine5.G[2].alpha`, and the analysis reached it statically — no value has been observed
