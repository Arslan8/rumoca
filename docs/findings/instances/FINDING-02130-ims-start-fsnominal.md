# FINDING-02130: `aimsData.fsNominal` in `IMS_Start`
...
| key | value |
|---|---|
| `parameter` | aimsData.fsNominal |
| `shape` | propagated |
| `path` | aimsData.fsNominal -> aimsData.Lm -> aimsData.turnsRatio |
| `declared_min` | None |
| `divisor_sites` | 28 |
...
`aimsData.fsNominal`, and the analysis reached it statically — no value has been observed
