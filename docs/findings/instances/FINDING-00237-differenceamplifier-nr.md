# FINDING-00237: `Transistor1.Tr.NR` in `DifferenceAmplifier`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Analog.Examples.DifferenceAmplifier` |
| **Reached as** | `Transistor1.Tr.NR` |
...
| key | value |
|---|---|
| `parameter` | Transistor1.Tr.NR |
| `shape` | product |
| `path` | Transistor1.Tr.NR |
| `declared_min` | None |
| `divisor_sites` | 1 |
...
`Transistor1.Tr.NR`, and the analysis reached it statically — no value has been observed
