# FINDING-04469: `Jmotor` in `FirstGrounded`

| | |
|---|---|
| **Model** | `Modelica.Mechanics.Rotational.Examples.FirstGrounded` |
| **Reached as** | `Jmotor` |
| **Declaration** | `FirstGrounded.mo:8` |
| **Parameter** | `Jmotor` |
| **Claim** | the declaration explicitly permits zero (`min=0`) |
| **Kind** | `physical-bound-permits-zero` |
| **Severity** | low |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0607](../../site-reports/SITE-0607-jmotor-physical-bound-permits-zero.md) |
...
One occurrence. The declaration at `FirstGrounded.mo:8` is reached by this model through
`Jmotor`, and the analysis reached it statically — no value has been observed
