# FINDING-03679: `chopperStepDown.transistor.Goff` in `ChopperStepDown_RL`
...
`chopperStepDown.transistor.Goff`, and the analysis reached it statically — no value has been observed
