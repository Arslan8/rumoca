# FINDING-01498: `dcee.Re` in `DC_CompareCharacteristics`
...
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0310](../../site-reports/SITE-0310-re-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `DC_ElectricalExcited.mo:24` is reached by this model through
`dcee.Re`, and the analysis reached it statically — no value has been observed
