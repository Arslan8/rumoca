...
One occurrence. The declaration at `AdvancedSolenoid.mo:11` is reached by this model through
`C_par`, and the analysis reached it statically — no value has been observed
