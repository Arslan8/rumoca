# FINDING-05189: `R` in `SwitchedRLC_MSL`

| | |
|---|---|
| **Model** | `SwitchedRLC_MSL` |
| **Reached as** | `R` |
| **Declaration** | `SwitchedRLC_MSL.mo:7` |
| **Parameter** | `R` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0817](../../site-reports/SITE-0817-r-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `SwitchedRLC_MSL.mo:7` is reached by this model through
