# FINDING-03185: `rectifier.thyristor_p2.Goff` in `ThyristorBridge2Pulse_RLV_Characteristic`
...
`rectifier.thyristor_p2.Goff`, and the analysis reached it statically — no value has been observed
