# FINDING-04960: `smpm.Rrd` in `SMPM_VoltageSourceWithLosses`

| | |
|---|---|
| **Model** | `ModelicaTest.Electrical.Machines.SMPM_VoltageSourceWithLosses` |
| **Reached as** | `smpm.Rrd` |
| **Declaration** | `SM_PermanentMagnet.mo:70` |
| **Parameter** | `Rrd` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0099](../../site-reports/SITE-0099-rrd-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `SM_PermanentMagnet.mo:70` is reached by this model through
`smpm.Rrd`, and the analysis reached it statically — no value has been observed
