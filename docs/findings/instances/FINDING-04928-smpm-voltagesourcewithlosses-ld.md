# FINDING-04928: `dqCurrentController.Ld` in `SMPM_VoltageSourceWithLosses`

| | |
|---|---|
| **Model** | `ModelicaTest.Electrical.Machines.SMPM_VoltageSourceWithLosses` |
| **Reached as** | `dqCurrentController.Ld` |
| **Declaration** | `DQCurrentController.mo:12` |
| **Parameter** | `Ld` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0314](../../site-reports/SITE-0314-ld-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `DQCurrentController.mo:12` is reached by this model through
`dqCurrentController.Ld`, and the analysis reached it statically — no value has been observed
