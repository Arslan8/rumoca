# FINDING-00999: `simpleTriac.idealDiode1.Goff` in `SimpleTriacCircuit`
...
`simpleTriac.idealDiode1.Goff`, and the analysis reached it statically — no value has been observed
