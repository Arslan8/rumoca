# FINDING-03024: `L` in `TestSensors`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Polyphase.Examples.TestSensors` |
| **Reached as** | `L` |
| **Declaration** | `TestSensors.mo:10` |
| **Parameter** | `L` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0819](../../site-reports/SITE-0819-l-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `TestSensors.mo:10` is reached by this model through
