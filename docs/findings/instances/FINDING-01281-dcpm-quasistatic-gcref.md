# FINDING-01281: `dcpm1.core.coreParameters.GcRef` in `DCPM_QuasiStatic`
...
`dcpm1.core.coreParameters.GcRef`, and the analysis reached it statically — no value has been observed
