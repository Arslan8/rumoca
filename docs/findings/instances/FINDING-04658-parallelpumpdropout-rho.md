# FINDING-04658: `pipe3.flowPort_b.medium.rho` in `ParallelPumpDropOut`
...
`pipe3.flowPort_b.medium.rho`, and the analysis reached it statically — no value has been observed
