# FINDING-02259: `smee.spacePhasorS.m` in `SMEE_Generator`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Machines.Examples.SynchronousMachines.SMEE_Generator` |
| **Reached as** | `smee.spacePhasorS.m` |
...
| key | value |
|---|---|
| `parameter` | smee.spacePhasorS.m |
| `shape` | direct |
| `path` | smee.spacePhasorS.m |
| `declared_min` | None |
| `divisor_sites` | 2 |
...
`smee.spacePhasorS.m`, and the analysis reached it statically — no value has been observed
