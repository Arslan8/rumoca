# FINDING-00966: `LAC` in `Rectifier`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Analog.Examples.Rectifier` |
| **Reached as** | `LAC` |
| **Declaration** | `Rectifier.mo:7` |
| **Parameter** | `LAC` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0774](../../site-reports/SITE-0774-lac-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `Rectifier.mo:7` is reached by this model through
`LAC`, and the analysis reached it statically — no value has been observed
