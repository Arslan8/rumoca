# FINDING-03803: `rightLeg.material.n` in `QuadraticCoreAirgap`

| | |
|---|---|
| **Model** | `Modelica.Magnetic.FluxTubes.Examples.BasicExamples.QuadraticCoreAirgap` |
| **Reached as** | `rightLeg.material.n` |
...
| key | value |
|---|---|
| `parameter` | rightLeg.material.n |
| `shape` | sum |
| `path` | rightLeg.material.n |
| `declared_min` | None |
| `divisor_sites` | 1 |
...
`rightLeg.material.n`, and the analysis reached it statically — no value has been observed
