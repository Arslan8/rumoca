# FINDING-03784: `hbridge.inverter_p.transistor_n.Goff` in `HBridge_TrianglePWM_RL`
...
`hbridge.inverter_p.transistor_n.Goff`, and the analysis reached it statically — no value has been observed
