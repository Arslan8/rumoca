# FINDING-01757: `inverter.diode_p.idealDiode[3].Ron` in `IMC_InverterDrive`
...
`inverter.diode_p.idealDiode[3].Ron`, and the analysis reached it statically — no value has been observed
