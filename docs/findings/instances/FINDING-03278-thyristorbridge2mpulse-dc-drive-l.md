# FINDING-03278: `lMains.inductor[3].L` in `ThyristorBridge2mPulse_DC_Drive`
...
`lMains.inductor[3].L`, and the analysis reached it statically — no value has been observed
