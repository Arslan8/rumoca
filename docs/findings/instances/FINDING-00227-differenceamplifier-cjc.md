...
One occurrence. The declaration at `NPN.mo:11` is reached by this model through
`Transistor1.Tr.Cjc`, and the analysis reached it statically — no value has been observed
