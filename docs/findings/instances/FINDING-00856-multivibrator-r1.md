# FINDING-00856: `R1` in `Multivibrator`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Analog.Examples.OpAmps.Multivibrator` |
| **Reached as** | `R1` |
| **Declaration** | `Multivibrator.mo:7` |
| **Parameter** | `R1` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0756](../../site-reports/SITE-0756-r1-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `Multivibrator.mo:7` is reached by this model through
