# FINDING-00105: `R8.IdealCommutingSwitch2.Ron` in `CauerLowPassSC`
...
`R8.IdealCommutingSwitch2.Ron`, and the analysis reached it statically — no value has been observed
