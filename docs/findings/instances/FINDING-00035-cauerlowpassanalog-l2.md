# FINDING-00035: `l2` in `CauerLowPassAnalog`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Analog.Examples.CauerLowPassAnalog` |
| **Reached as** | `l2` |
| **Declaration** | `CauerLowPassAnalog.mo:6` |
| **Parameter** | `l2` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0648](../../site-reports/SITE-0648-l2-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `CauerLowPassAnalog.mo:6` is reached by this model through
