# FINDING-01370: `dcpmData1.coreParameters.GcRef` in `DCPM_withLosses`
...
`dcpmData1.coreParameters.GcRef`, and the analysis reached it statically — no value has been observed
