# FINDING-01387: `dcpmData2.IaNominal` in `DCPM_withLosses`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Machines.Examples.DCMachines.DCPM_withLosses` |
| **Reached as** | `dcpmData2.IaNominal` |
...
| key | value |
|---|---|
| `parameter` | dcpmData2.IaNominal |
| `shape` | propagated |
| `path` | dcpmData2.IaNominal -> dcpmData2.brushParameters.ILinear |
| `declared_min` | None |
| `divisor_sites` | 4 |
...
`dcpmData2.IaNominal`, and the analysis reached it statically — no value has been observed
