# FINDING-00657: `oLine50.G[7].alpha` in `SmoothStep`
...
| key | value |
|---|---|
| `parameter` | oLine50.G[7].alpha |
| `shape` | sum |
| `path` | oLine50.G[7].alpha |
| `declared_min` | None |
| `divisor_sites` | 1 |
...
`oLine50.G[7].alpha`, and the analysis reached it statically — no value has been observed
