# FINDING-01199: `k` in `DCPM_CurrentControlled`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Machines.Examples.DCMachines.DCPM_CurrentControlled` |
| **Reached as** | `k` |
| **Declaration** | `DCPM_CurrentControlled.mo:16` |
| **Parameter** | `k` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0684](../../site-reports/SITE-0684-k-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `DCPM_CurrentControlled.mo:16` is reached by this model through
