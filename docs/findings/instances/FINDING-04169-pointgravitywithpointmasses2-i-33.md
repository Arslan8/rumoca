# FINDING-04169: `referenceSystem.pointMass5.I_33` in `PointGravityWithPointMasses2`

| | |
|---|---|
| **Model** | `Modelica.Mechanics.MultiBody.Examples.Elementary.PointGravityWithPointMasses2` |
| **Reached as** | `referenceSystem.pointMass5.I_33` |
...
| `required` | referenceSystem.pointMass5.I_33 > 0 |
| `declared_min` | 0.0 |
...
`referenceSystem.pointMass5.I_33`, and the analysis reached it statically — no value has been observed
