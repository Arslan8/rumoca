# FINDING-00084: `l2` in `CauerLowPassSC`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Analog.Examples.CauerLowPassSC` |
| **Reached as** | `l2` |
| **Declaration** | `CauerLowPassSC.mo:6` |
| **Parameter** | `l2` |
| **Claim** | the declaration explicitly permits zero (`min=0`) |
| **Kind** | `physical-bound-permits-zero` |
| **Severity** | low |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0584](../../site-reports/SITE-0584-l2-physical-bound-permits-zero.md) |
...
One occurrence. The declaration at `CauerLowPassSC.mo:6` is reached by this model through
