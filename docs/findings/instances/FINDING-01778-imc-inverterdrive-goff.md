# FINDING-01778: `inverter.transistor_n.idealGTOThyristor[3].Goff` in `IMC_InverterDrive`
...
`inverter.transistor_n.idealGTOThyristor[3].Goff`, and the analysis reached it statically — no value has been observed
