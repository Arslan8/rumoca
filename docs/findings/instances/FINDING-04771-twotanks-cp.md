# FINDING-04771: `openTank1.medium.cp` in `TwoTanks`
...
| key | value |
|---|---|
| `parameter` | openTank1.medium.cp |
| `shape` | direct |
| `path` | openTank1.medium.cp |
| `declared_min` | None |
| `divisor_sites` | 2 |
...
`openTank1.medium.cp`, and the analysis reached it statically — no value has been observed
