...
One occurrence. The declaration at `Buffer.mo:5` is reached by this model through
`buffer.R1`, and the analysis reached it statically — no value has been observed
