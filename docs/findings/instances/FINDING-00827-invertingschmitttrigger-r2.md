# FINDING-00827: `R2` in `InvertingSchmittTrigger`
...
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0750](../../site-reports/SITE-0750-r2-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `InvertingSchmittTrigger.mo:11` is reached by this model through
