# FINDING-00794: `data.RGround` in `DifferentialAmplifier`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Analog.Examples.OpAmps.DifferentialAmplifier` |
| **Reached as** | `data.RGround` |
| **Declaration** | `DifferentialAmplifierData.mo:10` |
| **Parameter** | `RGround` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0694](../../site-reports/SITE-0694-rground-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `DifferentialAmplifierData.mo:10` is reached by this model through
`data.RGround`, and the analysis reached it statically — no value has been observed
