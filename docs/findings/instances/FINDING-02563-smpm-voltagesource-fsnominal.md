# FINDING-02563: `smpmData.fsNominal` in `SMPM_VoltageSource`
...
| key | value |
|---|---|
| `parameter` | smpmData.fsNominal |
| `shape` | propagated |
| `path` | smpmData.fsNominal -> wNominal -> quadraticSpeedDependentTorque.w_nominal |
| `declared_min` | None |
| `divisor_sites` | 19 |
...
`smpmData.fsNominal`, and the analysis reached it statically — no value has been observed
