# FINDING-03277: `lMains.inductor[2].L` in `ThyristorBridge2mPulse_DC_Drive`
...
`lMains.inductor[2].L`, and the analysis reached it statically — no value has been observed
