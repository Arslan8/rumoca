# FINDING-02313: `diodeBridge2mPulse.diode_p.idealDiode[3].Goff` in `SMPM_Braking`
...
`diodeBridge2mPulse.diode_p.idealDiode[3].Goff`, and the analysis reached it statically — no value has been observed
