# FINDING-01388: `dcpmData1.wNominal` in `DCPM_withLosses`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Machines.Examples.DCMachines.DCPM_withLosses` |
| **Reached as** | `dcpmData1.wNominal` |
...
| key | value |
|---|---|
| `parameter` | dcpmData1.wNominal |
| `shape` | propagated |
| `path` | dcpmData1.wNominal -> dcpm1.wNominal |
| `declared_min` | None |
| `divisor_sites` | 8 |
...
`dcpmData1.wNominal`, and the analysis reached it statically — no value has been observed
