# FINDING-02901: `transformerData2.C1` in `Rectifier12pulse`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Machines.Examples.Transformers.Rectifier12pulse` |
| **Reached as** | `transformerData2.C1` |
...
| key | value |
|---|---|
| `parameter` | transformerData2.C1 |
| `shape` | propagated |
| `path` | transformerData2.C1 -> transformerData2.V1ph |
| `declared_min` | None |
| `divisor_sites` | 6 |
...
`transformerData2.C1`, and the analysis reached it statically — no value has been observed
