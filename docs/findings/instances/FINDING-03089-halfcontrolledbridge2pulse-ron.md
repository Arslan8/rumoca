# FINDING-03089: `rectifier.diode_n2.Ron` in `HalfControlledBridge2Pulse`
...
`rectifier.diode_n2.Ron`, and the analysis reached it statically — no value has been observed
