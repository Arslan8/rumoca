# FINDING-02850: `transformer1.l2sigma.inductor[2].L` in `Rectifier12pulse`
...
`transformer1.l2sigma.inductor[2].L`, and the analysis reached it statically — no value has been observed
