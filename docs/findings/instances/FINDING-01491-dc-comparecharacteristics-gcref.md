# FINDING-01491: `dcse.coreParameters.GcRef` in `DC_CompareCharacteristics`
...
`dcse.coreParameters.GcRef`, and the analysis reached it statically — no value has been observed
