...
One occurrence. The declaration at `IM_SlipRing.mo:30` is reached by this model through
`aims.Lrsigma`, and the analysis reached it statically — no value has been observed
