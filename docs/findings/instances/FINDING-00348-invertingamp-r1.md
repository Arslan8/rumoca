# FINDING-00348: `R1` in `InvertingAmp`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Analog.Examples.InvertingAmp` |
| **Reached as** | `R1` |
| **Declaration** | `InvertingAmp.mo:9` |
| **Parameter** | `R1` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0748](../../site-reports/SITE-0748-r1-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `InvertingAmp.mo:9` is reached by this model through
