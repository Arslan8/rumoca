# FINDING-00294: `V.signalSource.duration` in `HeatingNPN_NORGate`
...
| key | value |
|---|---|
| `parameter` | V.signalSource.duration |
| `shape` | direct |
| `path` | V.signalSource.duration |
| `declared_min` | 0.0 |
| `divisor_sites` | 1 |
...
`V.signalSource.duration`, and the analysis reached it statically — no value has been observed
