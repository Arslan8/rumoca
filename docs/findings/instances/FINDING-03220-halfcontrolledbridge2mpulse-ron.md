# FINDING-03220: `rectifier.diode_n.idealDiode[1].Ron` in `HalfControlledBridge2mPulse`
...
`rectifier.diode_n.idealDiode[1].Ron`, and the analysis reached it statically — no value has been observed
