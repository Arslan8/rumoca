# FINDING-03774: `hbridge.inverter_p.diode_n.Ron` in `HBridge_TrianglePWM_RL`
...
`hbridge.inverter_p.diode_n.Ron`, and the analysis reached it statically — no value has been observed
