# FINDING-03856: `pmActuator.armature.stopper_xMin.c` in `ArmatureStroke`
...
| **Declaration** | `ElastoGap.mo:4` |
| **Parameter** | `c` |
| **Claim** | the declaration explicitly permits zero (`min=0`) |
| **Kind** | `physical-bound-permits-zero` |
| **Severity** | low |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0078](../../site-reports/SITE-0078-c-physical-bound-permits-zero.md) |
...
One occurrence. The declaration at `ElastoGap.mo:4` is reached by this model through
`pmActuator.armature.stopper_xMin.c`, and the analysis reached it statically — no value has been observed
