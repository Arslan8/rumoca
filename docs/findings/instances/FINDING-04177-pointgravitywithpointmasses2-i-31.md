# FINDING-04177: `referenceSystem.pointMass1.I_31` in `PointGravityWithPointMasses2`

| | |
|---|---|
| **Model** | `Modelica.Mechanics.MultiBody.Examples.Elementary.PointGravityWithPointMasses2` |
| **Reached as** | `referenceSystem.pointMass1.I_31` |
...
| `required` | referenceSystem.pointMass1.I_31 > 0 |
...
`referenceSystem.pointMass1.I_31`, and the analysis reached it statically — no value has been observed
