# FINDING-04957: `smpm.Lmq` in `SMPM_VoltageSourceWithLosses`

| | |
|---|---|
| **Model** | `ModelicaTest.Electrical.Machines.SMPM_VoltageSourceWithLosses` |
| **Reached as** | `smpm.Lmq` |
| **Declaration** | `SM_PermanentMagnet.mo:53` |
| **Parameter** | `Lmq` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0096](../../site-reports/SITE-0096-lmq-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `SM_PermanentMagnet.mo:53` is reached by this model through
`smpm.Lmq`, and the analysis reached it statically — no value has been observed
