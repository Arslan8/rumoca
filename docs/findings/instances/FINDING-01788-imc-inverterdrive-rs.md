# FINDING-01788: `aimcData.Rs` in `IMC_InverterDrive`
...
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0022](../../site-reports/SITE-0022-rs-physical-domain-unenforced.md) |
...
`aimcData.Rs`, and the analysis reached it statically — no value has been observed
