# FINDING-00747: `Nand.TP1.RDS` in `NandGate`
...
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0220](../../site-reports/SITE-0220-rds-physical-domain-unenforced.md) |
...
`Nand.TP1.RDS`, and the analysis reached it statically — no value has been observed
