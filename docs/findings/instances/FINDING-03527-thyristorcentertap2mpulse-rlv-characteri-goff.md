# FINDING-03527: `rectifier.thyristor_p.Goff` in `ThyristorCenterTap2mPulse_RLV_Characteristic`
...
`rectifier.thyristor_p.Goff`, and the analysis reached it statically — no value has been observed
