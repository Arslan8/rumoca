# FINDING-04730: `pipe.V_flowNominal` in `SimpleCooling`
...
| key | value |
|---|---|
| `parameter` | pipe.V_flowNominal |
| `shape` | direct |
| `path` | pipe.V_flowNominal |
| `declared_min` | None |
| `divisor_sites` | 1 |
...
`pipe.V_flowNominal`, and the analysis reached it statically — no value has been observed
