# FINDING-03780: `hbridge.inverter_n.transistor_n.Goff` in `HBridge_TrianglePWM_RL`
...
`hbridge.inverter_n.transistor_n.Goff`, and the analysis reached it statically — no value has been observed
