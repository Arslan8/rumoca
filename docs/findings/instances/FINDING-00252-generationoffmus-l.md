# FINDING-00252: `directInductor3.inductor.L` in `GenerationOfFMUs`
...
`directInductor3.inductor.L`, and the analysis reached it statically — no value has been observed
