# FINDING-01773: `inverter.diode_p.idealDiode[1].Goff` in `IMC_InverterDrive`
...
`inverter.diode_p.idealDiode[1].Goff`, and the analysis reached it statically — no value has been observed
