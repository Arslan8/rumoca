# FINDING-02256: `smee.Rrq` in `SMEE_Generator`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Machines.Examples.SynchronousMachines.SMEE_Generator` |
| **Reached as** | `smee.Rrq` |
| **Declaration** | `SM_ElectricalExcited.mo:73` |
| **Parameter** | `Rrq` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0346](../../site-reports/SITE-0346-rrq-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `SM_ElectricalExcited.mo:73` is reached by this model through
`smee.Rrq`, and the analysis reached it statically — no value has been observed
