# FINDING-03668: `chopperStepDown.GoffDiode` in `ChopperStepDown_RL`
...
| **Declaration** | `ChopperStepDown.mo:13` |
| **Parameter** | `GoffDiode` |
| **Claim** | the declaration explicitly permits zero (`min=0`) |
| **Kind** | `physical-bound-permits-zero` |
| **Severity** | low |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0275](../../site-reports/SITE-0275-goffdiode-physical-bound-permits-zero.md) |
...
One occurrence. The declaration at `ChopperStepDown.mo:13` is reached by this model through
`chopperStepDown.GoffDiode`, and the analysis reached it statically — no value has been observed
