# FINDING-03062: `RL` in `TransformerYY`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Polyphase.Examples.TransformerYY` |
| **Reached as** | `RL` |
| **Declaration** | `TransformerYY.mo:11` |
| **Parameter** | `RL` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0876](../../site-reports/SITE-0876-rl-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `TransformerYY.mo:11` is reached by this model through
