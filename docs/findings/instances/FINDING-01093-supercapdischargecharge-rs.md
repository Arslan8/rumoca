...
One occurrence. The declaration at `SuperCap.mo:9` is reached by this model through
`superCap.Rs`, and the analysis reached it statically — no value has been observed
