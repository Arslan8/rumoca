...
One occurrence. The declaration at `SM_ElectricalExcited.mo:57` is reached by this model through
`smee.Lrsigmad`, and the analysis reached it statically — no value has been observed
