# FINDING-03006: `idealDiode2.idealDiode[2].Goff` in `Rectifier`
...
`idealDiode2.idealDiode[2].Goff`, and the analysis reached it statically — no value has been observed
