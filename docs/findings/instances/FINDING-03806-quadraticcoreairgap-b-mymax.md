# FINDING-03806: `leftLeg.material.B_myMax` in `QuadraticCoreAirgap`
...
`leftLeg.material.B_myMax`, and the analysis reached it statically — no value has been observed
