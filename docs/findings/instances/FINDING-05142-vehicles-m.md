...
One occurrence. The declaration at `Vehicle.mo:3` is reached by this model through
`vehicleInclinationInConst.m`, and the analysis reached it statically — no value has been observed
