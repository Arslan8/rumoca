# FINDING-00081: `c5` in `CauerLowPassSC`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Analog.Examples.CauerLowPassSC` |
| **Reached as** | `c5` |
| **Declaration** | `CauerLowPassSC.mo:13` |
| **Parameter** | `c5` |
| **Claim** | the declaration explicitly permits zero (`min=0`) |
| **Kind** | `physical-bound-permits-zero` |
| **Severity** | low |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0582](../../site-reports/SITE-0582-c5-physical-bound-permits-zero.md) |
...
One occurrence. The declaration at `CauerLowPassSC.mo:13` is reached by this model through
