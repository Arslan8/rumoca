# FINDING-04147: `referenceSystem.pointMass1.m` in `PointGravityWithPointMasses2`
...
`referenceSystem.pointMass1.m`, and the analysis reached it statically — no value has been observed
