# FINDING-04260: `body2.body.I_33` in `PlanarFourbar`

| | |
|---|---|
| **Model** | `Modelica.Mechanics.MultiBody.Examples.Loops.PlanarFourbar` |
| **Reached as** | `body2.body.I_33` |
...
`body2.body.I_33`, and the analysis reached it statically — no value has been observed
