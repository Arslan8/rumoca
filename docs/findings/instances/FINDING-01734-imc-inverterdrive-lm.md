...
One occurrence. The declaration at `IM_SquirrelCage.mo:26` is reached by this model through
`aimc.Lm`, and the analysis reached it statically — no value has been observed
