# FINDING-04804: `ambient2.medium.cp` in `WaterPump`
...
| key | value |
|---|---|
| `parameter` | ambient2.medium.cp |
| `shape` | direct |
| `path` | ambient2.medium.cp |
| `declared_min` | None |
| `divisor_sites` | 2 |
...
`ambient2.medium.cp`, and the analysis reached it statically — no value has been observed
