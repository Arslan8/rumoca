...
One occurrence. The declaration at `SynchronousMachineData.mo:88` is reached by this model through
`smeeData.Rs`, and the analysis reached it statically — no value has been observed
