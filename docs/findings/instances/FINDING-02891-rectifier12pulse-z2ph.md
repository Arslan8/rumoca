...
One occurrence. The declaration at `TransformerData.mo:43` is reached by this model through
`transformerData2.Z2ph`, and the analysis reached it statically — no value has been observed
