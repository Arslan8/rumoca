# FINDING-03084: `rectifier.RonThyristor` in `HalfControlledBridge2Pulse`
...
| **Declaration** | `HalfControlledBridge2Pulse.mo:12` |
| **Parameter** | `RonThyristor` |
| **Claim** | the declaration explicitly permits zero (`min=0`) |
| **Kind** | `physical-bound-permits-zero` |
| **Severity** | low |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0609](../../site-reports/SITE-0609-ronthyristor-physical-bound-permits-zero.md) |
...
One occurrence. The declaration at `HalfControlledBridge2Pulse.mo:12` is reached by this model through
