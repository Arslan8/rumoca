# FINDING-01484: `dcee.core.coreParameters.GcRef` in `DC_CompareCharacteristics`
...
`dcee.core.coreParameters.GcRef`, and the analysis reached it statically — no value has been observed
