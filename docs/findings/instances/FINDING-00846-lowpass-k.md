# FINDING-00846: `firstOrder.k` in `LowPass`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Analog.Examples.OpAmps.LowPass` |
| **Reached as** | `firstOrder.k` |
...
| key | value |
|---|---|
| `parameter` | firstOrder.k |
| `shape` | propagated |
| `path` | firstOrder.k -> firstOrder.R2 |
| `declared_min` | 0.0 |
| `divisor_sites` | 2 |
...
`firstOrder.k`, and the analysis reached it statically — no value has been observed
