# FINDING-01895: `idealCommutingSwitch.idealCommutingSwitch[3].Ron` in `IMC_Transformer`
...
`idealCommutingSwitch.idealCommutingSwitch[3].Ron`, and the analysis reached it statically — no value has been observed
