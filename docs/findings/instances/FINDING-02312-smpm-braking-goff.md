# FINDING-02312: `diodeBridge2mPulse.diode_p.idealDiode[2].Goff` in `SMPM_Braking`
...
`diodeBridge2mPulse.diode_p.idealDiode[2].Goff`, and the analysis reached it statically — no value has been observed
