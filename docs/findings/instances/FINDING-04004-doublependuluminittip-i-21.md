# FINDING-04004: `boxBody2.body.I_21` in `DoublePendulumInitTip`

| | |
|---|---|
| **Model** | `Modelica.Mechanics.MultiBody.Examples.Elementary.DoublePendulumInitTip` |
| **Reached as** | `boxBody2.body.I_21` |
...
`boxBody2.body.I_21`, and the analysis reached it statically — no value has been observed
