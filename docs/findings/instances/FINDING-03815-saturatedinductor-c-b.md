# FINDING-03815: `r_mFe.material.c_b` in `SaturatedInductor`

| | |
|---|---|
| **Model** | `Modelica.Magnetic.FluxTubes.Examples.BasicExamples.SaturatedInductor` |
| **Reached as** | `r_mFe.material.c_b` |
...
| key | value |
|---|---|
| `parameter` | r_mFe.material.c_b |
| `shape` | sum |
| `path` | r_mFe.material.c_b |
| `declared_min` | None |
| `divisor_sites` | 1 |
...
`r_mFe.material.c_b`, and the analysis reached it statically — no value has been observed
