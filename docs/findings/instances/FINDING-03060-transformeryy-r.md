# FINDING-03060: `transformerR.R` in `TransformerYY`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Polyphase.Examples.TransformerYY` |
| **Reached as** | `transformerR.R` |
...
`transformerR.R`, and the analysis reached it statically — no value has been observed
