# FINDING-02302: `diodeBridge2mPulse.diode_n.idealDiode[1].Ron` in `SMPM_Braking`
...
`diodeBridge2mPulse.diode_n.idealDiode[1].Ron`, and the analysis reached it statically — no value has been observed
