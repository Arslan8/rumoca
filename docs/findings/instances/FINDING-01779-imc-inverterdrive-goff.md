# FINDING-01779: `inverter.transistor_p.idealGTOThyristor[1].Goff` in `IMC_InverterDrive`
...
`inverter.transistor_p.idealGTOThyristor[1].Goff`, and the analysis reached it statically — no value has been observed
