# FINDING-00246: `inverseCapacitor1.capacitor.C` in `GenerationOfFMUs`
...
`inverseCapacitor1.capacitor.C`, and the analysis reached it statically — no value has been observed
