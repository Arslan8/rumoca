# FINDING-03808: `rightLeg.material.B_myMax` in `QuadraticCoreAirgap`
...
| key | value |
|---|---|
| `parameter` | rightLeg.material.B_myMax |
| `shape` | direct |
| `path` | rightLeg.material.B_myMax |
| `declared_min` | None |
| `divisor_sites` | 1 |
...
`rightLeg.material.B_myMax`, and the analysis reached it statically — no value has been observed
