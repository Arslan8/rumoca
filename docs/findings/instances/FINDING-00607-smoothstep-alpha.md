# FINDING-00607: `oLine5.G[3].alpha` in `SmoothStep`
...
| key | value |
|---|---|
| `parameter` | oLine5.G[3].alpha |
| `shape` | sum |
| `path` | oLine5.G[3].alpha |
| `declared_min` | None |
| `divisor_sites` | 1 |
...
`oLine5.G[3].alpha`, and the analysis reached it statically — no value has been observed
