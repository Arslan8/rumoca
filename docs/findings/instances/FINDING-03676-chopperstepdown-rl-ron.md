# FINDING-03676: `chopperStepDown.diode.Ron` in `ChopperStepDown_RL`
...
`chopperStepDown.diode.Ron`, and the analysis reached it statically — no value has been observed
