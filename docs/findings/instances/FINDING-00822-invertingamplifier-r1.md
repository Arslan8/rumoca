...
One occurrence. The declaration at `Gain.mo:5` is reached by this model through
`gain.R1`, and the analysis reached it statically — no value has been observed
