# FINDING-01019: `simpleTriac.thyristor1.Ron` in `SimpleTriacCircuit`
...
`simpleTriac.thyristor1.Ron`, and the analysis reached it statically — no value has been observed
