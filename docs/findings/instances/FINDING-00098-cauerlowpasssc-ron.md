# FINDING-00098: `R4.IdealCommutingSwitch1.Ron` in `CauerLowPassSC`
...
`R4.IdealCommutingSwitch1.Ron`, and the analysis reached it statically — no value has been observed
