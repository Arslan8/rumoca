# FINDING-00033: `l1` in `CauerLowPassAnalog`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Analog.Examples.CauerLowPassAnalog` |
| **Reached as** | `l1` |
| **Declaration** | `CauerLowPassAnalog.mo:5` |
| **Parameter** | `l1` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0647](../../site-reports/SITE-0647-l1-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `CauerLowPassAnalog.mo:5` is reached by this model through
