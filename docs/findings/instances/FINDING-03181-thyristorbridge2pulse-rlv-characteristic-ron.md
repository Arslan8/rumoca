# FINDING-03181: `rectifier.thyristor_p2.Ron` in `ThyristorBridge2Pulse_RLV_Characteristic`
...
`rectifier.thyristor_p2.Ron`, and the analysis reached it statically — no value has been observed
