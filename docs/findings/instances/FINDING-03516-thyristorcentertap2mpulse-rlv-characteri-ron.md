# FINDING-03516: `rectifier.thyristor_p.idealThyristor[2].Ron` in `ThyristorCenterTap2mPulse_RLV_Characteristic`
...
`rectifier.thyristor_p.idealThyristor[2].Ron`, and the analysis reached it statically — no value has been observed
