...
One occurrence. The declaration at `DifferentialAmplifierData.mo:26` is reached by this model through
`data.RInstrument`, and the analysis reached it statically — no value has been observed
