...
One occurrence. The declaration at `IMC_InverterDrive.mo:12` is reached by this model through
`LGrid`, and the analysis reached it statically — no value has been observed
