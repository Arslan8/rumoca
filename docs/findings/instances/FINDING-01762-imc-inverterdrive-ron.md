# FINDING-01762: `inverter.transistor_p.idealGTOThyristor[2].Ron` in `IMC_InverterDrive`
...
`inverter.transistor_p.idealGTOThyristor[2].Ron`, and the analysis reached it statically — no value has been observed
