# FINDING-00090: `R10.IdealCommutingSwitch1.Ron` in `CauerLowPassSC`
...
`R10.IdealCommutingSwitch1.Ron`, and the analysis reached it statically — no value has been observed
