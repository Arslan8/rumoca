# FINDING-00388: `oLine2.G[2].T_ref` in `CompareLineTrunks`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Analog.Examples.Lines.CompareLineTrunks` |
| **Reached as** | `oLine2.G[2].T_ref` |
...
| key | value |
|---|---|
| `parameter` | oLine2.G[2].T_ref |
| `shape` | sum |
| `path` | oLine2.G[2].T_ref |
| `declared_min` | 0.0 |
| `divisor_sites` | 1 |
...
`oLine2.G[2].T_ref`, and the analysis reached it statically — no value has been observed
