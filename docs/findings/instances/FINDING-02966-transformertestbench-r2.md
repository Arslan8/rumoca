...
One occurrence. The declaration at `PartialBasicTransformer.mo:21` is reached by this model through
`transformer.R2`, and the analysis reached it statically — no value has been observed
