# FINDING-00642: `oLine50.G[3].alpha` in `SmoothStep`
...
| key | value |
|---|---|
| `parameter` | oLine50.G[3].alpha |
| `shape` | sum |
| `path` | oLine50.G[3].alpha |
| `declared_min` | None |
| `divisor_sites` | 1 |
...
`oLine50.G[3].alpha`, and the analysis reached it statically — no value has been observed
