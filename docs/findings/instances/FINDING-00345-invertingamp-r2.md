# FINDING-00345: `R2` in `InvertingAmp`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Analog.Examples.InvertingAmp` |
| **Reached as** | `R2` |
| **Declaration** | `InvertingAmp.mo:10` |
| **Parameter** | `R2` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0747](../../site-reports/SITE-0747-r2-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `InvertingAmp.mo:10` is reached by this model through
