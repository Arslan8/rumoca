# FINDING-03781: `hbridge.inverter_n.transistor_p.Goff` in `HBridge_TrianglePWM_RL`
...
`hbridge.inverter_n.transistor_p.Goff`, and the analysis reached it statically — no value has been observed
