# FINDING-00996: `simpleTriac.idealDiode.Ron` in `SimpleTriacCircuit`
...
`simpleTriac.idealDiode.Ron`, and the analysis reached it statically — no value has been observed
