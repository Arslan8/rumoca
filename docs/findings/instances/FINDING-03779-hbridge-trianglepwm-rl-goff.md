# FINDING-03779: `hbridge.inverter_n.diode_p.Goff` in `HBridge_TrianglePWM_RL`
...
`hbridge.inverter_n.diode_p.Goff`, and the analysis reached it statically — no value has been observed
