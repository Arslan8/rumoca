# FINDING-05107: `vehicleInclinationInVar.inertia.J` in `Vehicles`
...
`vehicleInclinationInVar.inertia.J`, and the analysis reached it statically — no value has been observed
