# FINDING-00030: `c3` in `CauerLowPassAnalog`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Analog.Examples.CauerLowPassAnalog` |
| **Reached as** | `c3` |
| **Declaration** | `CauerLowPassAnalog.mo:10` |
| **Parameter** | `c3` |
| **Claim** | the declaration explicitly permits zero (`min=0`) |
| **Kind** | `physical-bound-permits-zero` |
| **Severity** | low |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0568](../../site-reports/SITE-0568-c3-physical-bound-permits-zero.md) |
...
One occurrence. The declaration at `CauerLowPassAnalog.mo:10` is reached by this model through
`c3`, and the analysis reached it statically — no value has been observed
