# FINDING-04007: `boxBody1.body.I_32` in `DoublePendulumInitTip`

| | |
|---|---|
| **Model** | `Modelica.Mechanics.MultiBody.Examples.Elementary.DoublePendulumInitTip` |
| **Reached as** | `boxBody1.body.I_32` |
...
`boxBody1.body.I_32`, and the analysis reached it statically — no value has been observed
