# FINDING-03782: `hbridge.inverter_p.diode_n.Goff` in `HBridge_TrianglePWM_RL`
...
`hbridge.inverter_p.diode_n.Goff`, and the analysis reached it statically — no value has been observed
