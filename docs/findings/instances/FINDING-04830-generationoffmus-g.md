# FINDING-04830: `conductor.thermalConductor.G` in `GenerationOfFMUs`
...
`conductor.thermalConductor.G`, and the analysis reached it statically — no value has been observed
