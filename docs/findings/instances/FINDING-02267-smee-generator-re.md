...
One occurrence. The declaration at `SynchronousMachineData.mo:127` is reached by this model through
`smeeData.Re`, and the analysis reached it statically — no value has been observed
