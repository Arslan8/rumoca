# FINDING-03429: `rectifier.GoffThyristor` in `ThyristorCenterTap2Pulse_RLV_Characteristic`
...
| **Declaration** | `ThyristorCenterTap2Pulse.mo:8` |
| **Parameter** | `GoffThyristor` |
| **Claim** | the declaration explicitly permits zero (`min=0`) |
| **Kind** | `physical-bound-permits-zero` |
| **Severity** | low |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0156](../../site-reports/SITE-0156-goffthyristor-physical-bound-permits-zero.md) |
...
One occurrence. The declaration at `ThyristorCenterTap2Pulse.mo:8` is reached by this model through
