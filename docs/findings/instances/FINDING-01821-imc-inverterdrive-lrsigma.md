...
One occurrence. The declaration at `SquirrelCage.mo:3` is reached by this model through
`aimc.squirrelCageR.Lrsigma`, and the analysis reached it statically — no value has been observed
