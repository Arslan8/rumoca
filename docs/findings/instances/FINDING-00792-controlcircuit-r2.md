# FINDING-00792: `PIA.R2` in `ControlCircuit`
...
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0335](../../site-reports/SITE-0335-r2-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `PI.mo:7` is reached by this model through
`PIA.R2`, and the analysis reached it statically — no value has been observed
