# FINDING-04947: `smpm.Rs` in `SMPM_VoltageSourceWithLosses`

| | |
|---|---|
| **Model** | `ModelicaTest.Electrical.Machines.SMPM_VoltageSourceWithLosses` |
| **Reached as** | `smpm.Rs` |
| **Declaration** | `PartialBasicInductionMachine.mo:11` |
| **Parameter** | `Rs` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0016](../../site-reports/SITE-0016-rs-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `PartialBasicInductionMachine.mo:11` is reached by this model through
`smpm.Rs`, and the analysis reached it statically — no value has been observed
