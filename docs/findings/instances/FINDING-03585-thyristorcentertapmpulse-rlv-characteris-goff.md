# FINDING-03585: `rectifier.thyristor.idealThyristor[1].Goff` in `ThyristorCenterTapmPulse_RLV_Characteristic`
...
`rectifier.thyristor.idealThyristor[1].Goff`, and the analysis reached it statically — no value has been observed
