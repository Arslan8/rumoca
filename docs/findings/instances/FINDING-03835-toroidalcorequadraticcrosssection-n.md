# FINDING-03835: `core.material.n` in `ToroidalCoreQuadraticCrossSection`

| | |
|---|---|
| **Model** | `Modelica.Magnetic.FluxTubes.Examples.BasicExamples.ToroidalCoreQuadraticCrossSection` |
| **Reached as** | `core.material.n` |
...
| key | value |
|---|---|
| `parameter` | core.material.n |
| `shape` | sum |
| `path` | core.material.n |
| `declared_min` | None |
| `divisor_sites` | 1 |
...
`core.material.n`, and the analysis reached it statically — no value has been observed
