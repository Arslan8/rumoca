# FINDING-03512: `rectifier.thyristor_n.idealThyristor[1].Ron` in `ThyristorCenterTap2mPulse_RLV_Characteristic`
...
`rectifier.thyristor_n.idealThyristor[1].Ron`, and the analysis reached it statically — no value has been observed
