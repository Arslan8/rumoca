# FINDING-01495: `dcseData.coreParameters.m` in `DC_CompareCharacteristics`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Machines.Examples.DCMachines.DC_CompareCharacteristics` |
| **Reached as** | `dcseData.coreParameters.m` |
...
| key | value |
|---|---|
| `parameter` | dcseData.coreParameters.m |
| `shape` | direct |
| `path` | dcseData.coreParameters.m |
| `declared_min` | None |
| `divisor_sites` | 2 |
...
`dcseData.coreParameters.m`, and the analysis reached it statically — no value has been observed
