# FINDING-04946: `JLoad` in `SMPM_VoltageSourceWithLosses`

| | |
|---|---|
| **Model** | `ModelicaTest.Electrical.Machines.SMPM_VoltageSourceWithLosses` |
| **Reached as** | `JLoad` |
| **Declaration** | `Machines.mo:14` |
| **Parameter** | `JLoad` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0755](../../site-reports/SITE-0755-jload-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `Machines.mo:14` is reached by this model through
