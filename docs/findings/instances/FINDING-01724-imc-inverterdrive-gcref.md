# FINDING-01724: `aimc.statorCoreParameters.GcRef` in `IMC_InverterDrive`
...
`aimc.statorCoreParameters.GcRef`, and the analysis reached it statically — no value has been observed
