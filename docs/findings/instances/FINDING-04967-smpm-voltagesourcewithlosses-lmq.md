# FINDING-04967: `smpmData.Lmq` in `SMPM_VoltageSourceWithLosses`

| | |
|---|---|
| **Model** | `ModelicaTest.Electrical.Machines.SMPM_VoltageSourceWithLosses` |
| **Reached as** | `smpmData.Lmq` |
| **Declaration** | `SM_ReluctanceRotorData.mo:9` |
| **Parameter** | `Lmq` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0087](../../site-reports/SITE-0087-lmq-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `SM_ReluctanceRotorData.mo:9` is reached by this model through
`smpmData.Lmq`, and the analysis reached it statically — no value has been observed
