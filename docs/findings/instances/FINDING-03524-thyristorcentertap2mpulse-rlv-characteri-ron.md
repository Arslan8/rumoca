# FINDING-03524: `rectifier.thyristor_n.Ron` in `ThyristorCenterTap2mPulse_RLV_Characteristic`
...
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0030](../../site-reports/SITE-0030-ron-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `IdealThyristor.mo:4` is reached by this model through
`rectifier.thyristor_n.Ron`, and the analysis reached it statically — no value has been observed
