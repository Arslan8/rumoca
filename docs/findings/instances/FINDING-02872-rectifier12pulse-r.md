# FINDING-02872: `transformer1.r1.R` in `Rectifier12pulse`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Machines.Examples.Transformers.Rectifier12pulse` |
| **Reached as** | `transformer1.r1.R` |
...
`transformer1.r1.R`, and the analysis reached it statically — no value has been observed
