# FINDING-03521: `rectifier.thyristor_p.idealThyristor[1].Goff` in `ThyristorCenterTap2mPulse_RLV_Characteristic`
...
`rectifier.thyristor_p.idealThyristor[1].Goff`, and the analysis reached it statically — no value has been observed
