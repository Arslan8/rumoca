# FINDING-01490: `dcse.core.coreParameters.GcRef` in `DC_CompareCharacteristics`
...
`dcse.core.coreParameters.GcRef`, and the analysis reached it statically — no value has been observed
