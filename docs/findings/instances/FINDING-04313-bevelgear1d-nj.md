...
One occurrence. The declaration at `Rotor1D.mo:147` is reached by this model through
`inertia2.rotorWith3DEffects.nJ`, and the analysis reached it statically — no value has been observed
