...
One occurrence. The declaration at `Transformer.mo:6` is reached by this model through
`basicTransformer.M`, and the analysis reached it statically — no value has been observed
