# FINDING-04982: `rectifier.diode_n.idealDiode[2].Goff` in `HalfControlledBridge2mPulse`
...
`rectifier.diode_n.idealDiode[2].Goff`, and the analysis reached it statically — no value has been observed
