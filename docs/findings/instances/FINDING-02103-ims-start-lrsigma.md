...
One occurrence. The declaration at `IM_SlipRingData.mo:9` is reached by this model through
`aimsData.Lrsigma`, and the analysis reached it statically — no value has been observed
