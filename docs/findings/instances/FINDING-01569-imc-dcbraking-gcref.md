# FINDING-01569: `imcData.statorCoreParameters.GcRef` in `IMC_DCBraking`
...
`imcData.statorCoreParameters.GcRef`, and the analysis reached it statically — no value has been observed
