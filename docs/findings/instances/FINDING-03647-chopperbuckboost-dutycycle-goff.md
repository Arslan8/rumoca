# FINDING-03647: `dcdc.transistorLS.Goff` in `ChopperBuckBoost_DutyCycle`
...
`dcdc.transistorLS.Goff`, and the analysis reached it statically — no value has been observed
