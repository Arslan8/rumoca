# FINDING-03217: `rectifier.GoffDiode` in `HalfControlledBridge2mPulse`
...
| **Declaration** | `HalfControlledBridge2mPulse.mo:9` |
| **Parameter** | `GoffDiode` |
| **Claim** | the declaration explicitly permits zero (`min=0`) |
| **Kind** | `physical-bound-permits-zero` |
| **Severity** | low |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0287](../../site-reports/SITE-0287-goffdiode-physical-bound-permits-zero.md) |
...
One occurrence. The declaration at `HalfControlledBridge2mPulse.mo:9` is reached by this model through
`rectifier.GoffDiode`, and the analysis reached it statically — no value has been observed
