# FINDING-00972: `conductor1.T_ref` in `ResonanceCircuits`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Analog.Examples.ResonanceCircuits` |
| **Reached as** | `conductor1.T_ref` |
...
| key | value |
|---|---|
| `parameter` | conductor1.T_ref |
| `shape` | sum |
| `path` | conductor1.T_ref |
| `declared_min` | 0.0 |
| `divisor_sites` | 1 |
...
`conductor1.T_ref`, and the analysis reached it statically — no value has been observed
