# FINDING-01178: `volumeFlow.medium.rho` in `DCPM_Cooling`
...
| key | value |
|---|---|
| `parameter` | volumeFlow.medium.rho |
| `shape` | direct |
| `path` | volumeFlow.medium.rho |
| `declared_min` | 0.0 |
| `divisor_sites` | 1 |
...
`volumeFlow.medium.rho`, and the analysis reached it statically — no value has been observed
