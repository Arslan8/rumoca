# FINDING-03836: `airGap.material.B_myMax` in `ToroidalCoreQuadraticCrossSection`
...
| key | value |
|---|---|
| `parameter` | airGap.material.B_myMax |
| `shape` | direct |
| `path` | airGap.material.B_myMax |
| `declared_min` | None |
| `divisor_sites` | 1 |
...
`airGap.material.B_myMax`, and the analysis reached it statically — no value has been observed
