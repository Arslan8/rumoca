# FINDING-03783: `hbridge.inverter_p.diode_p.Goff` in `HBridge_TrianglePWM_RL`
...
`hbridge.inverter_p.diode_p.Goff`, and the analysis reached it statically — no value has been observed
