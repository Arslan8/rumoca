# FINDING-00826: `R1` in `InvertingSchmittTrigger`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Analog.Examples.OpAmps.InvertingSchmittTrigger` |
| **Reached as** | `R1` |
| **Declaration** | `InvertingSchmittTrigger.mo:10` |
| **Parameter** | `R1` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0749](../../site-reports/SITE-0749-r1-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `InvertingSchmittTrigger.mo:10` is reached by this model through
`R1`, and the analysis reached it statically — no value has been observed
