...
One occurrence. The declaration at `SwitchYD.mo:5` is reached by this model through
`switchYD.Goff`, and the analysis reached it statically — no value has been observed
