# FINDING-00104: `R8.IdealCommutingSwitch1.Ron` in `CauerLowPassSC`
...
`R8.IdealCommutingSwitch1.Ron`, and the analysis reached it statically — no value has been observed
