# FINDING-03093: `rectifier.diode_n2.Goff` in `HalfControlledBridge2Pulse`
...
`rectifier.diode_n2.Goff`, and the analysis reached it statically — no value has been observed
