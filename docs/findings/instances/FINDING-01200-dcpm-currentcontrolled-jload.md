# FINDING-01200: `JLoad` in `DCPM_CurrentControlled`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Machines.Examples.DCMachines.DCPM_CurrentControlled` |
| **Reached as** | `JLoad` |
| **Declaration** | `DCPM_CurrentControlled.mo:7` |
| **Parameter** | `JLoad` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0685](../../site-reports/SITE-0685-jload-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `DCPM_CurrentControlled.mo:7` is reached by this model through
