# FINDING-01525: `dcseData.La` in `DC_CompareCharacteristics`
...
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0048](../../site-reports/SITE-0048-la-physical-domain-unenforced.md) |
...
`dcseData.La`, and the analysis reached it statically — no value has been observed
