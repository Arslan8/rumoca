# FINDING-03433: `rectifier.GoffDiode` in `DiodeCenterTap2mPulse`
...
| **Declaration** | `DiodeCenterTap2mPulse.mo:8` |
| **Parameter** | `GoffDiode` |
| **Claim** | the declaration explicitly permits zero (`min=0`) |
| **Kind** | `physical-bound-permits-zero` |
| **Severity** | low |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0600](../../site-reports/SITE-0600-goffdiode-physical-bound-permits-zero.md) |
...
One occurrence. The declaration at `DiodeCenterTap2mPulse.mo:8` is reached by this model through
