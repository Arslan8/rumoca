# FINDING-03448: `rectifier.diode_p.idealDiode[1].Goff` in `DiodeCenterTap2mPulse`
...
`rectifier.diode_p.idealDiode[1].Goff`, and the analysis reached it statically — no value has been observed
