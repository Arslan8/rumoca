# FINDING-02496: `switch3.idealClosingSwitch[1].Ron` in `SMPM_ResistiveBraking`
...
`switch3.idealClosingSwitch[1].Ron`, and the analysis reached it statically — no value has been observed
