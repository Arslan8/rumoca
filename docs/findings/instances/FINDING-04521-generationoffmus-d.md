# FINDING-04521: `springDamper.d` in `GenerationOfFMUs`
...
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0223](../../site-reports/SITE-0223-d-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `SpringDamper.mo:6` is reached by this model through
`springDamper.d`, and the analysis reached it statically — no value has been observed
