# FINDING-02498: `switch3.idealClosingSwitch[3].Ron` in `SMPM_ResistiveBraking`
...
`switch3.idealClosingSwitch[3].Ron`, and the analysis reached it statically — no value has been observed
