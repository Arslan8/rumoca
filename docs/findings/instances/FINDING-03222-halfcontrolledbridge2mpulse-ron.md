# FINDING-03222: `rectifier.diode_n.idealDiode[3].Ron` in `HalfControlledBridge2mPulse`
...
`rectifier.diode_n.idealDiode[3].Ron`, and the analysis reached it statically — no value has been observed
