# FINDING-01771: `inverter.diode_n.idealDiode[2].Goff` in `IMC_InverterDrive`
...
`inverter.diode_n.idealDiode[2].Goff`, and the analysis reached it statically — no value has been observed
