# FINDING-03541: `rectifier.diode.idealDiode[3].Ron` in `DiodeCenterTapmPulse`
...
`rectifier.diode.idealDiode[3].Ron`, and the analysis reached it statically — no value has been observed
