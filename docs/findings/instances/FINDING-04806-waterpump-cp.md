# FINDING-04806: `oneWayValve.medium.cp` in `WaterPump`
...
| key | value |
|---|---|
| `parameter` | oneWayValve.medium.cp |
| `shape` | direct |
| `path` | oneWayValve.medium.cp |
| `declared_min` | None |
| `divisor_sites` | 2 |
...
`oneWayValve.medium.cp`, and the analysis reached it statically — no value has been observed
