# FINDING-04691: `speedRamp.duration` in `PumpAndValve`
...
| key | value |
|---|---|
| `parameter` | speedRamp.duration |
| `shape` | direct |
| `path` | speedRamp.duration |
| `declared_min` | 0.0 |
| `divisor_sites` | 1 |
...
`speedRamp.duration`, and the analysis reached it statically — no value has been observed
