# FINDING-03544: `rectifier.diode.idealDiode[3].Goff` in `DiodeCenterTapmPulse`
...
`rectifier.diode.idealDiode[3].Goff`, and the analysis reached it statically — no value has been observed
