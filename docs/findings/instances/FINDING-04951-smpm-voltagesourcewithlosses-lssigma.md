# FINDING-04951: `smpm.Lssigma` in `SMPM_VoltageSourceWithLosses`

| | |
|---|---|
| **Model** | `ModelicaTest.Electrical.Machines.SMPM_VoltageSourceWithLosses` |
| **Reached as** | `smpm.Lssigma` |
| **Declaration** | `PartialBasicInductionMachine.mo:23` |
| **Parameter** | `Lssigma` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0019](../../site-reports/SITE-0019-lssigma-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `PartialBasicInductionMachine.mo:23` is reached by this model through
`smpm.Lssigma`, and the analysis reached it statically — no value has been observed
