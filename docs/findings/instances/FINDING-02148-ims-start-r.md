# FINDING-02148: `switchedRheostat.rheostat.R` in `IMS_Start`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Machines.Examples.InductionMachines.IMS_Start` |
| **Reached as** | `switchedRheostat.rheostat.R` |
...
| `required` | switchedRheostat.rheostat.R > 0 |
| `declared_min` | None |
...
`switchedRheostat.rheostat.R`, and the analysis reached it statically — no value has been observed
