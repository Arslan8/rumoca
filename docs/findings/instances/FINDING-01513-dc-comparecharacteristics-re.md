...
One occurrence. The declaration at `DcElectricalExcitedData.mo:6` is reached by this model through
`dceeData.Re`, and the analysis reached it statically — no value has been observed
