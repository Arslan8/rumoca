...
One occurrence. The declaration at `PartialBasicMachine.mo:5` is reached by this model through
`dcpm.Jr`, and the analysis reached it statically — no value has been observed
