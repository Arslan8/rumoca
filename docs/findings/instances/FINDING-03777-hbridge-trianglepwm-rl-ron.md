# FINDING-03777: `hbridge.inverter_p.transistor_p.Ron` in `HBridge_TrianglePWM_RL`
...
`hbridge.inverter_p.transistor_p.Ron`, and the analysis reached it statically — no value has been observed
