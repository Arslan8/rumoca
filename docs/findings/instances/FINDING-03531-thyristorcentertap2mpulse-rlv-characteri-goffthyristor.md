# FINDING-03531: `rectifier.GoffThyristor` in `ThyristorCenterTap2mPulse_RLV_Characteristic`
...
| **Declaration** | `ThyristorCenterTap2mPulse.mo:9` |
| **Parameter** | `GoffThyristor` |
| **Claim** | the declaration explicitly permits zero (`min=0`) |
| **Kind** | `physical-bound-permits-zero` |
| **Severity** | low |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0158](../../site-reports/SITE-0158-goffthyristor-physical-bound-permits-zero.md) |
...
One occurrence. The declaration at `ThyristorCenterTap2mPulse.mo:9` is reached by this model through
