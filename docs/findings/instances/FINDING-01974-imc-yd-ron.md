# FINDING-01974: `switchYD.idealCloser.idealClosingSwitch[3].Ron` in `IMC_YD`
...
`switchYD.idealCloser.idealClosingSwitch[3].Ron`, and the analysis reached it statically — no value has been observed
