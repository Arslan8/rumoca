# FINDING-04258: `body4.body.I_22` in `PlanarFourbar`

| | |
|---|---|
| **Model** | `Modelica.Mechanics.MultiBody.Examples.Loops.PlanarFourbar` |
| **Reached as** | `body4.body.I_22` |
...
`body4.body.I_22`, and the analysis reached it statically — no value has been observed
