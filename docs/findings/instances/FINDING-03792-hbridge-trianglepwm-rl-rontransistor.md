# FINDING-03792: `hbridge.inverter_p.RonTransistor` in `HBridge_TrianglePWM_RL`
...
| **Declaration** | `SinglePhase2Level.mo:4` |
| **Parameter** | `RonTransistor` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0141](../../site-reports/SITE-0141-rontransistor-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `SinglePhase2Level.mo:4` is reached by this model through
`hbridge.inverter_p.RonTransistor`, and the analysis reached it statically — no value has been observed
