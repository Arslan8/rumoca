# FINDING-02873: `transformer1.r2.R` in `Rectifier12pulse`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Machines.Examples.Transformers.Rectifier12pulse` |
| **Reached as** | `transformer1.r2.R` |
...
`transformer1.r2.R`, and the analysis reached it statically — no value has been observed
