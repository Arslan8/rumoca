...
One occurrence. The declaration at `IdealTriac.mo:5` is reached by this model through
`idealTriac.Goff`, and the analysis reached it statically — no value has been observed
