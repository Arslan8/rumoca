# FINDING-02309: `diodeBridge2mPulse.diode_n.idealDiode[2].Goff` in `SMPM_Braking`
...
`diodeBridge2mPulse.diode_n.idealDiode[2].Goff`, and the analysis reached it statically — no value has been observed
