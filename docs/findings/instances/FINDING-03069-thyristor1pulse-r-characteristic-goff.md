# FINDING-03069: `idealthyristor.Goff` in `Thyristor1Pulse_R_Characteristic`
...
`idealthyristor.Goff`, and the analysis reached it statically — no value has been observed
