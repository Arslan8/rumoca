# FINDING-03188: `rectifier.RonThyristor` in `ThyristorBridge2Pulse_RLV_Characteristic`
...
| **Declaration** | `ThyristorBridge2Pulse.mo:5` |
| **Parameter** | `RonThyristor` |
| **Claim** | the declaration explicitly permits zero (`min=0`) |
| **Kind** | `physical-bound-permits-zero` |
| **Severity** | low |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0133](../../site-reports/SITE-0133-ronthyristor-physical-bound-permits-zero.md) |
...
One occurrence. The declaration at `ThyristorBridge2Pulse.mo:5` is reached by this model through
