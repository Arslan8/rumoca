...
| key | value |
|---|---|
| `parameter` | dcpmData.IaNominal |
| `shape` | propagated |
| `path` | dcpmData.IaNominal -> dcpmData.ViNominal -> dcpmData.coreParameters.VRef |
| `declared_min` | None |
| `divisor_sites` | 2 |
...
`dcpmData.IaNominal`, and the analysis reached it statically — no value has been observed
