# FINDING-03798: `rightLeg.material.c_b` in `QuadraticCoreAirgap`

| | |
|---|---|
| **Model** | `Modelica.Magnetic.FluxTubes.Examples.BasicExamples.QuadraticCoreAirgap` |
| **Reached as** | `rightLeg.material.c_b` |
...
| key | value |
|---|---|
| `parameter` | rightLeg.material.c_b |
| `shape` | sum |
| `path` | rightLeg.material.c_b |
| `declared_min` | None |
| `divisor_sites` | 1 |
...
`rightLeg.material.c_b`, and the analysis reached it statically — no value has been observed
