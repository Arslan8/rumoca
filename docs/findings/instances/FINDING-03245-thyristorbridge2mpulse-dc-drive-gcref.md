# FINDING-03245: `dcpmData.coreParameters.GcRef` in `ThyristorBridge2mPulse_DC_Drive`
...
`dcpmData.coreParameters.GcRef`, and the analysis reached it statically — no value has been observed
