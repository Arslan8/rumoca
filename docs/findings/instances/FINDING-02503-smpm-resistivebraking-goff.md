# FINDING-02503: `switch3.idealClosingSwitch[2].Goff` in `SMPM_ResistiveBraking`
...
`switch3.idealClosingSwitch[2].Goff`, and the analysis reached it statically — no value has been observed
