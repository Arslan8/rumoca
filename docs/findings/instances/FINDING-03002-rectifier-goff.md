# FINDING-03002: `idealDiode1.idealDiode[1].Goff` in `Rectifier`
...
`idealDiode1.idealDiode[1].Goff`, and the analysis reached it statically — no value has been observed
