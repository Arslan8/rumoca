# FINDING-03073: `rectifier.GoffDiode` in `DiodeBridge2Pulse`
...
| **Declaration** | `DiodeBridge2Pulse.mo:7` |
| **Parameter** | `GoffDiode` |
| **Claim** | the declaration explicitly permits zero (`min=0`) |
| **Kind** | `physical-bound-permits-zero` |
| **Severity** | low |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0596](../../site-reports/SITE-0596-goffdiode-physical-bound-permits-zero.md) |
...
One occurrence. The declaration at `DiodeBridge2Pulse.mo:7` is reached by this model through
