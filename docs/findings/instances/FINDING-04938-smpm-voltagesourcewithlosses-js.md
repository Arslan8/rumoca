# FINDING-04938: `smpmData.Js` in `SMPM_VoltageSourceWithLosses`

| | |
|---|---|
| **Model** | `ModelicaTest.Electrical.Machines.SMPM_VoltageSourceWithLosses` |
| **Reached as** | `smpmData.Js` |
| **Declaration** | `InductionMachineData.mo:7` |
| **Parameter** | `Js` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0026](../../site-reports/SITE-0026-js-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `InductionMachineData.mo:7` is reached by this model through
`smpmData.Js`, and the analysis reached it statically — no value has been observed
