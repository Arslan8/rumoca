# FINDING-03797: `lowerYoke.material.c_b` in `QuadraticCoreAirgap`

| | |
|---|---|
| **Model** | `Modelica.Magnetic.FluxTubes.Examples.BasicExamples.QuadraticCoreAirgap` |
| **Reached as** | `lowerYoke.material.c_b` |
...
| key | value |
|---|---|
| `parameter` | lowerYoke.material.c_b |
| `shape` | sum |
| `path` | lowerYoke.material.c_b |
| `declared_min` | None |
| `divisor_sites` | 1 |
...
`lowerYoke.material.c_b`, and the analysis reached it statically — no value has been observed
