# FINDING-00378: `z0` in `CompareLineTrunks`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Analog.Examples.Lines.CompareLineTrunks` |
| **Reached as** | `z0` |
| **Declaration** | `CompareLineTrunks.mo:15` |
| **Parameter** | `z0` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0666](../../site-reports/SITE-0666-z0-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `CompareLineTrunks.mo:15` is reached by this model through
