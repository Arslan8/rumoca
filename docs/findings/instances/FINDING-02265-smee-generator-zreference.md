# FINDING-02265: `smeeData.ZReference` in `SMEE_Generator`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Machines.Examples.SynchronousMachines.SMEE_Generator` |
| **Reached as** | `smeeData.ZReference` |
| **Declaration** | `SynchronousMachineData.mo:12` |
| **Parameter** | `ZReference` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0359](../../site-reports/SITE-0359-zreference-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `SynchronousMachineData.mo:12` is reached by this model through
`smeeData.ZReference`, and the analysis reached it statically — no value has been observed
