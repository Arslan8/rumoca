# FINDING-01777: `inverter.transistor_n.idealGTOThyristor[2].Goff` in `IMC_InverterDrive`
...
`inverter.transistor_n.idealGTOThyristor[2].Goff`, and the analysis reached it statically — no value has been observed
