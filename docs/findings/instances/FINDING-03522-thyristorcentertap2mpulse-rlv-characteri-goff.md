# FINDING-03522: `rectifier.thyristor_p.idealThyristor[2].Goff` in `ThyristorCenterTap2mPulse_RLV_Characteristic`
...
`rectifier.thyristor_p.idealThyristor[2].Goff`, and the analysis reached it statically — no value has been observed
