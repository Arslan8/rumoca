...
One occurrence. The declaration at `SM_ReluctanceRotor.mo:62` is reached by this model through
`smr.Rrd`, and the analysis reached it statically — no value has been observed
