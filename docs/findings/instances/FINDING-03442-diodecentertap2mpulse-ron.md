# FINDING-03442: `rectifier.diode_p.idealDiode[1].Ron` in `DiodeCenterTap2mPulse`
...
`rectifier.diode_p.idealDiode[1].Ron`, and the analysis reached it statically — no value has been observed
