# FINDING-02983: `transformerData.L2sigma` in `TransformerTestbench`
...
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0121](../../site-reports/SITE-0121-l2sigma-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `TransformerData.mo:48` is reached by this model through
`transformerData.L2sigma`, and the analysis reached it statically — no value has been observed
