# FINDING-03281: `dcpm.inertiaStator.J` in `ThyristorBridge2mPulse_DC_Drive`
...
`dcpm.inertiaStator.J`, and the analysis reached it statically — no value has been observed
