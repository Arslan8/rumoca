# FINDING-01752: `inverter.diode_n.idealDiode[1].Ron` in `IMC_InverterDrive`
...
`inverter.diode_n.idealDiode[1].Ron`, and the analysis reached it statically — no value has been observed
