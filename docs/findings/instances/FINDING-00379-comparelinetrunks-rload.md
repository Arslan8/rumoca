# FINDING-00379: `Rload` in `CompareLineTrunks`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Analog.Examples.Lines.CompareLineTrunks` |
| **Reached as** | `Rload` |
| **Declaration** | `CompareLineTrunks.mo:6` |
| **Parameter** | `Rload` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0667](../../site-reports/SITE-0667-rload-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `CompareLineTrunks.mo:6` is reached by this model through
`Rload`, and the analysis reached it statically — no value has been observed
