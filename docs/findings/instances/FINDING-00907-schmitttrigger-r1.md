# FINDING-00907: `R1` in `SchmittTrigger`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Analog.Examples.OpAmps.SchmittTrigger` |
| **Reached as** | `R1` |
| **Declaration** | `SchmittTrigger.mo:10` |
| **Parameter** | `R1` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0792](../../site-reports/SITE-0792-r1-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `SchmittTrigger.mo:10` is reached by this model through
