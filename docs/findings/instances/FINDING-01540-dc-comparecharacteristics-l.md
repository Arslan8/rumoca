...
One occurrence. The declaration at `InductorDC.mo:5` is reached by this model through
`dcse.lesigma.L`, and the analysis reached it statically — no value has been observed
