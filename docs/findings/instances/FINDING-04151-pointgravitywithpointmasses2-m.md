# FINDING-04151: `referenceSystem.pointMass5.m` in `PointGravityWithPointMasses2`
...
`referenceSystem.pointMass5.m`, and the analysis reached it statically — no value has been observed
