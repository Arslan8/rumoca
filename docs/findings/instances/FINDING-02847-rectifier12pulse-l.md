# FINDING-02847: `transformer1.l1sigma.inductor[2].L` in `Rectifier12pulse`
...
`transformer1.l1sigma.inductor[2].L`, and the analysis reached it statically — no value has been observed
