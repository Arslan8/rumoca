# FINDING-04084: `body.body.I_11` in `InitSpringConstant`

| | |
|---|---|
| **Model** | `Modelica.Mechanics.MultiBody.Examples.Elementary.InitSpringConstant` |
| **Reached as** | `body.body.I_11` |
...
`body.body.I_11`, and the analysis reached it statically — no value has been observed
