# FINDING-05106: `vehicleInclinationInConst.inertia.J` in `Vehicles`
...
`vehicleInclinationInConst.inertia.J`, and the analysis reached it statically — no value has been observed
