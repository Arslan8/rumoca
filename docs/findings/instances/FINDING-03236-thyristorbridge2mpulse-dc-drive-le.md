# FINDING-03236: `dcpm.airGapDC.Le` in `ThyristorBridge2mPulse_DC_Drive`
...
| **Declaration** | `AirGapDC.mo:4` |
| **Parameter** | `Le` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0046](../../site-reports/SITE-0046-le-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `AirGapDC.mo:4` is reached by this model through
`dcpm.airGapDC.Le`, and the analysis reached it statically — no value has been observed
