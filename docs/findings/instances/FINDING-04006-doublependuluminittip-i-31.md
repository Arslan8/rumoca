# FINDING-04006: `boxBody2.body.I_31` in `DoublePendulumInitTip`

| | |
|---|---|
| **Model** | `Modelica.Mechanics.MultiBody.Examples.Elementary.DoublePendulumInitTip` |
| **Reached as** | `boxBody2.body.I_31` |
...
`boxBody2.body.I_31`, and the analysis reached it statically — no value has been observed
