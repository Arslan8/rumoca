# FINDING-00080: `c4` in `CauerLowPassSC`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Analog.Examples.CauerLowPassSC` |
| **Reached as** | `c4` |
| **Declaration** | `CauerLowPassSC.mo:11` |
| **Parameter** | `c4` |
| **Claim** | the declaration explicitly permits zero (`min=0`) |
| **Kind** | `physical-bound-permits-zero` |
| **Severity** | low |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0581](../../site-reports/SITE-0581-c4-physical-bound-permits-zero.md) |
...
One occurrence. The declaration at `CauerLowPassSC.mo:11` is reached by this model through
