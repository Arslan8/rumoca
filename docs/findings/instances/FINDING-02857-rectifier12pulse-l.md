# FINDING-02857: `transformer2.l2sigma.inductor[3].L` in `Rectifier12pulse`
...
`transformer2.l2sigma.inductor[3].L`, and the analysis reached it statically — no value has been observed
