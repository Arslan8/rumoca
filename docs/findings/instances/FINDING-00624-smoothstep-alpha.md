# FINDING-00624: `oLine50.G[23].alpha` in `SmoothStep`
...
| key | value |
|---|---|
| `parameter` | oLine50.G[23].alpha |
| `shape` | sum |
| `path` | oLine50.G[23].alpha |
| `declared_min` | None |
| `divisor_sites` | 1 |
...
`oLine50.G[23].alpha`, and the analysis reached it statically — no value has been observed
