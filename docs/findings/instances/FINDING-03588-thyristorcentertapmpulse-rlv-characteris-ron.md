# FINDING-03588: `rectifier.thyristor.Ron` in `ThyristorCenterTapmPulse_RLV_Characteristic`
...
`rectifier.thyristor.Ron`, and the analysis reached it statically — no value has been observed
