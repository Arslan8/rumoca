...
One occurrence. The declaration at `SM_ReluctanceRotor.mo:45` is reached by this model through
`smr.Lmq`, and the analysis reached it statically — no value has been observed
