# FINDING-03444: `rectifier.diode_p.idealDiode[3].Ron` in `DiodeCenterTap2mPulse`
...
`rectifier.diode_p.idealDiode[3].Ron`, and the analysis reached it statically — no value has been observed
