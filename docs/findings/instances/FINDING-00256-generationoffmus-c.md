...
One occurrence. The declaration at `InverseCapacitor.mo:4` is reached by this model through
`inverseCapacitor1.C`, and the analysis reached it statically — no value has been observed
