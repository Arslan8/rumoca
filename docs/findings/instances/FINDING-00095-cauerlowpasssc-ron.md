# FINDING-00095: `R2.IdealCommutingSwitch2.Ron` in `CauerLowPassSC`
...
`R2.IdealCommutingSwitch2.Ron`, and the analysis reached it statically — no value has been observed
