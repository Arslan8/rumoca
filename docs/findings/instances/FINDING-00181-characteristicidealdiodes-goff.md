# FINDING-00181: `With_Ron_Goff_Vknee.Goff` in `CharacteristicIdealDiodes`
...
`With_Ron_Goff_Vknee.Goff`, and the analysis reached it statically — no value has been observed
