# FINDING-03771: `hbridge.inverter_n.diode_p.Ron` in `HBridge_TrianglePWM_RL`
...
`hbridge.inverter_n.diode_p.Ron`, and the analysis reached it statically — no value has been observed
