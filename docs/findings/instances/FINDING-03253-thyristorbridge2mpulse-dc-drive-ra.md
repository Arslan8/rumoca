# FINDING-03253: `dcpmData.Ra` in `ThyristorBridge2mPulse_DC_Drive`
...
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0047](../../site-reports/SITE-0047-ra-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `DcPermanentMagnetData.mo:19` is reached by this model through
`dcpmData.Ra`, and the analysis reached it statically — no value has been observed
