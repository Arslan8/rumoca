# FINDING-03819: `r_mFe.material.B_myMax` in `SaturatedInductor`
...
| key | value |
|---|---|
| `parameter` | r_mFe.material.B_myMax |
| `shape` | direct |
| `path` | r_mFe.material.B_myMax |
| `declared_min` | None |
| `divisor_sites` | 1 |
...
`r_mFe.material.B_myMax`, and the analysis reached it statically — no value has been observed
