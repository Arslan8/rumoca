# FINDING-02089: `aims.statorCoreParameters.GcRef` in `IMS_Start`
...
`aims.statorCoreParameters.GcRef`, and the analysis reached it statically — no value has been observed
