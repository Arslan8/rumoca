# FINDING-03542: `rectifier.diode.idealDiode[1].Goff` in `DiodeCenterTapmPulse`
...
`rectifier.diode.idealDiode[1].Goff`, and the analysis reached it statically — no value has been observed
