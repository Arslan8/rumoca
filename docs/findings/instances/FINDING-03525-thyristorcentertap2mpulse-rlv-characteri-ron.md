# FINDING-03525: `rectifier.thyristor_p.Ron` in `ThyristorCenterTap2mPulse_RLV_Characteristic`
...
`rectifier.thyristor_p.Ron`, and the analysis reached it statically — no value has been observed
