# FINDING-01375: `dcpmData2.coreParameters.m` in `DCPM_withLosses`
...
| key | value |
|---|---|
| `parameter` | dcpmData2.coreParameters.m |
| `shape` | direct |
| `path` | dcpmData2.coreParameters.m |
| `declared_min` | None |
| `divisor_sites` | 2 |
...
`dcpmData2.coreParameters.m`, and the analysis reached it statically — no value has been observed
