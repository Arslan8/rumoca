# FINDING-03387: `rectifier.GoffThyristor` in `ThyristorBridge2mPulse_RLV_Characteristic`
...
| **Declaration** | `ThyristorBridge2mPulse.mo:8` |
| **Parameter** | `GoffThyristor` |
| **Claim** | the declaration explicitly permits zero (`min=0`) |
| **Kind** | `physical-bound-permits-zero` |
| **Severity** | low |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0110](../../site-reports/SITE-0110-goffthyristor-physical-bound-permits-zero.md) |
...
One occurrence. The declaration at `ThyristorBridge2mPulse.mo:8` is reached by this model through
