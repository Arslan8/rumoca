# FINDING-01725: `aimcData.statorCoreParameters.GcRef` in `IMC_InverterDrive`
...
`aimcData.statorCoreParameters.GcRef`, and the analysis reached it statically — no value has been observed
