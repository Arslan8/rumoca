# FINDING-00093: `R11.IdealCommutingSwitch2.Ron` in `CauerLowPassSC`
...
`R11.IdealCommutingSwitch2.Ron`, and the analysis reached it statically — no value has been observed
