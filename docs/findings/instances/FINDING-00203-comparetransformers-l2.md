...
One occurrence. The declaration at `Transformer.mo:5` is reached by this model through
`basicTransformer.L2`, and the analysis reached it statically — no value has been observed
