# FINDING-04580: `outerPump.flowPort_b.medium.rho` in `IndirectCooling`
...
`outerPump.flowPort_b.medium.rho`, and the analysis reached it statically — no value has been observed
