# FINDING-03044: `RL` in `TransformerYD`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Polyphase.Examples.TransformerYD` |
| **Reached as** | `RL` |
| **Declaration** | `TransformerYD.mo:11` |
| **Parameter** | `RL` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0872](../../site-reports/SITE-0872-rl-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `TransformerYD.mo:11` is reached by this model through
