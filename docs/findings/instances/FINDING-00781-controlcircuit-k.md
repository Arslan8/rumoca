# FINDING-00781: `firstOrder2A.k` in `ControlCircuit`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Analog.Examples.OpAmps.ControlCircuit` |
| **Reached as** | `firstOrder2A.k` |
...
| key | value |
|---|---|
| `parameter` | firstOrder2A.k |
| `shape` | propagated |
| `path` | firstOrder2A.k -> firstOrder2A.R2 |
| `declared_min` | 0.0 |
| `divisor_sites` | 2 |
...
`firstOrder2A.k`, and the analysis reached it statically — no value has been observed
