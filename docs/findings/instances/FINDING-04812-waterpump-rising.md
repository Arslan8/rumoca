# FINDING-04812: `trapezoid.rising` in `WaterPump`
...
| key | value |
|---|---|
| `parameter` | trapezoid.rising |
| `shape` | direct |
| `path` | trapezoid.rising |
| `declared_min` | 0.0 |
| `divisor_sites` | 1 |
...
`trapezoid.rising`, and the analysis reached it statically — no value has been observed
