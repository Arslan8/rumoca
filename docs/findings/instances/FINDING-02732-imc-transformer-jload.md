# FINDING-02732: `JLoad` in `IMC_Transformer`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Machines.Examples.Transformers.IMC_Transformer` |
| **Reached as** | `JLoad` |
| **Declaration** | `IMC_Transformer.mo:15` |
| **Parameter** | `JLoad` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0330](../../site-reports/SITE-0330-jload-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `IMC_Transformer.mo:15` is reached by this model through
