# FINDING-03911: `G_mLeakRad.material.c_b` in `AdvancedSolenoid`

| | |
|---|---|
| **Model** | `Modelica.Magnetic.FluxTubes.Examples.SolenoidActuator.Components.AdvancedSolenoid` |
| **Reached as** | `G_mLeakRad.material.c_b` |
...
| key | value |
|---|---|
| `parameter` | G_mLeakRad.material.c_b |
| `shape` | sum |
| `path` | G_mLeakRad.material.c_b |
| `declared_min` | None |
| `divisor_sites` | 1 |
...
`G_mLeakRad.material.c_b`, and the analysis reached it statically — no value has been observed
