# FINDING-03428: `rectifier.RonThyristor` in `ThyristorCenterTap2Pulse_RLV_Characteristic`
...
| **Declaration** | `ThyristorCenterTap2Pulse.mo:6` |
| **Parameter** | `RonThyristor` |
| **Claim** | the declaration explicitly permits zero (`min=0`) |
| **Kind** | `physical-bound-permits-zero` |
| **Severity** | low |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0155](../../site-reports/SITE-0155-ronthyristor-physical-bound-permits-zero.md) |
...
One occurrence. The declaration at `ThyristorCenterTap2Pulse.mo:6` is reached by this model through
