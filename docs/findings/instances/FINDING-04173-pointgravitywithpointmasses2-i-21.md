# FINDING-04173: `referenceSystem.pointMass3.I_21` in `PointGravityWithPointMasses2`

| | |
|---|---|
| **Model** | `Modelica.Mechanics.MultiBody.Examples.Elementary.PointGravityWithPointMasses2` |
| **Reached as** | `referenceSystem.pointMass3.I_21` |
...
| `required` | referenceSystem.pointMass3.I_21 > 0 |
...
`referenceSystem.pointMass3.I_21`, and the analysis reached it statically — no value has been observed
