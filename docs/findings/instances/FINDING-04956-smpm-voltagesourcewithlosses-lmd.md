# FINDING-04956: `smpm.Lmd` in `SMPM_VoltageSourceWithLosses`

| | |
|---|---|
| **Model** | `ModelicaTest.Electrical.Machines.SMPM_VoltageSourceWithLosses` |
| **Reached as** | `smpm.Lmd` |
| **Declaration** | `SM_PermanentMagnet.mo:50` |
| **Parameter** | `Lmd` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0095](../../site-reports/SITE-0095-lmd-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `SM_PermanentMagnet.mo:50` is reached by this model through
`smpm.Lmd`, and the analysis reached it statically — no value has been observed
