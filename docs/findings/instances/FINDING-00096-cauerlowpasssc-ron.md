# FINDING-00096: `R3.IdealCommutingSwitch1.Ron` in `CauerLowPassSC`
...
`R3.IdealCommutingSwitch1.Ron`, and the analysis reached it statically — no value has been observed
