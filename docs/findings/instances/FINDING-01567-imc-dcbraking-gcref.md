# FINDING-01567: `imc.statorCore.coreParameters.GcRef` in `IMC_DCBraking`
...
`imc.statorCore.coreParameters.GcRef`, and the analysis reached it statically — no value has been observed
