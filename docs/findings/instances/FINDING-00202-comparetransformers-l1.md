...
One occurrence. The declaration at `Transformer.mo:4` is reached by this model through
`basicTransformer.L1`, and the analysis reached it statically — no value has been observed
