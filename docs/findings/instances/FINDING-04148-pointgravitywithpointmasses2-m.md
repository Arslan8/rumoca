# FINDING-04148: `referenceSystem.pointMass2.m` in `PointGravityWithPointMasses2`
...
`referenceSystem.pointMass2.m`, and the analysis reached it statically — no value has been observed
