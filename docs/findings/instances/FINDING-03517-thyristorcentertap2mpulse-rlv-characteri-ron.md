# FINDING-03517: `rectifier.thyristor_p.idealThyristor[3].Ron` in `ThyristorCenterTap2mPulse_RLV_Characteristic`
...
`rectifier.thyristor_p.idealThyristor[3].Ron`, and the analysis reached it statically — no value has been observed
