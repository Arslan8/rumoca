# FINDING-02984: `transformerData.V1` in `TransformerTestbench`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Machines.Examples.Transformers.TransformerTestbench` |
| **Reached as** | `transformerData.V1` |
...
| key | value |
|---|---|
| `parameter` | transformerData.V1 |
| `shape` | propagated |
| `path` | transformerData.V1 -> transformerData.V1ph |
| `declared_min` | None |
| `divisor_sites` | 6 |
...
`transformerData.V1`, and the analysis reached it statically — no value has been observed
