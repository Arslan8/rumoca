# FINDING-03515: `rectifier.thyristor_p.idealThyristor[1].Ron` in `ThyristorCenterTap2mPulse_RLV_Characteristic`
...
`rectifier.thyristor_p.idealThyristor[1].Ron`, and the analysis reached it statically — no value has been observed
