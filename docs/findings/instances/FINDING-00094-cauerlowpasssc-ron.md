# FINDING-00094: `R2.IdealCommutingSwitch1.Ron` in `CauerLowPassSC`
...
`R2.IdealCommutingSwitch1.Ron`, and the analysis reached it statically — no value has been observed
