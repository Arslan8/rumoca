# FINDING-01774: `inverter.diode_p.idealDiode[2].Goff` in `IMC_InverterDrive`
...
`inverter.diode_p.idealDiode[2].Goff`, and the analysis reached it statically — no value has been observed
