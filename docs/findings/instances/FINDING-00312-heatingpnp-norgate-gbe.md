# FINDING-00312: `T1.Gbe` in `HeatingPNP_NORGate`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Analog.Examples.HeatingPNP_NORGate` |
| **Reached as** | `T1.Gbe` |
| **Declaration** | `PNP.mo:17` |
| **Parameter** | `Gbe` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0763](../../site-reports/SITE-0763-gbe-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `PNP.mo:17` is reached by this model through
`T1.Gbe`, and the analysis reached it statically — no value has been observed
