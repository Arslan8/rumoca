# FINDING-03513: `rectifier.thyristor_n.idealThyristor[2].Ron` in `ThyristorCenterTap2mPulse_RLV_Characteristic`
...
`rectifier.thyristor_n.idealThyristor[2].Ron`, and the analysis reached it statically — no value has been observed
