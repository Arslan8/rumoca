# FINDING-00340: `idealTriac.idealThyristor1.Goff` in `IdealTriacCircuit`
...
`idealTriac.idealThyristor1.Goff`, and the analysis reached it statically — no value has been observed
