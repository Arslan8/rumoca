# FINDING-03638: `dcdc.GoffTransistor` in `ChopperBuckBoost_DutyCycle`
...
| **Declaration** | `ChopperBuckBoost.mo:8` |
| **Parameter** | `GoffTransistor` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0656](../../site-reports/SITE-0656-gofftransistor-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `ChopperBuckBoost.mo:8` is reached by this model through
`dcdc.GoffTransistor`, and the analysis reached it statically — no value has been observed
