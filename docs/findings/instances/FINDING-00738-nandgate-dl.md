# FINDING-00738: `Nand.TN2.dL` in `NandGate`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Analog.Examples.NandGate` |
| **Reached as** | `Nand.TN2.dL` |
...
`Nand.TN2.dL`, and the analysis reached it statically — no value has been observed
