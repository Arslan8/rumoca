# FINDING-03625: `R` in `SinglePhaseTwoLevel_RL`
...
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0805](../../site-reports/SITE-0805-r-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `SinglePhaseTwoLevel_RL.mo:9` is reached by this model through
