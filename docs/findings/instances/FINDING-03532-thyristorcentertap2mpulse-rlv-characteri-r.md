# FINDING-03532: `R` in `ThyristorCenterTap2mPulse_RLV_Characteristic`
...
| **Reached as** | `R` |
| **Declaration** | `ThyristorCenterTap2mPulse_RLV_Characteristic.mo:8` |
| **Parameter** | `R` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0858](../../site-reports/SITE-0858-r-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `ThyristorCenterTap2mPulse_RLV_Characteristic.mo:8` is reached by this model through
