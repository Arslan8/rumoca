# FINDING-03383: `multiStarResistance.R` in `ThyristorBridge2mPulse_RLV_Characteristic`
...
| **Declaration** | `MultiStarResistance.mo:6` |
| **Parameter** | `R` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0081](../../site-reports/SITE-0081-r-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `MultiStarResistance.mo:6` is reached by this model through
`multiStarResistance.R`, and the analysis reached it statically — no value has been observed
