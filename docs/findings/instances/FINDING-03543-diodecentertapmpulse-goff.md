# FINDING-03543: `rectifier.diode.idealDiode[2].Goff` in `DiodeCenterTapmPulse`
...
`rectifier.diode.idealDiode[2].Goff`, and the analysis reached it statically — no value has been observed
