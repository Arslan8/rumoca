# FINDING-02251: `smee.Lmd` in `SMEE_Generator`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Machines.Examples.SynchronousMachines.SMEE_Generator` |
| **Reached as** | `smee.Lmd` |
| **Declaration** | `SM_ElectricalExcited.mo:48` |
| **Parameter** | `Lmd` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0341](../../site-reports/SITE-0341-lmd-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `SM_ElectricalExcited.mo:48` is reached by this model through
`smee.Lmd`, and the analysis reached it statically — no value has been observed
