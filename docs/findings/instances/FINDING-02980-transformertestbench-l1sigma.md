# FINDING-02980: `transformerData.L1sigma` in `TransformerTestbench`
...
`transformerData.L1sigma`, and the analysis reached it statically — no value has been observed
