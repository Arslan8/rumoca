# FINDING-03184: `rectifier.thyristor_p1.Goff` in `ThyristorBridge2Pulse_RLV_Characteristic`
...
`rectifier.thyristor_p1.Goff`, and the analysis reached it statically — no value has been observed
