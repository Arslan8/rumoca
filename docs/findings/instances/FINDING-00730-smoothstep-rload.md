# FINDING-00730: `Rload` in `SmoothStep`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Analog.Examples.Lines.SmoothStep` |
| **Reached as** | `Rload` |
| **Declaration** | `SmoothStep.mo:6` |
| **Parameter** | `Rload` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0807](../../site-reports/SITE-0807-rload-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `SmoothStep.mo:6` is reached by this model through
