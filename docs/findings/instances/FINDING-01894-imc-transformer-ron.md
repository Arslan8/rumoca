# FINDING-01894: `idealCommutingSwitch.idealCommutingSwitch[2].Ron` in `IMC_Transformer`
...
`idealCommutingSwitch.idealCommutingSwitch[2].Ron`, and the analysis reached it statically — no value has been observed
