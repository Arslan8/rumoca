# FINDING-03046: `Lm` in `TransformerYD`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Polyphase.Examples.TransformerYD` |
| **Reached as** | `Lm` |
| **Declaration** | `TransformerYD.mo:7` |
| **Parameter** | `Lm` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0873](../../site-reports/SITE-0873-lm-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `TransformerYD.mo:7` is reached by this model through
