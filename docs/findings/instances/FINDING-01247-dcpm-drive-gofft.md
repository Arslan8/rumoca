# FINDING-01247: `dcdcInverter1.GoffT` in `DCPM_Drive`
...
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0320](../../site-reports/SITE-0320-gofft-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `DcdcInverter.mo:13` is reached by this model through
`dcdcInverter1.GoffT`, and the analysis reached it statically — no value has been observed
