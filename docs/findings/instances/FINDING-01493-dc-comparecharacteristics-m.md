# FINDING-01493: `dceeData.coreParameters.m` in `DC_CompareCharacteristics`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Machines.Examples.DCMachines.DC_CompareCharacteristics` |
| **Reached as** | `dceeData.coreParameters.m` |
...
| key | value |
|---|---|
| `parameter` | dceeData.coreParameters.m |
| `shape` | direct |
| `path` | dceeData.coreParameters.m |
| `declared_min` | None |
| `divisor_sites` | 2 |
...
`dceeData.coreParameters.m`, and the analysis reached it statically — no value has been observed
