# FINDING-01250: `dcdcInverter2.RonD` in `DCPM_Drive`
...
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0321](../../site-reports/SITE-0321-rond-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `DcdcInverter.mo:19` is reached by this model through
`dcdcInverter2.RonD`, and the analysis reached it statically — no value has been observed
