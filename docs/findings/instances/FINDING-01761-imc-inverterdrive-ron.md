# FINDING-01761: `inverter.transistor_p.idealGTOThyristor[1].Ron` in `IMC_InverterDrive`
...
`inverter.transistor_p.idealGTOThyristor[1].Ron`, and the analysis reached it statically — no value has been observed
