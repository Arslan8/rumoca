# FINDING-03772: `hbridge.inverter_n.transistor_n.Ron` in `HBridge_TrianglePWM_RL`
...
`hbridge.inverter_n.transistor_n.Ron`, and the analysis reached it statically — no value has been observed
