# FINDING-03787: `hbridge.inverter_n.RonDiode` in `HBridge_TrianglePWM_RL`
...
| **Declaration** | `SinglePhase2Level.mo:10` |
| **Parameter** | `RonDiode` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0139](../../site-reports/SITE-0139-rondiode-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `SinglePhase2Level.mo:10` is reached by this model through
`hbridge.inverter_n.RonDiode`, and the analysis reached it statically — no value has been observed
