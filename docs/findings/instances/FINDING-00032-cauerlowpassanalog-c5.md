# FINDING-00032: `c5` in `CauerLowPassAnalog`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Analog.Examples.CauerLowPassAnalog` |
| **Reached as** | `c5` |
| **Declaration** | `CauerLowPassAnalog.mo:13` |
| **Parameter** | `c5` |
| **Claim** | the declaration explicitly permits zero (`min=0`) |
| **Kind** | `physical-bound-permits-zero` |
| **Severity** | low |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0570](../../site-reports/SITE-0570-c5-physical-bound-permits-zero.md) |
...
One occurrence. The declaration at `CauerLowPassAnalog.mo:13` is reached by this model through
`c5`, and the analysis reached it statically — no value has been observed
