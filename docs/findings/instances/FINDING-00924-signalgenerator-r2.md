# FINDING-00924: `R2` in `SignalGenerator`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Analog.Examples.OpAmps.SignalGenerator` |
| **Reached as** | `R2` |
| **Declaration** | `SignalGenerator.mo:9` |
| **Parameter** | `R2` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0799](../../site-reports/SITE-0799-r2-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `SignalGenerator.mo:9` is reached by this model through
