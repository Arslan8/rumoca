# FINDING-03092: `rectifier.diode_n1.Goff` in `HalfControlledBridge2Pulse`
...
`rectifier.diode_n1.Goff`, and the analysis reached it statically — no value has been observed
