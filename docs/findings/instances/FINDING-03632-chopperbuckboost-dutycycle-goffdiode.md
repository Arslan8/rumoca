# FINDING-03632: `dcdc.GoffDiode` in `ChopperBuckBoost_DutyCycle`
...
| **Declaration** | `ChopperBuckBoost.mo:14` |
| **Parameter** | `GoffDiode` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0652](../../site-reports/SITE-0652-goffdiode-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `ChopperBuckBoost.mo:14` is reached by this model through
`dcdc.GoffDiode`, and the analysis reached it statically — no value has been observed
