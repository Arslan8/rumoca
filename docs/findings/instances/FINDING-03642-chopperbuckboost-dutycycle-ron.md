# FINDING-03642: `dcdc.transistorHS.Ron` in `ChopperBuckBoost_DutyCycle`
...
`dcdc.transistorHS.Ron`, and the analysis reached it statically — no value has been observed
