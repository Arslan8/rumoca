# FINDING-03688: `chopperStepUp.RonTransistor` in `ChopperStepUp_R`
...
| **Declaration** | `ChopperStepUp.mo:5` |
| **Parameter** | `RonTransistor` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0659](../../site-reports/SITE-0659-rontransistor-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `ChopperStepUp.mo:5` is reached by this model through
`chopperStepUp.RonTransistor`, and the analysis reached it statically — no value has been observed
