# FINDING-04962: `smpmData.Lrsigmad` in `SMPM_VoltageSourceWithLosses`

| | |
|---|---|
| **Model** | `ModelicaTest.Electrical.Machines.SMPM_VoltageSourceWithLosses` |
| **Reached as** | `smpmData.Lrsigmad` |
| **Declaration** | `SM_ReluctanceRotorData.mo:15` |
| **Parameter** | `Lrsigmad` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0082](../../site-reports/SITE-0082-lrsigmad-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `SM_ReluctanceRotorData.mo:15` is reached by this model through
`smpmData.Lrsigmad`, and the analysis reached it statically — no value has been observed
