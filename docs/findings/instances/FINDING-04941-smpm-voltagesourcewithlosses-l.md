...
One occurrence. The declaration at `Inductor.mo:3` is reached by this model through
`smpm.lssigma.L`, and the analysis reached it statically — no value has been observed
