# FINDING-04088: `body.body.I_31` in `InitSpringConstant`

| | |
|---|---|
| **Model** | `Modelica.Mechanics.MultiBody.Examples.Elementary.InitSpringConstant` |
| **Reached as** | `body.body.I_31` |
...
`body.body.I_31`, and the analysis reached it statically — no value has been observed
