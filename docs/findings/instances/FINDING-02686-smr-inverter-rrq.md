...
One occurrence. The declaration at `SM_ReluctanceRotor.mo:67` is reached by this model through
`smr.Rrq`, and the analysis reached it statically — no value has been observed
