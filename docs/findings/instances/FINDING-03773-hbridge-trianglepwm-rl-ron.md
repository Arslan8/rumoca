# FINDING-03773: `hbridge.inverter_n.transistor_p.Ron` in `HBridge_TrianglePWM_RL`
...
`hbridge.inverter_n.transistor_p.Ron`, and the analysis reached it statically — no value has been observed
