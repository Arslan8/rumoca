# FINDING-04262: `body4.body.I_33` in `PlanarFourbar`

| | |
|---|---|
| **Model** | `Modelica.Mechanics.MultiBody.Examples.Loops.PlanarFourbar` |
| **Reached as** | `body4.body.I_33` |
...
`body4.body.I_33`, and the analysis reached it statically — no value has been observed
