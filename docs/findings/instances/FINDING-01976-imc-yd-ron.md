# FINDING-01976: `switchYD.idealOpener.idealOpeningSwitch[2].Ron` in `IMC_YD`
...
`switchYD.idealOpener.idealOpeningSwitch[2].Ron`, and the analysis reached it statically — no value has been observed
