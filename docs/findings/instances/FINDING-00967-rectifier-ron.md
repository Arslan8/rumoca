# FINDING-00967: `Ron` in `Rectifier`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Analog.Examples.Rectifier` |
| **Reached as** | `Ron` |
| **Declaration** | `Rectifier.mo:8` |
| **Parameter** | `Ron` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0775](../../site-reports/SITE-0775-ron-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `Rectifier.mo:8` is reached by this model through
