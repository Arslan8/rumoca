# FINDING-03595: `L` in `ThyristorCenterTapmPulse_RLV_Characteristic`
...
| **Reached as** | `L` |
| **Declaration** | `ThyristorCenterTapmPulse_RLV_Characteristic.mo:9` |
| **Parameter** | `L` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0866](../../site-reports/SITE-0866-l-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `ThyristorCenterTapmPulse_RLV_Characteristic.mo:9` is reached by this model through
