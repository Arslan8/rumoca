...
One occurrence. The declaration at `Gain.mo:6` is reached by this model through
`gain.R2`, and the analysis reached it statically — no value has been observed
