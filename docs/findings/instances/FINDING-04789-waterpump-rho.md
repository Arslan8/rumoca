# FINDING-04789: `oneWayValve.flowPort_b.medium.rho` in `WaterPump`
...
`oneWayValve.flowPort_b.medium.rho`, and the analysis reached it statically — no value has been observed
