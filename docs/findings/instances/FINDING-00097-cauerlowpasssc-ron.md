# FINDING-00097: `R3.IdealCommutingSwitch2.Ron` in `CauerLowPassSC`
...
`R3.IdealCommutingSwitch2.Ron`, and the analysis reached it statically — no value has been observed
