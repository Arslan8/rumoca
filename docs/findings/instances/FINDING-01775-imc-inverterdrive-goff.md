# FINDING-01775: `inverter.diode_p.idealDiode[3].Goff` in `IMC_InverterDrive`
...
`inverter.diode_p.idealDiode[3].Goff`, and the analysis reached it statically — no value has been observed
