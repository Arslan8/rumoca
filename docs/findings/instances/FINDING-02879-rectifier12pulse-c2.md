# FINDING-02879: `transformerData2.C2` in `Rectifier12pulse`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Machines.Examples.Transformers.Rectifier12pulse` |
| **Reached as** | `transformerData2.C2` |
...
| key | value |
|---|---|
| `parameter` | transformerData2.C2 |
| `shape` | propagated |
| `path` | transformerData2.C2 -> transformerData2.V2ph |
| `declared_min` | None |
| `divisor_sites` | 6 |
...
`transformerData2.C2`, and the analysis reached it statically — no value has been observed
