# FINDING-04470: `Jload` in `FirstGrounded`

| | |
|---|---|
| **Model** | `Modelica.Mechanics.Rotational.Examples.FirstGrounded` |
| **Reached as** | `Jload` |
| **Declaration** | `FirstGrounded.mo:9` |
| **Parameter** | `Jload` |
| **Claim** | the declaration explicitly permits zero (`min=0`) |
| **Kind** | `physical-bound-permits-zero` |
| **Severity** | low |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0608](../../site-reports/SITE-0608-jload-physical-bound-permits-zero.md) |
...
One occurrence. The declaration at `FirstGrounded.mo:9` is reached by this model through
