# FINDING-04152: `referenceSystem.pointMass6.m` in `PointGravityWithPointMasses2`
...
`referenceSystem.pointMass6.m`, and the analysis reached it statically — no value has been observed
