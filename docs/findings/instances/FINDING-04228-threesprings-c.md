# FINDING-04228: `spring1.c` in `ThreeSprings`
...
| **Severity** | low |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0108](../../site-reports/SITE-0108-c-physical-bound-permits-zero.md) |
...
One occurrence. The declaration at `Spring.mo:9` is reached by this model through
`spring1.c`, and the analysis reached it statically — no value has been observed
