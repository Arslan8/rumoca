...
One occurrence. The declaration at `SynchronousMachineData.mo:120` is reached by this model through
`smeeData.Rrq`, and the analysis reached it statically — no value has been observed
