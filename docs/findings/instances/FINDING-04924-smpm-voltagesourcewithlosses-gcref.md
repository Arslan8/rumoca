# FINDING-04924: `smpmData.statorCoreParameters.GcRef` in `SMPM_VoltageSourceWithLosses`
...
`smpmData.statorCoreParameters.GcRef`, and the analysis reached it statically — no value has been observed
