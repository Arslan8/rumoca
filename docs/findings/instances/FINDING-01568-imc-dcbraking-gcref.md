# FINDING-01568: `imc.statorCoreParameters.GcRef` in `IMC_DCBraking`
...
`imc.statorCoreParameters.GcRef`, and the analysis reached it statically — no value has been observed
