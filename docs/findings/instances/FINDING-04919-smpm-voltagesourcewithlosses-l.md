...
One occurrence. The declaration at `AirGapR.mo:11` is reached by this model through
`smpm.airGap.L`, and the analysis reached it statically — no value has been observed
