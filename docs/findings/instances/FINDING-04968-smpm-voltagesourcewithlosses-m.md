# FINDING-04968: `smpm.spacePhasorS.m` in `SMPM_VoltageSourceWithLosses`

| | |
|---|---|
| **Model** | `ModelicaTest.Electrical.Machines.SMPM_VoltageSourceWithLosses` |
| **Reached as** | `smpm.spacePhasorS.m` |
...
| key | value |
|---|---|
| `parameter` | smpm.spacePhasorS.m |
| `shape` | direct |
| `path` | smpm.spacePhasorS.m |
| `declared_min` | None |
| `divisor_sites` | 2 |
...
`smpm.spacePhasorS.m`, and the analysis reached it statically — no value has been observed
