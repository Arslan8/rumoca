# FINDING-00038: `c2` in `CauerLowPassAnalog`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Analog.Examples.CauerLowPassAnalog` |
| **Reached as** | `c2` |
| **Declaration** | `CauerLowPassAnalog.mo:8` |
| **Parameter** | `c2` |
| **Claim** | the declaration explicitly permits zero (`min=0`) |
| **Kind** | `physical-bound-permits-zero` |
| **Severity** | low |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0572](../../site-reports/SITE-0572-c2-physical-bound-permits-zero.md) |
...
One occurrence. The declaration at `CauerLowPassAnalog.mo:8` is reached by this model through
`c2`, and the analysis reached it statically — no value has been observed
