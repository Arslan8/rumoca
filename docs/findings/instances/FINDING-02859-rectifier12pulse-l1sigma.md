...
One occurrence. The declaration at `PartialBasicTransformer.mo:18` is reached by this model through
`transformer2.L1sigma`, and the analysis reached it statically — no value has been observed
