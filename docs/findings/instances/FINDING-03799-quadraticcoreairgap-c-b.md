# FINDING-03799: `upperYoke.material.c_b` in `QuadraticCoreAirgap`

| | |
|---|---|
| **Model** | `Modelica.Magnetic.FluxTubes.Examples.BasicExamples.QuadraticCoreAirgap` |
| **Reached as** | `upperYoke.material.c_b` |
...
| key | value |
|---|---|
| `parameter` | upperYoke.material.c_b |
| `shape` | sum |
| `path` | upperYoke.material.c_b |
| `declared_min` | None |
| `divisor_sites` | 1 |
...
`upperYoke.material.c_b`, and the analysis reached it statically — no value has been observed
