# FINDING-04423: `load.I_21` in `MechanicalStructure`

| | |
|---|---|
| **Model** | `Modelica.Mechanics.MultiBody.Examples.Systems.RobotR3.Utilities.MechanicalStructure` |
| **Reached as** | `load.I_21` |
| **Declaration** | `BodyShape.mo:30` |
| **Parameter** | `I_21` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0196](../../site-reports/SITE-0196-i-21-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `BodyShape.mo:30` is reached by this model through
`load.I_21`, and the analysis reached it statically — no value has been observed
