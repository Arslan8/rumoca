# FINDING-00864: `buffer.R2` in `NonInvertingAmplifier`
...
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0646](../../site-reports/SITE-0646-r2-physical-domain-unenforced.md) |
...
`buffer.R2`, and the analysis reached it statically — no value has been observed
