# FINDING-01486: `dceeData.coreParameters.GcRef` in `DC_CompareCharacteristics`
...
`dceeData.coreParameters.GcRef`, and the analysis reached it statically — no value has been observed
