# FINDING-00191: `Lm1` in `CompareTransformers`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Analog.Examples.CompareTransformers` |
| **Reached as** | `Lm1` |
| **Declaration** | `CompareTransformers.mo:15` |
| **Parameter** | `Lm1` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0671](../../site-reports/SITE-0671-lm1-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `CompareTransformers.mo:15` is reached by this model through
`Lm1`, and the analysis reached it statically — no value has been observed
