# FINDING-00602: `oLine50.G[8].T_ref` in `SmoothStep`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Analog.Examples.Lines.SmoothStep` |
| **Reached as** | `oLine50.G[8].T_ref` |
...
| key | value |
|---|---|
| `parameter` | oLine50.G[8].T_ref |
| `shape` | sum |
| `path` | oLine50.G[8].T_ref |
| `declared_min` | 0.0 |
| `divisor_sites` | 1 |
...
`oLine50.G[8].T_ref`, and the analysis reached it statically — no value has been observed
