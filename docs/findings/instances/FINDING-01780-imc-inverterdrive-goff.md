# FINDING-01780: `inverter.transistor_p.idealGTOThyristor[2].Goff` in `IMC_InverterDrive`
...
`inverter.transistor_p.idealGTOThyristor[2].Goff`, and the analysis reached it statically — no value has been observed
