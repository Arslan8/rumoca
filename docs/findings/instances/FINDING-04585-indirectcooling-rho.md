# FINDING-04585: `innerMedium.rho` in `IndirectCooling`
...
| key | value |
|---|---|
| `parameter` | innerMedium.rho |
| `shape` | direct |
| `path` | innerMedium.rho |
| `declared_min` | 0.0 |
| `divisor_sites` | 3 |
...
`innerMedium.rho`, and the analysis reached it statically — no value has been observed
