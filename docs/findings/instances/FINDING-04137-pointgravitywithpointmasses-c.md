# FINDING-04137: `spring.spring.c` in `PointGravityWithPointMasses`
...
| **Severity** | low |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0027](../../site-reports/SITE-0027-c-physical-bound-permits-zero.md) |
...
One occurrence. The declaration at `Spring.mo:4` is reached by this model through
`spring.spring.c`, and the analysis reached it statically — no value has been observed
