# FINDING-00100: `R5.IdealCommutingSwitch1.Ron` in `CauerLowPassSC`
...
`R5.IdealCommutingSwitch1.Ron`, and the analysis reached it statically — no value has been observed
