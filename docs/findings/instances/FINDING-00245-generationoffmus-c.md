# FINDING-00245: `directCapacitor1.capacitor.C` in `GenerationOfFMUs`
...
`directCapacitor1.capacitor.C`, and the analysis reached it statically — no value has been observed
