# FINDING-02856: `transformer2.l2sigma.inductor[2].L` in `Rectifier12pulse`
...
`transformer2.l2sigma.inductor[2].L`, and the analysis reached it statically — no value has been observed
