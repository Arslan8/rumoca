# FINDING-03003: `idealDiode1.idealDiode[2].Goff` in `Rectifier`
...
`idealDiode1.idealDiode[2].Goff`, and the analysis reached it statically — no value has been observed
