...
One occurrence. The declaration at `SuperCap.mo:7` is reached by this model through
`superCap.C`, and the analysis reached it statically — no value has been observed
