# FINDING-03667: `chopperStepDown.RonDiode` in `ChopperStepDown_RL`
...
| **Declaration** | `ChopperStepDown.mo:11` |
| **Parameter** | `RonDiode` |
| **Claim** | the declaration explicitly permits zero (`min=0`) |
| **Kind** | `physical-bound-permits-zero` |
| **Severity** | low |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0274](../../site-reports/SITE-0274-rondiode-physical-bound-permits-zero.md) |
...
One occurrence. The declaration at `ChopperStepDown.mo:11` is reached by this model through
`chopperStepDown.RonDiode`, and the analysis reached it statically — no value has been observed
