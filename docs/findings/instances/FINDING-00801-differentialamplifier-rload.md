# FINDING-00801: `data.RLoad` in `DifferentialAmplifier`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Analog.Examples.OpAmps.DifferentialAmplifier` |
| **Reached as** | `data.RLoad` |
| **Declaration** | `DifferentialAmplifierData.mo:8` |
| **Parameter** | `RLoad` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0700](../../site-reports/SITE-0700-rload-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `DifferentialAmplifierData.mo:8` is reached by this model through
`data.RLoad`, and the analysis reached it statically — no value has been observed
