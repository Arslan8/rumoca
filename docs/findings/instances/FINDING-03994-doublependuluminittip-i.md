# FINDING-03994: `boxBody2.body.I` in `DoublePendulumInitTip`
...
`boxBody2.body.I`, and the analysis reached it statically — no value has been observed
