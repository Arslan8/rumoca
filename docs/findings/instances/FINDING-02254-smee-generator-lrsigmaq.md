...
One occurrence. The declaration at `SM_ElectricalExcited.mo:63` is reached by this model through
`smee.Lrsigmaq`, and the analysis reached it statically — no value has been observed
