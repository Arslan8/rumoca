# FINDING-02307: `diodeBridge2mPulse.diode_p.idealDiode[3].Ron` in `SMPM_Braking`
...
`diodeBridge2mPulse.diode_p.idealDiode[3].Ron`, and the analysis reached it statically — no value has been observed
