# FINDING-03695: `chopperStepUp.transistor.Ron` in `ChopperStepUp_R`
...
`chopperStepUp.transistor.Ron`, and the analysis reached it statically — no value has been observed
