...
One occurrence. The declaration at `IM_SlipRing.mo:37` is reached by this model through
`aims.Rr`, and the analysis reached it statically — no value has been observed
