# FINDING-03817: `r_mFe.material.n` in `SaturatedInductor`

| | |
|---|---|
| **Model** | `Modelica.Magnetic.FluxTubes.Examples.BasicExamples.SaturatedInductor` |
| **Reached as** | `r_mFe.material.n` |
...
| key | value |
|---|---|
| `parameter` | r_mFe.material.n |
| `shape` | sum |
| `path` | r_mFe.material.n |
| `declared_min` | None |
| `divisor_sites` | 1 |
...
`r_mFe.material.n`, and the analysis reached it statically — no value has been observed
