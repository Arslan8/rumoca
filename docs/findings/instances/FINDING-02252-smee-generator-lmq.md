# FINDING-02252: `smee.Lmq` in `SMEE_Generator`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Machines.Examples.SynchronousMachines.SMEE_Generator` |
| **Reached as** | `smee.Lmq` |
| **Declaration** | `SM_ElectricalExcited.mo:51` |
| **Parameter** | `Lmq` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0342](../../site-reports/SITE-0342-lmq-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `SM_ElectricalExcited.mo:51` is reached by this model through
`smee.Lmq`, and the analysis reached it statically — no value has been observed
