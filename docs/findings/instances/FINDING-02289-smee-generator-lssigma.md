...
One occurrence. The declaration at `SynchronousMachineData.mo:95` is reached by this model through
`smeeData.Lssigma`, and the analysis reached it statically — no value has been observed
