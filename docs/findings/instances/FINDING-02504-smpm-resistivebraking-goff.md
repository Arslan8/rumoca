# FINDING-02504: `switch3.idealClosingSwitch[3].Goff` in `SMPM_ResistiveBraking`
...
`switch3.idealClosingSwitch[3].Goff`, and the analysis reached it statically — no value has been observed
