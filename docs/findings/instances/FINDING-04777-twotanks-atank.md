# FINDING-04777: `openTank2.ATank` in `TwoTanks`
...
| key | value |
|---|---|
| `parameter` | openTank2.ATank |
| `shape` | direct |
| `path` | openTank2.ATank |
| `declared_min` | None |
| `divisor_sites` | 1 |
...
`openTank2.ATank`, and the analysis reached it statically — no value has been observed
