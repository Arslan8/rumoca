...
One occurrence. The declaration at `IMC_Steinmetz.mo:10` is reached by this model through
`Cr`, and the analysis reached it statically — no value has been observed
