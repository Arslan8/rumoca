# FINDING-00798: `data.R3` in `DifferentialAmplifier`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Analog.Examples.OpAmps.DifferentialAmplifier` |
| **Reached as** | `data.R3` |
| **Declaration** | `DifferentialAmplifierData.mo:22` |
| **Parameter** | `R3` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0697](../../site-reports/SITE-0697-r3-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `DifferentialAmplifierData.mo:22` is reached by this model through
`data.R3`, and the analysis reached it statically — no value has been observed
