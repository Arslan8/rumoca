# FINDING-04163: `referenceSystem.pointMass5.I_22` in `PointGravityWithPointMasses2`

| | |
|---|---|
| **Model** | `Modelica.Mechanics.MultiBody.Examples.Elementary.PointGravityWithPointMasses2` |
| **Reached as** | `referenceSystem.pointMass5.I_22` |
...
| `required` | referenceSystem.pointMass5.I_22 > 0 |
| `declared_min` | 0.0 |
...
`referenceSystem.pointMass5.I_22`, and the analysis reached it statically — no value has been observed
