# FINDING-03670: `chopperStepDown.RonTransistor` in `ChopperStepDown_RL`
...
| **Declaration** | `ChopperStepDown.mo:5` |
| **Parameter** | `RonTransistor` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0300](../../site-reports/SITE-0300-rontransistor-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `ChopperStepDown.mo:5` is reached by this model through
`chopperStepDown.RonTransistor`, and the analysis reached it statically — no value has been observed
