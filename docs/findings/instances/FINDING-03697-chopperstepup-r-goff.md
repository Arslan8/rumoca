# FINDING-03697: `chopperStepUp.transistor.Goff` in `ChopperStepUp_R`
...
`chopperStepUp.transistor.Goff`, and the analysis reached it statically — no value has been observed
