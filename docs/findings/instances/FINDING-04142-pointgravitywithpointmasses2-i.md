# FINDING-04142: `referenceSystem.pointMass2.I` in `PointGravityWithPointMasses2`

| | |
|---|---|
| **Model** | `Modelica.Mechanics.MultiBody.Examples.Elementary.PointGravityWithPointMasses2` |
| **Reached as** | `referenceSystem.pointMass2.I` |
...
| `required` | referenceSystem.pointMass2.I > 0 |
| `declared_min` | None |
...
`referenceSystem.pointMass2.I`, and the analysis reached it statically — no value has been observed
