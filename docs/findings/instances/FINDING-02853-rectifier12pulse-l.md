# FINDING-02853: `transformer2.l1sigma.inductor[2].L` in `Rectifier12pulse`
...
`transformer2.l1sigma.inductor[2].L`, and the analysis reached it statically — no value has been observed
