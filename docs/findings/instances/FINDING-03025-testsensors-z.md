# FINDING-03025: `Z` in `TestSensors`
...
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0820](../../site-reports/SITE-0820-z-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `TestSensors.mo:11` is reached by this model through
`Z`, and the analysis reached it statically — no value has been observed
