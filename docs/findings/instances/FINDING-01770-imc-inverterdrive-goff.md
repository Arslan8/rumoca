# FINDING-01770: `inverter.diode_n.idealDiode[1].Goff` in `IMC_InverterDrive`
...
`inverter.diode_n.idealDiode[1].Goff`, and the analysis reached it statically — no value has been observed
