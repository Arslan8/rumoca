# FINDING-02300: `diodeBridge2mPulse.diode_n.Goff` in `SMPM_Braking`
...
`diodeBridge2mPulse.diode_n.Goff`, and the analysis reached it statically — no value has been observed
