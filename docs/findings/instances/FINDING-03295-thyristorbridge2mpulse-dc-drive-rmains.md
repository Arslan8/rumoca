...
One occurrence. The declaration at `ThyristorBridge2mPulse_DC_Drive.mo:16` is reached by this model through
`RMains`, and the analysis reached it statically — no value has been observed
