# FINDING-03063: `Lm` in `TransformerYY`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Polyphase.Examples.TransformerYY` |
| **Reached as** | `Lm` |
| **Declaration** | `TransformerYY.mo:7` |
| **Parameter** | `Lm` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0877](../../site-reports/SITE-0877-lm-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `TransformerYY.mo:7` is reached by this model through
`Lm`, and the analysis reached it statically — no value has been observed
