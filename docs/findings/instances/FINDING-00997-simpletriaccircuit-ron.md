# FINDING-00997: `simpleTriac.idealDiode1.Ron` in `SimpleTriacCircuit`
...
`simpleTriac.idealDiode1.Ron`, and the analysis reached it statically — no value has been observed
