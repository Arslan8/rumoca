# FINDING-04570: `innerPipe.flowPort_b.medium.rho` in `IndirectCooling`
...
`innerPipe.flowPort_b.medium.rho`, and the analysis reached it statically — no value has been observed
