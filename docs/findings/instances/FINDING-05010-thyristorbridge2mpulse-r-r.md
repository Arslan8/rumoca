# FINDING-05010: `R` in `ThyristorBridge2mPulse_R`

| | |
|---|---|
| **Model** | `ModelicaTest.Electrical.PowerConverters.ThyristorBridge2mPulse_R` |
| **Reached as** | `R` |
| **Declaration** | `PowerConverters.mo:131` |
| **Parameter** | `R` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0769](../../site-reports/SITE-0769-r-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `PowerConverters.mo:131` is reached by this model through
