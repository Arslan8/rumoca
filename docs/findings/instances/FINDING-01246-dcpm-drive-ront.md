...
One occurrence. The declaration at `DcdcInverter.mo:10` is reached by this model through
`dcdcInverter2.RonT`, and the analysis reached it statically — no value has been observed
