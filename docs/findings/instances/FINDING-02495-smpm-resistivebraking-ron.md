# FINDING-02495: `switch2.idealClosingSwitch[3].Ron` in `SMPM_ResistiveBraking`
...
`switch2.idealClosingSwitch[3].Ron`, and the analysis reached it statically — no value has been observed
