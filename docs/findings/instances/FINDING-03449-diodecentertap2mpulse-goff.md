# FINDING-03449: `rectifier.diode_p.idealDiode[2].Goff` in `DiodeCenterTap2mPulse`
...
`rectifier.diode_p.idealDiode[2].Goff`, and the analysis reached it statically — no value has been observed
