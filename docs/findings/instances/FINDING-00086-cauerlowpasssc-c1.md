# FINDING-00086: `c1` in `CauerLowPassSC`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Analog.Examples.CauerLowPassSC` |
| **Reached as** | `c1` |
| **Declaration** | `CauerLowPassSC.mo:7` |
| **Parameter** | `c1` |
| **Claim** | the declaration explicitly permits zero (`min=0`) |
| **Kind** | `physical-bound-permits-zero` |
| **Severity** | low |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0585](../../site-reports/SITE-0585-c1-physical-bound-permits-zero.md) |
...
One occurrence. The declaration at `CauerLowPassSC.mo:7` is reached by this model through
