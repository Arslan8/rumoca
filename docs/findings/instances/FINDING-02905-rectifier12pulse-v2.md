# FINDING-02905: `transformerData2.V2` in `Rectifier12pulse`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Machines.Examples.Transformers.Rectifier12pulse` |
| **Reached as** | `transformerData2.V2` |
...
| key | value |
|---|---|
| `parameter` | transformerData2.V2 |
| `shape` | propagated |
| `path` | transformerData2.V2 -> transformerData2.V2ph |
| `declared_min` | None |
| `divisor_sites` | 6 |
...
`transformerData2.V2`, and the analysis reached it statically — no value has been observed
