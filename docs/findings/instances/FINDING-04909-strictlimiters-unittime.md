# FINDING-04909: `PID1.unitTime` in `StrictLimiters`

| | |
|---|---|
| **Model** | `ModelicaTest.Blocks.StrictLimiters` |
| **Reached as** | `PID1.unitTime` |
...
`PID1.unitTime`, and the analysis reached it statically — no value has been observed
