# FINDING-04910: `PID2.unitTime` in `StrictLimiters`

| | |
|---|---|
| **Model** | `ModelicaTest.Blocks.StrictLimiters` |
| **Reached as** | `PID2.unitTime` |
...
`PID2.unitTime`, and the analysis reached it statically — no value has been observed
