...
One occurrence. The declaration at `ThyristorBridge2mPulse_DC_Drive.mo:21` is reached by this model through
`Ld`, and the analysis reached it statically — no value has been observed
