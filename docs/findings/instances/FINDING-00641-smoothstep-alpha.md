# FINDING-00641: `oLine50.G[39].alpha` in `SmoothStep`
...
| key | value |
|---|---|
| `parameter` | oLine50.G[39].alpha |
| `shape` | sum |
| `path` | oLine50.G[39].alpha |
| `declared_min` | None |
| `divisor_sites` | 1 |
...
`oLine50.G[39].alpha`, and the analysis reached it statically — no value has been observed
