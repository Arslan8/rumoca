# FINDING-03244: `dcpm.coreParameters.GcRef` in `ThyristorBridge2mPulse_DC_Drive`
...
`dcpm.coreParameters.GcRef`, and the analysis reached it statically — no value has been observed
