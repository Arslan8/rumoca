# FINDING-04317: `inertia2.rotorWith3DEffects.J` in `BevelGear1D`
...
`inertia2.rotorWith3DEffects.J`, and the analysis reached it statically — no value has been observed
