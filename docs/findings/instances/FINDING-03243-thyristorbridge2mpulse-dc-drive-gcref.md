# FINDING-03243: `dcpm.core.coreParameters.GcRef` in `ThyristorBridge2mPulse_DC_Drive`
...
`dcpm.core.coreParameters.GcRef`, and the analysis reached it statically — no value has been observed
