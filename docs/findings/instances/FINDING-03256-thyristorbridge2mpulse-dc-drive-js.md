# FINDING-03256: `dcpmData.Js` in `ThyristorBridge2mPulse_DC_Drive`
...
| **Declaration** | `DcPermanentMagnetData.mo:6` |
| **Parameter** | `Js` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0050](../../site-reports/SITE-0050-js-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `DcPermanentMagnetData.mo:6` is reached by this model through
`dcpmData.Js`, and the analysis reached it statically — no value has been observed
