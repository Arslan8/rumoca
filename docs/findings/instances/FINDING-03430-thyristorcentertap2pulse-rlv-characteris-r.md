# FINDING-03430: `R` in `ThyristorCenterTap2Pulse_RLV_Characteristic`
...
| **Reached as** | `R` |
| **Declaration** | `ThyristorCenterTap2Pulse_RLV_Characteristic.mo:8` |
| **Parameter** | `R` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0851](../../site-reports/SITE-0851-r-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `ThyristorCenterTap2Pulse_RLV_Characteristic.mo:8` is reached by this model through
