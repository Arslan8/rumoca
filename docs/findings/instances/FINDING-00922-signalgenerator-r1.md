# FINDING-00922: `R1` in `SignalGenerator`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Analog.Examples.OpAmps.SignalGenerator` |
| **Reached as** | `R1` |
| **Declaration** | `SignalGenerator.mo:8` |
| **Parameter** | `R1` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0798](../../site-reports/SITE-0798-r1-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `SignalGenerator.mo:8` is reached by this model through
