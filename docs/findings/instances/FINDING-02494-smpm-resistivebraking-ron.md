# FINDING-02494: `switch2.idealClosingSwitch[2].Ron` in `SMPM_ResistiveBraking`
...
`switch2.idealClosingSwitch[2].Ron`, and the analysis reached it statically — no value has been observed
