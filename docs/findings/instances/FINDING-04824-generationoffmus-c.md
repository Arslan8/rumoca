...
One occurrence. The declaration at `DirectCapacity.mo:5` is reached by this model through
`directCapacity.C`, and the analysis reached it statically — no value has been observed
