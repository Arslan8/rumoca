# FINDING-02663: `smrData.fsNominal` in `SMR_Inverter`
...
| key | value |
|---|---|
| `parameter` | smrData.fsNominal |
| `shape` | propagated |
| `path` | smrData.fsNominal -> smr.fsNominal |
| `declared_min` | None |
| `divisor_sites` | 10 |
...
`smrData.fsNominal`, and the analysis reached it statically — no value has been observed
