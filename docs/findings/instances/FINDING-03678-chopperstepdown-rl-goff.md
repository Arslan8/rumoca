# FINDING-03678: `chopperStepDown.diode.Goff` in `ChopperStepDown_RL`
...
`chopperStepDown.diode.Goff`, and the analysis reached it statically — no value has been observed
