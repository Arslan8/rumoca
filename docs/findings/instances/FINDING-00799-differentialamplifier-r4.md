# FINDING-00799: `data.R4` in `DifferentialAmplifier`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Analog.Examples.OpAmps.DifferentialAmplifier` |
| **Reached as** | `data.R4` |
| **Declaration** | `DifferentialAmplifierData.mo:24` |
| **Parameter** | `R4` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0698](../../site-reports/SITE-0698-r4-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `DifferentialAmplifierData.mo:24` is reached by this model through
`data.R4`, and the analysis reached it statically — no value has been observed
