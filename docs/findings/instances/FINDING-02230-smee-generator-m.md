# FINDING-02230: `smee.statorCoreParameters.m` in `SMEE_Generator`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Machines.Examples.SynchronousMachines.SMEE_Generator` |
| **Reached as** | `smee.statorCoreParameters.m` |
...
| key | value |
|---|---|
| `parameter` | smee.statorCoreParameters.m |
| `shape` | direct |
| `path` | smee.statorCoreParameters.m |
| `declared_min` | None |
| `divisor_sites` | 2 |
...
`smee.statorCoreParameters.m`, and the analysis reached it statically — no value has been observed
