# FINDING-03785: `hbridge.inverter_p.transistor_p.Goff` in `HBridge_TrianglePWM_RL`
...
`hbridge.inverter_p.transistor_p.Goff`, and the analysis reached it statically — no value has been observed
