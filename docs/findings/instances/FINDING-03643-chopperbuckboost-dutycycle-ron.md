# FINDING-03643: `dcdc.transistorLS.Ron` in `ChopperBuckBoost_DutyCycle`
...
`dcdc.transistorLS.Ron`, and the analysis reached it statically — no value has been observed
