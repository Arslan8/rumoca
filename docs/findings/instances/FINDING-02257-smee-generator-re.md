...
One occurrence. The declaration at `SM_ElectricalExcited.mo:96` is reached by this model through
`smee.Re`, and the analysis reached it statically — no value has been observed
