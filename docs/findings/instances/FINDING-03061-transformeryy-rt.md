# FINDING-03061: `RT` in `TransformerYY`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Polyphase.Examples.TransformerYY` |
| **Reached as** | `RT` |
| **Declaration** | `TransformerYY.mo:10` |
| **Parameter** | `RT` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0875](../../site-reports/SITE-0875-rt-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `TransformerYY.mo:10` is reached by this model through
