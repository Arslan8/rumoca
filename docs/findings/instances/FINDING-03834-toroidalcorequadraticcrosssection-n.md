# FINDING-03834: `airGap.material.n` in `ToroidalCoreQuadraticCrossSection`

| | |
|---|---|
| **Model** | `Modelica.Magnetic.FluxTubes.Examples.BasicExamples.ToroidalCoreQuadraticCrossSection` |
| **Reached as** | `airGap.material.n` |
...
| key | value |
|---|---|
| `parameter` | airGap.material.n |
| `shape` | sum |
| `path` | airGap.material.n |
| `declared_min` | None |
| `divisor_sites` | 1 |
...
`airGap.material.n`, and the analysis reached it statically — no value has been observed
