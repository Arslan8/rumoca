# FINDING-00433: `oLine4.G[5].alpha` in `CompareLineTrunks`
...
| key | value |
|---|---|
| `parameter` | oLine4.G[5].alpha |
| `shape` | sum |
| `path` | oLine4.G[5].alpha |
| `declared_min` | None |
| `divisor_sites` | 1 |
...
`oLine4.G[5].alpha`, and the analysis reached it statically — no value has been observed
