...
One occurrence. The declaration at `PNP.mo:11` is reached by this model through
`T1.Cjc`, and the analysis reached it statically — no value has been observed
