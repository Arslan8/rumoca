# FINDING-03539: `rectifier.diode.idealDiode[1].Ron` in `DiodeCenterTapmPulse`
...
`rectifier.diode.idealDiode[1].Ron`, and the analysis reached it statically — no value has been observed
