# FINDING-04801: `pipe.medium.rho` in `WaterPump`
...
| key | value |
|---|---|
| `parameter` | pipe.medium.rho |
| `shape` | direct |
| `path` | pipe.medium.rho |
| `declared_min` | 0.0 |
| `divisor_sites` | 1 |
...
`pipe.medium.rho`, and the analysis reached it statically — no value has been observed
