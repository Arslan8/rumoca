# FINDING-00305: `CapVal` in `HeatingPNP_NORGate`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Analog.Examples.HeatingPNP_NORGate` |
| **Reached as** | `CapVal` |
| **Declaration** | `HeatingPNP_NORGate.mo:4` |
| **Parameter** | `CapVal` |
| **Claim** | the declaration explicitly permits zero (`min=0`) |
| **Kind** | `physical-bound-permits-zero` |
| **Severity** | low |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0614](../../site-reports/SITE-0614-capval-physical-bound-permits-zero.md) |
...
One occurrence. The declaration at `HeatingPNP_NORGate.mo:4` is reached by this model through
