# FINDING-00193: `R2` in `CompareTransformers`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Analog.Examples.CompareTransformers` |
| **Reached as** | `R2` |
| **Declaration** | `CompareTransformers.mo:19` |
| **Parameter** | `R2` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0673](../../site-reports/SITE-0673-r2-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `CompareTransformers.mo:19` is reached by this model through
