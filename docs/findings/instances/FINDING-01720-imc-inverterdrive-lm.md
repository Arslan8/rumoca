...
One occurrence. The declaration at `AirGapS.mo:3` is reached by this model through
`aimc.airGap.Lm`, and the analysis reached it statically — no value has been observed
