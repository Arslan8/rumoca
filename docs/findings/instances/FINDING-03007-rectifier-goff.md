# FINDING-03007: `idealDiode2.idealDiode[3].Goff` in `Rectifier`
...
`idealDiode2.idealDiode[3].Goff`, and the analysis reached it statically — no value has been observed
