# FINDING-03791: `hbridge.inverter_n.RonTransistor` in `HBridge_TrianglePWM_RL`
...
`hbridge.inverter_n.RonTransistor`, and the analysis reached it statically — no value has been observed
