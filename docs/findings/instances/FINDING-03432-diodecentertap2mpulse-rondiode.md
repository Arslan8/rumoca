# FINDING-03432: `rectifier.RonDiode` in `DiodeCenterTap2mPulse`
...
| **Declaration** | `DiodeCenterTap2mPulse.mo:6` |
| **Parameter** | `RonDiode` |
| **Claim** | the declaration explicitly permits zero (`min=0`) |
| **Kind** | `physical-bound-permits-zero` |
| **Severity** | low |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0599](../../site-reports/SITE-0599-rondiode-physical-bound-permits-zero.md) |
...
One occurrence. The declaration at `DiodeCenterTap2mPulse.mo:6` is reached by this model through
