# FINDING-03776: `hbridge.inverter_p.transistor_n.Ron` in `HBridge_TrianglePWM_RL`
...
`hbridge.inverter_p.transistor_n.Ron`, and the analysis reached it statically — no value has been observed
