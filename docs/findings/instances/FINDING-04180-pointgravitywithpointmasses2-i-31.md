# FINDING-04180: `referenceSystem.pointMass4.I_31` in `PointGravityWithPointMasses2`

| | |
|---|---|
| **Model** | `Modelica.Mechanics.MultiBody.Examples.Elementary.PointGravityWithPointMasses2` |
| **Reached as** | `referenceSystem.pointMass4.I_31` |
...
| `required` | referenceSystem.pointMass4.I_31 > 0 |
...
`referenceSystem.pointMass4.I_31`, and the analysis reached it statically — no value has been observed
