# FINDING-00103: `R7.IdealCommutingSwitch2.Ron` in `CauerLowPassSC`
...
`R7.IdealCommutingSwitch2.Ron`, and the analysis reached it statically — no value has been observed
