# FINDING-02298: `diodeBridge2mPulse.diode_n.Ron` in `SMPM_Braking`
...
`diodeBridge2mPulse.diode_n.Ron`, and the analysis reached it statically — no value has been observed
