# FINDING-03226: `rectifier.diode_n.idealDiode[1].Goff` in `HalfControlledBridge2mPulse`
...
`rectifier.diode_n.idealDiode[1].Goff`, and the analysis reached it statically — no value has been observed
