# FINDING-00255: `inverseInductor3.inductor.L` in `GenerationOfFMUs`
...
`inverseInductor3.inductor.L`, and the analysis reached it statically — no value has been observed
