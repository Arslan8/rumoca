# FINDING-01584: `imcData.fsNominal` in `IMC_DCBraking`
...
| `shape` | propagated |
| `path` | imcData.fsNominal -> imcData.frictionParameters.wRef |
| `declared_min` | None |
| `divisor_sites` | 9 |
...
`imcData.fsNominal`, and the analysis reached it statically — no value has been observed
