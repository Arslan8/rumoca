# FINDING-01181: `outlet.medium.cp` in `DCPM_Cooling`
...
| key | value |
|---|---|
| `parameter` | outlet.medium.cp |
| `shape` | direct |
| `path` | outlet.medium.cp |
| `declared_min` | None |
| `divisor_sites` | 2 |
...
`outlet.medium.cp`, and the analysis reached it statically — no value has been observed
