# FINDING-01282: `dcpm1.coreParameters.GcRef` in `DCPM_QuasiStatic`
...
`dcpm1.coreParameters.GcRef`, and the analysis reached it statically — no value has been observed
