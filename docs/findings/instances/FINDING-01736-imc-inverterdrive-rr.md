...
One occurrence. The declaration at `IM_SquirrelCage.mo:33` is reached by this model through
`aimc.Rr`, and the analysis reached it statically — no value has been observed
