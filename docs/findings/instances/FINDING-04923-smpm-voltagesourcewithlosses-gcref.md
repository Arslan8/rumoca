# FINDING-04923: `smpm.statorCoreParameters.GcRef` in `SMPM_VoltageSourceWithLosses`
...
`smpm.statorCoreParameters.GcRef`, and the analysis reached it statically — no value has been observed
