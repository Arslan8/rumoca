# FINDING-02275: `smeeData.xdTransient` in `SMEE_Generator`
...
| **Severity** | medium |
| **Sanitizer** | `divisor` |
| **Fix site** | [SITE-0259](../../site-reports/SITE-0259-xdtransient-divisor-reachable-zero.md) |
...
| `shape` | propagated |
| `path` | smeeData.xdTransient -> smeeData.xe -> smeeData.sigmae -> smee.sigmae |
| `declared_min` | None |
| `divisor_sites` | 10 |
