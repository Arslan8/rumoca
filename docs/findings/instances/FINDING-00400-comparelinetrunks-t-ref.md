# FINDING-00400: `oLine3.G[7].T_ref` in `CompareLineTrunks`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Analog.Examples.Lines.CompareLineTrunks` |
| **Reached as** | `oLine3.G[7].T_ref` |
...
| key | value |
|---|---|
| `parameter` | oLine3.G[7].T_ref |
| `shape` | sum |
| `path` | oLine3.G[7].T_ref |
| `declared_min` | 0.0 |
| `divisor_sites` | 1 |
...
`oLine3.G[7].T_ref`, and the analysis reached it statically — no value has been observed
