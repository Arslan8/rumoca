# FINDING-00783: `firstOrder2A.R1` in `ControlCircuit`
...
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0206](../../site-reports/SITE-0206-r1-physical-domain-unenforced.md) |
...
`firstOrder2A.R1`, and the analysis reached it statically — no value has been observed
