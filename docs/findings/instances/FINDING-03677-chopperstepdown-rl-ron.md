# FINDING-03677: `chopperStepDown.transistor.Ron` in `ChopperStepDown_RL`
...
`chopperStepDown.transistor.Ron`, and the analysis reached it statically — no value has been observed
