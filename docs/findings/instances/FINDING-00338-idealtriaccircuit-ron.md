# FINDING-00338: `idealTriac.idealThyristor1.Ron` in `IdealTriacCircuit`
...
`idealTriac.idealThyristor1.Ron`, and the analysis reached it statically — no value has been observed
