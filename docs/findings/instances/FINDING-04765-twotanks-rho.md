# FINDING-04765: `openTank2.flowPort.medium.rho` in `TwoTanks`
...
`openTank2.flowPort.medium.rho`, and the analysis reached it statically — no value has been observed
