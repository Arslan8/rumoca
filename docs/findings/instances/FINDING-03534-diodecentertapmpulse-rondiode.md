# FINDING-03534: `rectifier.RonDiode` in `DiodeCenterTapmPulse`
...
| **Declaration** | `DiodeCenterTapmPulse.mo:6` |
| **Parameter** | `RonDiode` |
| **Claim** | the declaration explicitly permits zero (`min=0`) |
| **Kind** | `physical-bound-permits-zero` |
| **Severity** | low |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0601](../../site-reports/SITE-0601-rondiode-physical-bound-permits-zero.md) |
...
One occurrence. The declaration at `DiodeCenterTapmPulse.mo:6` is reached by this model through
