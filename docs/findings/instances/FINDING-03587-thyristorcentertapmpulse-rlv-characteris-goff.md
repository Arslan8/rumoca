# FINDING-03587: `rectifier.thyristor.idealThyristor[3].Goff` in `ThyristorCenterTapmPulse_RLV_Characteristic`
...
`rectifier.thyristor.idealThyristor[3].Goff`, and the analysis reached it statically — no value has been observed
