...
One occurrence. The declaration at `TransformerData.mo:35` is reached by this model through
`transformerData.Z1ph`, and the analysis reached it statically — no value has been observed
