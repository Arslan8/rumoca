# FINDING-01748: `inverter.transistor_n.Ron` in `IMC_InverterDrive`
...
`inverter.transistor_n.Ron`, and the analysis reached it statically — no value has been observed
