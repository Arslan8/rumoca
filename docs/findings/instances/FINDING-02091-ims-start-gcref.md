# FINDING-02091: `aimsData.statorCoreParameters.GcRef` in `IMS_Start`
...
`aimsData.statorCoreParameters.GcRef`, and the analysis reached it statically — no value has been observed
