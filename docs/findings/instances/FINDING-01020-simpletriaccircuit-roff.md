# FINDING-01020: `simpleTriac.thyristor.Roff` in `SimpleTriacCircuit`
...
`simpleTriac.thyristor.Roff`, and the analysis reached it statically — no value has been observed
