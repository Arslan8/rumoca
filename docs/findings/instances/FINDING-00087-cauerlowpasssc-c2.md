# FINDING-00087: `c2` in `CauerLowPassSC`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Analog.Examples.CauerLowPassSC` |
| **Reached as** | `c2` |
| **Declaration** | `CauerLowPassSC.mo:8` |
| **Parameter** | `c2` |
| **Claim** | the declaration explicitly permits zero (`min=0`) |
| **Kind** | `physical-bound-permits-zero` |
| **Severity** | low |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0586](../../site-reports/SITE-0586-c2-physical-bound-permits-zero.md) |
...
One occurrence. The declaration at `CauerLowPassSC.mo:8` is reached by this model through
