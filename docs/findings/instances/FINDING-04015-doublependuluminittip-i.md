...
One occurrence. The declaration at `BodyBox.mo:111` is reached by this model through
`boxBody1.I`, and the analysis reached it statically — no value has been observed
