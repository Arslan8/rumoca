# FINDING-03583: `rectifier.thyristor.idealThyristor[2].Ron` in `ThyristorCenterTapmPulse_RLV_Characteristic`
...
`rectifier.thyristor.idealThyristor[2].Ron`, and the analysis reached it statically — no value has been observed
