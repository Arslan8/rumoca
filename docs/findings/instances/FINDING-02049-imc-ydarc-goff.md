# FINDING-02049: `switchYDwithArc.idealOpener.openerWithArc[2].Goff` in `IMC_YDarc`
...
`switchYDwithArc.idealOpener.openerWithArc[2].Goff`, and the analysis reached it statically — no value has been observed
