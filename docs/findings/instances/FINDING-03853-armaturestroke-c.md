# FINDING-03853: `cActuator.armature.stopper_xMax.c` in `ArmatureStroke`
...
`cActuator.armature.stopper_xMax.c`, and the analysis reached it statically — no value has been observed
