# FINDING-01076: `S.Goff` in `RealSwitch`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Analog.Examples.Utilities.RealSwitch` |
| **Reached as** | `S.Goff` |
| **Declaration** | `ControlledIdealTwoWaySwitch.mo:5` |
| **Parameter** | `Goff` |
| **Claim** | the declaration explicitly permits zero (`min=0`) |
| **Kind** | `physical-bound-permits-zero` |
| **Severity** | low |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0594](../../site-reports/SITE-0594-goff-physical-bound-permits-zero.md) |
...
One occurrence. The declaration at `ControlledIdealTwoWaySwitch.mo:5` is reached by this model through
`S.Goff`, and the analysis reached it statically — no value has been observed
