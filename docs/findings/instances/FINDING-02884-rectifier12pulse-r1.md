...
One occurrence. The declaration at `TransformerData.mo:37` is reached by this model through
`transformerData1.R1`, and the analysis reached it statically — no value has been observed
