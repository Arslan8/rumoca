# FINDING-04000: `boxBody2.body.I_22` in `DoublePendulumInitTip`

| | |
|---|---|
| **Model** | `Modelica.Mechanics.MultiBody.Examples.Elementary.DoublePendulumInitTip` |
| **Reached as** | `boxBody2.body.I_22` |
...
`boxBody2.body.I_22`, and the analysis reached it statically — no value has been observed
