# FINDING-04155: `referenceSystem.pointMass3.I_11` in `PointGravityWithPointMasses2`

| | |
|---|---|
| **Model** | `Modelica.Mechanics.MultiBody.Examples.Elementary.PointGravityWithPointMasses2` |
| **Reached as** | `referenceSystem.pointMass3.I_11` |
...
| `required` | referenceSystem.pointMass3.I_11 > 0 |
| `declared_min` | 0.0 |
...
`referenceSystem.pointMass3.I_11`, and the analysis reached it statically — no value has been observed
