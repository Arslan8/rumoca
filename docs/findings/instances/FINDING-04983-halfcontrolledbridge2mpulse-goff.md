# FINDING-04983: `rectifier.diode_n.idealDiode[3].Goff` in `HalfControlledBridge2mPulse`
...
`rectifier.diode_n.idealDiode[3].Goff`, and the analysis reached it statically — no value has been observed
