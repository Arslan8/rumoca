# FINDING-01378: `JLoad` in `DCPM_withLosses`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Machines.Examples.DCMachines.DCPM_withLosses` |
| **Reached as** | `JLoad` |
| **Declaration** | `DCPM_withLosses.mo:16` |
| **Parameter** | `JLoad` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0690](../../site-reports/SITE-0690-jload-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `DCPM_withLosses.mo:16` is reached by this model through
