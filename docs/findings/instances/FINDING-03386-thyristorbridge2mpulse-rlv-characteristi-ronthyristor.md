# FINDING-03386: `rectifier.RonThyristor` in `ThyristorBridge2mPulse_RLV_Characteristic`
...
| **Declaration** | `ThyristorBridge2mPulse.mo:6` |
| **Parameter** | `RonThyristor` |
| **Claim** | the declaration explicitly permits zero (`min=0`) |
| **Kind** | `physical-bound-permits-zero` |
| **Severity** | low |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0109](../../site-reports/SITE-0109-ronthyristor-physical-bound-permits-zero.md) |
...
One occurrence. The declaration at `ThyristorBridge2mPulse.mo:6` is reached by this model through
