# FINDING-01389: `dcpmData2.wNominal` in `DCPM_withLosses`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Machines.Examples.DCMachines.DCPM_withLosses` |
| **Reached as** | `dcpmData2.wNominal` |
...
| key | value |
|---|---|
| `parameter` | dcpmData2.wNominal |
| `shape` | propagated |
| `path` | dcpmData2.wNominal -> dcpmData2.strayLoadParameters.wRef |
| `declared_min` | None |
| `divisor_sites` | 11 |
...
`dcpmData2.wNominal`, and the analysis reached it statically — no value has been observed
