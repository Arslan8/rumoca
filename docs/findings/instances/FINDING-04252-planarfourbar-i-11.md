# FINDING-04252: `body2.body.I_11` in `PlanarFourbar`

| | |
|---|---|
| **Model** | `Modelica.Mechanics.MultiBody.Examples.Loops.PlanarFourbar` |
| **Reached as** | `body2.body.I_11` |
...
`body2.body.I_11`, and the analysis reached it statically — no value has been observed
