# FINDING-00916: `R` in `SignalGenerator`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Analog.Examples.OpAmps.SignalGenerator` |
| **Reached as** | `R` |
| **Declaration** | `SignalGenerator.mo:11` |
| **Parameter** | `R` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0797](../../site-reports/SITE-0797-r-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `SignalGenerator.mo:11` is reached by this model through
