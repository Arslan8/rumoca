# FINDING-02228: `smee.statorCore.coreParameters.GcRef` in `SMEE_Generator`
...
`smee.statorCore.coreParameters.GcRef`, and the analysis reached it statically — no value has been observed
