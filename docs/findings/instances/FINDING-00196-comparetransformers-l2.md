# FINDING-00196: `L2` in `CompareTransformers`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Analog.Examples.CompareTransformers` |
| **Reached as** | `L2` |
| **Declaration** | `CompareTransformers.mo:24` |
| **Parameter** | `L2` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0676](../../site-reports/SITE-0676-l2-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `CompareTransformers.mo:24` is reached by this model through
`L2`, and the analysis reached it statically — no value has been observed
