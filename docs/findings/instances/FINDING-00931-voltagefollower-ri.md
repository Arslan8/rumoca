# FINDING-00931: `Ri` in `VoltageFollower`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Analog.Examples.OpAmps.VoltageFollower` |
| **Reached as** | `Ri` |
| **Declaration** | `VoltageFollower.mo:8` |
| **Parameter** | `Ri` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0882](../../site-reports/SITE-0882-ri-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `VoltageFollower.mo:8` is reached by this model through
`Ri`, and the analysis reached it statically — no value has been observed
