# FINDING-03634: `dcdc.RonTransistor` in `ChopperBuckBoost_DutyCycle`
...
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0654](../../site-reports/SITE-0654-rontransistor-physical-domain-unenforced.md) |
...
`dcdc.RonTransistor`, and the analysis reached it statically — no value has been observed
