# FINDING-00154: `R4.R` in `CauerLowPassSC`
...
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0885](../../site-reports/SITE-0885-r-physical-invariant-violated.md) |
...
`R4.R`, and the analysis reached it statically — no value has been observed
