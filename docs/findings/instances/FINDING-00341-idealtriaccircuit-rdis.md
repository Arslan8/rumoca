...
One occurrence. The declaration at `IdealTriac.mo:11` is reached by this model through
`idealTriac.Rdis`, and the analysis reached it statically — no value has been observed
