# FINDING-04959: `smpm.Lrsigmaq` in `SMPM_VoltageSourceWithLosses`

| | |
|---|---|
| **Model** | `ModelicaTest.Electrical.Machines.SMPM_VoltageSourceWithLosses` |
| **Reached as** | `smpm.Lrsigmaq` |
| **Declaration** | `SM_PermanentMagnet.mo:65` |
| **Parameter** | `Lrsigmaq` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0098](../../site-reports/SITE-0098-lrsigmaq-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `SM_PermanentMagnet.mo:65` is reached by this model through
`smpm.Lrsigmaq`, and the analysis reached it statically — no value has been observed
