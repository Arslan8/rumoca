# FINDING-04797: `volumeFlowSensor.flowPort_b.medium.rho` in `WaterPump`
...
`volumeFlowSensor.flowPort_b.medium.rho`, and the analysis reached it statically — no value has been observed
