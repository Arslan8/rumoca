...
One occurrence. The declaration at `ChopperStepUp.mo:11` is reached by this model through
`chopperStepUp.RonDiode`, and the analysis reached it statically — no value has been observed
