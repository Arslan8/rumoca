# FINDING-02650: `smr.statorCoreParameters.GcRef` in `SMR_Inverter`
...
`smr.statorCoreParameters.GcRef`, and the analysis reached it statically — no value has been observed
