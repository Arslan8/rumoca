# FINDING-04150: `referenceSystem.pointMass4.m` in `PointGravityWithPointMasses2`
...
`referenceSystem.pointMass4.m`, and the analysis reached it statically — no value has been observed
