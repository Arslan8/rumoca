# FINDING-02086: `aims.rotorCore.coreParameters.GcRef` in `IMS_Start`
...
`aims.rotorCore.coreParameters.GcRef`, and the analysis reached it statically — no value has been observed
