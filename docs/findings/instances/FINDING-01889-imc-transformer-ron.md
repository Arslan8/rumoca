# FINDING-01889: `idealCloser.idealClosingSwitch[3].Ron` in `IMC_Transformer`
...
`idealCloser.idealClosingSwitch[3].Ron`, and the analysis reached it statically — no value has been observed
