# FINDING-03514: `rectifier.thyristor_n.idealThyristor[3].Ron` in `ThyristorCenterTap2mPulse_RLV_Characteristic`
...
`rectifier.thyristor_n.idealThyristor[3].Ron`, and the analysis reached it statically — no value has been observed
