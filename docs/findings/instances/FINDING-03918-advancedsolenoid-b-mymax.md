# FINDING-03918: `g_mAirPar.material.B_myMax` in `AdvancedSolenoid`
...
| key | value |
|---|---|
| `parameter` | g_mAirPar.material.B_myMax |
| `shape` | direct |
| `path` | g_mAirPar.material.B_myMax |
| `declared_min` | None |
| `divisor_sites` | 1 |
...
`g_mAirPar.material.B_myMax`, and the analysis reached it statically — no value has been observed
