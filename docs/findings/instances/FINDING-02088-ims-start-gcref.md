# FINDING-02088: `aims.statorCore.coreParameters.GcRef` in `IMS_Start`
...
`aims.statorCore.coreParameters.GcRef`, and the analysis reached it statically — no value has been observed
