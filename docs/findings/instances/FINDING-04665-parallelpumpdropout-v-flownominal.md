# FINDING-04665: `pipe1.V_flowNominal` in `ParallelPumpDropOut`
...
| key | value |
|---|---|
| `parameter` | pipe1.V_flowNominal |
| `shape` | direct |
| `path` | pipe1.V_flowNominal |
| `declared_min` | None |
| `divisor_sites` | 1 |
...
`pipe1.V_flowNominal`, and the analysis reached it statically — no value has been observed
