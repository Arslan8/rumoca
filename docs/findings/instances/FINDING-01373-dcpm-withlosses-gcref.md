# FINDING-01373: `dcpmData2.coreParameters.GcRef` in `DCPM_withLosses`
...
`dcpmData2.coreParameters.GcRef`, and the analysis reached it statically — no value has been observed
