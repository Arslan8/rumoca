...
One occurrence. The declaration at `IdealOpeningSwitch.mo:4` is reached by this model through
`switchYD.idealOpener.Ron`, and the analysis reached it statically — no value has been observed
