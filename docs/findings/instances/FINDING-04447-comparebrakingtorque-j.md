# FINDING-04447: `J` in `CompareBrakingTorque`

| | |
|---|---|
| **Model** | `Modelica.Mechanics.Rotational.Examples.CompareBrakingTorque` |
| **Reached as** | `J` |
| **Declaration** | `CompareBrakingTorque.mo:4` |
| **Parameter** | `J` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0665](../../site-reports/SITE-0665-j-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `CompareBrakingTorque.mo:4` is reached by this model through
`J`, and the analysis reached it statically — no value has been observed
