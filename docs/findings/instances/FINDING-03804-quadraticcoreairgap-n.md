# FINDING-03804: `upperYoke.material.n` in `QuadraticCoreAirgap`

| | |
|---|---|
| **Model** | `Modelica.Magnetic.FluxTubes.Examples.BasicExamples.QuadraticCoreAirgap` |
| **Reached as** | `upperYoke.material.n` |
...
| key | value |
|---|---|
| `parameter` | upperYoke.material.n |
| `shape` | sum |
| `path` | upperYoke.material.n |
| `declared_min` | None |
| `divisor_sites` | 1 |
...
`upperYoke.material.n`, and the analysis reached it statically — no value has been observed
