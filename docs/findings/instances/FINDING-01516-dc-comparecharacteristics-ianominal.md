# FINDING-01516: `dcseData.IaNominal` in `DC_CompareCharacteristics`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Machines.Examples.DCMachines.DC_CompareCharacteristics` |
| **Reached as** | `dcseData.IaNominal` |
...
| key | value |
|---|---|
| `parameter` | dcseData.IaNominal |
| `shape` | propagated |
| `path` | dcseData.IaNominal -> dcseData.ViNominal -> dcseData.coreParameters.VRef |
| `declared_min` | None |
| `divisor_sites` | 4 |
...
`dcseData.IaNominal`, and the analysis reached it statically — no value has been observed
