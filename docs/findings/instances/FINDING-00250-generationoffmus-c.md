...
One occurrence. The declaration at `DirectCapacitor.mo:4` is reached by this model through
`directCapacitor1.C`, and the analysis reached it statically — no value has been observed
