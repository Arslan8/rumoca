# FINDING-04763: `openTank1.flowPort.medium.rho` in `TwoTanks`
...
`openTank1.flowPort.medium.rho`, and the analysis reached it statically — no value has been observed
