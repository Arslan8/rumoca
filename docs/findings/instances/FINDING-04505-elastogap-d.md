...
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0709](../../site-reports/SITE-0709-d-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `ElastoGap.mo:45` is reached by this model through
