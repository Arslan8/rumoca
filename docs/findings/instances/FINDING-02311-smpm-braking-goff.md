# FINDING-02311: `diodeBridge2mPulse.diode_p.idealDiode[1].Goff` in `SMPM_Braking`
...
`diodeBridge2mPulse.diode_p.idealDiode[1].Goff`, and the analysis reached it statically — no value has been observed
