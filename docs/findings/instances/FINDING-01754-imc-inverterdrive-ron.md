# FINDING-01754: `inverter.diode_n.idealDiode[3].Ron` in `IMC_InverterDrive`
...
`inverter.diode_n.idealDiode[3].Ron`, and the analysis reached it statically — no value has been observed
