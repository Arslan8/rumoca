# FINDING-00092: `R11.IdealCommutingSwitch1.Ron` in `CauerLowPassSC`
...
`R11.IdealCommutingSwitch1.Ron`, and the analysis reached it statically — no value has been observed
