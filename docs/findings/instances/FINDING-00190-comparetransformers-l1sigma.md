# FINDING-00190: `L1sigma` in `CompareTransformers`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Analog.Examples.CompareTransformers` |
| **Reached as** | `L1sigma` |
| **Declaration** | `CompareTransformers.mo:13` |
| **Parameter** | `L1sigma` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0670](../../site-reports/SITE-0670-l1sigma-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `CompareTransformers.mo:13` is reached by this model through
`L1sigma`, and the analysis reached it statically — no value has been observed
