# FINDING-00803: `der_.R` in `Differentiator`
...
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0323](../../site-reports/SITE-0323-r-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `Der.mo:7` is reached by this model through
`der_.R`, and the analysis reached it statically — no value has been observed
