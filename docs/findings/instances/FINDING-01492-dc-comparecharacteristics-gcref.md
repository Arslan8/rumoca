# FINDING-01492: `dcseData.coreParameters.GcRef` in `DC_CompareCharacteristics`
...
`dcseData.coreParameters.GcRef`, and the analysis reached it statically — no value has been observed
