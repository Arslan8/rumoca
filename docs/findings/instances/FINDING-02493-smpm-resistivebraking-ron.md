# FINDING-02493: `switch2.idealClosingSwitch[1].Ron` in `SMPM_ResistiveBraking`
...
`switch2.idealClosingSwitch[1].Ron`, and the analysis reached it statically — no value has been observed
