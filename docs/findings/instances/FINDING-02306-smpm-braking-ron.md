# FINDING-02306: `diodeBridge2mPulse.diode_p.idealDiode[2].Ron` in `SMPM_Braking`
...
`diodeBridge2mPulse.diode_p.idealDiode[2].Ron`, and the analysis reached it statically — no value has been observed
