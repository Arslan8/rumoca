# FINDING-04149: `referenceSystem.pointMass3.m` in `PointGravityWithPointMasses2`
...
| **Declaration** | `Body.mo:16` |
| **Parameter** | `m` |
| **Claim** | the declaration explicitly permits zero (`min=0`) |
| **Kind** | `physical-bound-permits-zero` |
| **Severity** | low |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0033](../../site-reports/SITE-0033-m-physical-bound-permits-zero.md) |
...
One occurrence. The declaration at `Body.mo:16` is reached by this model through
`referenceSystem.pointMass3.m`, and the analysis reached it statically — no value has been observed
