# FINDING-04950: `smpm.Lszero` in `SMPM_VoltageSourceWithLosses`

| | |
|---|---|
| **Model** | `ModelicaTest.Electrical.Machines.SMPM_VoltageSourceWithLosses` |
| **Reached as** | `smpm.Lszero` |
| **Declaration** | `PartialBasicInductionMachine.mo:20` |
| **Parameter** | `Lszero` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0018](../../site-reports/SITE-0018-lszero-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `PartialBasicInductionMachine.mo:20` is reached by this model through
`smpm.Lszero`, and the analysis reached it statically — no value has been observed
