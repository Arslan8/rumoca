# FINDING-02499: `switch2.idealClosingSwitch[1].Goff` in `SMPM_ResistiveBraking`
...
`switch2.idealClosingSwitch[1].Goff`, and the analysis reached it statically — no value has been observed
