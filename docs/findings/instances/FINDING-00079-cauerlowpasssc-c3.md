# FINDING-00079: `c3` in `CauerLowPassSC`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Analog.Examples.CauerLowPassSC` |
| **Reached as** | `c3` |
| **Declaration** | `CauerLowPassSC.mo:10` |
| **Parameter** | `c3` |
| **Claim** | the declaration explicitly permits zero (`min=0`) |
| **Kind** | `physical-bound-permits-zero` |
| **Severity** | low |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0580](../../site-reports/SITE-0580-c3-physical-bound-permits-zero.md) |
...
One occurrence. The declaration at `CauerLowPassSC.mo:10` is reached by this model through
