# FINDING-00973: `conductor1.alpha` in `ResonanceCircuits`
...
| key | value |
|---|---|
| `parameter` | conductor1.alpha |
| `shape` | sum |
| `path` | conductor1.alpha |
| `declared_min` | None |
| `divisor_sites` | 1 |
...
`conductor1.alpha`, and the analysis reached it statically — no value has been observed
