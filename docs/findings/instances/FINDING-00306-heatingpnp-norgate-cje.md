...
One occurrence. The declaration at `PNP.mo:10` is reached by this model through
`T1.Cje`, and the analysis reached it statically — no value has been observed
