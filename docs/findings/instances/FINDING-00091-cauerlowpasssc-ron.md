# FINDING-00091: `R10.IdealCommutingSwitch2.Ron` in `CauerLowPassSC`
...
`R10.IdealCommutingSwitch2.Ron`, and the analysis reached it statically — no value has been observed
