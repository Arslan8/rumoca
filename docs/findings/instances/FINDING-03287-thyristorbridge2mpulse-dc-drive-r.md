...
| `required` | earthing.resistor.R > 0 |
| `declared_min` | None |
...
`earthing.resistor.R`, and the analysis reached it statically — no value has been observed
