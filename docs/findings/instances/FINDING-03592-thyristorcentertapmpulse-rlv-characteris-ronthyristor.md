# FINDING-03592: `rectifier.RonThyristor` in `ThyristorCenterTapmPulse_RLV_Characteristic`
...
| **Declaration** | `ThyristorCenterTapmPulse.mo:7` |
| **Parameter** | `RonThyristor` |
| **Claim** | the declaration explicitly permits zero (`min=0`) |
| **Kind** | `physical-bound-permits-zero` |
| **Severity** | low |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0159](../../site-reports/SITE-0159-ronthyristor-physical-bound-permits-zero.md) |
...
One occurrence. The declaration at `ThyristorCenterTapmPulse.mo:7` is reached by this model through
