# FINDING-04143: `referenceSystem.pointMass3.I` in `PointGravityWithPointMasses2`

| | |
|---|---|
| **Model** | `Modelica.Mechanics.MultiBody.Examples.Elementary.PointGravityWithPointMasses2` |
| **Reached as** | `referenceSystem.pointMass3.I` |
...
| `required` | referenceSystem.pointMass3.I > 0 |
| `declared_min` | None |
...
`referenceSystem.pointMass3.I`, and the analysis reached it statically — no value has been observed
