# FINDING-04963: `smpmData.Lrsigmaq` in `SMPM_VoltageSourceWithLosses`

| | |
|---|---|
| **Model** | `ModelicaTest.Electrical.Machines.SMPM_VoltageSourceWithLosses` |
| **Reached as** | `smpmData.Lrsigmaq` |
| **Declaration** | `SM_ReluctanceRotorData.mo:20` |
| **Parameter** | `Lrsigmaq` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0083](../../site-reports/SITE-0083-lrsigmaq-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `SM_ReluctanceRotorData.mo:20` is reached by this model through
`smpmData.Lrsigmaq`, and the analysis reached it statically — no value has been observed
