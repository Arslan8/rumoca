# FINDING-03919: `material.B_myMax` in `AdvancedSolenoid`
...
| key | value |
|---|---|
| `parameter` | material.B_myMax |
| `shape` | direct |
| `path` | material.B_myMax |
| `declared_min` | None |
| `divisor_sites` | 6 |
...
`material.B_myMax`, and the analysis reached it statically — no value has been observed
