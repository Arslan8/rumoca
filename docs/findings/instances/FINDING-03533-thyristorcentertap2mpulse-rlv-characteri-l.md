# FINDING-03533: `L` in `ThyristorCenterTap2mPulse_RLV_Characteristic`
...
| **Reached as** | `L` |
| **Declaration** | `ThyristorCenterTap2mPulse_RLV_Characteristic.mo:9` |
| **Parameter** | `L` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0859](../../site-reports/SITE-0859-l-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `ThyristorCenterTap2mPulse_RLV_Characteristic.mo:9` is reached by this model through
