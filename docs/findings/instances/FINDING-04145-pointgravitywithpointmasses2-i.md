# FINDING-04145: `referenceSystem.pointMass5.I` in `PointGravityWithPointMasses2`

| | |
|---|---|
| **Model** | `Modelica.Mechanics.MultiBody.Examples.Elementary.PointGravityWithPointMasses2` |
| **Reached as** | `referenceSystem.pointMass5.I` |
| **Declaration** | `Body.mo:114` |
| **Parameter** | `I` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0037](../../site-reports/SITE-0037-i-physical-domain-unenforced.md) |
...
| `required` | referenceSystem.pointMass5.I > 0 |
| `declared_min` | None |
...
One occurrence. The declaration at `Body.mo:114` is reached by this model through
`referenceSystem.pointMass5.I`, and the analysis reached it statically — no value has been observed
