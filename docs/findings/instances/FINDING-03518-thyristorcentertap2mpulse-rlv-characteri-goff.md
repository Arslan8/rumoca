# FINDING-03518: `rectifier.thyristor_n.idealThyristor[1].Goff` in `ThyristorCenterTap2mPulse_RLV_Characteristic`
...
`rectifier.thyristor_n.idealThyristor[1].Goff`, and the analysis reached it statically — no value has been observed
