# FINDING-03837: `core.material.B_myMax` in `ToroidalCoreQuadraticCrossSection`
...
| key | value |
|---|---|
| `parameter` | core.material.B_myMax |
| `shape` | direct |
| `path` | core.material.B_myMax |
| `declared_min` | None |
| `divisor_sites` | 1 |
...
`core.material.B_myMax`, and the analysis reached it statically — no value has been observed
