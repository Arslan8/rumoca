...
One occurrence. The declaration at `ThyristorBridge2mPulse_DC_Drive.mo:18` is reached by this model through
`LMains`, and the analysis reached it statically — no value has been observed
