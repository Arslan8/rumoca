# FINDING-02106: `switchedRheostat.idealCommutingSwitch.Ron` in `IMS_Start`
...
| **Declaration** | `IdealCommutingSwitch.mo:4` |
| **Parameter** | `Ron` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0212](../../site-reports/SITE-0212-ron-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `IdealCommutingSwitch.mo:4` is reached by this model through
`switchedRheostat.idealCommutingSwitch.Ron`, and the analysis reached it statically — no value has been observed
