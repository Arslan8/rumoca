# FINDING-04931: `dqCurrentController.unitResistance` in `SMPM_VoltageSourceWithLosses`

| | |
|---|---|
| **Model** | `ModelicaTest.Electrical.Machines.SMPM_VoltageSourceWithLosses` |
| **Reached as** | `dqCurrentController.unitResistance` |
| **Declaration** | `DQCurrentController.mo:75` |
| **Parameter** | `unitResistance` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0316](../../site-reports/SITE-0316-unitresistance-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `DQCurrentController.mo:75` is reached by this model through
`dqCurrentController.unitResistance`, and the analysis reached it statically — no value has been observed
