# FINDING-03530: `rectifier.RonThyristor` in `ThyristorCenterTap2mPulse_RLV_Characteristic`
...
| **Declaration** | `ThyristorCenterTap2mPulse.mo:7` |
| **Parameter** | `RonThyristor` |
| **Claim** | the declaration explicitly permits zero (`min=0`) |
| **Kind** | `physical-bound-permits-zero` |
| **Severity** | low |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0157](../../site-reports/SITE-0157-ronthyristor-physical-bound-permits-zero.md) |
...
One occurrence. The declaration at `ThyristorCenterTap2mPulse.mo:7` is reached by this model through
`rectifier.RonThyristor`, and the analysis reached it statically — no value has been observed
