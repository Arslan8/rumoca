# FINDING-04589: `innerPipe.V_flowNominal` in `IndirectCooling`
...
| key | value |
|---|---|
| `parameter` | innerPipe.V_flowNominal |
| `shape` | direct |
| `path` | innerPipe.V_flowNominal |
| `declared_min` | None |
| `divisor_sites` | 1 |
...
`innerPipe.V_flowNominal`, and the analysis reached it statically — no value has been observed
