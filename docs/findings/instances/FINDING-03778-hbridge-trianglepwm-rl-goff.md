# FINDING-03778: `hbridge.inverter_n.diode_n.Goff` in `HBridge_TrianglePWM_RL`
...
`hbridge.inverter_n.diode_n.Goff`, and the analysis reached it statically — no value has been observed
