...
One occurrence. The declaration at `Spring.mo:11` is reached by this model through
`spring1.m`, and the analysis reached it statically — no value has been observed
