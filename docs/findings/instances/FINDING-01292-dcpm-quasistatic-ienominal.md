# FINDING-01292: `dcpm1.IeNominal` in `DCPM_QuasiStatic`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Machines.Examples.DCMachines.DCPM_QuasiStatic` |
| **Reached as** | `dcpm1.IeNominal` |
...
| key | value |
|---|---|
| `parameter` | dcpm1.IeNominal |
| `shape` | propagated |
| `path` | dcpm1.IeNominal -> dcpm1.psi_eNominal |
| `declared_min` | None |
| `divisor_sites` | 2 |
...
`dcpm1.IeNominal`, and the analysis reached it statically — no value has been observed
