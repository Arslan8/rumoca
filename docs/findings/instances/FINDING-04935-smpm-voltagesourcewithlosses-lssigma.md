# FINDING-04935: `smpmData.Lssigma` in `SMPM_VoltageSourceWithLosses`

| | |
|---|---|
| **Model** | `ModelicaTest.Electrical.Machines.SMPM_VoltageSourceWithLosses` |
| **Reached as** | `smpmData.Lssigma` |
| **Declaration** | `InductionMachineData.mo:23` |
| **Parameter** | `Lssigma` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0024](../../site-reports/SITE-0024-lssigma-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `InductionMachineData.mo:23` is reached by this model through
`smpmData.Lssigma`, and the analysis reached it statically — no value has been observed
