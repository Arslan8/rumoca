# FINDING-00189: `R1` in `CompareTransformers`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Analog.Examples.CompareTransformers` |
| **Reached as** | `R1` |
| **Declaration** | `CompareTransformers.mo:11` |
| **Parameter** | `R1` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0669](../../site-reports/SITE-0669-r1-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `CompareTransformers.mo:11` is reached by this model through
