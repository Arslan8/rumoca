# FINDING-01763: `inverter.transistor_p.idealGTOThyristor[3].Ron` in `IMC_InverterDrive`
...
`inverter.transistor_p.idealGTOThyristor[3].Ron`, and the analysis reached it statically — no value has been observed
