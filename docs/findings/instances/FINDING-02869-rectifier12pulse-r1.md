...
One occurrence. The declaration at `PartialBasicTransformer.mo:9` is reached by this model through
`transformer2.R1`, and the analysis reached it statically — no value has been observed
