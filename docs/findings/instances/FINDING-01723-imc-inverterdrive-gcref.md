# FINDING-01723: `aimc.statorCore.coreParameters.GcRef` in `IMC_InverterDrive`
...
`aimc.statorCore.coreParameters.GcRef`, and the analysis reached it statically — no value has been observed
