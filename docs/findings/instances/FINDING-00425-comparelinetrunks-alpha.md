# FINDING-00425: `oLine3.G[4].alpha` in `CompareLineTrunks`
...
| key | value |
|---|---|
| `parameter` | oLine3.G[4].alpha |
| `shape` | sum |
| `path` | oLine3.G[4].alpha |
| `declared_min` | None |
| `divisor_sites` | 1 |
...
`oLine3.G[4].alpha`, and the analysis reached it statically — no value has been observed
