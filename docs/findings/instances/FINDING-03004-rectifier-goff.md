# FINDING-03004: `idealDiode1.idealDiode[3].Goff` in `Rectifier`
...
`idealDiode1.idealDiode[3].Goff`, and the analysis reached it statically — no value has been observed
