# FINDING-02751: `idealCommutingSwitch.idealCommutingSwitch[1].Ron` in `IMC_Transformer`
...
`idealCommutingSwitch.idealCommutingSwitch[1].Ron`, and the analysis reached it statically — no value has been observed
