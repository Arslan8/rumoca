# FINDING-02011: `switchYD.Ron` in `IMC_YD`
...
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0810](../../site-reports/SITE-0810-ron-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `SwitchYD.mo:4` is reached by this model through
`switchYD.Ron`, and the analysis reached it statically — no value has been observed
