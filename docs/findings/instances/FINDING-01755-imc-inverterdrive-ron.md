# FINDING-01755: `inverter.diode_p.idealDiode[1].Ron` in `IMC_InverterDrive`
...
`inverter.diode_p.idealDiode[1].Ron`, and the analysis reached it statically — no value has been observed
