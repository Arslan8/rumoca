# FINDING-03630: `dcdc.RonDiode` in `ChopperBuckBoost_DutyCycle`
...
| **Declaration** | `ChopperBuckBoost.mo:12` |
| **Parameter** | `RonDiode` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0651](../../site-reports/SITE-0651-rondiode-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `ChopperBuckBoost.mo:12` is reached by this model through
`dcdc.RonDiode`, and the analysis reached it statically — no value has been observed
