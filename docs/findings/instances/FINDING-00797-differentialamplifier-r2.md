# FINDING-00797: `data.R2` in `DifferentialAmplifier`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Analog.Examples.OpAmps.DifferentialAmplifier` |
| **Reached as** | `data.R2` |
| **Declaration** | `DifferentialAmplifierData.mo:20` |
| **Parameter** | `R2` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0696](../../site-reports/SITE-0696-r2-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `DifferentialAmplifierData.mo:20` is reached by this model through
`data.R2`, and the analysis reached it statically — no value has been observed
