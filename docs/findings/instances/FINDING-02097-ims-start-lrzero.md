...
One occurrence. The declaration at `IM_SlipRing.mo:34` is reached by this model through
`aims.Lrzero`, and the analysis reached it statically — no value has been observed
