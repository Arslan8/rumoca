# FINDING-01371: `dcpm2.core.coreParameters.GcRef` in `DCPM_withLosses`
...
`dcpm2.core.coreParameters.GcRef`, and the analysis reached it statically — no value has been observed
