# FINDING-05011: `innerResistor.R` in `ThyristorBridge2mPulse_R`

| | |
|---|---|
| **Model** | `ModelicaTest.Electrical.PowerConverters.ThyristorBridge2mPulse_R` |
| **Reached as** | `innerResistor.R` |
...
`innerResistor.R`, and the analysis reached it statically — no value has been observed
