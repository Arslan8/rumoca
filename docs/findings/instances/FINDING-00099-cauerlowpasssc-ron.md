# FINDING-00099: `R4.IdealCommutingSwitch2.Ron` in `CauerLowPassSC`
...
`R4.IdealCommutingSwitch2.Ron`, and the analysis reached it statically — no value has been observed
