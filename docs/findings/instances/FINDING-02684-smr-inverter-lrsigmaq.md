...
One occurrence. The declaration at `SM_ReluctanceRotor.mo:57` is reached by this model through
`smr.Lrsigmaq`, and the analysis reached it statically — no value has been observed
