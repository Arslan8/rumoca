# FINDING-04256: `body2.body.I_22` in `PlanarFourbar`

| | |
|---|---|
| **Model** | `Modelica.Mechanics.MultiBody.Examples.Loops.PlanarFourbar` |
| **Reached as** | `body2.body.I_22` |
...
`body2.body.I_22`, and the analysis reached it statically — no value has been observed
