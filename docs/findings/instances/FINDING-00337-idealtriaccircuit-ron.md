# FINDING-00337: `idealTriac.idealThyristor.Ron` in `IdealTriacCircuit`
...
`idealTriac.idealThyristor.Ron`, and the analysis reached it statically — no value has been observed
