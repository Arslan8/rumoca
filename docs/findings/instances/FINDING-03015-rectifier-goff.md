# FINDING-03015: `Goff` in `Rectifier`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Polyphase.Examples.Rectifier` |
| **Reached as** | `Goff` |
| **Declaration** | `Rectifier.mo:13` |
| **Parameter** | `Goff` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0773](../../site-reports/SITE-0773-goff-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `Rectifier.mo:13` is reached by this model through
