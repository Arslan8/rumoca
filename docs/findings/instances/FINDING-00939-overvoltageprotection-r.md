# FINDING-00939: `zDiode.R` in `OvervoltageProtection`
...
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0883](../../site-reports/SITE-0883-r-physical-domain-unenforced.md) |
...
`zDiode.R`, and the analysis reached it statically — no value has been observed
