# FINDING-01972: `switchYD.idealCloser.idealClosingSwitch[1].Ron` in `IMC_YD`
...
`switchYD.idealCloser.idealClosingSwitch[1].Ron`, and the analysis reached it statically — no value has been observed
