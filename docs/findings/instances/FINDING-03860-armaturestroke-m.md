# FINDING-03860: `pmActuator.armature.mass.m` in `ArmatureStroke`
...
`pmActuator.armature.mass.m`, and the analysis reached it statically — no value has been observed
