# FINDING-04154: `referenceSystem.pointMass2.I_11` in `PointGravityWithPointMasses2`

| | |
|---|---|
| **Model** | `Modelica.Mechanics.MultiBody.Examples.Elementary.PointGravityWithPointMasses2` |
| **Reached as** | `referenceSystem.pointMass2.I_11` |
...
| **Severity** | low |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0034](../../site-reports/SITE-0034-i-11-physical-bound-permits-zero.md) |
...
| `required` | referenceSystem.pointMass2.I_11 > 0 |
| `declared_min` | 0.0 |
...
One occurrence. The declaration at `Body.mo:17` is reached by this model through
`referenceSystem.pointMass2.I_11`, and the analysis reached it statically — no value has been observed
