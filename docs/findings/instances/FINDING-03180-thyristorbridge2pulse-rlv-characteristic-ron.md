# FINDING-03180: `rectifier.thyristor_p1.Ron` in `ThyristorBridge2Pulse_RLV_Characteristic`
...
`rectifier.thyristor_p1.Ron`, and the analysis reached it statically — no value has been observed
