# FINDING-04929: `dqCurrentController.Lq` in `SMPM_VoltageSourceWithLosses`

| | |
|---|---|
| **Model** | `ModelicaTest.Electrical.Machines.SMPM_VoltageSourceWithLosses` |
| **Reached as** | `dqCurrentController.Lq` |
| **Declaration** | `DQCurrentController.mo:13` |
| **Parameter** | `Lq` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0315](../../site-reports/SITE-0315-lq-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `DQCurrentController.mo:13` is reached by this model through
`dqCurrentController.Lq`, and the analysis reached it statically — no value has been observed
