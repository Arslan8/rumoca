# FINDING-03248: `dcpm.Lme` in `ThyristorBridge2mPulse_DC_Drive`
...
| `parameter` | dcpm.Lme |
| `shape` | propagated |
| `path` | dcpm.Lme -> dcpm.psi_eNominal |
| `declared_min` | None |
| `divisor_sites` | 2 |
...
`dcpm.Lme`, and the analysis reached it statically — no value has been observed
