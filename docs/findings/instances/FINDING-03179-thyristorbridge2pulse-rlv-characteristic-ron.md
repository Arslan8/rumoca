# FINDING-03179: `rectifier.thyristor_n2.Ron` in `ThyristorBridge2Pulse_RLV_Characteristic`
...
`rectifier.thyristor_n2.Ron`, and the analysis reached it statically — no value has been observed
