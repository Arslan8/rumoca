...
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0771](../../site-reports/SITE-0771-re-physical-domain-unenforced.md) |
...
`RE`, and the analysis reached it statically — no value has been observed
