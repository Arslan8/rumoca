# FINDING-01598: `imc.spacePhasorS.m` in `IMC_DCBraking`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Machines.Examples.InductionMachines.IMC_DCBraking` |
| **Reached as** | `imc.spacePhasorS.m` |
...
`imc.spacePhasorS.m`, and the analysis reached it statically — no value has been observed
