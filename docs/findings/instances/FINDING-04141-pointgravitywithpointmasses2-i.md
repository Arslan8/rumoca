# FINDING-04141: `referenceSystem.pointMass1.I` in `PointGravityWithPointMasses2`

| | |
|---|---|
| **Model** | `Modelica.Mechanics.MultiBody.Examples.Elementary.PointGravityWithPointMasses2` |
| **Reached as** | `referenceSystem.pointMass1.I` |
...
| `required` | referenceSystem.pointMass1.I > 0 |
| `declared_min` | None |
...
`referenceSystem.pointMass1.I`, and the analysis reached it statically — no value has been observed
