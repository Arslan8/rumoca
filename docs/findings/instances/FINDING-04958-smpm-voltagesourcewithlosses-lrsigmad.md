# FINDING-04958: `smpm.Lrsigmad` in `SMPM_VoltageSourceWithLosses`

| | |
|---|---|
| **Model** | `ModelicaTest.Electrical.Machines.SMPM_VoltageSourceWithLosses` |
| **Reached as** | `smpm.Lrsigmad` |
| **Declaration** | `SM_PermanentMagnet.mo:59` |
| **Parameter** | `Lrsigmad` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0097](../../site-reports/SITE-0097-lrsigmad-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `SM_PermanentMagnet.mo:59` is reached by this model through
`smpm.Lrsigmad`, and the analysis reached it statically — no value has been observed
