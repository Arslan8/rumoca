# FINDING-03770: `hbridge.inverter_n.diode_n.Ron` in `HBridge_TrianglePWM_RL`
...
`hbridge.inverter_n.diode_n.Ron`, and the analysis reached it statically — no value has been observed
