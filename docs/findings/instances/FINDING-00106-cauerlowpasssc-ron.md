# FINDING-00106: `R9.IdealCommutingSwitch1.Ron` in `CauerLowPassSC`
...
`R9.IdealCommutingSwitch1.Ron`, and the analysis reached it statically — no value has been observed
