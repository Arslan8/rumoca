...
One occurrence. The declaration at `IM_SlipRingData.mo:16` is reached by this model through
`aimsData.Lrzero`, and the analysis reached it statically — no value has been observed
