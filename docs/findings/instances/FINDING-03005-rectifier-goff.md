# FINDING-03005: `idealDiode2.idealDiode[1].Goff` in `Rectifier`
...
`idealDiode2.idealDiode[1].Goff`, and the analysis reached it statically — no value has been observed
