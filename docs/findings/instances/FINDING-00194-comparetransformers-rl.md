# FINDING-00194: `RL` in `CompareTransformers`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Analog.Examples.CompareTransformers` |
| **Reached as** | `RL` |
| **Declaration** | `CompareTransformers.mo:21` |
| **Parameter** | `RL` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0674](../../site-reports/SITE-0674-rl-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `CompareTransformers.mo:21` is reached by this model through
