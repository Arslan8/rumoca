# FINDING-05172: `vehicleDragInConst.A` in `Vehicles`
...
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0880](../../site-reports/SITE-0880-a-physical-domain-unenforced.md) |
...
`vehicleDragInConst.A`, and the analysis reached it statically — no value has been observed
