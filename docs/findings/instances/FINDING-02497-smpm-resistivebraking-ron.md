# FINDING-02497: `switch3.idealClosingSwitch[2].Ron` in `SMPM_ResistiveBraking`
...
`switch3.idealClosingSwitch[2].Ron`, and the analysis reached it statically — no value has been observed
