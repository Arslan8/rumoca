# FINDING-03903: `r_arm` in `AdvancedSolenoid`
...
| **Severity** | medium |
| **Sanitizer** | `divisor` |
| **Fix site** | [SITE-0371](../../site-reports/SITE-0371-r-arm-divisor-reachable-zero.md) |
...
One occurrence. The declaration at `AdvancedSolenoid.mo:34` is reached by this model through
