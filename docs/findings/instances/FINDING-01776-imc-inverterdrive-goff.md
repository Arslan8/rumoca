# FINDING-01776: `inverter.transistor_n.idealGTOThyristor[1].Goff` in `IMC_InverterDrive`
...
`inverter.transistor_n.idealGTOThyristor[1].Goff`, and the analysis reached it statically — no value has been observed
