# FINDING-03535: `rectifier.GoffDiode` in `DiodeCenterTapmPulse`
...
| **Declaration** | `DiodeCenterTapmPulse.mo:8` |
| **Parameter** | `GoffDiode` |
| **Claim** | the declaration explicitly permits zero (`min=0`) |
| **Kind** | `physical-bound-permits-zero` |
| **Severity** | low |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0602](../../site-reports/SITE-0602-goffdiode-physical-bound-permits-zero.md) |
...
One occurrence. The declaration at `DiodeCenterTapmPulse.mo:8` is reached by this model through
