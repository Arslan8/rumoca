# FINDING-02849: `transformer1.l2sigma.inductor[1].L` in `Rectifier12pulse`
...
`transformer1.l2sigma.inductor[1].L`, and the analysis reached it statically — no value has been observed
