...
One occurrence. The declaration at `AirGapR.mo:3` is reached by this model through
`smpm.airGap.Lmd`, and the analysis reached it statically — no value has been observed
