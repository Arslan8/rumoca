# FINDING-03520: `rectifier.thyristor_n.idealThyristor[3].Goff` in `ThyristorCenterTap2mPulse_RLV_Characteristic`
...
`rectifier.thyristor_n.idealThyristor[3].Goff`, and the analysis reached it statically — no value has been observed
