# FINDING-00192: `L2sigma` in `CompareTransformers`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Analog.Examples.CompareTransformers` |
| **Reached as** | `L2sigma` |
| **Declaration** | `CompareTransformers.mo:17` |
| **Parameter** | `L2sigma` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0672](../../site-reports/SITE-0672-l2sigma-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `CompareTransformers.mo:17` is reached by this model through
`L2sigma`, and the analysis reached it statically — no value has been observed
