# FINDING-04186: `referenceSystem.pointMass4.I_32` in `PointGravityWithPointMasses2`

| | |
|---|---|
| **Model** | `Modelica.Mechanics.MultiBody.Examples.Elementary.PointGravityWithPointMasses2` |
| **Reached as** | `referenceSystem.pointMass4.I_32` |
...
| `required` | referenceSystem.pointMass4.I_32 > 0 |
...
`referenceSystem.pointMass4.I_32`, and the analysis reached it statically — no value has been observed
