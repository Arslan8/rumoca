# FINDING-04001: `boxBody1.body.I_33` in `DoublePendulumInitTip`

| | |
|---|---|
| **Model** | `Modelica.Mechanics.MultiBody.Examples.Elementary.DoublePendulumInitTip` |
| **Reached as** | `boxBody1.body.I_33` |
...
`boxBody1.body.I_33`, and the analysis reached it statically — no value has been observed
