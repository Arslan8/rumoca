# FINDING-02502: `switch3.idealClosingSwitch[1].Goff` in `SMPM_ResistiveBraking`
...
`switch3.idealClosingSwitch[1].Goff`, and the analysis reached it statically — no value has been observed
