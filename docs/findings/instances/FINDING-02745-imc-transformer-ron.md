# FINDING-02745: `idealCloser.idealClosingSwitch[1].Ron` in `IMC_Transformer`
...
`idealCloser.idealClosingSwitch[1].Ron`, and the analysis reached it statically — no value has been observed
