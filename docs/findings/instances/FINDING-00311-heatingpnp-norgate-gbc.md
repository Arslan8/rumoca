# FINDING-00311: `T2.Gbc` in `HeatingPNP_NORGate`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Analog.Examples.HeatingPNP_NORGate` |
| **Reached as** | `T2.Gbc` |
| **Declaration** | `PNP.mo:16` |
| **Parameter** | `Gbc` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0762](../../site-reports/SITE-0762-gbc-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `PNP.mo:16` is reached by this model through
`T2.Gbc`, and the analysis reached it statically — no value has been observed
