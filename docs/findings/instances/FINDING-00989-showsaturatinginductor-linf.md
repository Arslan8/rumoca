# FINDING-00989: `SaturatingInductance1.Linf` in `ShowSaturatingInductor`
...
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0791](../../site-reports/SITE-0791-linf-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `SaturatingInductor.mo:14` is reached by this model through
`SaturatingInductance1.Linf`, and the analysis reached it statically — no value has been observed
