# FINDING-02301: `diodeBridge2mPulse.diode_p.Goff` in `SMPM_Braking`
...
`diodeBridge2mPulse.diode_p.Goff`, and the analysis reached it statically — no value has been observed
