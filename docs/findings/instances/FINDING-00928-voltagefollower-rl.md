# FINDING-00928: `Rl` in `VoltageFollower`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Analog.Examples.OpAmps.VoltageFollower` |
| **Reached as** | `Rl` |
| **Declaration** | `VoltageFollower.mo:10` |
| **Parameter** | `Rl` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0881](../../site-reports/SITE-0881-rl-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `VoltageFollower.mo:10` is reached by this model through
