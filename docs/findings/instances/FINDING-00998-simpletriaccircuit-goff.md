# FINDING-00998: `simpleTriac.idealDiode.Goff` in `SimpleTriacCircuit`
...
`simpleTriac.idealDiode.Goff`, and the analysis reached it statically — no value has been observed
