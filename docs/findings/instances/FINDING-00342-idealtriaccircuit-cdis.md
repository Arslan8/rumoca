...
One occurrence. The declaration at `IdealTriac.mo:12` is reached by this model through
`idealTriac.Cdis`, and the analysis reached it statically — no value has been observed
