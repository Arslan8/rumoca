# FINDING-04577: `outerPipe.flowPort_b.medium.rho` in `IndirectCooling`
...
`outerPipe.flowPort_b.medium.rho`, and the analysis reached it statically — no value has been observed
