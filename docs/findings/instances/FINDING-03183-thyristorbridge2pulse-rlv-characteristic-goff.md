# FINDING-03183: `rectifier.thyristor_n2.Goff` in `ThyristorBridge2Pulse_RLV_Characteristic`
...
`rectifier.thyristor_n2.Goff`, and the analysis reached it statically — no value has been observed
