# FINDING-02973: `transformer.r2.R` in `TransformerTestbench`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Machines.Examples.Transformers.TransformerTestbench` |
| **Reached as** | `transformer.r2.R` |
...
`transformer.r2.R`, and the analysis reached it statically — no value has been observed
