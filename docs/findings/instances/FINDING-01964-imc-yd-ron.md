# FINDING-01964: `switchYD.idealCloser.Ron` in `IMC_YD`
...
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0079](../../site-reports/SITE-0079-ron-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `IdealClosingSwitch.mo:4` is reached by this model through
`switchYD.idealCloser.Ron`, and the analysis reached it statically — no value has been observed
