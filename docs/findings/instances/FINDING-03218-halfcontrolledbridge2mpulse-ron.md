# FINDING-03218: `rectifier.diode_n.Ron` in `HalfControlledBridge2mPulse`
...
`rectifier.diode_n.Ron`, and the analysis reached it statically — no value has been observed
