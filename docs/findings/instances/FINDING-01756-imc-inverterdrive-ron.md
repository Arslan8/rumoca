# FINDING-01756: `inverter.diode_p.idealDiode[2].Ron` in `IMC_InverterDrive`
...
`inverter.diode_p.idealDiode[2].Ron`, and the analysis reached it statically — no value has been observed
