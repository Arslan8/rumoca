# FINDING-03998: `boxBody2.body.I_11` in `DoublePendulumInitTip`

| | |
|---|---|
| **Model** | `Modelica.Mechanics.MultiBody.Examples.Elementary.DoublePendulumInitTip` |
| **Reached as** | `boxBody2.body.I_11` |
...
`boxBody2.body.I_11`, and the analysis reached it statically — no value has been observed
