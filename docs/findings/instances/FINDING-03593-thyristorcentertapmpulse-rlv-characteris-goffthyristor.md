# FINDING-03593: `rectifier.GoffThyristor` in `ThyristorCenterTapmPulse_RLV_Characteristic`
...
| **Declaration** | `ThyristorCenterTapmPulse.mo:9` |
| **Parameter** | `GoffThyristor` |
| **Claim** | the declaration explicitly permits zero (`min=0`) |
| **Kind** | `physical-bound-permits-zero` |
| **Severity** | low |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0160](../../site-reports/SITE-0160-goffthyristor-physical-bound-permits-zero.md) |
...
One occurrence. The declaration at `ThyristorCenterTapmPulse.mo:9` is reached by this model through
