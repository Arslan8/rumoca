# FINDING-02243: `smee.pi` in `SMEE_Generator`
...
| `parameter` | smee.pi |
| `shape` | propagated |
| `path` | smee.pi -> smee.strayLoadParameters.wRef |
| `declared_min` | None |
| `divisor_sites` | 6 |
...
`smee.pi`, and the analysis reached it statically — no value has been observed
