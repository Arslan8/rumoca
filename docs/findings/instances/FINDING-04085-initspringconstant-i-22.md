# FINDING-04085: `body.body.I_22` in `InitSpringConstant`

| | |
|---|---|
| **Model** | `Modelica.Mechanics.MultiBody.Examples.Elementary.InitSpringConstant` |
| **Reached as** | `body.body.I_22` |
...
`body.body.I_22`, and the analysis reached it statically — no value has been observed
