# FINDING-03216: `rectifier.RonDiode` in `HalfControlledBridge2mPulse`
...
| **Declaration** | `HalfControlledBridge2mPulse.mo:7` |
| **Parameter** | `RonDiode` |
| **Claim** | the declaration explicitly permits zero (`min=0`) |
| **Kind** | `physical-bound-permits-zero` |
| **Severity** | low |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0286](../../site-reports/SITE-0286-rondiode-physical-bound-permits-zero.md) |
...
One occurrence. The declaration at `HalfControlledBridge2mPulse.mo:7` is reached by this model through
