# FINDING-00020: `mixingUnit.tau0` in `MixingUnitWithContinuousControl`
...
| key | value |
|---|---|
| `parameter` | mixingUnit.tau0 |
| `shape` | direct |
| `path` | mixingUnit.tau0 |
| `declared_min` | None |
| `divisor_sites` | 14 |
...
`mixingUnit.tau0`, and the analysis reached it statically — no value has been observed
