# FINDING-00793: `PIA.C` in `ControlCircuit`
...
| **Severity** | low |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0293](../../site-reports/SITE-0293-c-physical-bound-permits-zero.md) |
...
One occurrence. The declaration at `PI.mo:9` is reached by this model through
`PIA.C`, and the analysis reached it statically — no value has been observed
