# FINDING-04990: `R` in `HalfControlledBridge2mPulse`

| | |
|---|---|
| **Model** | `ModelicaTest.Electrical.PowerConverters.HalfControlledBridge2mPulse` |
| **Reached as** | `R` |
| **Declaration** | `PowerConverters.mo:15` |
| **Parameter** | `R` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0770](../../site-reports/SITE-0770-r-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `PowerConverters.mo:15` is reached by this model through
