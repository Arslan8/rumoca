...
One occurrence. The declaration at `IM_SquirrelCageData.mo:9` is reached by this model through
`aimcData.Lrsigma`, and the analysis reached it statically — no value has been observed
