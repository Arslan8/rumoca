# FINDING-03047: `LT` in `TransformerYD`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Polyphase.Examples.TransformerYD` |
| **Reached as** | `LT` |
| **Declaration** | `TransformerYD.mo:8` |
| **Parameter** | `LT` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0874](../../site-reports/SITE-0874-lt-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `TransformerYD.mo:8` is reached by this model through
