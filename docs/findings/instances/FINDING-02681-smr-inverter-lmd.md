...
One occurrence. The declaration at `SM_ReluctanceRotor.mo:42` is reached by this model through
`smr.Lmd`, and the analysis reached it statically — no value has been observed
