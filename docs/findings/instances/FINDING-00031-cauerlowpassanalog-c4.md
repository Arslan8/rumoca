# FINDING-00031: `c4` in `CauerLowPassAnalog`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Analog.Examples.CauerLowPassAnalog` |
| **Reached as** | `c4` |
| **Declaration** | `CauerLowPassAnalog.mo:11` |
| **Parameter** | `c4` |
| **Claim** | the declaration explicitly permits zero (`min=0`) |
| **Kind** | `physical-bound-permits-zero` |
| **Severity** | low |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0569](../../site-reports/SITE-0569-c4-physical-bound-permits-zero.md) |
...
One occurrence. The declaration at `CauerLowPassAnalog.mo:11` is reached by this model through
`c4`, and the analysis reached it statically — no value has been observed
