# FINDING-03621: `inverter.RonTransistor` in `SinglePhaseTwoLevel_RL`
...
`inverter.RonTransistor`, and the analysis reached it statically — no value has been observed
