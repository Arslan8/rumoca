...
One occurrence. The declaration at `ChopperStepUp.mo:13` is reached by this model through
`chopperStepUp.GoffDiode`, and the analysis reached it statically — no value has been observed
