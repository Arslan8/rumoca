# FINDING-04966: `smpmData.Lmd` in `SMPM_VoltageSourceWithLosses`

| | |
|---|---|
| **Model** | `ModelicaTest.Electrical.Machines.SMPM_VoltageSourceWithLosses` |
| **Reached as** | `smpmData.Lmd` |
| **Declaration** | `SM_ReluctanceRotorData.mo:6` |
| **Parameter** | `Lmd` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0086](../../site-reports/SITE-0086-lmd-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `SM_ReluctanceRotorData.mo:6` is reached by this model through
`smpmData.Lmd`, and the analysis reached it statically — no value has been observed
