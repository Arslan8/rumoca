# FINDING-02046: `switchYDwithArc.idealCloser.closerWithArc[2].Goff` in `IMC_YDarc`
...
`switchYDwithArc.idealCloser.closerWithArc[2].Goff`, and the analysis reached it statically — no value has been observed
