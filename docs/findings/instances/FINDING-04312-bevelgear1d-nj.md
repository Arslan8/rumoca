# FINDING-04312: `inertia1.rotorWith3DEffects.nJ` in `BevelGear1D`
...
`inertia1.rotorWith3DEffects.nJ`, and the analysis reached it statically — no value has been observed
