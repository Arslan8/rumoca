...
| key | value |
|---|---|
| `parameter` | dcpm.IeNominal |
| `shape` | propagated |
| `path` | dcpm.IeNominal -> dcpm.psi_eNominal |
| `declared_min` | None |
| `divisor_sites` | 2 |
...
`dcpm.IeNominal`, and the analysis reached it statically — no value has been observed
