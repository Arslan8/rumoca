# FINDING-00978: `L` in `ResonanceCircuits`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Analog.Examples.ResonanceCircuits` |
| **Reached as** | `L` |
| **Declaration** | `ResonanceCircuits.mo:7` |
| **Parameter** | `L` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0779](../../site-reports/SITE-0779-l-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `ResonanceCircuits.mo:7` is reached by this model through
