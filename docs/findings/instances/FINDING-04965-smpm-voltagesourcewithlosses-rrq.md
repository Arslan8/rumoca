# FINDING-04965: `smpmData.Rrq` in `SMPM_VoltageSourceWithLosses`
...
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0085](../../site-reports/SITE-0085-rrq-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `SM_ReluctanceRotorData.mo:30` is reached by this model through
`smpmData.Rrq`, and the analysis reached it statically — no value has been observed
