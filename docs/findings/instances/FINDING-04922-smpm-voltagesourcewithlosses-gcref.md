# FINDING-04922: `smpm.statorCore.coreParameters.GcRef` in `SMPM_VoltageSourceWithLosses`
...
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0309](../../site-reports/SITE-0309-gcref-physical-domain-unenforced.md) |
...
`smpm.statorCore.coreParameters.GcRef`, and the analysis reached it statically — no value has been observed
