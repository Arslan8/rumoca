...
One occurrence. The declaration at `Potentiometer.mo:3` is reached by this model through
`potentiometer.R`, and the analysis reached it statically — no value has been observed
