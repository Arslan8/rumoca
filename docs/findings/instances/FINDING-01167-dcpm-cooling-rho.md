# FINDING-01167: `cooling.flowPort_a.medium.rho` in `DCPM_Cooling`
...
`cooling.flowPort_a.medium.rho`, and the analysis reached it statically — no value has been observed
