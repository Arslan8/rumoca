# FINDING-04945: `smpm.inertiaStator.J` in `SMPM_VoltageSourceWithLosses`
...
`smpm.inertiaStator.J`, and the analysis reached it statically — no value has been observed
