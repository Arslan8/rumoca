# FINDING-01977: `switchYD.idealOpener.idealOpeningSwitch[3].Ron` in `IMC_YD`
...
`switchYD.idealOpener.idealOpeningSwitch[3].Ron`, and the analysis reached it statically — no value has been observed
