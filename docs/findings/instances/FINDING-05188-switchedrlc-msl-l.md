# FINDING-05188: `L` in `SwitchedRLC_MSL`

| | |
|---|---|
| **Model** | `SwitchedRLC_MSL` |
| **Reached as** | `L` |
| **Declaration** | `SwitchedRLC_MSL.mo:6` |
| **Parameter** | `L` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0816](../../site-reports/SITE-0816-l-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `SwitchedRLC_MSL.mo:6` is reached by this model through
