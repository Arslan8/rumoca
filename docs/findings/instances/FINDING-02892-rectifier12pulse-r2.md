...
One occurrence. The declaration at `TransformerData.mo:45` is reached by this model through
`transformerData1.R2`, and the analysis reached it statically — no value has been observed
