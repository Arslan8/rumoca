# FINDING-01075: `S.Ron` in `RealSwitch`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Analog.Examples.Utilities.RealSwitch` |
| **Reached as** | `S.Ron` |
| **Declaration** | `ControlledIdealTwoWaySwitch.mo:4` |
| **Parameter** | `Ron` |
| **Claim** | the declaration explicitly permits zero (`min=0`) |
| **Kind** | `physical-bound-permits-zero` |
| **Severity** | low |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0593](../../site-reports/SITE-0593-ron-physical-bound-permits-zero.md) |
...
One occurrence. The declaration at `ControlledIdealTwoWaySwitch.mo:4` is reached by this model through
`S.Ron`, and the analysis reached it statically — no value has been observed
