# FINDING-01209: `dcpmData.wNominal` in `DCPM_CurrentControlled`
...
| `shape` | propagated |
| `path` | dcpmData.wNominal -> wLoad -> loadTorque.w_nominal |
| `declared_min` | None |
| `divisor_sites` | 10 |
...
`dcpmData.wNominal`, and the analysis reached it statically — no value has been observed
