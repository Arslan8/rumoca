# FINDING-01258: `dcdcInverter2.Ti` in `DCPM_Drive`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Machines.Examples.DCMachines.DCPM_Drive` |
| **Reached as** | `dcdcInverter2.Ti` |
...
| key | value |
|---|---|
| `parameter` | dcdcInverter2.Ti |
| `shape` | propagated |
| `path` | dcdcInverter2.Ti -> dcdcInverter2.idealDcDc.Ti |
| `declared_min` | None |
| `divisor_sites` | 1 |
...
`dcdcInverter2.Ti`, and the analysis reached it statically — no value has been observed
