# FINDING-01975: `switchYD.idealOpener.idealOpeningSwitch[1].Ron` in `IMC_YD`
...
`switchYD.idealOpener.idealOpeningSwitch[1].Ron`, and the analysis reached it statically — no value has been observed
