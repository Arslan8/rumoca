...
One occurrence. The declaration at `AdvancedSolenoid.mo:59` is reached by this model through
`rho_steel`, and the analysis reached it statically — no value has been observed
