# FINDING-02501: `switch2.idealClosingSwitch[3].Goff` in `SMPM_ResistiveBraking`
...
`switch2.idealClosingSwitch[3].Goff`, and the analysis reached it statically — no value has been observed
