...
One occurrence. The declaration at `HBridge.mo:8` is reached by this model through
`hbridge.RonTransistor`, and the analysis reached it statically — no value has been observed
