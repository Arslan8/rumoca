# FINDING-00159: `R10.R` in `CauerLowPassSC`
...
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0815](../../site-reports/SITE-0815-r-physical-domain-unenforced.md) |
...
`R10.R`, and the analysis reached it statically — no value has been observed
