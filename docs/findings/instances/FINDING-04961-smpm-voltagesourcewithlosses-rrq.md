# FINDING-04961: `smpm.Rrq` in `SMPM_VoltageSourceWithLosses`

| | |
|---|---|
| **Model** | `ModelicaTest.Electrical.Machines.SMPM_VoltageSourceWithLosses` |
| **Reached as** | `smpm.Rrq` |
| **Declaration** | `SM_PermanentMagnet.mo:75` |
| **Parameter** | `Rrq` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0100](../../site-reports/SITE-0100-rrq-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `SM_PermanentMagnet.mo:75` is reached by this model through
`smpm.Rrq`, and the analysis reached it statically — no value has been observed
