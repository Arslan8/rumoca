# FINDING-04269: `body3.body.I_31` in `PlanarFourbar`

| | |
|---|---|
| **Model** | `Modelica.Mechanics.MultiBody.Examples.Loops.PlanarFourbar` |
| **Reached as** | `body3.body.I_31` |
...
`body3.body.I_31`, and the analysis reached it statically — no value has been observed
