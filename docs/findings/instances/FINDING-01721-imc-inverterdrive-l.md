...
One occurrence. The declaration at `AirGapS.mo:8` is reached by this model through
`aimc.airGap.L`, and the analysis reached it statically — no value has been observed
