# FINDING-03523: `rectifier.thyristor_p.idealThyristor[3].Goff` in `ThyristorCenterTap2mPulse_RLV_Characteristic`
...
`rectifier.thyristor_p.idealThyristor[3].Goff`, and the analysis reached it statically — no value has been observed
