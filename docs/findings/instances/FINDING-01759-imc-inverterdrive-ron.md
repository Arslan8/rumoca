# FINDING-01759: `inverter.transistor_n.idealGTOThyristor[2].Ron` in `IMC_InverterDrive`
...
`inverter.transistor_n.idealGTOThyristor[2].Ron`, and the analysis reached it statically — no value has been observed
