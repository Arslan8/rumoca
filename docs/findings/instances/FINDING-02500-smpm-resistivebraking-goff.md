# FINDING-02500: `switch2.idealClosingSwitch[2].Goff` in `SMPM_ResistiveBraking`
...
`switch2.idealClosingSwitch[2].Goff`, and the analysis reached it statically — no value has been observed
