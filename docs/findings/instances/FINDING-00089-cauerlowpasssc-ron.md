# FINDING-00089: `R1.IdealCommutingSwitch2.Ron` in `CauerLowPassSC`
...
`R1.IdealCommutingSwitch2.Ron`, and the analysis reached it statically — no value has been observed
