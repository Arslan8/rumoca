# FINDING-04146: `referenceSystem.pointMass6.I` in `PointGravityWithPointMasses2`

| | |
|---|---|
| **Model** | `Modelica.Mechanics.MultiBody.Examples.Elementary.PointGravityWithPointMasses2` |
| **Reached as** | `referenceSystem.pointMass6.I` |
...
| `required` | referenceSystem.pointMass6.I > 0 |
| `declared_min` | None |
...
`referenceSystem.pointMass6.I`, and the analysis reached it statically — no value has been observed
