# FINDING-03646: `dcdc.transistorHS.Goff` in `ChopperBuckBoost_DutyCycle`
...
`dcdc.transistorHS.Goff`, and the analysis reached it statically — no value has been observed
