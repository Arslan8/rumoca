# FINDING-01507: `dcse.Lme` in `DC_CompareCharacteristics`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Machines.Examples.DCMachines.DC_CompareCharacteristics` |
| **Reached as** | `dcse.Lme` |
| **Declaration** | `DC_SeriesExcited.mo:84` |
| **Parameter** | `Lme` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0201](../../site-reports/SITE-0201-lme-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `DC_SeriesExcited.mo:84` is reached by this model through
`dcse.Lme`, and the analysis reached it statically — no value has been observed
