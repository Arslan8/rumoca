# FINDING-03833: `core.material.c_b` in `ToroidalCoreQuadraticCrossSection`

| | |
|---|---|
| **Model** | `Modelica.Magnetic.FluxTubes.Examples.BasicExamples.ToroidalCoreQuadraticCrossSection` |
| **Reached as** | `core.material.c_b` |
...
| key | value |
|---|---|
| `parameter` | core.material.c_b |
| `shape` | sum |
| `path` | core.material.c_b |
| `declared_min` | None |
| `divisor_sites` | 1 |
...
`core.material.c_b`, and the analysis reached it statically — no value has been observed
