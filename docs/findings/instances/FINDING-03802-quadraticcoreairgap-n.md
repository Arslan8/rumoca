# FINDING-03802: `lowerYoke.material.n` in `QuadraticCoreAirgap`

| | |
|---|---|
| **Model** | `Modelica.Magnetic.FluxTubes.Examples.BasicExamples.QuadraticCoreAirgap` |
| **Reached as** | `lowerYoke.material.n` |
...
| key | value |
|---|---|
| `parameter` | lowerYoke.material.n |
| `shape` | sum |
| `path` | lowerYoke.material.n |
| `declared_min` | None |
| `divisor_sites` | 1 |
...
`lowerYoke.material.n`, and the analysis reached it statically — no value has been observed
