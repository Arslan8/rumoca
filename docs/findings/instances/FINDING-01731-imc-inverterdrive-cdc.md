...
One occurrence. The declaration at `IMC_InverterDrive.mo:14` is reached by this model through
`CDC`, and the analysis reached it statically — no value has been observed
