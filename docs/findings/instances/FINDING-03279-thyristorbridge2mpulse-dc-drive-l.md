# FINDING-03279: `dcpm.la.L` in `ThyristorBridge2mPulse_DC_Drive`
...
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0051](../../site-reports/SITE-0051-l-physical-domain-unenforced.md) |
...
`dcpm.la.L`, and the analysis reached it statically — no value has been observed
