# FINDING-00819: `integrator.R` in `Integrator`
...
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0331](../../site-reports/SITE-0331-r-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `Integrator.mo:7` is reached by this model through
`integrator.R`, and the analysis reached it statically — no value has been observed
