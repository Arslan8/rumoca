...
One occurrence. The declaration at `PNP.mo:9` is reached by this model through
`T2.Ccs`, and the analysis reached it statically — no value has been observed
