# FINDING-00858: `R2` in `Multivibrator`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Analog.Examples.OpAmps.Multivibrator` |
| **Reached as** | `R2` |
| **Declaration** | `Multivibrator.mo:8` |
| **Parameter** | `R2` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0757](../../site-reports/SITE-0757-r2-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `Multivibrator.mo:8` is reached by this model through
