# FINDING-03914: `G_mLeakRad.material.n` in `AdvancedSolenoid`

| | |
|---|---|
| **Model** | `Modelica.Magnetic.FluxTubes.Examples.SolenoidActuator.Components.AdvancedSolenoid` |
| **Reached as** | `G_mLeakRad.material.n` |
...
| key | value |
|---|---|
| `parameter` | G_mLeakRad.material.n |
| `shape` | sum |
| `path` | G_mLeakRad.material.n |
| `declared_min` | None |
| `divisor_sites` | 1 |
...
`G_mLeakRad.material.n`, and the analysis reached it statically — no value has been observed
