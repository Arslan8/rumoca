# FINDING-02090: `aimsData.rotorCoreParameters.GcRef` in `IMS_Start`
...
`aimsData.rotorCoreParameters.GcRef`, and the analysis reached it statically — no value has been observed
