# FINDING-04089: `body.body.I_32` in `InitSpringConstant`

| | |
|---|---|
| **Model** | `Modelica.Mechanics.MultiBody.Examples.Elementary.InitSpringConstant` |
| **Reached as** | `body.body.I_32` |
...
`body.body.I_32`, and the analysis reached it statically — no value has been observed
