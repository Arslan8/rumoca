...
One occurrence. The declaration at `IM_SlipRingData.mo:6` is reached by this model through
`aimsData.Lm`, and the analysis reached it statically — no value has been observed
