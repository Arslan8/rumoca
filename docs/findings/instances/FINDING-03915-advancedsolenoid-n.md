...
| key | value |
|---|---|
| `parameter` | g_mAirPar.material.n |
| `shape` | sum |
| `path` | g_mAirPar.material.n |
| `declared_min` | None |
| `divisor_sites` | 1 |
...
`g_mAirPar.material.n`, and the analysis reached it statically — no value has been observed
