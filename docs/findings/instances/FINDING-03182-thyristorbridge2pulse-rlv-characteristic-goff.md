# FINDING-03182: `rectifier.thyristor_n1.Goff` in `ThyristorBridge2Pulse_RLV_Characteristic`
...
`rectifier.thyristor_n1.Goff`, and the analysis reached it statically — no value has been observed
