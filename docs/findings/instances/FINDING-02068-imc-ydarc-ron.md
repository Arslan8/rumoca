...
One occurrence. The declaration at `OpenerWithArc.mo:4` is reached by this model through
`switchYDwithArc.idealOpener.Ron`, and the analysis reached it statically — no value has been observed
