# FINDING-03589: `rectifier.thyristor.Goff` in `ThyristorCenterTapmPulse_RLV_Characteristic`
...
`rectifier.thyristor.Goff`, and the analysis reached it statically — no value has been observed
