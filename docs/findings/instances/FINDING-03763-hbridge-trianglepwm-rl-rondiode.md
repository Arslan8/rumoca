...
One occurrence. The declaration at `HBridge.mo:14` is reached by this model through
`hbridge.RonDiode`, and the analysis reached it statically — no value has been observed
