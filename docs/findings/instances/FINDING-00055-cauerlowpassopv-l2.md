# FINDING-00055: `l2` in `CauerLowPassOPV`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Analog.Examples.CauerLowPassOPV` |
| **Reached as** | `l2` |
| **Declaration** | `CauerLowPassOPV.mo:6` |
| **Parameter** | `l2` |
| **Claim** | the declaration explicitly permits zero (`min=0`) |
| **Kind** | `physical-bound-permits-zero` |
| **Severity** | low |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0577](../../site-reports/SITE-0577-l2-physical-bound-permits-zero.md) |
...
One occurrence. The declaration at `CauerLowPassOPV.mo:6` is reached by this model through
