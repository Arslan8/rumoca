# FINDING-03912: `g_mAirPar.material.c_b` in `AdvancedSolenoid`

| | |
|---|---|
| **Model** | `Modelica.Magnetic.FluxTubes.Examples.SolenoidActuator.Components.AdvancedSolenoid` |
| **Reached as** | `g_mAirPar.material.c_b` |
...
| key | value |
|---|---|
| `parameter` | g_mAirPar.material.c_b |
| `shape` | sum |
| `path` | g_mAirPar.material.c_b |
| `declared_min` | None |
| `divisor_sites` | 1 |
...
`g_mAirPar.material.c_b`, and the analysis reached it statically — no value has been observed
