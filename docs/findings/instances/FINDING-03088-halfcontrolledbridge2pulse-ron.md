# FINDING-03088: `rectifier.diode_n1.Ron` in `HalfControlledBridge2Pulse`
...
`rectifier.diode_n1.Ron`, and the analysis reached it statically — no value has been observed
