...
One occurrence. The declaration at `IM_SquirrelCageData.mo:13` is reached by this model through
`aimcData.Rr`, and the analysis reached it statically — no value has been observed
