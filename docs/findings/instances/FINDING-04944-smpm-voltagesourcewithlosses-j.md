# FINDING-04944: `smpm.inertiaRotor.J` in `SMPM_VoltageSourceWithLosses`
...
`smpm.inertiaRotor.J`, and the analysis reached it statically — no value has been observed
