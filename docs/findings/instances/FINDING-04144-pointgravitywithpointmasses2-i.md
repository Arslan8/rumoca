# FINDING-04144: `referenceSystem.pointMass4.I` in `PointGravityWithPointMasses2`

| | |
|---|---|
| **Model** | `Modelica.Mechanics.MultiBody.Examples.Elementary.PointGravityWithPointMasses2` |
| **Reached as** | `referenceSystem.pointMass4.I` |
...
| `required` | referenceSystem.pointMass4.I > 0 |
| `declared_min` | None |
...
`referenceSystem.pointMass4.I`, and the analysis reached it statically — no value has been observed
