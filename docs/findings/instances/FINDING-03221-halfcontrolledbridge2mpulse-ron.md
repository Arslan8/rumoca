# FINDING-03221: `rectifier.diode_n.idealDiode[2].Ron` in `HalfControlledBridge2mPulse`
...
`rectifier.diode_n.idealDiode[2].Ron`, and the analysis reached it statically — no value has been observed
