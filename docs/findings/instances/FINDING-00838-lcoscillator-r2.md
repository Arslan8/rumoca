# FINDING-00838: `R2` in `LCOscillator`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Analog.Examples.OpAmps.LCOscillator` |
| **Reached as** | `R2` |
| **Declaration** | `LCOscillator.mo:12` |
| **Parameter** | `R2` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0753](../../site-reports/SITE-0753-r2-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `LCOscillator.mo:12` is reached by this model through
