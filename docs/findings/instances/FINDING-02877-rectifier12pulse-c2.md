# FINDING-02877: `transformerData1.C2` in `Rectifier12pulse`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Machines.Examples.Transformers.Rectifier12pulse` |
| **Reached as** | `transformerData1.C2` |
...
| key | value |
|---|---|
| `parameter` | transformerData1.C2 |
| `shape` | propagated |
| `path` | transformerData1.C2 -> transformerData1.V2ph |
| `declared_min` | None |
| `divisor_sites` | 6 |
...
`transformerData1.C2`, and the analysis reached it statically — no value has been observed
