...
One occurrence. The declaration at `IdealDiode.mo:4` is reached by this model through
`diodeBridge2mPulse.diode_p.Ron`, and the analysis reached it statically — no value has been observed
