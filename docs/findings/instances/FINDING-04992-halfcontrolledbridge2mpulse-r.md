# FINDING-04992: `resistor1.R` in `HalfControlledBridge2mPulse`

| | |
|---|---|
| **Model** | `ModelicaTest.Electrical.PowerConverters.HalfControlledBridge2mPulse` |
| **Reached as** | `resistor1.R` |
...
`resistor1.R`, and the analysis reached it statically — no value has been observed
