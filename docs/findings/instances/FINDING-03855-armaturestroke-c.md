# FINDING-03855: `pmActuator.armature.stopper_xMax.c` in `ArmatureStroke`
...
`pmActuator.armature.stopper_xMax.c`, and the analysis reached it statically — no value has been observed
