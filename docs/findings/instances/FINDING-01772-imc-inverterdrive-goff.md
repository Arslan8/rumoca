# FINDING-01772: `inverter.diode_n.idealDiode[3].Goff` in `IMC_InverterDrive`
...
`inverter.diode_n.idealDiode[3].Goff`, and the analysis reached it statically — no value has been observed
