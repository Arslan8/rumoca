# FINDING-03775: `hbridge.inverter_p.diode_p.Ron` in `HBridge_TrianglePWM_RL`
...
`hbridge.inverter_p.diode_p.Ron`, and the analysis reached it statically — no value has been observed
