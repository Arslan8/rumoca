# FINDING-00385: `oLine1.G[6].T_ref` in `CompareLineTrunks`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Analog.Examples.Lines.CompareLineTrunks` |
| **Reached as** | `oLine1.G[6].T_ref` |
...
| key | value |
|---|---|
| `parameter` | oLine1.G[6].T_ref |
| `shape` | sum |
| `path` | oLine1.G[6].T_ref |
| `declared_min` | 0.0 |
| `divisor_sites` | 1 |
...
`oLine1.G[6].T_ref`, and the analysis reached it statically — no value has been observed
