# FINDING-03014: `Ron` in `Rectifier`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Polyphase.Examples.Rectifier` |
| **Reached as** | `Ron` |
| **Declaration** | `Rectifier.mo:12` |
| **Parameter** | `Ron` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0772](../../site-reports/SITE-0772-ron-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `Rectifier.mo:12` is reached by this model through
`Ron`, and the analysis reached it statically — no value has been observed
