# FINDING-01372: `dcpm2.coreParameters.GcRef` in `DCPM_withLosses`
...
`dcpm2.coreParameters.GcRef`, and the analysis reached it statically — no value has been observed
