# FINDING-00277: `CapVal` in `HeatingNPN_NORGate`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Analog.Examples.HeatingNPN_NORGate` |
| **Reached as** | `CapVal` |
| **Declaration** | `HeatingNPN_NORGate.mo:4` |
| **Parameter** | `CapVal` |
| **Claim** | the declaration explicitly permits zero (`min=0`) |
| **Kind** | `physical-bound-permits-zero` |
| **Severity** | low |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0613](../../site-reports/SITE-0613-capval-physical-bound-permits-zero.md) |
...
One occurrence. The declaration at `HeatingNPN_NORGate.mo:4` is reached by this model through
`CapVal`, and the analysis reached it statically — no value has been observed
