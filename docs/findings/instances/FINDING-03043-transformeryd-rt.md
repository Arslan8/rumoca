# FINDING-03043: `RT` in `TransformerYD`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Polyphase.Examples.TransformerYD` |
| **Reached as** | `RT` |
| **Declaration** | `TransformerYD.mo:10` |
| **Parameter** | `RT` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0871](../../site-reports/SITE-0871-rt-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `TransformerYD.mo:10` is reached by this model through
`RT`, and the analysis reached it statically — no value has been observed
