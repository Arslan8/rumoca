...
One occurrence. The declaration at `IM_SlipRing.mo:27` is reached by this model through
`aims.Lm`, and the analysis reached it statically — no value has been observed
