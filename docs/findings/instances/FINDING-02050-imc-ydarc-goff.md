# FINDING-02050: `switchYDwithArc.idealOpener.openerWithArc[3].Goff` in `IMC_YDarc`
...
`switchYDwithArc.idealOpener.openerWithArc[3].Goff`, and the analysis reached it statically — no value has been observed
