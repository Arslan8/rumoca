# FINDING-02047: `switchYDwithArc.idealCloser.closerWithArc[3].Goff` in `IMC_YDarc`
...
`switchYDwithArc.idealCloser.closerWithArc[3].Goff`, and the analysis reached it statically — no value has been observed
