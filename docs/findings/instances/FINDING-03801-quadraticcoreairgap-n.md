# FINDING-03801: `leftLeg.material.n` in `QuadraticCoreAirgap`

| | |
|---|---|
| **Model** | `Modelica.Magnetic.FluxTubes.Examples.BasicExamples.QuadraticCoreAirgap` |
| **Reached as** | `leftLeg.material.n` |
...
`leftLeg.material.n`, and the analysis reached it statically — no value has been observed
