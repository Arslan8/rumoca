# FINDING-01168: `cooling.flowPort_b.medium.rho` in `DCPM_Cooling`
...
`cooling.flowPort_b.medium.rho`, and the analysis reached it statically — no value has been observed
