# FINDING-01177: `cooling.medium.rho` in `DCPM_Cooling`
...
| key | value |
|---|---|
| `parameter` | cooling.medium.rho |
| `shape` | direct |
| `path` | cooling.medium.rho |
| `declared_min` | 0.0 |
| `divisor_sites` | 1 |
...
`cooling.medium.rho`, and the analysis reached it statically — no value has been observed
