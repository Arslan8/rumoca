# FINDING-01347: `JLoad` in `DCPM_Temperature`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Machines.Examples.DCMachines.DCPM_Temperature` |
| **Reached as** | `JLoad` |
| **Declaration** | `DCPM_Temperature.mo:10` |
| **Parameter** | `JLoad` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0689](../../site-reports/SITE-0689-jload-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `DCPM_Temperature.mo:10` is reached by this model through
