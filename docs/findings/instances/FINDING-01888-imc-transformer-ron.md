# FINDING-01888: `idealCloser.idealClosingSwitch[2].Ron` in `IMC_Transformer`
...
`idealCloser.idealClosingSwitch[2].Ron`, and the analysis reached it statically — no value has been observed
