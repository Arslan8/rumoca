# FINDING-03540: `rectifier.diode.idealDiode[2].Ron` in `DiodeCenterTapmPulse`
...
`rectifier.diode.idealDiode[2].Ron`, and the analysis reached it statically — no value has been observed
