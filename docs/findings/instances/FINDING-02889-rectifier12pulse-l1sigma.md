...
One occurrence. The declaration at `TransformerData.mo:40` is reached by this model through
`transformerData2.L1sigma`, and the analysis reached it statically — no value has been observed
