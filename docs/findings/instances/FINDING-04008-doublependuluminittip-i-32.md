# FINDING-04008: `boxBody2.body.I_32` in `DoublePendulumInitTip`

| | |
|---|---|
| **Model** | `Modelica.Mechanics.MultiBody.Examples.Elementary.DoublePendulumInitTip` |
| **Reached as** | `boxBody2.body.I_32` |
...
`boxBody2.body.I_32`, and the analysis reached it statically — no value has been observed
