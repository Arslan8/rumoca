# FINDING-02087: `aims.rotorCoreParameters.GcRef` in `IMS_Start`
...
`aims.rotorCoreParameters.GcRef`, and the analysis reached it statically — no value has been observed
