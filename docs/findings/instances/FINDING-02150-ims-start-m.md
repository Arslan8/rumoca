# FINDING-02150: `aims.spacePhasorS.m` in `IMS_Start`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Machines.Examples.InductionMachines.IMS_Start` |
| **Reached as** | `aims.spacePhasorS.m` |
...
| key | value |
|---|---|
| `parameter` | aims.spacePhasorS.m |
| `shape` | direct |
| `path` | aims.spacePhasorS.m |
| `declared_min` | None |
| `divisor_sites` | 2 |
...
`aims.spacePhasorS.m`, and the analysis reached it statically — no value has been observed
