# FINDING-01973: `switchYD.idealCloser.idealClosingSwitch[2].Ron` in `IMC_YD`
...
| **Severity** | low |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0041](../../site-reports/SITE-0041-ron-physical-bound-permits-zero.md) |
...
One occurrence. The declaration at `IdealSwitch.mo:4` is reached by this model through
`switchYD.idealCloser.idealClosingSwitch[2].Ron`, and the analysis reached it statically — no value has been observed
