# FINDING-02045: `switchYDwithArc.idealCloser.closerWithArc[1].Goff` in `IMC_YDarc`
...
`switchYDwithArc.idealCloser.closerWithArc[1].Goff`, and the analysis reached it statically — no value has been observed
