# FINDING-04692: `valveRamp.duration` in `PumpAndValve`
...
| key | value |
|---|---|
| `parameter` | valveRamp.duration |
| `shape` | direct |
| `path` | valveRamp.duration |
| `declared_min` | 0.0 |
| `divisor_sites` | 1 |
...
`valveRamp.duration`, and the analysis reached it statically — no value has been observed
