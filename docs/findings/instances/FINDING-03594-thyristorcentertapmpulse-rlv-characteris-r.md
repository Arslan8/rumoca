# FINDING-03594: `R` in `ThyristorCenterTapmPulse_RLV_Characteristic`
...
| **Reached as** | `R` |
| **Declaration** | `ThyristorCenterTapmPulse_RLV_Characteristic.mo:8` |
| **Parameter** | `R` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0865](../../site-reports/SITE-0865-r-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `ThyristorCenterTapmPulse_RLV_Characteristic.mo:8` is reached by this model through
