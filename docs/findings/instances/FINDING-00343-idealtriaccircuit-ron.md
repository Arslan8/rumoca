...
One occurrence. The declaration at `IdealTriac.mo:4` is reached by this model through
`idealTriac.Ron`, and the analysis reached it statically — no value has been observed
