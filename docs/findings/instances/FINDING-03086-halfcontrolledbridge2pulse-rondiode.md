# FINDING-03086: `rectifier.RonDiode` in `HalfControlledBridge2Pulse`
...
| **Declaration** | `HalfControlledBridge2Pulse.mo:6` |
| **Parameter** | `RonDiode` |
| **Claim** | the declaration explicitly permits zero (`min=0`) |
| **Kind** | `physical-bound-permits-zero` |
| **Severity** | low |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0611](../../site-reports/SITE-0611-rondiode-physical-bound-permits-zero.md) |
...
One occurrence. The declaration at `HalfControlledBridge2Pulse.mo:6` is reached by this model through
