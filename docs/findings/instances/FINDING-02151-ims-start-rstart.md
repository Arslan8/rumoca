...
One occurrence. The declaration at `SwitchedRheostat.mo:10` is reached by this model through
`switchedRheostat.RStart`, and the analysis reached it statically — no value has been observed
