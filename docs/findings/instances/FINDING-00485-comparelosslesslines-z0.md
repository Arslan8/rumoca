# FINDING-00485: `z0` in `CompareLosslessLines`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Analog.Examples.Lines.CompareLosslessLines` |
| **Reached as** | `z0` |
| **Declaration** | `CompareLosslessLines.mo:12` |
| **Parameter** | `z0` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0668](../../site-reports/SITE-0668-z0-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `CompareLosslessLines.mo:12` is reached by this model through
`z0`, and the analysis reached it statically — no value has been observed
