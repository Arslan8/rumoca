# FINDING-04964: `smpmData.Rrd` in `SMPM_VoltageSourceWithLosses`

| | |
|---|---|
| **Model** | `ModelicaTest.Electrical.Machines.SMPM_VoltageSourceWithLosses` |
| **Reached as** | `smpmData.Rrd` |
| **Declaration** | `SM_ReluctanceRotorData.mo:25` |
| **Parameter** | `Rrd` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0084](../../site-reports/SITE-0084-rrd-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `SM_ReluctanceRotorData.mo:25` is reached by this model through
`smpmData.Rrd`, and the analysis reached it statically — no value has been observed
