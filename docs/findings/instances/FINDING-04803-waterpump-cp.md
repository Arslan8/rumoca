# FINDING-04803: `ambient1.medium.cp` in `WaterPump`
...
| key | value |
|---|---|
| `parameter` | ambient1.medium.cp |
| `shape` | direct |
| `path` | ambient1.medium.cp |
| `declared_min` | None |
| `divisor_sites` | 2 |
...
`ambient1.medium.cp`, and the analysis reached it statically — no value has been observed
