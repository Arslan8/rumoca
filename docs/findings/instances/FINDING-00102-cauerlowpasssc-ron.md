# FINDING-00102: `R7.IdealCommutingSwitch1.Ron` in `CauerLowPassSC`
...
`R7.IdealCommutingSwitch1.Ron`, and the analysis reached it statically — no value has been observed
