# FINDING-00615: `oLine50.G[15].alpha` in `SmoothStep`
...
| key | value |
|---|---|
| `parameter` | oLine50.G[15].alpha |
| `shape` | sum |
| `path` | oLine50.G[15].alpha |
| `declared_min` | None |
| `divisor_sites` | 1 |
...
`oLine50.G[15].alpha`, and the analysis reached it statically — no value has been observed
