# FINDING-02649: `smr.statorCore.coreParameters.GcRef` in `SMR_Inverter`
...
`smr.statorCore.coreParameters.GcRef`, and the analysis reached it statically — no value has been observed
