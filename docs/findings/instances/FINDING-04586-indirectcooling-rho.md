# FINDING-04586: `outerMedium.rho` in `IndirectCooling`
...
| key | value |
|---|---|
| `parameter` | outerMedium.rho |
| `shape` | direct |
| `path` | outerMedium.rho |
| `declared_min` | 0.0 |
| `divisor_sites` | 2 |
...
`outerMedium.rho`, and the analysis reached it statically — no value has been observed
