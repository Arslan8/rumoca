# FINDING-03584: `rectifier.thyristor.idealThyristor[3].Ron` in `ThyristorCenterTapmPulse_RLV_Characteristic`
...
`rectifier.thyristor.idealThyristor[3].Ron`, and the analysis reached it statically — no value has been observed
