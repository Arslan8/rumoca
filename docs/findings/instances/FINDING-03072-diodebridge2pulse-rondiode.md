# FINDING-03072: `rectifier.RonDiode` in `DiodeBridge2Pulse`
...
| **Declaration** | `DiodeBridge2Pulse.mo:5` |
| **Parameter** | `RonDiode` |
| **Claim** | the declaration explicitly permits zero (`min=0`) |
| **Kind** | `physical-bound-permits-zero` |
| **Severity** | low |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0595](../../site-reports/SITE-0595-rondiode-physical-bound-permits-zero.md) |
...
One occurrence. The declaration at `DiodeBridge2Pulse.mo:5` is reached by this model through
