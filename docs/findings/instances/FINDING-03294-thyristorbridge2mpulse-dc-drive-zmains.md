...
One occurrence. The declaration at `ThyristorBridge2mPulse_DC_Drive.mo:14` is reached by this model through
`ZMains`, and the analysis reached it statically — no value has been observed
