# FINDING-00037: `c1` in `CauerLowPassAnalog`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Analog.Examples.CauerLowPassAnalog` |
| **Reached as** | `c1` |
| **Declaration** | `CauerLowPassAnalog.mo:7` |
| **Parameter** | `c1` |
| **Claim** | the declaration explicitly permits zero (`min=0`) |
| **Kind** | `physical-bound-permits-zero` |
| **Severity** | low |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0571](../../site-reports/SITE-0571-c1-physical-bound-permits-zero.md) |
...
One occurrence. The declaration at `CauerLowPassAnalog.mo:7` is reached by this model through
