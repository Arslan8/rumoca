# FINDING-03068: `idealthyristor.Ron` in `Thyristor1Pulse_R_Characteristic`
...
`idealthyristor.Ron`, and the analysis reached it statically — no value has been observed
