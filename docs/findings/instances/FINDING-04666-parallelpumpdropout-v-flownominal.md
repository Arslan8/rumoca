# FINDING-04666: `pipe2.V_flowNominal` in `ParallelPumpDropOut`
...
| key | value |
|---|---|
| `parameter` | pipe2.V_flowNominal |
| `shape` | direct |
| `path` | pipe2.V_flowNominal |
| `declared_min` | None |
| `divisor_sites` | 1 |
...
`pipe2.V_flowNominal`, and the analysis reached it statically — no value has been observed
