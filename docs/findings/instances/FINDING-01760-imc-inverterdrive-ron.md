# FINDING-01760: `inverter.transistor_n.idealGTOThyristor[3].Ron` in `IMC_InverterDrive`
...
`inverter.transistor_n.idealGTOThyristor[3].Ron`, and the analysis reached it statically — no value has been observed
