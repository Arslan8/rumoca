...
One occurrence. The declaration at `PartialBasicTransformer.mo:30` is reached by this model through
`transformer2.L2sigma`, and the analysis reached it statically — no value has been observed
