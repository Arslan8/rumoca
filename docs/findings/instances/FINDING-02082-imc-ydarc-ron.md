...
One occurrence. The declaration at `SwitchYDwithArc.mo:4` is reached by this model through
`switchYDwithArc.Ron`, and the analysis reached it statically — no value has been observed
