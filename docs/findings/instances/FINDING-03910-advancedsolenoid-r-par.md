...
One occurrence. The declaration at `AdvancedSolenoid.mo:9` is reached by this model through
`R_par`, and the analysis reached it statically — no value has been observed
