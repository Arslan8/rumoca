# FINDING-04563: `absolutePressure.medium.rho` in `IndirectCooling`
...
`absolutePressure.medium.rho`, and the analysis reached it statically — no value has been observed
