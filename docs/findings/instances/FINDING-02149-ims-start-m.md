# FINDING-02149: `aims.spacePhasorR.m` in `IMS_Start`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Machines.Examples.InductionMachines.IMS_Start` |
| **Reached as** | `aims.spacePhasorR.m` |
...
| key | value |
|---|---|
| `parameter` | aims.spacePhasorR.m |
| `shape` | direct |
| `path` | aims.spacePhasorR.m |
| `declared_min` | None |
| `divisor_sites` | 2 |
...
`aims.spacePhasorR.m`, and the analysis reached it statically — no value has been observed
