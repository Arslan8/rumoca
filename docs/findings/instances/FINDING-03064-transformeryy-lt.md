# FINDING-03064: `LT` in `TransformerYY`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Polyphase.Examples.TransformerYY` |
| **Reached as** | `LT` |
| **Declaration** | `TransformerYY.mo:8` |
| **Parameter** | `LT` |
| **Claim** | nothing bounds this declaration at all |
| **Kind** | `physical-domain-unenforced` |
| **Severity** | medium |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0878](../../site-reports/SITE-0878-lt-physical-domain-unenforced.md) |
...
One occurrence. The declaration at `TransformerYY.mo:8` is reached by this model through
`LT`, and the analysis reached it statically — no value has been observed
