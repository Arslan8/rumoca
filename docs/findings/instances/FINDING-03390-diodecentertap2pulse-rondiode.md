# FINDING-03390: `rectifier.RonDiode` in `DiodeCenterTap2Pulse`
...
| **Declaration** | `DiodeCenterTap2Pulse.mo:5` |
| **Parameter** | `RonDiode` |
| **Claim** | the declaration explicitly permits zero (`min=0`) |
| **Kind** | `physical-bound-permits-zero` |
| **Severity** | low |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0597](../../site-reports/SITE-0597-rondiode-physical-bound-permits-zero.md) |
...
One occurrence. The declaration at `DiodeCenterTap2Pulse.mo:5` is reached by this model through
