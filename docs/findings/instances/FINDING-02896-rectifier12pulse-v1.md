# FINDING-02896: `transformerData1.V1` in `Rectifier12pulse`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Machines.Examples.Transformers.Rectifier12pulse` |
| **Reached as** | `transformerData1.V1` |
...
| key | value |
|---|---|
| `parameter` | transformerData1.V1 |
| `shape` | propagated |
| `path` | transformerData1.V1 -> transformerData1.V1ph |
| `declared_min` | None |
| `divisor_sites` | 6 |
...
`transformerData1.V1`, and the analysis reached it statically — no value has been observed
