# FINDING-00737: `Nand.TN1.dL` in `NandGate`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Analog.Examples.NandGate` |
| **Reached as** | `Nand.TN1.dL` |
...
`Nand.TN1.dL`, and the analysis reached it statically — no value has been observed
