...
One occurrence. The declaration at `DcSeriesExcitedData.mo:5` is reached by this model through
`dcseData.Re`, and the analysis reached it statically — no value has been observed
