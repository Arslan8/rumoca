# FINDING-03519: `rectifier.thyristor_n.idealThyristor[2].Goff` in `ThyristorCenterTap2mPulse_RLV_Characteristic`
...
`rectifier.thyristor_n.idealThyristor[2].Goff`, and the analysis reached it statically — no value has been observed
