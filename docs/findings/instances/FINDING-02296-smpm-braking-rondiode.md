# FINDING-02296: `diodeBridge2mPulse.RonDiode` in `SMPM_Braking`
...
`diodeBridge2mPulse.RonDiode`, and the analysis reached it statically — no value has been observed
