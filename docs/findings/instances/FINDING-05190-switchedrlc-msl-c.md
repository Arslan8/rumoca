# FINDING-05190: `C` in `SwitchedRLC_MSL`

| | |
|---|---|
| **Model** | `SwitchedRLC_MSL` |
| **Reached as** | `C` |
| **Declaration** | `SwitchedRLC_MSL.mo:8` |
| **Parameter** | `C` |
| **Claim** | the declaration explicitly permits zero (`min=0`) |
| **Kind** | `physical-bound-permits-zero` |
| **Severity** | low |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0637](../../site-reports/SITE-0637-c-physical-bound-permits-zero.md) |
...
One occurrence. The declaration at `SwitchedRLC_MSL.mo:8` is reached by this model through
