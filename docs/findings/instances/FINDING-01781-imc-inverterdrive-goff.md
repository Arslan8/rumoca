# FINDING-01781: `inverter.transistor_p.idealGTOThyristor[3].Goff` in `IMC_InverterDrive`
...
`inverter.transistor_p.idealGTOThyristor[3].Goff`, and the analysis reached it statically — no value has been observed
