# FINDING-03796: `leftLeg.material.c_b` in `QuadraticCoreAirgap`

| | |
|---|---|
| **Model** | `Modelica.Magnetic.FluxTubes.Examples.BasicExamples.QuadraticCoreAirgap` |
| **Reached as** | `leftLeg.material.c_b` |
...
`leftLeg.material.c_b`, and the analysis reached it statically — no value has been observed
