# FINDING-02310: `diodeBridge2mPulse.diode_n.idealDiode[3].Goff` in `SMPM_Braking`
...
`diodeBridge2mPulse.diode_n.idealDiode[3].Goff`, and the analysis reached it statically — no value has been observed
