# FINDING-03832: `airGap.material.c_b` in `ToroidalCoreQuadraticCrossSection`

| | |
|---|---|
| **Model** | `Modelica.Magnetic.FluxTubes.Examples.BasicExamples.ToroidalCoreQuadraticCrossSection` |
| **Reached as** | `airGap.material.c_b` |
...
| key | value |
|---|---|
| `parameter` | airGap.material.c_b |
| `shape` | sum |
| `path` | airGap.material.c_b |
| `declared_min` | None |
| `divisor_sites` | 1 |
...
`airGap.material.c_b`, and the analysis reached it statically — no value has been observed
