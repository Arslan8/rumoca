# FINDING-01179: `cooling.medium.cp` in `DCPM_Cooling`
...
| key | value |
|---|---|
| `parameter` | cooling.medium.cp |
| `shape` | direct |
| `path` | cooling.medium.cp |
| `declared_min` | None |
| `divisor_sites` | 2 |
...
`cooling.medium.cp`, and the analysis reached it statically — no value has been observed
