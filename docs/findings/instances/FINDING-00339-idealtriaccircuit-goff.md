# FINDING-00339: `idealTriac.idealThyristor.Goff` in `IdealTriacCircuit`
...
`idealTriac.idealThyristor.Goff`, and the analysis reached it statically — no value has been observed
