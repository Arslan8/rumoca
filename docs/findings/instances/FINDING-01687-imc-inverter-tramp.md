# FINDING-01687: `tRamp` in `IMC_Inverter`
...
| **Severity** | medium |
| **Sanitizer** | `divisor` |
| **Fix site** | [SITE-0434](../../site-reports/SITE-0434-tramp-divisor-reachable-zero.md) |
...
One occurrence. The declaration at `IMC_Inverter.mo:10` is reached by this model through
