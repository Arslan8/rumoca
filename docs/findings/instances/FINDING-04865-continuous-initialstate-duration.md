# FINDING-04865: `ramp1.duration` in `Continuous_InitialState`
...
`ramp1.duration`, and the analysis reached it statically — no value has been observed
