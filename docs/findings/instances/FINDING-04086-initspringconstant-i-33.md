# FINDING-04086: `body.body.I_33` in `InitSpringConstant`

| | |
|---|---|
| **Model** | `Modelica.Mechanics.MultiBody.Examples.Elementary.InitSpringConstant` |
| **Reached as** | `body.body.I_33` |
...
`body.body.I_33`, and the analysis reached it statically — no value has been observed
