# FINDING-04576: `outerPipe.flowPort_a.medium.rho` in `IndirectCooling`
...
`outerPipe.flowPort_a.medium.rho`, and the analysis reached it statically — no value has been observed
