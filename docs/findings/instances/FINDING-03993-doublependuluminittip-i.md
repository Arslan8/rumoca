# FINDING-03993: `boxBody1.body.I` in `DoublePendulumInitTip`
...
`boxBody1.body.I`, and the analysis reached it statically — no value has been observed
