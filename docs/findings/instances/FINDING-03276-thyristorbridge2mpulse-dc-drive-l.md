# FINDING-03276: `lMains.inductor[1].L` in `ThyristorBridge2mPulse_DC_Drive`
...
`lMains.inductor[1].L`, and the analysis reached it statically — no value has been observed
