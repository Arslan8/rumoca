# FINDING-00408: `oLine1.G[1].alpha` in `CompareLineTrunks`
...
| key | value |
|---|---|
| `parameter` | oLine1.G[1].alpha |
| `shape` | sum |
| `path` | oLine1.G[1].alpha |
| `declared_min` | None |
| `divisor_sites` | 1 |
...
`oLine1.G[1].alpha`, and the analysis reached it statically — no value has been observed
