...
One occurrence. The declaration at `SM_ElectricalExcited.mo:161` is reached by this model through
`smee.Lesigma`, and the analysis reached it statically — no value has been observed
