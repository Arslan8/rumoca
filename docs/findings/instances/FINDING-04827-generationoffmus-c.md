# FINDING-04827: `directCapacity.heatCapacitor.C` in `GenerationOfFMUs`
...
`directCapacity.heatCapacitor.C`, and the analysis reached it statically — no value has been observed
