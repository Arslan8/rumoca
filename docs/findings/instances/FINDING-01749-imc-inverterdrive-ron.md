...
One occurrence. The declaration at `IdealGTOThyristor.mo:4` is reached by this model through
`inverter.transistor_p.Ron`, and the analysis reached it statically — no value has been observed
