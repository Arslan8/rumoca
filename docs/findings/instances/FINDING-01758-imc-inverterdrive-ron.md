# FINDING-01758: `inverter.transistor_n.idealGTOThyristor[1].Ron` in `IMC_InverterDrive`
...
`inverter.transistor_n.idealGTOThyristor[1].Ron`, and the analysis reached it statically — no value has been observed
