# FINDING-02976: `transformerData.SNominal` in `TransformerTestbench`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Machines.Examples.Transformers.TransformerTestbench` |
| **Reached as** | `transformerData.SNominal` |
...
| key | value |
|---|---|
| `parameter` | transformerData.SNominal |
| `shape` | propagated |
| `path` | transformerData.SNominal -> transformerData.I1ph |
| `declared_min` | None |
| `divisor_sites` | 8 |
...
`transformerData.SNominal`, and the analysis reached it statically — no value has been observed
