...
One occurrence. The declaration at `CloserWithArc.mo:4` is reached by this model through
`switchYDwithArc.idealCloser.Ron`, and the analysis reached it statically — no value has been observed
