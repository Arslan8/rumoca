# FINDING-02651: `smrData.statorCoreParameters.GcRef` in `SMR_Inverter`
...
`smrData.statorCoreParameters.GcRef`, and the analysis reached it statically — no value has been observed
