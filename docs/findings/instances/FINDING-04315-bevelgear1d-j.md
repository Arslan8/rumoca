...
One occurrence. The declaration at `Rotor1D.mo:7` is reached by this model through
`inertia2.J`, and the analysis reached it statically — no value has been observed
