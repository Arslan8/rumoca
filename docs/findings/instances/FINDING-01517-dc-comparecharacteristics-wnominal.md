# FINDING-01517: `dceeData.wNominal` in `DC_CompareCharacteristics`

| | |
|---|---|
| **Model** | `Modelica.Electrical.Machines.Examples.DCMachines.DC_CompareCharacteristics` |
| **Reached as** | `dceeData.wNominal` |
...
| key | value |
|---|---|
| `parameter` | dceeData.wNominal |
| `shape` | propagated |
| `path` | dceeData.wNominal -> dceeData.frictionParameters.wRef |
| `declared_min` | None |
| `divisor_sites` | 8 |
...
`dceeData.wNominal`, and the analysis reached it statically — no value has been observed
