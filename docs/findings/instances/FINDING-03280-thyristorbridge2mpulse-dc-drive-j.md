# FINDING-03280: `dcpm.inertiaRotor.J` in `ThyristorBridge2mPulse_DC_Drive`
...
`dcpm.inertiaRotor.J`, and the analysis reached it statically — no value has been observed
