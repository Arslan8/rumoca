# FINDING-04817: `volumeFlowSensor.m` in `WaterPump`
...
| **Severity** | low |
| **Sanitizer** | `physical` |
| **Fix site** | [SITE-0059](../../site-reports/SITE-0059-m-physical-bound-permits-zero.md) |
...
One occurrence. The declaration at `TwoPort.mo:5` is reached by this model through
`volumeFlowSensor.m`, and the analysis reached it statically — no value has been observed
