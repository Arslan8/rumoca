# FINDING-03582: `rectifier.thyristor.idealThyristor[1].Ron` in `ThyristorCenterTapmPulse_RLV_Characteristic`
...
`rectifier.thyristor.idealThyristor[1].Ron`, and the analysis reached it statically — no value has been observed
