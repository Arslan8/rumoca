# FINDING-02852: `transformer2.l1sigma.inductor[1].L` in `Rectifier12pulse`
...
`transformer2.l1sigma.inductor[1].L`, and the analysis reached it statically — no value has been observed
