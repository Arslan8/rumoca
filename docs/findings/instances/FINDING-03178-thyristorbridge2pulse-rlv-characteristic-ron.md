# FINDING-03178: `rectifier.thyristor_n1.Ron` in `ThyristorBridge2Pulse_RLV_Characteristic`
...
`rectifier.thyristor_n1.Ron`, and the analysis reached it statically — no value has been observed
